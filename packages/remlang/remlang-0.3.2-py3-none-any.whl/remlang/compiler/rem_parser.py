...
tupleArg = AstParser([LiteralParser('(', name='\'(\''),Ref('argMany'),LiteralParser(')', name='\')\'')],[LiteralParser('[', name='\'[\''),Ref('argMany'),LiteralParser(']', name='\']\'')], name = 'tupleArg', toIgnore = [{},{']',')','(','['}])
...
lambdef = AstParser([LiteralParser('{', name='\'{\''),SeqParser([LiteralParser('|', name='\'|\''),SeqParser([Ref('singleArgs')], atmost = 1),LiteralParser('|', name='\'|\'')], atmost = 1),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('statements'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser('}', name='\'}\'')],[LiteralParser('`from`', name='\'`from`\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('singleArgs'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser('`let`', name='\'`let`\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('statements'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser('`end`', name='\'`end`\'')], name = 'lambdef', toIgnore = [{"T"},{'}','`let`','`end`','|',',','{','`from`'}])
...
asExp = AstParser([SeqParser([LiteralParser('`as`', name='\'`as`\''),Ref('argMany')], atmost = 1),SeqParser([SeqParser([Ref('T')], atmost = 1),LiteralParser('`when`', name='\'`when`\''),SeqParser([Ref('T')], atmost = 1),Ref('expr')], atmost = 1),SeqParser([Ref('T')], atmost = 1),SeqParser([LiteralParser('=>', name='\'=>\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('statements')], atmost = 1)], atmost = 1)], name = 'asExp', toIgnore = [{"T"},{'`when`','`as`','=>'}])
...
compreh = AstParser([LiteralParser('`from`', name='\'`from`\''),Ref('exprMany'),SeqParser([LiteralParser('`not`', name='\'`not`\'')], atmost = 1),LiteralParser('`yield`', name='\'`yield`\''),Ref('lambdef')], name = 'compreh', toIgnore = [{},{'`yield`','`from`'}])
