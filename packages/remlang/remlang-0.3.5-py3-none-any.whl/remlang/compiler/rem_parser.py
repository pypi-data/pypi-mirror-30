...
remImport = AstParser([LiteralParser('`import`', name='\'`import`\''),Ref('string'),SeqParser([LiteralParser('`as`', name='\'`as`\''),Ref('symbol')], atmost = 1)], name = 'remImport', toIgnore = [{},{'`import`','`as`'}])
...
arg = AstParser([SeqParser([LiteralParser('...', name='\'...\'')], atmost = 1),LiteralParser('_', name='\'_\'')],[SeqParser([LiteralParser('...', name='\'...\'')], atmost = 1),Ref('refName')],[Ref('tupleArg')],[Ref('string')],[Ref('const')],[Ref('number')], name = 'arg', toIgnore = [{},{'++'}])
iterMark = AstParser([LiteralParser(',', name='\',\'')], name = 'iterMark')
argMany = AstParser([Ref('arg'),SeqParser([SeqParser([SeqParser([Ref('T')], atmost = 1),LiteralParser(',', name='\',\''),SeqParser([Ref('T')], atmost = 1),Ref('arg')], atleast = 1),SeqParser([Ref('T')], atmost = 1)], atmost = 1),SeqParser([Ref('iterMark')], atmost = 1)], name = 'argMany', toIgnore = [{"T"},{','}])
tupleArg = AstParser([LiteralParser('(', name='\'(\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('argMany'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser(')', name='\')\'')],[LiteralParser('[', name='\'[\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('argMany'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser(']', name='\']\'')], name = 'tupleArg', toIgnore = [{"T"},{']','[','(',')'}])
singleArgs = AstParser([Ref('symbol'),SeqParser([SeqParser([Ref('T')], atmost = 1),LiteralParser(',', name='\',\''),SeqParser([Ref('T')], atmost = 1),Ref('symbol')])], name = 'singleArgs', toIgnore = [{"T"},{','}])
...
lambdef = AstParser([LiteralParser('{', name='\'{\''),SeqParser([Ref('T')], atmost = 1),SeqParser([LiteralParser('|', name='\'|\''),SeqParser([Ref('singleArgs'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser('|', name='\'|\'')], atmost = 1),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('statements'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser('}', name='\'}\'')],[LiteralParser('`from`', name='\'`from`\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('singleArgs'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser('`let`', name='\'`let`\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('statements'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser('`end`', name='\'`end`\'')], name = 'lambdef', toIgnore = [{"T"},{'{','`from`','}',',','`let`','`end`','|'}])
...
invExp = AstParser([Ref('atomExpr'),SeqParser([DependentAstParser([Ref('atomExpr')],[Ref('invTrailer')])])], name = 'invExp')
...
caseExp = AstParser([LiteralParser('`case`', name='\'`case`\''),Ref('expr'),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('asExp')]),SeqParser([Ref('otherwiseExp')], atmost = 1),SeqParser([Ref('T')], atmost = 1),LiteralParser('`end`', name='\'`end`\'')], name = 'caseExp', toIgnore = [{"T"},{'`end`','`case`'}])
asExp = AstParser([SeqParser([LiteralParser('`as`', name='\'`as`\''),Ref('argMany')], atmost = 1),SeqParser([SeqParser([Ref('T')], atmost = 1),LiteralParser('`when`', name='\'`when`\''),SeqParser([Ref('T')], atmost = 1),Ref('expr')], atmost = 1),SeqParser([Ref('T')], atmost = 1),SeqParser([LiteralParser('=>', name='\'=>\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('statements')], atmost = 1)], atmost = 1)], name = 'asExp', toIgnore = [{"T"},{'=>','`as`','`when`'}])
...
where = AstParser([LiteralParser('`where`', name='\'`where`\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('statements'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser('`end`', name='\'`end`\'')], name = 'where', toIgnore = [{"T"},{'`end`','`where`'}])
expr = AstParser([Ref('testExpr'),SeqParser([DependentAstParser([Ref('thenTrailer')],[Ref('applicationTrailer')])]),SeqParser([Ref('where')], atmost = 1)], name = 'expr')
thenTrailer = AstParser([LiteralParser('`then`', name='\'`then`\''),Ref('testExpr')], name = 'thenTrailer', toIgnore = [{},{'`then`'}])
applicationTrailer = AstParser([LiteralParser('$', name='\'$\''),Ref('testExpr')], name = 'applicationTrailer', toIgnore = [{},{'$'}])
statements = AstParser([Ref('statement'),SeqParser([SeqParser([Ref('T')], atmost = 1),Ref('statement')])], name = 'statements', toIgnore = [{"T"},{}])
statement = AstParser([DependentAstParser([Ref('label')],[Ref('let')],[Ref('expr')],[Ref('into')],[Ref('importExpr')]),SeqParser([LiteralParser(';', name='\';\'')], atmost = 1)], name = 'statement')
let = AstParser([SeqParser([LiteralParser('`let`', name='\'`let`\'')], atmost = 1),Ref('symbol'),SeqParser([LiteralParser('!', name='\'!\''),SeqParser([Ref('trailer')], atleast = 1)], atmost = 1),LiteralParser('=', name='\'=\''),Ref('expr')], name = 'let', toIgnore = [{},{'!','='}])
...
exprCons = AstParser([Ref('exprMany'),SeqParser([SeqParser([Ref('T')], atmost = 1),LiteralParser(',', name='\',\''),SeqParser([Ref('T')], atmost = 1),Ref('unpack'),SeqParser([SeqParser([Ref('T')], atmost = 1),LiteralParser(',', name='\',\''),SeqParser([Ref('T')], atmost = 1),Ref('exprMany')], atmost = 1)]),SeqParser([LiteralParser(',', name='\',\'')], atmost = 1)], name = 'exprCons', toIgnore = [{"T"},{','}])
...
kvCons = AstParser([Ref('kvMany'),SeqParser([SeqParser([Ref('T')], atmost = 1),LiteralParser(',', name='\',\''),SeqParser([Ref('T')], atmost = 1),Ref('unpack'),SeqParser([SeqParser([Ref('T')], atmost = 1),LiteralParser(',', name='\',\''),SeqParser([Ref('T')], atmost = 1),Ref('kvMany')], atmost = 1)]),SeqParser([LiteralParser(',', name='\',\'')], atmost = 1)], name = 'kvCons', toIgnore = [{"T"},{','}])
listCons = AstParser([LiteralParser('[', name='\'[\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('exprCons'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser(']', name='\']\'')], name = 'listCons', toIgnore = [{"T"},{']','['}])
tupleCons = AstParser([LiteralParser('(', name='\'(\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('exprCons'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser(')', name='\')\'')], name = 'tupleCons', toIgnore = [{"T"},{'(',')'}])
setCons = AstParser([LiteralParser('%', name='\'%\''),LiteralParser('{', name='\'{\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('exprCons'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser('}', name='\'}\'')], name = 'setCons', toIgnore = [{"T"},{'%','{','}'}])
dictCons = AstParser([LiteralParser('%', name='\'%\''),LiteralParser('{', name='\'{\''),SeqParser([Ref('T')], atmost = 1),SeqParser([Ref('kvCons'),SeqParser([Ref('T')], atmost = 1)], atmost = 1),LiteralParser('}', name='\'}\'')], name = 'dictCons', toIgnore = [{"T"},{'%','{','}'}])
compreh = AstParser([LiteralParser('`from`', name='\'`from`\''),SeqParser([Ref('T')], atmost = 1),Ref('exprMany'),SeqParser([SeqParser([Ref('T')], atmost = 1),LiteralParser('`not`', name='\'`not`\'')], atmost = 1),SeqParser([Ref('T')], atmost = 1),LiteralParser('`yield`', name='\'`yield`\''),SeqParser([Ref('T')], atmost = 1),Ref('lambdef')], name = 'compreh', toIgnore = [{"T"},{'`from`','`yield`'}])
...
applicationTrailer.compile(namespace, recurSearcher)
