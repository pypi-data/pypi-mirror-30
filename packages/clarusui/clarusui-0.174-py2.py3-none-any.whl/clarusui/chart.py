...
class Chart(Element):
    ...
    def set_xaxis(self, title, type, reverse):
        xoptions = dict()
    ...
    def set_yaxis(self, axis, reverse):
        yoptions = dict()
        ...
        if axis is not None:
            yoptions['title'] = axis
        self.layout.update({'yaxis' : yoptions})   
...
#        return self._plot('file')
    ...
    def _get_options(self):
        ...
        self.set_xaxis(chart_options.pop('xlabel', None), chart_options.pop('xtype', None), chart_options.pop('xreverse', False))
        self.set_yaxis(chart_options.pop('ylabel', None), chart_options.pop('yreverse', False))
