...
CASTING_ERROR_MESSAGE = """Couldn't cast parameter {0!r}, returning raw value instead.
Please report it to comet.ml and use `.raw({0!r})` instead of `[{0!r}]` in the meantime."""
...
class Suggestion(object):
    ...
    def __getitem__(self, name):
        ...
        try:
            ...
            print(CASTING_ERROR_MESSAGE.format(name))
