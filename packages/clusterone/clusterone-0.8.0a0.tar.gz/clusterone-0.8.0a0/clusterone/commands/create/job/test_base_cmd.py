...
def test_no_project_commits(mocker):
    ...
    with pytest.raises(NoProjectCommits):
        base_cmd.base(context, { 'framework': 'tensorflow-130', 'project_path': 'mnist-demo', 'python_version': '3', 'requirements': None, 'commit': 'latest', 'name': 'old-morning-562', 'module': 'mymodule.py', 'package_manager': 'anaconda', 'package_path': '', 'description': '', 'time_limit': 2880, 'datasets': '',}, module_arguments=())
...
def test_custom_user_arguments(mocker):
    ...
    result = base_cmd.base(context, {'framework': 'tensorflow-130', 'project_path': 'mnist-demo', 'python_version': '3', 'requirements': None, 'commit': 'latest', 'name': 'old-morning-562', 'module': 'mymodule.py', 'package_manager': 'pip', 'package_path': '', 'description': '', 'time_limit': 2880, 'datasets': '',}, module_arguments=('--custom-dummy-argument0', 'dummy0', '--custom-dummy-argument1', 'dummy1'))

    assert result['parameters']['module_arguments'] == {'custom-dummy-argument0': 'dummy0', 'custom-dummy-argument1': 'dummy1'}
