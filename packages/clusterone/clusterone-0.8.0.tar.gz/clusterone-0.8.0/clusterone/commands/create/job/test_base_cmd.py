...
def test_custom_user_arguments(mocker):
    assert base_cmd.validate_module_arguments("","", ('--custom-dummy-argument0', 'dummy0', '--custom-dummy-argument1', 'dummy1')) == {'custom-dummy-argument0': 'dummy0', 'custom-dummy-argument1': 'dummy1'}

def test_custom_user_arguemnts_missing_value(mocker):
    with raises(BadParameter):
        base_cmd.validate_module_arguments("","", ('--custom-dummy-argument0', '--custom-dummy-argument1', 'dummy1'))
