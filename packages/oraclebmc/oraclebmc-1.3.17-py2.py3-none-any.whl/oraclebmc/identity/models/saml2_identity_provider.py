...
class Saml2IdentityProvider(IdentityProvider):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new Saml2IdentityProvider object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.identity.models.Saml2IdentityProvider.protocol` attribute
