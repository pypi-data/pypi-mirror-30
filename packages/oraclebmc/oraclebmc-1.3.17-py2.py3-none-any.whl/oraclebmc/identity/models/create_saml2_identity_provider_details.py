...
class CreateSaml2IdentityProviderDetails(CreateIdentityProviderDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new CreateSaml2IdentityProviderDetails object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.identity.models.CreateSaml2IdentityProviderDetails.protocol` attribute
