...
class ComputeClient(object):
    ...
    def attach_boot_volume(self, attach_boot_volume_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.core.models.BootVolumeAttachment`
    ...
    def create_instance_console_connection(self, create_instance_console_connection_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.core.models.InstanceConsoleConnection`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def list_boot_volume_attachments(self, availability_domain, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.core.models.BootVolumeAttachment`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/bootVolumeAttachments/"
        method = "GET"
    ...
    def list_instance_console_connections(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.core.models.InstanceConsoleConnection`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/instanceConsoleConnections"
        method = "GET"
