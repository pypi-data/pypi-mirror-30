...
class BlockstorageClient(object):
    ...
    def create_volume_backup_policy_assignment(self, create_volume_backup_policy_assignment_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.core.models.VolumeBackupPolicyAssignment`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def get_boot_volume(self, boot_volume_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.core.models.BootVolume`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/bootVolumes/{bootVolumeId}"
        method = "GET"
    ...
    def get_volume_backup_policy(self, policy_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.core.models.VolumeBackupPolicy`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def get_volume_backup_policy_asset_assignment(self, asset_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.core.models.VolumeBackupPolicyAssignment`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/volumeBackupPolicyAssignments"
        method = "GET"
    ...
    def list_boot_volumes(self, availability_domain, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.core.models.BootVolume`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def list_volume_backup_policies(self, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.core.models.VolumeBackupPolicy`
        :rtype: :class:`~oraclebmc.response.Response`
        """
