...
class InstanceSourceViaBootVolumeDetails(InstanceSourceDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new InstanceSourceViaBootVolumeDetails object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.InstanceSourceViaBootVolumeDetails.source_type` attribute
