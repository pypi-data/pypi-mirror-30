...
class ImageSourceViaObjectStorageUriDetails(ImageSourceDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ImageSourceViaObjectStorageUriDetails object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.ImageSourceViaObjectStorageUriDetails.source_type` attribute
