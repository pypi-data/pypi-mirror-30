...
class ImageSourceViaObjectStorageTupleDetails(ImageSourceDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ImageSourceViaObjectStorageTupleDetails object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.ImageSourceViaObjectStorageTupleDetails.source_type` attribute
