...
class VirtualNetworkClient(object):
    ...
    def create_local_peering_gateway(self, create_local_peering_gateway_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.core.models.LocalPeeringGateway`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def create_public_ip(self, create_public_ip_details, **kwargs):
        ...
        **Note:** When assigning a public IP to a private IP, the private IP must not already have
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.core.models.PublicIp`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def create_remote_peering_connection(self, create_remote_peering_connection_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.core.models.RemotePeeringConnection`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def get_fast_connect_provider_service(self, provider_service_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.core.models.FastConnectProviderService`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def list_allowed_peer_regions_for_remote_peering(self, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.core.models.PeerRegionForRemotePeering`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def list_local_peering_gateways(self, compartment_id, vcn_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.core.models.LocalPeeringGateway`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/localPeeringGateways"
        method = "GET"
    ...
    def list_public_ips(self, scope, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.core.models.PublicIp`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/publicIps"
        method = "GET"
    ...
    def list_remote_peering_connections(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.core.models.RemotePeeringConnection`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/remotePeeringConnections"
        method = "GET"
    ...
    def list_virtual_circuit_public_prefixes(self, virtual_circuit_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.core.models.VirtualCircuitPublicPrefix`
        :rtype: :class:`~oraclebmc.response.Response`
        """
