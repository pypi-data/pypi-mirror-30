...
class EmailClient(object):
    ...
    def create_sender(self, create_sender_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.email.models.Sender`
    ...
    def create_suppression(self, create_suppression_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.email.models.Suppression`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def list_senders(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.email.models.SenderSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/senders"
        method = "GET"
    ...
    def list_suppressions(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.email.models.SuppressionSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/suppressions"
        method = "GET"
