...
class FileStorageClient(object):
    ...
    def create_export(self, create_export_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.file_storage.models.Export`
    ...
    def create_file_system(self, create_file_system_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.file_storage.models.FileSystem`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def create_mount_target(self, create_mount_target_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.file_storage.models.MountTarget`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def create_snapshot(self, create_snapshot_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.file_storage.models.Snapshot`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def get_export_set(self, export_set_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.file_storage.models.ExportSet`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def list_export_sets(self, compartment_id, availability_domain, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.file_storage.models.ExportSetSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def list_exports(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.file_storage.models.ExportSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/exports"
        method = "GET"
    ...
    def list_file_systems(self, compartment_id, availability_domain, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.file_storage.models.FileSystemSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/fileSystems"
        method = "GET"
    ...
    def list_mount_targets(self, compartment_id, availability_domain, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.file_storage.models.MountTargetSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/mountTargets"
        method = "GET"
    ...
    def list_snapshots(self, file_system_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.file_storage.models.SnapshotSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/snapshots"
        method = "GET"
