...
class LoadBalancerClient(object):
    ...
    def get_backend_health(self, load_balancer_id, backend_set_name, backend_name, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.load_balancer.models.BackendHealth`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def get_backend_set_health(self, load_balancer_id, backend_set_name, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.load_balancer.models.BackendSetHealth`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def get_load_balancer_health(self, load_balancer_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.load_balancer.models.LoadBalancerHealth`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def get_path_route_set(self, load_balancer_id, path_route_set_name, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.load_balancer.models.PathRouteSet`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/loadBalancers/{loadBalancerId}/pathRouteSets/{pathRouteSetName}"
        method = "GET"
    ...
    def list_load_balancer_healths(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.load_balancer.models.LoadBalancerHealthSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def list_path_route_sets(self, load_balancer_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.load_balancer.models.PathRouteSet`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/loadBalancers/{loadBalancerId}/pathRouteSets"
        method = "GET"
