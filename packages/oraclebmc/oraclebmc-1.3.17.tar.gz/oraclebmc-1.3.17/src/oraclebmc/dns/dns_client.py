...
class DnsClient(object):
    ...
    def create_zone(self, create_zone_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.dns.models.Zone`
    ...
    def get_domain_records(self, zone_name_or_id, domain, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.dns.models.RecordCollection`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/zones/{zoneNameOrId}/records/{domain}"
        method = "GET"
    ...
    def get_rr_set(self, zone_name_or_id, domain, rtype, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.dns.models.RRSet`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/zones/{zoneNameOrId}/records/{domain}/{rtype}"
        method = "GET"
    ...
    def list_zones(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.dns.models.ZoneSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/zones"
        method = "GET"
