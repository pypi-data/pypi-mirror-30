...
class UploadManager:
    ...
    def upload_stream(self,
        ...
        :return:
            The response from multipart commit operation or the put operation.  In both cases this will be a :class:`~oraclebmc.response.Response` object with data of type None.
            For a multipart upload (non-empty stream data) the :class:`~oraclebmc.response.Response` will contain the :code:`opc-multipart-md5` header and for a non-multipart upload
    ...
    def upload_file(self,
        ...
        :return:
            The response from multipart commit operation or the put operation.  In both cases this will be a :class:`~oraclebmc.response.Response` object with data of type None.
            For a multipart upload the :class:`~oraclebmc.response.Response` will contain the :code:`opc-multipart-md5` header and for a non-multipart upload
    ...
    def resume_upload_file(self,
        ...
        :return:
            The response from the multipart commit operation. This will be a :class:`~oraclebmc.response.Response` object with data of type None
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resume_kwargs = {}
        if 'progress_callback' in kwargs:
