...
class AuditClient(object):
    ...
    def get_configuration(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.audit.models.Configuration`
    ...
    def list_events(self, compartment_id, start_time, end_time, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.audit.models.AuditEvent`
        :rtype: :class:`~oraclebmc.response.Response`
        """
