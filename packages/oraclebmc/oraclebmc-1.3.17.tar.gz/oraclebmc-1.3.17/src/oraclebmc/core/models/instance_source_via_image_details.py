...
class InstanceSourceViaImageDetails(InstanceSourceDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new InstanceSourceViaImageDetails object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.InstanceSourceViaImageDetails.source_type` attribute
