...
class VolumeSourceFromVolumeDetails(VolumeSourceDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new VolumeSourceFromVolumeDetails object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.VolumeSourceFromVolumeDetails.type` attribute
