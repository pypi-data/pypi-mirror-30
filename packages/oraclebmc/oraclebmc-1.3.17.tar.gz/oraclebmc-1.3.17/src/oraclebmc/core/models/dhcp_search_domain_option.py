...
class DhcpSearchDomainOption(DhcpOption):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DhcpSearchDomainOption object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.DhcpSearchDomainOption.type` attribute
