...
class ExportImageViaObjectStorageUriDetails(ExportImageDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ExportImageViaObjectStorageUriDetails object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.ExportImageViaObjectStorageUriDetails.destination_type` attribute
