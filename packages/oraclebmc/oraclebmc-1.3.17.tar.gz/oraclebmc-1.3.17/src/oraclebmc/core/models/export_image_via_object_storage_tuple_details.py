...
class ExportImageViaObjectStorageTupleDetails(ExportImageDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new ExportImageViaObjectStorageTupleDetails object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.ExportImageViaObjectStorageTupleDetails.destination_type` attribute
