...
class AttachIScsiVolumeDetails(AttachVolumeDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new AttachIScsiVolumeDetails object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.AttachIScsiVolumeDetails.type` attribute
