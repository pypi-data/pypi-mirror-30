...
class VolumeSourceFromVolumeBackupDetails(VolumeSourceDetails):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new VolumeSourceFromVolumeBackupDetails object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.VolumeSourceFromVolumeBackupDetails.type` attribute
