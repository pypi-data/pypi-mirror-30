...
class DhcpDnsOption(DhcpOption):
    ...
    def __init__(self, **kwargs):
        """
        Initializes a new DhcpDnsOption object with values from keyword arguments. The default value of the :py:attr:`~oraclebmc.core.models.DhcpDnsOption.type` attribute
