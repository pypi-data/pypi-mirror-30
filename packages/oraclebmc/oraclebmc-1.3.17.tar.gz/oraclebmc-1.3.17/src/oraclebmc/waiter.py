...
def wait_until(client, response, property=None, state=None, max_interval_seconds=30, max_wait_seconds=1200, succeed_on_not_found=False, **kwargs):
    ...
    :return: The final response, which will contain the property in the specified state.
        ...
        If the ``succeed_on_not_found`` parameter is set to True and the data was not then ``oraclebmc.waiter.WAIT_RESOURCE_NOT_FOUND`` will be returned. This is a :py:class:`~oraclebmc.util.Sentinel` which is not truthy and holds an internal name of ``WaitResourceNotFound``.
    """
