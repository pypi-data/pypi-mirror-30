...
class IdentityClient(object):
    ...
    def create_customer_secret_key(self, create_customer_secret_key_details, user_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.identity.models.CustomerSecretKey`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def create_dynamic_group(self, create_dynamic_group_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.identity.models.DynamicGroup`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def create_smtp_credential(self, create_smtp_credential_details, user_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.identity.models.SmtpCredential`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def create_tag(self, tag_namespace_id, create_tag_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.identity.models.Tag`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def create_tag_namespace(self, create_tag_namespace_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.identity.models.TagNamespace`
        :rtype: :class:`~oraclebmc.response.Response`
        """
    ...
    def list_customer_secret_keys(self, user_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.identity.models.CustomerSecretKeySummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/users/{userId}/customerSecretKeys/"
        method = "GET"
    ...
    def list_dynamic_groups(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.identity.models.DynamicGroup`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/dynamicGroups/"
        method = "GET"
    ...
    def list_smtp_credentials(self, user_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.identity.models.SmtpCredentialSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/users/{userId}/smtpCredentials/"
        method = "GET"
    ...
    def list_tag_namespaces(self, compartment_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.identity.models.TagNamespaceSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/tagNamespaces"
        method = "GET"
    ...
    def list_tags(self, tag_namespace_id, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type list of :class:`~oraclebmc.identity.models.TagSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/tagNamespaces/{tagNamespaceId}/tags"
        method = "GET"
    ...
    def update_customer_secret_key(self, user_id, customer_secret_key_id, update_customer_secret_key_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.identity.models.CustomerSecretKeySummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/users/{userId}/customerSecretKeys/{customerSecretKeyId}"
        method = "PUT"
    ...
    def update_smtp_credential(self, user_id, smtp_credential_id, update_smtp_credential_details, **kwargs):
        ...
        :return: A :class:`~oraclebmc.response.Response` object with data of type :class:`~oraclebmc.identity.models.SmtpCredentialSummary`
        :rtype: :class:`~oraclebmc.response.Response`
        """
        resource_path = "/users/{userId}/smtpCredentials/{smtpCredentialId}"
        method = "PUT"
