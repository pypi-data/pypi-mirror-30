...
class RetryStrategyBuilder(object):
    ...
    Trying to build a strategy when there are no enabled checks will result in a :py:class:`oraclebmc.retry.NoneRetryStrategy`
    being produced.
...
class ExponentialBackoffRetryStrategyBase(object):
    ...
    :py:class:`oraclebmc.retry.retry_checkers.BaseRetryChecker` and provide this in the checker container.
    """
