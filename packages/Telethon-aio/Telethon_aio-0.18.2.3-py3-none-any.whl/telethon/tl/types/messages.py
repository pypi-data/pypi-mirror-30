...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerPack, TypeBotInlineResult, TypeFoundGif, TypeEncryptedFile, TypeInlineBotSwitchPM, TypeChat, TypeDocument, TypeUser, TypeMessage, TypeChatFull, TypeStickerSet, TypeHighScore, TypeStickerSetCovered, TypeDialog
