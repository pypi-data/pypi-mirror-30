...
class DocumentAttributeVideo(TLObject):
    ...
    def __init__(self, duration, w, h, round_message=None, supports_streaming=None):
        ...
        :param bool | None supports_streaming:
        :param int duration:
        :param int w:
        :param int h:
    ...
    def from_reader(reader):
        ...
        _w = reader.read_int()
        _h = reader.read_int()
        return DocumentAttributeVideo(duration=_duration, w=_w, h=_h, round_message=_round_message, supports_streaming=_supports_streaming)
...
class InputMessageReplyTo(TLObject):
    ...
    def from_reader(reader):
        _id = reader.read_int()
        return InputMessageReplyTo(id=_id)
...
class WebAuthorization(TLObject):
    ...
    def from_reader(reader):
        ...
        _ip = reader.tgread_string()
        _region = reader.tgread_string()
        return WebAuthorization(hash=_hash, bot_id=_bot_id, domain=_domain, browser=_browser, platform=_platform, date_created=_date_created, date_active=_date_active, ip=_ip, region=_region)
