...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputEncryptedChat, TypeInputMessage, TypeInputEncryptedFile, TypeInputStickerSet, TypeInputSingleMedia, TypeInputDocument, TypeInputGeoPoint, TypeSendMessageAction, TypeMessagesFilter, TypeInlineBotSwitchPM, TypeInputStickeredMedia, TypeShippingOption, TypeInputBotInlineResult, TypeInputUser, TypeInputPeer, TypeMessageEntity, TypeBool, TypeInputChatPhoto, TypeInputMedia, TypeInputBotInlineMessageID, TypeReplyMarkup
