...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeAccountDaysTTL, TypeInputPrivacyRule, TypeInputPeerNotifySettings, TypeInputNotifyPeer, TypeInputPrivacyKey, TypeReportReason, TypeInputPeer
