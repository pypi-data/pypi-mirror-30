...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputNotifyPeer, TypeInputPeerNotifySettings, TypeInputPrivacyKey, TypeReportReason, TypeBool, TypeInputPeer, TypeAccountDaysTTL, TypeInputPrivacyRule
...
class RegisterDeviceRequest(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        return cls(token_type=_token_type, token=_token, app_sandbox=_app_sandbox, other_uids=_other_uids)
