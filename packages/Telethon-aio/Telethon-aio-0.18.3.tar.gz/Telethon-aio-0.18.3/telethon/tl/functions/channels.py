...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChannel, TypeChannelBannedRights, TypeChannelAdminLogEventsFilter, TypeChannelParticipantsFilter, TypeInputChatPhoto, TypeInputMessage, TypeBool, TypeInputUser, TypeChannelAdminRights, TypeInputStickerSet
