...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeInputContact, TypeTopPeerCategory, TypeInputPeer
    pass
...
class DeleteContactsRequest(TLObject):
    ...
    async def resolve(self, client, utils):
        self.id = [utils.get_input_user(await client.get_input_entity(_x)) for _x in self.id]
