...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeerNotifySettings, TypeInputPrivacyKey, TypeInputNotifyPeer, TypeBool, TypeReportReason, TypeInputPrivacyRule, TypeAccountDaysTTL, TypeInputPeer
