...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChatPhoto, TypeBool, TypeChannelParticipantsFilter, TypeInputChannel, TypeChannelAdminRights, TypeChannelAdminLogEventsFilter, TypeChannelBannedRights, TypeInputUser, TypeInputStickerSet
    pass
