...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerSet, TypeChatFull, TypeUser, TypeStickerSetCovered, TypeFoundGif, TypeStickerPack, TypeChat, TypeEncryptedFile, TypeDialog, TypeDocument, TypeInlineBotSwitchPM, TypeHighScore, TypeMessage, TypeBotInlineResult
