...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContact, TypeUser, TypeTopPeerCategoryPeers, TypeChat, TypePeer, TypeImportedContact, TypeContactBlocked, TypePopularContact, TypeContactLink
    pass
