...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContact, TypeContactLink, TypeChat, TypeUser, TypeTopPeerCategoryPeers, TypeImportedContact, TypePopularContact, TypePeer, TypeContactBlocked
