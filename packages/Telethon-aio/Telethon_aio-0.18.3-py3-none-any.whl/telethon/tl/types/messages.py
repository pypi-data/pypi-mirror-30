...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBotInlineResult, TypeFoundGif, TypeChatFull, TypeDialog, TypeMessage, TypeDocument, TypeStickerPack, TypeHighScore, TypeEncryptedFile, TypeStickerSetCovered, TypeStickerSet, TypeInlineBotSwitchPM, TypeChat, TypeUser
