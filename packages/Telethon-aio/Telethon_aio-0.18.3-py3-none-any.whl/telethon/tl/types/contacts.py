...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeImportedContact, TypeContact, TypeTopPeerCategoryPeers, TypePeer, TypeContactBlocked, TypeContactLink, TypeUser, TypeChat, TypePopularContact
