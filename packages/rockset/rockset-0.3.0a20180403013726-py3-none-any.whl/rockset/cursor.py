...
Introduction
------------
Cursor objects are return by the Collection.query_ and the View.query_ APIs.
A cursor simply binds the query to a particular collection or view and the
...
and are always instantiated by Collection or View ``query()`` APIs.
...
class Cursor(object):
    """ Fetch the results of a query executed against a collection or a view
    """
