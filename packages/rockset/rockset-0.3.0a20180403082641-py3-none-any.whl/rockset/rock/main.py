...
Commands:
  ...
  Data Definition:
       create                create a new collection or view
       describe              get detailed stats about a collection or view
       drop                  drop an existing collection or view
       ls                    list all collections and views

  Data Management:
       add                   add local files to a collection
       get                   retrieve documents from a collection or a view
       query                 run a query against a collection or a view
