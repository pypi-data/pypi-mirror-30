...
class RESTCommand(Command):
    ...
    def _url(self, url):
        return '{}/v1{}'.format(self.api_server, url)

    def _headers(self, headers):
        if headers is None:
            headers = {}
        headers.update({'authorization': 'ApiKey {}'.format(self.api_key)})
        return headers
    ...
    def _method(self, method, url, *args, **kwargs):
        ...
        try:
            ...
            raise InputError(code='-', message=str(e), type='InputError') from None
