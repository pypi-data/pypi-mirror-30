...
_DOCUMENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='collection', full_name='rockset.Document.collection', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='rockset.Document.id', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sort_key', full_name='rockset.Document.sort_key', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='rockset.Document.value', index=3,
