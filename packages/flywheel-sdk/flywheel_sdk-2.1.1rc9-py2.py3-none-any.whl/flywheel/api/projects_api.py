...
class ProjectsApi(object):
    ...
    def add_project_permission(self, project_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.add_project_permission_with_http_info(project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.add_project_permission_with_http_info(project_id, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def add_project_permission_with_http_info(self, project_id, **kwargs):  # noqa: E501
        """Add a permission
    ...
    def add_project_rule(self, project_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.add_project_rule_with_http_info(project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.add_project_rule_with_http_info(project_id, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def add_project_rule_with_http_info(self, project_id, **kwargs):  # noqa: E501
        """Create a new rule for a project.
    ...
    def download_project_analysis_inputs_by_filename(self, project_id, analysis_id, filename, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.download_project_analysis_inputs_by_filename_with_http_info(project_id, analysis_id, filename, **kwargs)  # noqa: E501
        else:
            (data) = self.download_project_analysis_inputs_by_filename_with_http_info(project_id, analysis_id, filename, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def download_project_analysis_inputs_by_filename_with_http_info(self, project_id, analysis_id, filename, **kwargs):  # noqa: E501
        """Download anaylsis inputs with filter.
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method download_project_analysis_inputs_by_filename" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `download_project_analysis_inputs_by_filename`")  # noqa: E501
        # verify the required parameter 'analysis_id' is set
        if ('analysis_id' not in params or
                params['analysis_id'] is None):
            raise ValueError("Missing the required parameter `analysis_id` when calling `download_project_analysis_inputs_by_filename`")  # noqa: E501
        # verify the required parameter 'filename' is set
        if ('filename' not in params or
                params['filename'] is None):
            raise ValueError("Missing the required parameter `filename` when calling `download_project_analysis_inputs_by_filename`")  # noqa: E501
    ...
    def download_project_analysis_outputs_by_filename(self, project_id, analysis_id, filename, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.download_project_analysis_outputs_by_filename_with_http_info(project_id, analysis_id, filename, **kwargs)  # noqa: E501
        else:
            (data) = self.download_project_analysis_outputs_by_filename_with_http_info(project_id, analysis_id, filename, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def download_project_analysis_outputs_by_filename_with_http_info(self, project_id, analysis_id, filename, **kwargs):  # noqa: E501
        """Download anaylsis outputs with filter.
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method download_project_analysis_outputs_by_filename" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `download_project_analysis_outputs_by_filename`")  # noqa: E501
        # verify the required parameter 'analysis_id' is set
        if ('analysis_id' not in params or
                params['analysis_id'] is None):
            raise ValueError("Missing the required parameter `analysis_id` when calling `download_project_analysis_outputs_by_filename`")  # noqa: E501
        # verify the required parameter 'filename' is set
        if ('filename' not in params or
                params['filename'] is None):
            raise ValueError("Missing the required parameter `filename` when calling `download_project_analysis_outputs_by_filename`")  # noqa: E501
    ...
    def modify_project_rule(self, project_id, rule_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.modify_project_rule_with_http_info(project_id, rule_id, **kwargs)  # noqa: E501
        else:
            (data) = self.modify_project_rule_with_http_info(project_id, rule_id, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def modify_project_rule_with_http_info(self, project_id, rule_id, **kwargs):  # noqa: E501
        """Update a rule on a project.
    ...
    def modify_project_user_permission(self, project_id, user_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.modify_project_user_permission_with_http_info(project_id, user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.modify_project_user_permission_with_http_info(project_id, user_id, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def modify_project_user_permission_with_http_info(self, project_id, user_id, **kwargs):  # noqa: E501
        """Update a user&#39;s permission for this project.
    ...
    def rename_project_tag(self, project_id, tag_value, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.rename_project_tag_with_http_info(project_id, tag_value, **kwargs)  # noqa: E501
        else:
            (data) = self.rename_project_tag_with_http_info(project_id, tag_value, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def rename_project_tag_with_http_info(self, project_id, tag_value, **kwargs):  # noqa: E501
        """Rename a tag.
    ...
    def set_project_template(self, project_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.set_project_template_with_http_info(project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.set_project_template_with_http_info(project_id, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def set_project_template_with_http_info(self, project_id, **kwargs):  # noqa: E501
        """Set the session template for a project.
