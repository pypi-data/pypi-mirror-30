...
class JobsApi(object):
    ...
    def prepare_compete(self, job_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.prepare_compete_with_http_info(job_id, **kwargs)  # noqa: E501
        else:
            (data) = self.prepare_compete_with_http_info(job_id, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def prepare_compete_with_http_info(self, job_id, **kwargs):  # noqa: E501
        """Create a ticket with the job id and its status.
