...
class RulesApi(object):
    ...
    def add_site_rule(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async'):
            return self.add_site_rule_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.add_site_rule_with_http_info(**kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def add_site_rule_with_http_info(self, **kwargs):  # noqa: E501
        """Create a new site rule.
    ...
    def modify_site_rule(self, rule_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.modify_site_rule_with_http_info(rule_id, **kwargs)  # noqa: E501
        else:
            (data) = self.modify_site_rule_with_http_info(rule_id, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def modify_site_rule_with_http_info(self, rule_id, **kwargs):  # noqa: E501
        """Update a site rule.
