...
class DevicesApi(object):
    ...
    def update_device(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_device_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.update_device_with_http_info(**kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def update_device_with_http_info(self, **kwargs):  # noqa: E501
        """Modify a device&#39;s interval, info or set errors.
