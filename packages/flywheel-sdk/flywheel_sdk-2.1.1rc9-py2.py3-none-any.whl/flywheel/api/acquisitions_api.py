...
class AcquisitionsApi(object):
    ...
    def download_acquisition_analysis_inputs_by_filename(self, acquisition_id, analysis_id, filename, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.download_acquisition_analysis_inputs_by_filename_with_http_info(acquisition_id, analysis_id, filename, **kwargs)  # noqa: E501
        else:
            (data) = self.download_acquisition_analysis_inputs_by_filename_with_http_info(acquisition_id, analysis_id, filename, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def download_acquisition_analysis_inputs_by_filename_with_http_info(self, acquisition_id, analysis_id, filename, **kwargs):  # noqa: E501
        """Download anaylsis inputs with filter.
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method download_acquisition_analysis_inputs_by_filename" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'acquisition_id' is set
        if ('acquisition_id' not in params or
                params['acquisition_id'] is None):
            raise ValueError("Missing the required parameter `acquisition_id` when calling `download_acquisition_analysis_inputs_by_filename`")  # noqa: E501
        # verify the required parameter 'analysis_id' is set
        if ('analysis_id' not in params or
                params['analysis_id'] is None):
            raise ValueError("Missing the required parameter `analysis_id` when calling `download_acquisition_analysis_inputs_by_filename`")  # noqa: E501
        # verify the required parameter 'filename' is set
        if ('filename' not in params or
                params['filename'] is None):
            raise ValueError("Missing the required parameter `filename` when calling `download_acquisition_analysis_inputs_by_filename`")  # noqa: E501
    ...
    def download_acquisition_analysis_outputs_by_filename(self, acquisition_id, analysis_id, filename, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.download_acquisition_analysis_outputs_by_filename_with_http_info(acquisition_id, analysis_id, filename, **kwargs)  # noqa: E501
        else:
            (data) = self.download_acquisition_analysis_outputs_by_filename_with_http_info(acquisition_id, analysis_id, filename, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def download_acquisition_analysis_outputs_by_filename_with_http_info(self, acquisition_id, analysis_id, filename, **kwargs):  # noqa: E501
        """Download anaylsis outputs with filter.
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method download_acquisition_analysis_outputs_by_filename" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'acquisition_id' is set
        if ('acquisition_id' not in params or
                params['acquisition_id'] is None):
            raise ValueError("Missing the required parameter `acquisition_id` when calling `download_acquisition_analysis_outputs_by_filename`")  # noqa: E501
        # verify the required parameter 'analysis_id' is set
        if ('analysis_id' not in params or
                params['analysis_id'] is None):
            raise ValueError("Missing the required parameter `analysis_id` when calling `download_acquisition_analysis_outputs_by_filename`")  # noqa: E501
        # verify the required parameter 'filename' is set
        if ('filename' not in params or
                params['filename'] is None):
            raise ValueError("Missing the required parameter `filename` when calling `download_acquisition_analysis_outputs_by_filename`")  # noqa: E501
    ...
    def rename_acquisition_tag(self, acquisition_id, tag_value, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.rename_acquisition_tag_with_http_info(acquisition_id, tag_value, **kwargs)  # noqa: E501
        else:
            (data) = self.rename_acquisition_tag_with_http_info(acquisition_id, tag_value, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def rename_acquisition_tag_with_http_info(self, acquisition_id, tag_value, **kwargs):  # noqa: E501
        """Rename a tag.
