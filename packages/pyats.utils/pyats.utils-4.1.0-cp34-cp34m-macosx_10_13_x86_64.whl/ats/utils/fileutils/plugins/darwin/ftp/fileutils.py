...
class FileUtils(FileUtilsLinuxBase):
    ...
    def copyfile(self, from_file_url, to_file_url,
        ...
        if upload:
            ...
            _, _, from_path = \
                self.validate_and_parse_url(from_file_url, 'copyfile')

            to_server_name, to_parsed_port, to_path = \
                self.validate_and_parse_url(to_file_url, 'copyfile')
    ...
    def dir(self, from_directory_url,
        ...
        split_url = urlsplit(from_directory_url)
        return [urlunsplit(
    ...
    def renamefile(self, from_file_url, to_file_url,
        ...
        from_server_name, from_parsed_port, from_path = \
            self.validate_and_parse_url(from_file_url, 'renamefile')
        ...
        to_server_name, to_parsed_port, to_path = \
            self.validate_and_parse_url(to_file_url, 'renamefile')
