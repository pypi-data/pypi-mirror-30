...
from isi_sdk_8_0_1.models.result_directories_total_usage import ResultDirectoriesTotalUsage  # noqa: E501
...
class TestResultDirectoriesTotalUsage(unittest.TestCase):
    ...
    def testResultDirectoriesTotalUsage(self):
        ...
        # model = isi_sdk_8_0_1.models.result_directories_total_usage.ResultDirectoriesTotalUsage()  # noqa: E501
        pass
