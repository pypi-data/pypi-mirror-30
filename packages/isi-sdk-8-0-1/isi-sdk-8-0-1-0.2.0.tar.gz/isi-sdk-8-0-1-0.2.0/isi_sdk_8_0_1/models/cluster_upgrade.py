...
class ClusterUpgrade(object):
    ...
    def __init__(self, nodes_to_rolling_upgrade=None):  # noqa: E501
    ...
    def nodes_to_rolling_upgrade(self):
        ...
        The nodes (to be) scheduled for an existing upgrade ordered by queue position number. [<lnn-1>, <lnn-2>, ... ], 'All', null  # noqa: E501
