...
from isi_sdk_8_0_1.models.quota_notification import QuotaNotification  # noqa: F401,E501
...
class QuotaNotificationExtended(object):
    ...
    def action_alert(self, action_alert):
        ...
        :type: bool
        """
        if action_alert is None:
            raise ValueError("Invalid value for `action_alert`, must not be `None`")  # noqa: E501
    ...
    def action_email_owner(self, action_email_owner):
        ...
        :type: bool
        """
        if action_email_owner is None:
            raise ValueError("Invalid value for `action_email_owner`, must not be `None`")  # noqa: E501
