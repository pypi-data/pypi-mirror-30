...
class SummaryProtocolStatsProtocolStatNetworkIn(object):
    ...
    def __init__(self, errors_per_sec=None, megabytes_per_sec=None, packets_per_sec=None):  # noqa: E501
        """SummaryProtocolStatsProtocolStatNetworkIn - a model defined in Swagger"""  # noqa: E501
    ...
    def errors_per_sec(self):
        """Gets the errors_per_sec of this SummaryProtocolStatsProtocolStatNetworkIn.  # noqa: E501

        Network input errors per-second  # noqa: E501

        :return: The errors_per_sec of this SummaryProtocolStatsProtocolStatNetworkIn.  # noqa: E501
        :rtype: float
        """
    ...
    def errors_per_sec(self, errors_per_sec):
        """Sets the errors_per_sec of this SummaryProtocolStatsProtocolStatNetworkIn.

        Network input errors per-second  # noqa: E501

        :param errors_per_sec: The errors_per_sec of this SummaryProtocolStatsProtocolStatNetworkIn.  # noqa: E501
        :type: float
        """
    ...
    def megabytes_per_sec(self):
        """Gets the megabytes_per_sec of this SummaryProtocolStatsProtocolStatNetworkIn.  # noqa: E501

        Network input megabytes per-second  # noqa: E501

        :return: The megabytes_per_sec of this SummaryProtocolStatsProtocolStatNetworkIn.  # noqa: E501
        :rtype: float
        """
    ...
    def megabytes_per_sec(self, megabytes_per_sec):
        """Sets the megabytes_per_sec of this SummaryProtocolStatsProtocolStatNetworkIn.

        Network input megabytes per-second  # noqa: E501

        :param megabytes_per_sec: The megabytes_per_sec of this SummaryProtocolStatsProtocolStatNetworkIn.  # noqa: E501
        :type: float
        """
    ...
    def packets_per_sec(self):
        """Gets the packets_per_sec of this SummaryProtocolStatsProtocolStatNetworkIn.  # noqa: E501

        Network input packets per-second  # noqa: E501

        :return: The packets_per_sec of this SummaryProtocolStatsProtocolStatNetworkIn.  # noqa: E501
        :rtype: float
        """
    ...
    def packets_per_sec(self, packets_per_sec):
        """Sets the packets_per_sec of this SummaryProtocolStatsProtocolStatNetworkIn.

        Network input packets per-second  # noqa: E501

        :param packets_per_sec: The packets_per_sec of this SummaryProtocolStatsProtocolStatNetworkIn.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SummaryProtocolStatsProtocolStatNetworkIn):
            return False
