...
class SnmpSettingsExtended(object):
    ...
    def __init__(self, read_only_community=None, service=None, snmp_v1_v2c_access=None, snmp_v3_access=None, snmp_v3_password=None, snmp_v3_read_only_user=None, system_contact=None, system_location=None):  # noqa: E501
    ...
    def snmp_v3_password(self):
        ...
        This field allows a client to change the SNMP v3 password. There is always a password set.  @DEFAULT reverts this field to its default value.  # noqa: E501
    ...
    def system_contact(self, system_contact):
        ...
        if system_contact is not None and not re.search('^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$', system_contact):  # noqa: E501
            raise ValueError("Invalid value for `system_contact`, must be a follow pattern or equal to `/^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$/`")  # noqa: E501
