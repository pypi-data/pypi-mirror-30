...
class AuthIdNtoken(object):
    ...
    def local_address(self):
        ...
        Specifies the IP address of the node that is serving the request.  # noqa: E501
    ...
    def protocol(self):
        ...
        Specifies the protocol that is responsible for the creation of the token. The integer values for each protcol are as follows: NFS (1), SMB (2), NLM (3), FTP (4), HTTP (5), ISCSI (7), SMB2 (8), NFS4 (9), OneFS API (10), HDFS (15), console (16), and SSH (17).  # noqa: E501
    ...
    def remote_address(self):
        ...
        Specifies the IP address of the client requesting information.  # noqa: E501
    ...
    def zid(self):
        ...
        Specifies the zone ID of the access zone that is serving the request.  # noqa: E501
    ...
    def zone_id(self):
        ...
        Specifies the name of the access zone that is serving the request.  # noqa: E501
