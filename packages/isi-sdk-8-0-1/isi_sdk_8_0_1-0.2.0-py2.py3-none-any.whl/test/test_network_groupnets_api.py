...
from isi_sdk_8_0_1.api.network_groupnets_api import NetworkGroupnetsApi  # noqa: E501
...
class TestNetworkGroupnetsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = isi_sdk_8_0_1.api.network_groupnets_api.NetworkGroupnetsApi()  # noqa: E501
