...
class X0Reactor:
    ...
    def plot_activation_energy(self,time_intervals,gas):
        ...
        plt.plot(temperature_fit,ion_current_fit, label=str(round(activation_energy,2)) + ' kcal/(K $\cdot$ mol)')
        plt.legend()
