...
class X0Reactor:
    ...
    def calculate_activation_energy(self,time_intervals,gas,method='steps',boltzmann_constant = 0.0083144621):
        ...
        activation_energy, error, linear_fit = X0Functions.calculate_activation_energy(temperature=temperature, reaction_rate=ion_current, boltzmann_constant=boltzmann_constant)
