...
def new_object(request, form, operation, template_name, redirect_success):
    ...
    object_form = form(request.POST or None, request.FILES or None, prefix='object')
...
def update_object(request, pk, object_model, form, operation, template_name, redirect_success):
    ...
    object_form = form(request.POST or None, request.FILES or None, instance=object_instance)
