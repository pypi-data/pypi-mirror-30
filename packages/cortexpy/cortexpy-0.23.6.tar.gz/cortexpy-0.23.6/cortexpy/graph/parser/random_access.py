...
class RandomAccess(Mapping):
    ...
    binary_search_kmer_cache_size = attr.ib(None)
    ...
    def __attrs_post_init__(self):
        ...
        if self.binary_search_kmer_cache_size is None:
            self.binary_search_kmer_cache_size = self.kmer_cache_size
        self.graph_sequence = KmerRecordSequence(graph_handle=self.graph_handle,
                                                 body_start=body_start_stream_position,
                                                 header=self._header,
                                                 n_records=self.n_records,
                                                 kmer_cache_size=self.binary_search_kmer_cache_size)
