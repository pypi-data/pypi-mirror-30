...
class OrmUniquenessError(OrmException):
    """ Raises when trying to insert into the database an object which
    conflicts with already existing one by one or several unique keys
