...
def list_files(name=None, directory=None, file_type=None, source=None, **kwargs):
    ...
    headers = {'api-key': api_key, 'accept': 'application/json'}
    params = {'tagId': kwargs.get('tag_id', None), 'dir': directory, 'name': name, 'type': file_type, 'source': source, 'isUploaded': kwargs.get('is_uploaded', None), 'sort': kwargs.get('sort', None), 'limit': kwargs.get('limit', 100)}
    file_list = []
