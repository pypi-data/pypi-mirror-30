...
class Ui(QMainWindow, main_window):
    ...
    def __init__(self):
        ...
        # export_etabs_window.__init__(self)
        self.setupUi(self)
    ...
    def export_to_etabs(self):
        ...
        #     kx, ky = self.final_building.kx, self.final_building.ky
        #     ex_drift, kx_drift = self.final_building.results_drift[1], self.final_building.kx_drift
        #     ey_drift, ky_drift = self.final_building.results_drift[2], self.final_building.ky_drift
        #     etabs = export.ExportToEtabs(self, self.lastDirectory, "applications/cfactor/db/ETABS2015-STATIC-A0.3-RHO1.e2k", ex, kx, ey, ky, ex_drift, kx_drift, ey_drift, ky_drift)
        #     etabs.to_e2k()
