...
class show_system_uptime(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__days','__hours','__minutes','__seconds',)
...
and 'minutes'.
  ...
  _pyangbind_elements = {'days': days, 'hours': hours, 'minutes': minutes, 'seconds': seconds, }
