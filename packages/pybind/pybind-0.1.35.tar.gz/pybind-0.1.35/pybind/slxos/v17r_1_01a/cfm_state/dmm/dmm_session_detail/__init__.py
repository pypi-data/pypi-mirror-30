...
class dmm_session_detail(PybindBase):
  ...
  def _get_type(self):
    """
    Getter method for type, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/type (boolean)
  ...
  def _set_type(self, v, load=False):
    """
    Setter method for type, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/type (boolean)
  ...
  def _get_status(self):
    """
    Getter method for status, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/status (boolean)
  ...
  def _set_status(self, v, load=False):
    """
    Setter method for status, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/status (boolean)
    If this variable is read-only (config: false) in the
