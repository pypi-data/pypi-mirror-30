...
class mep(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__mep_id','__mep_direction','__mep_mac','__mep_port','__port_state','__mep_vlan','__mep_inner_vlan','__rmep_fail','__rmep_ok','__rmep',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__mep_vlan = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="mep-vlan", rest_name="mep-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint32', is_config=False)
    ...
    self.__mep_inner_vlan = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="mep-inner-vlan", rest_name="mep-inner-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint32', is_config=False)
  ...
  def _get_mep_vlan(self):
    """
    Getter method for mep_vlan, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/mep/mep_vlan (uint32)

    YANG Description: MEP VLAN Id
    """
    return self.__mep_vlan
      
  def _set_mep_vlan(self, v, load=False):
    """
    Setter method for mep_vlan, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/mep/mep_vlan (uint32)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mep_vlan is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_mep_vlan() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="mep-vlan", rest_name="mep-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """mep_vlan must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="mep-vlan", rest_name="mep-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint32', is_config=False)""",
        })
  ...
  def _unset_mep_vlan(self):
    self.__mep_vlan = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="mep-vlan", rest_name="mep-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint32', is_config=False)


  def _get_mep_inner_vlan(self):
    """
    Getter method for mep_inner_vlan, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/mep/mep_inner_vlan (uint32)

    YANG Description: MEP Inner VLAN Id
    """
    return self.__mep_inner_vlan
      
  def _set_mep_inner_vlan(self, v, load=False):
    """
    Setter method for mep_inner_vlan, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/mep/mep_inner_vlan (uint32)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mep_inner_vlan is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_mep_inner_vlan() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="mep-inner-vlan", rest_name="mep-inner-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """mep_inner_vlan must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="mep-inner-vlan", rest_name="mep-inner-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint32', is_config=False)""",
        })

    self.__mep_inner_vlan = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_mep_inner_vlan(self):
    self.__mep_inner_vlan = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="mep-inner-vlan", rest_name="mep-inner-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint32', is_config=False)
  ...
  mep_vlan = __builtin__.property(_get_mep_vlan)
  mep_inner_vlan = __builtin__.property(_get_mep_inner_vlan)
  ...
  _pyangbind_elements = {'mep_id': mep_id, 'mep_direction': mep_direction, 'mep_mac': mep_mac, 'mep_port': mep_port, 'port_state': port_state, 'mep_vlan': mep_vlan, 'mep_inner_vlan': mep_inner_vlan, 'rmep_fail': rmep_fail, 'rmep_ok': rmep_ok, 'rmep': rmep, }
