...
class ma(PybindBase):
  ...
  def _get_maid_format(self):
    """
    Getter method for maid_format, mapped from YANG variable /cfm_state/cfm_detail/domain/ma/maid_format (uint8)
  ...
  def _set_maid_format(self, v, load=False):
    """
    Setter method for maid_format, mapped from YANG variable /cfm_state/cfm_detail/domain/ma/maid_format (uint8)
    If this variable is read-only (config: false) in the
