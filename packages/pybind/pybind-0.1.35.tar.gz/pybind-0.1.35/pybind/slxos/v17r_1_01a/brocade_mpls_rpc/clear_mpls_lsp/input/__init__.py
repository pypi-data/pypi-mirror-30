...
class input(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__mpls_clear_lsp_name_in',)
  ...
  def _get_mpls_clear_lsp_name_in(self):
    """
    Getter method for mpls_clear_lsp_name_in, mapped from YANG variable /brocade_mpls_rpc/clear_mpls_lsp/input/mpls_clear_lsp_name_in (string)

    YANG Description: Clear LSP(both primary and secondary) lsp-name
    """
    return self.__mpls_clear_lsp_name_in
      
  def _set_mpls_clear_lsp_name_in(self, v, load=False):
    """
    Setter method for mpls_clear_lsp_name_in, mapped from YANG variable /brocade_mpls_rpc/clear_mpls_lsp/input/mpls_clear_lsp_name_in (string)
  ...
  _pyangbind_elements = {'mpls_clear_lsp_name_in': mpls_clear_lsp_name_in, }
