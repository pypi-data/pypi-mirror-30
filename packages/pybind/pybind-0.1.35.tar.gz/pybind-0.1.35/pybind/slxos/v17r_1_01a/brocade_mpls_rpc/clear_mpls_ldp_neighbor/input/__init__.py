...
class input(PybindBase):
  ...
  def _get_mpls_clear_all_ldp_sessions(self):
    """
    Getter method for mpls_clear_all_ldp_sessions, mapped from YANG variable /brocade_mpls_rpc/clear_mpls_ldp_neighbor/input/mpls_clear_all_ldp_sessions (boolean)
  ...
  def _set_mpls_clear_all_ldp_sessions(self, v, load=False):
    """
    Setter method for mpls_clear_all_ldp_sessions, mapped from YANG variable /brocade_mpls_rpc/clear_mpls_ldp_neighbor/input/mpls_clear_all_ldp_sessions (boolean)
    ...
    try:
      ...
      raise ValueError({
          'error-string': """mpls_clear_all_ldp_sessions must be of a type compatible with boolean""",
