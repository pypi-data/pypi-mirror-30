...
class system_monitor(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__fan','__power','__temp','__cid_card','__compact_flash','__MM','__LineCard','__SFM','__port','__tm',)
  ...
  def _get_port(self):
    """
    Getter method for port, mapped from YANG variable /system_monitor/port (container)
    """
    return self.__port
      
  def _set_port(self, v, load=False):
    """
    Setter method for port, mapped from YANG variable /system_monitor/port (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_tm(self):
    """
    Getter method for tm, mapped from YANG variable /system_monitor/tm (container)
    """
    return self.__tm
  ...
  tm = __builtin__.property(_get_tm, _set_tm)


  _pyangbind_elements = {'fan': fan, 'power': power, 'temp': temp, 'cid_card': cid_card, 'compact_flash': compact_flash, 'MM': MM, 'LineCard': LineCard, 'SFM': SFM, 'port': port, 'tm': tm, }
