...
setup. Site is identified by a name.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__tunnel_dst','__static','__extend','__mac_learning','__bfd_enable','__bfd','__shutdown',)
...
tunnels are admin enabled.
  ...
  _pyangbind_elements = {'name': name, 'tunnel_dst': tunnel_dst, 'static': static, 'extend': extend, 'mac_learning': mac_learning, 'bfd_enable': bfd_enable, 'bfd': bfd, 'shutdown': shutdown, }
