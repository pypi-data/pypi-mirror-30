...
class adj_neighbor(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__adj_mtprot = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'adj-prot-ip': {'value': 2}, u'adj-prot-ip6': {'value': 8}, u'adj-prot-ipv4-ip6': {'value': 10}},), is_leaf=True, yang_name="adj-mtprot", rest_name="adj-mtprot", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-isis-operational', defining_module='brocade-isis-operational', yang_type='isis-adj-prot-type', is_config=False)
    ...
    self.__adj_prot = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'adj-prot-ip': {'value': 2}, u'adj-prot-ip6': {'value': 8}, u'adj-prot-ipv4-ip6': {'value': 10}},), is_leaf=True, yang_name="adj-prot", rest_name="adj-prot", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-isis-operational', defining_module='brocade-isis-operational', yang_type='isis-adj-prot-type', is_config=False)
  ...
  def _set_adj_mtprot(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'adj-prot-ip': {'value': 2}, u'adj-prot-ip6': {'value': 8}, u'adj-prot-ipv4-ip6': {'value': 10}},), is_leaf=True, yang_name="adj-mtprot", rest_name="adj-mtprot", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-isis-operational', defining_module='brocade-isis-operational', yang_type='isis-adj-prot-type', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'adj-prot-ip': {'value': 2}, u'adj-prot-ip6': {'value': 8}, u'adj-prot-ipv4-ip6': {'value': 10}},), is_leaf=True, yang_name="adj-mtprot", rest_name="adj-mtprot", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-isis-operational', defining_module='brocade-isis-operational', yang_type='isis-adj-prot-type', is_config=False)""",
        })
