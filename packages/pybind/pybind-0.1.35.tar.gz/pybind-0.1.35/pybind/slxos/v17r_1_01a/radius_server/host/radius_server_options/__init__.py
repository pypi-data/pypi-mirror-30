...
class radius_server_options(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__auth_port','__protocol','__key','__encryption_level','__retries','__timeout','__source_interface',)
  ...
  def _get_source_interface(self):
    """
    Getter method for source_interface, mapped from YANG variable /radius_server/host/radius_server_options/source_interface (container)
    """
    return self.__source_interface
      
  def _set_source_interface(self, v, load=False):
    """
    Setter method for source_interface, mapped from YANG variable /radius_server/host/radius_server_options/source_interface (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'auth_port': auth_port, 'protocol': protocol, 'key': key, 'encryption_level': encryption_level, 'retries': retries, 'timeout': timeout, 'source_interface': source_interface, }
