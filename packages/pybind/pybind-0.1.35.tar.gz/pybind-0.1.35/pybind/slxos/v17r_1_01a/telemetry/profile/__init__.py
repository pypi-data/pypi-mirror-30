...
class profile(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__system_utilization','__interface',)
  ...
  _pyangbind_elements = {'system_utilization': system_utilization, 'interface': interface, }
