...
class main_interface_pseudo_wire(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__logical_interface_pseudo_wire = YANGDynClass(base=YANGListType("logical_interface_name",logical_interface_pseudo_wire.logical_interface_pseudo_wire, yang_name="logical-interface-pseudo-wire", rest_name="logical-interface-pseudo-wire", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='logical-interface-name', extensions={u'tailf-common': {u'callpoint': u'nsm-logical-interface-pseudo-wire', u'cli-suppress-show-path': None}}), is_container='list', yang_name="logical-interface-pseudo-wire", rest_name="logical-interface-pseudo-wire", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-logical-interface-pseudo-wire', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
