...
import __builtin__
import https
class https_sa(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-hidden-cli - based on the path /https-sa. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__https',)
  ...
  def _get_https(self):
    """
    Getter method for https, mapped from YANG variable /https_sa/https (container)
    """
    return self.__https
      
  def _set_https(self, v, load=False):
    """
    Setter method for https, mapped from YANG variable /https_sa/https (container)
  ...
  _pyangbind_elements = {'https': https, }
