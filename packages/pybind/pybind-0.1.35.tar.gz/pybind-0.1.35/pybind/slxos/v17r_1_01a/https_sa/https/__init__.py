...
class https(PybindBase):
  ...
  from YANG module brocade-hidden-cli - based on the path /https-sa/https. Each member element of
  ...
  def _get_server(self):
    """
    Getter method for server, mapped from YANG variable /https_sa/https/server (container)
    """
    return self.__server
      
  def _set_server(self, v, load=False):
    """
    Setter method for server, mapped from YANG variable /https_sa/https/server (container)
