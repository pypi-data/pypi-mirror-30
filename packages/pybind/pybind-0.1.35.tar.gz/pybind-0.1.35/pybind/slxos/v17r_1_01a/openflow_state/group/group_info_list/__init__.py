...
class group_info_list(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__group_id','__transaction_id','__group_type','__packet_count','__byte_count','__flow_count','__num_of_bkts','__mcast_group_id','__replication_type','__group_bucket_list',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__byte_count = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="byte-count", rest_name="byte-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='uint64', is_config=False)
    self.__replication_type = YANGDynClass(base=unicode, is_leaf=True, yang_name="replication-type", rest_name="replication-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='string', is_config=False)
    self.__packet_count = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="packet-count", rest_name="packet-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='uint64', is_config=False)
  ...
  def _get_packet_count(self):
    """
    Getter method for packet_count, mapped from YANG variable /openflow_state/group/group_info_list/packet_count (uint64)
  ...
  def _set_packet_count(self, v, load=False):
    """
    Setter method for packet_count, mapped from YANG variable /openflow_state/group/group_info_list/packet_count (uint64)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="packet-count", rest_name="packet-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='uint64', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """packet_count must be of a type compatible with uint64""",
          'defined-type': "uint64",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="packet-count", rest_name="packet-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='uint64', is_config=False)""",
        })
  ...
  def _get_byte_count(self):
    """
    Getter method for byte_count, mapped from YANG variable /openflow_state/group/group_info_list/byte_count (uint64)
  ...
  def _set_byte_count(self, v, load=False):
    """
    Setter method for byte_count, mapped from YANG variable /openflow_state/group/group_info_list/byte_count (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_mcast_group_id(self):
    """
    Getter method for mcast_group_id, mapped from YANG variable /openflow_state/group/group_info_list/mcast_group_id (uint32)

    YANG Description: Multicast group id
    """
    return self.__mcast_group_id
      
  def _set_mcast_group_id(self, v, load=False):
    """
    Setter method for mcast_group_id, mapped from YANG variable /openflow_state/group/group_info_list/mcast_group_id (uint32)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mcast_group_id is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_mcast_group_id() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="mcast-group-id", rest_name="mcast-group-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """mcast_group_id must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="mcast-group-id", rest_name="mcast-group-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='uint32', is_config=False)""",
        })

    self.__mcast_group_id = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_mcast_group_id(self):
    self.__mcast_group_id = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="mcast-group-id", rest_name="mcast-group-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='uint32', is_config=False)


  def _get_replication_type(self):
    """
    Getter method for replication_type, mapped from YANG variable /openflow_state/group/group_info_list/replication_type (string)

    YANG Description: Multicast Replication Method
    """
    return self.__replication_type
      
  def _set_replication_type(self, v, load=False):
    """
    Setter method for replication_type, mapped from YANG variable /openflow_state/group/group_info_list/replication_type (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_replication_type is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_replication_type() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="replication-type", rest_name="replication-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='string', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """replication_type must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="replication-type", rest_name="replication-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='string', is_config=False)""",
        })

    self.__replication_type = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_replication_type(self):
    self.__replication_type = YANGDynClass(base=unicode, is_leaf=True, yang_name="replication-type", rest_name="replication-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='string', is_config=False)
  ...
  mcast_group_id = __builtin__.property(_get_mcast_group_id)
  replication_type = __builtin__.property(_get_replication_type)
  group_bucket_list = __builtin__.property(_get_group_bucket_list)


  _pyangbind_elements = {'group_id': group_id, 'transaction_id': transaction_id, 'group_type': group_type, 'packet_count': packet_count, 'byte_count': byte_count, 'flow_count': flow_count, 'num_of_bkts': num_of_bkts, 'mcast_group_id': mcast_group_id, 'replication_type': replication_type, 'group_bucket_list': group_bucket_list, }
