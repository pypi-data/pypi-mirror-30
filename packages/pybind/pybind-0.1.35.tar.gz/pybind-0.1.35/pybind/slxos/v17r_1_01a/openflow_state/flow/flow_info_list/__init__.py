...
class flow_info_list(PybindBase):
  ...
  def _get_source_ipv6(self):
    """
    Getter method for source_ipv6, mapped from YANG variable /openflow_state/flow/flow_info_list/source_ipv6 (string)
  ...
  def _set_source_ipv6(self, v, load=False):
    """
    Setter method for source_ipv6, mapped from YANG variable /openflow_state/flow/flow_info_list/source_ipv6 (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_destination_ipv6(self):
    """
    Getter method for destination_ipv6, mapped from YANG variable /openflow_state/flow/flow_info_list/destination_ipv6 (string)
  ...
  def _set_destination_ipv6(self, v, load=False):
    """
    Setter method for destination_ipv6, mapped from YANG variable /openflow_state/flow/flow_info_list/destination_ipv6 (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_total_packets(self):
    """
    Getter method for total_packets, mapped from YANG variable /openflow_state/flow/flow_info_list/total_packets (uint64)
  ...
  def _set_total_packets(self, v, load=False):
    """
    Setter method for total_packets, mapped from YANG variable /openflow_state/flow/flow_info_list/total_packets (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_total_bytes(self):
    """
    Getter method for total_bytes, mapped from YANG variable /openflow_state/flow/flow_info_list/total_bytes (uint64)
  ...
  def _set_total_bytes(self, v, load=False):
    """
    Setter method for total_bytes, mapped from YANG variable /openflow_state/flow/flow_info_list/total_bytes (uint64)
    If this variable is read-only (config: false) in the
