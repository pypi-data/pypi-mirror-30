...
class meterband_info_list(PybindBase):
  ...
  def _get_in_packet_band_count(self):
    """
    Getter method for in_packet_band_count, mapped from YANG variable /openflow_state/meter/meter_info_list/meterband_info_list/in_packet_band_count (uint64)
  ...
  def _set_in_packet_band_count(self, v, load=False):
    """
    Setter method for in_packet_band_count, mapped from YANG variable /openflow_state/meter/meter_info_list/meterband_info_list/in_packet_band_count (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_in_byte_band_count(self):
    """
    Getter method for in_byte_band_count, mapped from YANG variable /openflow_state/meter/meter_info_list/meterband_info_list/in_byte_band_count (uint64)
  ...
  def _set_in_byte_band_count(self, v, load=False):
    """
    Setter method for in_byte_band_count, mapped from YANG variable /openflow_state/meter/meter_info_list/meterband_info_list/in_byte_band_count (uint64)
    If this variable is read-only (config: false) in the
