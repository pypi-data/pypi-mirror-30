...
class rsvp(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__refresh_interval','__refresh_multiple','__g_refresh_reduction','__g_reliable_messaging','__global_rsvp_hello','__global_rsvp_hello_acknowledgements','__global_rsvp_hello_unprioritize','__g_rsvp_backup_bw_guarantee','__delay_resv_send',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__delay_resv_send = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="delay-resv-send", rest_name="delay-resv-send", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Delay sending RESV for backup to come up before protected session', u'cli-full-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='empty', is_config=True)
  ...
  def _get_delay_resv_send(self):
    """
    Getter method for delay_resv_send, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/rsvp/delay_resv_send (empty)
    """
    return self.__delay_resv_send
      
  def _set_delay_resv_send(self, v, load=False):
    """
    Setter method for delay_resv_send, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/rsvp/delay_resv_send (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_delay_resv_send is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_delay_resv_send() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="delay-resv-send", rest_name="delay-resv-send", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Delay sending RESV for backup to come up before protected session', u'cli-full-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='empty', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """delay_resv_send must be of a type compatible with empty""",
          'defined-type': "empty",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="delay-resv-send", rest_name="delay-resv-send", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Delay sending RESV for backup to come up before protected session', u'cli-full-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='empty', is_config=True)""",
        })

    self.__delay_resv_send = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_delay_resv_send(self):
    self.__delay_resv_send = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="delay-resv-send", rest_name="delay-resv-send", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Delay sending RESV for backup to come up before protected session', u'cli-full-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mpls', defining_module='brocade-mpls', yang_type='empty', is_config=True)
  ...
  delay_resv_send = __builtin__.property(_get_delay_resv_send, _set_delay_resv_send)


  _pyangbind_elements = {'refresh_interval': refresh_interval, 'refresh_multiple': refresh_multiple, 'g_refresh_reduction': g_refresh_reduction, 'g_reliable_messaging': g_reliable_messaging, 'global_rsvp_hello': global_rsvp_hello, 'global_rsvp_hello_acknowledgements': global_rsvp_hello_acknowledgements, 'global_rsvp_hello_unprioritize': global_rsvp_hello_unprioritize, 'g_rsvp_backup_bw_guarantee': g_rsvp_backup_bw_guarantee, 'delay_resv_send': delay_resv_send, }
