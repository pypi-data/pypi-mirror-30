...
class lsp_auto_bandwidth(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__lsp_autobw_template','__adjustment_interval','__adjustment_threshold','__min_bandwidth','__max_bandwidth','__overflow_limit','__underflow_limit','__mode','__sample_recording',)
  ...
  def _get_adjustment_threshold(self):
    """
    Getter method for adjustment_threshold, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/lsp/lsp_auto_bandwidth/adjustment_threshold (container)
    """
    return self.__adjustment_threshold
      
  def _set_adjustment_threshold(self, v, load=False):
    """
    Setter method for adjustment_threshold, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/lsp/lsp_auto_bandwidth/adjustment_threshold (container)
    If this variable is read-only (config: false) in the
