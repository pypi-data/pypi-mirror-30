...
class adjustment_threshold(PybindBase):
  ...
  from YANG module brocade-mpls - based on the path /mpls-config/router/mpls/mpls-cmds-holder/lsp/secondary-path/lsp-secpath-auto-bandwidth/adjustment-threshold. Each member element of
  ...
  def _get_threshold_percentage(self):
    """
    Getter method for threshold_percentage, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/lsp/secondary_path/lsp_secpath_auto_bandwidth/adjustment_threshold/threshold_percentage (uint32)
    """
    return self.__threshold_percentage
      
  def _set_threshold_percentage(self, v, load=False):
    """
    Setter method for threshold_percentage, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/lsp/secondary_path/lsp_secpath_auto_bandwidth/adjustment_threshold/threshold_percentage (uint32)
  ...
  def _get_use_threshold_table(self):
    """
    Getter method for use_threshold_table, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/lsp/secondary_path/lsp_secpath_auto_bandwidth/adjustment_threshold/use_threshold_table (empty)
    """
    return self.__use_threshold_table
      
  def _set_use_threshold_table(self, v, load=False):
    """
    Setter method for use_threshold_table, mapped from YANG variable /mpls_config/router/mpls/mpls_cmds_holder/lsp/secondary_path/lsp_secpath_auto_bandwidth/adjustment_threshold/use_threshold_table (empty)
    If this variable is read-only (config: false) in the
