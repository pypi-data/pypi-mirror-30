...
class bridge_domain(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__bridge_domain_id','__bridge_domain_type','__vc_id_num','__description','__peer','__statistics','__logical_interface','__pw_profile_name','__bpdu_drop_enable','__local_switching','__mac_address',)
  ...
  _pyangbind_elements = {'bridge_domain_id': bridge_domain_id, 'bridge_domain_type': bridge_domain_type, 'vc_id_num': vc_id_num, 'description': description, 'peer': peer, 'statistics': statistics, 'logical_interface': logical_interface, 'pw_profile_name': pw_profile_name, 'bpdu_drop_enable': bpdu_drop_enable, 'local_switching': local_switching, 'mac_address': mac_address, }
