...
class instances(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__auto_bandwidth = YANGDynClass(base=auto_bandwidth.auto_bandwidth, is_container='container', presence=False, yang_name="auto-bandwidth", rest_name="auto-bandwidth", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mpls-auto-bandwidth-config-auto-bandwidth-1'}}, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='container', is_config=False)
    self.__lsp_hops = YANGDynClass(base=YANGListType("hop_index hop_address",lsp_hops.lsp_hops, yang_name="lsp-hops", rest_name="lsp-hops", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='hop-index hop-address', extensions={u'tailf-common': {u'callpoint': u'mpls-lsp-hop', u'cli-suppress-show-path': None}}), is_container='list', yang_name="lsp-hops", rest_name="lsp-hops", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mpls-lsp-hop', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)
    ...
    self.__current_signaled_mean_rate = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="current-signaled-mean-rate", rest_name="current-signaled-mean-rate", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='uint32', is_config=False)
    ...
    self.__config_frr_bandwidth_inherited = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="config-frr-bandwidth-inherited", rest_name="config-frr-bandwidth-inherited", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='boolean', is_config=False)
    ...
    self.__config_exclude_interfaces = YANGDynClass(base=TypedListType(allowed_type=unicode), is_leaf=False, yang_name="config-exclude-interfaces", rest_name="config-exclude-interfaces", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='string', is_config=False)
  ...
  def _get_config_frr_bandwidth_inherited(self):
    """
    Getter method for config_frr_bandwidth_inherited, mapped from YANG variable /mpls_state/lsp/instances/config_frr_bandwidth_inherited (boolean)

    YANG Description: Frr bandwidth inherited
    """
    return self.__config_frr_bandwidth_inherited
      
  def _set_config_frr_bandwidth_inherited(self, v, load=False):
    """
    Setter method for config_frr_bandwidth_inherited, mapped from YANG variable /mpls_state/lsp/instances/config_frr_bandwidth_inherited (boolean)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_config_frr_bandwidth_inherited is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_config_frr_bandwidth_inherited() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """config_frr_bandwidth_inherited must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="config-frr-bandwidth-inherited", rest_name="config-frr-bandwidth-inherited", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='boolean', is_config=False)""",
        })

    self.__config_frr_bandwidth_inherited = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_config_frr_bandwidth_inherited(self):
    self.__config_frr_bandwidth_inherited = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="config-frr-bandwidth-inherited", rest_name="config-frr-bandwidth-inherited", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='boolean', is_config=False)
  ...
  def _get_current_signaled_mean_rate(self):
    """
    Getter method for current_signaled_mean_rate, mapped from YANG variable /mpls_state/lsp/instances/current_signaled_mean_rate (uint32)

    YANG Description: current_signaled_mean_rate
    """
    return self.__current_signaled_mean_rate
      
  def _set_current_signaled_mean_rate(self, v, load=False):
    """
    Setter method for current_signaled_mean_rate, mapped from YANG variable /mpls_state/lsp/instances/current_signaled_mean_rate (uint32)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_current_signaled_mean_rate is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_current_signaled_mean_rate() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="current-signaled-mean-rate", rest_name="current-signaled-mean-rate", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """current_signaled_mean_rate must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="current-signaled-mean-rate", rest_name="current-signaled-mean-rate", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='uint32', is_config=False)""",
        })

    self.__current_signaled_mean_rate = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_current_signaled_mean_rate(self):
    self.__current_signaled_mean_rate = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="current-signaled-mean-rate", rest_name="current-signaled-mean-rate", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='uint32', is_config=False)


  def _get_config_exclude_interfaces(self):
    """
    Getter method for config_exclude_interfaces, mapped from YANG variable /mpls_state/lsp/instances/config_exclude_interfaces (string)

    YANG Description: lsp_config_exclude_interface
    """
    return self.__config_exclude_interfaces
      
  def _set_config_exclude_interfaces(self, v, load=False):
    """
    Setter method for config_exclude_interfaces, mapped from YANG variable /mpls_state/lsp/instances/config_exclude_interfaces (string)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """config_exclude_interfaces must be of a type compatible with string""",
          'defined-type': "string",
  ...
  def _get_lsp_hops(self):
    """
    Getter method for lsp_hops, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops (list)

    YANG Description: MPLS LSP hop info
    """
    return self.__lsp_hops
      
  def _set_lsp_hops(self, v, load=False):
    """
    Setter method for lsp_hops, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_lsp_hops is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_lsp_hops() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """lsp_hops must be of a type compatible with list""",
          'defined-type': "list",
  ...
  def _unset_lsp_hops(self):
    self.__lsp_hops = YANGDynClass(base=YANGListType("hop_index hop_address",lsp_hops.lsp_hops, yang_name="lsp-hops", rest_name="lsp-hops", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='hop-index hop-address', extensions={u'tailf-common': {u'callpoint': u'mpls-lsp-hop', u'cli-suppress-show-path': None}}), is_container='list', yang_name="lsp-hops", rest_name="lsp-hops", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mpls-lsp-hop', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=False)


  def _get_auto_bandwidth(self):
    """
    Getter method for auto_bandwidth, mapped from YANG variable /mpls_state/lsp/instances/auto_bandwidth (container)
    """
    return self.__auto_bandwidth
      
  def _set_auto_bandwidth(self, v, load=False):
    """
    Setter method for auto_bandwidth, mapped from YANG variable /mpls_state/lsp/instances/auto_bandwidth (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_admin_group_lists(self):
    """
    Getter method for admin_group_lists, mapped from YANG variable /mpls_state/lsp/instances/admin_group_lists (list)
    """
    return self.__admin_group_lists
      
  def _set_admin_group_lists(self, v, load=False):
    """
    Setter method for admin_group_lists, mapped from YANG variable /mpls_state/lsp/instances/admin_group_lists (list)
    If this variable is read-only (config: false) in the
  ...
  config_frr_bandwidth_inherited = __builtin__.property(_get_config_frr_bandwidth_inherited)
