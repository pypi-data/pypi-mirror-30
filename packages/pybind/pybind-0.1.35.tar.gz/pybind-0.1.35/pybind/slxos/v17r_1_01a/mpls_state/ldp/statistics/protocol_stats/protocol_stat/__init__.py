...
class protocol_stat(PybindBase):
  ...
  from YANG module brocade-mpls-operational - based on the path /mpls-state/ldp/statistics/protocol-stats/protocol-stat. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mpls-state', u'ldp', u'statistics', u'protocol-stats', u'protocol-stat']
  ...
  def _get_stat_type(self):
    """
    Getter method for stat_type, mapped from YANG variable /mpls_state/ldp/statistics/protocol_stats/protocol_stat/stat_type (uint32)
  ...
  def _set_stat_type(self, v, load=False):
    """
    Setter method for stat_type, mapped from YANG variable /mpls_state/ldp/statistics/protocol_stats/protocol_stat/stat_type (uint32)
  ...
  def _get_rx_count(self):
    """
    Getter method for rx_count, mapped from YANG variable /mpls_state/ldp/statistics/protocol_stats/protocol_stat/rx_count (uint32)
  ...
  def _set_rx_count(self, v, load=False):
    """
    Setter method for rx_count, mapped from YANG variable /mpls_state/ldp/statistics/protocol_stats/protocol_stat/rx_count (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_tx_count(self):
    """
    Getter method for tx_count, mapped from YANG variable /mpls_state/ldp/statistics/protocol_stats/protocol_stat/tx_count (uint32)
  ...
  def _set_tx_count(self, v, load=False):
    """
    Setter method for tx_count, mapped from YANG variable /mpls_state/ldp/statistics/protocol_stats/protocol_stat/tx_count (uint32)
    If this variable is read-only (config: false) in the
