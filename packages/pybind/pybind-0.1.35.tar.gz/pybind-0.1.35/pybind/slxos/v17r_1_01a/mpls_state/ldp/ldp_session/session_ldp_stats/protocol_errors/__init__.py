...
class protocol_errors(PybindBase):
  ...
  from YANG module brocade-mpls-operational - based on the path /mpls-state/ldp/ldp-session/session-ldp-stats/protocol-errors. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mpls-state', u'ldp', u'ldp-session', u'session-ldp-stats', u'protocol-errors']
  ...
  def _get_stats_group(self):
    """
    Getter method for stats_group, mapped from YANG variable /mpls_state/ldp/ldp_session/session_ldp_stats/protocol_errors/stats_group (mpls-ldp-stats-error-group)
  ...
  def _get_protocol_error(self):
    """
    Getter method for protocol_error, mapped from YANG variable /mpls_state/ldp/ldp_session/session_ldp_stats/protocol_errors/protocol_error (list)
  ...
  def _set_protocol_error(self, v, load=False):
    """
    Setter method for protocol_error, mapped from YANG variable /mpls_state/ldp/ldp_session/session_ldp_stats/protocol_errors/protocol_error (list)
    If this variable is read-only (config: false) in the
