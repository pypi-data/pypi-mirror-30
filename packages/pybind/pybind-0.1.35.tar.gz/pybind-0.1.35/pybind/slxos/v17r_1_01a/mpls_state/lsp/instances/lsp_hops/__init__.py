...
import __builtin__
class lsp_hops(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mpls-operational - based on the path /mpls-state/lsp/instances/lsp-hops. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: MPLS LSP hop info
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__hop_index','__hop_address','__lsp_hop_type','__is_strict_hop','__hop_is_router_id','__protection','__node_protection','__bandwidth_protection','__protection_in_use',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__is_strict_hop = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="is-strict-hop", rest_name="is-strict-hop", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='boolean', is_config=False)
    ...
    self.__lsp_hop_type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'lsp-hop-type-cspf-exclude-hops': {'value': 2}, u'lsp-hop-type-cspf-path-hops': {'value': 1}, u'lsp-hop-type-rsvp-rro-hops': {'value': 3}},), is_leaf=True, yang_name="lsp-hop-type", rest_name="lsp-hop-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='lsp-hop-type', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mpls-state', u'lsp', u'instances', u'lsp-hops']
  ...
  def _get_hop_index(self):
    """
    Getter method for hop_index, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/hop_index (uint32)
  ...
  def _set_hop_index(self, v, load=False):
    """
    Setter method for hop_index, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/hop_index (uint32)
  ...
  def _get_hop_address(self):
    """
    Getter method for hop_address, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/hop_address (inet:ipv4-address)
  ...
  def _set_hop_address(self, v, load=False):
    """
    Setter method for hop_address, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/hop_address (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_lsp_hop_type(self):
    """
    Getter method for lsp_hop_type, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/lsp_hop_type (lsp-hop-type)

    YANG Description: If the hop is CSPF path hops, CSPF exclude hops or RSVP session RRO hops
    """
    return self.__lsp_hop_type
      
  def _set_lsp_hop_type(self, v, load=False):
    """
    Setter method for lsp_hop_type, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/lsp_hop_type (lsp-hop-type)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_lsp_hop_type is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_lsp_hop_type() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'lsp-hop-type-cspf-exclude-hops': {'value': 2}, u'lsp-hop-type-cspf-path-hops': {'value': 1}, u'lsp-hop-type-rsvp-rro-hops': {'value': 3}},), is_leaf=True, yang_name="lsp-hop-type", rest_name="lsp-hop-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='lsp-hop-type', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """lsp_hop_type must be of a type compatible with lsp-hop-type""",
          'defined-type': "brocade-mpls-operational:lsp-hop-type",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'lsp-hop-type-cspf-exclude-hops': {'value': 2}, u'lsp-hop-type-cspf-path-hops': {'value': 1}, u'lsp-hop-type-rsvp-rro-hops': {'value': 3}},), is_leaf=True, yang_name="lsp-hop-type", rest_name="lsp-hop-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='lsp-hop-type', is_config=False)""",
        })

    self.__lsp_hop_type = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_lsp_hop_type(self):
    self.__lsp_hop_type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'lsp-hop-type-cspf-exclude-hops': {'value': 2}, u'lsp-hop-type-cspf-path-hops': {'value': 1}, u'lsp-hop-type-rsvp-rro-hops': {'value': 3}},), is_leaf=True, yang_name="lsp-hop-type", rest_name="lsp-hop-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='lsp-hop-type', is_config=False)


  def _get_is_strict_hop(self):
    """
    Getter method for is_strict_hop, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/is_strict_hop (boolean)

    YANG Description: True if this a strict hop. False if it's a loose hop
    """
    return self.__is_strict_hop
      
  def _set_is_strict_hop(self, v, load=False):
    """
    Setter method for is_strict_hop, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/is_strict_hop (boolean)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_is_strict_hop is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_is_strict_hop() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="is-strict-hop", rest_name="is-strict-hop", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='boolean', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """is_strict_hop must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="is-strict-hop", rest_name="is-strict-hop", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='boolean', is_config=False)""",
        })

    self.__is_strict_hop = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_is_strict_hop(self):
    self.__is_strict_hop = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="is-strict-hop", rest_name="is-strict-hop", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='boolean', is_config=False)


  def _get_hop_is_router_id(self):
    """
    Getter method for hop_is_router_id, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/hop_is_router_id (boolean)
  ...
  def _set_hop_is_router_id(self, v, load=False):
    """
    Setter method for hop_is_router_id, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/hop_is_router_id (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_protection(self):
    """
    Getter method for protection, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/protection (boolean)
  ...
  def _set_protection(self, v, load=False):
    """
    Setter method for protection, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/protection (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_node_protection(self):
    """
    Getter method for node_protection, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/node_protection (boolean)
  ...
  def _set_node_protection(self, v, load=False):
    """
    Setter method for node_protection, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/node_protection (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_bandwidth_protection(self):
    """
    Getter method for bandwidth_protection, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/bandwidth_protection (boolean)
  ...
  def _set_bandwidth_protection(self, v, load=False):
    """
    Setter method for bandwidth_protection, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/bandwidth_protection (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_protection_in_use(self):
    """
    Getter method for protection_in_use, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/protection_in_use (boolean)
  ...
  def _set_protection_in_use(self, v, load=False):
    """
    Setter method for protection_in_use, mapped from YANG variable /mpls_state/lsp/instances/lsp_hops/protection_in_use (boolean)
    If this variable is read-only (config: false) in the
  ...
  lsp_hop_type = __builtin__.property(_get_lsp_hop_type)
  is_strict_hop = __builtin__.property(_get_is_strict_hop)
  ...
  _pyangbind_elements = {'hop_index': hop_index, 'hop_address': hop_address, 'lsp_hop_type': lsp_hop_type, 'is_strict_hop': is_strict_hop, 'hop_is_router_id': hop_is_router_id, 'protection': protection, 'node_protection': node_protection, 'bandwidth_protection': bandwidth_protection, 'protection_in_use': protection_in_use, }
