...
class show_cluster_mem_vlan(PybindBase):
  ...
  def _get_vlan_label_info(self):
    """
    Getter method for vlan_label_info, mapped from YANG variable /mctd_client_state_state/show_cluster_mem_vlan/vlan_label_info (list)
  ...
  def _set_vlan_label_info(self, v, load=False):
    """
    Setter method for vlan_label_info, mapped from YANG variable /mctd_client_state_state/show_cluster_mem_vlan/vlan_label_info (list)
    If this variable is read-only (config: false) in the
