...
class pim(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/pim-intf-phy-cont/pim-int-cmd/pim. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'pim-intf-phy-cont', u'pim-int-cmd', u'pim']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'ip', u'pim']

  def _get_neighbor_filter(self):
    """
    Getter method for neighbor_filter, mapped from YANG variable /interface/ethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim/neighbor_filter (ip-prefix-name-t)
    """
    return self.__neighbor_filter
      
  def _set_neighbor_filter(self, v, load=False):
    """
    Setter method for neighbor_filter, mapped from YANG variable /interface/ethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim/neighbor_filter (ip-prefix-name-t)
  ...
  def _get_dr_priority(self):
    """
    Getter method for dr_priority, mapped from YANG variable /interface/ethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim/dr_priority (uint32)
    """
    return self.__dr_priority
      
  def _set_dr_priority(self, v, load=False):
    """
    Setter method for dr_priority, mapped from YANG variable /interface/ethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim/dr_priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_ttl_threshold(self):
    """
    Getter method for ttl_threshold, mapped from YANG variable /interface/ethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim/ttl_threshold (uint32)
    """
    return self.__ttl_threshold
      
  def _set_ttl_threshold(self, v, load=False):
    """
    Setter method for ttl_threshold, mapped from YANG variable /interface/ethernet/ip/pim_intf_phy_cont/pim_int_cmd/pim/ttl_threshold (uint32)
    If this variable is read-only (config: false) in the
