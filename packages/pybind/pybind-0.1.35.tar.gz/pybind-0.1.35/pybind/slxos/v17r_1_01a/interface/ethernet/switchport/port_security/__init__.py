...
class port_security(PybindBase):
  ...
  def _get_port_security_mac_address(self):
    """
    Getter method for port_security_mac_address, mapped from YANG variable /interface/ethernet/switchport/port_security/port_security_mac_address (list)
  ...
  def _set_port_security_mac_address(self, v, load=False):
    """
    Setter method for port_security_mac_address, mapped from YANG variable /interface/ethernet/switchport/port_security/port_security_mac_address (list)
    If this variable is read-only (config: false) in the
