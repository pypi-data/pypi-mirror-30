...
class inspection(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/arp/inspection. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__trust','__filter',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'arp', u'inspection']
  ...
  def _get_trust(self):
    """
    Getter method for trust, mapped from YANG variable /interface/port_channel/ip/arp/inspection/trust (empty)
    """
    return self.__trust
      
  def _set_trust(self, v, load=False):
    """
    Setter method for trust, mapped from YANG variable /interface/port_channel/ip/arp/inspection/trust (empty)
  ...
  def _get_filter(self):
    """
    Getter method for filter, mapped from YANG variable /interface/port_channel/ip/arp/inspection/filter (container)
    """
    return self.__filter
      
  def _set_filter(self, v, load=False):
    """
    Setter method for filter, mapped from YANG variable /interface/port_channel/ip/arp/inspection/filter (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'trust': trust, 'filter': filter, }
