...
class edge_loop_detection(PybindBase):
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'loop-detection']
  ...
  def _get_eldshutdown_disable(self):
    """
    Getter method for eldshutdown_disable, mapped from YANG variable /interface/port_channel/edge_loop_detection/eldshutdown_disable (empty)
    """
    return self.__eldshutdown_disable
      
  def _set_eldshutdown_disable(self, v, load=False):
    """
    Setter method for eldshutdown_disable, mapped from YANG variable /interface/port_channel/edge_loop_detection/eldshutdown_disable (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_eldvlan(self):
    """
    Getter method for eldvlan, mapped from YANG variable /interface/port_channel/edge_loop_detection/eldvlan (ui32-vlan-range)
  ...
  def _set_eldvlan(self, v, load=False):
    """
    Setter method for eldvlan, mapped from YANG variable /interface/port_channel/edge_loop_detection/eldvlan (ui32-vlan-range)
    If this variable is read-only (config: false) in the
