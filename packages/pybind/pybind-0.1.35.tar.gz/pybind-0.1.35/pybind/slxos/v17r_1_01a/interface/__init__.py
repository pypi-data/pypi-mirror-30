...
grouped under this container.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ethernet','__port_channel','__management','__tunnel',)
...
device. Each row represents a management interface.
  ...
  _pyangbind_elements = {'ethernet': ethernet, 'port_channel': port_channel, 'management': management, 'tunnel': tunnel, }
