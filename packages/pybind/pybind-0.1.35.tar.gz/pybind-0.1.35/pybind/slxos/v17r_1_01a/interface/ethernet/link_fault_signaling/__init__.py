...
class link_fault_signaling(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/link-fault-signaling. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'link-fault-signaling']
  ...
  def _get_rx(self):
    """
    Getter method for rx, mapped from YANG variable /interface/ethernet/link_fault_signaling/rx (enumeration)
    """
    return self.__rx
      
  def _set_rx(self, v, load=False):
    """
    Setter method for rx, mapped from YANG variable /interface/ethernet/link_fault_signaling/rx (enumeration)
  ...
  def _get_tx(self):
    """
    Getter method for tx, mapped from YANG variable /interface/ethernet/link_fault_signaling/tx (enumeration)
    """
    return self.__tx
      
  def _set_tx(self, v, load=False):
    """
    Setter method for tx, mapped from YANG variable /interface/ethernet/link_fault_signaling/tx (enumeration)
    If this variable is read-only (config: false) in the
