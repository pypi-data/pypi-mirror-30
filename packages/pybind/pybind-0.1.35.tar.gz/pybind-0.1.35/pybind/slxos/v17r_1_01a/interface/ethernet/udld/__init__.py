...
class udld(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/udld. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'udld']
  ...
  def _get_udld_enable(self):
    """
    Getter method for udld_enable, mapped from YANG variable /interface/ethernet/udld/udld_enable (empty)
...
be enabled explicitly.
  ...
  def _set_udld_enable(self, v, load=False):
    """
    Setter method for udld_enable, mapped from YANG variable /interface/ethernet/udld/udld_enable (empty)
