...
class logical_interface(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/logical-interface. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__port_channel',)
  ...
  def _get_port_channel(self):
    """
    Getter method for port_channel, mapped from YANG variable /interface/port_channel/logical_interface/port_channel (list)
    """
    return self.__port_channel
      
  def _set_port_channel(self, v, load=False):
    """
    Setter method for port_channel, mapped from YANG variable /interface/port_channel/logical_interface/port_channel (list)
  ...
  _pyangbind_elements = {'port_channel': port_channel, }
