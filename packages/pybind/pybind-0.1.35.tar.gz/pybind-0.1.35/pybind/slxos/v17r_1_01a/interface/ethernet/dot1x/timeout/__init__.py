...
class timeout(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/dot1x/timeout. Each member element of
...
configuration elements.
  ...
  def _get_re_authperiod(self):
    """
    Getter method for re_authperiod, mapped from YANG variable /interface/ethernet/dot1x/timeout/re_authperiod (dot1x-reauth-timeout-interval)
...
between re-authentication attempts.
  ...
  def _set_re_authperiod(self, v, load=False):
    """
    Setter method for re_authperiod, mapped from YANG variable /interface/ethernet/dot1x/timeout/re_authperiod (dot1x-reauth-timeout-interval)
...
server.
  ...
  def _get_supp_timeout(self):
    """
    Getter method for supp_timeout, mapped from YANG variable /interface/ethernet/dot1x/timeout/supp_timeout (dot1x-supp-timeout-interval)
...
to client.
  ...
  def _set_supp_timeout(self, v, load=False):
    """
    Setter method for supp_timeout, mapped from YANG variable /interface/ethernet/dot1x/timeout/supp_timeout (dot1x-supp-timeout-interval)
    If this variable is read-only (config: false) in the
...
to client.
  ...
  def _get_tx_period(self):
    """
    Getter method for tx_period, mapped from YANG variable /interface/ethernet/dot1x/timeout/tx_period (dot1x-tx-timeout-interval)
...
retransmitting the request.
  ...
  def _set_tx_period(self, v, load=False):
    """
    Setter method for tx_period, mapped from YANG variable /interface/ethernet/dot1x/timeout/tx_period (dot1x-tx-timeout-interval)
    If this variable is read-only (config: false) in the
