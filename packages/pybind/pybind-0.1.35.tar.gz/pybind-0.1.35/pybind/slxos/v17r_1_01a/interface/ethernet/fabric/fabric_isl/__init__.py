...
class fabric_isl(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/fabric/fabric-isl. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'fabric', u'fabric-isl']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'fabric', u'isl']

  def _get_fabric_isl_enable(self):
    """
    Getter method for fabric_isl_enable, mapped from YANG variable /interface/ethernet/fabric/fabric_isl/fabric_isl_enable (empty)
  ...
  def _set_fabric_isl_enable(self, v, load=False):
    """
    Setter method for fabric_isl_enable, mapped from YANG variable /interface/ethernet/fabric/fabric_isl/fabric_isl_enable (empty)
