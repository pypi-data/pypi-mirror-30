...
class port_security(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__port_sec_max','__port_sec_violation','__port_security_mac_address','__sticky','__shutdown_time',)
  ...
  def _get_port_security_mac_address(self):
    """
    Getter method for port_security_mac_address, mapped from YANG variable /interface/port_channel/switchport/port_security/port_security_mac_address (list)
  ...
  def _set_port_security_mac_address(self, v, load=False):
    """
    Setter method for port_security_mac_address, mapped from YANG variable /interface/port_channel/switchport/port_security/port_security_mac_address (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'port_sec_max': port_sec_max, 'port_sec_violation': port_sec_violation, 'port_security_mac_address': port_security_mac_address, 'sticky': sticky, 'shutdown_time': shutdown_time, }
