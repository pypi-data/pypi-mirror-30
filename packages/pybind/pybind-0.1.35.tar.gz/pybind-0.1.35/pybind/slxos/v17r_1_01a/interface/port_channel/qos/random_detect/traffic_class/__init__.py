...
class traffic_class(PybindBase):
  ...
  def _get_red_dp_value(self):
    """
    Getter method for red_dp_value, mapped from YANG variable /interface/port_channel/qos/random_detect/traffic_class/red_dp_value (drop-precedence-id-type)
  ...
  def _set_red_dp_value(self, v, load=False):
    """
    Setter method for red_dp_value, mapped from YANG variable /interface/port_channel/qos/random_detect/traffic_class/red_dp_value (drop-precedence-id-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_red_profile_id(self):
    """
    Getter method for red_profile_id, mapped from YANG variable /interface/port_channel/qos/random_detect/traffic_class/red_profile_id (red-profile-id-type)
  ...
  def _set_red_profile_id(self, v, load=False):
    """
    Setter method for red_profile_id, mapped from YANG variable /interface/port_channel/qos/random_detect/traffic_class/red_profile_id (red-profile-id-type)
    If this variable is read-only (config: false) in the
