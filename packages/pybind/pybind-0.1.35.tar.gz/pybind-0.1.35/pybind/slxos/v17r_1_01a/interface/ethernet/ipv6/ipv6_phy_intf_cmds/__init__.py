...
import __builtin__
class ipv6_phy_intf_cmds(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/ethernet/ipv6/ipv6-phy-intf-cmds. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__hop_by_hop_trap',)

  _yang_name = 'ipv6-phy-intf-cmds'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ipv6', u'ipv6-phy-intf-cmds']
  ...
  def _get_hop_by_hop_trap(self):
    """
    Getter method for hop_by_hop_trap, mapped from YANG variable /interface/ethernet/ipv6/ipv6_phy_intf_cmds/hop_by_hop_trap (empty)
    """
    return self.__hop_by_hop_trap
      
  def _set_hop_by_hop_trap(self, v, load=False):
    """
    Setter method for hop_by_hop_trap, mapped from YANG variable /interface/ethernet/ipv6/ipv6_phy_intf_cmds/hop_by_hop_trap (empty)
