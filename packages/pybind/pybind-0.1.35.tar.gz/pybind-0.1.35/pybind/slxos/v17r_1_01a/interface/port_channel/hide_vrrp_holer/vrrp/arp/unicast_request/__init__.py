...
class unicast_request(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/hide-vrrp-holer/vrrp/arp/unicast-request. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'hide-vrrp-holer', u'vrrp', u'arp', u'unicast-request']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'vrrp-group', u'arp', u'unicast-request']

  def _get_receive(self):
    """
    Getter method for receive, mapped from YANG variable /interface/port_channel/hide_vrrp_holer/vrrp/arp/unicast_request/receive (empty)
  ...
  def _set_receive(self, v, load=False):
    """
    Setter method for receive, mapped from YANG variable /interface/port_channel/hide_vrrp_holer/vrrp/arp/unicast_request/receive (empty)
