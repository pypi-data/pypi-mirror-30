...
import __builtin__
class lacp_pdu_forward(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/port-channel/lacp-pdu-forward. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__enable',)

  _yang_name = 'lacp-pdu-forward'
  _rest_name = 'lacp-pdu-forward'
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__enable = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="enable", rest_name="enable", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Enable LACP PDU Forward', u'cli-full-command': None, u'cli-full-no': None}}, namespace='urn:brocade.com:mgmt:brocade-lacp-pdu-forward', defining_module='brocade-lacp-pdu-forward', yang_type='empty', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'lacp-pdu-forward']
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /interface/port_channel/lacp_pdu_forward/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /interface/port_channel/lacp_pdu_forward/enable (empty)
