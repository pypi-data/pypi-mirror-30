...
class lacp_pdu_forward(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/lacp-pdu-forward. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'lacp-pdu-forward']
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /interface/ethernet/lacp_pdu_forward/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /interface/ethernet/lacp_pdu_forward/enable (empty)
