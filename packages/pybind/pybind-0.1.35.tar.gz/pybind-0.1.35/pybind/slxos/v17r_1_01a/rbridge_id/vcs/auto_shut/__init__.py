...
import __builtin__
class auto_shut(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/vcs/auto-shut. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__lag',)

  _yang_name = 'auto-shut'
  _rest_name = 'auto-shut'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vcs', u'auto-shut']
  ...
  def _get_lag(self):
    """
    Getter method for lag, mapped from YANG variable /rbridge_id/vcs/auto_shut/lag (empty)
    """
    return self.__lag
      
  def _set_lag(self, v, load=False):
    """
    Setter method for lag, mapped from YANG variable /rbridge_id/vcs/auto_shut/lag (empty)
