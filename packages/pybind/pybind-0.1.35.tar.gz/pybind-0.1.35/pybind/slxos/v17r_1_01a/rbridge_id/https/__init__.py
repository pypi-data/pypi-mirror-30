...
import __builtin__
import server
class https(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/https. Each member element of
  ...
  def _get_server(self):
    """
    Getter method for server, mapped from YANG variable /rbridge_id/https/server (container)
    """
    return self.__server
      
  def _set_server(self, v, load=False):
    """
    Setter method for server, mapped from YANG variable /rbridge_id/https/server (container)
