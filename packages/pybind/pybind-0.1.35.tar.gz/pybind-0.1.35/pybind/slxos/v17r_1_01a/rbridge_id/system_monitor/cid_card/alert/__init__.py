...
class alert(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/system-monitor/cid-card/alert. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'system-monitor', u'cid-card', u'alert']
  ...
  def _get_state(self):
    """
    Getter method for state, mapped from YANG variable /rbridge_id/system_monitor/cid_card/alert/state (supported-state)
    """
    return self.__state
      
  def _set_state(self, v, load=False):
    """
    Setter method for state, mapped from YANG variable /rbridge_id/system_monitor/cid_card/alert/state (supported-state)
  ...
  def _get_action(self):
    """
    Getter method for action, mapped from YANG variable /rbridge_id/system_monitor/cid_card/alert/action (supported-actions)
    """
    return self.__action
      
  def _set_action(self, v, load=False):
    """
    Setter method for action, mapped from YANG variable /rbridge_id/system_monitor/cid_card/alert/action (supported-actions)
    If this variable is read-only (config: false) in the
