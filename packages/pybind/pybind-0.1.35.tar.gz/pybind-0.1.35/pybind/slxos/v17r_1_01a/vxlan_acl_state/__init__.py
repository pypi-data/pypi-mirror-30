...
class vxlan_acl_state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ssm-operational - based on the path /vxlan-acl-state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description:  Vxlan ACL information
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__extended_data',)

  _yang_name = 'vxlan-acl-state'
  _rest_name = 'vxlan-acl-state'
  ...
  def _get_extended_data(self):
    """
    Getter method for extended_data, mapped from YANG variable /vxlan_acl_state/extended_data (list)
  ...
  def _set_extended_data(self, v, load=False):
    """
    Setter method for extended_data, mapped from YANG variable /vxlan_acl_state/extended_data (list)
  ...
  _pyangbind_elements = {'extended_data': extended_data, }
