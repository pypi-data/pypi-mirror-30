...
class extended_data(PybindBase):
  ...
  from YANG module brocade-ssm-operational - based on the path /vxlan-acl-state/extended-data. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Extended ACL
  """
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__seq_num = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="seq-num", rest_name="seq-num", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='uint32', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vxlan-acl-state', u'extended-data']
  ...
  def _get_acl_name(self):
    """
    Getter method for acl_name, mapped from YANG variable /vxlan_acl_state/extended_data/acl_name (string)
  ...
  def _set_acl_name(self, v, load=False):
    """
    Setter method for acl_name, mapped from YANG variable /vxlan_acl_state/extended_data/acl_name (string)
  ...
  def _get_seq_num(self):
    """
    Getter method for seq_num, mapped from YANG variable /vxlan_acl_state/extended_data/seq_num (uint32)
  ...
  def _set_seq_num(self, v, load=False):
    """
    Setter method for seq_num, mapped from YANG variable /vxlan_acl_state/extended_data/seq_num (uint32)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="seq-num", rest_name="seq-num", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """seq_num must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="seq-num", rest_name="seq-num", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='uint32', is_config=False)""",
        })
  ...
  def _get_permit_deny(self):
    """
    Getter method for permit_deny, mapped from YANG variable /vxlan_acl_state/extended_data/permit_deny (string)
  ...
  def _set_permit_deny(self, v, load=False):
    """
    Setter method for permit_deny, mapped from YANG variable /vxlan_acl_state/extended_data/permit_deny (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_dst_vtep_ip(self):
    """
    Getter method for dst_vtep_ip, mapped from YANG variable /vxlan_acl_state/extended_data/dst_vtep_ip (inet:ipv4-address)
  ...
  def _set_dst_vtep_ip(self, v, load=False):
    """
    Setter method for dst_vtep_ip, mapped from YANG variable /vxlan_acl_state/extended_data/dst_vtep_ip (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_src_vtep_ip(self):
    """
    Getter method for src_vtep_ip, mapped from YANG variable /vxlan_acl_state/extended_data/src_vtep_ip (inet:ipv4-address)
  ...
  def _set_src_vtep_ip(self, v, load=False):
    """
    Setter method for src_vtep_ip, mapped from YANG variable /vxlan_acl_state/extended_data/src_vtep_ip (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_vni(self):
    """
    Getter method for vni, mapped from YANG variable /vxlan_acl_state/extended_data/vni (string)
  ...
  def _set_vni(self, v, load=False):
    """
    Setter method for vni, mapped from YANG variable /vxlan_acl_state/extended_data/vni (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_vni_mask(self):
    """
    Getter method for vni_mask, mapped from YANG variable /vxlan_acl_state/extended_data/vni_mask (string)
  ...
  def _set_vni_mask(self, v, load=False):
    """
    Setter method for vni_mask, mapped from YANG variable /vxlan_acl_state/extended_data/vni_mask (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_native_tag(self):
    """
    Getter method for native_tag, mapped from YANG variable /vxlan_acl_state/extended_data/native_tag (string)
  ...
  def _set_native_tag(self, v, load=False):
    """
    Setter method for native_tag, mapped from YANG variable /vxlan_acl_state/extended_data/native_tag (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_dst_ip(self):
    """
    Getter method for dst_ip, mapped from YANG variable /vxlan_acl_state/extended_data/dst_ip (inet:ipv4-address)
  ...
  def _set_dst_ip(self, v, load=False):
    """
    Setter method for dst_ip, mapped from YANG variable /vxlan_acl_state/extended_data/dst_ip (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_dst_ip_mask(self):
    """
    Getter method for dst_ip_mask, mapped from YANG variable /vxlan_acl_state/extended_data/dst_ip_mask (uint16)
  ...
  def _set_dst_ip_mask(self, v, load=False):
    """
    Setter method for dst_ip_mask, mapped from YANG variable /vxlan_acl_state/extended_data/dst_ip_mask (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_src_ip(self):
    """
    Getter method for src_ip, mapped from YANG variable /vxlan_acl_state/extended_data/src_ip (inet:ipv4-address)
  ...
  def _set_src_ip(self, v, load=False):
    """
    Setter method for src_ip, mapped from YANG variable /vxlan_acl_state/extended_data/src_ip (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_src_ip_mask(self):
    """
    Getter method for src_ip_mask, mapped from YANG variable /vxlan_acl_state/extended_data/src_ip_mask (uint16)
  ...
  def _set_src_ip_mask(self, v, load=False):
    """
    Setter method for src_ip_mask, mapped from YANG variable /vxlan_acl_state/extended_data/src_ip_mask (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_dst_port(self):
    """
    Getter method for dst_port, mapped from YANG variable /vxlan_acl_state/extended_data/dst_port (uint16)
  ...
  def _set_dst_port(self, v, load=False):
    """
    Setter method for dst_port, mapped from YANG variable /vxlan_acl_state/extended_data/dst_port (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_src_port(self):
    """
    Getter method for src_port, mapped from YANG variable /vxlan_acl_state/extended_data/src_port (uint16)
  ...
  def _set_src_port(self, v, load=False):
    """
    Setter method for src_port, mapped from YANG variable /vxlan_acl_state/extended_data/src_port (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_count(self):
    """
    Getter method for count, mapped from YANG variable /vxlan_acl_state/extended_data/count (uint64)
  ...
  def _set_count(self, v, load=False):
    """
    Setter method for count, mapped from YANG variable /vxlan_acl_state/extended_data/count (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_byte_count(self):
    """
    Getter method for byte_count, mapped from YANG variable /vxlan_acl_state/extended_data/byte_count (uint64)
  ...
  def _set_byte_count(self, v, load=False):
    """
    Setter method for byte_count, mapped from YANG variable /vxlan_acl_state/extended_data/byte_count (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_transit_name(self):
    """
    Getter method for transit_name, mapped from YANG variable /vxlan_acl_state/extended_data/transit_name (string)
  ...
  def _set_transit_name(self, v, load=False):
    """
    Setter method for transit_name, mapped from YANG variable /vxlan_acl_state/extended_data/transit_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_sflow(self):
    """
    Getter method for sflow, mapped from YANG variable /vxlan_acl_state/extended_data/sflow (boolean)
  ...
  def _set_sflow(self, v, load=False):
    """
    Setter method for sflow, mapped from YANG variable /vxlan_acl_state/extended_data/sflow (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_redir_interface(self):
    """
    Getter method for redir_interface, mapped from YANG variable /vxlan_acl_state/extended_data/redir_interface (string)
  ...
  def _set_redir_interface(self, v, load=False):
    """
    Setter method for redir_interface, mapped from YANG variable /vxlan_acl_state/extended_data/redir_interface (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_mirror_interface(self):
    """
    Getter method for mirror_interface, mapped from YANG variable /vxlan_acl_state/extended_data/mirror_interface (string)
  ...
  def _set_mirror_interface(self, v, load=False):
    """
    Setter method for mirror_interface, mapped from YANG variable /vxlan_acl_state/extended_data/mirror_interface (string)
    If this variable is read-only (config: false) in the
