...
class export(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ipv6/unicast/export. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv6', u'unicast', u'export']
  ...
  def _get_map_export(self):
    """
    Getter method for map_export, mapped from YANG variable /vrf/address_family/ipv6/unicast/export/map_export (route-map-type)
    """
    return self.__map_export
      
  def _set_map_export(self, v, load=False):
    """
    Setter method for map_export, mapped from YANG variable /vrf/address_family/ipv6/unicast/export/map_export (route-map-type)
