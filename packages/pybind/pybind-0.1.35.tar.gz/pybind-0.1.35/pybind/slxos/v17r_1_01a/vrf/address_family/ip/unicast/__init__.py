...
class unicast(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__max_route','__route_target','__import_','__export','__bgp','__arp_entry','__ip',)
  ...
  def _set_route_target(self, v, load=False):
    """
    Setter method for route_target, mapped from YANG variable /vrf/address_family/ip/unicast/route_target (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'max_route': max_route, 'route_target': route_target, 'import_': import_, 'export': export, 'bgp': bgp, 'arp_entry': arp_entry, 'ip': ip, }
