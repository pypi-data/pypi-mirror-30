...
class import_(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ip/unicast/import. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__map_import',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ip', u'unicast', u'import']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv4', u'unicast', u'import']

  def _get_map_import(self):
    """
    Getter method for map_import, mapped from YANG variable /vrf/address_family/ip/unicast/import/map_import (route-map-type)
    """
    return self.__map_import
      
  def _set_map_import(self, v, load=False):
    """
    Setter method for map_import, mapped from YANG variable /vrf/address_family/ip/unicast/import/map_import (route-map-type)
  ...
  _pyangbind_elements = {'map_import': map_import, }
