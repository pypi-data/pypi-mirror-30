...
class bgp(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ip/unicast/bgp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ip', u'unicast', u'bgp']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv4', u'unicast', u'bgp']

  def _get_next_hop(self):
    """
    Getter method for next_hop, mapped from YANG variable /vrf/address_family/ip/unicast/bgp/next_hop (container)
    """
    return self.__next_hop
      
  def _set_next_hop(self, v, load=False):
    """
    Setter method for next_hop, mapped from YANG variable /vrf/address_family/ip/unicast/bgp/next_hop (container)
