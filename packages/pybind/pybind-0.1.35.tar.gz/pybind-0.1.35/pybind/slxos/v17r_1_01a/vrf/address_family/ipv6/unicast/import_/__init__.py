...
class import_(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ipv6/unicast/import. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv6', u'unicast', u'import']
  ...
  def _get_map_import(self):
    """
    Getter method for map_import, mapped from YANG variable /vrf/address_family/ipv6/unicast/import/map_import (route-map-type)
    """
    return self.__map_import
      
  def _set_map_import(self, v, load=False):
    """
    Setter method for map_import, mapped from YANG variable /vrf/address_family/ipv6/unicast/import/map_import (route-map-type)
