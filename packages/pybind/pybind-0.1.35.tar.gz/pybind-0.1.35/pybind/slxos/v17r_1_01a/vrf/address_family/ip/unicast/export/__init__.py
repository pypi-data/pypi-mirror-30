...
class export(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ip/unicast/export. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__map_export',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ip', u'unicast', u'export']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv4', u'unicast', u'export']

  def _get_map_export(self):
    """
    Getter method for map_export, mapped from YANG variable /vrf/address_family/ip/unicast/export/map_export (route-map-type)
    """
    return self.__map_export
      
  def _set_map_export(self, v, load=False):
    """
    Setter method for map_export, mapped from YANG variable /vrf/address_family/ip/unicast/export/map_export (route-map-type)
  ...
  _pyangbind_elements = {'map_export': map_export, }
