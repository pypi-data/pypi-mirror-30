...
class bgp(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ipv6/unicast/bgp. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__next_hop = YANGDynClass(base=next_hop.next_hop, is_container='container', presence=False, yang_name="next-hop", rest_name="next-hop", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv6', u'unicast', u'bgp']
  ...
  def _get_next_hop(self):
    """
    Getter method for next_hop, mapped from YANG variable /vrf/address_family/ipv6/unicast/bgp/next_hop (container)
    """
    return self.__next_hop
      
  def _set_next_hop(self, v, load=False):
    """
    Setter method for next_hop, mapped from YANG variable /vrf/address_family/ipv6/unicast/bgp/next_hop (container)
