...
import __builtin__
import memory_per_process
class mem_list(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-RAS-operational - based on the path /mem-state/mem-list. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description:  Memory utilization of all the process 
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__memory_used_percentage','__memory_total','__memory_total_used','__memory_total_free','__memory_low_free','__memory_high_free','__memory_cached','__memory_per_process',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__memory_per_process = YANGDynClass(base=YANGListType("memory_process_id",memory_per_process.memory_per_process, yang_name="memory-per-process", rest_name="memory-per-process", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='memory-process-id', extensions={u'tailf-common': {u'callpoint': u'RAS-memory-per-process', u'cli-suppress-show-path': None}}), is_container='list', yang_name="memory-per-process", rest_name="memory-per-process", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'RAS-memory-per-process', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-RAS-operational', defining_module='brocade-RAS-operational', yang_type='list', is_config=False)
  ...
  def _get_memory_used_percentage(self):
    """
    Getter method for memory_used_percentage, mapped from YANG variable /mem_state/mem_list/memory_used_percentage (decimal64)
  ...
  def _set_memory_used_percentage(self, v, load=False):
    """
    Setter method for memory_used_percentage, mapped from YANG variable /mem_state/mem_list/memory_used_percentage (decimal64)
  ...
  def _get_memory_total(self):
    """
    Getter method for memory_total, mapped from YANG variable /mem_state/mem_list/memory_total (uint32)
  ...
  def _set_memory_total(self, v, load=False):
    """
    Setter method for memory_total, mapped from YANG variable /mem_state/mem_list/memory_total (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_memory_total_used(self):
    """
    Getter method for memory_total_used, mapped from YANG variable /mem_state/mem_list/memory_total_used (uint32)
  ...
  def _set_memory_total_used(self, v, load=False):
    """
    Setter method for memory_total_used, mapped from YANG variable /mem_state/mem_list/memory_total_used (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_memory_total_free(self):
    """
    Getter method for memory_total_free, mapped from YANG variable /mem_state/mem_list/memory_total_free (uint32)
  ...
  def _set_memory_total_free(self, v, load=False):
    """
    Setter method for memory_total_free, mapped from YANG variable /mem_state/mem_list/memory_total_free (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_memory_low_free(self):
    """
    Getter method for memory_low_free, mapped from YANG variable /mem_state/mem_list/memory_low_free (uint32)
  ...
  def _set_memory_low_free(self, v, load=False):
    """
    Setter method for memory_low_free, mapped from YANG variable /mem_state/mem_list/memory_low_free (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_memory_high_free(self):
    """
    Getter method for memory_high_free, mapped from YANG variable /mem_state/mem_list/memory_high_free (uint32)
  ...
  def _set_memory_high_free(self, v, load=False):
    """
    Setter method for memory_high_free, mapped from YANG variable /mem_state/mem_list/memory_high_free (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_memory_cached(self):
    """
    Getter method for memory_cached, mapped from YANG variable /mem_state/mem_list/memory_cached (uint32)
  ...
  def _set_memory_cached(self, v, load=False):
    """
    Setter method for memory_cached, mapped from YANG variable /mem_state/mem_list/memory_cached (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_memory_per_process(self):
    """
    Getter method for memory_per_process, mapped from YANG variable /mem_state/mem_list/memory_per_process (list)

    YANG Description:  Memory utilization per process 
    """
    return self.__memory_per_process
      
  def _set_memory_per_process(self, v, load=False):
    """
    Setter method for memory_per_process, mapped from YANG variable /mem_state/mem_list/memory_per_process (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_memory_per_process is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_memory_per_process() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """memory_per_process must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("memory_process_id",memory_per_process.memory_per_process, yang_name="memory-per-process", rest_name="memory-per-process", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='memory-process-id', extensions={u'tailf-common': {u'callpoint': u'RAS-memory-per-process', u'cli-suppress-show-path': None}}), is_container='list', yang_name="memory-per-process", rest_name="memory-per-process", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'RAS-memory-per-process', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-RAS-operational', defining_module='brocade-RAS-operational', yang_type='list', is_config=False)""",
        })

    self.__memory_per_process = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_memory_per_process(self):
    self.__memory_per_process = YANGDynClass(base=YANGListType("memory_process_id",memory_per_process.memory_per_process, yang_name="memory-per-process", rest_name="memory-per-process", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='memory-process-id', extensions={u'tailf-common': {u'callpoint': u'RAS-memory-per-process', u'cli-suppress-show-path': None}}), is_container='list', yang_name="memory-per-process", rest_name="memory-per-process", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'RAS-memory-per-process', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-RAS-operational', defining_module='brocade-RAS-operational', yang_type='list', is_config=False)
  ...
  memory_per_process = __builtin__.property(_get_memory_per_process)


  _pyangbind_elements = {'memory_used_percentage': memory_used_percentage, 'memory_total': memory_total, 'memory_total_used': memory_total_used, 'memory_total_free': memory_total_free, 'memory_low_free': memory_low_free, 'memory_high_free': memory_high_free, 'memory_cached': memory_cached, 'memory_per_process': memory_per_process, }
