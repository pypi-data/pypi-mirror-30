...
class output(PybindBase):
  ...
  from YANG module brocade-interface-ext - based on the path /brocade_interface_ext_rpc/get-media-detail/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_interface_ext_rpc', u'get-media-detail', u'output']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'get-media-detail', u'output']

  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /brocade_interface_ext_rpc/get_media_detail/output/interface (list)
...
interface.
  ...
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /brocade_interface_ext_rpc/get_media_detail/output/interface (list)
