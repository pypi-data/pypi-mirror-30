...
class cpu_cfg_group(PybindBase):
  ...
  from YANG module brocade-qos-operational - based on the path /cpu-cfg-state/cpu-cfg-group. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: CPU group shaper/burst/wfq config
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__shaper_rate','__burst_size','__wfq_value','__group_id','__cpu_cfg_prio',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'cpu-cfg-state', u'cpu-cfg-group']
  ...
  def _get_shaper_rate(self):
    """
    Getter method for shaper_rate, mapped from YANG variable /cpu_cfg_state/cpu_cfg_group/shaper_rate (uint32)
  ...
  def _set_shaper_rate(self, v, load=False):
    """
    Setter method for shaper_rate, mapped from YANG variable /cpu_cfg_state/cpu_cfg_group/shaper_rate (uint32)
  ...
  def _get_burst_size(self):
    """
    Getter method for burst_size, mapped from YANG variable /cpu_cfg_state/cpu_cfg_group/burst_size (uint32)
  ...
  def _set_burst_size(self, v, load=False):
    """
    Setter method for burst_size, mapped from YANG variable /cpu_cfg_state/cpu_cfg_group/burst_size (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_wfq_value(self):
    """
    Getter method for wfq_value, mapped from YANG variable /cpu_cfg_state/cpu_cfg_group/wfq_value (uint32)
  ...
  def _set_wfq_value(self, v, load=False):
    """
    Setter method for wfq_value, mapped from YANG variable /cpu_cfg_state/cpu_cfg_group/wfq_value (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_group_id(self):
    """
    Getter method for group_id, mapped from YANG variable /cpu_cfg_state/cpu_cfg_group/group_id (int8)
  ...
  def _set_group_id(self, v, load=False):
    """
    Setter method for group_id, mapped from YANG variable /cpu_cfg_state/cpu_cfg_group/group_id (int8)
    If this variable is read-only (config: false) in the
  ...
  def _get_cpu_cfg_prio(self):
    """
    Getter method for cpu_cfg_prio, mapped from YANG variable /cpu_cfg_state/cpu_cfg_group/cpu_cfg_prio (list)
  ...
  def _set_cpu_cfg_prio(self, v, load=False):
    """
    Setter method for cpu_cfg_prio, mapped from YANG variable /cpu_cfg_state/cpu_cfg_group/cpu_cfg_prio (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'shaper_rate': shaper_rate, 'burst_size': burst_size, 'wfq_value': wfq_value, 'group_id': group_id, 'cpu_cfg_prio': cpu_cfg_prio, }
