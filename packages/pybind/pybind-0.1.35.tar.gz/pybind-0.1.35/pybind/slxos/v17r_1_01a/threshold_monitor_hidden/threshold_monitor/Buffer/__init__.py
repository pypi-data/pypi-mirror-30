...
import __builtin__
class Buffer(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-threshold-monitor - based on the path /threshold-monitor-hidden/threshold-monitor/Buffer. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'threshold-monitor-hidden', u'threshold-monitor', u'Buffer']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'threshold-monitor', u'Buffer']

  def _get_poll(self):
    """
    Getter method for poll, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Buffer/poll (uint32)
    """
    return self.__poll
      
  def _set_poll(self, v, load=False):
    """
    Setter method for poll, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Buffer/poll (uint32)
  ...
  def _get_retry(self):
    """
    Getter method for retry, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Buffer/retry (uint32)
    """
    return self.__retry
      
  def _set_retry(self, v, load=False):
    """
    Setter method for retry, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Buffer/retry (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_limit(self):
    """
    Getter method for limit, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Buffer/limit (uint32)
    """
    return self.__limit
      
  def _set_limit(self, v, load=False):
    """
    Setter method for limit, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Buffer/limit (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_actions(self):
    """
    Getter method for actions, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Buffer/actions (enumeration)
    """
    return self.__actions
      
  def _set_actions(self, v, load=False):
    """
    Setter method for actions, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Buffer/actions (enumeration)
    If this variable is read-only (config: false) in the
