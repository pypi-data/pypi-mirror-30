...
class security(PybindBase):
  ...
  from YANG module brocade-threshold-monitor - based on the path /threshold-monitor-hidden/threshold-monitor/security. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'threshold-monitor-hidden', u'threshold-monitor', u'security']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'threshold-monitor', u'security']

  def _get_apply(self):
    """
    Getter method for apply, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/apply (supported-config)
    """
    return self.__apply
      
  def _set_apply(self, v, load=False):
    """
    Setter method for apply, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/apply (supported-config)
  ...
  def _get_pause(self):
    """
    Getter method for pause, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/pause (empty)
    """
    return self.__pause
      
  def _set_pause(self, v, load=False):
    """
    Setter method for pause, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/pause (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_policy(self):
    """
    Getter method for policy, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/policy (list)
    """
    return self.__policy
      
  def _set_policy(self, v, load=False):
    """
    Setter method for policy, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/security/policy (list)
    If this variable is read-only (config: false) in the
