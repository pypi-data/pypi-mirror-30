...
class match(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/isis/router-isis-cmds-holder/address-family/ipv4/af-ipv4-unicast/af-ipv4-attributes/af-common-attributes/redistribute/ospf/match. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'isis', u'router-isis-cmds-holder', u'address-family', u'ipv4', u'af-ipv4-unicast', u'af-ipv4-attributes', u'af-common-attributes', u'redistribute', u'ospf', u'match']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'isis', u'address-family', u'ipv4', u'unicast', u'redistribute', u'ospf', u'match']
  ...
  def _set_ospf_internal(self, v, load=False):
    """
    Setter method for ospf_internal, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv4/af_ipv4_unicast/af_ipv4_attributes/af_common_attributes/redistribute/ospf/match/ospf_internal (empty)
  ...
  def _set_ospf_external1(self, v, load=False):
    """
    Setter method for ospf_external1, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv4/af_ipv4_unicast/af_ipv4_attributes/af_common_attributes/redistribute/ospf/match/ospf_external1 (empty)
    If this variable is read-only (config: false) in the
  ...
  def _set_ospf_external2(self, v, load=False):
    """
    Setter method for ospf_external2, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv4/af_ipv4_unicast/af_ipv4_attributes/af_common_attributes/redistribute/ospf/match/ospf_external2 (empty)
    If this variable is read-only (config: false) in the
