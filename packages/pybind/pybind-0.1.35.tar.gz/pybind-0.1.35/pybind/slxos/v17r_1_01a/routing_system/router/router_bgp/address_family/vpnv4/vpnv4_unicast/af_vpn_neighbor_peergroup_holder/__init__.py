...
class af_vpn_neighbor_peergroup_holder(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv4/vpnv4-unicast/af-vpn-neighbor-peergroup-holder. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv4', u'vpnv4-unicast', u'af-vpn-neighbor-peergroup-holder']
  ...
  def _get_af_vpn_neighbor_peergroup(self):
    """
    Getter method for af_vpn_neighbor_peergroup, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup (list)
    """
    return self.__af_vpn_neighbor_peergroup
      
  def _set_af_vpn_neighbor_peergroup(self, v, load=False):
    """
    Setter method for af_vpn_neighbor_peergroup, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup (list)
