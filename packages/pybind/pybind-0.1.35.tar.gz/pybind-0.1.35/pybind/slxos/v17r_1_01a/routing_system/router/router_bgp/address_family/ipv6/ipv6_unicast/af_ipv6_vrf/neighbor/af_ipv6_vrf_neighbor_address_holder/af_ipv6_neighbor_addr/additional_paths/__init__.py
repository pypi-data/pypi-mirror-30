...
class additional_paths(PybindBase):
  ...
  def _get_addpath_disable(self):
    """
    Getter method for addpath_disable, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/additional_paths/addpath_disable (empty)
    """
    return self.__addpath_disable
      
  def _set_addpath_disable(self, v, load=False):
    """
    Setter method for addpath_disable, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/additional_paths/addpath_disable (empty)
  ...
  def _get_addpath_txrx(self):
    """
    Getter method for addpath_txrx, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/additional_paths/addpath_txrx (container)
    """
    return self.__addpath_txrx
      
  def _set_addpath_txrx(self, v, load=False):
    """
    Setter method for addpath_txrx, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/additional_paths/addpath_txrx (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_addpath_advertise(self):
    """
    Getter method for addpath_advertise, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/additional_paths/addpath_advertise (container)
    """
    return self.__addpath_advertise
      
  def _set_addpath_advertise(self, v, load=False):
    """
    Setter method for addpath_advertise, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/neighbor/af_ipv6_vrf_neighbor_address_holder/af_ipv6_neighbor_addr/additional_paths/addpath_advertise (container)
    If this variable is read-only (config: false) in the
