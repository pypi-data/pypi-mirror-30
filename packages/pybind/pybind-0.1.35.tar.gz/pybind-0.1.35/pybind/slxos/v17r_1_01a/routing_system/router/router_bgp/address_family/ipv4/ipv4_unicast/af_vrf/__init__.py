...
class af_vrf(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__af_vrf_name','__local_as','__maxas_limit','__next_hop_recursion','__graceful_restart_status','__af_ipv4_uc_and_vrf_cmds_call_point_holder','__static_network','__aggregate_address','__network','__neighbor','__maximum_paths','__multipath','__always_propagate','__default_information_originate','__rib_route_limit','__af_additional_paths','__advertise_best_external','__client_to_client_reflection','__dampening','__default_metric','__next_hop_enable_default','__table_map','__update_time',)
  ...
  def _get_af_additional_paths(self):
    """
    Getter method for af_additional_paths, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/af_additional_paths (container)
    """
    return self.__af_additional_paths
      
  def _set_af_additional_paths(self, v, load=False):
    """
    Setter method for af_additional_paths, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/af_additional_paths (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_advertise_best_external(self):
    """
    Getter method for advertise_best_external, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/advertise_best_external (empty)
    """
    return self.__advertise_best_external
      
  def _set_advertise_best_external(self, v, load=False):
    """
    Setter method for advertise_best_external, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/advertise_best_external (empty)
    If this variable is read-only (config: false) in the
