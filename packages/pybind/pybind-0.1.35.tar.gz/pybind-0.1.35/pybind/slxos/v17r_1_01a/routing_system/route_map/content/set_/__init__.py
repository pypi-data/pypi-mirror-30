...
class set_(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__level','__ip','__ipv6','__extcommunity','__community','__metric','__distance','__route_type','__tag','__weight','__as_path','__automatic_tag','__comm_list','__dampening','__local_preference','__origin','__metric_type',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__level = YANGDynClass(base=level.level, is_container='container', presence=False, yang_name="level", rest_name="level", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)
  ...
  def _set_level(self, v, load=False):
    """
    Setter method for level, mapped from YANG variable /routing_system/route_map/content/set/level (container)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=level.level, is_container='container', presence=False, yang_name="level", rest_name="level", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """level must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=level.level, is_container='container', presence=False, yang_name="level", rest_name="level", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)""",
        })
