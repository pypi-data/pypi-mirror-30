...
class protocol_static_container(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/match/protocol/protocol-static-container. Each member element of
  ...
  def _get_static(self):
    """
    Getter method for static, mapped from YANG variable /routing_system/route_map/content/match/protocol/protocol_static_container/static (empty)
  ...
  def _set_static(self, v, load=False):
    """
    Setter method for static, mapped from YANG variable /routing_system/route_map/content/match/protocol/protocol_static_container/static (empty)
