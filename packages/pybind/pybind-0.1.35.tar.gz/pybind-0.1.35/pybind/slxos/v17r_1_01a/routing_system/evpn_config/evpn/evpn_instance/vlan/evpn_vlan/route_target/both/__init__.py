...
class both(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/evpn-config/evpn/evpn-instance/vlan/evpn-vlan/route-target/both. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'evpn-config', u'evpn', u'evpn-instance', u'vlan', u'evpn-vlan', u'route-target', u'both']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'evpn', u'evpn-instance', u'vlan', u'evpn-vlan', u'route-target', u'both']

  def _get_target_community(self):
    """
    Getter method for target_community, mapped from YANG variable /routing_system/evpn_config/evpn/evpn_instance/vlan/evpn_vlan/route_target/both/target_community (rd-rt-type)
  ...
  def _set_target_community(self, v, load=False):
    """
    Setter method for target_community, mapped from YANG variable /routing_system/evpn_config/evpn/evpn_instance/vlan/evpn_vlan/route_target/both/target_community (rd-rt-type)
