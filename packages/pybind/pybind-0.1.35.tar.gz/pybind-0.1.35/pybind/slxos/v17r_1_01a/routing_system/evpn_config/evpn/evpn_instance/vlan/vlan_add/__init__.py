...
import __builtin__
class vlan_add(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /routing-system/evpn-config/evpn/evpn-instance/vlan/vlan-add. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'evpn-config', u'evpn', u'evpn-instance', u'vlan', u'vlan-add']
  ...
  def _get_add_(self):
    """
    Getter method for add_, mapped from YANG variable /routing_system/evpn_config/evpn/evpn_instance/vlan/vlan_add/add (interface:ui32-vlan-range)

    YANG Description: Add VLANS to the EVPN Instance.
    """
    return self.__add_
      
  def _set_add_(self, v, load=False):
    """
    Setter method for add_, mapped from YANG variable /routing_system/evpn_config/evpn/evpn_instance/vlan/vlan_add/add (interface:ui32-vlan-range)
  ...
  def _get_remove_(self):
    """
    Getter method for remove_, mapped from YANG variable /routing_system/evpn_config/evpn/evpn_instance/vlan/vlan_add/remove (interface:ui32-vlan-range)

    YANG Description: Remove VLANS to the EVPN Instance.
    """
    return self.__remove_
      
  def _set_remove_(self, v, load=False):
    """
    Setter method for remove_, mapped from YANG variable /routing_system/evpn_config/evpn/evpn_instance/vlan/vlan_add/remove (interface:ui32-vlan-range)
    If this variable is read-only (config: false) in the
