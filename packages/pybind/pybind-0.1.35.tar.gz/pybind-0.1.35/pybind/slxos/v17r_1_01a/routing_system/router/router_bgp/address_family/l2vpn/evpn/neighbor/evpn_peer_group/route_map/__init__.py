...
class route_map(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/l2vpn/evpn/neighbor/evpn-peer-group/route-map. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'l2vpn', u'evpn', u'neighbor', u'evpn-peer-group', u'route-map']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'l2vpn', u'evpn', u'neighbor', u'evpn-peer-group', u'route-map']

  def _get_direction_in(self):
    """
    Getter method for direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/route_map/direction_in (container)
    """
    return self.__direction_in
      
  def _set_direction_in(self, v, load=False):
    """
    Setter method for direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/route_map/direction_in (container)
  ...
  def _get_direction_out(self):
    """
    Getter method for direction_out, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/route_map/direction_out (container)
    """
    return self.__direction_out
      
  def _set_direction_out(self, v, load=False):
    """
    Setter method for direction_out, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/route_map/direction_out (container)
    If this variable is read-only (config: false) in the
