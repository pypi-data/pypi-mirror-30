...
class addpath_txrx(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv6/ipv6-unicast/default-vrf/af-common-cmds-holder/af-additional-paths/addpath-txrx. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'default-vrf', u'af-common-cmds-holder', u'af-additional-paths', u'addpath-txrx']
  ...
  def _get_addpath_send(self):
    """
    Getter method for addpath_send, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/af_common_cmds_holder/af_additional_paths/addpath_txrx/addpath_send (empty)
    """
    return self.__addpath_send
      
  def _set_addpath_send(self, v, load=False):
    """
    Setter method for addpath_send, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/af_common_cmds_holder/af_additional_paths/addpath_txrx/addpath_send (empty)
  ...
  def _get_addpath_receive(self):
    """
    Getter method for addpath_receive, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/af_common_cmds_holder/af_additional_paths/addpath_txrx/addpath_receive (empty)
    """
    return self.__addpath_receive
      
  def _set_addpath_receive(self, v, load=False):
    """
    Setter method for addpath_receive, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/af_common_cmds_holder/af_additional_paths/addpath_txrx/addpath_receive (empty)
    If this variable is read-only (config: false) in the
