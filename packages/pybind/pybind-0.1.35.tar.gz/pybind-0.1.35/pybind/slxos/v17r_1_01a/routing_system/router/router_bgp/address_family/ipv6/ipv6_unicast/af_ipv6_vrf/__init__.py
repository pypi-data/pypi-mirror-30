...
class af_ipv6_vrf(PybindBase):
  ...
  def _get_af_additional_paths(self):
    """
    Getter method for af_additional_paths, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/af_additional_paths (container)
    """
    return self.__af_additional_paths
      
  def _set_af_additional_paths(self, v, load=False):
    """
    Setter method for af_additional_paths, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/af_additional_paths (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_advertise_best_external(self):
    """
    Getter method for advertise_best_external, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/advertise_best_external (empty)
    """
    return self.__advertise_best_external
      
  def _set_advertise_best_external(self, v, load=False):
    """
    Setter method for advertise_best_external, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/advertise_best_external (empty)
    If this variable is read-only (config: false) in the
