...
class int_ipv6_router_isis(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/loopback/ipv6/intf-ipv6-router-isis/int-ipv6-router-isis. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u'loopback', u'ipv6', u'intf-ipv6-router-isis', u'int-ipv6-router-isis']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Loopback', u'ipv6', u'router']
  ...
  def _set_interface_ipv6_router_isis(self, v, load=False):
    """
    Setter method for interface_ipv6_router_isis, mapped from YANG variable /routing_system/interface/loopback/ipv6/intf_ipv6_router_isis/int_ipv6_router_isis/interface_ipv6_router_isis (empty)
