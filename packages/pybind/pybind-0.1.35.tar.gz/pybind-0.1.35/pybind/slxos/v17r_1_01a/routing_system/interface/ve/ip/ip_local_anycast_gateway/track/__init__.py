...
class track(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/ip-local-anycast-gateway/track. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip', u'ip-local-anycast-gateway', u'track']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'ip', u'fabric-virtual-gateway', u'track']

  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /routing_system/interface/ve/ip/ip_local_anycast_gateway/track/interface (list)
    """
    return self.__interface
      
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /routing_system/interface/ve/ip/ip_local_anycast_gateway/track/interface (list)
  ...
  def _get_network(self):
    """
    Getter method for network, mapped from YANG variable /routing_system/interface/ve/ip/ip_local_anycast_gateway/track/network (list)
    """
    return self.__network
      
  def _set_network(self, v, load=False):
    """
    Setter method for network, mapped from YANG variable /routing_system/interface/ve/ip/ip_local_anycast_gateway/track/network (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_next_hop(self):
    """
    Getter method for next_hop, mapped from YANG variable /routing_system/interface/ve/ip/ip_local_anycast_gateway/track/next_hop (list)
    """
    return self.__next_hop
      
  def _set_next_hop(self, v, load=False):
    """
    Setter method for next_hop, mapped from YANG variable /routing_system/interface/ve/ip/ip_local_anycast_gateway/track/next_hop (list)
    If this variable is read-only (config: false) in the
