...
class prefix_list(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv6/vpnv6-unicast/af-vpn-neighbor-peergroup-holder/af-vpn-neighbor-peergroup/af-neighbor-capability/orf/prefix-list. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv6', u'vpnv6-unicast', u'af-vpn-neighbor-peergroup-holder', u'af-vpn-neighbor-peergroup', u'af-neighbor-capability', u'orf', u'prefix-list']
  ...
  def _get_prefixlist_status(self):
    """
    Getter method for prefixlist_status, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/af_neighbor_capability/orf/prefix_list/prefixlist_status (empty)
  ...
  def _set_prefixlist_status(self, v, load=False):
    """
    Setter method for prefixlist_status, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/af_neighbor_capability/orf/prefix_list/prefixlist_status (empty)
  ...
  def _get_prefixlist_send(self):
    """
    Getter method for prefixlist_send, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/af_neighbor_capability/orf/prefix_list/prefixlist_send (empty)
  ...
  def _set_prefixlist_send(self, v, load=False):
    """
    Setter method for prefixlist_send, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/af_neighbor_capability/orf/prefix_list/prefixlist_send (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_prefixlist_receive(self):
    """
    Getter method for prefixlist_receive, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/af_neighbor_capability/orf/prefix_list/prefixlist_receive (empty)
  ...
  def _set_prefixlist_receive(self, v, load=False):
    """
    Setter method for prefixlist_receive, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/af_neighbor_capability/orf/prefix_list/prefixlist_receive (empty)
    If this variable is read-only (config: false) in the
