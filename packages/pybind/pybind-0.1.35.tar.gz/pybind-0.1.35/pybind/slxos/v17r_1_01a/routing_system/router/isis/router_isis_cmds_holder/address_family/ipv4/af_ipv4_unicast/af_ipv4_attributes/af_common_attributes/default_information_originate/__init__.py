...
class default_information_originate(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__default_information_originate_route_map',)
  ...
  _pyangbind_elements = {'default_information_originate_route_map': default_information_originate_route_map, }
