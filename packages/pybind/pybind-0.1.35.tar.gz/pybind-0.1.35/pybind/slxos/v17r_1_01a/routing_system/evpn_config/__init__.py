...
import __builtin__
import evpn
class evpn_config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /routing-system/evpn-config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__evpn',)

  _yang_name = 'evpn-config'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'evpn-config']
  ...
  def _set_evpn(self, v, load=False):
    """
    Setter method for evpn, mapped from YANG variable /routing_system/evpn_config/evpn (container)
