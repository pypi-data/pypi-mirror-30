...
class af_common_cmds_holder(PybindBase):
  ...
  def _set_af_additional_paths(self, v, load=False):
    """
    Setter method for af_additional_paths, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/af_common_cmds_holder/af_additional_paths (container)
    If this variable is read-only (config: false) in the
  ...
  def _set_advertise_best_external(self, v, load=False):
    """
    Setter method for advertise_best_external, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/af_common_cmds_holder/advertise_best_external (empty)
    If this variable is read-only (config: false) in the
