...
class af_additional_paths(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/af-vrf/af-additional-paths. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'af-vrf', u'af-additional-paths']
  ...
  def _get_addpath_txrx(self):
    """
    Getter method for addpath_txrx, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/af_additional_paths/addpath_txrx (container)
    """
    return self.__addpath_txrx
      
  def _set_addpath_txrx(self, v, load=False):
    """
    Setter method for addpath_txrx, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/af_additional_paths/addpath_txrx (container)
  ...
  def _get_addpath_select(self):
    """
    Getter method for addpath_select, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/af_additional_paths/addpath_select (container)
    """
    return self.__addpath_select
      
  def _set_addpath_select(self, v, load=False):
    """
    Setter method for addpath_select, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/af_additional_paths/addpath_select (container)
    If this variable is read-only (config: false) in the
