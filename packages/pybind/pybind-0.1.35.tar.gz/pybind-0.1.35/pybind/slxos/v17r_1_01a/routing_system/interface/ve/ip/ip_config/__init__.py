...
class ip_config(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/ip-config. Each member element of
  ...
  def _get_mtu(self):
    """
    Getter method for mtu, mapped from YANG variable /routing_system/interface/ve/ip/ip_config/mtu (ip-mtu)
    """
    return self.__mtu
      
  def _set_mtu(self, v, load=False):
    """
    Setter method for mtu, mapped from YANG variable /routing_system/interface/ve/ip/ip_config/mtu (ip-mtu)
  ...
  def _get_proxy_arp(self):
    """
    Getter method for proxy_arp, mapped from YANG variable /routing_system/interface/ve/ip/ip_config/proxy_arp (empty)
    """
    return self.__proxy_arp
      
  def _set_proxy_arp(self, v, load=False):
    """
    Setter method for proxy_arp, mapped from YANG variable /routing_system/interface/ve/ip/ip_config/proxy_arp (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_arp_aging_timeout(self):
    """
    Getter method for arp_aging_timeout, mapped from YANG variable /routing_system/interface/ve/ip/ip_config/arp_aging_timeout (uint32)
...
(default value 240)
  ...
  def _set_arp_aging_timeout(self, v, load=False):
    """
    Setter method for arp_aging_timeout, mapped from YANG variable /routing_system/interface/ve/ip/ip_config/arp_aging_timeout (uint32)
    If this variable is read-only (config: false) in the
...
(default value 240)
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /routing_system/interface/ve/ip/ip_config/address (list)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /routing_system/interface/ve/ip/ip_config/address (list)
    If this variable is read-only (config: false) in the
