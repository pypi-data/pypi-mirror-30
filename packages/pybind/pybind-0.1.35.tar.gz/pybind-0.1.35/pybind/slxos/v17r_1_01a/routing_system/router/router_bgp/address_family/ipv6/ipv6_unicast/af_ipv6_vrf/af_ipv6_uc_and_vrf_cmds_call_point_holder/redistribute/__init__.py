...
class redistribute(PybindBase):
  ...
  def _get_redistribute_isis(self):
    """
    Getter method for redistribute_isis, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/af_ipv6_uc_and_vrf_cmds_call_point_holder/redistribute/redistribute_isis (container)
  ...
  def _set_redistribute_isis(self, v, load=False):
    """
    Setter method for redistribute_isis, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/af_ipv6_uc_and_vrf_cmds_call_point_holder/redistribute/redistribute_isis (container)
    If this variable is read-only (config: false) in the
