...
import prefix_list
import filter_list
class af_vpnv6_neighbor(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv6/vpnv6-unicast/af-vpnv6-neighbor-address-holder/af-vpnv6-neighbor. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__af_vpnv6_neighbor_address','__af_neighbor_capability','__send_community','__activate','__weight','__route_reflector_client','__neighbor_route_map','__prefix_list','__filter_list',)

  _yang_name = 'af-vpnv6-neighbor'
  _rest_name = 'neighbor'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv6', u'vpnv6-unicast', u'af-vpnv6-neighbor-address-holder', u'af-vpnv6-neighbor']
  ...
  def _get_af_vpnv6_neighbor_address(self):
    """
    Getter method for af_vpnv6_neighbor_address, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/af_vpnv6_neighbor_address (inet:ipv4-address)
    """
    return self.__af_vpnv6_neighbor_address
      
  def _set_af_vpnv6_neighbor_address(self, v, load=False):
    """
    Setter method for af_vpnv6_neighbor_address, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/af_vpnv6_neighbor_address (inet:ipv4-address)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_af_vpnv6_neighbor_address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_af_vpnv6_neighbor_address() directly.
    """
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="af-vpnv6-neighbor-address", rest_name="af-vpnv6-neighbor-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'A.B.C.D;;Neighbor Address'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='inet:ipv4-address', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """af_vpnv6_neighbor_address must be of a type compatible with inet:ipv4-address""",
          'defined-type': "inet:ipv4-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="af-vpnv6-neighbor-address", rest_name="af-vpnv6-neighbor-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'A.B.C.D;;Neighbor Address'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='inet:ipv4-address', is_config=True)""",
        })

    self.__af_vpnv6_neighbor_address = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_af_vpnv6_neighbor_address(self):
    self.__af_vpnv6_neighbor_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="af-vpnv6-neighbor-address", rest_name="af-vpnv6-neighbor-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'A.B.C.D;;Neighbor Address'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='inet:ipv4-address', is_config=True)


  def _get_af_neighbor_capability(self):
    """
    Getter method for af_neighbor_capability, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/af_neighbor_capability (container)
    """
    return self.__af_neighbor_capability
      
  def _set_af_neighbor_capability(self, v, load=False):
    """
    Setter method for af_neighbor_capability, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/af_neighbor_capability (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_send_community(self):
    """
    Getter method for send_community, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/send_community (container)
    """
    return self.__send_community
      
  def _set_send_community(self, v, load=False):
    """
    Setter method for send_community, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/send_community (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_activate(self):
    """
    Getter method for activate, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/activate (empty)
    """
    return self.__activate
      
  def _set_activate(self, v, load=False):
    """
    Setter method for activate, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/activate (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_weight(self):
    """
    Getter method for weight, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/weight (nei-weight)
    """
    return self.__weight
      
  def _set_weight(self, v, load=False):
    """
    Setter method for weight, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/weight (nei-weight)
    If this variable is read-only (config: false) in the
  ...
  def _get_route_reflector_client(self):
    """
    Getter method for route_reflector_client, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/route_reflector_client (empty)
    """
    return self.__route_reflector_client
      
  def _set_route_reflector_client(self, v, load=False):
    """
    Setter method for route_reflector_client, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/route_reflector_client (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_neighbor_route_map(self):
    """
    Getter method for neighbor_route_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/neighbor_route_map (container)
    """
    return self.__neighbor_route_map
      
  def _set_neighbor_route_map(self, v, load=False):
    """
    Setter method for neighbor_route_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/neighbor_route_map (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_prefix_list(self):
    """
    Getter method for prefix_list, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/prefix_list (container)
  ...
  def _set_prefix_list(self, v, load=False):
    """
    Setter method for prefix_list, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/prefix_list (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_filter_list(self):
    """
    Getter method for filter_list, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/filter_list (container)
    """
    return self.__filter_list
      
  def _set_filter_list(self, v, load=False):
    """
    Setter method for filter_list, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/filter_list (container)
    If this variable is read-only (config: false) in the
  ...
  af_vpnv6_neighbor_address = __builtin__.property(_get_af_vpnv6_neighbor_address, _set_af_vpnv6_neighbor_address)
  ...
  _pyangbind_elements = {'af_vpnv6_neighbor_address': af_vpnv6_neighbor_address, 'af_neighbor_capability': af_neighbor_capability, 'send_community': send_community, 'activate': activate, 'weight': weight, 'route_reflector_client': route_reflector_client, 'neighbor_route_map': neighbor_route_map, 'prefix_list': prefix_list, 'filter_list': filter_list, }
