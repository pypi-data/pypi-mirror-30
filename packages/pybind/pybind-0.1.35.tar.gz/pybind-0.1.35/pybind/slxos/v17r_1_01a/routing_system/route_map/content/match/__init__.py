...
class match(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__vrf','__additional_paths','__interface','__ipv6','__ip','__extcommunity','__metric','__route_type','__tag','__as_path','__community','__next_hop','__protocol',)
  ...
  def _set_additional_paths(self, v, load=False):
    """
    Setter method for additional_paths, mapped from YANG variable /routing_system/route_map/content/match/additional_paths (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'vrf': vrf, 'additional_paths': additional_paths, 'interface': interface, 'ipv6': ipv6, 'ip': ip, 'extcommunity': extcommunity, 'metric': metric, 'route_type': route_type, 'tag': tag, 'as_path': as_path, 'community': community, 'next_hop': next_hop, 'protocol': protocol, }
