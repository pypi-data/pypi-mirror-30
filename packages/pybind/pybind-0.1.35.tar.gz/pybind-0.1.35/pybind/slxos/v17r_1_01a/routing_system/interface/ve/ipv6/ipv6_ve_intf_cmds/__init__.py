...
import __builtin__
class ipv6_ve_intf_cmds(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ipv6/ipv6-ve-intf-cmds. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__hop_by_hop_trap',)

  _yang_name = 'ipv6-ve-intf-cmds'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ipv6', u'ipv6-ve-intf-cmds']
  ...
  def _get_hop_by_hop_trap(self):
    """
    Getter method for hop_by_hop_trap, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_ve_intf_cmds/hop_by_hop_trap (empty)
    """
    return self.__hop_by_hop_trap
      
  def _set_hop_by_hop_trap(self, v, load=False):
    """
    Setter method for hop_by_hop_trap, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_ve_intf_cmds/hop_by_hop_trap (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_hop_by_hop_trap is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_hop_by_hop_trap() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  _pyangbind_elements = {'hop_by_hop_trap': hop_by_hop_trap, }
