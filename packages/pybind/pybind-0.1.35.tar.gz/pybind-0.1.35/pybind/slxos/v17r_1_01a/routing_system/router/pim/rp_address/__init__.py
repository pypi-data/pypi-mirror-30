...
class rp_address(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/pim/rp-address. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'pim', u'rp-address']
  ...
  def _get_rp_ip_addr(self):
    """
    Getter method for rp_ip_addr, mapped from YANG variable /routing_system/router/pim/rp_address/rp_ip_addr (inet:ipv4-address)
    """
    return self.__rp_ip_addr
      
  def _set_rp_ip_addr(self, v, load=False):
    """
    Setter method for rp_ip_addr, mapped from YANG variable /routing_system/router/pim/rp_address/rp_ip_addr (inet:ipv4-address)
  ...
  def _set_rp_addr_prefix_list(self, v, load=False):
    """
    Setter method for rp_addr_prefix_list, mapped from YANG variable /routing_system/router/pim/rp_address/rp_addr_prefix_list (common-def:name-string63)
    If this variable is read-only (config: false) in the
