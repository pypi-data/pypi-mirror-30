...
class direction_in(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv6/vpnv6-unicast/af-vpn-neighbor-peergroup-holder/af-vpn-neighbor-peergroup/prefix-list/direction-in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv6', u'vpnv6-unicast', u'af-vpn-neighbor-peergroup-holder', u'af-vpn-neighbor-peergroup', u'prefix-list', u'direction-in']
  ...
  def _get_prefix_list_direction_in_prefix_name(self):
    """
    Getter method for prefix_list_direction_in_prefix_name, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/prefix_list/direction_in/prefix_list_direction_in_prefix_name (nei-prefix-list-filter)
    """
    return self.__prefix_list_direction_in_prefix_name
      
  def _set_prefix_list_direction_in_prefix_name(self, v, load=False):
    """
    Setter method for prefix_list_direction_in_prefix_name, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/prefix_list/direction_in/prefix_list_direction_in_prefix_name (nei-prefix-list-filter)
  ...
  def _get_prefix_list_direction_in(self):
    """
    Getter method for prefix_list_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/prefix_list/direction_in/prefix_list_direction_in (empty)
    """
    return self.__prefix_list_direction_in
      
  def _set_prefix_list_direction_in(self, v, load=False):
    """
    Setter method for prefix_list_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/prefix_list/direction_in/prefix_list_direction_in (empty)
    If this variable is read-only (config: false) in the
