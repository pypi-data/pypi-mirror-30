...
class extended_community(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv4/vpnv4-unicast/af-vpnv4-neighbor-address-holder/af-vpnv4-neighbor/af-neighbor-capability/orf/extended-community. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv4', u'vpnv4-unicast', u'af-vpnv4-neighbor-address-holder', u'af-vpnv4-neighbor', u'af-neighbor-capability', u'orf', u'extended-community']
  ...
  def _get_ext_community_receive(self):
    """
    Getter method for ext_community_receive, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpnv4_neighbor_address_holder/af_vpnv4_neighbor/af_neighbor_capability/orf/extended_community/ext_community_receive (empty)
  ...
  def _set_ext_community_receive(self, v, load=False):
    """
    Setter method for ext_community_receive, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpnv4_neighbor_address_holder/af_vpnv4_neighbor/af_neighbor_capability/orf/extended_community/ext_community_receive (empty)
  ...
  def _get_ext_community_send_vrf(self):
    """
    Getter method for ext_community_send_vrf, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpnv4_neighbor_address_holder/af_vpnv4_neighbor/af_neighbor_capability/orf/extended_community/ext_community_send_vrf (empty)
  ...
  def _set_ext_community_send_vrf(self, v, load=False):
    """
    Setter method for ext_community_send_vrf, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpnv4_neighbor_address_holder/af_vpnv4_neighbor/af_neighbor_capability/orf/extended_community/ext_community_send_vrf (empty)
    If this variable is read-only (config: false) in the
