...
class prefix_list(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ipv6/prefix-list. Each member element of
  ...
  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /ipv6/prefix_list/name (ipv6-prefix-name-t)
    """
    return self.__name
      
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /ipv6/prefix_list/name (ipv6-prefix-name-t)
  ...
  def _get_seq_keyword(self):
    """
    Getter method for seq_keyword, mapped from YANG variable /ipv6/prefix_list/seq_keyword (enumeration)
    """
    return self.__seq_keyword
      
  def _set_seq_keyword(self, v, load=False):
    """
    Setter method for seq_keyword, mapped from YANG variable /ipv6/prefix_list/seq_keyword (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_instance(self):
    """
    Getter method for instance, mapped from YANG variable /ipv6/prefix_list/instance (instance-id-t)
    """
    return self.__instance
      
  def _set_instance(self, v, load=False):
    """
    Setter method for instance, mapped from YANG variable /ipv6/prefix_list/instance (instance-id-t)
    If this variable is read-only (config: false) in the
  ...
  def _get_action_ipp(self):
    """
    Getter method for action_ipp, mapped from YANG variable /ipv6/prefix_list/action_ipp (action-t)
    """
    return self.__action_ipp
      
  def _set_action_ipp(self, v, load=False):
    """
    Setter method for action_ipp, mapped from YANG variable /ipv6/prefix_list/action_ipp (action-t)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv6_prefix_ipp(self):
    """
    Getter method for ipv6_prefix_ipp, mapped from YANG variable /ipv6/prefix_list/ipv6_prefix_ipp (inet:ipv6-prefix)
    """
    return self.__ipv6_prefix_ipp
      
  def _set_ipv6_prefix_ipp(self, v, load=False):
    """
    Setter method for ipv6_prefix_ipp, mapped from YANG variable /ipv6/prefix_list/ipv6_prefix_ipp (inet:ipv6-prefix)
    If this variable is read-only (config: false) in the
  ...
  def _get_ge_ipp(self):
    """
    Getter method for ge_ipp, mapped from YANG variable /ipv6/prefix_list/ge_ipp (ipv6-prefix-len-t)
  ...
  def _set_ge_ipp(self, v, load=False):
    """
    Setter method for ge_ipp, mapped from YANG variable /ipv6/prefix_list/ge_ipp (ipv6-prefix-len-t)
    If this variable is read-only (config: false) in the
  ...
  def _get_le_ipp(self):
    """
    Getter method for le_ipp, mapped from YANG variable /ipv6/prefix_list/le_ipp (ipv6-prefix-len-t)
  ...
  def _set_le_ipp(self, v, load=False):
    """
    Setter method for le_ipp, mapped from YANG variable /ipv6/prefix_list/le_ipp (ipv6-prefix-len-t)
    If this variable is read-only (config: false) in the
