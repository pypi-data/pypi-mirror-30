...
class proto_vrrpv3(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ipv6/proto-vrrpv3. Each member element of
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ipv6', u'protocol']

  def _get_vrrp(self):
    """
    Getter method for vrrp, mapped from YANG variable /ipv6/proto_vrrpv3/vrrp (empty)
  ...
  def _set_vrrp(self, v, load=False):
    """
    Setter method for vrrp, mapped from YANG variable /ipv6/proto_vrrpv3/vrrp (empty)
  ...
  def _get_vrrp_extended(self):
    """
    Getter method for vrrp_extended, mapped from YANG variable /ipv6/proto_vrrpv3/vrrp_extended (empty)
  ...
  def _set_vrrp_extended(self, v, load=False):
    """
    Setter method for vrrp_extended, mapped from YANG variable /ipv6/proto_vrrpv3/vrrp_extended (empty)
    If this variable is read-only (config: false) in the
