...
class extcommunity_list(PybindBase):
  ...
  def _set_extended(self, v, load=False):
    """
    Setter method for extended, mapped from YANG variable /ip/hide_ext_community_list_holder/extcommunity_list/extended (list)
    If this variable is read-only (config: false) in the
