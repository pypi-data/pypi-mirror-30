...
import __builtin__
class dom_name(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /ip/dns/dom-name. Each member element of
  ...
  def _get_domain_name(self):
    """
    Getter method for domain_name, mapped from YANG variable /ip/dns/dom_name/domain_name (string)
    """
    return self.__domain_name
      
  def _set_domain_name(self, v, load=False):
    """
    Setter method for domain_name, mapped from YANG variable /ip/dns/dom_name/domain_name (string)
