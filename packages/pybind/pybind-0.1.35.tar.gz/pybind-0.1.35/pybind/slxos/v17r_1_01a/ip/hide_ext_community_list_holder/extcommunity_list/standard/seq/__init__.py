...
class seq(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ip/hide-ext-community-list-holder/extcommunity-list/standard/seq. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__seq_id','__ext_community_action','__ext_community_expr',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__seq_id = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..65535']}), is_leaf=True, yang_name="seq-id", rest_name="seq-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'code-name': u'extcommlist-std-seq-id', u'cli-full-no': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='uint32', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ip', u'hide-ext-community-list-holder', u'extcommunity-list', u'standard', u'seq']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'ip', u'extcommunity-list', u'standard', u'seq']
  ...
  def _set_seq_id(self, v, load=False):
    """
    Setter method for seq_id, mapped from YANG variable /ip/hide_ext_community_list_holder/extcommunity_list/standard/seq/seq_id (uint32)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..65535']}), is_leaf=True, yang_name="seq-id", rest_name="seq-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'code-name': u'extcommlist-std-seq-id', u'cli-full-no': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='uint32', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """seq_id must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..65535']}), is_leaf=True, yang_name="seq-id", rest_name="seq-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'code-name': u'extcommlist-std-seq-id', u'cli-full-no': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='uint32', is_config=True)""",
        })
  ...
  def _set_ext_community_action(self, v, load=False):
    """
    Setter method for ext_community_action, mapped from YANG variable /ip/hide_ext_community_list_holder/extcommunity_list/standard/seq/ext_community_action (action-t)
    If this variable is read-only (config: false) in the
  ...
  def _set_ext_community_expr(self, v, load=False):
    """
    Setter method for ext_community_expr, mapped from YANG variable /ip/hide_ext_community_list_holder/extcommunity_list/standard/seq/ext_community_expr (extcommunity-list-expr-t)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'seq_id': seq_id, 'ext_community_action': ext_community_action, 'ext_community_expr': ext_community_expr, }
