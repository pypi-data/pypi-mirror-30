...
import __builtin__
class config_bds(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-nsm-operational - based on the path /mct-state/show-cluster/client-info-list/config-bds. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__bd_id',)

  _yang_name = 'config-bds'
  _rest_name = 'config-bds'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mct-state', u'show-cluster', u'client-info-list', u'config-bds']
  ...
  def _get_bd_id(self):
    """
    Getter method for bd_id, mapped from YANG variable /mct_state/show_cluster/client_info_list/config_bds/bd_id (uint32)
  ...
  def _set_bd_id(self, v, load=False):
    """
    Setter method for bd_id, mapped from YANG variable /mct_state/show_cluster/client_info_list/config_bds/bd_id (uint32)
  ...
  _pyangbind_elements = {'bd_id': bd_id, }
