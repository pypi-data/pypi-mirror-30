...
import __builtin__
class active_bd_list(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-nsm-operational - based on the path /mct-state/show-cluster/active-bd-list. Each member element of
  ...
  _yang_name = 'active-bd-list'
  _rest_name = 'active-bd-list'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mct-state', u'show-cluster', u'active-bd-list']
  ...
  def _get_bd_id(self):
    """
    Getter method for bd_id, mapped from YANG variable /mct_state/show_cluster/active_bd_list/bd_id (uint32)
  ...
  def _set_bd_id(self, v, load=False):
    """
    Setter method for bd_id, mapped from YANG variable /mct_state/show_cluster/active_bd_list/bd_id (uint32)
