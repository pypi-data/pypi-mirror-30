...
class email(PybindBase):
  ...
  from YANG module brocade-maps - based on the path /maps/email. Each member element of
  ...
  def _get_email_list(self):
    """
    Getter method for email_list, mapped from YANG variable /maps/email/email_list (list)
    """
    return self.__email_list
      
  def _set_email_list(self, v, load=False):
    """
    Setter method for email_list, mapped from YANG variable /maps/email/email_list (list)
