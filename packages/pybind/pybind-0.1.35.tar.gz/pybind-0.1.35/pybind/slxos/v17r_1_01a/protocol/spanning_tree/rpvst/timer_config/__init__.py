...
class timer_config(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /protocol/spanning-tree/rpvst/timer-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'protocol', u'spanning-tree', u'rpvst', u'timer-config']
  ...
  def _set_hello_time(self, v, load=False):
    """
    Setter method for hello_time, mapped from YANG variable /protocol/spanning_tree/rpvst/timer_config/hello_time (uint32)
  ...
  def _set_forward_delay(self, v, load=False):
    """
    Setter method for forward_delay, mapped from YANG variable /protocol/spanning_tree/rpvst/timer_config/forward_delay (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _set_max_age(self, v, load=False):
    """
    Setter method for max_age, mapped from YANG variable /protocol/spanning_tree/rpvst/timer_config/max_age (uint32)
    If this variable is read-only (config: false) in the
