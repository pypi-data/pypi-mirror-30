...
class test_profile_params(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /protocol/cfm/y1731/test-profile/test-profile-params. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'protocol', u'cfm', u'y1731', u'test-profile', u'test-profile-params']
  ...
  def _set_direction(self, v, load=False):
    """
    Setter method for direction, mapped from YANG variable /protocol/cfm/y1731/test_profile/test_profile_params/direction (y1731-profile-direction)
  ...
  def _set_tx_interval(self, v, load=False):
    """
    Setter method for tx_interval, mapped from YANG variable /protocol/cfm/y1731/test_profile/test_profile_params/tx_interval (y1731-profile-tx-interval)
    If this variable is read-only (config: false) in the
  ...
  def _set_measurement_interval(self, v, load=False):
    """
    Setter method for measurement_interval, mapped from YANG variable /protocol/cfm/y1731/test_profile/test_profile_params/measurement_interval (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _set_cos(self, v, load=False):
    """
    Setter method for cos, mapped from YANG variable /protocol/cfm/y1731/test_profile/test_profile_params/cos (uint8)
    If this variable is read-only (config: false) in the
  ...
  def _set_tx_frame_count(self, v, load=False):
    """
    Setter method for tx_frame_count, mapped from YANG variable /protocol/cfm/y1731/test_profile/test_profile_params/tx_frame_count (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _set_timeout(self, v, load=False):
    """
    Setter method for timeout, mapped from YANG variable /protocol/cfm/y1731/test_profile/test_profile_params/timeout (uint8)
    If this variable is read-only (config: false) in the
  ...
  def _set_start(self, v, load=False):
    """
    Setter method for start, mapped from YANG variable /protocol/cfm/y1731/test_profile/test_profile_params/start (container)
    If this variable is read-only (config: false) in the
  ...
  def _set_stop(self, v, load=False):
    """
    Setter method for stop, mapped from YANG variable /protocol/cfm/y1731/test_profile/test_profile_params/stop (container)
    If this variable is read-only (config: false) in the
  ...
  def _set_slm_threshold(self, v, load=False):
    """
    Setter method for slm_threshold, mapped from YANG variable /protocol/cfm/y1731/test_profile/test_profile_params/slm_threshold (container)
    If this variable is read-only (config: false) in the
  ...
  def _set_dmm_threshold(self, v, load=False):
    """
    Setter method for dmm_threshold, mapped from YANG variable /protocol/cfm/y1731/test_profile/test_profile_params/dmm_threshold (container)
    If this variable is read-only (config: false) in the
