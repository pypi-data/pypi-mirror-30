...
class vlan_groups(PybindBase):
  ...
  def _get_grp_ip_addr(self):
    """
    Getter method for grp_ip_addr, mapped from YANG variable /igmp_snooping_state/igmp_snooping_vlans/igmp_snooping_vlans/vlan_groups/grp_ip_addr (inet:ipv4-address)
  ...
  def _set_grp_ip_addr(self, v, load=False):
    """
    Setter method for grp_ip_addr, mapped from YANG variable /igmp_snooping_state/igmp_snooping_vlans/igmp_snooping_vlans/vlan_groups/grp_ip_addr (inet:ipv4-address)
