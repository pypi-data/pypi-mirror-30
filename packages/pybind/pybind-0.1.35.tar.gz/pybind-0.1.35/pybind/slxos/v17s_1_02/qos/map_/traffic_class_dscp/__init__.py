...
import __builtin__
import traffic_class_to_dscp_mappings
class traffic_class_dscp(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-qos-mls - based on the path /qos/map/traffic-class-dscp. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__traffic_class_to_dscp_mappings',)

  _yang_name = 'traffic-class-dscp'
  _rest_name = 'traffic-class-dscp'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__traffic_class_to_dscp_mappings = YANGDynClass(base=YANGListType("from_traffic_class",traffic_class_to_dscp_mappings.traffic_class_to_dscp_mappings, yang_name="traffic-class-to-dscp-mappings", rest_name="map", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='from-traffic-class', extensions={u'tailf-common': {u'info': u'Map Traffic-Class value to DSCP value.', u'cli-no-key-completion': None, u'cli-suppress-mode': None, u'cli-suppress-list-no': None, u'cli-full-no': None, u'alt-name': u'map', u'cli-compact-syntax': None, u'cli-sequence-commands': None, u'cli-incomplete-command': None, u'callpoint': u'traffic_class_dscp_mapping'}}), is_container='list', yang_name="traffic-class-to-dscp-mappings", rest_name="map", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Map Traffic-Class value to DSCP value.', u'cli-no-key-completion': None, u'cli-suppress-mode': None, u'cli-suppress-list-no': None, u'cli-full-no': None, u'alt-name': u'map', u'cli-compact-syntax': None, u'cli-sequence-commands': None, u'cli-incomplete-command': None, u'callpoint': u'traffic_class_dscp_mapping'}}, namespace='urn:brocade.com:mgmt:brocade-qos-mls', defining_module='brocade-qos-mls', yang_type='list', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'traffic-class-dscp']
  ...
  def _get_traffic_class_to_dscp_mappings(self):
    ...
    """
    return self.__traffic_class_to_dscp_mappings
  ...
  def _set_traffic_class_to_dscp_mappings(self, v, load=False):
    ...
    try:
      ...
      raise ValueError({
          'error-string': """traffic_class_to_dscp_mappings must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("from_traffic_class",traffic_class_to_dscp_mappings.traffic_class_to_dscp_mappings, yang_name="traffic-class-to-dscp-mappings", rest_name="map", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='from-traffic-class', extensions={u'tailf-common': {u'info': u'Map Traffic-Class value to DSCP value.', u'cli-no-key-completion': None, u'cli-suppress-mode': None, u'cli-suppress-list-no': None, u'cli-full-no': None, u'alt-name': u'map', u'cli-compact-syntax': None, u'cli-sequence-commands': None, u'cli-incomplete-command': None, u'callpoint': u'traffic_class_dscp_mapping'}}), is_container='list', yang_name="traffic-class-to-dscp-mappings", rest_name="map", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Map Traffic-Class value to DSCP value.', u'cli-no-key-completion': None, u'cli-suppress-mode': None, u'cli-suppress-list-no': None, u'cli-full-no': None, u'alt-name': u'map', u'cli-compact-syntax': None, u'cli-sequence-commands': None, u'cli-incomplete-command': None, u'callpoint': u'traffic_class_dscp_mapping'}}, namespace='urn:brocade.com:mgmt:brocade-qos-mls', defining_module='brocade-qos-mls', yang_type='list', is_config=True)""",
        })

    self.__traffic_class_to_dscp_mappings = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_traffic_class_to_dscp_mappings(self):
    self.__traffic_class_to_dscp_mappings = YANGDynClass(base=YANGListType("from_traffic_class",traffic_class_to_dscp_mappings.traffic_class_to_dscp_mappings, yang_name="traffic-class-to-dscp-mappings", rest_name="map", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='from-traffic-class', extensions={u'tailf-common': {u'info': u'Map Traffic-Class value to DSCP value.', u'cli-no-key-completion': None, u'cli-suppress-mode': None, u'cli-suppress-list-no': None, u'cli-full-no': None, u'alt-name': u'map', u'cli-compact-syntax': None, u'cli-sequence-commands': None, u'cli-incomplete-command': None, u'callpoint': u'traffic_class_dscp_mapping'}}), is_container='list', yang_name="traffic-class-to-dscp-mappings", rest_name="map", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Map Traffic-Class value to DSCP value.', u'cli-no-key-completion': None, u'cli-suppress-mode': None, u'cli-suppress-list-no': None, u'cli-full-no': None, u'alt-name': u'map', u'cli-compact-syntax': None, u'cli-sequence-commands': None, u'cli-incomplete-command': None, u'callpoint': u'traffic_class_dscp_mapping'}}, namespace='urn:brocade.com:mgmt:brocade-qos-mls', defining_module='brocade-qos-mls', yang_type='list', is_config=True)

  name = __builtin__.property(_get_name, _set_name)
  traffic_class_to_dscp_mappings = __builtin__.property(_get_traffic_class_to_dscp_mappings, _set_traffic_class_to_dscp_mappings)


  _pyangbind_elements = {'name': name, 'traffic_class_to_dscp_mappings': traffic_class_to_dscp_mappings, }
