...
import __builtin__
import to
class cos_to_dscp_mappings(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-qos-mls - based on the path /qos/map/cos-dscp/cos-to-dscp-mappings. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__from_cos','__to',)

  _yang_name = 'cos-to-dscp-mappings'
  _rest_name = 'map'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'cos-dscp', u'cos-to-dscp-mappings']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'cos-dscp', u'map']

  def _get_from_cos(self):
    """
    Getter method for from_cos, mapped from YANG variable /qos/map/cos_dscp/cos_to_dscp_mappings/from_cos (cos-id-type)
    """
    return self.__from_cos
      
  def _set_from_cos(self, v, load=False):
    """
    Setter method for from_cos, mapped from YANG variable /qos/map/cos_dscp/cos_to_dscp_mappings/from_cos (cos-id-type)
  ...
  def _get_to(self):
    """
    Getter method for to, mapped from YANG variable /qos/map/cos_dscp/cos_to_dscp_mappings/to (container)
    """
    return self.__to
      
  def _set_to(self, v, load=False):
    """
    Setter method for to, mapped from YANG variable /qos/map/cos_dscp/cos_to_dscp_mappings/to (container)
    If this variable is read-only (config: false) in the
