...
class to(PybindBase):
  ...
  from YANG module brocade-qos-mls - based on the path /qos/map/traffic-class-mutation/traffic-class-mutation-mappings/to. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__to_traffic_class',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'traffic-class-mutation', u'traffic-class-mutation-mappings', u'to']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'map', u'traffic-class-mutation', u'map', u'to']
  ...
  _pyangbind_elements = {'to_traffic_class': to_traffic_class, }
