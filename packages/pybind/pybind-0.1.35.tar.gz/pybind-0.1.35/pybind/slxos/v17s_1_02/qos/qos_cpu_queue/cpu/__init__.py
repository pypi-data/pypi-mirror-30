...
class cpu(PybindBase):
  ...
  from YANG module brocade-qos-mls - based on the path /qos/qos-cpu-queue/cpu. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__queue',)
  ...
  def _get_queue(self):
    """
    Getter method for queue, mapped from YANG variable /qos/qos_cpu_queue/cpu/queue (list)
    """
    return self.__queue
      
  def _set_queue(self, v, load=False):
    """
    Setter method for queue, mapped from YANG variable /qos/qos_cpu_queue/cpu/queue (list)
