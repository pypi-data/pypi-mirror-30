...
import __builtin__
import igmp_static_groups
class igmp_static_groups_state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mc-hms-operational - based on the path /igmp-static-groups-state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Igmp Snooping Static Group Information
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__group_addr','__interface_name','__igmp_static_groups',)

  _yang_name = 'igmp-static-groups-state'
  _rest_name = 'igmp-static-groups-state'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__igmp_static_groups = YANGDynClass(base=YANGListType("group_addr interface_name",igmp_static_groups.igmp_static_groups, yang_name="igmp-static-groups", rest_name="igmp-static-groups", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='group-addr interface-name', extensions={u'tailf-common': {u'callpoint': u'mc_hms-igmp-group-igmp-static-groups-2'}}), is_container='list', yang_name="igmp-static-groups", rest_name="igmp-static-groups", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc_hms-igmp-group-igmp-static-groups-2'}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'igmp-static-groups-state']
  ...
  def _get_group_addr(self):
    """
    Getter method for group_addr, mapped from YANG variable /igmp_static_groups_state/group_addr (inet:ipv4-address)
  ...
  def _set_group_addr(self, v, load=False):
    """
    Setter method for group_addr, mapped from YANG variable /igmp_static_groups_state/group_addr (inet:ipv4-address)
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /igmp_static_groups_state/interface_name (string)
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /igmp_static_groups_state/interface_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_igmp_static_groups(self):
    ...
    """
    return self.__igmp_static_groups
      
  def _set_igmp_static_groups(self, v, load=False):
    """
    Setter method for igmp_static_groups, mapped from YANG variable /igmp_static_groups_state/igmp_static_groups (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_igmp_static_groups is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_igmp_static_groups() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      ...
      raise ValueError({
          'error-string': """igmp_static_groups must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("group_addr interface_name",igmp_static_groups.igmp_static_groups, yang_name="igmp-static-groups", rest_name="igmp-static-groups", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='group-addr interface-name', extensions={u'tailf-common': {u'callpoint': u'mc_hms-igmp-group-igmp-static-groups-2'}}), is_container='list', yang_name="igmp-static-groups", rest_name="igmp-static-groups", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc_hms-igmp-group-igmp-static-groups-2'}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=False)""",
        })

    self.__igmp_static_groups = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_igmp_static_groups(self):
    self.__igmp_static_groups = YANGDynClass(base=YANGListType("group_addr interface_name",igmp_static_groups.igmp_static_groups, yang_name="igmp-static-groups", rest_name="igmp-static-groups", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='group-addr interface-name', extensions={u'tailf-common': {u'callpoint': u'mc_hms-igmp-group-igmp-static-groups-2'}}), is_container='list', yang_name="igmp-static-groups", rest_name="igmp-static-groups", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc_hms-igmp-group-igmp-static-groups-2'}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=False)

  group_addr = __builtin__.property(_get_group_addr)
  interface_name = __builtin__.property(_get_interface_name)
  igmp_static_groups = __builtin__.property(_get_igmp_static_groups)


  _pyangbind_elements = {'group_addr': group_addr, 'interface_name': interface_name, 'igmp_static_groups': igmp_static_groups, }
