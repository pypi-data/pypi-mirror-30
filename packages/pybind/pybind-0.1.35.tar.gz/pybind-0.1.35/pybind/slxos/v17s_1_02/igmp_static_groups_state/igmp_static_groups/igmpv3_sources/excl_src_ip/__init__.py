...
class excl_src_ip(PybindBase):
  ...
  from YANG module brocade-mc-hms-operational - based on the path /igmp-static-groups-state/igmp-static-groups/igmpv3-sources/excl-src-ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'igmp-static-groups-state', u'igmp-static-groups', u'igmpv3-sources', u'excl-src-ip']
