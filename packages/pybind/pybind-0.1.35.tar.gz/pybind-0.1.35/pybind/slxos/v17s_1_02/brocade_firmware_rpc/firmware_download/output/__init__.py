...
class output(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__fwdl_cmd_status','__fwdl_cmd_msg','__fwdl_status','__fwdl_msg',)
  ...
  def _set_fwdl_status(self, v, load=False):
    """
    Setter method for fwdl_status, mapped from YANG variable /brocade_firmware_rpc/firmware_download/output/fwdl_status (int32)
    If this variable is read-only (config: false) in the
  ...
  def _set_fwdl_msg(self, v, load=False):
    """
    Setter method for fwdl_msg, mapped from YANG variable /brocade_firmware_rpc/firmware_download/output/fwdl_msg (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'fwdl_cmd_status': fwdl_cmd_status, 'fwdl_cmd_msg': fwdl_cmd_msg, 'fwdl_status': fwdl_status, 'fwdl_msg': fwdl_msg, }
