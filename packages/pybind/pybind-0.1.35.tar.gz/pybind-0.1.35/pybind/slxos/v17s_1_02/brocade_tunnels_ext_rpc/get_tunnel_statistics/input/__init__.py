...
class input(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__page_cursor','__node_id','__id','__mode','__gw_name',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__node_id = YANGDynClass(base=TypedListType(allowed_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32)), is_leaf=False, yang_name="node-id", rest_name="node-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='urn:brocade.com:mgmt:brocade-tunnels-ext', defining_module='brocade-tunnels-ext', yang_type='uint32', is_config=True)
...
this value is not present or empty.
  ...
  def _get_node_id(self):
    """
    Getter method for node_id, mapped from YANG variable /brocade_tunnels_ext_rpc/get_tunnel_statistics/input/node_id (uint32)

    YANG Description: Node from which the tunnel statistics to be
...
all nodes.
  ...
  def _set_node_id(self, v, load=False):
    """
    Setter method for node_id, mapped from YANG variable /brocade_tunnels_ext_rpc/get_tunnel_statistics/input/node_id (uint32)
    If this variable is read-only (config: false) in the
...
last-rcvd-record-id parameter is ignored.
  ...
  _pyangbind_elements = {'page_cursor': page_cursor, 'node_id': node_id, 'id': id, 'mode': mode, 'gw_name': gw_name, }
