...
class relay(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/vlan/ip/dhcp/relay. Each member element of
  ...
  def _get_information(self):
    """
    Getter method for information, mapped from YANG variable /interface_vlan/vlan/ip/dhcp/relay/information (container)
    """
    return self.__information
      
  def _set_information(self, v, load=False):
    """
    Setter method for information, mapped from YANG variable /interface_vlan/vlan/ip/dhcp/relay/information (container)
