...
class ip(PybindBase):
  ...
  def _get_dhcp(self):
    """
    Getter method for dhcp, mapped from YANG variable /interface_vlan/vlan/ip/dhcp (container)
    """
    return self.__dhcp
      
  def _set_dhcp(self, v, load=False):
    """
    Setter method for dhcp, mapped from YANG variable /interface_vlan/vlan/ip/dhcp (container)
