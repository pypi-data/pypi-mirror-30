...
class mrouter(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/vlan/ipv6/mldVlan/snooping/mrouter. Each member element of
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /interface_vlan/vlan/ipv6/mldVlan/snooping/mrouter/interface (list)
    """
    return self.__interface
      
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /interface_vlan/vlan/ipv6/mldVlan/snooping/mrouter/interface (list)
