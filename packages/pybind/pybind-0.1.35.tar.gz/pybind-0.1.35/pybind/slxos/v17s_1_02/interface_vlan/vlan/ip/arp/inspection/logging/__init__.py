...
class logging(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/vlan/ip/arp/inspection/logging. Each member element of
  ...
  def _get_acl_match(self):
    """
    Getter method for acl_match, mapped from YANG variable /interface_vlan/vlan/ip/arp/inspection/logging/acl_match (enumeration)
    """
    return self.__acl_match
      
  def _set_acl_match(self, v, load=False):
    """
    Setter method for acl_match, mapped from YANG variable /interface_vlan/vlan/ip/arp/inspection/logging/acl_match (enumeration)
