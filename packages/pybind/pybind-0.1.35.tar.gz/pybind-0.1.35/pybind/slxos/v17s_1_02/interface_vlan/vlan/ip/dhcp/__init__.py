...
class dhcp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/vlan/ip/dhcp. Each member element of
  ...
  def _get_relay(self):
    """
    Getter method for relay, mapped from YANG variable /interface_vlan/vlan/ip/dhcp/relay (container)
    """
    return self.__relay
      
  def _set_relay(self, v, load=False):
    """
    Setter method for relay, mapped from YANG variable /interface_vlan/vlan/ip/dhcp/relay (container)
