...
class igmps_querier(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/vlan/ip/igmpVlan/snooping/igmps-querier. Each member element of
  ...
  def _get_igmps_qenable(self):
    """
    Getter method for igmps_qenable, mapped from YANG variable /interface_vlan/vlan/ip/igmpVlan/snooping/igmps_querier/igmps_qenable (empty)
    """
    return self.__igmps_qenable
      
  def _set_igmps_qenable(self, v, load=False):
    """
    Setter method for igmps_qenable, mapped from YANG variable /interface_vlan/vlan/ip/igmpVlan/snooping/igmps_querier/igmps_qenable (empty)
