...
class show(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__defaults','__crypto','__fabric','__infra','__http','__telnet','__ssh','__bpswitch','__vnetwork',)
...
(standalone mode) fabric does not exist.
  ...
  _pyangbind_elements = {'defaults': defaults, 'crypto': crypto, 'fabric': fabric, 'infra': infra, 'http': http, 'telnet': telnet, 'ssh': ssh, 'bpswitch': bpswitch, 'vnetwork': vnetwork, }
