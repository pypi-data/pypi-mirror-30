...
class overlay_gateway(PybindBase):
  ...
  YANG Description: 
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__gw_type','__ip','__map_','__overlay_service_policy','__site','__activate',)
...
associated tunnels will also be inactive (oper down).
  ...
  _pyangbind_elements = {'name': name, 'gw_type': gw_type, 'ip': ip, 'map_': map_, 'overlay_service_policy': overlay_service_policy, 'site': site, 'activate': activate, }
