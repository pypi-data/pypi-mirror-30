...
import __builtin__
import vni
class vlan_and_bd(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-tunnels - based on the path /overlay-gateway/map/vlan-and-bd. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__vni',)

  _yang_name = 'vlan-and-bd'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'overlay-gateway', u'map', u'vlan-and-bd']
  ...
  def _get_vni(self):
    """
    Getter method for vni, mapped from YANG variable /overlay_gateway/map/vlan_and_bd/vni (container)
    """
    return self.__vni
      
  def _set_vni(self, v, load=False):
    """
    Setter method for vni, mapped from YANG variable /overlay_gateway/map/vlan_and_bd/vni (container)
