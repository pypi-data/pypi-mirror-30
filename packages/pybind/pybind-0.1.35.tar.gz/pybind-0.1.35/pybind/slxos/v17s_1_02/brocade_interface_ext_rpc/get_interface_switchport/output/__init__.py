...
class output(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__switchport','__has_more',)
...
fetched with another request
  ...
  _pyangbind_elements = {'switchport': switchport, 'has_more': has_more, }
