...
class last_rcvd_interface(PybindBase):
  ...
  from YANG module brocade-interface-ext - based on the path /brocade_interface_ext_rpc/get-interface-switchport/input/last-rcvd-interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_interface_ext_rpc', u'get-interface-switchport', u'input', u'last-rcvd-interface']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'get-interface-switchport', u'input', u'last-rcvd-interface']
