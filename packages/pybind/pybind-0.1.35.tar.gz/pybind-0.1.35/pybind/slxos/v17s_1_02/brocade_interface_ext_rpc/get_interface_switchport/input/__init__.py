...
class input(PybindBase):
  ...
  from YANG module brocade-interface-ext - based on the path /brocade_interface_ext_rpc/get-interface-switchport/input. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__last_rcvd_interface',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_interface_ext_rpc', u'get-interface-switchport', u'input']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'get-interface-switchport', u'input']
  ...
  __choices__ = {u'request-type': {u'get-next-request': [u'last_rcvd_interface']}}
  _pyangbind_elements = {'last_rcvd_interface': last_rcvd_interface, }
