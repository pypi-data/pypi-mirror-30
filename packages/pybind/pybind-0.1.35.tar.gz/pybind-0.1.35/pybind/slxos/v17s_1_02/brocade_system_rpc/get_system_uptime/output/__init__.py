...
class output(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__show_system_uptime = YANGDynClass(base=show_system_uptime.show_system_uptime, is_container='container', presence=False, yang_name="show-system-uptime", rest_name="show-system-uptime", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-system', defining_module='brocade-system', yang_type='container', is_config=True)
  ...
  def _get_show_system_uptime(self):
    """
    Getter method for show_system_uptime, mapped from YANG variable /brocade_system_rpc/get_system_uptime/output/show_system_uptime (container)
    """
    return self.__show_system_uptime
      
  def _set_show_system_uptime(self, v, load=False):
    """
    Setter method for show_system_uptime, mapped from YANG variable /brocade_system_rpc/get_system_uptime/output/show_system_uptime (container)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=show_system_uptime.show_system_uptime, is_container='container', presence=False, yang_name="show-system-uptime", rest_name="show-system-uptime", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-system', defining_module='brocade-system', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """show_system_uptime must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=show_system_uptime.show_system_uptime, is_container='container', presence=False, yang_name="show-system-uptime", rest_name="show-system-uptime", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-system', defining_module='brocade-system', yang_type='container', is_config=True)""",
        })
