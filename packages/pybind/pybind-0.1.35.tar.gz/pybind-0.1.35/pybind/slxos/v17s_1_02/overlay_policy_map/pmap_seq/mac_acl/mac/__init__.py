...
class mac(PybindBase):
  ...
  from YANG module brocade-overlay-policy - based on the path /overlay-policy-map/pmap-seq/mac-acl/mac. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'overlay-policy-map', u'pmap-seq', u'mac-acl', u'mac']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'overlay-policy-map', u'seq', u'mac']

  def _get_access_group(self):
    """
    Getter method for access_group, mapped from YANG variable /overlay_policy_map/pmap_seq/mac_acl/mac/access_group (container)
    """
    return self.__access_group
      
  def _set_access_group(self, v, load=False):
    """
    Setter method for access_group, mapped from YANG variable /overlay_policy_map/pmap_seq/mac_acl/mac/access_group (container)
