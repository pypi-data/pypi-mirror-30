...
import __builtin__
import mac
class mac_acl(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-overlay-policy - based on the path /overlay-policy-map/pmap-seq/mac-acl. Each member element of
  ...
  def _get_mac(self):
    """
    Getter method for mac, mapped from YANG variable /overlay_policy_map/pmap_seq/mac_acl/mac (container)
    """
    return self.__mac
      
  def _set_mac(self, v, load=False):
    """
    Setter method for mac, mapped from YANG variable /overlay_policy_map/pmap_seq/mac_acl/mac (container)
