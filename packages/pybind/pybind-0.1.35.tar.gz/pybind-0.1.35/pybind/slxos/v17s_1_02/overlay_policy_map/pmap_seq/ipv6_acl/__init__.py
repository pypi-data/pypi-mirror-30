...
class ipv6_acl(PybindBase):
  ...
  from YANG module brocade-overlay-policy - based on the path /overlay-policy-map/pmap-seq/ipv6-acl. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'overlay-policy-map', u'pmap-seq', u'ipv6-acl']
  ...
  def _get_ipv6(self):
    """
    Getter method for ipv6, mapped from YANG variable /overlay_policy_map/pmap_seq/ipv6_acl/ipv6 (container)
    """
    return self.__ipv6
      
  def _set_ipv6(self, v, load=False):
    """
    Setter method for ipv6, mapped from YANG variable /overlay_policy_map/pmap_seq/ipv6_acl/ipv6 (container)
