...
class ipv6(PybindBase):
  ...
  from YANG module brocade-overlay-policy - based on the path /overlay-policy-map/pmap-seq/ipv6-acl/ipv6. Each member element of
  ...
  def _get_access_group(self):
    """
    Getter method for access_group, mapped from YANG variable /overlay_policy_map/pmap_seq/ipv6_acl/ipv6/access_group (container)
    """
    return self.__access_group
      
  def _set_access_group(self, v, load=False):
    """
    Setter method for access_group, mapped from YANG variable /overlay_policy_map/pmap_seq/ipv6_acl/ipv6/access_group (container)
