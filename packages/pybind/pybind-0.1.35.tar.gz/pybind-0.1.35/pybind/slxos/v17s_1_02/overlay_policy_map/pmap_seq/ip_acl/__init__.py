...
class ip_acl(PybindBase):
  ...
  from YANG module brocade-overlay-policy - based on the path /overlay-policy-map/pmap-seq/ip-acl. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'overlay-policy-map', u'pmap-seq', u'ip-acl']
  ...
  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /overlay_policy_map/pmap_seq/ip_acl/ip (container)
    """
    return self.__ip
      
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /overlay_policy_map/pmap_seq/ip_acl/ip (container)
