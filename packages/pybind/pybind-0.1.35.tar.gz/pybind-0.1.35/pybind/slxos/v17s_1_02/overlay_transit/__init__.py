...
import __builtin__
import overlay_service_policy
class overlay_transit(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-overlay-policy - based on the path /overlay-transit. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__transit_name','__overlay_service_policy',)
  ...
  def _get_transit_name(self):
    """
    Getter method for transit_name, mapped from YANG variable /overlay_transit/transit_name (string)
    """
    return self.__transit_name
      
  def _set_transit_name(self, v, load=False):
    """
    Setter method for transit_name, mapped from YANG variable /overlay_transit/transit_name (string)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[a-zA-Z]{1}([-a-zA-Z0-9_]{0,62})'}), is_leaf=True, yang_name="transit-name", rest_name="transit-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Overlay Transit Name'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-overlay-policy', defining_module='brocade-overlay-policy', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """transit_name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[a-zA-Z]{1}([-a-zA-Z0-9_]{0,62})'}), is_leaf=True, yang_name="transit-name", rest_name="transit-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Overlay Transit Name'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-overlay-policy', defining_module='brocade-overlay-policy', yang_type='string', is_config=True)""",
        })
  ...
  def _get_overlay_service_policy(self):
    """
    Getter method for overlay_service_policy, mapped from YANG variable /overlay_transit/overlay_service_policy (list)
    """
    return self.__overlay_service_policy
  ...
  def _unset_overlay_service_policy(self):
    self.__overlay_service_policy = YANGDynClass(base=YANGListType("overlay_sp_direction overlay_sp_pmap_name",overlay_service_policy.overlay_service_policy, yang_name="overlay-service-policy", rest_name="overlay-service-policy", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='overlay-sp-direction overlay-sp-pmap-name', extensions={u'tailf-common': {u'info': u'Attach Overlay policy Map', u'cli-no-key-completion': None, u'cli-suppress-mode': None, u'cli-suppress-list-no': None, u'cli-suppress-key-abbreviation': None, u'callpoint': u'OverlayServicePolicyCallPoint'}}), is_container='list', yang_name="overlay-service-policy", rest_name="overlay-service-policy", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Attach Overlay policy Map', u'cli-no-key-completion': None, u'cli-suppress-mode': None, u'cli-suppress-list-no': None, u'cli-suppress-key-abbreviation': None, u'callpoint': u'OverlayServicePolicyCallPoint'}}, namespace='urn:brocade.com:mgmt:brocade-overlay-policy', defining_module='brocade-overlay-policy', yang_type='list', is_config=True)

  transit_name = __builtin__.property(_get_transit_name, _set_transit_name)
  overlay_service_policy = __builtin__.property(_get_overlay_service_policy, _set_overlay_service_policy)


  _pyangbind_elements = {'transit_name': transit_name, 'overlay_service_policy': overlay_service_policy, }
