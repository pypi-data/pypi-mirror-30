...
class show_cluster_mctd_client(PybindBase):
  ...
  def _get_tunnel_type(self):
    """
    Getter method for tunnel_type, mapped from YANG variable /mctd_client_state_state/show_cluster_mctd_client/tunnel_type (uint32)
  ...
  def _set_tunnel_type(self, v, load=False):
    """
    Setter method for tunnel_type, mapped from YANG variable /mctd_client_state_state/show_cluster_mctd_client/tunnel_type (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_tunnel_status(self):
    """
    Getter method for tunnel_status, mapped from YANG variable /mctd_client_state_state/show_cluster_mctd_client/tunnel_status (uint32)
  ...
  def _set_tunnel_status(self, v, load=False):
    """
    Setter method for tunnel_status, mapped from YANG variable /mctd_client_state_state/show_cluster_mctd_client/tunnel_status (uint32)
    If this variable is read-only (config: false) in the
