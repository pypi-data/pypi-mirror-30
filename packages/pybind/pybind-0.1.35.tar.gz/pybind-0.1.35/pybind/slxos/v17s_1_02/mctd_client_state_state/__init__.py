...
class mctd_client_state_state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__show_cluster_mctd_client',)
  ...
  _pyangbind_elements = {'show_cluster_mctd_client': show_cluster_mctd_client, }
