...
class ethernet(PybindBase):
  ...
  from YANG module brocade-rbridge-lag - based on the path /load-balance/hash/ethernet. Each member element of
  ...
  def _get_sa_mac(self):
    """
    Getter method for sa_mac, mapped from YANG variable /load_balance/hash/ethernet/sa_mac (empty)
    """
    return self.__sa_mac
      
  def _set_sa_mac(self, v, load=False):
    """
    Setter method for sa_mac, mapped from YANG variable /load_balance/hash/ethernet/sa_mac (empty)
  ...
  def _get_da_mac(self):
    """
    Getter method for da_mac, mapped from YANG variable /load_balance/hash/ethernet/da_mac (empty)
    """
    return self.__da_mac
      
  def _set_da_mac(self, v, load=False):
    """
    Setter method for da_mac, mapped from YANG variable /load_balance/hash/ethernet/da_mac (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /load_balance/hash/ethernet/vlan (empty)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /load_balance/hash/ethernet/vlan (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_etype(self):
    """
    Getter method for etype, mapped from YANG variable /load_balance/hash/ethernet/etype (empty)
    """
    return self.__etype
      
  def _set_etype(self, v, load=False):
    """
    Setter method for etype, mapped from YANG variable /load_balance/hash/ethernet/etype (empty)
    If this variable is read-only (config: false) in the
