...
class ipv6(PybindBase):
  ...
  from YANG module brocade-rbridge-lag - based on the path /load-balance/hash/ipv6. Each member element of
  ...
  def _get_ipv6_src_l4_port(self):
    """
    Getter method for ipv6_src_l4_port, mapped from YANG variable /load_balance/hash/ipv6/ipv6_src_l4_port (empty)
    """
    return self.__ipv6_src_l4_port
      
  def _set_ipv6_src_l4_port(self, v, load=False):
    """
    Setter method for ipv6_src_l4_port, mapped from YANG variable /load_balance/hash/ipv6/ipv6_src_l4_port (empty)
  ...
  def _get_ipv6_dst_l4_port(self):
    """
    Getter method for ipv6_dst_l4_port, mapped from YANG variable /load_balance/hash/ipv6/ipv6_dst_l4_port (empty)
    """
    return self.__ipv6_dst_l4_port
      
  def _set_ipv6_dst_l4_port(self, v, load=False):
    """
    Setter method for ipv6_dst_l4_port, mapped from YANG variable /load_balance/hash/ipv6/ipv6_dst_l4_port (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv6_src_ip(self):
    """
    Getter method for ipv6_src_ip, mapped from YANG variable /load_balance/hash/ipv6/ipv6_src_ip (empty)
    """
    return self.__ipv6_src_ip
      
  def _set_ipv6_src_ip(self, v, load=False):
    """
    Setter method for ipv6_src_ip, mapped from YANG variable /load_balance/hash/ipv6/ipv6_src_ip (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv6_dst_ip(self):
    """
    Getter method for ipv6_dst_ip, mapped from YANG variable /load_balance/hash/ipv6/ipv6_dst_ip (empty)
    """
    return self.__ipv6_dst_ip
      
  def _set_ipv6_dst_ip(self, v, load=False):
    """
    Setter method for ipv6_dst_ip, mapped from YANG variable /load_balance/hash/ipv6/ipv6_dst_ip (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv6_next_hdr(self):
    """
    Getter method for ipv6_next_hdr, mapped from YANG variable /load_balance/hash/ipv6/ipv6_next_hdr (empty)
    """
    return self.__ipv6_next_hdr
      
  def _set_ipv6_next_hdr(self, v, load=False):
    """
    Setter method for ipv6_next_hdr, mapped from YANG variable /load_balance/hash/ipv6/ipv6_next_hdr (empty)
    If this variable is read-only (config: false) in the
