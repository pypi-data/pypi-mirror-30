...
class mpls(PybindBase):
  ...
  from YANG module brocade-rbridge-lag - based on the path /load-balance/hash/mpls. Each member element of
  ...
  def _get_label1(self):
    """
    Getter method for label1, mapped from YANG variable /load_balance/hash/mpls/label1 (empty)
    """
    return self.__label1
      
  def _set_label1(self, v, load=False):
    """
    Setter method for label1, mapped from YANG variable /load_balance/hash/mpls/label1 (empty)
  ...
  def _get_label2(self):
    """
    Getter method for label2, mapped from YANG variable /load_balance/hash/mpls/label2 (empty)
    """
    return self.__label2
      
  def _set_label2(self, v, load=False):
    """
    Setter method for label2, mapped from YANG variable /load_balance/hash/mpls/label2 (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_label3(self):
    """
    Getter method for label3, mapped from YANG variable /load_balance/hash/mpls/label3 (empty)
    """
    return self.__label3
      
  def _set_label3(self, v, load=False):
    """
    Setter method for label3, mapped from YANG variable /load_balance/hash/mpls/label3 (empty)
    If this variable is read-only (config: false) in the
