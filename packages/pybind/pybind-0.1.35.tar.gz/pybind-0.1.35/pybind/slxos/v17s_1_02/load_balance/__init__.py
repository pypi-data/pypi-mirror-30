...
import __builtin__
import hash
import po_load_balance
class load_balance(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge-lag - based on the path /load-balance. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__hash','__po_load_balance',)
  ...
  def _get_hash(self):
    """
    Getter method for hash, mapped from YANG variable /load_balance/hash (container)
    """
    return self.__hash
  ...
  def _get_po_load_balance(self):
    """
    Getter method for po_load_balance, mapped from YANG variable /load_balance/po_load_balance (container)
    """
    return self.__po_load_balance
      
  def _set_po_load_balance(self, v, load=False):
    """
    Setter method for po_load_balance, mapped from YANG variable /load_balance/po_load_balance (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_po_load_balance is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_po_load_balance() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  _pyangbind_elements = {'hash': hash, 'po_load_balance': po_load_balance, }
