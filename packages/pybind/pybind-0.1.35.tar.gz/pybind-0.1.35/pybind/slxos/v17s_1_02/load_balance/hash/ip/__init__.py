...
class ip(PybindBase):
  ...
  from YANG module brocade-rbridge-lag - based on the path /load-balance/hash/ip. Each member element of
  ...
  def _get_src_l4_port(self):
    """
    Getter method for src_l4_port, mapped from YANG variable /load_balance/hash/ip/src_l4_port (empty)
    """
    return self.__src_l4_port
      
  def _set_src_l4_port(self, v, load=False):
    """
    Setter method for src_l4_port, mapped from YANG variable /load_balance/hash/ip/src_l4_port (empty)
  ...
  def _get_dst_l4_port(self):
    """
    Getter method for dst_l4_port, mapped from YANG variable /load_balance/hash/ip/dst_l4_port (empty)
    """
    return self.__dst_l4_port
      
  def _set_dst_l4_port(self, v, load=False):
    """
    Setter method for dst_l4_port, mapped from YANG variable /load_balance/hash/ip/dst_l4_port (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_src_ip(self):
    """
    Getter method for src_ip, mapped from YANG variable /load_balance/hash/ip/src_ip (empty)
    """
    return self.__src_ip
      
  def _set_src_ip(self, v, load=False):
    """
    Setter method for src_ip, mapped from YANG variable /load_balance/hash/ip/src_ip (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_dst_ip(self):
    """
    Getter method for dst_ip, mapped from YANG variable /load_balance/hash/ip/dst_ip (empty)
    """
    return self.__dst_ip
      
  def _set_dst_ip(self, v, load=False):
    """
    Setter method for dst_ip, mapped from YANG variable /load_balance/hash/ip/dst_ip (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_protocol(self):
    """
    Getter method for protocol, mapped from YANG variable /load_balance/hash/ip/protocol (empty)
    """
    return self.__protocol
      
  def _set_protocol(self, v, load=False):
    """
    Setter method for protocol, mapped from YANG variable /load_balance/hash/ip/protocol (empty)
    If this variable is read-only (config: false) in the
