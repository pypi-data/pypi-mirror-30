...
class hash(PybindBase):
  ...
  from YANG module brocade-rbridge-lag - based on the path /load-balance/hash. Each member element of
  ...
  def _get_ethernet(self):
    """
    Getter method for ethernet, mapped from YANG variable /load_balance/hash/ethernet (container)
    """
    return self.__ethernet
      
  def _set_ethernet(self, v, load=False):
    """
    Setter method for ethernet, mapped from YANG variable /load_balance/hash/ethernet (container)
  ...
  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /load_balance/hash/ip (container)
    """
    return self.__ip
      
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /load_balance/hash/ip (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv6(self):
    """
    Getter method for ipv6, mapped from YANG variable /load_balance/hash/ipv6 (container)
    """
    return self.__ipv6
      
  def _set_ipv6(self, v, load=False):
    """
    Setter method for ipv6, mapped from YANG variable /load_balance/hash/ipv6 (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_mpls(self):
    """
    Getter method for mpls, mapped from YANG variable /load_balance/hash/mpls (container)
    """
    return self.__mpls
      
  def _set_mpls(self, v, load=False):
    """
    Setter method for mpls, mapped from YANG variable /load_balance/hash/mpls (container)
    If this variable is read-only (config: false) in the
