...
import __builtin__
import predefined
class overlay_visibility(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-hardware - based on the path /hardware/profile/overlay-visibility. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__predefined',)

  _yang_name = 'overlay-visibility'
  _rest_name = 'overlay-visibility'
  ...
  def _set_predefined(self, v, load=False):
    """
    Setter method for predefined, mapped from YANG variable /hardware/profile/overlay_visibility/predefined (container)
