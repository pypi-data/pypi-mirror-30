...
class mstp(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__timer_config','__description','__cluster_system_id','__bridge_priority','__error_disable_timeout','__port_channel','__shutdown','__cisco_interoperability','__instance','__region','__revision','__max_hops','__transmit_holdcount',)
  ...
  def _get_cluster_system_id(self):
    """
    Getter method for cluster_system_id, mapped from YANG variable /protocol/spanning_tree/mstp/cluster_system_id (uint8)
...
can be changed via this configuration.
  ...
  def _set_cluster_system_id(self, v, load=False):
    """
    Setter method for cluster_system_id, mapped from YANG variable /protocol/spanning_tree/mstp/cluster_system_id (uint8)
    If this variable is read-only (config: false) in the
...
can be changed via this configuration.
  ...
  _pyangbind_elements = {'timer_config': timer_config, 'description': description, 'cluster_system_id': cluster_system_id, 'bridge_priority': bridge_priority, 'error_disable_timeout': error_disable_timeout, 'port_channel': port_channel, 'shutdown': shutdown, 'cisco_interoperability': cisco_interoperability, 'instance': instance, 'region': region, 'revision': revision, 'max_hops': max_hops, 'transmit_holdcount': transmit_holdcount, }
