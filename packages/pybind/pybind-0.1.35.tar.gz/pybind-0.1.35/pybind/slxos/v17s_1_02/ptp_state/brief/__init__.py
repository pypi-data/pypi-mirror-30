...
import __builtin__
import port_detail_list
class brief(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ptp-operational - based on the path /ptp-state/brief. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: 
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__port_detail_list',)
  ...
  def _get_port_detail_list(self):
    ...
    """
    return self.__port_detail_list
      
  def _set_port_detail_list(self, v, load=False):
    """
    Setter method for port_detail_list, mapped from YANG variable /ptp_state/brief/port_detail_list (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_port_detail_list is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_port_detail_list() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  _pyangbind_elements = {'port_detail_list': port_detail_list, }
