...
level commands
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__ha = YANGDynClass(base=ha.ha, is_container='container', presence=False, yang_name="ha", rest_name="ha", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'High availability Configuration', u'cli-add-mode': None, u'hidden': u'full', u'cli-suppress-no': None, u'cli-full-command': None}}, namespace='urn:brocade.com:mgmt:brocade-ha', defining_module='brocade-ha', yang_type='container', is_config=True)
...
class brocade_mc_hms_operational(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__igmp_static_groups_state = YANGDynClass(base=YANGListType("group_addr interface_name",igmp_static_groups_state.igmp_static_groups_state, yang_name="igmp-static-groups-state", rest_name="igmp-static-groups-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='group-addr interface-name', extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-static-groups', u'cli-suppress-show-path': None}}), is_container='list', yang_name="igmp-static-groups-state", rest_name="igmp-static-groups-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-static-groups', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=True)
...
import acl_state
import cpu_queue_info_state
import filter_info_state
import overlay_service_policy_brief_state
import overlay_transit_state
import vxlan_stats_acl_state
import cpu_queue_id_info_state
import overlay_class_map_state
import overlay_class_map_get_next_cookie_state
import overlay_policy_map_state
import overlay_policy_map_get_next_cookie_state
import overlay_service_policy_state
import overlay_service_policy_get_next_cookie_state
class brocade_ssm_operational(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__acl_state','__cpu_queue_info_state','__filter_info_state','__overlay_service_policy_brief_state','__overlay_transit_state','__vxlan_stats_acl_state','__cpu_queue_id_info_state','__overlay_class_map_state','__overlay_class_map_get_next_cookie_state','__overlay_policy_map_state','__overlay_policy_map_get_next_cookie_state','__overlay_service_policy_state','__overlay_service_policy_get_next_cookie_state',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__cpu_queue_id_info_state = YANGDynClass(base=YANGListType("queue_range",cpu_queue_id_info_state.cpu_queue_id_info_state, yang_name="cpu-queue-id-info-state", rest_name="cpu-queue-id-info-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='queue-range', extensions={u'tailf-common': {u'callpoint': u'ssm-cpu-queue-id-info', u'cli-suppress-show-path': None}}), is_container='list', yang_name="cpu-queue-id-info-state", rest_name="cpu-queue-id-info-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-cpu-queue-id-info', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)
    self.__filter_info_state = YANGDynClass(base=filter_info_state.filter_info_state, is_container='container', presence=False, yang_name="filter-info-state", rest_name="filter-info-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-filter-info', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='container', is_config=True)
    self.__cpu_queue_info_state = YANGDynClass(base=cpu_queue_info_state.cpu_queue_info_state, is_container='container', presence=False, yang_name="cpu-queue-info-state", rest_name="cpu-queue-info-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-cpu-queue-info', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='container', is_config=True)
    self.__overlay_service_policy_brief_state = YANGDynClass(base=overlay_service_policy_brief_state.overlay_service_policy_brief_state, is_container='container', presence=False, yang_name="overlay-service-policy-brief-state", rest_name="overlay-service-policy-brief-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy-brief', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='container', is_config=True)
    self.__overlay_policy_map_get_next_cookie_state = YANGDynClass(base=YANGListType("seq_id",overlay_policy_map_get_next_cookie_state.overlay_policy_map_get_next_cookie_state, yang_name="overlay-policy-map-get-next-cookie-state", rest_name="overlay-policy-map-get-next-cookie-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='seq-id', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-policy-map-get-next-cookie', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-policy-map-get-next-cookie-state", rest_name="overlay-policy-map-get-next-cookie-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-policy-map-get-next-cookie', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)
    self.__overlay_transit_state = YANGDynClass(base=overlay_transit_state.overlay_transit_state, is_container='container', presence=False, yang_name="overlay-transit-state", rest_name="overlay-transit-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-transit', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='container', is_config=True)
    self.__vxlan_stats_acl_state = YANGDynClass(base=vxlan_stats_acl_state.vxlan_stats_acl_state, is_container='container', presence=False, yang_name="vxlan-stats-acl-state", rest_name="vxlan-stats-acl-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-vxlan-stats-acl', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='container', is_config=True)
    self.__overlay_service_policy_get_next_cookie_state = YANGDynClass(base=YANGListType("seq_id",overlay_service_policy_get_next_cookie_state.overlay_service_policy_get_next_cookie_state, yang_name="overlay-service-policy-get-next-cookie-state", rest_name="overlay-service-policy-get-next-cookie-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='seq-id', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy-get-next-cookie', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-service-policy-get-next-cookie-state", rest_name="overlay-service-policy-get-next-cookie-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy-get-next-cookie', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)
    self.__overlay_policy_map_state = YANGDynClass(base=YANGListType("policy_name",overlay_policy_map_state.overlay_policy_map_state, yang_name="overlay-policy-map-state", rest_name="overlay-policy-map-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='policy-name', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-policy-map', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-policy-map-state", rest_name="overlay-policy-map-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-policy-map', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)
    self.__overlay_class_map_state = YANGDynClass(base=YANGListType("class_map_name",overlay_class_map_state.overlay_class_map_state, yang_name="overlay-class-map-state", rest_name="overlay-class-map-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='class-map-name', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-class-map', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-class-map-state", rest_name="overlay-class-map-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-class-map', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)
    self.__overlay_class_map_get_next_cookie_state = YANGDynClass(base=YANGListType("class_map_name",overlay_class_map_get_next_cookie_state.overlay_class_map_get_next_cookie_state, yang_name="overlay-class-map-get-next-cookie-state", rest_name="overlay-class-map-get-next-cookie-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='class-map-name', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-class-map-get-next-cookie', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-class-map-get-next-cookie-state", rest_name="overlay-class-map-get-next-cookie-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-class-map-get-next-cookie', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)
    self.__overlay_service_policy_state = YANGDynClass(base=YANGListType("policy_name",overlay_service_policy_state.overlay_service_policy_state, yang_name="overlay-service-policy-state", rest_name="overlay-service-policy-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='policy-name', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-service-policy-state", rest_name="overlay-service-policy-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)
    self.__acl_state = YANGDynClass(base=acl_state.acl_state, is_container='container', presence=False, yang_name="acl-state", rest_name="acl-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-acl', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='container', is_config=True)
  ...
  def _get_cpu_queue_info_state(self):
    """
    Getter method for cpu_queue_info_state, mapped from YANG variable /cpu_queue_info_state (container)

    YANG Description: QoS CPU Queue info
    """
    return self.__cpu_queue_info_state
  ...
  def _unset_cpu_queue_info_state(self):
    self.__cpu_queue_info_state = YANGDynClass(base=cpu_queue_info_state.cpu_queue_info_state, is_container='container', presence=False, yang_name="cpu-queue-info-state", rest_name="cpu-queue-info-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-cpu-queue-info', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='container', is_config=True)


  def _get_filter_info_state(self):
    """
    Getter method for filter_info_state, mapped from YANG variable /filter_info_state (container)

    YANG Description: Filter Info
    """
    return self.__filter_info_state
      
  def _set_filter_info_state(self, v, load=False):
    """
  ...
  def _unset_filter_info_state(self):
    self.__filter_info_state = YANGDynClass(base=filter_info_state.filter_info_state, is_container='container', presence=False, yang_name="filter-info-state", rest_name="filter-info-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-filter-info', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='container', is_config=True)


  def _get_overlay_service_policy_brief_state(self):
    """
    Getter method for overlay_service_policy_brief_state, mapped from YANG variable /overlay_service_policy_brief_state (container)

    YANG Description: Overlay Service Policy Brief
    """
    return self.__overlay_service_policy_brief_state
  ...
  def _unset_overlay_service_policy_brief_state(self):
    self.__overlay_service_policy_brief_state = YANGDynClass(base=overlay_service_policy_brief_state.overlay_service_policy_brief_state, is_container='container', presence=False, yang_name="overlay-service-policy-brief-state", rest_name="overlay-service-policy-brief-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy-brief', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='container', is_config=True)
  ...
  def _get_cpu_queue_id_info_state(self):
    """
    Getter method for cpu_queue_id_info_state, mapped from YANG variable /cpu_queue_id_info_state (list)

    YANG Description: QoS CPU Queue Id frame-rate
    """
    return self.__cpu_queue_id_info_state
      
  def _set_cpu_queue_id_info_state(self, v, load=False):
    """
    Setter method for cpu_queue_id_info_state, mapped from YANG variable /cpu_queue_id_info_state (list)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """cpu_queue_id_info_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("queue_range",cpu_queue_id_info_state.cpu_queue_id_info_state, yang_name="cpu-queue-id-info-state", rest_name="cpu-queue-id-info-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='queue-range', extensions={u'tailf-common': {u'callpoint': u'ssm-cpu-queue-id-info', u'cli-suppress-show-path': None}}), is_container='list', yang_name="cpu-queue-id-info-state", rest_name="cpu-queue-id-info-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-cpu-queue-id-info', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)""",
        })

    self.__cpu_queue_id_info_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_cpu_queue_id_info_state(self):
    self.__cpu_queue_id_info_state = YANGDynClass(base=YANGListType("queue_range",cpu_queue_id_info_state.cpu_queue_id_info_state, yang_name="cpu-queue-id-info-state", rest_name="cpu-queue-id-info-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='queue-range', extensions={u'tailf-common': {u'callpoint': u'ssm-cpu-queue-id-info', u'cli-suppress-show-path': None}}), is_container='list', yang_name="cpu-queue-id-info-state", rest_name="cpu-queue-id-info-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-cpu-queue-id-info', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)


  def _get_overlay_class_map_state(self):
    """
    Getter method for overlay_class_map_state, mapped from YANG variable /overlay_class_map_state (list)

    YANG Description: Overlay Class Map
    """
    return self.__overlay_class_map_state
      
  def _set_overlay_class_map_state(self, v, load=False):
    """
    Setter method for overlay_class_map_state, mapped from YANG variable /overlay_class_map_state (list)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """overlay_class_map_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("class_map_name",overlay_class_map_state.overlay_class_map_state, yang_name="overlay-class-map-state", rest_name="overlay-class-map-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='class-map-name', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-class-map', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-class-map-state", rest_name="overlay-class-map-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-class-map', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)""",
        })

    self.__overlay_class_map_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_overlay_class_map_state(self):
    self.__overlay_class_map_state = YANGDynClass(base=YANGListType("class_map_name",overlay_class_map_state.overlay_class_map_state, yang_name="overlay-class-map-state", rest_name="overlay-class-map-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='class-map-name', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-class-map', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-class-map-state", rest_name="overlay-class-map-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-class-map', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)


  def _get_overlay_class_map_get_next_cookie_state(self):
    """
    Getter method for overlay_class_map_get_next_cookie_state, mapped from YANG variable /overlay_class_map_get_next_cookie_state (list)

    YANG Description: Overlay Class Map Get Next Cookie
    """
    return self.__overlay_class_map_get_next_cookie_state
      
  def _set_overlay_class_map_get_next_cookie_state(self, v, load=False):
    """
    Setter method for overlay_class_map_get_next_cookie_state, mapped from YANG variable /overlay_class_map_get_next_cookie_state (list)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """overlay_class_map_get_next_cookie_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("class_map_name",overlay_class_map_get_next_cookie_state.overlay_class_map_get_next_cookie_state, yang_name="overlay-class-map-get-next-cookie-state", rest_name="overlay-class-map-get-next-cookie-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='class-map-name', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-class-map-get-next-cookie', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-class-map-get-next-cookie-state", rest_name="overlay-class-map-get-next-cookie-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-class-map-get-next-cookie', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)""",
        })

    self.__overlay_class_map_get_next_cookie_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_overlay_class_map_get_next_cookie_state(self):
    self.__overlay_class_map_get_next_cookie_state = YANGDynClass(base=YANGListType("class_map_name",overlay_class_map_get_next_cookie_state.overlay_class_map_get_next_cookie_state, yang_name="overlay-class-map-get-next-cookie-state", rest_name="overlay-class-map-get-next-cookie-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='class-map-name', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-class-map-get-next-cookie', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-class-map-get-next-cookie-state", rest_name="overlay-class-map-get-next-cookie-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-class-map-get-next-cookie', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)


  def _get_overlay_policy_map_state(self):
    """
    Getter method for overlay_policy_map_state, mapped from YANG variable /overlay_policy_map_state (list)

    YANG Description: Overlay Policy Map
    """
    return self.__overlay_policy_map_state
      
  def _set_overlay_policy_map_state(self, v, load=False):
    """
    Setter method for overlay_policy_map_state, mapped from YANG variable /overlay_policy_map_state (list)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """overlay_policy_map_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("policy_name",overlay_policy_map_state.overlay_policy_map_state, yang_name="overlay-policy-map-state", rest_name="overlay-policy-map-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='policy-name', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-policy-map', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-policy-map-state", rest_name="overlay-policy-map-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-policy-map', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)""",
        })

    self.__overlay_policy_map_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_overlay_policy_map_state(self):
    self.__overlay_policy_map_state = YANGDynClass(base=YANGListType("policy_name",overlay_policy_map_state.overlay_policy_map_state, yang_name="overlay-policy-map-state", rest_name="overlay-policy-map-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='policy-name', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-policy-map', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-policy-map-state", rest_name="overlay-policy-map-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-policy-map', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)


  def _get_overlay_policy_map_get_next_cookie_state(self):
    """
    Getter method for overlay_policy_map_get_next_cookie_state, mapped from YANG variable /overlay_policy_map_get_next_cookie_state (list)

    YANG Description: Overlay Policy Map Get Next Cookie
    """
    return self.__overlay_policy_map_get_next_cookie_state
      
  def _set_overlay_policy_map_get_next_cookie_state(self, v, load=False):
    """
    Setter method for overlay_policy_map_get_next_cookie_state, mapped from YANG variable /overlay_policy_map_get_next_cookie_state (list)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """overlay_policy_map_get_next_cookie_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("seq_id",overlay_policy_map_get_next_cookie_state.overlay_policy_map_get_next_cookie_state, yang_name="overlay-policy-map-get-next-cookie-state", rest_name="overlay-policy-map-get-next-cookie-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='seq-id', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-policy-map-get-next-cookie', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-policy-map-get-next-cookie-state", rest_name="overlay-policy-map-get-next-cookie-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-policy-map-get-next-cookie', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)""",
        })

    self.__overlay_policy_map_get_next_cookie_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_overlay_policy_map_get_next_cookie_state(self):
    self.__overlay_policy_map_get_next_cookie_state = YANGDynClass(base=YANGListType("seq_id",overlay_policy_map_get_next_cookie_state.overlay_policy_map_get_next_cookie_state, yang_name="overlay-policy-map-get-next-cookie-state", rest_name="overlay-policy-map-get-next-cookie-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='seq-id', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-policy-map-get-next-cookie', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-policy-map-get-next-cookie-state", rest_name="overlay-policy-map-get-next-cookie-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-policy-map-get-next-cookie', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)


  def _get_overlay_service_policy_state(self):
    """
    Getter method for overlay_service_policy_state, mapped from YANG variable /overlay_service_policy_state (list)

    YANG Description: Overlay Service Policy
    """
    return self.__overlay_service_policy_state
      
  def _set_overlay_service_policy_state(self, v, load=False):
    """
    Setter method for overlay_service_policy_state, mapped from YANG variable /overlay_service_policy_state (list)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """overlay_service_policy_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("policy_name",overlay_service_policy_state.overlay_service_policy_state, yang_name="overlay-service-policy-state", rest_name="overlay-service-policy-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='policy-name', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-service-policy-state", rest_name="overlay-service-policy-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)""",
        })

    self.__overlay_service_policy_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_overlay_service_policy_state(self):
    self.__overlay_service_policy_state = YANGDynClass(base=YANGListType("policy_name",overlay_service_policy_state.overlay_service_policy_state, yang_name="overlay-service-policy-state", rest_name="overlay-service-policy-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='policy-name', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-service-policy-state", rest_name="overlay-service-policy-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)


  def _get_overlay_service_policy_get_next_cookie_state(self):
    """
    Getter method for overlay_service_policy_get_next_cookie_state, mapped from YANG variable /overlay_service_policy_get_next_cookie_state (list)

    YANG Description: Overlay Service Policy Get Next Cookie
    """
    return self.__overlay_service_policy_get_next_cookie_state
      
  def _set_overlay_service_policy_get_next_cookie_state(self, v, load=False):
    """
    Setter method for overlay_service_policy_get_next_cookie_state, mapped from YANG variable /overlay_service_policy_get_next_cookie_state (list)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """overlay_service_policy_get_next_cookie_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("seq_id",overlay_service_policy_get_next_cookie_state.overlay_service_policy_get_next_cookie_state, yang_name="overlay-service-policy-get-next-cookie-state", rest_name="overlay-service-policy-get-next-cookie-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='seq-id', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy-get-next-cookie', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-service-policy-get-next-cookie-state", rest_name="overlay-service-policy-get-next-cookie-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy-get-next-cookie', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)""",
        })

    self.__overlay_service_policy_get_next_cookie_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_overlay_service_policy_get_next_cookie_state(self):
    self.__overlay_service_policy_get_next_cookie_state = YANGDynClass(base=YANGListType("seq_id",overlay_service_policy_get_next_cookie_state.overlay_service_policy_get_next_cookie_state, yang_name="overlay-service-policy-get-next-cookie-state", rest_name="overlay-service-policy-get-next-cookie-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='seq-id', extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy-get-next-cookie', u'cli-suppress-show-path': None}}), is_container='list', yang_name="overlay-service-policy-get-next-cookie-state", rest_name="overlay-service-policy-get-next-cookie-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'ssm-overlay-service-policy-get-next-cookie', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-ssm-operational', defining_module='brocade-ssm-operational', yang_type='list', is_config=True)

  acl_state = __builtin__.property(_get_acl_state, _set_acl_state)
  cpu_queue_info_state = __builtin__.property(_get_cpu_queue_info_state, _set_cpu_queue_info_state)
  filter_info_state = __builtin__.property(_get_filter_info_state, _set_filter_info_state)
  overlay_service_policy_brief_state = __builtin__.property(_get_overlay_service_policy_brief_state, _set_overlay_service_policy_brief_state)
  ...
  cpu_queue_id_info_state = __builtin__.property(_get_cpu_queue_id_info_state, _set_cpu_queue_id_info_state)
  overlay_class_map_state = __builtin__.property(_get_overlay_class_map_state, _set_overlay_class_map_state)
  overlay_class_map_get_next_cookie_state = __builtin__.property(_get_overlay_class_map_get_next_cookie_state, _set_overlay_class_map_get_next_cookie_state)
  overlay_policy_map_state = __builtin__.property(_get_overlay_policy_map_state, _set_overlay_policy_map_state)
  overlay_policy_map_get_next_cookie_state = __builtin__.property(_get_overlay_policy_map_get_next_cookie_state, _set_overlay_policy_map_get_next_cookie_state)
  overlay_service_policy_state = __builtin__.property(_get_overlay_service_policy_state, _set_overlay_service_policy_state)
  overlay_service_policy_get_next_cookie_state = __builtin__.property(_get_overlay_service_policy_get_next_cookie_state, _set_overlay_service_policy_get_next_cookie_state)


  _pyangbind_elements = {'acl_state': acl_state, 'cpu_queue_info_state': cpu_queue_info_state, 'filter_info_state': filter_info_state, 'overlay_service_policy_brief_state': overlay_service_policy_brief_state, 'overlay_transit_state': overlay_transit_state, 'vxlan_stats_acl_state': vxlan_stats_acl_state, 'cpu_queue_id_info_state': cpu_queue_id_info_state, 'overlay_class_map_state': overlay_class_map_state, 'overlay_class_map_get_next_cookie_state': overlay_class_map_get_next_cookie_state, 'overlay_policy_map_state': overlay_policy_map_state, 'overlay_policy_map_get_next_cookie_state': overlay_policy_map_get_next_cookie_state, 'overlay_service_policy_state': overlay_service_policy_state, 'overlay_service_policy_get_next_cookie_state': overlay_service_policy_get_next_cookie_state, }
...
feature.
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__maps = YANGDynClass(base=maps.maps, is_container='container', presence=False, yang_name="maps", rest_name="maps", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'All MAPS mode related commands.', u'cli-suppress-no': None, u'cli-full-command': None, u'cli-add-mode': None, u'hidden': u'full', u'cli-mode-name': u'config-maps'}}, namespace='urn:brocade.com:mgmt:brocade-maps', defining_module='brocade-maps', yang_type='container', is_config=True)
...
class brocade_nsm_operational(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__tvf_domain_list_state = YANGDynClass(base=YANGListType("domain_count",tvf_domain_list_state.tvf_domain_list_state, yang_name="tvf-domain-list-state", rest_name="tvf-domain-list-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='domain-count', extensions={u'tailf-common': {u'callpoint': u'nsm-tvf-domain-list', u'cli-suppress-show-path': None}}), is_container='list', yang_name="tvf-domain-list-state", rest_name="tvf-domain-list-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-tvf-domain-list', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=True)
    ...
    self.__link_fault_signalling_counters_state = YANGDynClass(base=YANGListType("name",link_fault_signalling_counters_state.link_fault_signalling_counters_state, yang_name="link-fault-signalling-counters-state", rest_name="link-fault-signalling-counters-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='name', extensions={u'tailf-common': {u'callpoint': u'nsm-link-fault-signalling-counters', u'cli-suppress-show-path': None}}), is_container='list', yang_name="link-fault-signalling-counters-state", rest_name="link-fault-signalling-counters-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-link-fault-signalling-counters', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=True)
