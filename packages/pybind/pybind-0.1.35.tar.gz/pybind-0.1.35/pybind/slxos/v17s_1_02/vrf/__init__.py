...
class vrf(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__vrf_name','__route_distiniguisher','__evpn','__route_target','__address_family','__ip',)
...
in NOS4.0.0 release
  ...
  _pyangbind_elements = {'vrf_name': vrf_name, 'route_distiniguisher': route_distiniguisher, 'evpn': evpn, 'route_target': route_target, 'address_family': address_family, 'ip': ip, }
