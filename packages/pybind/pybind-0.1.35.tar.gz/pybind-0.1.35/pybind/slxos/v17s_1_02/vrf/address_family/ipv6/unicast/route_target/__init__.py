...
class route_target(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ipv6/unicast/route-target. Each member element of
  ...
  def _set_action(self, v, load=False):
    """
    Setter method for action, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_target/action (enumeration)
  ...
  def _get_target_community(self):
    """
    Getter method for target_community, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_target/target_community (rt-type)
  ...
  def _set_target_community(self, v, load=False):
    """
    Setter method for target_community, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_target/target_community (rt-type)
    If this variable is read-only (config: false) in the
  ...
  def _set_evpn(self, v, load=False):
    """
    Setter method for evpn, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_target/evpn (empty)
    If this variable is read-only (config: false) in the
