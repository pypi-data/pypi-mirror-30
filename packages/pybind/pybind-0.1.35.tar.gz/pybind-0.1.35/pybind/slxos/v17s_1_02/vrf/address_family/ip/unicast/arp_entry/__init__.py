...
class arp_entry(PybindBase):
  ...
  def _get_Ve(self):
    """
    Getter method for Ve, mapped from YANG variable /vrf/address_family/ip/unicast/arp_entry/Ve (interface:ve-type)
  ...
  def _set_Ve(self, v, load=False):
    """
    Setter method for Ve, mapped from YANG variable /vrf/address_family/ip/unicast/arp_entry/Ve (interface:ve-type)
    If this variable is read-only (config: false) in the
