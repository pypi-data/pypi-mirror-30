...
class import_(PybindBase):
  ...
  def _get_evpn_import(self):
    """
    Getter method for evpn_import, mapped from YANG variable /vrf/address_family/ipv6/unicast/import/evpn_import (empty)
    """
    return self.__evpn_import
      
  def _set_evpn_import(self, v, load=False):
    """
    Setter method for evpn_import, mapped from YANG variable /vrf/address_family/ipv6/unicast/import/evpn_import (empty)
    If this variable is read-only (config: false) in the
