...
import __builtin__
class overlay_class_map_get_next_cookie_state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ssm-operational - based on the path /overlay-class-map-get-next-cookie-state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Overlay Class Map Get Next Cookie
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__class_map_name',)

  _yang_name = 'overlay-class-map-get-next-cookie-state'
  _rest_name = 'overlay-class-map-get-next-cookie-state'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'overlay-class-map-get-next-cookie-state']
  ...
  def _get_class_map_name(self):
    """
    Getter method for class_map_name, mapped from YANG variable /overlay_class_map_get_next_cookie_state/class_map_name (string)
  ...
  def _set_class_map_name(self, v, load=False):
    """
    Setter method for class_map_name, mapped from YANG variable /overlay_class_map_get_next_cookie_state/class_map_name (string)
  ...
  _pyangbind_elements = {'class_map_name': class_map_name, }
