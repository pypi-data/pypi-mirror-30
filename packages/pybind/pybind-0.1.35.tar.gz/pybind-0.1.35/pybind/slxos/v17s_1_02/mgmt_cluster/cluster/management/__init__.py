...
class management(PybindBase):
  ...
  from YANG module brocade-cluster - based on the path /mgmt-cluster/cluster/management. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__virtual',)
  ...
  def _set_virtual(self, v, load=False):
    """
    Setter method for virtual, mapped from YANG variable /mgmt_cluster/cluster/management/virtual (container)
  ...
  _pyangbind_elements = {'virtual': virtual, }
