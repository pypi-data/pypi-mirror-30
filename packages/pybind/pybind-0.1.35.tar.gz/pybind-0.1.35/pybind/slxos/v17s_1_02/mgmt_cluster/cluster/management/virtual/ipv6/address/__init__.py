...
class address(PybindBase):
  ...
  from YANG module brocade-cluster - based on the path /mgmt-cluster/cluster/management/virtual/ipv6/address. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mgmt-cluster', u'cluster', u'management', u'virtual', u'ipv6', u'address']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'cluster', u'management', u'virtual', u'ipv6', u'address']

  def _get_ipv6address(self):
    """
    Getter method for ipv6address, mapped from YANG variable /mgmt_cluster/cluster/management/virtual/ipv6/address/ipv6address (common-def:ipv6-address-prefix)
    """
    return self.__ipv6address
      
  def _set_ipv6address(self, v, load=False):
    """
    Setter method for ipv6address, mapped from YANG variable /mgmt_cluster/cluster/management/virtual/ipv6/address/ipv6address (common-def:ipv6-address-prefix)
