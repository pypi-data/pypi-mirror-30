...
class virtual(PybindBase):
  ...
  from YANG module brocade-cluster - based on the path /mgmt-cluster/cluster/management/virtual. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mgmt-cluster', u'cluster', u'management', u'virtual']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'cluster', u'management', u'virtual']

  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /mgmt_cluster/cluster/management/virtual/ip (container)
    """
    return self.__ip
      
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /mgmt_cluster/cluster/management/virtual/ip (container)
  ...
  def _get_ipv6(self):
    """
    Getter method for ipv6, mapped from YANG variable /mgmt_cluster/cluster/management/virtual/ipv6 (container)
    """
    return self.__ipv6
      
  def _set_ipv6(self, v, load=False):
    """
    Setter method for ipv6, mapped from YANG variable /mgmt_cluster/cluster/management/virtual/ipv6 (container)
    If this variable is read-only (config: false) in the
