...
class address(PybindBase):
  ...
  from YANG module brocade-cluster - based on the path /mgmt-cluster/cluster/management/virtual/ip/address. Each member element of
  ...
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /mgmt_cluster/cluster/management/virtual/ip/address/address (common-def:ipv4-address-prefix-type)
