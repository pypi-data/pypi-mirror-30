...
import __builtin__
import cluster
class mgmt_cluster(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-cluster - based on the path /mgmt-cluster. Each member element of
...
elements of this managed device.
  ...
  def _get_cluster(self):
    """
    Getter method for cluster, mapped from YANG variable /mgmt_cluster/cluster (container)
    """
