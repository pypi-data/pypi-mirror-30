...
class import_(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ipv6/import. Each member element of
  ...
  def _get_routes(self):
    """
    Getter method for routes, mapped from YANG variable /ipv6/import/routes (list)
  ...
  def _set_routes(self, v, load=False):
    """
    Setter method for routes, mapped from YANG variable /ipv6/import/routes (list)
