...
import __builtin__
class interface_list(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ssm-operational - based on the path /filter-info-state/interface-list. Each member element of
  ...
  _yang_name = 'interface-list'
  _rest_name = 'interface-list'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'filter-info-state', u'interface-list']
  ...
  def _get_interface_type(self):
    """
    Getter method for interface_type, mapped from YANG variable /filter_info_state/interface_list/interface_type (string)
  ...
  def _set_interface_type(self, v, load=False):
    """
    Setter method for interface_type, mapped from YANG variable /filter_info_state/interface_list/interface_type (string)
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /filter_info_state/interface_list/interface_name (string)
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /filter_info_state/interface_list/interface_name (string)
    If this variable is read-only (config: false) in the
