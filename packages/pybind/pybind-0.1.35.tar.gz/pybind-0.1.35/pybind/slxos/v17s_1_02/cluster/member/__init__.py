...
class member(PybindBase):
  ...
  from YANG module brocade-mct - based on the path /cluster/member. Each member element of
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /cluster/member/vlan (container)
  ...
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /cluster/member/vlan (container)
  ...
  def _get_bridge_domain(self):
    """
    Getter method for bridge_domain, mapped from YANG variable /cluster/member/bridge_domain (container)
  ...
  def _set_bridge_domain(self, v, load=False):
    """
    Setter method for bridge_domain, mapped from YANG variable /cluster/member/bridge_domain (container)
    If this variable is read-only (config: false) in the
