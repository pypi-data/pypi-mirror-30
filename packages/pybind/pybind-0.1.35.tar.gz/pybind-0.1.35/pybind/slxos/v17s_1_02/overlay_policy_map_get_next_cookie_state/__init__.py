...
import __builtin__
class overlay_policy_map_get_next_cookie_state(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ssm-operational - based on the path /overlay-policy-map-get-next-cookie-state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Overlay Policy Map Get Next Cookie
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__policy_name','__seq_id',)

  _yang_name = 'overlay-policy-map-get-next-cookie-state'
  _rest_name = 'overlay-policy-map-get-next-cookie-state'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'overlay-policy-map-get-next-cookie-state']
  ...
  _pyangbind_elements = {'policy_name': policy_name, 'seq_id': seq_id, }
