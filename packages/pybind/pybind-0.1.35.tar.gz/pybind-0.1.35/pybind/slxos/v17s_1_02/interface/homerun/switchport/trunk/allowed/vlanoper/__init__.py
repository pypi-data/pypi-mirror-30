...
class vlanoper(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/switchport/trunk/allowed/vlanoper. Each member element of
...
Do not use in edit-config.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'switchport', u'trunk', u'allowed', u'vlanoper']
