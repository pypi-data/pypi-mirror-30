...
class gre(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tunnel/mode/gre. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tunnel', u'mode', u'gre']
  ...
  def _get_ip(self):
    """
    Getter method for ip, mapped from YANG variable /interface/tunnel/mode/gre/ip (empty)
    """
    return self.__ip
      
  def _set_ip(self, v, load=False):
    """
    Setter method for ip, mapped from YANG variable /interface/tunnel/mode/gre/ip (empty)
