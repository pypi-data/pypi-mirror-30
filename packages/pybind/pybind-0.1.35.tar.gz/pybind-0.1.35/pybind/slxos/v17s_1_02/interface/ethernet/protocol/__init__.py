...
class protocol(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/protocol. Each member element of
  ...
  def _get_ptp(self):
    """
    Getter method for ptp, mapped from YANG variable /interface/ethernet/protocol/ptp (container)
...
'protocol/ptp/enable' is set.
  ...
  def _set_ptp(self, v, load=False):
    """
    Setter method for ptp, mapped from YANG variable /interface/ethernet/protocol/ptp (container)
