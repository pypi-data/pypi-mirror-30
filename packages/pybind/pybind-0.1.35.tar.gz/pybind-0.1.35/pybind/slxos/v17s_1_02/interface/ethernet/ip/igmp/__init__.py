...
class igmp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/igmp. Each member element of
  ...
  _pyangbind_elements = {'igmp_phy_intf_cfg': igmp_phy_intf_cfg, }
