...
class add_(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/switchport/trunk/trunk-vlan-classification/allowed/vlan/add. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'switchport', u'trunk', u'trunk-vlan-classification', u'allowed', u'vlan', u'add']
