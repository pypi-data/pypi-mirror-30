...
class vrrpv3_group(PybindBase):
  ...
  def _get_owner(self):
    """
    Getter method for owner, mapped from YANG variable /interface/ethernet/ipv6/vrrpv3_group/owner (container)
  ...
  def _set_owner(self, v, load=False):
    """
    Setter method for owner, mapped from YANG variable /interface/ethernet/ipv6/vrrpv3_group/owner (container)
    If this variable is read-only (config: false) in the
