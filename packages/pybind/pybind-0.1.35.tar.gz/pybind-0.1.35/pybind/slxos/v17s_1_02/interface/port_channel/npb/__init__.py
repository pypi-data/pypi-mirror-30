...
import __builtin__
import policy
class npb(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/port-channel/npb. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'npb']
  ...
  def _get_policy(self):
    """
    Getter method for policy, mapped from YANG variable /interface/port_channel/npb/policy (container)

    YANG Description: Configure NPB
    """
    return self.__policy
      
  def _set_policy(self, v, load=False):
    """
    Setter method for policy, mapped from YANG variable /interface/port_channel/npb/policy (container)
