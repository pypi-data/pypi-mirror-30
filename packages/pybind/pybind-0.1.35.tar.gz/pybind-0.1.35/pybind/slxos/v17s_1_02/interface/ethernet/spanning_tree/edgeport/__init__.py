...
class edgeport(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__edgeportbasic','__bpdu_guard',)
  ...
  _pyangbind_elements = {'edgeportbasic': edgeportbasic, 'bpdu_guard': bpdu_guard, }
