...
class rx_queue(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__unicast','__multicast',)
  ...
  _pyangbind_elements = {'unicast': unicast, 'multicast': multicast, }
