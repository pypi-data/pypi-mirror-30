...
class tvf_domain(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/tvf-domain. Each member element of
  ...
  def _get_tvfdomain_all(self):
    """
    Getter method for tvfdomain_all, mapped from YANG variable /interface/port_channel/tvf_domain/tvfdomain_all (empty)
    """
    return self.__tvfdomain_all
      
  def _set_tvfdomain_all(self, v, load=False):
    """
    Setter method for tvfdomain_all, mapped from YANG variable /interface/port_channel/tvf_domain/tvfdomain_all (empty)
  ...
  def _get_tvfdomain_none(self):
    """
    Getter method for tvfdomain_none, mapped from YANG variable /interface/port_channel/tvf_domain/tvfdomain_none (empty)
    """
    return self.__tvfdomain_none
      
  def _set_tvfdomain_none(self, v, load=False):
    """
    Setter method for tvfdomain_none, mapped from YANG variable /interface/port_channel/tvf_domain/tvfdomain_none (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_tvfdomain_add(self):
    """
    Getter method for tvfdomain_add, mapped from YANG variable /interface/port_channel/tvf_domain/tvfdomain_add (tvf-domain-range)
    """
    return self.__tvfdomain_add
      
  def _set_tvfdomain_add(self, v, load=False):
    """
    Setter method for tvfdomain_add, mapped from YANG variable /interface/port_channel/tvf_domain/tvfdomain_add (tvf-domain-range)
    If this variable is read-only (config: false) in the
  ...
  def _get_tvfdomain_remove(self):
    """
    Getter method for tvfdomain_remove, mapped from YANG variable /interface/port_channel/tvf_domain/tvfdomain_remove (tvf-domain-range)
    """
    return self.__tvfdomain_remove
      
  def _set_tvfdomain_remove(self, v, load=False):
    """
    Setter method for tvfdomain_remove, mapped from YANG variable /interface/port_channel/tvf_domain/tvfdomain_remove (tvf-domain-range)
    If this variable is read-only (config: false) in the
  ...
  def _get_tvfdomain_except(self):
    """
    Getter method for tvfdomain_except, mapped from YANG variable /interface/port_channel/tvf_domain/tvfdomain_except (tvf-domain-range)
    """
    return self.__tvfdomain_except
      
  def _set_tvfdomain_except(self, v, load=False):
    """
    Setter method for tvfdomain_except, mapped from YANG variable /interface/port_channel/tvf_domain/tvfdomain_except (tvf-domain-range)
    If this variable is read-only (config: false) in the
