...
class vrf(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/vrf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'vrf']
  ...
  def _get_forwarding(self):
    """
    Getter method for forwarding, mapped from YANG variable /interface/homerun/vrf/forwarding (common-def:vrf-name)
...
with interface.
  ...
  def _set_forwarding(self, v, load=False):
    """
    Setter method for forwarding, mapped from YANG variable /interface/homerun/vrf/forwarding (common-def:vrf-name)
