...
class ipv6(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/ipv6. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: The IPv6 configurations for an interface.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__raguard','__ipv6_config',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'ipv6']
  ...
  def _get_raguard(self):
    """
    Getter method for raguard, mapped from YANG variable /interface/homerun/ipv6/raguard (empty)
    """
    return self.__raguard
      
  def _set_raguard(self, v, load=False):
    """
    Setter method for raguard, mapped from YANG variable /interface/homerun/ipv6/raguard (empty)
  ...
  def _get_ipv6_config(self):
    """
    Getter method for ipv6_config, mapped from YANG variable /interface/homerun/ipv6/ipv6_config (container)
    """
    return self.__ipv6_config
      
  def _set_ipv6_config(self, v, load=False):
    """
    Setter method for ipv6_config, mapped from YANG variable /interface/homerun/ipv6/ipv6_config (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'raguard': raguard, 'ipv6_config': ipv6_config, }
