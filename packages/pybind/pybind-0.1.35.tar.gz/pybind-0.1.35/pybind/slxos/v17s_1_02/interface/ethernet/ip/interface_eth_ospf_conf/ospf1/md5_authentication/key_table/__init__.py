...
class key_table(PybindBase):
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'ip', u'ospf', u'md5-authentication', u'key-id']
  ...
  def _get_key(self):
    """
    Getter method for key, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/md5_authentication/key_table/key (key-type)
  ...
  def _set_key(self, v, load=False):
    """
    Setter method for key, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/md5_authentication/key_table/key (key-type)
    If this variable is read-only (config: false) in the
