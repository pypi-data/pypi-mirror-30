...
class vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/switchport/access-mac-group-rspan-vlan-classification/access/vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'switchport', u'access-mac-group-rspan-vlan-classification', u'access', u'vlan']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Homerun', u'switchport', u'access-mac-group-rspan-vlan-classification', u'access', u'rspan-vlan']

  def _get_access_vlan_id(self):
    """
    Getter method for access_vlan_id, mapped from YANG variable /interface/homerun/switchport/access_mac_group_rspan_vlan_classification/access/vlan/access_vlan_id (vlan-type)
  ...
  def _set_access_vlan_id(self, v, load=False):
    """
    Setter method for access_vlan_id, mapped from YANG variable /interface/homerun/switchport/access_mac_group_rspan_vlan_classification/access/vlan/access_vlan_id (vlan-type)
  ...
  def _get_access_mac_group(self):
    """
    Getter method for access_mac_group, mapped from YANG variable /interface/homerun/switchport/access_mac_group_rspan_vlan_classification/access/vlan/access_mac_group (mac-group-id-type)
  ...
  def _set_access_mac_group(self, v, load=False):
    """
    Setter method for access_mac_group, mapped from YANG variable /interface/homerun/switchport/access_mac_group_rspan_vlan_classification/access/vlan/access_mac_group (mac-group-id-type)
    If this variable is read-only (config: false) in the
