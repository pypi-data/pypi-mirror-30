...
class sticky(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/switchport/port-security/sticky. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Sticky MAC
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__port_secutiry_mac_address',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'switchport', u'port-security', u'sticky']
  ...
  def _get_port_secutiry_mac_address(self):
    """
    Getter method for port_secutiry_mac_address, mapped from YANG variable /interface/homerun/switchport/port_security/sticky/port_secutiry_mac_address (list)
  ...
  def _set_port_secutiry_mac_address(self, v, load=False):
    """
    Setter method for port_secutiry_mac_address, mapped from YANG variable /interface/homerun/switchport/port_security/sticky/port_secutiry_mac_address (list)
  ...
  _pyangbind_elements = {'port_secutiry_mac_address': port_secutiry_mac_address, }
