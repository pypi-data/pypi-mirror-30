...
class protocol(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/protocol. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Protocol configuration
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ptp',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'protocol']
  ...
  def _get_ptp(self):
    """
    Getter method for ptp, mapped from YANG variable /interface/port_channel/protocol/ptp (container)
...
'protocol/ptp/enable' is set.
  ...
  def _set_ptp(self, v, load=False):
    """
    Setter method for ptp, mapped from YANG variable /interface/port_channel/protocol/ptp (container)
