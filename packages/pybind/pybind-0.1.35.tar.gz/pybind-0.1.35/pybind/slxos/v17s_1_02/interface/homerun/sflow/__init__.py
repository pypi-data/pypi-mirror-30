...
class sflow(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/sflow. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__enable','__polling_interval','__sample_rate',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'sflow']
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /interface/homerun/sflow/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /interface/homerun/sflow/enable (empty)
  ...
  def _get_polling_interval(self):
    """
    Getter method for polling_interval, mapped from YANG variable /interface/homerun/sflow/polling_interval (uint32)
    """
    return self.__polling_interval
      
  def _set_polling_interval(self, v, load=False):
    """
    Setter method for polling_interval, mapped from YANG variable /interface/homerun/sflow/polling_interval (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_sample_rate(self):
    """
    Getter method for sample_rate, mapped from YANG variable /interface/homerun/sflow/sample_rate (uint32)
    """
    return self.__sample_rate
      
  def _set_sample_rate(self, v, load=False):
    """
    Setter method for sample_rate, mapped from YANG variable /interface/homerun/sflow/sample_rate (uint32)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'enable': enable, 'polling_interval': polling_interval, 'sample_rate': sample_rate, }
