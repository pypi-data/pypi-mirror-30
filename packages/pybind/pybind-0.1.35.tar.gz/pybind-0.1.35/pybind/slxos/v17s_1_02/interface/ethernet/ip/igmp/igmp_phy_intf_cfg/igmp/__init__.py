...
class igmp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/igmp/igmp-phy-intf-cfg/igmp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'igmp', u'igmp-phy-intf-cfg', u'igmp']
