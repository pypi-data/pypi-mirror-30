...
import __builtin__
class drop_monitor(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/port-channel/qos/drop-monitor. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__drop_monitor_enable',)

  _yang_name = 'drop-monitor'
  _rest_name = 'drop-monitor'
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__drop_monitor_enable = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="drop-monitor-enable", rest_name="enable", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Enable polling on ingress and egress queue drops on this interface', u'cli-full-command': None, u'alt-name': u'enable', u'cli-full-no': None}}, namespace='urn:brocade.com:mgmt:brocade-qos-mls', defining_module='brocade-qos-mls', yang_type='empty', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'qos', u'drop-monitor']
  ...
  def _get_drop_monitor_enable(self):
    """
    Getter method for drop_monitor_enable, mapped from YANG variable /interface/port_channel/qos/drop_monitor/drop_monitor_enable (empty)
    """
    return self.__drop_monitor_enable
      
  def _set_drop_monitor_enable(self, v, load=False):
    """
    Setter method for drop_monitor_enable, mapped from YANG variable /interface/port_channel/qos/drop_monitor/drop_monitor_enable (empty)
  ...
  _pyangbind_elements = {'drop_monitor_enable': drop_monitor_enable, }
