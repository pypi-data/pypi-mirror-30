...
class access(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/switchport/access. Each member element of
...
interface.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'switchport', u'access']
  ...
  def _get_accessvlan(self):
    """
    Getter method for accessvlan, mapped from YANG variable /interface/homerun/switchport/access/accessvlan (vlan-type)
...
interface.
  ...
  def _set_accessvlan(self, v, load=False):
    """
    Setter method for accessvlan, mapped from YANG variable /interface/homerun/switchport/access/accessvlan (vlan-type)
...
interface.
  ...
  def _get_rspan_access(self):
    """
    Getter method for rspan_access, mapped from YANG variable /interface/homerun/switchport/access/rspan_access (container)
...
interface.
  ...
  def _set_rspan_access(self, v, load=False):
    """
    Setter method for rspan_access, mapped from YANG variable /interface/homerun/switchport/access/rspan_access (container)
    If this variable is read-only (config: false) in the
