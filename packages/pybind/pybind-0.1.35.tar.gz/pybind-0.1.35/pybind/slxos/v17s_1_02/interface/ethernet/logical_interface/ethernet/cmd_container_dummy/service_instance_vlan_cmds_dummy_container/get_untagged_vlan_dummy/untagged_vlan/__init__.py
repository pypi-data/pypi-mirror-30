...
class untagged_vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/logical-interface/ethernet/cmd-container-dummy/service-instance-vlan-cmds-dummy-container/get-untagged-vlan-dummy/untagged-vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'logical-interface', u'ethernet', u'cmd-container-dummy', u'service-instance-vlan-cmds-dummy-container', u'get-untagged-vlan-dummy', u'untagged-vlan']
  ...
  def _get_untagged_flag(self):
    """
    Getter method for untagged_flag, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/cmd_container_dummy/service_instance_vlan_cmds_dummy_container/get_untagged_vlan_dummy/untagged_vlan/untagged_flag (empty)
    """
    return self.__untagged_flag
      
  def _set_untagged_flag(self, v, load=False):
    """
    Setter method for untagged_flag, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/cmd_container_dummy/service_instance_vlan_cmds_dummy_container/get_untagged_vlan_dummy/untagged_vlan/untagged_flag (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_untagged_flag is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_untagged_flag() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  def _get_untagged_vlan_id(self):
    """
    Getter method for untagged_vlan_id, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/cmd_container_dummy/service_instance_vlan_cmds_dummy_container/get_untagged_vlan_dummy/untagged_vlan/untagged_vlan_id (interface:vlan-type)
    """
    return self.__untagged_vlan_id
      
  def _set_untagged_vlan_id(self, v, load=False):
    """
    Setter method for untagged_vlan_id, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/cmd_container_dummy/service_instance_vlan_cmds_dummy_container/get_untagged_vlan_dummy/untagged_vlan/untagged_vlan_id (interface:vlan-type)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'untagged_flag': untagged_flag, 'untagged_vlan_id': untagged_vlan_id, }
