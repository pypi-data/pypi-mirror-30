...
class drop_monitor(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/qos/drop-monitor. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'qos', u'drop-monitor']
