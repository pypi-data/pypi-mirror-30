...
class arp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/vrrpe/arp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'vrrpe', u'arp']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'vrrp-extended-group', u'arp']

  def _get_unicast_request(self):
    """
    Getter method for unicast_request, mapped from YANG variable /interface/ethernet/vrrpe/arp/unicast_request (container)
  ...
  def _set_unicast_request(self, v, load=False):
    """
    Setter method for unicast_request, mapped from YANG variable /interface/ethernet/vrrpe/arp/unicast_request (container)
