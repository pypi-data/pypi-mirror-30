...
class vrrp(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__vrid','__version','__owner','__virtual_ip','__track','__advertisement_interval','__enable','__hold_time','__preempt_mode','__arp','__priority','__description',)
  ...
  def _get_owner(self):
    """
    Getter method for owner, mapped from YANG variable /interface/port_channel/hide_vrrp_holer/vrrp/owner (container)
  ...
  def _set_owner(self, v, load=False):
    """
    Setter method for owner, mapped from YANG variable /interface/port_channel/hide_vrrp_holer/vrrp/owner (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'vrid': vrid, 'version': version, 'owner': owner, 'virtual_ip': virtual_ip, 'track': track, 'advertisement_interval': advertisement_interval, 'enable': enable, 'hold_time': hold_time, 'preempt_mode': preempt_mode, 'arp': arp, 'priority': priority, 'description': description, }
