...
class deny(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/deny. Each member element of
  ...
  def _get_inner_gtp_https(self):
    """
    Getter method for inner_gtp_https, mapped from YANG variable /interface/port_channel/deny/inner_gtp_https (empty)
  ...
  def _set_inner_gtp_https(self, v, load=False):
    """
    Setter method for inner_gtp_https, mapped from YANG variable /interface/port_channel/deny/inner_gtp_https (empty)
