...
class track(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/track. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'track']
  ...
  def _get_track_enable(self):
    """
    Getter method for track_enable, mapped from YANG variable /interface/homerun/track/track_enable (empty)
  ...
  def _set_track_enable(self, v, load=False):
    """
    Setter method for track_enable, mapped from YANG variable /interface/homerun/track/track_enable (empty)
  ...
  def _get_min_link(self):
    """
    Getter method for min_link, mapped from YANG variable /interface/homerun/track/min_link (uint32)
  ...
  def _set_min_link(self, v, load=False):
    """
    Setter method for min_link, mapped from YANG variable /interface/homerun/track/min_link (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /interface/homerun/track/interface (list)
  ...
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /interface/homerun/track/interface (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_remove_(self):
    """
    Getter method for remove_, mapped from YANG variable /interface/homerun/track/remove (container)
  ...
  def _set_remove_(self, v, load=False):
    """
    Setter method for remove_, mapped from YANG variable /interface/homerun/track/remove (container)
    If this variable is read-only (config: false) in the
