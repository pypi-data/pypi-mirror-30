...
class untagged_vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/logical-interface/port-channel/pc-cmd-container-dummy/service-instance-vlan-cmds-dummy-container/get-untagged-vlan-dummy/untagged-vlan. Each member element of
  ...
  def _get_untagged_flag(self):
    """
    Getter method for untagged_flag, mapped from YANG variable /interface/port_channel/logical_interface/port_channel/pc_cmd_container_dummy/service_instance_vlan_cmds_dummy_container/get_untagged_vlan_dummy/untagged_vlan/untagged_flag (empty)
    """
    return self.__untagged_flag
      
  def _set_untagged_flag(self, v, load=False):
    """
    Setter method for untagged_flag, mapped from YANG variable /interface/port_channel/logical_interface/port_channel/pc_cmd_container_dummy/service_instance_vlan_cmds_dummy_container/get_untagged_vlan_dummy/untagged_vlan/untagged_flag (empty)
  ...
  def _get_untagged_vlan_id(self):
    """
    Getter method for untagged_vlan_id, mapped from YANG variable /interface/port_channel/logical_interface/port_channel/pc_cmd_container_dummy/service_instance_vlan_cmds_dummy_container/get_untagged_vlan_dummy/untagged_vlan/untagged_vlan_id (interface:vlan-type)
    """
    return self.__untagged_vlan_id
      
  def _set_untagged_vlan_id(self, v, load=False):
    """
    Setter method for untagged_vlan_id, mapped from YANG variable /interface/port_channel/logical_interface/port_channel/pc_cmd_container_dummy/service_instance_vlan_cmds_dummy_container/get_untagged_vlan_dummy/untagged_vlan/untagged_vlan_id (interface:vlan-type)
    If this variable is read-only (config: false) in the
