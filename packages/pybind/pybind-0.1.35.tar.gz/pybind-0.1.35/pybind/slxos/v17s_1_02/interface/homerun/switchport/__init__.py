...
class switchport(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/switchport. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__access_mac_group_rspan_vlan_classification = YANGDynClass(base=access_mac_group_rspan_vlan_classification.access_mac_group_rspan_vlan_classification, is_container='container', presence=False, yang_name="access-mac-group-rspan-vlan-classification", rest_name="access-mac-group-rspan-vlan-classification", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'hidden': u'full'}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)
    ...
    self.__trunk = YANGDynClass(base=trunk.trunk, is_container='container', presence=False, yang_name="trunk", rest_name="trunk", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Set the Layer2 interface as trunk', u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)
    self.__access_mac_rspan_vlan_classification = YANGDynClass(base=access_mac_rspan_vlan_classification.access_mac_rspan_vlan_classification, is_container='container', presence=False, yang_name="access-mac-rspan-vlan-classification", rest_name="access-mac-rspan-vlan-classification", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'hidden': u'full'}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'switchport']
  ...
  def _get_mode(self):
    """
    Getter method for mode, mapped from YANG variable /interface/homerun/switchport/mode (container)
  ...
  def _set_mode(self, v, load=False):
    """
    Setter method for mode, mapped from YANG variable /interface/homerun/switchport/mode (container)
  ...
  def _get_port_security(self):
    """
    Getter method for port_security, mapped from YANG variable /interface/homerun/switchport/port_security (container)
  ...
  def _set_port_security(self, v, load=False):
    """
    Setter method for port_security, mapped from YANG variable /interface/homerun/switchport/port_security (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_access(self):
    """
    Getter method for access, mapped from YANG variable /interface/homerun/switchport/access (container)
...
interface.
  ...
  def _set_access(self, v, load=False):
    """
    Setter method for access, mapped from YANG variable /interface/homerun/switchport/access (container)
    If this variable is read-only (config: false) in the
...
interface.
  ...
  def _set_access_mac_vlan_classification(self, v, load=False):
    """
    Setter method for access_mac_vlan_classification, mapped from YANG variable /interface/homerun/switchport/access_mac_vlan_classification (container)
    If this variable is read-only (config: false) in the
  ...
  def _set_access_mac_group_vlan_classification(self, v, load=False):
    """
    Setter method for access_mac_group_vlan_classification, mapped from YANG variable /interface/homerun/switchport/access_mac_group_vlan_classification (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_trunk(self):
    """
    Getter method for trunk, mapped from YANG variable /interface/homerun/switchport/trunk (container)
  ...
  def _set_trunk(self, v, load=False):
    """
    Setter method for trunk, mapped from YANG variable /interface/homerun/switchport/trunk (container)
    If this variable is read-only (config: false) in the
  ...
  def _set_access_mac_rspan_vlan_classification(self, v, load=False):
    """
    Setter method for access_mac_rspan_vlan_classification, mapped from YANG variable /interface/homerun/switchport/access_mac_rspan_vlan_classification (container)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=access_mac_rspan_vlan_classification.access_mac_rspan_vlan_classification, is_container='container', presence=False, yang_name="access-mac-rspan-vlan-classification", rest_name="access-mac-rspan-vlan-classification", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'hidden': u'full'}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """access_mac_rspan_vlan_classification must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=access_mac_rspan_vlan_classification.access_mac_rspan_vlan_classification, is_container='container', presence=False, yang_name="access-mac-rspan-vlan-classification", rest_name="access-mac-rspan-vlan-classification", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'hidden': u'full'}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='container', is_config=True)""",
        })
  ...
  def _set_access_mac_group_rspan_vlan_classification(self, v, load=False):
    """
    Setter method for access_mac_group_rspan_vlan_classification, mapped from YANG variable /interface/homerun/switchport/access_mac_group_rspan_vlan_classification (container)
    If this variable is read-only (config: false) in the
