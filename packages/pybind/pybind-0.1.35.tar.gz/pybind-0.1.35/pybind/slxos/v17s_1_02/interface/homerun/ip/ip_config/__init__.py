...
class ip_config(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/ip/ip-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'ip', u'ip-config']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Homerun', u'ip']

  def _get_mtu(self):
    """
    Getter method for mtu, mapped from YANG variable /interface/homerun/ip/ip_config/mtu (ip-mtu)
    """
    return self.__mtu
      
  def _set_mtu(self, v, load=False):
    """
    Setter method for mtu, mapped from YANG variable /interface/homerun/ip/ip_config/mtu (ip-mtu)
  ...
  def _get_directed_broadcast(self):
    """
    Getter method for directed_broadcast, mapped from YANG variable /interface/homerun/ip/ip_config/directed_broadcast (empty)
    """
    return self.__directed_broadcast
      
  def _set_directed_broadcast(self, v, load=False):
    """
    Setter method for directed_broadcast, mapped from YANG variable /interface/homerun/ip/ip_config/directed_broadcast (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_proxy_arp(self):
    """
    Getter method for proxy_arp, mapped from YANG variable /interface/homerun/ip/ip_config/proxy_arp (empty)
    """
    return self.__proxy_arp
      
  def _set_proxy_arp(self, v, load=False):
    """
    Setter method for proxy_arp, mapped from YANG variable /interface/homerun/ip/ip_config/proxy_arp (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_arp(self):
    """
    Getter method for arp, mapped from YANG variable /interface/homerun/ip/ip_config/arp (container)
    """
    return self.__arp
      
  def _set_arp(self, v, load=False):
    """
    Setter method for arp, mapped from YANG variable /interface/homerun/ip/ip_config/arp (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_arp_aging_timeout(self):
    """
    Getter method for arp_aging_timeout, mapped from YANG variable /interface/homerun/ip/ip_config/arp_aging_timeout (uint32)
    """
    return self.__arp_aging_timeout
      
  def _set_arp_aging_timeout(self, v, load=False):
    """
    Setter method for arp_aging_timeout, mapped from YANG variable /interface/homerun/ip/ip_config/arp_aging_timeout (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /interface/homerun/ip/ip_config/address (list)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /interface/homerun/ip/ip_config/address (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_unnumbered(self):
    """
    Getter method for unnumbered, mapped from YANG variable /interface/homerun/ip/ip_config/unnumbered (container)
    """
    return self.__unnumbered
      
  def _set_unnumbered(self, v, load=False):
    """
    Setter method for unnumbered, mapped from YANG variable /interface/homerun/ip/ip_config/unnumbered (container)
    If this variable is read-only (config: false) in the
