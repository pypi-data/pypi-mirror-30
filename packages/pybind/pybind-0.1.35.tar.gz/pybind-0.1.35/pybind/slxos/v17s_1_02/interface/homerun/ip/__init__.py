...
class ip(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/ip. Each member element of
  ...
  def _get_ip_config(self):
    """
    Getter method for ip_config, mapped from YANG variable /interface/homerun/ip/ip_config (container)
    """
    return self.__ip_config
      
  def _set_ip_config(self, v, load=False):
    """
    Setter method for ip_config, mapped from YANG variable /interface/homerun/ip/ip_config (container)
