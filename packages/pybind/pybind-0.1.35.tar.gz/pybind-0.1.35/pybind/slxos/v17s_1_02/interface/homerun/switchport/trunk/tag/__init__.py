...
class tag(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/switchport/trunk/tag. Each member element of
...
trunk port.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'switchport', u'trunk', u'tag']
  ...
  def _get_native_vlan(self):
    """
    Getter method for native_vlan, mapped from YANG variable /interface/homerun/switchport/trunk/tag/native_vlan (empty)
...
for classifying the un-tagged traffic.
  ...
  def _set_native_vlan(self, v, load=False):
    """
    Setter method for native_vlan, mapped from YANG variable /interface/homerun/switchport/trunk/tag/native_vlan (empty)
