...
class access_mac_group_vlan_classification(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/switchport/access-mac-group-vlan-classification. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'switchport', u'access-mac-group-vlan-classification']
  ...
  def _get_access(self):
    """
    Getter method for access, mapped from YANG variable /interface/homerun/switchport/access_mac_group_vlan_classification/access (container)
...
interface.
  ...
  def _set_access(self, v, load=False):
    """
    Setter method for access, mapped from YANG variable /interface/homerun/switchport/access_mac_group_vlan_classification/access (container)
