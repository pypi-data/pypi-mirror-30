...
class address(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/ipv6/ipv6-config/address. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'ipv6', u'ipv6-config', u'address']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Homerun', u'ipv6', u'address']

  def _get_use_link_local_only(self):
    """
    Getter method for use_link_local_only, mapped from YANG variable /interface/homerun/ipv6/ipv6_config/address/use_link_local_only (empty)
    """
    return self.__use_link_local_only
      
  def _set_use_link_local_only(self, v, load=False):
    """
    Setter method for use_link_local_only, mapped from YANG variable /interface/homerun/ipv6/ipv6_config/address/use_link_local_only (empty)
  ...
  def _get_link_local_config(self):
    """
    Getter method for link_local_config, mapped from YANG variable /interface/homerun/ipv6/ipv6_config/address/link_local_config (container)
    """
    return self.__link_local_config
      
  def _set_link_local_config(self, v, load=False):
    """
    Setter method for link_local_config, mapped from YANG variable /interface/homerun/ipv6/ipv6_config/address/link_local_config (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv6_address(self):
    """
    Getter method for ipv6_address, mapped from YANG variable /interface/homerun/ipv6/ipv6_config/address/ipv6_address (list)
    """
    return self.__ipv6_address
      
  def _set_ipv6_address(self, v, load=False):
    """
    Setter method for ipv6_address, mapped from YANG variable /interface/homerun/ipv6/ipv6_config/address/ipv6_address (list)
    If this variable is read-only (config: false) in the
