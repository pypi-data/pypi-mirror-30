...
class ip(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ip_config','__arp_node_config','__interface_eth_dhcp_conf','__icmp','__igmp','__intf_router_isis','__interface_eth_ospf_conf','__pim_intf_phy_cont',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__igmp = YANGDynClass(base=igmp.igmp, is_container='container', presence=False, yang_name="igmp", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-igmp', defining_module='brocade-igmp', yang_type='container', is_config=True)
  ...
  def _set_interface_eth_dhcp_conf(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=interface_eth_dhcp_conf.interface_eth_dhcp_conf, is_container='container', presence=False, yang_name="interface-eth-dhcp-conf", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-dhcp', defining_module='brocade-dhcp', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """interface_eth_dhcp_conf must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=interface_eth_dhcp_conf.interface_eth_dhcp_conf, is_container='container', presence=False, yang_name="interface-eth-dhcp-conf", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-dhcp', defining_module='brocade-dhcp', yang_type='container', is_config=True)""",
        })
  ...
  def _set_igmp(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=igmp.igmp, is_container='container', presence=False, yang_name="igmp", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-igmp', defining_module='brocade-igmp', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """igmp must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=igmp.igmp, is_container='container', presence=False, yang_name="igmp", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-igmp', defining_module='brocade-igmp', yang_type='container', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'ip_config': ip_config, 'arp_node_config': arp_node_config, 'interface_eth_dhcp_conf': interface_eth_dhcp_conf, 'icmp': icmp, 'igmp': igmp, 'intf_router_isis': intf_router_isis, 'interface_eth_ospf_conf': interface_eth_ospf_conf, 'pim_intf_phy_cont': pim_intf_phy_cont, }
