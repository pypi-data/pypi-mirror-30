...
class remove_(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/switchport/trunk/allowed/trunk-rspan-vlan-classification/rspan-vlan/remove. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'switchport', u'trunk', u'allowed', u'trunk-rspan-vlan-classification', u'rspan-vlan', u'remove']
