...
class vrrpv3e_group(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__virtual_mac = YANGDynClass(base=virtual_mac.virtual_mac, is_container='container', presence=False, yang_name="virtual-mac", rest_name="virtual-mac", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Virtual MAC'}}, namespace='urn:brocade.com:mgmt:brocade-vrrpv3', defining_module='brocade-vrrpv3', yang_type='container', is_config=True)
  ...
  def _set_vrid(self, v, load=False):
    """
    Setter method for vrid, mapped from YANG variable /interface/ethernet/ipv6/vrrpv3e_group/vrid (vrid-type)
  ...
  def _get_virtual_mac(self):
    """
    Getter method for virtual_mac, mapped from YANG variable /interface/ethernet/ipv6/vrrpv3e_group/virtual_mac (container)
  ...
  def _set_virtual_mac(self, v, load=False):
    """
    Setter method for virtual_mac, mapped from YANG variable /interface/ethernet/ipv6/vrrpv3e_group/virtual_mac (container)
    If this variable is read-only (config: false) in the
