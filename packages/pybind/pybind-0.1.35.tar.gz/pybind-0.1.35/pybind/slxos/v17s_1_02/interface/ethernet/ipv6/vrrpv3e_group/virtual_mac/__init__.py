...
class virtual_mac(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ipv6/vrrpv3e-group/virtual-mac. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ipv6', u'vrrpv3e-group', u'virtual-mac']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'ipv6', u'vrrp-extended-group', u'virtual-mac']

  def _get_vmac(self):
    """
    Getter method for vmac, mapped from YANG variable /interface/ethernet/ipv6/vrrpv3e_group/virtual_mac/vmac (empty)
  ...
  def _set_vmac(self, v, load=False):
    """
    Setter method for vmac, mapped from YANG variable /interface/ethernet/ipv6/vrrpv3e_group/virtual_mac/vmac (empty)
