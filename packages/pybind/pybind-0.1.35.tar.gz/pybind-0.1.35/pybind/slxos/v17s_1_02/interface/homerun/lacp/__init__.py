...
class lacp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/lacp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'lacp']
  ...
  def _get_timeout(self):
    """
    Getter method for timeout, mapped from YANG variable /interface/homerun/lacp/timeout (enumeration)
    """
    return self.__timeout
      
  def _set_timeout(self, v, load=False):
    """
    Setter method for timeout, mapped from YANG variable /interface/homerun/lacp/timeout (enumeration)
  ...
  def _get_std_port_priority(self):
    """
    Getter method for std_port_priority, mapped from YANG variable /interface/homerun/lacp/std_port_priority (uint32)
  ...
  def _set_std_port_priority(self, v, load=False):
    """
    Setter method for std_port_priority, mapped from YANG variable /interface/homerun/lacp/std_port_priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_default_up(self):
    """
    Getter method for default_up, mapped from YANG variable /interface/homerun/lacp/default_up (empty)
    """
    return self.__default_up
      
  def _set_default_up(self, v, load=False):
    """
    Setter method for default_up, mapped from YANG variable /interface/homerun/lacp/default_up (empty)
    If this variable is read-only (config: false) in the
