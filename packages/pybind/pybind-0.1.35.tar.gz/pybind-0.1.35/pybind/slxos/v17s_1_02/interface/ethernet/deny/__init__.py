...
import __builtin__
class deny(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/ethernet/deny. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Deny Traffic
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__inner_gtp_https',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'deny']
  ...
  def _get_inner_gtp_https(self):
    """
    Getter method for inner_gtp_https, mapped from YANG variable /interface/ethernet/deny/inner_gtp_https (empty)

    YANG Description: Deny HTTPS over GTP
    """
    return self.__inner_gtp_https
      
  def _set_inner_gtp_https(self, v, load=False):
    """
    Setter method for inner_gtp_https, mapped from YANG variable /interface/ethernet/deny/inner_gtp_https (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_inner_gtp_https is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_inner_gtp_https() directly.
  ...
  _pyangbind_elements = {'inner_gtp_https': inner_gtp_https, }
