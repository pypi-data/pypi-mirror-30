...
class npb(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/npb. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'npb']
  ...
  def _get_policy(self):
    """
    Getter method for policy, mapped from YANG variable /interface/ethernet/npb/policy (container)
  ...
  def _set_policy(self, v, load=False):
    """
    Setter method for policy, mapped from YANG variable /interface/ethernet/npb/policy (container)
