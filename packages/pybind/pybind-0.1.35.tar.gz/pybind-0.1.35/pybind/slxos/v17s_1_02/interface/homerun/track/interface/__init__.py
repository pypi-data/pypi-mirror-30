...
class interface(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/track/interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'track', u'interface']
  ...
  def _set_track_interface_type(self, v, load=False):
    """
    Setter method for track_interface_type, mapped from YANG variable /interface/homerun/track/interface/track_interface_type (enumeration)
  ...
  def _get_track_interface_name(self):
    """
    Getter method for track_interface_name, mapped from YANG variable /interface/homerun/track/interface/track_interface_name (string)
  ...
  def _set_track_interface_name(self, v, load=False):
    """
    Setter method for track_interface_name, mapped from YANG variable /interface/homerun/track/interface/track_interface_name (string)
    If this variable is read-only (config: false) in the
