...
class ip_config(PybindBase):
  ...
  def _get_arp(self):
    """
    Getter method for arp, mapped from YANG variable /interface/ethernet/ip/ip_config/arp (container)
    """
    return self.__arp
      
  def _set_arp(self, v, load=False):
    """
    Setter method for arp, mapped from YANG variable /interface/ethernet/ip/ip_config/arp (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_unnumbered(self):
    """
    Getter method for unnumbered, mapped from YANG variable /interface/ethernet/ip/ip_config/unnumbered (container)
    """
    return self.__unnumbered
      
  def _set_unnumbered(self, v, load=False):
    """
    Setter method for unnumbered, mapped from YANG variable /interface/ethernet/ip/ip_config/unnumbered (container)
    If this variable is read-only (config: false) in the
