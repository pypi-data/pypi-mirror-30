...
class access(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/switchport/access-mac-vlan-classification/access. Each member element of
...
interface.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'switchport', u'access-mac-vlan-classification', u'access']
  ...
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/homerun/switchport/access_mac_vlan_classification/access/vlan (list)
