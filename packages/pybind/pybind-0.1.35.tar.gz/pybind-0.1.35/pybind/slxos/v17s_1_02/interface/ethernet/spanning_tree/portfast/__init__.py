...
class portfast(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__portfastbasic','__bpdu_guard',)
  ...
  _pyangbind_elements = {'portfastbasic': portfastbasic, 'bpdu_guard': bpdu_guard, }
