...
class access(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/homerun/switchport/access-mac-group-rspan-vlan-classification/access. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'homerun', u'switchport', u'access-mac-group-rspan-vlan-classification', u'access']
  ...
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/homerun/switchport/access_mac_group_rspan_vlan_classification/access/vlan (list)
