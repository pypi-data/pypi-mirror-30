...
class system(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/system. Each member element of
  ...
  def _get_packet_timestamp(self):
    """
    Getter method for packet_timestamp, mapped from YANG variable /interface/port_channel/system/packet_timestamp (container)
