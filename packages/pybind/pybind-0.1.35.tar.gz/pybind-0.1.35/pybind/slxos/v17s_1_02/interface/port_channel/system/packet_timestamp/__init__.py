...
class packet_timestamp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/system/packet-timestamp. Each member element of
  ...
  def _get_ingress(self):
    """
    Getter method for ingress, mapped from YANG variable /interface/port_channel/system/packet_timestamp/ingress (enumeration)
  ...
  def _set_ingress(self, v, load=False):
    """
    Setter method for ingress, mapped from YANG variable /interface/port_channel/system/packet_timestamp/ingress (enumeration)
  ...
  def _get_egress(self):
    """
    Getter method for egress, mapped from YANG variable /interface/port_channel/system/packet_timestamp/egress (enumeration)
  ...
  def _set_egress(self, v, load=False):
    """
    Setter method for egress, mapped from YANG variable /interface/port_channel/system/packet_timestamp/egress (enumeration)
    If this variable is read-only (config: false) in the
