...
class access_group(PybindBase):
  ...
  def _get_ip_access_list(self):
    """
    Getter method for ip_access_list, mapped from YANG variable /routing_system/ip/receive/access_group/ip_access_list (l3-acl-policy-name)
    """
    return self.__ip_access_list
      
  def _set_ip_access_list(self, v, load=False):
    """
    Setter method for ip_access_list, mapped from YANG variable /routing_system/ip/receive/access_group/ip_access_list (l3-acl-policy-name)
  ...
  def _get_ip_direction(self):
    """
    Getter method for ip_direction, mapped from YANG variable /routing_system/ip/receive/access_group/ip_direction (enumeration)
    """
    return self.__ip_direction
      
  def _set_ip_direction(self, v, load=False):
    """
    Setter method for ip_direction, mapped from YANG variable /routing_system/ip/receive/access_group/ip_direction (enumeration)
    If this variable is read-only (config: false) in the
