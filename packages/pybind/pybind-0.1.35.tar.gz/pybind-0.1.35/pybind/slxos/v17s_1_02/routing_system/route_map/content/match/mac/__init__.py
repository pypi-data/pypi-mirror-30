...
class mac(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/match/mac. Each member element of
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /routing_system/route_map/content/match/mac/address (container)
  ...
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /routing_system/route_map/content/match/mac/address (container)
