...
class match(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__vrf','__interface','__ipv6','__ip','__mac','__extcommunity','__metric','__route_type','__tag','__as_path','__community','__next_hop','__protocol',)
  ...
  def _get_mac(self):
    """
    Getter method for mac, mapped from YANG variable /routing_system/route_map/content/match/mac (container)
  ...
  def _set_mac(self, v, load=False):
    """
    Setter method for mac, mapped from YANG variable /routing_system/route_map/content/match/mac (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'vrf': vrf, 'interface': interface, 'ipv6': ipv6, 'ip': ip, 'mac': mac, 'extcommunity': extcommunity, 'metric': metric, 'route_type': route_type, 'tag': tag, 'as_path': as_path, 'community': community, 'next_hop': next_hop, 'protocol': protocol, }
