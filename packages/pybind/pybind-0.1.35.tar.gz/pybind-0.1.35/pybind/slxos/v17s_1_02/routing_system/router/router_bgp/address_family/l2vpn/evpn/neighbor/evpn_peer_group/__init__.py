...
class evpn_peer_group(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/l2vpn/evpn/neighbor/evpn-peer-group. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__evpn_neighbor_peergroup_name','__encapsulation','__maximum_prefix','__route_reflector_client','__allowas_in','__next_hop_unchanged','__enable_peer_as_check','__route_map','__activate','__send_community',)
  ...
  def _get_evpn_neighbor_peergroup_name(self):
    """
    Getter method for evpn_neighbor_peergroup_name, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/evpn_neighbor_peergroup_name (bgp-peergroup)
    """
    return self.__evpn_neighbor_peergroup_name
      
  def _set_evpn_neighbor_peergroup_name(self, v, load=False):
    """
    Setter method for evpn_neighbor_peergroup_name, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/evpn_neighbor_peergroup_name (bgp-peergroup)
  ...
  def _get_encapsulation(self):
    """
    Getter method for encapsulation, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/encapsulation (encapsulation-t)
    """
    return self.__encapsulation
      
  def _set_encapsulation(self, v, load=False):
    """
    Setter method for encapsulation, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/encapsulation (encapsulation-t)
    If this variable is read-only (config: false) in the
  ...
  def _get_maximum_prefix(self):
    """
    Getter method for maximum_prefix, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/maximum_prefix (max-prefix-limit)
    """
    return self.__maximum_prefix
      
  def _set_maximum_prefix(self, v, load=False):
    """
    Setter method for maximum_prefix, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/maximum_prefix (max-prefix-limit)
    If this variable is read-only (config: false) in the
  ...
  def _get_route_reflector_client(self):
    """
    Getter method for route_reflector_client, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/route_reflector_client (empty)
    """
    return self.__route_reflector_client
      
  def _set_route_reflector_client(self, v, load=False):
    """
    Setter method for route_reflector_client, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/route_reflector_client (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_allowas_in(self):
    """
    Getter method for allowas_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/allowas_in (uint32)
    """
    return self.__allowas_in
      
  def _set_allowas_in(self, v, load=False):
    """
    Setter method for allowas_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/allowas_in (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_next_hop_unchanged(self):
    """
    Getter method for next_hop_unchanged, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/next_hop_unchanged (empty)
    """
    return self.__next_hop_unchanged
      
  def _set_next_hop_unchanged(self, v, load=False):
    """
    Setter method for next_hop_unchanged, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/next_hop_unchanged (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_enable_peer_as_check(self):
    """
    Getter method for enable_peer_as_check, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/enable_peer_as_check (empty)
    """
    return self.__enable_peer_as_check
      
  def _set_enable_peer_as_check(self, v, load=False):
    """
    Setter method for enable_peer_as_check, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/enable_peer_as_check (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_route_map(self):
    """
    Getter method for route_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/route_map (container)
    """
    return self.__route_map
      
  def _set_route_map(self, v, load=False):
    """
    Setter method for route_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/route_map (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_activate(self):
    """
    Getter method for activate, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/activate (empty)
    """
    return self.__activate
      
  def _set_activate(self, v, load=False):
    """
    Setter method for activate, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/activate (empty)
    If this variable is read-only (config: false) in the
  ...
  def _set_send_community(self, v, load=False):
    """
    Setter method for send_community, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/send_community (container)
    If this variable is read-only (config: false) in the
