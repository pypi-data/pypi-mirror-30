...
class mac(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/mac. Each member element of
  ...
  def _set_receive(self, v, load=False):
    """
    Setter method for receive, mapped from YANG variable /routing_system/mac/receive (container)
