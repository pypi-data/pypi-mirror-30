...
class update_source(PybindBase):
  ...
  def _get_port_channel(self):
    """
    Getter method for port_channel, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/update_source/port_channel (interface:portchannel-type)
    """
    return self.__port_channel
      
  def _set_port_channel(self, v, load=False):
    """
    Setter method for port_channel, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/update_source/port_channel (interface:portchannel-type)
    If this variable is read-only (config: false) in the
