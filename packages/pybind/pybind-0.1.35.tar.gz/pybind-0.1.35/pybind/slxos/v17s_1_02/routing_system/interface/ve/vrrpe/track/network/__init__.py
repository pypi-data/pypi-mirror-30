...
class network(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/vrrpe/track/network. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'vrrpe', u'track', u'network']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'vrrp-extended-group', u'track', u'network']

  def _get_network_address(self):
    """
    Getter method for network_address, mapped from YANG variable /routing_system/interface/ve/vrrpe/track/network/network_address (union)
  ...
  def _set_network_address(self, v, load=False):
    """
    Setter method for network_address, mapped from YANG variable /routing_system/interface/ve/vrrpe/track/network/network_address (union)
  ...
  def _set_network_priority(self, v, load=False):
    """
    Setter method for network_priority, mapped from YANG variable /routing_system/interface/ve/vrrpe/track/network/network_priority (uint8)
    If this variable is read-only (config: false) in the
