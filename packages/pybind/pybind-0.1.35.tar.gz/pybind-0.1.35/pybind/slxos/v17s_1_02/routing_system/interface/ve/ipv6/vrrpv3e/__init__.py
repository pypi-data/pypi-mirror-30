...
class vrrpv3e(PybindBase):
  ...
  def _get_vrid(self):
    """
    Getter method for vrid, mapped from YANG variable /routing_system/interface/ve/ipv6/vrrpv3e/vrid (vrid-type)
    """
    return self.__vrid
      
  def _set_vrid(self, v, load=False):
    """
    Setter method for vrid, mapped from YANG variable /routing_system/interface/ve/ipv6/vrrpv3e/vrid (vrid-type)
