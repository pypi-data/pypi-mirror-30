...
class virtual_ip(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ipv6/vrrpv3e/virtual-ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ipv6', u'vrrpv3e', u'virtual-ip']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'ipv6', u'vrrp-extended-group', u'virtual-ip']

  def _get_virtual_ipaddr(self):
    """
    Getter method for virtual_ipaddr, mapped from YANG variable /routing_system/interface/ve/ipv6/vrrpv3e/virtual_ip/virtual_ipaddr (inet:ipv6-address)
  ...
  def _set_virtual_ipaddr(self, v, load=False):
    """
    Setter method for virtual_ipaddr, mapped from YANG variable /routing_system/interface/ve/ipv6/vrrpv3e/virtual_ip/virtual_ipaddr (inet:ipv6-address)
