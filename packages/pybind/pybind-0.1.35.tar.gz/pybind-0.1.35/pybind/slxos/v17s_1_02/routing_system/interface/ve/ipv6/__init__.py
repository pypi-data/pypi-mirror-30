...
class ipv6(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ipv6_config','__ipv6_anycast_address','__ipv6_vrrp_extended','__ipv6_local_anycast_gateway','__interface_ve_dhcp_conf','__icmpv6','__access_group','__policy','__ipv6_nd_ra','__intf_ipv6_router_isis','__ipv6_ve_intf_cmds','__interface_ospfv3_conf','__vrrpv3','__vrrpv3e',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__ipv6_vrrp_extended = YANGDynClass(base=ipv6_vrrp_extended.ipv6_vrrp_extended, is_container='container', presence=False, yang_name="ipv6-vrrp-extended", rest_name="vrrp-extended", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'VRRP Extended', u'cli-sequence-commands': None, u'alt-name': u'vrrp-extended', u'callpoint': u'VRRPEIpv6Md5Auth'}}, namespace='urn:brocade.com:mgmt:brocade-vrrp', defining_module='brocade-vrrp', yang_type='container', is_config=True)
  ...
  def _get_ipv6_anycast_address(self):
    """
    Getter method for ipv6_anycast_address, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_anycast_address (list)
    """
    return self.__ipv6_anycast_address
      
  def _set_ipv6_anycast_address(self, v, load=False):
    """
    Setter method for ipv6_anycast_address, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_anycast_address (list)
    If this variable is read-only (config: false) in the
  ...
  def _set_ipv6_vrrp_extended(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=ipv6_vrrp_extended.ipv6_vrrp_extended, is_container='container', presence=False, yang_name="ipv6-vrrp-extended", rest_name="vrrp-extended", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'VRRP Extended', u'cli-sequence-commands': None, u'alt-name': u'vrrp-extended', u'callpoint': u'VRRPEIpv6Md5Auth'}}, namespace='urn:brocade.com:mgmt:brocade-vrrp', defining_module='brocade-vrrp', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ipv6_vrrp_extended must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=ipv6_vrrp_extended.ipv6_vrrp_extended, is_container='container', presence=False, yang_name="ipv6-vrrp-extended", rest_name="vrrp-extended", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'VRRP Extended', u'cli-sequence-commands': None, u'alt-name': u'vrrp-extended', u'callpoint': u'VRRPEIpv6Md5Auth'}}, namespace='urn:brocade.com:mgmt:brocade-vrrp', defining_module='brocade-vrrp', yang_type='container', is_config=True)""",
        })
