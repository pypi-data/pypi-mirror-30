...
class update_source(PybindBase):
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'neighbor', u'neighbor-addr', u'update-source']
  ...
  def _get_port_channel(self):
    """
    Getter method for port_channel, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/update_source/port_channel (interface:portchannel-type)
    """
    return self.__port_channel
      
  def _set_port_channel(self, v, load=False):
    """
    Setter method for port_channel, mapped from YANG variable /routing_system/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/update_source/port_channel (interface:portchannel-type)
    If this variable is read-only (config: false) in the
