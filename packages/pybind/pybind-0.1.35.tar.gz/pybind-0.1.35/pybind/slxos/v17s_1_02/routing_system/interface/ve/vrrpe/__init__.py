...
class vrrpe(PybindBase):
  ...
  def _get_vrid(self):
    """
    Getter method for vrid, mapped from YANG variable /routing_system/interface/ve/vrrpe/vrid (vrid-type)
    """
    return self.__vrid
      
  def _set_vrid(self, v, load=False):
    """
    Setter method for vrid, mapped from YANG variable /routing_system/interface/ve/vrrpe/vrid (vrid-type)
