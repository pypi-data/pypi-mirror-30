...
class virtual_mac(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ipv6/vrrpv3e/virtual-mac. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ipv6', u'vrrpv3e', u'virtual-mac']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'ipv6', u'vrrp-extended-group', u'virtual-mac']

  def _get_vmac(self):
    """
    Getter method for vmac, mapped from YANG variable /routing_system/interface/ve/ipv6/vrrpv3e/virtual_mac/vmac (empty)
  ...
  def _set_vmac(self, v, load=False):
    """
    Setter method for vmac, mapped from YANG variable /routing_system/interface/ve/ipv6/vrrpv3e/virtual_mac/vmac (empty)
