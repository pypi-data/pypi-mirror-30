...
class timers(PybindBase):
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'neighbor', u'neighbor-ipv6-addr', u'timers']
