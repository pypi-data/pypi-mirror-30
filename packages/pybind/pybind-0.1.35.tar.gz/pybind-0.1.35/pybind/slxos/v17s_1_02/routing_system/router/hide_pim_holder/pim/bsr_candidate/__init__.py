...
class bsr_candidate(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/hide-pim-holder/pim/bsr-candidate. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'hide-pim-holder', u'pim', u'bsr-candidate']
  ...
  def _set_bsr_cand_interface(self, v, load=False):
    """
    Setter method for bsr_cand_interface, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/bsr_candidate/bsr_cand_interface (list)
