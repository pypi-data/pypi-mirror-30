...
class aggregate_address(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/default-vrf/aggregate-address. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'default-vrf', u'aggregate-address']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'ipv4', u'unicast', u'aggregate-address']

  def _get_aggregate_ip_prefix(self):
    """
    Getter method for aggregate_ip_prefix, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/aggregate_address/aggregate_ip_prefix (inet:ipv4-prefix)
    """
    return self.__aggregate_ip_prefix
      
  def _set_aggregate_ip_prefix(self, v, load=False):
    """
    Setter method for aggregate_ip_prefix, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/aggregate_address/aggregate_ip_prefix (inet:ipv4-prefix)
  ...
  def _get_advertise_map(self):
    """
    Getter method for advertise_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/aggregate_address/advertise_map (advertise-map)
    """
    return self.__advertise_map
      
  def _set_advertise_map(self, v, load=False):
    """
    Setter method for advertise_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/aggregate_address/advertise_map (advertise-map)
    If this variable is read-only (config: false) in the
  ...
  def _get_as_set(self):
    """
    Getter method for as_set, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/aggregate_address/as_set (empty)
    """
    return self.__as_set
      
  def _set_as_set(self, v, load=False):
    """
    Setter method for as_set, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/aggregate_address/as_set (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_attribute_map(self):
    """
    Getter method for attribute_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/aggregate_address/attribute_map (attribute-map)
    """
    return self.__attribute_map
      
  def _set_attribute_map(self, v, load=False):
    """
    Setter method for attribute_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/aggregate_address/attribute_map (attribute-map)
    If this variable is read-only (config: false) in the
  ...
  def _get_summary_only(self):
    """
    Getter method for summary_only, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/aggregate_address/summary_only (empty)
    """
    return self.__summary_only
      
  def _set_summary_only(self, v, load=False):
    """
    Setter method for summary_only, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/aggregate_address/summary_only (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_suppress_map(self):
    """
    Getter method for suppress_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/aggregate_address/suppress_map (suppress-map)
    """
    return self.__suppress_map
      
  def _set_suppress_map(self, v, load=False):
    """
    Setter method for suppress_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/aggregate_address/suppress_map (suppress-map)
    If this variable is read-only (config: false) in the
