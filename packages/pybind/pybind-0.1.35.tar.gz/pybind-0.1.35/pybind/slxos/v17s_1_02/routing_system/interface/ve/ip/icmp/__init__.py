...
class icmp(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/icmp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip', u'icmp']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'ip', u'icmp']

  def _get_rate_limiting(self):
    """
    Getter method for rate_limiting, mapped from YANG variable /routing_system/interface/ve/ip/icmp/rate_limiting (uint32)
    """
    return self.__rate_limiting
      
  def _set_rate_limiting(self, v, load=False):
    """
    Setter method for rate_limiting, mapped from YANG variable /routing_system/interface/ve/ip/icmp/rate_limiting (uint32)
  ...
  def _get_redirect(self):
    """
    Getter method for redirect, mapped from YANG variable /routing_system/interface/ve/ip/icmp/redirect (empty)
    """
    return self.__redirect
      
  def _set_redirect(self, v, load=False):
    """
    Setter method for redirect, mapped from YANG variable /routing_system/interface/ve/ip/icmp/redirect (empty)
    If this variable is read-only (config: false) in the
