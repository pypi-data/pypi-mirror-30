...
class receive(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/mac/receive. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'mac', u'receive']
  ...
  def _set_access_group(self, v, load=False):
    """
    Setter method for access_group, mapped from YANG variable /routing_system/mac/receive/access_group (container)
