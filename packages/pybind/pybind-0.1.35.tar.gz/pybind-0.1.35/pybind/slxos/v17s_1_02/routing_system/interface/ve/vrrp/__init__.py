...
class vrrp(PybindBase):
  ...
  def _get_owner(self):
    """
    Getter method for owner, mapped from YANG variable /routing_system/interface/ve/vrrp/owner (container)
  ...
  def _set_owner(self, v, load=False):
    """
    Setter method for owner, mapped from YANG variable /routing_system/interface/ve/vrrp/owner (container)
    If this variable is read-only (config: false) in the
