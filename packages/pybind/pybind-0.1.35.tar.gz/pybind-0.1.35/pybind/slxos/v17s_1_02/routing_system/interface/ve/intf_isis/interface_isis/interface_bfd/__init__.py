...
class interface_bfd(PybindBase):
  ...
  def _get_interface_bfd_disable(self):
    """
    Getter method for interface_bfd_disable, mapped from YANG variable /routing_system/interface/ve/intf_isis/interface_isis/interface_bfd/interface_bfd_disable (empty)
    """
    return self.__interface_bfd_disable
      
  def _set_interface_bfd_disable(self, v, load=False):
    """
    Setter method for interface_bfd_disable, mapped from YANG variable /routing_system/interface/ve/intf_isis/interface_isis/interface_bfd/interface_bfd_disable (empty)
