...
class bgp(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/redistribute/bgp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'redistribute', u'bgp']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'redistribute', u'bgp']
  ...
  def _set_bgp_route_map(self, v, load=False):
    """
    Setter method for bgp_route_map, mapped from YANG variable /routing_system/router/ospf/redistribute/bgp/bgp_route_map (common-def:name-string63)
