...
import __builtin__
class icmp_plus(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/icmp-plus. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__echo_reply','__unreachable','__address_mask',)

  _yang_name = 'icmp-plus'
  _rest_name = 'icmp-plus'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip', u'icmp-plus']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'ip', u'icmp-plus']

  def _get_echo_reply(self):
    """
    Getter method for echo_reply, mapped from YANG variable /routing_system/interface/ve/ip/icmp_plus/echo_reply (empty)
    """
    return self.__echo_reply
      
  def _set_echo_reply(self, v, load=False):
    """
    Setter method for echo_reply, mapped from YANG variable /routing_system/interface/ve/ip/icmp_plus/echo_reply (empty)
  ...
  def _get_unreachable(self):
    """
    Getter method for unreachable, mapped from YANG variable /routing_system/interface/ve/ip/icmp_plus/unreachable (empty)
    """
    return self.__unreachable
      
  def _set_unreachable(self, v, load=False):
    """
    Setter method for unreachable, mapped from YANG variable /routing_system/interface/ve/ip/icmp_plus/unreachable (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_address_mask(self):
    """
    Getter method for address_mask, mapped from YANG variable /routing_system/interface/ve/ip/icmp_plus/address_mask (empty)
    """
    return self.__address_mask
      
  def _set_address_mask(self, v, load=False):
    """
    Setter method for address_mask, mapped from YANG variable /routing_system/interface/ve/ip/icmp_plus/address_mask (empty)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'echo_reply': echo_reply, 'unreachable': unreachable, 'address_mask': address_mask, }
