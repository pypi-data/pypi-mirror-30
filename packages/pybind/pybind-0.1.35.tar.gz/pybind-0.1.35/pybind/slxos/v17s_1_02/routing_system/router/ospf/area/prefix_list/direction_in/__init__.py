...
class direction_in(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/area/prefix-list/direction-in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'area', u'prefix-list', u'direction-in']
  ...
  def _get_prefix_list_direction_in_prefix_name(self):
    """
    Getter method for prefix_list_direction_in_prefix_name, mapped from YANG variable /routing_system/router/ospf/area/prefix_list/direction_in/prefix_list_direction_in_prefix_name (ipv4-prefix-name-t)
    """
    return self.__prefix_list_direction_in_prefix_name
      
  def _set_prefix_list_direction_in_prefix_name(self, v, load=False):
    """
    Setter method for prefix_list_direction_in_prefix_name, mapped from YANG variable /routing_system/router/ospf/area/prefix_list/direction_in/prefix_list_direction_in_prefix_name (ipv4-prefix-name-t)
  ...
  def _set_prefix_list_direction_in(self, v, load=False):
    """
    Setter method for prefix_list_direction_in, mapped from YANG variable /routing_system/router/ospf/area/prefix_list/direction_in/prefix_list_direction_in (empty)
    If this variable is read-only (config: false) in the
