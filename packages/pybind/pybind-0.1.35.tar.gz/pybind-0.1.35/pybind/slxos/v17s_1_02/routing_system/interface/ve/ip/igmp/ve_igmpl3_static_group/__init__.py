...
import __builtin__
class ve_igmpl3_static_group(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/igmp/ve_igmpl3-static-group. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__igmpl3_sg_addr',)

  _yang_name = 've_igmpl3-static-group'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip', u'igmp', u've_igmpl3-static-group']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'ip', u'igmp', u'static-group']

  def _get_igmpl3_sg_addr(self):
    """
    Getter method for igmpl3_sg_addr, mapped from YANG variable /routing_system/interface/ve/ip/igmp/ve_igmpl3_static_group/igmpl3_sg_addr (inet:ipv4-address)
    """
    return self.__igmpl3_sg_addr
      
  def _set_igmpl3_sg_addr(self, v, load=False):
    """
    Setter method for igmpl3_sg_addr, mapped from YANG variable /routing_system/interface/ve/ip/igmp/ve_igmpl3_static_group/igmpl3_sg_addr (inet:ipv4-address)
  ...
  _pyangbind_elements = {'igmpl3_sg_addr': igmpl3_sg_addr, }
