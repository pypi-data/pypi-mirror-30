...
class unicast_request(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/vrrp/arp/unicast-request. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'vrrp', u'arp', u'unicast-request']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'vrrp-group', u'arp', u'unicast-request']

  def _get_receive(self):
    """
    Getter method for receive, mapped from YANG variable /routing_system/interface/ve/vrrp/arp/unicast_request/receive (empty)
  ...
  def _set_receive(self, v, load=False):
    """
    Setter method for receive, mapped from YANG variable /routing_system/interface/ve/vrrp/arp/unicast_request/receive (empty)
