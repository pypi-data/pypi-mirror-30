...
class rp_candidate(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/hide-pim-holder/pim/rp-candidate. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'hide-pim-holder', u'pim', u'rp-candidate']
  ...
  def _set_rp_cand_interface(self, v, load=False):
    """
    Setter method for rp_cand_interface, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/rp_candidate/rp_cand_interface (list)
  ...
  def _set_rp_cand_grp_prefix(self, v, load=False):
    """
    Setter method for rp_cand_grp_prefix, mapped from YANG variable /routing_system/router/hide_pim_holder/pim/rp_candidate/rp_cand_grp_prefix (list)
    If this variable is read-only (config: false) in the
