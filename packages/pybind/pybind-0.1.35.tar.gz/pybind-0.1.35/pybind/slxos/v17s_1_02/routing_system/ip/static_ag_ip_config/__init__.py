...
class static_ag_ip_config(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/ip/static-ag-ip-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'ip', u'static-ag-ip-config']
  ...
  def _get_anycast_gateway_mac(self):
    """
    Getter method for anycast_gateway_mac, mapped from YANG variable /routing_system/ip/static_ag_ip_config/anycast_gateway_mac (container)
  ...
  def _set_anycast_gateway_mac(self, v, load=False):
    """
    Setter method for anycast_gateway_mac, mapped from YANG variable /routing_system/ip/static_ag_ip_config/anycast_gateway_mac (container)
