...
class pim(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip/pim-intf-vlan-cont/pim-int-cmd/pim. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__neighbor_filter','__dr_priority','__ttl_threshold',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__ttl_threshold = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..64']}), default=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32)(1), is_leaf=True, yang_name="ttl-threshold", rest_name="ttl-threshold", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Set TTL threshold'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='uint32', is_config=True)
    self.__neighbor_filter = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[a-zA-Z]{1}([-a-zA-Z0-9\\.\\\\\\\\@#\\+\\*\\(\\)=\\{~\\}%<>=$_\\[\\]\\|]{0,31})'}), is_leaf=True, yang_name="neighbor-filter", rest_name="neighbor-filter", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Set prefix list name', u'hidden': u'full'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='ip-prefix-name-t', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip', u'pim-intf-vlan-cont', u'pim-int-cmd', u'pim']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'ip', u'pim']

  def _get_neighbor_filter(self):
    """
    Getter method for neighbor_filter, mapped from YANG variable /routing_system/interface/ve/ip/pim_intf_vlan_cont/pim_int_cmd/pim/neighbor_filter (ip-prefix-name-t)
    """
    return self.__neighbor_filter
      
  def _set_neighbor_filter(self, v, load=False):
    """
    Setter method for neighbor_filter, mapped from YANG variable /routing_system/interface/ve/ip/pim_intf_vlan_cont/pim_int_cmd/pim/neighbor_filter (ip-prefix-name-t)
  ...
  def _get_dr_priority(self):
    """
    Getter method for dr_priority, mapped from YANG variable /routing_system/interface/ve/ip/pim_intf_vlan_cont/pim_int_cmd/pim/dr_priority (uint32)
    """
    return self.__dr_priority
      
  def _set_dr_priority(self, v, load=False):
    """
    Setter method for dr_priority, mapped from YANG variable /routing_system/interface/ve/ip/pim_intf_vlan_cont/pim_int_cmd/pim/dr_priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_ttl_threshold(self):
    """
    Getter method for ttl_threshold, mapped from YANG variable /routing_system/interface/ve/ip/pim_intf_vlan_cont/pim_int_cmd/pim/ttl_threshold (uint32)
    """
    return self.__ttl_threshold
      
  def _set_ttl_threshold(self, v, load=False):
    """
    Setter method for ttl_threshold, mapped from YANG variable /routing_system/interface/ve/ip/pim_intf_vlan_cont/pim_int_cmd/pim/ttl_threshold (uint32)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..64']}), default=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32)(1), is_leaf=True, yang_name="ttl-threshold", rest_name="ttl-threshold", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Set TTL threshold'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='uint32', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ttl_threshold must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..64']}), default=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32)(1), is_leaf=True, yang_name="ttl-threshold", rest_name="ttl-threshold", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Set TTL threshold'}}, namespace='urn:brocade.com:mgmt:brocade-pim', defining_module='brocade-pim', yang_type='uint32', is_config=True)""",
        })
  ...
  ttl_threshold = __builtin__.property(_get_ttl_threshold, _set_ttl_threshold)


  _pyangbind_elements = {'neighbor_filter': neighbor_filter, 'dr_priority': dr_priority, 'ttl_threshold': ttl_threshold, }
