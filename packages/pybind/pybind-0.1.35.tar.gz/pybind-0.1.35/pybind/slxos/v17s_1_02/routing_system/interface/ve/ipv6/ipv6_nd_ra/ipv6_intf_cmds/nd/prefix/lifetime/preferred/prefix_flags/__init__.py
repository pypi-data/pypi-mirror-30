...
class prefix_flags(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ipv6/ipv6-nd-ra/ipv6-intf-cmds/nd/prefix/lifetime/preferred/prefix-flags. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ipv6', u'ipv6-nd-ra', u'ipv6-intf-cmds', u'nd', u'prefix', u'lifetime', u'preferred', u'prefix-flags']
  ...
  def _get_no_autoconfig(self):
    """
    Getter method for no_autoconfig, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/prefix_flags/no_autoconfig (empty)
    """
    return self.__no_autoconfig
      
  def _set_no_autoconfig(self, v, load=False):
    """
    Setter method for no_autoconfig, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/prefix_flags/no_autoconfig (empty)
  ...
  def _get_no_onlink(self):
    """
    Getter method for no_onlink, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/prefix_flags/no_onlink (empty)
    """
    return self.__no_onlink
      
  def _set_no_onlink(self, v, load=False):
    """
    Setter method for no_onlink, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/prefix_flags/no_onlink (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_off_link(self):
    """
    Getter method for off_link, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/prefix_flags/off_link (empty)
    """
    return self.__off_link
      
  def _set_off_link(self, v, load=False):
    """
    Setter method for off_link, mapped from YANG variable /routing_system/interface/ve/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/prefix/lifetime/preferred/prefix_flags/off_link (empty)
    If this variable is read-only (config: false) in the
