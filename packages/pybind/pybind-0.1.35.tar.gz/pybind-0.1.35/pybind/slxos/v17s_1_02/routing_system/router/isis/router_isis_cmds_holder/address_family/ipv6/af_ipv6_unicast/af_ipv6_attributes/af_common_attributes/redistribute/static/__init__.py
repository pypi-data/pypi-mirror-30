...
class static(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/isis/router-isis-cmds-holder/address-family/ipv6/af-ipv6-unicast/af-ipv6-attributes/af-common-attributes/redistribute/static. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'isis', u'router-isis-cmds-holder', u'address-family', u'ipv6', u'af-ipv6-unicast', u'af-ipv6-attributes', u'af-common-attributes', u'redistribute', u'static']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'isis', u'address-family', u'ipv6', u'unicast', u'redistribute', u'static']

  def _get_static_metric(self):
    """
    Getter method for static_metric, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/redistribute/static/static_metric (conn-metric)
    """
    return self.__static_metric
      
  def _set_static_metric(self, v, load=False):
    """
    Setter method for static_metric, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/redistribute/static/static_metric (conn-metric)
  ...
  def _get_static_route_map(self):
    """
    Getter method for static_route_map, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/redistribute/static/static_route_map (rmap-type)
    """
    return self.__static_route_map
      
  def _set_static_route_map(self, v, load=False):
    """
    Setter method for static_route_map, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/redistribute/static/static_route_map (rmap-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_level1(self):
    """
    Getter method for static_level1, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/redistribute/static/static_level1 (empty)
    """
    return self.__static_level1
      
  def _set_static_level1(self, v, load=False):
    """
    Setter method for static_level1, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/redistribute/static/static_level1 (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_level2(self):
    """
    Getter method for static_level2, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/redistribute/static/static_level2 (empty)
    """
    return self.__static_level2
      
  def _set_static_level2(self, v, load=False):
    """
    Setter method for static_level2, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/redistribute/static/static_level2 (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_level12(self):
    """
    Getter method for static_level12, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/redistribute/static/static_level12 (empty)
    """
    return self.__static_level12
      
  def _set_static_level12(self, v, load=False):
    """
    Setter method for static_level12, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/redistribute/static/static_level12 (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_metric_type(self):
    """
    Getter method for static_metric_type, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/redistribute/static/static_metric_type (is-metric-type-t)
    """
    return self.__static_metric_type
      
  def _set_static_metric_type(self, v, load=False):
    """
    Setter method for static_metric_type, mapped from YANG variable /routing_system/router/isis/router_isis_cmds_holder/address_family/ipv6/af_ipv6_unicast/af_ipv6_attributes/af_common_attributes/redistribute/static/static_metric_type (is-metric-type-t)
    If this variable is read-only (config: false) in the
