...
class key_table(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/area/virtual-link/md5-authentication/key-table. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'area', u'virtual-link', u'md5-authentication', u'key-table']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'area', u'virtual-link', u'md5-authentication', u'key-id']

  def _get_key_id(self):
    """
    Getter method for key_id, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/md5_authentication/key_table/key_id (uint32)
    """
    return self.__key_id
      
  def _set_key_id(self, v, load=False):
    """
    Setter method for key_id, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/md5_authentication/key_table/key_id (uint32)
  ...
  def _get_key(self):
    """
    Getter method for key, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/md5_authentication/key_table/key (key-type)
  ...
  def _set_key(self, v, load=False):
    """
    Setter method for key, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/md5_authentication/key_table/key (key-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_md5_authentication_key(self):
    """
    Getter method for md5_authentication_key, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/md5_authentication/key_table/md5_authentication_key (ospf-auth-psswd-string)
    """
    return self.__md5_authentication_key
      
  def _set_md5_authentication_key(self, v, load=False):
    """
    Setter method for md5_authentication_key, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/md5_authentication/key_table/md5_authentication_key (ospf-auth-psswd-string)
    If this variable is read-only (config: false) in the
