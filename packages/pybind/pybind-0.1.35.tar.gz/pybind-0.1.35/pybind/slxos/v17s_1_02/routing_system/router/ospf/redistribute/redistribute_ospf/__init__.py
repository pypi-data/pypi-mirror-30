...
class redistribute_ospf(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/redistribute/redistribute-ospf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'redistribute', u'redistribute-ospf']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'redistribute', u'ospf']
  ...
  def _set_ospf_route_map(self, v, load=False):
    """
    Setter method for ospf_route_map, mapped from YANG variable /routing_system/router/ospf/redistribute/redistribute_ospf/ospf_route_map (common-def:name-string63)
