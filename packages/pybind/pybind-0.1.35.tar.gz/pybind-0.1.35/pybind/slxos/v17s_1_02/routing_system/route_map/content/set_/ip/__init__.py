...
class ip(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__dscp','__next_hop','__global_','__next_vrf',)
  ...
  _pyangbind_elements = {'dscp': dscp, 'next_hop': next_hop, 'global_': global_, 'next_vrf': next_vrf, }
