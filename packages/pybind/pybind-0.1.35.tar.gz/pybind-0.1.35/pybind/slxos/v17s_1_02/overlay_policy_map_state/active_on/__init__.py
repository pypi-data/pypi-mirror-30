...
import __builtin__
class active_on(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ssm-operational - based on the path /overlay-policy-map-state/active-on. Each member element of
  ...
  _yang_name = 'active-on'
  _rest_name = 'active-on'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'overlay-policy-map-state', u'active-on']
