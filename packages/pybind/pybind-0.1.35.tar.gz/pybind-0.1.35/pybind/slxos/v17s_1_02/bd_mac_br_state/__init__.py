...
class bd_mac_br_state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__total_mac_count','__static_mac_count','__dyn_mac_count','__evpn_mac_count',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__evpn_mac_count = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="evpn-mac-count", rest_name="evpn-mac-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-l2sys-operational', defining_module='brocade-l2sys-operational', yang_type='uint32', is_config=False)
  ...
  def _get_evpn_mac_count(self):
    """
    Getter method for evpn_mac_count, mapped from YANG variable /bd_mac_br_state/evpn_mac_count (uint32)

    YANG Description: EVPN mac count
    """
    return self.__evpn_mac_count
      
  def _set_evpn_mac_count(self, v, load=False):
    """
    Setter method for evpn_mac_count, mapped from YANG variable /bd_mac_br_state/evpn_mac_count (uint32)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_evpn_mac_count is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_evpn_mac_count() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="evpn-mac-count", rest_name="evpn-mac-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-l2sys-operational', defining_module='brocade-l2sys-operational', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """evpn_mac_count must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="evpn-mac-count", rest_name="evpn-mac-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-l2sys-operational', defining_module='brocade-l2sys-operational', yang_type='uint32', is_config=False)""",
        })

    self.__evpn_mac_count = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_evpn_mac_count(self):
    self.__evpn_mac_count = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="evpn-mac-count", rest_name="evpn-mac-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-l2sys-operational', defining_module='brocade-l2sys-operational', yang_type='uint32', is_config=False)
  ...
  evpn_mac_count = __builtin__.property(_get_evpn_mac_count)


  _pyangbind_elements = {'total_mac_count': total_mac_count, 'static_mac_count': static_mac_count, 'dyn_mac_count': dyn_mac_count, 'evpn_mac_count': evpn_mac_count, }
