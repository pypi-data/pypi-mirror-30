...
import __builtin__
class active_interfaces(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ssm-operational - based on the path /overlay-service-policy-brief-state/active-interfaces. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Active Interface
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__interface_type','__interface_name','__direction','__policy_name',)

  _yang_name = 'active-interfaces'
  _rest_name = 'active-interfaces'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'overlay-service-policy-brief-state', u'active-interfaces']
  ...
  def _get_interface_type(self):
    """
    Getter method for interface_type, mapped from YANG variable /overlay_service_policy_brief_state/active_interfaces/interface_type (string)
  ...
  def _set_interface_type(self, v, load=False):
    """
    Setter method for interface_type, mapped from YANG variable /overlay_service_policy_brief_state/active_interfaces/interface_type (string)
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /overlay_service_policy_brief_state/active_interfaces/interface_name (string)
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /overlay_service_policy_brief_state/active_interfaces/interface_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_direction(self):
    """
    Getter method for direction, mapped from YANG variable /overlay_service_policy_brief_state/active_interfaces/direction (string)
  ...
  def _set_direction(self, v, load=False):
    """
    Setter method for direction, mapped from YANG variable /overlay_service_policy_brief_state/active_interfaces/direction (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_policy_name(self):
    """
    Getter method for policy_name, mapped from YANG variable /overlay_service_policy_brief_state/active_interfaces/policy_name (string)
  ...
  def _set_policy_name(self, v, load=False):
    """
    Setter method for policy_name, mapped from YANG variable /overlay_service_policy_brief_state/active_interfaces/policy_name (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'interface_type': interface_type, 'interface_name': interface_name, 'direction': direction, 'policy_name': policy_name, }
