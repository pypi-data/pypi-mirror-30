...
class trigger_function(PybindBase):
  ...
  from YANG module brocade-event-handler - based on the path /event-handler/activate/name/trigger-function. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'event-handler', u'activate', u'name', u'trigger-function']
  ...
  def _set_trigger_function(self, v, load=False):
    """
    Setter method for trigger_function, mapped from YANG variable /event_handler/activate/name/trigger_function/trigger_function (enumeration)
  ...
  def _set_time_window(self, v, load=False):
    """
    Setter method for time_window, mapped from YANG variable /event_handler/activate/name/trigger_function/time_window (uint32)
    If this variable is read-only (config: false) in the
