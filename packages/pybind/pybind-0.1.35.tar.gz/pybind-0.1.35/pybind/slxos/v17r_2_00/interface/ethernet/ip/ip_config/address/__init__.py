...
class address(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/ip-config/address. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'ip-config', u'address']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'ip', u'address']

  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /interface/ethernet/ip/ip_config/address/address (union)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /interface/ethernet/ip/ip_config/address/address (union)
  ...
  def _get_secondary(self):
    """
    Getter method for secondary, mapped from YANG variable /interface/ethernet/ip/ip_config/address/secondary (empty)
    """
    return self.__secondary
      
  def _set_secondary(self, v, load=False):
    """
    Setter method for secondary, mapped from YANG variable /interface/ethernet/ip/ip_config/address/secondary (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_ospf_passive(self):
    """
    Getter method for ospf_passive, mapped from YANG variable /interface/ethernet/ip/ip_config/address/ospf_passive (empty)
    """
    return self.__ospf_passive
      
  def _set_ospf_passive(self, v, load=False):
    """
    Setter method for ospf_passive, mapped from YANG variable /interface/ethernet/ip/ip_config/address/ospf_passive (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_ospf_ignore(self):
    """
    Getter method for ospf_ignore, mapped from YANG variable /interface/ethernet/ip/ip_config/address/ospf_ignore (empty)
    """
    return self.__ospf_ignore
      
  def _set_ospf_ignore(self, v, load=False):
    """
    Setter method for ospf_ignore, mapped from YANG variable /interface/ethernet/ip/ip_config/address/ospf_ignore (empty)
    If this variable is read-only (config: false) in the
