...
class untagged(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/logical-interface/ethernet/untagged. Each member element of
  ...
  def _get_untagged_vlan(self):
    """
    Getter method for untagged_vlan, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/untagged/untagged_vlan (container)
    """
    return self.__untagged_vlan
      
  def _set_untagged_vlan(self, v, load=False):
    """
    Setter method for untagged_vlan, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/untagged/untagged_vlan (container)
