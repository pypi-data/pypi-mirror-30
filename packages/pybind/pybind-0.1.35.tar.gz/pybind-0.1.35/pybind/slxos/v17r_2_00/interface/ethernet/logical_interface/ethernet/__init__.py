...
class ethernet(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__instance_id','__shutdown','__name','__untagged','__tagged_outer_vlan',)
  ...
  def _get_shutdown(self):
    """
    Getter method for shutdown, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/shutdown (empty)
    """
    return self.__shutdown
      
  def _set_shutdown(self, v, load=False):
    """
    Setter method for shutdown, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/shutdown (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/name (string)
    """
    return self.__name
      
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_untagged(self):
    """
    Getter method for untagged, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/untagged (container)
    """
    return self.__untagged
      
  def _set_untagged(self, v, load=False):
    """
    Setter method for untagged, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/untagged (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_tagged_outer_vlan(self):
    """
    Getter method for tagged_outer_vlan, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/tagged_outer_vlan (container)
    """
    return self.__tagged_outer_vlan
      
  def _set_tagged_outer_vlan(self, v, load=False):
    """
    Setter method for tagged_outer_vlan, mapped from YANG variable /interface/ethernet/logical_interface/ethernet/tagged_outer_vlan (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'instance_id': instance_id, 'shutdown': shutdown, 'name': name, 'untagged': untagged, 'tagged_outer_vlan': tagged_outer_vlan, }
