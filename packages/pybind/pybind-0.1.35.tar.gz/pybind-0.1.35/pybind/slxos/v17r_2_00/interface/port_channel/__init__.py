...
entry represents a port-channel.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__vlag','__po_speed','__insight','__ifindex','__description','__shutdown','__minimum_links','__mtu','__route_only','__tag_type','__switchport_basic','__switchport','__ip','__ipv6','__track','__edge_loop_detection_native','__edge_loop_detection','__priority_tag_enable','__load_balance','__load_balance_type','__mac','__hide_vrrp_holer','__logical_interface','__fcoeport','__ip_acl_interface','__lacp_pdu_forward','__openflowPo','__port_profile_port','__port_profile_to_interface_associations','__qos','__service_policy','__uda','__offsets','__spanning_tree',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__po_speed = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'25000': {'value': 6}, u'40000': {'value': 3}, u'100000': {'value': 4}, u'10000': {'value': 2}, u'100': {'value': 5}, u'1000': {'value': 1}},), default=unicode("10000"), is_leaf=True, yang_name="po-speed", rest_name="speed", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Set speed informational parameter', u'alt-name': u'speed'}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='enumeration', is_config=True)
...
bandwidth for this physical interface.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'25000': {'value': 6}, u'40000': {'value': 3}, u'100000': {'value': 4}, u'10000': {'value': 2}, u'100': {'value': 5}, u'1000': {'value': 1}},), default=unicode("10000"), is_leaf=True, yang_name="po-speed", rest_name="speed", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Set speed informational parameter', u'alt-name': u'speed'}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='enumeration', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """po_speed must be of a type compatible with enumeration""",
          'defined-type': "brocade-interface:enumeration",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'25000': {'value': 6}, u'40000': {'value': 3}, u'100000': {'value': 4}, u'10000': {'value': 2}, u'100': {'value': 5}, u'1000': {'value': 1}},), default=unicode("10000"), is_leaf=True, yang_name="po-speed", rest_name="speed", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Set speed informational parameter', u'alt-name': u'speed'}}, namespace='urn:brocade.com:mgmt:brocade-interface', defining_module='brocade-interface', yang_type='enumeration', is_config=True)""",
        })
...
datagram that can be sent on the interface.
  ...
  def _get_tag_type(self):
    """
    Getter method for tag_type, mapped from YANG variable /interface/port_channel/tag_type (tpid-type)
  ...
  def _set_tag_type(self, v, load=False):
    """
    Setter method for tag_type, mapped from YANG variable /interface/port_channel/tag_type (tpid-type)
    If this variable is read-only (config: false) in the
...
following MAC learning process.
  ...
  def _set_uda(self, v, load=False):
    """
    Setter method for uda, mapped from YANG variable /interface/port_channel/uda (container)
    If this variable is read-only (config: false) in the
