...
class flowcontrol(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__link_level_flowcontrol','__pfc','__threshold','__pfc_threshold',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__threshold = YANGDynClass(base=threshold.threshold, is_container='container', presence=False, yang_name="threshold", rest_name="threshold", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Tx On/Off thresholds', u'cli-incomplete-no': None, u'cli-compact-syntax': None, u'cli-sequence-commands': None, u'cli-incomplete-command': None, u'hidden': u'performance-tuning'}}, namespace='urn:brocade.com:mgmt:brocade-qos-mls', defining_module='brocade-qos-mls', yang_type='container', is_config=True)
    self.__pfc_threshold = YANGDynClass(base=pfc_threshold.pfc_threshold, is_container='container', presence=False, yang_name="pfc-threshold", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'pfc_threshold_phy'}}, namespace='urn:brocade.com:mgmt:brocade-qos-mls', defining_module='brocade-qos-mls', yang_type='container', is_config=True)
  ...
  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /interface/ethernet/qos/flowcontrol/threshold (container)
    """
    return self.__threshold
      
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /interface/ethernet/qos/flowcontrol/threshold (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_pfc_threshold(self):
    """
    Getter method for pfc_threshold, mapped from YANG variable /interface/ethernet/qos/flowcontrol/pfc_threshold (container)
    """
    return self.__pfc_threshold
      
  def _set_pfc_threshold(self, v, load=False):
    """
    Setter method for pfc_threshold, mapped from YANG variable /interface/ethernet/qos/flowcontrol/pfc_threshold (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_pfc_threshold is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_pfc_threshold() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=pfc_threshold.pfc_threshold, is_container='container', presence=False, yang_name="pfc-threshold", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'pfc_threshold_phy'}}, namespace='urn:brocade.com:mgmt:brocade-qos-mls', defining_module='brocade-qos-mls', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """pfc_threshold must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=pfc_threshold.pfc_threshold, is_container='container', presence=False, yang_name="pfc-threshold", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'pfc_threshold_phy'}}, namespace='urn:brocade.com:mgmt:brocade-qos-mls', defining_module='brocade-qos-mls', yang_type='container', is_config=True)""",
        })

    self.__pfc_threshold = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_pfc_threshold(self):
    self.__pfc_threshold = YANGDynClass(base=pfc_threshold.pfc_threshold, is_container='container', presence=False, yang_name="pfc-threshold", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'callpoint': u'pfc_threshold_phy'}}, namespace='urn:brocade.com:mgmt:brocade-qos-mls', defining_module='brocade-qos-mls', yang_type='container', is_config=True)
  ...
  pfc_threshold = __builtin__.property(_get_pfc_threshold, _set_pfc_threshold)


  _pyangbind_elements = {'link_level_flowcontrol': link_level_flowcontrol, 'pfc': pfc, 'threshold': threshold, 'pfc_threshold': pfc_threshold, }
