...
class authentication(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/interface-eth-ospf-conf/ospf1/authentication. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Authentication of OSPF messages
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__key_chain',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'interface-eth-ospf-conf', u'ospf1', u'authentication']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'ip', u'ospf', u'authentication']

  def _get_key_chain(self):
    """
    Getter method for key_chain, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/authentication/key_chain (ospf-keychain-string)
    """
    return self.__key_chain
      
  def _set_key_chain(self, v, load=False):
    """
    Setter method for key_chain, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/authentication/key_chain (ospf-keychain-string)
  ...
  _pyangbind_elements = {'key_chain': key_chain, }
