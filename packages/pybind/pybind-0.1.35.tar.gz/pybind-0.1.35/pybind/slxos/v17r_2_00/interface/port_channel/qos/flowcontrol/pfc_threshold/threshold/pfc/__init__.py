...
class pfc(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/qos/flowcontrol/pfc-threshold/threshold/pfc. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'qos', u'flowcontrol', u'pfc-threshold', u'threshold', u'pfc']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'qos', u'flowcontrol', u'threshold', u'pfc']

  def _get_pfc_threshold_cos(self):
    """
    Getter method for pfc_threshold_cos, mapped from YANG variable /interface/port_channel/qos/flowcontrol/pfc_threshold/threshold/pfc/pfc_threshold_cos (cos-id-type)
    """
    return self.__pfc_threshold_cos
      
  def _set_pfc_threshold_cos(self, v, load=False):
    """
    Setter method for pfc_threshold_cos, mapped from YANG variable /interface/port_channel/qos/flowcontrol/pfc_threshold/threshold/pfc/pfc_threshold_cos (cos-id-type)
  ...
  def _set_pfc_threshold_tx_on(self, v, load=False):
    """
    Setter method for pfc_threshold_tx_on, mapped from YANG variable /interface/port_channel/qos/flowcontrol/pfc_threshold/threshold/pfc/pfc_threshold_tx_on (flowcontrol-threshold-type)
    If this variable is read-only (config: false) in the
  ...
  def _set_pfc_threshold_tx_off(self, v, load=False):
    """
    Setter method for pfc_threshold_tx_off, mapped from YANG variable /interface/port_channel/qos/flowcontrol/pfc_threshold/threshold/pfc/pfc_threshold_tx_off (flowcontrol-threshold-type)
    If this variable is read-only (config: false) in the
