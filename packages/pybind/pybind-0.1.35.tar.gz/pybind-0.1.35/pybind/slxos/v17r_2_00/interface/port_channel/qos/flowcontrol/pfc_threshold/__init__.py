...
import __builtin__
import threshold
class pfc_threshold(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/port-channel/qos/flowcontrol/pfc-threshold. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__threshold',)

  _yang_name = 'pfc-threshold'
  _rest_name = ''
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__threshold = YANGDynClass(base=threshold.threshold, is_container='container', presence=False, yang_name="threshold", rest_name="threshold", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Tx On/Off thresholds', u'cli-compact-syntax': None, u'hidden': u'performance-tuning', u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-qos-mls', defining_module='brocade-qos-mls', yang_type='container', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'qos', u'flowcontrol', u'pfc-threshold']
  ...
  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /interface/port_channel/qos/flowcontrol/pfc_threshold/threshold (container)
    """
    return self.__threshold
      
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /interface/port_channel/qos/flowcontrol/pfc_threshold/threshold (container)
