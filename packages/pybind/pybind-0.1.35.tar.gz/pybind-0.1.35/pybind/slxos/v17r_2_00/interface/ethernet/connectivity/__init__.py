...
class connectivity(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/connectivity. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__deviceconnectivity',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'connectivity']
  ...
  def _get_deviceconnectivity(self):
    """
    Getter method for deviceconnectivity, mapped from YANG variable /interface/ethernet/connectivity/deviceconnectivity (enumeration)
    """
    return self.__deviceconnectivity
      
  def _set_deviceconnectivity(self, v, load=False):
    """
    Setter method for deviceconnectivity, mapped from YANG variable /interface/ethernet/connectivity/deviceconnectivity (enumeration)
  ...
  _pyangbind_elements = {'deviceconnectivity': deviceconnectivity, }
