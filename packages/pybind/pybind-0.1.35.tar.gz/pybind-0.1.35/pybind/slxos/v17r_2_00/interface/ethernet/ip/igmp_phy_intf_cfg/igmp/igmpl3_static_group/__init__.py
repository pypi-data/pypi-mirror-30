...
import __builtin__
class igmpl3_static_group(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/igmp-phy-intf-cfg/igmp/igmpl3-static-group. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'igmp-phy-intf-cfg', u'igmp', u'igmpl3-static-group']
  ...
  def _get_igmpl3_sg_addr(self):
    """
    Getter method for igmpl3_sg_addr, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_static_group/igmpl3_sg_addr (inet:ipv4-address)
    """
    return self.__igmpl3_sg_addr
      
  def _set_igmpl3_sg_addr(self, v, load=False):
    """
    Setter method for igmpl3_sg_addr, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_static_group/igmpl3_sg_addr (inet:ipv4-address)
