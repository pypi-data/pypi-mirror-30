...
class filter(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/arp/inspection/filter. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'arp', u'inspection', u'filter']
  ...
  def _get_acl_name(self):
    """
    Getter method for acl_name, mapped from YANG variable /interface/port_channel/ip/arp/inspection/filter/acl_name (dai-acl-policy-name)
    """
    return self.__acl_name
      
  def _set_acl_name(self, v, load=False):
    """
    Setter method for acl_name, mapped from YANG variable /interface/port_channel/ip/arp/inspection/filter/acl_name (dai-acl-policy-name)
