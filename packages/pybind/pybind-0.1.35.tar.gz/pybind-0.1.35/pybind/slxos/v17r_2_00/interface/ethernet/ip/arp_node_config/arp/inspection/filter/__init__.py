...
class filter(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/arp-node-config/arp/inspection/filter. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'arp-node-config', u'arp', u'inspection', u'filter']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'ip', u'arp', u'inspection', u'filter']

  def _get_acl_name(self):
    """
    Getter method for acl_name, mapped from YANG variable /interface/ethernet/ip/arp_node_config/arp/inspection/filter/acl_name (dai-acl-policy-name)
    """
    return self.__acl_name
      
  def _set_acl_name(self, v, load=False):
    """
    Setter method for acl_name, mapped from YANG variable /interface/ethernet/ip/arp_node_config/arp/inspection/filter/acl_name (dai-acl-policy-name)
