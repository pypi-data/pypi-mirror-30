...
class database_filter(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/interface-eth-ospf-conf/ospf1/database-filter. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'interface-eth-ospf-conf', u'ospf1', u'database-filter']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'ip', u'ospf', u'database-filter']

  def _get_all_out(self):
    """
    Getter method for all_out, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/database_filter/all_out (empty)
    """
    return self.__all_out
      
  def _set_all_out(self, v, load=False):
    """
    Setter method for all_out, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/database_filter/all_out (empty)
  ...
  def _get_all_external(self):
    """
    Getter method for all_external, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/database_filter/all_external (database-filter-options)
    """
    return self.__all_external
      
  def _set_all_external(self, v, load=False):
    """
    Setter method for all_external, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/database_filter/all_external (database-filter-options)
    If this variable is read-only (config: false) in the
  ...
  def _get_all_summary_external(self):
    """
    Getter method for all_summary_external, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/database_filter/all_summary_external (database-filter-options)
    """
    return self.__all_summary_external
      
  def _set_all_summary_external(self, v, load=False):
    """
    Setter method for all_summary_external, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/database_filter/all_summary_external (database-filter-options)
    If this variable is read-only (config: false) in the
