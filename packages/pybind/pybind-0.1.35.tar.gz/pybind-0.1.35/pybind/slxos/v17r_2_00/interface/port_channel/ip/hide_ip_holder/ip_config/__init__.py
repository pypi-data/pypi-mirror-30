...
class ip_config(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/hide-ip-holder/ip-config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__mtu','__directed_broadcast','__proxy_arp','__arp','__arp_aging_timeout','__address',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'hide-ip-holder', u'ip-config']
  ...
  def _get_mtu(self):
    """
    Getter method for mtu, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/mtu (uint32)
    """
    return self.__mtu
      
  def _set_mtu(self, v, load=False):
    """
    Setter method for mtu, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/mtu (uint32)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'576..9018']}), default=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32)(1500), is_leaf=True, yang_name="mtu", rest_name="mtu", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'cli-run-template': u'ip mtu $(mtu)\n', u'info': u'Set ip mtu value to interface'}}, namespace='urn:brocade.com:mgmt:brocade-ip-config', defining_module='brocade-ip-config', yang_type='uint32', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """mtu must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'576..9018']}), default=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32)(1500), is_leaf=True, yang_name="mtu", rest_name="mtu", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'cli-run-template': u'ip mtu $(mtu)\n', u'info': u'Set ip mtu value to interface'}}, namespace='urn:brocade.com:mgmt:brocade-ip-config', defining_module='brocade-ip-config', yang_type='uint32', is_config=True)""",
        })
  ...
  def _get_directed_broadcast(self):
    """
    Getter method for directed_broadcast, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/directed_broadcast (empty)
    """
    return self.__directed_broadcast
      
  def _set_directed_broadcast(self, v, load=False):
    """
    Setter method for directed_broadcast, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/directed_broadcast (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_proxy_arp(self):
    """
    Getter method for proxy_arp, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/proxy_arp (empty)
    """
    return self.__proxy_arp
      
  def _set_proxy_arp(self, v, load=False):
    """
    Setter method for proxy_arp, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/proxy_arp (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_arp(self):
    """
    Getter method for arp, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/arp (container)
    """
    return self.__arp
      
  def _set_arp(self, v, load=False):
    """
    Setter method for arp, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/arp (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_arp_aging_timeout(self):
    """
    Getter method for arp_aging_timeout, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/arp_aging_timeout (uint32)
    """
    return self.__arp_aging_timeout
      
  def _set_arp_aging_timeout(self, v, load=False):
    """
    Setter method for arp_aging_timeout, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/arp_aging_timeout (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/address (list)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/address (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'mtu': mtu, 'directed_broadcast': directed_broadcast, 'proxy_arp': proxy_arp, 'arp': arp, 'arp_aging_timeout': arp_aging_timeout, 'address': address, }
