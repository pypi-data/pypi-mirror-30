...
class suppressing_address(PybindBase):
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'ipv6', u'nd', u'address', u'suppressing-address']

  def _get_suppress_ipv6_address(self):
    """
    Getter method for suppress_ipv6_address, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/address/suppressing_address/suppress_ipv6_address (nd-suppress-ipv6-address)
    """
    return self.__suppress_ipv6_address
      
  def _set_suppress_ipv6_address(self, v, load=False):
    """
    Setter method for suppress_ipv6_address, mapped from YANG variable /interface/ethernet/ipv6/ipv6_nd_ra/ipv6_intf_cmds/nd/address/suppressing_address/suppress_ipv6_address (nd-suppress-ipv6-address)
