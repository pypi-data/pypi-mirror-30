...
import __builtin__
import igmpl3_static_group
class igmp(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/igmp-phy-intf-cfg/igmp. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__igmpl3_last_member_query_interval','__igmpl3_query_interval','__igmpl3_query_max_response_time','__igmpl3_immediate_leave','__igmpl3_version','__igmpl3_static_group',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__igmpl3_static_group = YANGDynClass(base=YANGListType("igmpl3_sg_addr",igmpl3_static_group.igmpl3_static_group, yang_name="igmpl3-static-group", rest_name="static-group", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='igmpl3-sg-addr', extensions={u'tailf-common': {u'callpoint': u'IgmpSgPhy', u'cli-suppress-mode': None, u'alt-name': u'static-group', u'info': u'Static Group to be Joined', u'cli-suppress-list-no': None}}), is_container='list', yang_name="igmpl3-static-group", rest_name="static-group", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'IgmpSgPhy', u'cli-suppress-mode': None, u'alt-name': u'static-group', u'info': u'Static Group to be Joined', u'cli-suppress-list-no': None}}, namespace='urn:brocade.com:mgmt:brocade-igmp', defining_module='brocade-igmp', yang_type='list', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'igmp-phy-intf-cfg', u'igmp']
  ...
  def _get_igmpl3_last_member_query_interval(self):
    """
    Getter method for igmpl3_last_member_query_interval, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_last_member_query_interval (igmp-snooping:lmqt-type)
    """
    return self.__igmpl3_last_member_query_interval
      
  def _set_igmpl3_last_member_query_interval(self, v, load=False):
    """
    Setter method for igmpl3_last_member_query_interval, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_last_member_query_interval (igmp-snooping:lmqt-type)
  ...
  def _get_igmpl3_query_interval(self):
    """
    Getter method for igmpl3_query_interval, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_query_interval (igmp-snooping:qi-type)
    """
    return self.__igmpl3_query_interval
      
  def _set_igmpl3_query_interval(self, v, load=False):
    """
    Setter method for igmpl3_query_interval, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_query_interval (igmp-snooping:qi-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_igmpl3_query_max_response_time(self):
    """
    Getter method for igmpl3_query_max_response_time, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_query_max_response_time (igmp-snooping:qmrt-type)
    """
    return self.__igmpl3_query_max_response_time
      
  def _set_igmpl3_query_max_response_time(self, v, load=False):
    """
    Setter method for igmpl3_query_max_response_time, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_query_max_response_time (igmp-snooping:qmrt-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_igmpl3_immediate_leave(self):
    """
    Getter method for igmpl3_immediate_leave, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_immediate_leave (empty)
    """
    return self.__igmpl3_immediate_leave
      
  def _set_igmpl3_immediate_leave(self, v, load=False):
    """
    Setter method for igmpl3_immediate_leave, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_immediate_leave (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_igmpl3_version(self):
    """
    Getter method for igmpl3_version, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_version (uint32)
    """
    return self.__igmpl3_version
      
  def _set_igmpl3_version(self, v, load=False):
    """
    Setter method for igmpl3_version, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_version (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_igmpl3_static_group(self):
    """
    Getter method for igmpl3_static_group, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_static_group (list)
    """
    return self.__igmpl3_static_group
      
  def _set_igmpl3_static_group(self, v, load=False):
    """
    Setter method for igmpl3_static_group, mapped from YANG variable /interface/ethernet/ip/igmp_phy_intf_cfg/igmp/igmpl3_static_group (list)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """igmpl3_static_group must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("igmpl3_sg_addr",igmpl3_static_group.igmpl3_static_group, yang_name="igmpl3-static-group", rest_name="static-group", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='igmpl3-sg-addr', extensions={u'tailf-common': {u'callpoint': u'IgmpSgPhy', u'cli-suppress-mode': None, u'alt-name': u'static-group', u'info': u'Static Group to be Joined', u'cli-suppress-list-no': None}}), is_container='list', yang_name="igmpl3-static-group", rest_name="static-group", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'IgmpSgPhy', u'cli-suppress-mode': None, u'alt-name': u'static-group', u'info': u'Static Group to be Joined', u'cli-suppress-list-no': None}}, namespace='urn:brocade.com:mgmt:brocade-igmp', defining_module='brocade-igmp', yang_type='list', is_config=True)""",
        })

    self.__igmpl3_static_group = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_igmpl3_static_group(self):
    self.__igmpl3_static_group = YANGDynClass(base=YANGListType("igmpl3_sg_addr",igmpl3_static_group.igmpl3_static_group, yang_name="igmpl3-static-group", rest_name="static-group", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='igmpl3-sg-addr', extensions={u'tailf-common': {u'callpoint': u'IgmpSgPhy', u'cli-suppress-mode': None, u'alt-name': u'static-group', u'info': u'Static Group to be Joined', u'cli-suppress-list-no': None}}), is_container='list', yang_name="igmpl3-static-group", rest_name="static-group", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'IgmpSgPhy', u'cli-suppress-mode': None, u'alt-name': u'static-group', u'info': u'Static Group to be Joined', u'cli-suppress-list-no': None}}, namespace='urn:brocade.com:mgmt:brocade-igmp', defining_module='brocade-igmp', yang_type='list', is_config=True)
  ...
  igmpl3_static_group = __builtin__.property(_get_igmpl3_static_group, _set_igmpl3_static_group)


  _pyangbind_elements = {'igmpl3_last_member_query_interval': igmpl3_last_member_query_interval, 'igmpl3_query_interval': igmpl3_query_interval, 'igmpl3_query_max_response_time': igmpl3_query_max_response_time, 'igmpl3_immediate_leave': igmpl3_immediate_leave, 'igmpl3_version': igmpl3_version, 'igmpl3_static_group': igmpl3_static_group, }
