...
class tagged_outer_vlan(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/logical-interface/port-channel/tagged-outer-vlan. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'logical-interface', u'port-channel', u'tagged-outer-vlan']
  ...
  def _set_outer_tagged_vlan_id(self, v, load=False):
    """
    Setter method for outer_tagged_vlan_id, mapped from YANG variable /interface/port_channel/logical_interface/port_channel/tagged_outer_vlan/outer_tagged_vlan_id (uint32)
  ...
  def _set_inner_tagged_vlan_id(self, v, load=False):
    """
    Setter method for inner_tagged_vlan_id, mapped from YANG variable /interface/port_channel/logical_interface/port_channel/tagged_outer_vlan/inner_tagged_vlan_id (uint32)
    If this variable is read-only (config: false) in the
