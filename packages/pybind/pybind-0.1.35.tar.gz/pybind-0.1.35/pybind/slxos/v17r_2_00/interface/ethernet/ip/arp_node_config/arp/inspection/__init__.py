...
class inspection(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/ip/arp-node-config/arp/inspection. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'ip', u'arp-node-config', u'arp', u'inspection']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ethernet', u'ip', u'arp', u'inspection']
  ...
  def _get_filter(self):
    """
    Getter method for filter, mapped from YANG variable /interface/ethernet/ip/arp_node_config/arp/inspection/filter (container)
    """
    return self.__filter
      
  def _set_filter(self, v, load=False):
    """
    Setter method for filter, mapped from YANG variable /interface/ethernet/ip/arp_node_config/arp/inspection/filter (container)
    If this variable is read-only (config: false) in the
