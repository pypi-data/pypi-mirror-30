...
class threshold(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/qos/flowcontrol/pfc-threshold/threshold. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'qos', u'flowcontrol', u'pfc-threshold', u'threshold']
  ...
  def _set_pfc(self, v, load=False):
    """
    Setter method for pfc, mapped from YANG variable /interface/port_channel/qos/flowcontrol/pfc_threshold/threshold/pfc (list)
