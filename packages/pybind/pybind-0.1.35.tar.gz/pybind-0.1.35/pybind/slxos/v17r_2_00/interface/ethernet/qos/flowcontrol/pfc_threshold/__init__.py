...
class pfc_threshold(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/qos/flowcontrol/pfc-threshold. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'qos', u'flowcontrol', u'pfc-threshold']
  ...
  def _get_threshold(self):
    """
    Getter method for threshold, mapped from YANG variable /interface/ethernet/qos/flowcontrol/pfc_threshold/threshold (container)
    """
    return self.__threshold
      
  def _set_threshold(self, v, load=False):
    """
    Setter method for threshold, mapped from YANG variable /interface/ethernet/qos/flowcontrol/pfc_threshold/threshold (container)
