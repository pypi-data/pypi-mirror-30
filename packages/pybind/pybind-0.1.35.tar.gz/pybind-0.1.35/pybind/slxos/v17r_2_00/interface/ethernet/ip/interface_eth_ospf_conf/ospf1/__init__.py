...
class ospf1(PybindBase):
  ...
  def _get_authentication(self):
    """
    Getter method for authentication, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/authentication (container)
  ...
  def _set_authentication(self, v, load=False):
    """
    Setter method for authentication, mapped from YANG variable /interface/ethernet/ip/interface_eth_ospf_conf/ospf1/authentication (container)
    If this variable is read-only (config: false) in the
