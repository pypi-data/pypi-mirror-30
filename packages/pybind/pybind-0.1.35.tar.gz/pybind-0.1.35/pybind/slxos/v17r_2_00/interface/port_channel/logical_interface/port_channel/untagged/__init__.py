...
class untagged(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/logical-interface/port-channel/untagged. Each member element of
  ...
  def _set_untagged_vlan(self, v, load=False):
    """
    Setter method for untagged_vlan, mapped from YANG variable /interface/port_channel/logical_interface/port_channel/untagged/untagged_vlan (container)
