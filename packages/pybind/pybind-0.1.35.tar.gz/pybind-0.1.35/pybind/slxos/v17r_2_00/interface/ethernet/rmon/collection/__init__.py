...
class collection(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/ethernet/rmon/collection. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'ethernet', u'rmon', u'collection']
  ...
  def _get_ether_stats_entry(self):
    """
    Getter method for ether_stats_entry, mapped from YANG variable /interface/ethernet/rmon/collection/ether_stats_entry (list)
    """
    return self.__ether_stats_entry
      
  def _set_ether_stats_entry(self, v, load=False):
    """
    Setter method for ether_stats_entry, mapped from YANG variable /interface/ethernet/rmon/collection/ether_stats_entry (list)
  ...
  def _get_history_control_entry(self):
    """
    Getter method for history_control_entry, mapped from YANG variable /interface/ethernet/rmon/collection/history_control_entry (list)
    """
    return self.__history_control_entry
      
  def _set_history_control_entry(self, v, load=False):
    """
    Setter method for history_control_entry, mapped from YANG variable /interface/ethernet/rmon/collection/history_control_entry (list)
    If this variable is read-only (config: false) in the
