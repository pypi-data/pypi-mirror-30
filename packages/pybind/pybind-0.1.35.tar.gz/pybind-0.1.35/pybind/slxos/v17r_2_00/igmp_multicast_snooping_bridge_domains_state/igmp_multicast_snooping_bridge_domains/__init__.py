...
import __builtin__
class igmp_multicast_snooping_bridge_domains(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-mc-hms-operational - based on the path /igmp-multicast-snooping-bridge-domains-state/igmp-multicast-snooping-bridge-domains. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Multicast snooping bridge domain
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__bd_id','__pim_sn_status','__igmp_sn_status','__igmp_version',)

  _yang_name = 'igmp-multicast-snooping-bridge-domains'
  _rest_name = 'igmp-multicast-snooping-bridge-domains'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'igmp-multicast-snooping-bridge-domains-state', u'igmp-multicast-snooping-bridge-domains']
  ...
  def _get_bd_id(self):
    """
    Getter method for bd_id, mapped from YANG variable /igmp_multicast_snooping_bridge_domains_state/igmp_multicast_snooping_bridge_domains/bd_id (uint32)
  ...
  def _set_bd_id(self, v, load=False):
    """
    Setter method for bd_id, mapped from YANG variable /igmp_multicast_snooping_bridge_domains_state/igmp_multicast_snooping_bridge_domains/bd_id (uint32)
  ...
  def _get_pim_sn_status(self):
    """
    Getter method for pim_sn_status, mapped from YANG variable /igmp_multicast_snooping_bridge_domains_state/igmp_multicast_snooping_bridge_domains/pim_sn_status (uint8)
  ...
  def _set_pim_sn_status(self, v, load=False):
    """
    Setter method for pim_sn_status, mapped from YANG variable /igmp_multicast_snooping_bridge_domains_state/igmp_multicast_snooping_bridge_domains/pim_sn_status (uint8)
    If this variable is read-only (config: false) in the
  ...
  def _get_igmp_sn_status(self):
    """
    Getter method for igmp_sn_status, mapped from YANG variable /igmp_multicast_snooping_bridge_domains_state/igmp_multicast_snooping_bridge_domains/igmp_sn_status (uint8)
  ...
  def _set_igmp_sn_status(self, v, load=False):
    """
    Setter method for igmp_sn_status, mapped from YANG variable /igmp_multicast_snooping_bridge_domains_state/igmp_multicast_snooping_bridge_domains/igmp_sn_status (uint8)
    If this variable is read-only (config: false) in the
  ...
  def _get_igmp_version(self):
    """
    Getter method for igmp_version, mapped from YANG variable /igmp_multicast_snooping_bridge_domains_state/igmp_multicast_snooping_bridge_domains/igmp_version (uint8)
  ...
  def _set_igmp_version(self, v, load=False):
    """
    Setter method for igmp_version, mapped from YANG variable /igmp_multicast_snooping_bridge_domains_state/igmp_multicast_snooping_bridge_domains/igmp_version (uint8)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'bd_id': bd_id, 'pim_sn_status': pim_sn_status, 'igmp_sn_status': igmp_sn_status, 'igmp_version': igmp_version, }
