...
class logical_interface_state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__main_interface_physical','__main_interface_pseudo_wire','__main_interface_tunnel',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__main_interface_pseudo_wire = YANGDynClass(base=YANGListType("interface_index",main_interface_pseudo_wire.main_interface_pseudo_wire, yang_name="main-interface-pseudo-wire", rest_name="main-interface-pseudo-wire", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='interface-index', extensions={u'tailf-common': {u'callpoint': u'nsm-main-interface-pseudo-wire', u'cli-suppress-show-path': None}}), is_container='list', yang_name="main-interface-pseudo-wire", rest_name="main-interface-pseudo-wire", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-main-interface-pseudo-wire', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
    self.__main_interface_physical = YANGDynClass(base=YANGListType("interface_index intf_name",main_interface_physical.main_interface_physical, yang_name="main-interface-physical", rest_name="main-interface-physical", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='interface-index intf-name', extensions={u'tailf-common': {u'callpoint': u'nsm-main-interface-physical', u'cli-suppress-show-path': None}}), is_container='list', yang_name="main-interface-physical", rest_name="main-interface-physical", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-main-interface-physical', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
    self.__main_interface_tunnel = YANGDynClass(base=YANGListType("interface_index",main_interface_tunnel.main_interface_tunnel, yang_name="main-interface-tunnel", rest_name="main-interface-tunnel", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='interface-index', extensions={u'tailf-common': {u'callpoint': u'nsm-main-interface-tunnel', u'cli-suppress-show-path': None}}), is_container='list', yang_name="main-interface-tunnel", rest_name="main-interface-tunnel", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-main-interface-tunnel', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)
  ...
  def _get_main_interface_pseudo_wire(self):
    """
    Getter method for main_interface_pseudo_wire, mapped from YANG variable /logical_interface_state/main_interface_pseudo_wire (list)
  ...
  def _set_main_interface_pseudo_wire(self, v, load=False):
    """
    Setter method for main_interface_pseudo_wire, mapped from YANG variable /logical_interface_state/main_interface_pseudo_wire (list)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """main_interface_pseudo_wire must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("interface_index",main_interface_pseudo_wire.main_interface_pseudo_wire, yang_name="main-interface-pseudo-wire", rest_name="main-interface-pseudo-wire", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='interface-index', extensions={u'tailf-common': {u'callpoint': u'nsm-main-interface-pseudo-wire', u'cli-suppress-show-path': None}}), is_container='list', yang_name="main-interface-pseudo-wire", rest_name="main-interface-pseudo-wire", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-main-interface-pseudo-wire', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)""",
        })
  ...
  def _get_main_interface_tunnel(self):
    """
    Getter method for main_interface_tunnel, mapped from YANG variable /logical_interface_state/main_interface_tunnel (list)
  ...
  def _set_main_interface_tunnel(self, v, load=False):
    """
    Setter method for main_interface_tunnel, mapped from YANG variable /logical_interface_state/main_interface_tunnel (list)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """main_interface_tunnel must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("interface_index",main_interface_tunnel.main_interface_tunnel, yang_name="main-interface-tunnel", rest_name="main-interface-tunnel", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='interface-index', extensions={u'tailf-common': {u'callpoint': u'nsm-main-interface-tunnel', u'cli-suppress-show-path': None}}), is_container='list', yang_name="main-interface-tunnel", rest_name="main-interface-tunnel", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-main-interface-tunnel', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=False)""",
        })
  ...
  _pyangbind_elements = {'main_interface_physical': main_interface_physical, 'main_interface_pseudo_wire': main_interface_pseudo_wire, 'main_interface_tunnel': main_interface_tunnel, }
