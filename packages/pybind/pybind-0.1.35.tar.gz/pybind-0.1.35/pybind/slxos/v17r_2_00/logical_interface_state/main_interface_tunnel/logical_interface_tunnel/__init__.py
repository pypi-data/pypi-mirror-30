...
class logical_interface_tunnel(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__source_type','__protocol_status','__admin_status','__lif_index','__bridge_domain_index','__interface_name','__is_binded','__logical_interface_name','__vni_tni',)
  ...
  _pyangbind_elements = {'source_type': source_type, 'protocol_status': protocol_status, 'admin_status': admin_status, 'lif_index': lif_index, 'bridge_domain_index': bridge_domain_index, 'interface_name': interface_name, 'is_binded': is_binded, 'logical_interface_name': logical_interface_name, 'vni_tni': vni_tni, }
