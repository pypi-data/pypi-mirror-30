...
class isis_intf_brief(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__intf_type','__intf_number','__circuit_type','__is_circuit_passive','__circuit_mode','__circ_state','__mtu_size','__circ_adj_up','__circ_changes','__adj_changes','__is_l1_dis','__is_l2_dis',)
  ...
  def _get_intf_type(self):
    """
    Getter method for intf_type, mapped from YANG variable /isis_state/interface_brief/isis_intf_brief/intf_type (isis-interface-type)
  ...
  def _set_intf_type(self, v, load=False):
    """
    Setter method for intf_type, mapped from YANG variable /isis_state/interface_brief/isis_intf_brief/intf_type (isis-interface-type)
  ...
  def _get_intf_number(self):
    """
    Getter method for intf_number, mapped from YANG variable /isis_state/interface_brief/isis_intf_brief/intf_number (string)
  ...
  def _set_intf_number(self, v, load=False):
    """
    Setter method for intf_number, mapped from YANG variable /isis_state/interface_brief/isis_intf_brief/intf_number (string)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'intf_type': intf_type, 'intf_number': intf_number, 'circuit_type': circuit_type, 'is_circuit_passive': is_circuit_passive, 'circuit_mode': circuit_mode, 'circ_state': circ_state, 'mtu_size': mtu_size, 'circ_adj_up': circ_adj_up, 'circ_changes': circ_changes, 'adj_changes': adj_changes, 'is_l1_dis': is_l1_dis, 'is_l2_dis': is_l2_dis, }
