...
class ipv6_routes(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__level1_route_count','__level2_route_count','__ecmp_route_count','__total_routes_count','__ipv6_route_entry',)
  ...
  def _get_total_routes_count(self):
    """
    Getter method for total_routes_count, mapped from YANG variable /isis_state/ipv6_routes/total_routes_count (uint32)

    YANG Description: Total number of IPv6 ISIS routes
    """
    return self.__total_routes_count
      
  def _set_total_routes_count(self, v, load=False):
    """
    Setter method for total_routes_count, mapped from YANG variable /isis_state/ipv6_routes/total_routes_count (uint32)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'level1_route_count': level1_route_count, 'level2_route_count': level2_route_count, 'ecmp_route_count': ecmp_route_count, 'total_routes_count': total_routes_count, 'ipv6_route_entry': ipv6_route_entry, }
