...
class priority(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__priority_in_values','__drop_precedence','__to',)
  ...
  def _set_to(self, v, load=False):
    """
    Setter method for to, mapped from YANG variable /qos_mpls/map/traffic_class_exp/priority/to (container)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=to.to, is_container='container', presence=False, yang_name="to", rest_name="to", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'to', u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-qos-mpls', defining_module='brocade-qos-mpls', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """to must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=to.to, is_container='container', presence=False, yang_name="to", rest_name="to", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'to', u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-qos-mpls', defining_module='brocade-qos-mpls', yang_type='container', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'priority_in_values': priority_in_values, 'drop_precedence': drop_precedence, 'to': to, }
