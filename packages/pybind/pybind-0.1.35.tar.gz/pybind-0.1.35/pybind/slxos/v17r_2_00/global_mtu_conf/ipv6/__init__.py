...
class ipv6(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__global_ipv6_mtu = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1300..9194']}), default=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32)(1500), is_leaf=True, yang_name="global-ipv6-mtu", rest_name="mtu", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Set ipv6 mtu value to all interfaces', u'alt-name': u'mtu'}}, namespace='urn:brocade.com:mgmt:brocade-ipv6-config', defining_module='brocade-ipv6-config', yang_type='ip-mtu', is_config=True)
  ...
  def _get_global_ipv6_mtu(self):
    """
    Getter method for global_ipv6_mtu, mapped from YANG variable /global_mtu_conf/ipv6/global_ipv6_mtu (ip-mtu)
...
datagram that can be sent on the interface.
  ...
  def _set_global_ipv6_mtu(self, v, load=False):
    """
    Setter method for global_ipv6_mtu, mapped from YANG variable /global_mtu_conf/ipv6/global_ipv6_mtu (ip-mtu)
...
datagram that can be sent on the interface.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """global_ipv6_mtu must be of a type compatible with ip-mtu""",
