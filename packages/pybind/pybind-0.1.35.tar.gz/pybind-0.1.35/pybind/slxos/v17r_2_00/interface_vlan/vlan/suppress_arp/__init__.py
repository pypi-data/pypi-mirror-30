...
class suppress_arp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/vlan/suppress-arp. Each member element of
  ...
  def _set_suppress_arp_enable(self, v, load=False):
    """
    Setter method for suppress_arp_enable, mapped from YANG variable /interface_vlan/vlan/suppress_arp/suppress_arp_enable (empty)
