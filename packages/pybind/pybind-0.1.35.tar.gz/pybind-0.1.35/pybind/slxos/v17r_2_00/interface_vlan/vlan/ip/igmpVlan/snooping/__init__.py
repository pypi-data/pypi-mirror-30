...
class snooping(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__igmps_mrouter = YANGDynClass(base=igmps_mrouter.igmps_mrouter, is_container='container', presence=False, yang_name="igmps_mrouter", rest_name="mrouter", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'IgmpsMrtrVlan', u'info': u'Multicast Router', u'alt-name': u'mrouter', u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-igmp-snooping', defining_module='brocade-igmp-snooping', yang_type='container', is_config=True)
