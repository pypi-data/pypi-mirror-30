...
import __builtin__
import mpls_traffic_lsps
import add_
class mpls_traffic_lsp(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-telemetry - based on the path /telemetry/profile/mpls-traffic-lsp. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__interval','__mpls_traffic_lsps','__add_',)

  _yang_name = 'mpls-traffic-lsp'
  _rest_name = 'mpls-traffic-lsp'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'telemetry', u'profile', u'mpls-traffic-lsp']
  ...
  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /telemetry/profile/mpls_traffic_lsp/name (mpls-traffic-lsp-profile-name-type)
    """
    return self.__name
      
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /telemetry/profile/mpls_traffic_lsp/name (mpls-traffic-lsp-profile-name-type)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'default_mpls_traffic_lsp_statistics', 'length': [u'3..64']}), is_leaf=True, yang_name="name", rest_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'MPLS profile name'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-telemetry', defining_module='brocade-telemetry', yang_type='mpls-traffic-lsp-profile-name-type', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """name must be of a type compatible with mpls-traffic-lsp-profile-name-type""",
          'defined-type': "brocade-telemetry:mpls-traffic-lsp-profile-name-type",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'default_mpls_traffic_lsp_statistics', 'length': [u'3..64']}), is_leaf=True, yang_name="name", rest_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'MPLS profile name'}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-telemetry', defining_module='brocade-telemetry', yang_type='mpls-traffic-lsp-profile-name-type', is_config=True)""",
        })
  ...
  def _get_interval(self):
    """
    Getter method for interval, mapped from YANG variable /telemetry/profile/mpls_traffic_lsp/interval (mpls-traffic-profile-interval-type)
    """
    return self.__interval
      
  def _set_interval(self, v, load=False):
    """
    Setter method for interval, mapped from YANG variable /telemetry/profile/mpls_traffic_lsp/interval (mpls-traffic-profile-interval-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_mpls_traffic_lsps(self):
    """
    Getter method for mpls_traffic_lsps, mapped from YANG variable /telemetry/profile/mpls_traffic_lsp/mpls_traffic_lsps (list)
    """
    return self.__mpls_traffic_lsps
  ...
  def _unset_mpls_traffic_lsps(self):
    self.__mpls_traffic_lsps = YANGDynClass(base=YANGListType("mpls_traffic_lsp_name",mpls_traffic_lsps.mpls_traffic_lsps, yang_name="mpls-traffic-lsps", rest_name="lsp", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='mpls-traffic-lsp-name', extensions={u'tailf-common': {u'callpoint': u'Mplstrafficlsp', u'cli-suppress-mode': None, u'alt-name': u'lsp', u'info': u'MPLS Stats profile by LSP name', u'cli-suppress-list-no': None}}), is_container='list', yang_name="mpls-traffic-lsps", rest_name="lsp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'Mplstrafficlsp', u'cli-suppress-mode': None, u'alt-name': u'lsp', u'info': u'MPLS Stats profile by LSP name', u'cli-suppress-list-no': None}}, namespace='urn:brocade.com:mgmt:brocade-telemetry', defining_module='brocade-telemetry', yang_type='list', is_config=True)


  def _get_add_(self):
    """
    Getter method for add_, mapped from YANG variable /telemetry/profile/mpls_traffic_lsp/add (list)
    """
    return self.__add_
      
  def _set_add_(self, v, load=False):
    """
    Setter method for add_, mapped from YANG variable /telemetry/profile/mpls_traffic_lsp/add (list)
    If this variable is read-only (config: false) in the
  ...
  mpls_traffic_lsps = __builtin__.property(_get_mpls_traffic_lsps, _set_mpls_traffic_lsps)
  add_ = __builtin__.property(_get_add_, _set_add_)


  _pyangbind_elements = {'name': name, 'interval': interval, 'mpls_traffic_lsps': mpls_traffic_lsps, 'add_': add_, }
