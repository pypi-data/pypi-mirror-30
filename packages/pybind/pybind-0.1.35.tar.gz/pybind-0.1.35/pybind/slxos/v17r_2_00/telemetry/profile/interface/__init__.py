...
class interface(PybindBase):
  ...
  from YANG module brocade-telemetry - based on the path /telemetry/profile/interface. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__interval','__interface','__add_',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'telemetry', u'profile', u'interface']
  ...
  def _get_name(self):
    """
    Getter method for name, mapped from YANG variable /telemetry/profile/interface/name (interface-profile-name-type)
    """
    return self.__name
      
  def _set_name(self, v, load=False):
    """
    Setter method for name, mapped from YANG variable /telemetry/profile/interface/name (interface-profile-name-type)
  ...
  def _get_interval(self):
    """
    Getter method for interval, mapped from YANG variable /telemetry/profile/interface/interval (interface-profile-interval-type)
    """
    return self.__interval
      
  def _set_interval(self, v, load=False):
    """
    Setter method for interval, mapped from YANG variable /telemetry/profile/interface/interval (interface-profile-interval-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /telemetry/profile/interface/interface (list)
    """
    return self.__interface
      
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /telemetry/profile/interface/interface (list)
    If this variable is read-only (config: false) in the
  ...
  def _get_add_(self):
    """
    Getter method for add_, mapped from YANG variable /telemetry/profile/interface/add (list)
    """
    return self.__add_
      
  def _set_add_(self, v, load=False):
    """
    Setter method for add_, mapped from YANG variable /telemetry/profile/interface/add (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'name': name, 'interval': interval, 'interface': interface, 'add_': add_, }
