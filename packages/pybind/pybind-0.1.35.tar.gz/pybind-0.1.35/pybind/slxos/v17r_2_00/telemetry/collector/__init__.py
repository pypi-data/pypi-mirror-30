...
class collector(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__collector_name','__collector_ip','__collector_profile','__collector_encoding','__collector_activate',)
  ...
  _pyangbind_elements = {'collector_name': collector_name, 'collector_ip': collector_ip, 'collector_profile': collector_profile, 'collector_encoding': collector_encoding, 'collector_activate': collector_activate, }
