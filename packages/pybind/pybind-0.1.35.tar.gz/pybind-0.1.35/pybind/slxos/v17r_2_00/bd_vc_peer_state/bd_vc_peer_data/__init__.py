...
class bd_vc_peer_data(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__vc_peer_address','__vc_peer_state','__vc_peer_uptime','__vc_peer_load_balance','__vc_peer_cos_enabled','__vc_peer_cos_value','__vc_ldp_tnnl_in_use','__vc_local_label','__vc_remote_label','__vc_local_mtu','__vc_remote_mtu','__vc_local_type','__vc_remote_type','__vc_local_pw_status','__vc_remote_pw_status','__vc_local_flow_label_tx','__vc_local_flow_label_rx','__vc_remote_flow_label_tx','__vc_remote_flow_label_rx','__vc_local_control_word','__vc_remote_control_word','__vc_proto_tnnl','__vc_assigned_lsp',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__vc_local_pw_status = YANGDynClass(base=unicode, is_leaf=True, yang_name="vc-local-pw-status", rest_name="vc-local-pw-status", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='string', is_config=False)
    ...
    self.__vc_local_control_word = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-local-control-word", rest_name="vc-local-control-word", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)
    ...
    self.__vc_remote_flow_label_rx = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-remote-flow-label-rx", rest_name="vc-remote-flow-label-rx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)
    self.__vc_remote_flow_label_tx = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-remote-flow-label-tx", rest_name="vc-remote-flow-label-tx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)
    ...
    self.__vc_remote_control_word = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-remote-control-word", rest_name="vc-remote-control-word", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)
    ...
    self.__vc_remote_pw_status = YANGDynClass(base=unicode, is_leaf=True, yang_name="vc-remote-pw-status", rest_name="vc-remote-pw-status", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='string', is_config=False)
    self.__vc_local_flow_label_rx = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-local-flow-label-rx", rest_name="vc-local-flow-label-rx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)
    self.__vc_local_flow_label_tx = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-local-flow-label-tx", rest_name="vc-local-flow-label-tx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)
  ...
  def _get_vc_local_pw_status(self):
    """
    Getter method for vc_local_pw_status, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_local_pw_status (string)

    YANG Description: vc local pw status
    """
    return self.__vc_local_pw_status
      
  def _set_vc_local_pw_status(self, v, load=False):
    """
    Setter method for vc_local_pw_status, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_local_pw_status (string)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="vc-local-pw-status", rest_name="vc-local-pw-status", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='string', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vc_local_pw_status must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="vc-local-pw-status", rest_name="vc-local-pw-status", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='string', is_config=False)""",
        })

    self.__vc_local_pw_status = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_vc_local_pw_status(self):
    self.__vc_local_pw_status = YANGDynClass(base=unicode, is_leaf=True, yang_name="vc-local-pw-status", rest_name="vc-local-pw-status", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='string', is_config=False)


  def _get_vc_remote_pw_status(self):
    """
    Getter method for vc_remote_pw_status, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_remote_pw_status (string)

    YANG Description: vc remote pw status
    """
    return self.__vc_remote_pw_status
      
  def _set_vc_remote_pw_status(self, v, load=False):
    """
    Setter method for vc_remote_pw_status, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_remote_pw_status (string)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="vc-remote-pw-status", rest_name="vc-remote-pw-status", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='string', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vc_remote_pw_status must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="vc-remote-pw-status", rest_name="vc-remote-pw-status", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='string', is_config=False)""",
        })

    self.__vc_remote_pw_status = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_vc_remote_pw_status(self):
    self.__vc_remote_pw_status = YANGDynClass(base=unicode, is_leaf=True, yang_name="vc-remote-pw-status", rest_name="vc-remote-pw-status", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='string', is_config=False)


  def _get_vc_local_flow_label_tx(self):
    """
    Getter method for vc_local_flow_label_tx, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_local_flow_label_tx (boolean)

    YANG Description: vc local flow label Tx
    """
    return self.__vc_local_flow_label_tx
      
  def _set_vc_local_flow_label_tx(self, v, load=False):
    """
    Setter method for vc_local_flow_label_tx, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_local_flow_label_tx (boolean)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="vc-local-flow-label-tx", rest_name="vc-local-flow-label-tx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vc_local_flow_label_tx must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-local-flow-label-tx", rest_name="vc-local-flow-label-tx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)""",
        })
  ...
  def _get_vc_local_flow_label_rx(self):
    """
    Getter method for vc_local_flow_label_rx, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_local_flow_label_rx (boolean)

    YANG Description: vc local flow label Rx
    """
    return self.__vc_local_flow_label_rx
      
  def _set_vc_local_flow_label_rx(self, v, load=False):
    """
    Setter method for vc_local_flow_label_rx, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_local_flow_label_rx (boolean)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """vc_local_flow_label_rx must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-local-flow-label-rx", rest_name="vc-local-flow-label-rx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)""",
        })
  ...
  def _get_vc_remote_flow_label_tx(self):
    """
    Getter method for vc_remote_flow_label_tx, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_remote_flow_label_tx (boolean)

    YANG Description: vc remote flow label Tx
    """
    return self.__vc_remote_flow_label_tx
      
  def _set_vc_remote_flow_label_tx(self, v, load=False):
    """
    Setter method for vc_remote_flow_label_tx, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_remote_flow_label_tx (boolean)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="vc-remote-flow-label-tx", rest_name="vc-remote-flow-label-tx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vc_remote_flow_label_tx must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-remote-flow-label-tx", rest_name="vc-remote-flow-label-tx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)""",
        })
  ...
  def _get_vc_remote_flow_label_rx(self):
    """
    Getter method for vc_remote_flow_label_rx, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_remote_flow_label_rx (boolean)

    YANG Description: vc remote flow label Rx
    """
    return self.__vc_remote_flow_label_rx
      
  def _set_vc_remote_flow_label_rx(self, v, load=False):
    """
    Setter method for vc_remote_flow_label_rx, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_remote_flow_label_rx (boolean)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          'error-string': """vc_remote_flow_label_rx must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-remote-flow-label-rx", rest_name="vc-remote-flow-label-rx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)""",
        })
  ...
  def _get_vc_local_control_word(self):
    """
    Getter method for vc_local_control_word, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_local_control_word (boolean)

    YANG Description: vc local control word
    """
    return self.__vc_local_control_word
      
  def _set_vc_local_control_word(self, v, load=False):
    """
    Setter method for vc_local_control_word, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_local_control_word (boolean)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="vc-local-control-word", rest_name="vc-local-control-word", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vc_local_control_word must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-local-control-word", rest_name="vc-local-control-word", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)""",
        })

    self.__vc_local_control_word = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_vc_local_control_word(self):
    self.__vc_local_control_word = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-local-control-word", rest_name="vc-local-control-word", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)


  def _get_vc_remote_control_word(self):
    """
    Getter method for vc_remote_control_word, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_remote_control_word (boolean)

    YANG Description: vc remote control word
    """
    return self.__vc_remote_control_word
      
  def _set_vc_remote_control_word(self, v, load=False):
    """
    Setter method for vc_remote_control_word, mapped from YANG variable /bd_vc_peer_state/bd_vc_peer_data/vc_remote_control_word (boolean)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="vc-remote-control-word", rest_name="vc-remote-control-word", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vc_remote_control_word must be of a type compatible with boolean""",
          'defined-type': "boolean",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-remote-control-word", rest_name="vc-remote-control-word", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)""",
        })

    self.__vc_remote_control_word = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_vc_remote_control_word(self):
    self.__vc_remote_control_word = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vc-remote-control-word", rest_name="vc-remote-control-word", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-pwm-operational', defining_module='brocade-pwm-operational', yang_type='boolean', is_config=False)
  ...
  vc_local_pw_status = __builtin__.property(_get_vc_local_pw_status)
  vc_remote_pw_status = __builtin__.property(_get_vc_remote_pw_status)
  ...
  vc_local_control_word = __builtin__.property(_get_vc_local_control_word)
  vc_remote_control_word = __builtin__.property(_get_vc_remote_control_word)
  vc_proto_tnnl = __builtin__.property(_get_vc_proto_tnnl)
  vc_assigned_lsp = __builtin__.property(_get_vc_assigned_lsp)


  _pyangbind_elements = {'vc_peer_address': vc_peer_address, 'vc_peer_state': vc_peer_state, 'vc_peer_uptime': vc_peer_uptime, 'vc_peer_load_balance': vc_peer_load_balance, 'vc_peer_cos_enabled': vc_peer_cos_enabled, 'vc_peer_cos_value': vc_peer_cos_value, 'vc_ldp_tnnl_in_use': vc_ldp_tnnl_in_use, 'vc_local_label': vc_local_label, 'vc_remote_label': vc_remote_label, 'vc_local_mtu': vc_local_mtu, 'vc_remote_mtu': vc_remote_mtu, 'vc_local_type': vc_local_type, 'vc_remote_type': vc_remote_type, 'vc_local_pw_status': vc_local_pw_status, 'vc_remote_pw_status': vc_remote_pw_status, 'vc_local_flow_label_tx': vc_local_flow_label_tx, 'vc_local_flow_label_rx': vc_local_flow_label_rx, 'vc_remote_flow_label_tx': vc_remote_flow_label_tx, 'vc_remote_flow_label_rx': vc_remote_flow_label_rx, 'vc_local_control_word': vc_local_control_word, 'vc_remote_control_word': vc_remote_control_word, 'vc_proto_tnnl': vc_proto_tnnl, 'vc_assigned_lsp': vc_assigned_lsp, }
