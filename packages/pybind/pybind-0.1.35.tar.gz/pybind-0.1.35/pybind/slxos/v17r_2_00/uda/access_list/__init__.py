...
class access_list(PybindBase):
  ...
  from YANG module brocade-uda-access-list - based on the path /uda/access-list. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__extended',)
  ...
  def _get_extended(self):
    """
    Getter method for extended, mapped from YANG variable /uda/access_list/extended (list)
    """
    return self.__extended
      
  def _set_extended(self, v, load=False):
    """
    Setter method for extended, mapped from YANG variable /uda/access_list/extended (list)
  ...
  _pyangbind_elements = {'extended': extended, }
