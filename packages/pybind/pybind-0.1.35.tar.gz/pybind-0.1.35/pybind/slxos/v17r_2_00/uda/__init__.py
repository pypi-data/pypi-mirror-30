...
class uda(PybindBase):
  ...
  from YANG module brocade-uda-access-list - based on the path /uda. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__access_list = YANGDynClass(base=access_list.access_list, is_container='container', presence=False, yang_name="access-list", rest_name="access-list", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'UDA access list', u'cli-incomplete-no': None}}, namespace='urn:brocade.com:mgmt:brocade-uda-access-list', defining_module='brocade-uda-access-list', yang_type='container', is_config=True)
  ...
  def _get_access_list(self):
    """
    Getter method for access_list, mapped from YANG variable /uda/access_list (container)
    """
    return self.__access_list
      
  def _set_access_list(self, v, load=False):
    """
    Setter method for access_list, mapped from YANG variable /uda/access_list (container)
