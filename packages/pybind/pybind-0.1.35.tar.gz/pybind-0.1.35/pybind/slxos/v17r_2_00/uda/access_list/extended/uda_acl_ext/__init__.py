...
import __builtin__
import seq
class uda_acl_ext(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-uda-access-list - based on the path /uda/access-list/extended/uda-acl-ext. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__seq',)

  _yang_name = 'uda-acl-ext'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'uda', u'access-list', u'extended', u'uda-acl-ext']
  ...
  def _get_seq(self):
    """
    Getter method for seq, mapped from YANG variable /uda/access_list/extended/uda_acl_ext/seq (list)
    """
    return self.__seq
      
  def _set_seq(self, v, load=False):
    """
    Setter method for seq, mapped from YANG variable /uda/access_list/extended/uda_acl_ext/seq (list)
