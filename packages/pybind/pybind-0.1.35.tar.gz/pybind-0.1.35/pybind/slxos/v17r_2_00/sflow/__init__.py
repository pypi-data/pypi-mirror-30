...
class sflow(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__enable','__null0_sampling','__collector_vrf','__agent_address','__source_interface','__collector','__polling_interval','__sample_rate',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__agent_address = YANGDynClass(base=agent_address.agent_address, is_container='container', presence=False, yang_name="agent-address", rest_name="agent-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'Set sFlow Agent-ID address', u'cli-sequence-commands': None, u'cli-full-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-sflow', defining_module='brocade-sflow', yang_type='container', is_config=True)
  ...
  def _get_agent_address(self):
    ...
    """
    return self.__agent_address
      
  def _set_agent_address(self, v, load=False):
    """
    Setter method for agent_address, mapped from YANG variable /sflow/agent_address (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_agent_address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_agent_address() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=agent_address.agent_address, is_container='container', presence=False, yang_name="agent-address", rest_name="agent-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'Set sFlow Agent-ID address', u'cli-sequence-commands': None, u'cli-full-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-sflow', defining_module='brocade-sflow', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """agent_address must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=agent_address.agent_address, is_container='container', presence=False, yang_name="agent-address", rest_name="agent-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'Set sFlow Agent-ID address', u'cli-sequence-commands': None, u'cli-full-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-sflow', defining_module='brocade-sflow', yang_type='container', is_config=True)""",
        })

    self.__agent_address = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_agent_address(self):
    self.__agent_address = YANGDynClass(base=agent_address.agent_address, is_container='container', presence=False, yang_name="agent-address", rest_name="agent-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'info': u'Set sFlow Agent-ID address', u'cli-sequence-commands': None, u'cli-full-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-sflow', defining_module='brocade-sflow', yang_type='container', is_config=True)
  ...
  agent_address = __builtin__.property(_get_agent_address, _set_agent_address)
  ...
  _pyangbind_elements = {'enable': enable, 'null0_sampling': null0_sampling, 'collector_vrf': collector_vrf, 'agent_address': agent_address, 'source_interface': source_interface, 'collector': collector, 'polling_interval': polling_interval, 'sample_rate': sample_rate, }
