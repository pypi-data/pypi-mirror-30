...
class qos(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__mls','__mqc',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__mls = YANGDynClass(base=mls.mls, is_container='container', presence=False, yang_name="mls", rest_name="mls", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-system-capabilities', defining_module='brocade-system-capabilities', yang_type='container', is_config=False)
  ...
  def _set_mls(self, v, load=False):
    """
    Setter method for mls, mapped from YANG variable /capabilities/qos/mls (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mls is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_mls() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=mls.mls, is_container='container', presence=False, yang_name="mls", rest_name="mls", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-system-capabilities', defining_module='brocade-system-capabilities', yang_type='container', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """mls must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=mls.mls, is_container='container', presence=False, yang_name="mls", rest_name="mls", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-system-capabilities', defining_module='brocade-system-capabilities', yang_type='container', is_config=False)""",
        })
  ...
  def _set_mqc(self, v, load=False):
    """
    Setter method for mqc, mapped from YANG variable /capabilities/qos/mqc (container)
    If this variable is read-only (config: false) in the
  ...
  mls = __builtin__.property(_get_mls)
  mqc = __builtin__.property(_get_mqc)


  _pyangbind_elements = {'mls': mls, 'mqc': mqc, }
