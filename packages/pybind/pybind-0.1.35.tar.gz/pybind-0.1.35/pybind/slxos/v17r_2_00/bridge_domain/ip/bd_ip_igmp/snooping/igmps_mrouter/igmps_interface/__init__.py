...
class igmps_interface(PybindBase):
  ...
  from YANG module brocade-bridge-domain - based on the path /bridge-domain/ip/bd-ip-igmp/snooping/igmps_mrouter/igmps-interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bridge-domain', u'ip', u'bd-ip-igmp', u'snooping', u'igmps_mrouter', u'igmps-interface']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bridge-domain', u'ip', u'igmp', u'snooping', u'mrouter', u'logical-interface']

  def _get_igmps_if_type(self):
    """
    Getter method for igmps_if_type, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_mrouter/igmps_interface/igmps_if_type (enumeration)
    """
    return self.__igmps_if_type
      
  def _set_igmps_if_type(self, v, load=False):
    """
    Setter method for igmps_if_type, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_mrouter/igmps_interface/igmps_if_type (enumeration)
  ...
  def _get_igmps_value(self):
    """
    Getter method for igmps_value, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_mrouter/igmps_interface/igmps_value (string-type)
    """
    return self.__igmps_value
      
  def _set_igmps_value(self, v, load=False):
    """
    Setter method for igmps_value, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_mrouter/igmps_interface/igmps_value (string-type)
    If this variable is read-only (config: false) in the
