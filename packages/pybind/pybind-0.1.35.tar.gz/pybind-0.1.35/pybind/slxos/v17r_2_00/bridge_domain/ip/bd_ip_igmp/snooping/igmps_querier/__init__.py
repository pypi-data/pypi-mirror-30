...
import __builtin__
class igmps_querier(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-bridge-domain - based on the path /bridge-domain/ip/bd-ip-igmp/snooping/igmps-querier. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bridge-domain', u'ip', u'bd-ip-igmp', u'snooping', u'igmps-querier']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bridge-domain', u'ip', u'igmp', u'snooping', u'querier']

  def _get_igmps_qenable(self):
    """
    Getter method for igmps_qenable, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_querier/igmps_qenable (empty)
    """
    return self.__igmps_qenable
      
  def _set_igmps_qenable(self, v, load=False):
    """
    Setter method for igmps_qenable, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_querier/igmps_qenable (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_igmps_qenable is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_igmps_qenable() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  _pyangbind_elements = {'igmps_qenable': igmps_qenable, }
