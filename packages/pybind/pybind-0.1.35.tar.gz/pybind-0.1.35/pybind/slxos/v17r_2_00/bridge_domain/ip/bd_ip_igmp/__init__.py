...
import __builtin__
import snooping
class bd_ip_igmp(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-bridge-domain - based on the path /bridge-domain/ip/bd-ip-igmp. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__snooping',)

  _yang_name = 'bd-ip-igmp'
  _rest_name = 'igmp'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bridge-domain', u'ip', u'bd-ip-igmp']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bridge-domain', u'ip', u'igmp']

  def _get_snooping(self):
    """
    Getter method for snooping, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping (container)
    """
    return self.__snooping
      
  def _set_snooping(self, v, load=False):
    """
    Setter method for snooping, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping (container)
