...
class igmps_mrouter(PybindBase):
  ...
  from YANG module brocade-bridge-domain - based on the path /bridge-domain/ip/bd-ip-igmp/snooping/igmps_mrouter. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__igmps_interface = YANGDynClass(base=YANGListType("igmps_if_type igmps_value",igmps_interface.igmps_interface, yang_name="igmps-interface", rest_name="logical-interface", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='igmps-if-type igmps-value', extensions={u'tailf-common': {u'info': u'Interface to use', u'cli-suppress-mode': None, u'alt-name': u'logical-interface', u'cli-suppress-list-no': None}}), is_container='list', yang_name="igmps-interface", rest_name="logical-interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Interface to use', u'cli-suppress-mode': None, u'alt-name': u'logical-interface', u'cli-suppress-list-no': None}}, namespace='urn:brocade.com:mgmt:brocade-igmp-snooping', defining_module='brocade-igmp-snooping', yang_type='list', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bridge-domain', u'ip', u'bd-ip-igmp', u'snooping', u'igmps_mrouter']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bridge-domain', u'ip', u'igmp', u'snooping', u'mrouter']

  def _get_igmps_interface(self):
    """
    Getter method for igmps_interface, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_mrouter/igmps_interface (list)
    """
    return self.__igmps_interface
      
  def _set_igmps_interface(self, v, load=False):
    """
    Setter method for igmps_interface, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_mrouter/igmps_interface (list)
