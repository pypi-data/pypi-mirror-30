...
import __builtin__
import snooping
class bd_pim(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-bridge-domain - based on the path /bridge-domain/ip/bd-pim. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bridge-domain', u'ip', u'bd-pim']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bridge-domain', u'ip', u'pim']

  def _get_snooping(self):
    """
    Getter method for snooping, mapped from YANG variable /bridge_domain/ip/bd_pim/snooping (container)
    """
    return self.__snooping
      
  def _set_snooping(self, v, load=False):
    """
    Setter method for snooping, mapped from YANG variable /bridge_domain/ip/bd_pim/snooping (container)
