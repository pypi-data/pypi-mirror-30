...
class igmps_static_group(PybindBase):
  ...
  from YANG module brocade-bridge-domain - based on the path /bridge-domain/ip/bd-ip-igmp/snooping/igmps_static-group. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__igmps_interface = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'logical-interface': {}},), is_leaf=True, yang_name="igmps-interface", rest_name="interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'alt-name': u'interface', u'cli-incomplete-no': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-igmp-snooping', defining_module='brocade-igmp-snooping', yang_type='enumeration', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bridge-domain', u'ip', u'bd-ip-igmp', u'snooping', u'igmps_static-group']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bridge-domain', u'ip', u'igmp', u'snooping', u'static-group']

  def _get_igmps_mcast_address(self):
    """
    Getter method for igmps_mcast_address, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_static_group/igmps_mcast_address (inet:ipv4-address)
    """
    return self.__igmps_mcast_address
      
  def _set_igmps_mcast_address(self, v, load=False):
    """
    Setter method for igmps_mcast_address, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_static_group/igmps_mcast_address (inet:ipv4-address)
  ...
  def _get_igmps_interface(self):
    """
    Getter method for igmps_interface, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_static_group/igmps_interface (enumeration)
    """
    return self.__igmps_interface
      
  def _set_igmps_interface(self, v, load=False):
    """
    Setter method for igmps_interface, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_static_group/igmps_interface (enumeration)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'logical-interface': {}},), is_leaf=True, yang_name="igmps-interface", rest_name="interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'alt-name': u'interface', u'cli-incomplete-no': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-igmp-snooping', defining_module='brocade-igmp-snooping', yang_type='enumeration', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """igmps_interface must be of a type compatible with enumeration""",
          'defined-type': "brocade-igmp-snooping:enumeration",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'logical-interface': {}},), is_leaf=True, yang_name="igmps-interface", rest_name="interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'alt-name': u'interface', u'cli-incomplete-no': None}}, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-igmp-snooping', defining_module='brocade-igmp-snooping', yang_type='enumeration', is_config=True)""",
        })
  ...
  def _get_igmps_if_type(self):
    """
    Getter method for igmps_if_type, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_static_group/igmps_if_type (enumeration)
    """
    return self.__igmps_if_type
      
  def _set_igmps_if_type(self, v, load=False):
    """
    Setter method for igmps_if_type, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_static_group/igmps_if_type (enumeration)
    If this variable is read-only (config: false) in the
  ...
  def _get_igmps_value(self):
    """
    Getter method for igmps_value, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_static_group/igmps_value (string-type)
    """
    return self.__igmps_value
      
  def _set_igmps_value(self, v, load=False):
    """
    Setter method for igmps_value, mapped from YANG variable /bridge_domain/ip/bd_ip_igmp/snooping/igmps_static_group/igmps_value (string-type)
    If this variable is read-only (config: false) in the
