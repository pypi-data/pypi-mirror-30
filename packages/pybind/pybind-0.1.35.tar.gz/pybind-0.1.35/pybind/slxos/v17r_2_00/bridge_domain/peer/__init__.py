...
class peer(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__peer_ip','__load_balance','__cos','__lsp','__flow_label','__control_word',)
  ...
  def _get_flow_label(self):
    """
    Getter method for flow_label, mapped from YANG variable /bridge_domain/peer/flow_label (empty)
  ...
  def _set_flow_label(self, v, load=False):
    """
    Setter method for flow_label, mapped from YANG variable /bridge_domain/peer/flow_label (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_control_word(self):
    """
    Getter method for control_word, mapped from YANG variable /bridge_domain/peer/control_word (empty)
  ...
  def _set_control_word(self, v, load=False):
    """
    Setter method for control_word, mapped from YANG variable /bridge_domain/peer/control_word (empty)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'peer_ip': peer_ip, 'load_balance': load_balance, 'cos': cos, 'lsp': lsp, 'flow_label': flow_label, 'control_word': control_word, }
