...
import __builtin__
import interface
class system_config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-system-watermark - based on the path /system-config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__interface',)

  _yang_name = 'system-config'
  _rest_name = 'system'
  ...
  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /system_config/interface (container)
    """
    return self.__interface
      
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /system_config/interface (container)
