...
class system_ras(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-ras - based on the path /system-ras. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__switch_attributes',)

  _yang_name = 'system-ras'
  _rest_name = ''
  ...
  def _set_switch_attributes(self, v, load=False):
    """
    Setter method for switch_attributes, mapped from YANG variable /system_ras/switch_attributes (container)
