...
class switch_attributes(PybindBase):
  ...
  from YANG module brocade-ras - based on the path /system-ras/switch-attributes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system-ras', u'switch-attributes']
  ...
  def _set_chassis_name(self, v, load=False):
    """
    Setter method for chassis_name, mapped from YANG variable /system_ras/switch_attributes/chassis_name (string)
  ...
  def _set_host_name(self, v, load=False):
    """
    Setter method for host_name, mapped from YANG variable /system_ras/switch_attributes/host_name (string)
    If this variable is read-only (config: false) in the
