...
import __builtin__
import show_cluster_management
class brocade_cluster(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-cluster - based on the path /brocade_cluster_rpc. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: This module provides interface to provision principal priority
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__show_cluster_management',)
  ...
  def _get_show_cluster_management(self):
    """
    Getter method for show_cluster_management, mapped from YANG variable /brocade_cluster_rpc/show_cluster_management (rpc)
    """
    return self.__show_cluster_management
      
  def _set_show_cluster_management(self, v, load=False):
    """
    Setter method for show_cluster_management, mapped from YANG variable /brocade_cluster_rpc/show_cluster_management (rpc)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_show_cluster_management is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_show_cluster_management() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  _pyangbind_elements = {'show_cluster_management': show_cluster_management, }
