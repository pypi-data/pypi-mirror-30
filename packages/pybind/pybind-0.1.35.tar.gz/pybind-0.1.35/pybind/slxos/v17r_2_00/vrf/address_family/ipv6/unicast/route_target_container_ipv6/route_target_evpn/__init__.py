...
import __builtin__
class route_target_evpn(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-vrf - based on the path /vrf/address-family/ipv6/unicast/route-target-container-ipv6/route-target-evpn. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv6', u'unicast', u'route-target-container-ipv6', u'route-target-evpn']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv6', u'unicast', u'route-target']

  def _get_action(self):
    """
    Getter method for action, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_target_container_ipv6/route_target_evpn/action (enumeration)
    """
    return self.__action
      
  def _set_action(self, v, load=False):
    """
    Setter method for action, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_target_container_ipv6/route_target_evpn/action (enumeration)
  ...
  def _get_target_community(self):
    """
    Getter method for target_community, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_target_container_ipv6/route_target_evpn/target_community (rt-type)
  ...
  def _set_target_community(self, v, load=False):
    """
    Setter method for target_community, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_target_container_ipv6/route_target_evpn/target_community (rt-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_evpn(self):
    """
    Getter method for evpn, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_target_container_ipv6/route_target_evpn/evpn (empty)
    """
    return self.__evpn
      
  def _set_evpn(self, v, load=False):
    """
    Setter method for evpn, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_target_container_ipv6/route_target_evpn/evpn (empty)
    If this variable is read-only (config: false) in the
