...
class vrf(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__vrf_name','__route_distiniguisher','__vpn_statistics','__evpn','__route_target','__address_family','__ip',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__vpn_statistics = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vpn-statistics", rest_name="vpn-statistics", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'VPN Statistics', u'cli-full-command': None}}, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='empty', is_config=True)
...
format.
  ...
  def _get_vpn_statistics(self):
    """
    Getter method for vpn_statistics, mapped from YANG variable /vrf/vpn_statistics (empty)

    YANG Description: VPN Statistics
    """
    return self.__vpn_statistics
      
  def _set_vpn_statistics(self, v, load=False):
    """
    Setter method for vpn_statistics, mapped from YANG variable /vrf/vpn_statistics (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_vpn_statistics is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_vpn_statistics() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="vpn-statistics", rest_name="vpn-statistics", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'VPN Statistics', u'cli-full-command': None}}, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='empty', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vpn_statistics must be of a type compatible with empty""",
          'defined-type': "empty",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vpn-statistics", rest_name="vpn-statistics", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'VPN Statistics', u'cli-full-command': None}}, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='empty', is_config=True)""",
        })

    self.__vpn_statistics = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_vpn_statistics(self):
    self.__vpn_statistics = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="vpn-statistics", rest_name="vpn-statistics", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'VPN Statistics', u'cli-full-command': None}}, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='empty', is_config=True)
  ...
  def _set_evpn(self, v, load=False):
    """
    Setter method for evpn, mapped from YANG variable /vrf/evpn (container)
    If this variable is read-only (config: false) in the
...
in NOS4.0.0 release
  ...
  vpn_statistics = __builtin__.property(_get_vpn_statistics, _set_vpn_statistics)
  ...
  _pyangbind_elements = {'vrf_name': vrf_name, 'route_distiniguisher': route_distiniguisher, 'vpn_statistics': vpn_statistics, 'evpn': evpn, 'route_target': route_target, 'address_family': address_family, 'ip': ip, }
