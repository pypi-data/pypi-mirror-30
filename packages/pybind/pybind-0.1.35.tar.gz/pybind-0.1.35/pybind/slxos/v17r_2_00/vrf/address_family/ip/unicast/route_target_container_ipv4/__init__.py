...
import __builtin__
import route_target
class route_target_container_ipv4(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-vrf - based on the path /vrf/address-family/ip/unicast/route-target-container-ipv4. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__route_target',)

  _yang_name = 'route-target-container-ipv4'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ip', u'unicast', u'route-target-container-ipv4']
  ...
  def _get_route_target(self):
    """
    Getter method for route_target, mapped from YANG variable /vrf/address_family/ip/unicast/route_target_container_ipv4/route_target (list)
    """
    return self.__route_target
      
  def _set_route_target(self, v, load=False):
    """
    Setter method for route_target, mapped from YANG variable /vrf/address_family/ip/unicast/route_target_container_ipv4/route_target (list)
