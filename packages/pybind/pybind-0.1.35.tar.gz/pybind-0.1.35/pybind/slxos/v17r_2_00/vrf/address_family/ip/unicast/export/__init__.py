...
class export(PybindBase):
  ...
  def _get_evpn_export(self):
    """
    Getter method for evpn_export, mapped from YANG variable /vrf/address_family/ip/unicast/export/evpn_export (empty)
    """
    return self.__evpn_export
      
  def _set_evpn_export(self, v, load=False):
    """
    Setter method for evpn_export, mapped from YANG variable /vrf/address_family/ip/unicast/export/evpn_export (empty)
    If this variable is read-only (config: false) in the
