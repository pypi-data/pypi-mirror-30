...
class import_(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ipv6/unicast/ipv6/import. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv6', u'unicast', u'ipv6', u'import']
  ...
  def _get_routes(self):
    """
    Getter method for routes, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/import/routes (list)
  ...
  def _set_routes(self, v, load=False):
    """
    Setter method for routes, mapped from YANG variable /vrf/address_family/ipv6/unicast/ipv6/import/routes (list)
