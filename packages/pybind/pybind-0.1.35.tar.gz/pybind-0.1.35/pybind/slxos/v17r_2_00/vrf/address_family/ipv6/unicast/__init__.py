...
import __builtin__
import route_target_container_ipv6
import route_taret_container_ipv6
import import_
import export
import bgp
import ipv6
class unicast(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__max_route','__route_target_container_ipv6','__route_taret_container_ipv6','__import_','__export','__bgp','__ipv6',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__route_target_container_ipv6 = YANGDynClass(base=route_target_container_ipv6.route_target_container_ipv6, is_container='container', presence=False, yang_name="route-target-container-ipv6", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Target VPN Extended Communities', u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='container', is_config=True)
    ...
    self.__bgp = YANGDynClass(base=bgp.bgp, is_container='container', presence=False, yang_name="bgp", rest_name="bgp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='container', is_config=True)
    ...
    self.__route_taret_container_ipv6 = YANGDynClass(base=route_taret_container_ipv6.route_taret_container_ipv6, is_container='container', presence=False, yang_name="route-taret-container-ipv6", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Target VPN Extended Communities', u'cli-drop-node-name': None, u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='container', is_config=True)
  ...
  def _get_route_target_container_ipv6(self):
    """
    Getter method for route_target_container_ipv6, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_target_container_ipv6 (container)
    """
    return self.__route_target_container_ipv6
      
  def _set_route_target_container_ipv6(self, v, load=False):
    """
    Setter method for route_target_container_ipv6, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_target_container_ipv6 (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_route_target_container_ipv6 is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_route_target_container_ipv6() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=route_target_container_ipv6.route_target_container_ipv6, is_container='container', presence=False, yang_name="route-target-container-ipv6", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Target VPN Extended Communities', u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """route_target_container_ipv6 must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=route_target_container_ipv6.route_target_container_ipv6, is_container='container', presence=False, yang_name="route-target-container-ipv6", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Target VPN Extended Communities', u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='container', is_config=True)""",
        })

    self.__route_target_container_ipv6 = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_route_target_container_ipv6(self):
    self.__route_target_container_ipv6 = YANGDynClass(base=route_target_container_ipv6.route_target_container_ipv6, is_container='container', presence=False, yang_name="route-target-container-ipv6", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Target VPN Extended Communities', u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='container', is_config=True)


  def _get_route_taret_container_ipv6(self):
    """
    Getter method for route_taret_container_ipv6, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_taret_container_ipv6 (container)
    """
    return self.__route_taret_container_ipv6
      
  def _set_route_taret_container_ipv6(self, v, load=False):
    """
    Setter method for route_taret_container_ipv6, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_taret_container_ipv6 (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_route_taret_container_ipv6 is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_route_taret_container_ipv6() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=route_taret_container_ipv6.route_taret_container_ipv6, is_container='container', presence=False, yang_name="route-taret-container-ipv6", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Target VPN Extended Communities', u'cli-drop-node-name': None, u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """route_taret_container_ipv6 must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=route_taret_container_ipv6.route_taret_container_ipv6, is_container='container', presence=False, yang_name="route-taret-container-ipv6", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Target VPN Extended Communities', u'cli-drop-node-name': None, u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='container', is_config=True)""",
        })

    self.__route_taret_container_ipv6 = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_route_taret_container_ipv6(self):
    self.__route_taret_container_ipv6 = YANGDynClass(base=route_taret_container_ipv6.route_taret_container_ipv6, is_container='container', presence=False, yang_name="route-taret-container-ipv6", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Target VPN Extended Communities', u'cli-drop-node-name': None, u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='container', is_config=True)
  ...
  def _get_bgp(self):
    """
    Getter method for bgp, mapped from YANG variable /vrf/address_family/ipv6/unicast/bgp (container)
    """
    return self.__bgp
      
  def _set_bgp(self, v, load=False):
    """
    Setter method for bgp, mapped from YANG variable /vrf/address_family/ipv6/unicast/bgp (container)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=bgp.bgp, is_container='container', presence=False, yang_name="bgp", rest_name="bgp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """bgp must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=bgp.bgp, is_container='container', presence=False, yang_name="bgp", rest_name="bgp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:brocade.com:mgmt:brocade-vrf', defining_module='brocade-vrf', yang_type='container', is_config=True)""",
        })
  ...
  route_target_container_ipv6 = __builtin__.property(_get_route_target_container_ipv6, _set_route_target_container_ipv6)
  route_taret_container_ipv6 = __builtin__.property(_get_route_taret_container_ipv6, _set_route_taret_container_ipv6)
  ...
  _pyangbind_elements = {'max_route': max_route, 'route_target_container_ipv6': route_target_container_ipv6, 'route_taret_container_ipv6': route_taret_container_ipv6, 'import_': import_, 'export': export, 'bgp': bgp, 'ipv6': ipv6, }
