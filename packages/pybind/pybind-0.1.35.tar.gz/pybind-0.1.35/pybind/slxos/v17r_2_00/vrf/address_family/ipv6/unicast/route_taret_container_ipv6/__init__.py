...
import __builtin__
import route_target
class route_taret_container_ipv6(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-vrf - based on the path /vrf/address-family/ipv6/unicast/route-taret-container-ipv6. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__route_target',)

  _yang_name = 'route-taret-container-ipv6'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv6', u'unicast', u'route-taret-container-ipv6']
  ...
  def _get_route_target(self):
    """
    Getter method for route_target, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_taret_container_ipv6/route_target (list)
    """
    return self.__route_target
      
  def _set_route_target(self, v, load=False):
    """
    Setter method for route_target, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_taret_container_ipv6/route_target (list)
