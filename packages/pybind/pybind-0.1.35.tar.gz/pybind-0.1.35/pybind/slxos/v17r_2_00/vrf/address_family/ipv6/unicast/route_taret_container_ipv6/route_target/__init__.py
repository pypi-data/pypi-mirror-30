...
class route_target(PybindBase):
  ...
  from YANG module brocade-vrf - based on the path /vrf/address-family/ipv6/unicast/route-taret-container-ipv6/route-target. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'vrf', u'address-family', u'ipv6', u'unicast', u'route-taret-container-ipv6', u'route-target']
  ...
  def _get_action(self):
    """
    Getter method for action, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_taret_container_ipv6/route_target/action (enumeration)
    """
    return self.__action
      
  def _set_action(self, v, load=False):
    """
    Setter method for action, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_taret_container_ipv6/route_target/action (enumeration)
  ...
  def _get_target_community(self):
    """
    Getter method for target_community, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_taret_container_ipv6/route_target/target_community (rt-type)
  ...
  def _set_target_community(self, v, load=False):
    """
    Setter method for target_community, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_taret_container_ipv6/route_target/target_community (rt-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_evpn(self):
    """
    Getter method for evpn, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_taret_container_ipv6/route_target/evpn (empty)
    """
    return self.__evpn
      
  def _set_evpn(self, v, load=False):
    """
    Setter method for evpn, mapped from YANG variable /vrf/address_family/ipv6/unicast/route_taret_container_ipv6/route_target/evpn (empty)
    If this variable is read-only (config: false) in the
