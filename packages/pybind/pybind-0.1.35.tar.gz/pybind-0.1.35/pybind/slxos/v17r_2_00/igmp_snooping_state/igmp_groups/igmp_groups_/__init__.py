...
class igmp_groups(PybindBase):
  ...
  def _get_group_addr(self):
    """
    Getter method for group_addr, mapped from YANG variable /igmp_snooping_state/igmp_groups/igmp_groups/group_addr (inet:ipv4-address)
  ...
  def _set_group_addr(self, v, load=False):
    """
    Setter method for group_addr, mapped from YANG variable /igmp_snooping_state/igmp_groups/igmp_groups/group_addr (inet:ipv4-address)
  ...
  def _get_last_reporter(self):
    """
    Getter method for last_reporter, mapped from YANG variable /igmp_snooping_state/igmp_groups/igmp_groups/last_reporter (inet:ipv4-address)
  ...
  def _set_last_reporter(self, v, load=False):
    """
    Setter method for last_reporter, mapped from YANG variable /igmp_snooping_state/igmp_groups/igmp_groups/last_reporter (inet:ipv4-address)
    If this variable is read-only (config: false) in the
