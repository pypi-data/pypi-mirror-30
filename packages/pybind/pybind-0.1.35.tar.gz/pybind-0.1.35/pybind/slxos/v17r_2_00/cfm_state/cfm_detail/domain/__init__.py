...
class domain(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__md_name','__md_idx','__md_level','__ma',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__md_idx = YANGDynClass(base=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), is_leaf=True, yang_name="md-idx", rest_name="md-idx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint16', is_config=False)
  ...
  def _get_md_idx(self):
    """
    Getter method for md_idx, mapped from YANG variable /cfm_state/cfm_detail/domain/md_idx (uint16)

    YANG Description: domain index
    """
    return self.__md_idx
      
  def _set_md_idx(self, v, load=False):
    """
    Setter method for md_idx, mapped from YANG variable /cfm_state/cfm_detail/domain/md_idx (uint16)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_md_idx is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_md_idx() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), is_leaf=True, yang_name="md-idx", rest_name="md-idx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint16', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """md_idx must be of a type compatible with uint16""",
          'defined-type': "uint16",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), is_leaf=True, yang_name="md-idx", rest_name="md-idx", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint16', is_config=False)""",
        })
  ...
  md_idx = __builtin__.property(_get_md_idx)
  md_level = __builtin__.property(_get_md_level)
  ma = __builtin__.property(_get_ma)


  _pyangbind_elements = {'md_name': md_name, 'md_idx': md_idx, 'md_level': md_level, 'ma': ma, }
