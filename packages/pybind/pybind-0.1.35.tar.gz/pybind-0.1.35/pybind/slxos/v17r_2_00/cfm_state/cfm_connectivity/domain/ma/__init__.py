...
class ma(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__ma_name','__ma_idx','__ma_type','__maid_format','__ccm_interval','__vlan_id','__priority','__mep','__mip',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__ccm_interval = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'three-dot-three-ms': {'value': 3}, u'one-min': {'value': 60000}, u'ten-sec': {'value': 10000}, u'hundred-ms': {'value': 100}, u'ten-min': {'value': 600000}, u'one-sec': {'value': 1000}, u'ten-ms': {'value': 10}},), is_leaf=True, yang_name="ccm-interval", rest_name="ccm-interval", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='ccm-intervals', is_config=False)
    self.__maid_format = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'short-maid': {'value': 0}, u'long-maid': {'value': 1}},), is_leaf=True, yang_name="maid-format", rest_name="maid-format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='maid-formats', is_config=False)
  ...
  def _get_ma_type(self):
    """
    Getter method for ma_type, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/ma_type (ma-types)
  ...
  def _set_ma_type(self, v, load=False):
    """
    Setter method for ma_type, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/ma_type (ma-types)
    If this variable is read-only (config: false) in the
  ...
  def _get_maid_format(self):
    """
    Getter method for maid_format, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/maid_format (maid-formats)

    YANG Description: Short or Long MA ID Format
    """
    return self.__maid_format
      
  def _set_maid_format(self, v, load=False):
    """
    Setter method for maid_format, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/maid_format (maid-formats)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'short-maid': {'value': 0}, u'long-maid': {'value': 1}},), is_leaf=True, yang_name="maid-format", rest_name="maid-format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='maid-formats', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """maid_format must be of a type compatible with maid-formats""",
          'defined-type': "brocade-dot1ag-operational:maid-formats",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'short-maid': {'value': 0}, u'long-maid': {'value': 1}},), is_leaf=True, yang_name="maid-format", rest_name="maid-format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='maid-formats', is_config=False)""",
        })
  ...
  def _get_ccm_interval(self):
    """
    Getter method for ccm_interval, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/ccm_interval (ccm-intervals)
  ...
  def _set_ccm_interval(self, v, load=False):
    """
    Setter method for ccm_interval, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/ccm_interval (ccm-intervals)
    If this variable is read-only (config: false) in the
  ...
  maid_format = __builtin__.property(_get_maid_format)
  ...
  _pyangbind_elements = {'ma_name': ma_name, 'ma_idx': ma_idx, 'ma_type': ma_type, 'maid_format': maid_format, 'ccm_interval': ccm_interval, 'vlan_id': vlan_id, 'priority': priority, 'mep': mep, 'mip': mip, }
