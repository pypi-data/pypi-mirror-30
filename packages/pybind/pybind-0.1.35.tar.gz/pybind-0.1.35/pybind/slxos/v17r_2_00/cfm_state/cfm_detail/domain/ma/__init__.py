...
class ma(PybindBase):
  ...
  def _get_ma_type(self):
    """
    Getter method for ma_type, mapped from YANG variable /cfm_state/cfm_detail/domain/ma/ma_type (ma-types)
  ...
  def _get_maid_format(self):
    """
    Getter method for maid_format, mapped from YANG variable /cfm_state/cfm_detail/domain/ma/maid_format (maid-formats)
  ...
  def _set_maid_format(self, v, load=False):
    """
    Setter method for maid_format, mapped from YANG variable /cfm_state/cfm_detail/domain/ma/maid_format (maid-formats)
    If this variable is read-only (config: false) in the
  ...
  def _get_ccm_interval(self):
    """
    Getter method for ccm_interval, mapped from YANG variable /cfm_state/cfm_detail/domain/ma/ccm_interval (ccm-intervals)
