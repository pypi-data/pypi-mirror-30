...
class domain(PybindBase):
  ...
  def _get_md_idx(self):
    """
    Getter method for md_idx, mapped from YANG variable /cfm_state/cfm_connectivity/domain/md_idx (uint16)
  ...
  def _set_md_idx(self, v, load=False):
    """
    Setter method for md_idx, mapped from YANG variable /cfm_state/cfm_connectivity/domain/md_idx (uint16)
    If this variable is read-only (config: false) in the
