...
class slm_session_brief(PybindBase):
  ...
  def _get_type(self):
    """
    Getter method for type, mapped from YANG variable /cfm_state/slm/slm_session_brief/type (y1731-session-type)
  ...
  def _set_type(self, v, load=False):
    """
    Setter method for type, mapped from YANG variable /cfm_state/slm/slm_session_brief/type (y1731-session-type)
  ...
  def _get_status(self):
    """
    Getter method for status, mapped from YANG variable /cfm_state/slm/slm_session_brief/status (y1731-session-status)
  ...
  def _set_status(self, v, load=False):
    """
    Setter method for status, mapped from YANG variable /cfm_state/slm/slm_session_brief/status (y1731-session-status)
    If this variable is read-only (config: false) in the
