...
import __builtin__
class dmm_session_detail(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-dot1ag-operational - based on the path /cfm-state/dmm/dmm-session-detail. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Detailed display of DM configuration
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__type','__status','__domain_name','__ma_name','__src_mep','__tgt_mep','__cos','__start_time','__stop_time','__test_profile_name','__start_type','__stop_type','__tx_interval','__tx_frame_count','__meas_interval','__session_index','__avg','__max_',)

  _yang_name = 'dmm-session-detail'
  _rest_name = 'dmm-session-detail'
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__max_ = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="max", rest_name="max", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint32', is_config=False)
    self.__start_type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'periodic': {'value': 0}, u'after': {'value': 2}, u'fixed': {'value': 1}},), is_leaf=True, yang_name="start-type", rest_name="start-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='start-stop-type', is_config=False)
    ...
    self.__stop_type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'periodic': {'value': 0}, u'after': {'value': 2}, u'fixed': {'value': 1}},), is_leaf=True, yang_name="stop-type", rest_name="stop-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='start-stop-type', is_config=False)
    ...
    self.__avg = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="avg", rest_name="avg", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint32', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'cfm-state', u'dmm', u'dmm-session-detail']
  ...
  def _get_type(self):
    """
    Getter method for type, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/type (y1731-session-type)
  ...
  def _set_type(self, v, load=False):
    """
    Setter method for type, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/type (y1731-session-type)
  ...
  def _get_status(self):
    """
    Getter method for status, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/status (y1731-session-status)
  ...
  def _set_status(self, v, load=False):
    """
    Setter method for status, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/status (y1731-session-status)
    If this variable is read-only (config: false) in the
  ...
  def _get_domain_name(self):
    """
    Getter method for domain_name, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/domain_name (string)
  ...
  def _set_domain_name(self, v, load=False):
    """
    Setter method for domain_name, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/domain_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_ma_name(self):
    """
    Getter method for ma_name, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/ma_name (string)
  ...
  def _set_ma_name(self, v, load=False):
    """
    Setter method for ma_name, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/ma_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_src_mep(self):
    """
    Getter method for src_mep, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/src_mep (uint16)
  ...
  def _set_src_mep(self, v, load=False):
    """
    Setter method for src_mep, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/src_mep (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_tgt_mep(self):
    """
    Getter method for tgt_mep, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/tgt_mep (uint16)
  ...
  def _set_tgt_mep(self, v, load=False):
    """
    Setter method for tgt_mep, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/tgt_mep (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_cos(self):
    """
    Getter method for cos, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/cos (uint8)
  ...
  def _set_cos(self, v, load=False):
    """
    Setter method for cos, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/cos (uint8)
    If this variable is read-only (config: false) in the
  ...
  def _get_start_time(self):
    """
    Getter method for start_time, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/start_time (string)
  ...
  def _set_start_time(self, v, load=False):
    """
    Setter method for start_time, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/start_time (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_stop_time(self):
    """
    Getter method for stop_time, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/stop_time (string)
  ...
  def _set_stop_time(self, v, load=False):
    """
    Setter method for stop_time, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/stop_time (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_test_profile_name(self):
    """
    Getter method for test_profile_name, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/test_profile_name (string)
  ...
  def _set_test_profile_name(self, v, load=False):
    """
    Setter method for test_profile_name, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/test_profile_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_start_type(self):
    """
    Getter method for start_type, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/start_type (start-stop-type)
  ...
  def _set_start_type(self, v, load=False):
    """
    Setter method for start_type, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/start_type (start-stop-type)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'periodic': {'value': 0}, u'after': {'value': 2}, u'fixed': {'value': 1}},), is_leaf=True, yang_name="start-type", rest_name="start-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='start-stop-type', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'periodic': {'value': 0}, u'after': {'value': 2}, u'fixed': {'value': 1}},), is_leaf=True, yang_name="start-type", rest_name="start-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='start-stop-type', is_config=False)""",
        })
  ...
  def _get_stop_type(self):
    """
    Getter method for stop_type, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/stop_type (start-stop-type)
  ...
  def _set_stop_type(self, v, load=False):
    """
    Setter method for stop_type, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/stop_type (start-stop-type)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'periodic': {'value': 0}, u'after': {'value': 2}, u'fixed': {'value': 1}},), is_leaf=True, yang_name="stop-type", rest_name="stop-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='start-stop-type', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """stop_type must be of a type compatible with start-stop-type""",
          'defined-type': "brocade-dot1ag-operational:start-stop-type",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'periodic': {'value': 0}, u'after': {'value': 2}, u'fixed': {'value': 1}},), is_leaf=True, yang_name="stop-type", rest_name="stop-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='start-stop-type', is_config=False)""",
        })
  ...
  def _get_tx_interval(self):
    """
    Getter method for tx_interval, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/tx_interval (uint16)
  ...
  def _set_tx_interval(self, v, load=False):
    """
    Setter method for tx_interval, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/tx_interval (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_tx_frame_count(self):
    """
    Getter method for tx_frame_count, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/tx_frame_count (uint16)
  ...
  def _set_tx_frame_count(self, v, load=False):
    """
    Setter method for tx_frame_count, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/tx_frame_count (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_meas_interval(self):
    """
    Getter method for meas_interval, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/meas_interval (uint16)
  ...
  def _set_meas_interval(self, v, load=False):
    """
    Setter method for meas_interval, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/meas_interval (uint16)
    If this variable is read-only (config: false) in the
  ...
  def _get_session_index(self):
    """
    Getter method for session_index, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/session_index (uint32)
  ...
  def _set_session_index(self, v, load=False):
    """
    Setter method for session_index, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/session_index (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_avg(self):
    """
    Getter method for avg, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/avg (uint32)
  ...
  def _set_avg(self, v, load=False):
    """
    Setter method for avg, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/avg (uint32)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="avg", rest_name="avg", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """avg must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="avg", rest_name="avg", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-dot1ag-operational', defining_module='brocade-dot1ag-operational', yang_type='uint32', is_config=False)""",
        })
  ...
  def _get_max_(self):
    """
    Getter method for max_, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/max (uint32)
  ...
  def _set_max_(self, v, load=False):
    """
    Setter method for max_, mapped from YANG variable /cfm_state/dmm/dmm_session_detail/max (uint32)
    If this variable is read-only (config: false) in the
