...
class mep(PybindBase):
  ...
  def _get_mep_vlan(self):
    """
    Getter method for mep_vlan, mapped from YANG variable /cfm_state/cfm_detail/domain/ma/mep/mep_vlan (uint32)
  ...
  def _set_mep_vlan(self, v, load=False):
    """
    Setter method for mep_vlan, mapped from YANG variable /cfm_state/cfm_detail/domain/ma/mep/mep_vlan (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_mep_inner_vlan(self):
    """
    Getter method for mep_inner_vlan, mapped from YANG variable /cfm_state/cfm_detail/domain/ma/mep/mep_inner_vlan (uint32)
  ...
  def _set_mep_inner_vlan(self, v, load=False):
    """
    Setter method for mep_inner_vlan, mapped from YANG variable /cfm_state/cfm_detail/domain/ma/mep/mep_inner_vlan (uint32)
    If this variable is read-only (config: false) in the
