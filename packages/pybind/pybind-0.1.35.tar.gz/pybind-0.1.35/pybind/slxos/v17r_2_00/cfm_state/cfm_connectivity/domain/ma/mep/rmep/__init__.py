...
class rmep(PybindBase):
  ...
  def _get_rmep_vlan(self):
    """
    Getter method for rmep_vlan, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/mep/rmep/rmep_vlan (uint32)
  ...
  def _set_rmep_vlan(self, v, load=False):
    """
    Setter method for rmep_vlan, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/mep/rmep/rmep_vlan (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_rmep_inner_vlan(self):
    """
    Getter method for rmep_inner_vlan, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/mep/rmep/rmep_inner_vlan (uint32)
  ...
  def _set_rmep_inner_vlan(self, v, load=False):
    """
    Setter method for rmep_inner_vlan, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/mep/rmep/rmep_inner_vlan (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_rmep_state(self):
    """
    Getter method for rmep_state, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/mep/rmep/rmep_state (rmep-status)
  ...
  def _set_rmep_state(self, v, load=False):
    """
    Setter method for rmep_state, mapped from YANG variable /cfm_state/cfm_connectivity/domain/ma/mep/rmep/rmep_state (rmep-status)
    If this variable is read-only (config: false) in the
