...
class management(PybindBase):
  ...
  from YANG module brocade-node - based on the path /node-id/cluster/management. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'node-id', u'cluster', u'management']
  ...
  def _set_principal_priority(self, v, load=False):
    """
    Setter method for principal_priority, mapped from YANG variable /node_id/cluster/management/principal_priority (uint32)
