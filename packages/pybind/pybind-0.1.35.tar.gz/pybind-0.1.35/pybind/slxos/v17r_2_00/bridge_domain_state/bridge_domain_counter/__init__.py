...
class bridge_domain_counter(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__no_of_bd','__no_of_vpls_bd',)
  ...
  _pyangbind_elements = {'no_of_bd': no_of_bd, 'no_of_vpls_bd': no_of_vpls_bd, }
