...
import __builtin__
class vrrp_global(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-vrrpv3 - based on the path /vrrp-global. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__vrrp_acceptmode_disable',)

  _yang_name = 'vrrp-global'
  _rest_name = ''
  ...
  def _get_vrrp_acceptmode_disable(self):
    """
    Getter method for vrrp_acceptmode_disable, mapped from YANG variable /vrrp_global/vrrp_acceptmode_disable (empty)
  ...
  def _set_vrrp_acceptmode_disable(self, v, load=False):
    """
    Setter method for vrrp_acceptmode_disable, mapped from YANG variable /vrrp_global/vrrp_acceptmode_disable (empty)
