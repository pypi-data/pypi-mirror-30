...
details.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__interface_type','__interface_name','__actor_port','__sync',)
...
This is valid in active mode only.
  ...
  _pyangbind_elements = {'interface_type': interface_type, 'interface_name': interface_name, 'actor_port': actor_port, 'sync': sync, }
