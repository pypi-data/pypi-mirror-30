...
class lsp(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__lsp_name','__lsp_type','__bypass_lsp_type','__interface','__history','__autobw_history','__basic','__forwarding','__frr','__backup','__auto_bandwidth','__instances','__secondary_path',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__autobw_history = YANGDynClass(base=TypedListType(allowed_type=unicode), is_leaf=False, yang_name="autobw-history", rest_name="autobw-history", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='string', is_config=False)
  ...
  def _get_autobw_history(self):
    """
    Getter method for autobw_history, mapped from YANG variable /mpls_state/lsp/autobw_history (string)

    YANG Description: Auto bandwidth history Information
    """
    return self.__autobw_history
      
  def _set_autobw_history(self, v, load=False):
    """
    Setter method for autobw_history, mapped from YANG variable /mpls_state/lsp/autobw_history (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_autobw_history is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_autobw_history() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """autobw_history must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=TypedListType(allowed_type=unicode), is_leaf=False, yang_name="autobw-history", rest_name="autobw-history", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='string', is_config=False)""",
        })

    self.__autobw_history = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_autobw_history(self):
    self.__autobw_history = YANGDynClass(base=TypedListType(allowed_type=unicode), is_leaf=False, yang_name="autobw-history", rest_name="autobw-history", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='string', is_config=False)
  ...
  def _get_auto_bandwidth(self):
    """
    Getter method for auto_bandwidth, mapped from YANG variable /mpls_state/lsp/auto_bandwidth (container)
  ...
  def _set_auto_bandwidth(self, v, load=False):
    """
    Setter method for auto_bandwidth, mapped from YANG variable /mpls_state/lsp/auto_bandwidth (container)
    If this variable is read-only (config: false) in the
  ...
  autobw_history = __builtin__.property(_get_autobw_history)
  ...
  _pyangbind_elements = {'lsp_name': lsp_name, 'lsp_type': lsp_type, 'bypass_lsp_type': bypass_lsp_type, 'interface': interface, 'history': history, 'autobw_history': autobw_history, 'basic': basic, 'forwarding': forwarding, 'frr': frr, 'backup': backup, 'auto_bandwidth': auto_bandwidth, 'instances': instances, 'secondary_path': secondary_path, }
