...
class policy(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__switchover_activation_delay = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="switchover-activation-delay", rest_name="switchover-activation-delay", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='uint32', is_config=False)
    ...
    self.__switchover_hold_tear_delay = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="switchover-hold-tear-delay", rest_name="switchover-hold-tear-delay", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='uint32', is_config=False)
  ...
  def _get_switchover_activation_delay(self):
    """
    Getter method for switchover_activation_delay, mapped from YANG variable /mpls_state/policy/switchover_activation_delay (uint32)

    YANG Description: LSP new instance activation delay
    """
    return self.__switchover_activation_delay
      
  def _set_switchover_activation_delay(self, v, load=False):
    """
    Setter method for switchover_activation_delay, mapped from YANG variable /mpls_state/policy/switchover_activation_delay (uint32)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="switchover-activation-delay", rest_name="switchover-activation-delay", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """switchover_activation_delay must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="switchover-activation-delay", rest_name="switchover-activation-delay", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='uint32', is_config=False)""",
        })
  ...
  def _get_switchover_hold_tear_delay(self):
    """
    Getter method for switchover_hold_tear_delay, mapped from YANG variable /mpls_state/policy/switchover_hold_tear_delay (uint32)
  ...
  def _set_switchover_hold_tear_delay(self, v, load=False):
    """
    Setter method for switchover_hold_tear_delay, mapped from YANG variable /mpls_state/policy/switchover_hold_tear_delay (uint32)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="switchover-hold-tear-delay", rest_name="switchover-hold-tear-delay", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """switchover_hold_tear_delay must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="switchover-hold-tear-delay", rest_name="switchover-hold-tear-delay", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='uint32', is_config=False)""",
        })
  ...
  switchover_activation_delay = __builtin__.property(_get_switchover_activation_delay)
  switchover_hold_tear_delay = __builtin__.property(_get_switchover_hold_tear_delay)
