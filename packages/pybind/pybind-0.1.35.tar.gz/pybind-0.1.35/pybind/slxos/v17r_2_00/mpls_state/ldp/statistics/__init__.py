...
class statistics(PybindBase):
  ...
  def _get_protocol_errors(self):
    """
    Getter method for protocol_errors, mapped from YANG variable /mpls_state/ldp/statistics/protocol_errors (list)
    """
    return self.__protocol_errors
      
  def _set_protocol_errors(self, v, load=False):
    """
    Setter method for protocol_errors, mapped from YANG variable /mpls_state/ldp/statistics/protocol_errors (list)
  ...
  def _get_protocol_stats(self):
    """
    Getter method for protocol_stats, mapped from YANG variable /mpls_state/ldp/statistics/protocol_stats (list)
    """
    return self.__protocol_stats
      
  def _set_protocol_stats(self, v, load=False):
    """
    Setter method for protocol_stats, mapped from YANG variable /mpls_state/ldp/statistics/protocol_stats (list)
    If this variable is read-only (config: false) in the
