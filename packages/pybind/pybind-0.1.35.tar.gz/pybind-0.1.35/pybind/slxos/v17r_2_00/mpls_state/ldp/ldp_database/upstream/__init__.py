...
class upstream(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__label','__prefix','__prefix_length','__fec_type','__stale','__index',)
  ...
  def _get_index(self):
    """
    Getter method for index, mapped from YANG variable /mpls_state/ldp/ldp_database/upstream/index (uint32)
  ...
  def _set_index(self, v, load=False):
    """
    Setter method for index, mapped from YANG variable /mpls_state/ldp/ldp_database/upstream/index (uint32)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'label': label, 'prefix': prefix, 'prefix_length': prefix_length, 'fec_type': fec_type, 'stale': stale, 'index': index, }
