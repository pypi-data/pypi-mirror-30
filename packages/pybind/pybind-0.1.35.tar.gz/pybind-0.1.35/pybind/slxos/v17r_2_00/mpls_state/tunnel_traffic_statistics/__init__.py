...
class tunnel_traffic_statistics(PybindBase):
  ...
  def _get_number_of_packets(self):
    """
    Getter method for number_of_packets, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/number_of_packets (uint64)
  ...
  def _set_number_of_packets(self, v, load=False):
    """
    Setter method for number_of_packets, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/number_of_packets (uint64)
  ...
  def _get_number_of_packets_since_clear(self):
    """
    Getter method for number_of_packets_since_clear, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/number_of_packets_since_clear (uint64)
  ...
  def _set_number_of_packets_since_clear(self, v, load=False):
    """
    Setter method for number_of_packets_since_clear, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/number_of_packets_since_clear (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_number_of_bytes(self):
    """
    Getter method for number_of_bytes, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/number_of_bytes (uint64)
  ...
  def _set_number_of_bytes(self, v, load=False):
    """
    Setter method for number_of_bytes, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/number_of_bytes (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_number_of_bytes_since_clear(self):
    """
    Getter method for number_of_bytes_since_clear, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/number_of_bytes_since_clear (uint64)
  ...
  def _set_number_of_bytes_since_clear(self, v, load=False):
    """
    Setter method for number_of_bytes_since_clear, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/number_of_bytes_since_clear (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_packets_per_second(self):
    """
    Getter method for packets_per_second, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/packets_per_second (uint64)
  ...
  def _set_packets_per_second(self, v, load=False):
    """
    Setter method for packets_per_second, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/packets_per_second (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_bytes_per_second(self):
    """
    Getter method for bytes_per_second, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/bytes_per_second (uint64)
  ...
  def _set_bytes_per_second(self, v, load=False):
    """
    Setter method for bytes_per_second, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/bytes_per_second (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_averaging_interval_seconds(self):
    """
    Getter method for averaging_interval_seconds, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/averaging_interval_seconds (uint32)
  ...
  def _set_averaging_interval_seconds(self, v, load=False):
    """
    Setter method for averaging_interval_seconds, mapped from YANG variable /mpls_state/tunnel_traffic_statistics/averaging_interval_seconds (uint32)
    If this variable is read-only (config: false) in the
