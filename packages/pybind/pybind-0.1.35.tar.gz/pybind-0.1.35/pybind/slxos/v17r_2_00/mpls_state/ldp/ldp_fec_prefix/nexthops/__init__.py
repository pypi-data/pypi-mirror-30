...
class nexthops(PybindBase):
  ...
  from YANG module brocade-mpls-operational - based on the path /mpls-state/ldp/ldp-fec-prefix/nexthops. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mpls-state', u'ldp', u'ldp-fec-prefix', u'nexthops']
  ...
  def _get_nexthop(self):
    """
    Getter method for nexthop, mapped from YANG variable /mpls_state/ldp/ldp_fec_prefix/nexthops/nexthop (string)

    YANG Description: For an ingress FEC, this mentions the nexthop IP address
    """
    return self.__nexthop
      
  def _set_nexthop(self, v, load=False):
    """
    Setter method for nexthop, mapped from YANG variable /mpls_state/ldp/ldp_fec_prefix/nexthops/nexthop (string)
  ...
  def _get_out_intf(self):
    """
    Getter method for out_intf, mapped from YANG variable /mpls_state/ldp/ldp_fec_prefix/nexthops/out_intf (string)

    YANG Description: For an ingress FEC, this mentions the output interface to reach to the Next-hop. The Out-Intf field displays the egress interface associated with the FEC entry. When applicable, the Out-Intf field displays a VE interface specified by the vid variable
    """
    return self.__out_intf
      
  def _set_out_intf(self, v, load=False):
    """
    Setter method for out_intf, mapped from YANG variable /mpls_state/ldp/ldp_fec_prefix/nexthops/out_intf (string)
    If this variable is read-only (config: false) in the
