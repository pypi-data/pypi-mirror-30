...
class admin_group(PybindBase):
  ...
  from YANG module brocade-mpls-operational - based on the path /mpls-state/lsp/secondary-path/admin-group-lists/admin-group. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'mpls-state', u'lsp', u'secondary-path', u'admin-group-lists', u'admin-group']
  ...
  def _get_admin_group_id(self):
    """
    Getter method for admin_group_id, mapped from YANG variable /mpls_state/lsp/secondary_path/admin_group_lists/admin_group/admin_group_id (uint32)
  ...
  def _set_admin_group_id(self, v, load=False):
    """
    Setter method for admin_group_id, mapped from YANG variable /mpls_state/lsp/secondary_path/admin_group_lists/admin_group/admin_group_id (uint32)
  ...
  def _get_admin_group_name(self):
    """
    Getter method for admin_group_name, mapped from YANG variable /mpls_state/lsp/secondary_path/admin_group_lists/admin_group/admin_group_name (string)
  ...
  def _set_admin_group_name(self, v, load=False):
    """
    Setter method for admin_group_name, mapped from YANG variable /mpls_state/lsp/secondary_path/admin_group_lists/admin_group/admin_group_name (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_exclude_any(self):
    """
    Getter method for exclude_any, mapped from YANG variable /mpls_state/lsp/secondary_path/admin_group_lists/admin_group/exclude_any (boolean)
  ...
  def _set_exclude_any(self, v, load=False):
    """
    Setter method for exclude_any, mapped from YANG variable /mpls_state/lsp/secondary_path/admin_group_lists/admin_group/exclude_any (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_include_all(self):
    """
    Getter method for include_all, mapped from YANG variable /mpls_state/lsp/secondary_path/admin_group_lists/admin_group/include_all (boolean)
  ...
  def _set_include_all(self, v, load=False):
    """
    Setter method for include_all, mapped from YANG variable /mpls_state/lsp/secondary_path/admin_group_lists/admin_group/include_all (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_include_any(self):
    """
    Getter method for include_any, mapped from YANG variable /mpls_state/lsp/secondary_path/admin_group_lists/admin_group/include_any (boolean)
  ...
  def _set_include_any(self, v, load=False):
    """
    Setter method for include_any, mapped from YANG variable /mpls_state/lsp/secondary_path/admin_group_lists/admin_group/include_any (boolean)
    If this variable is read-only (config: false) in the
