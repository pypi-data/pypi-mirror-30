...
class port_channel(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /protocol/spanning-tree/rstp/port-channel. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'protocol', u'spanning-tree', u'rstp', u'port-channel']
  ...
  def _get_path_cost(self):
    """
    Getter method for path_cost, mapped from YANG variable /protocol/spanning_tree/rstp/port_channel/path_cost (enumeration)
    """
    return self.__path_cost
      
  def _set_path_cost(self, v, load=False):
    """
    Setter method for path_cost, mapped from YANG variable /protocol/spanning_tree/rstp/port_channel/path_cost (enumeration)
