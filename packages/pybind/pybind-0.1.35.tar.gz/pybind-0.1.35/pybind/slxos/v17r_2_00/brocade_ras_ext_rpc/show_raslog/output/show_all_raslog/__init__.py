...
class show_all_raslog(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__number_of_entries','__raslog_entries',)
  ...
  _pyangbind_elements = {'number_of_entries': number_of_entries, 'raslog_entries': raslog_entries, }
