...
class ip(PybindBase):
  ...
  from YANG module brocade-cluster - based on the path /mgmt-cluster/cluster/management/virtual/ip. Each member element of
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /mgmt_cluster/cluster/management/virtual/ip/address (list)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /mgmt_cluster/cluster/management/virtual/ip/address (list)
