...
class direction_out(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/area/prefix-list/direction-out. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'area', u'prefix-list', u'direction-out']
  ...
  def _set_prefix_list_direction_out_prefix_name(self, v, load=False):
    """
    Setter method for prefix_list_direction_out_prefix_name, mapped from YANG variable /routing_system/router/ospf/area/prefix_list/direction_out/prefix_list_direction_out_prefix_name (ipv4-prefix-name-t)
  ...
  def _set_prefix_list_direction_out(self, v, load=False):
    """
    Setter method for prefix_list_direction_out, mapped from YANG variable /routing_system/router/ospf/area/prefix_list/direction_out/prefix_list_direction_out (empty)
    If this variable is read-only (config: false) in the
