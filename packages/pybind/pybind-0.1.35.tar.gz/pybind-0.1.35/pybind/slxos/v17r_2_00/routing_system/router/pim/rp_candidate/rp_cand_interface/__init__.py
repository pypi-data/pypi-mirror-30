...
class rp_cand_interface(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/pim/rp-candidate/rp-cand-interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'pim', u'rp-candidate', u'rp-cand-interface']
  ...
  def _set_rp_cand_intf_type(self, v, load=False):
    """
    Setter method for rp_cand_intf_type, mapped from YANG variable /routing_system/router/pim/rp_candidate/rp_cand_interface/rp_cand_intf_type (pim-intf-types)
  ...
  def _set_rp_cand_intf_id(self, v, load=False):
    """
    Setter method for rp_cand_intf_id, mapped from YANG variable /routing_system/router/pim/rp_candidate/rp_cand_interface/rp_cand_intf_id (string)
    If this variable is read-only (config: false) in the
