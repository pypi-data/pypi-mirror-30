...
class neighbor_route_map_direction_in(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv4/vpnv4-unicast/af-vpnv4-neighbor-address-holder/af-vpnv4-neighbor/neighbor-route-map/neighbor-route-map-direction-in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv4', u'vpnv4-unicast', u'af-vpnv4-neighbor-address-holder', u'af-vpnv4-neighbor', u'neighbor-route-map', u'neighbor-route-map-direction-in']
