...
class interface_md5(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/loopback/intf-isis/interface-isis/interface-auth-mode/interface-md5. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u'loopback', u'intf-isis', u'interface-isis', u'interface-auth-mode', u'interface-md5']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Loopback', u'isis', u'auth-mode', u'md5']
  ...
  def _set_interface_auth_mode_md5_level1(self, v, load=False):
    """
    Setter method for interface_auth_mode_md5_level1, mapped from YANG variable /routing_system/interface/loopback/intf_isis/interface_isis/interface_auth_mode/interface_md5/interface_auth_mode_md5_level1 (empty)
  ...
  def _set_interface_auth_mode_md5_level2(self, v, load=False):
    """
    Setter method for interface_auth_mode_md5_level2, mapped from YANG variable /routing_system/interface/loopback/intf_isis/interface_isis/interface_auth_mode/interface_md5/interface_auth_mode_md5_level2 (empty)
    If this variable is read-only (config: false) in the
