...
class addpath_select(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/default-vrf/af-ipv4-uc-and-vrf-cmds-call-point-holder/af-additional-paths/addpath-select. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'default-vrf', u'af-ipv4-uc-and-vrf-cmds-call-point-holder', u'af-additional-paths', u'addpath-select']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'ipv4', u'unicast', u'additional-paths', u'select']

  def _get_addpath_sel_best(self):
    """
    Getter method for addpath_sel_best, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/af_additional_paths/addpath_select/addpath_sel_best (uint8)
    """
    return self.__addpath_sel_best
      
  def _set_addpath_sel_best(self, v, load=False):
    """
    Setter method for addpath_sel_best, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/af_additional_paths/addpath_select/addpath_sel_best (uint8)
  ...
  def _get_addpath_sel_groupbest(self):
    """
    Getter method for addpath_sel_groupbest, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/af_additional_paths/addpath_select/addpath_sel_groupbest (empty)
    """
    return self.__addpath_sel_groupbest
      
  def _set_addpath_sel_groupbest(self, v, load=False):
    """
    Setter method for addpath_sel_groupbest, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/af_additional_paths/addpath_select/addpath_sel_groupbest (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_addpath_sel_all(self):
    """
    Getter method for addpath_sel_all, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/af_additional_paths/addpath_select/addpath_sel_all (empty)
    """
    return self.__addpath_sel_all
      
  def _set_addpath_sel_all(self, v, load=False):
    """
    Setter method for addpath_sel_all, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/af_additional_paths/addpath_select/addpath_sel_all (empty)
    If this variable is read-only (config: false) in the
