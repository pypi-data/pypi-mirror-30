...
import isis_protocol_container
import ospf_protocol_container
class protocol(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__protocol_static_container','__bgp_protocol_container','__isis_protocol_container','__ospf_protocol_container',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__isis_protocol_container = YANGDynClass(base=isis_protocol_container.isis_protocol_container, is_container='container', presence=False, yang_name="isis-protocol-container", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)
    ...
    self.__ospf_protocol_container = YANGDynClass(base=ospf_protocol_container.ospf_protocol_container, is_container='container', presence=False, yang_name="ospf-protocol-container", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)
  ...
  def _get_isis_protocol_container(self):
    ...
    """
    return self.__isis_protocol_container
      
  def _set_isis_protocol_container(self, v, load=False):
    """
    Setter method for isis_protocol_container, mapped from YANG variable /routing_system/route_map/content/match/protocol/isis_protocol_container (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_isis_protocol_container is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_isis_protocol_container() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=isis_protocol_container.isis_protocol_container, is_container='container', presence=False, yang_name="isis-protocol-container", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """isis_protocol_container must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=isis_protocol_container.isis_protocol_container, is_container='container', presence=False, yang_name="isis-protocol-container", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)""",
        })

    self.__isis_protocol_container = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_isis_protocol_container(self):
    self.__isis_protocol_container = YANGDynClass(base=isis_protocol_container.isis_protocol_container, is_container='container', presence=False, yang_name="isis-protocol-container", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)
  ...
  def _get_ospf_protocol_container(self):
    ...
    """
    return self.__ospf_protocol_container
      
  def _set_ospf_protocol_container(self, v, load=False):
    """
    Setter method for ospf_protocol_container, mapped from YANG variable /routing_system/route_map/content/match/protocol/ospf_protocol_container (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ospf_protocol_container is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ospf_protocol_container() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=ospf_protocol_container.ospf_protocol_container, is_container='container', presence=False, yang_name="ospf-protocol-container", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ospf_protocol_container must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=ospf_protocol_container.ospf_protocol_container, is_container='container', presence=False, yang_name="ospf-protocol-container", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)""",
        })

    self.__ospf_protocol_container = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_ospf_protocol_container(self):
    self.__ospf_protocol_container = YANGDynClass(base=ospf_protocol_container.ospf_protocol_container, is_container='container', presence=False, yang_name="ospf-protocol-container", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-compact-syntax': None, u'cli-drop-node-name': None, u'cli-sequence-commands': None}}, namespace='urn:brocade.com:mgmt:brocade-ip-policy', defining_module='brocade-ip-policy', yang_type='container', is_config=True)
  ...
  isis_protocol_container = __builtin__.property(_get_isis_protocol_container, _set_isis_protocol_container)
  ospf_protocol_container = __builtin__.property(_get_ospf_protocol_container, _set_ospf_protocol_container)


  _pyangbind_elements = {'protocol_static_container': protocol_static_container, 'bgp_protocol_container': bgp_protocol_container, 'isis_protocol_container': isis_protocol_container, 'ospf_protocol_container': ospf_protocol_container, }
