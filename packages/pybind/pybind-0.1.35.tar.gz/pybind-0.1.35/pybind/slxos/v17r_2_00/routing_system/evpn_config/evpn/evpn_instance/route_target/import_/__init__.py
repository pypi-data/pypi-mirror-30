...
class import_(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/evpn-config/evpn/evpn-instance/route-target/import. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'evpn-config', u'evpn', u'evpn-instance', u'route-target', u'import']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'evpn', u'evpn-instance', u'route-target', u'import']

  def _get_target_community(self):
    """
    Getter method for target_community, mapped from YANG variable /routing_system/evpn_config/evpn/evpn_instance/route_target/import/target_community (rt-type)
  ...
  def _set_target_community(self, v, load=False):
    """
    Setter method for target_community, mapped from YANG variable /routing_system/evpn_config/evpn/evpn_instance/route_target/import/target_community (rt-type)
  ...
  def _set_ignore_as(self, v, load=False):
    """
    Setter method for ignore_as, mapped from YANG variable /routing_system/evpn_config/evpn/evpn_instance/route_target/import/ignore_as (empty)
    If this variable is read-only (config: false) in the
