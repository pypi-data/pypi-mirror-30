...
class neighbor(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/l2vpn/evpn/neighbor. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'l2vpn', u'evpn', u'neighbor']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'l2vpn', u'evpn', u'neighbor']
  ...
  def _set_evpn_peer_group(self, v, load=False):
    """
    Setter method for evpn_peer_group, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group (list)
  ...
  def _set_evpn_neighbor_ipv4(self, v, load=False):
    """
    Setter method for evpn_neighbor_ipv4, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv4 (list)
    If this variable is read-only (config: false) in the
  ...
  def _set_evpn_neighbor_ipv6(self, v, load=False):
    """
    Setter method for evpn_neighbor_ipv6, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6 (list)
    If this variable is read-only (config: false) in the
