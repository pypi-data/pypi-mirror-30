...
import af_vpnv4_neighbor_address_holder
class vpnv4_unicast(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv4/vpnv4-unicast. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__rr_group','__export_vrf_leaked_routes','__af_vpn_neighbor_peergroup_holder','__af_vpnv4_neighbor_address_holder',)

  _yang_name = 'vpnv4-unicast'
  _rest_name = 'unicast'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv4', u'vpnv4-unicast']
  ...
  def _get_rr_group(self):
    """
    Getter method for rr_group, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/rr_group (rr-group-type)
    """
    return self.__rr_group
      
  def _set_rr_group(self, v, load=False):
    """
    Setter method for rr_group, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/rr_group (rr-group-type)
  ...
  def _get_export_vrf_leaked_routes(self):
    """
    Getter method for export_vrf_leaked_routes, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/export_vrf_leaked_routes (empty)
    """
    return self.__export_vrf_leaked_routes
      
  def _set_export_vrf_leaked_routes(self, v, load=False):
    """
    Setter method for export_vrf_leaked_routes, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/export_vrf_leaked_routes (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_af_vpn_neighbor_peergroup_holder(self):
    """
    Getter method for af_vpn_neighbor_peergroup_holder, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder (container)
    """
    return self.__af_vpn_neighbor_peergroup_holder
      
  def _set_af_vpn_neighbor_peergroup_holder(self, v, load=False):
    """
    Setter method for af_vpn_neighbor_peergroup_holder, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_af_vpnv4_neighbor_address_holder(self):
    """
    Getter method for af_vpnv4_neighbor_address_holder, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpnv4_neighbor_address_holder (container)
    """
    return self.__af_vpnv4_neighbor_address_holder
      
  def _set_af_vpnv4_neighbor_address_holder(self, v, load=False):
    """
    Setter method for af_vpnv4_neighbor_address_holder, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpnv4_neighbor_address_holder (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_af_vpnv4_neighbor_address_holder is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_af_vpnv4_neighbor_address_holder() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=af_vpnv4_neighbor_address_holder.af_vpnv4_neighbor_address_holder, is_container='container', presence=False, yang_name="af-vpnv4-neighbor-address-holder", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """af_vpnv4_neighbor_address_holder must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=af_vpnv4_neighbor_address_holder.af_vpnv4_neighbor_address_holder, is_container='container', presence=False, yang_name="af-vpnv4-neighbor-address-holder", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='container', is_config=True)""",
        })

    self.__af_vpnv4_neighbor_address_holder = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_af_vpnv4_neighbor_address_holder(self):
    self.__af_vpnv4_neighbor_address_holder = YANGDynClass(base=af_vpnv4_neighbor_address_holder.af_vpnv4_neighbor_address_holder, is_container='container', presence=False, yang_name="af-vpnv4-neighbor-address-holder", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='container', is_config=True)
  ...
  af_vpnv4_neighbor_address_holder = __builtin__.property(_get_af_vpnv4_neighbor_address_holder, _set_af_vpnv4_neighbor_address_holder)


  _pyangbind_elements = {'rr_group': rr_group, 'export_vrf_leaked_routes': export_vrf_leaked_routes, 'af_vpn_neighbor_peergroup_holder': af_vpn_neighbor_peergroup_holder, 'af_vpnv4_neighbor_address_holder': af_vpnv4_neighbor_address_holder, }
