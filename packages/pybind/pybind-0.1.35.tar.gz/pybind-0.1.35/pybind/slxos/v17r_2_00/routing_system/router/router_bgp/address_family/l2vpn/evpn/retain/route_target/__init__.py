...
class route_target(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/l2vpn/evpn/retain/route-target. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'l2vpn', u'evpn', u'retain', u'route-target']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'l2vpn', u'evpn', u'retain', u'route-target']
  ...
  def _set_all(self, v, load=False):
    """
    Setter method for all, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/retain/route_target/all (empty)
