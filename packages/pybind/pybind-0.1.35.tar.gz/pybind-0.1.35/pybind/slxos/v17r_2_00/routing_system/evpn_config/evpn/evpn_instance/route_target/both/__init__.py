...
class both(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/evpn-config/evpn/evpn-instance/route-target/both. Each member element of
  ...
  def _get_target_community(self):
    """
    Getter method for target_community, mapped from YANG variable /routing_system/evpn_config/evpn/evpn_instance/route_target/both/target_community (rt-type)
  ...
  def _set_target_community(self, v, load=False):
    """
    Setter method for target_community, mapped from YANG variable /routing_system/evpn_config/evpn/evpn_instance/route_target/both/target_community (rt-type)
  ...
  def _set_ignore_as(self, v, load=False):
    """
    Setter method for ignore_as, mapped from YANG variable /routing_system/evpn_config/evpn/evpn_instance/route_target/both/ignore_as (empty)
    If this variable is read-only (config: false) in the
