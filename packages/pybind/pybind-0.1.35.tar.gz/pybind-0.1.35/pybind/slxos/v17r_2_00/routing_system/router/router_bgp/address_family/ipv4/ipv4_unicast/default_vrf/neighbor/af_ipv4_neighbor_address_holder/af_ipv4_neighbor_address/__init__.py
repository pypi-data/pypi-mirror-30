...
class af_ipv4_neighbor_address(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__af_ipv4_neighbor_address','__send_community','__af_neighbor_capability','__activate','__allowas_in','__filter_list','__maximum_prefix','__default_originate','__prefix_list','__neighbor_route_map','__route_reflector_client','__unsuppress_map','__af_nei_weight','__enable_peer_as_check','__additional_paths',)
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'ipv4', u'unicast', u'neighbor', u'af-ipv4-neighbor-address']
  ...
  def _get_enable_peer_as_check(self):
    """
    Getter method for enable_peer_as_check, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/neighbor/af_ipv4_neighbor_address_holder/af_ipv4_neighbor_address/enable_peer_as_check (empty)
    """
    return self.__enable_peer_as_check
      
  def _set_enable_peer_as_check(self, v, load=False):
    """
    Setter method for enable_peer_as_check, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/neighbor/af_ipv4_neighbor_address_holder/af_ipv4_neighbor_address/enable_peer_as_check (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_additional_paths(self):
    """
    Getter method for additional_paths, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/neighbor/af_ipv4_neighbor_address_holder/af_ipv4_neighbor_address/additional_paths (container)
    """
    return self.__additional_paths
      
  def _set_additional_paths(self, v, load=False):
    """
    Setter method for additional_paths, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/neighbor/af_ipv4_neighbor_address_holder/af_ipv4_neighbor_address/additional_paths (container)
    If this variable is read-only (config: false) in the
