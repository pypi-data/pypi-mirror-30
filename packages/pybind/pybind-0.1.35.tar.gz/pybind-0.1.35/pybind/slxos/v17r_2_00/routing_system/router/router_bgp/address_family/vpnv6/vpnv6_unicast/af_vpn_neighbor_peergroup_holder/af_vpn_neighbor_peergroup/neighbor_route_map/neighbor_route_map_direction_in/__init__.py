...
class neighbor_route_map_direction_in(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv6/vpnv6-unicast/af-vpn-neighbor-peergroup-holder/af-vpn-neighbor-peergroup/neighbor-route-map/neighbor-route-map-direction-in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv6', u'vpnv6-unicast', u'af-vpn-neighbor-peergroup-holder', u'af-vpn-neighbor-peergroup', u'neighbor-route-map', u'neighbor-route-map-direction-in']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'vpnv6', u'unicast', u'neighbor', u'route-map', u'in']

  def _get_neighbor_route_map_name_direction_in(self):
    """
    Getter method for neighbor_route_map_name_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/neighbor_route_map/neighbor_route_map_direction_in/neighbor_route_map_name_direction_in (common-def:name-string64)
    """
