...
class neighbor_route_map(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv6/vpnv6-unicast/af-vpnv6-neighbor-address-holder/af-vpnv6-neighbor/neighbor-route-map. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv6', u'vpnv6-unicast', u'af-vpnv6-neighbor-address-holder', u'af-vpnv6-neighbor', u'neighbor-route-map']
  ...
  def _get_neighbor_route_map_direction_in(self):
    """
    Getter method for neighbor_route_map_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/neighbor_route_map/neighbor_route_map_direction_in (container)
    """
    return self.__neighbor_route_map_direction_in
      
  def _set_neighbor_route_map_direction_in(self, v, load=False):
    """
    Setter method for neighbor_route_map_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/neighbor_route_map/neighbor_route_map_direction_in (container)
  ...
  def _get_neighbor_route_map_direction_out(self):
    """
    Getter method for neighbor_route_map_direction_out, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/neighbor_route_map/neighbor_route_map_direction_out (container)
    """
    return self.__neighbor_route_map_direction_out
      
  def _set_neighbor_route_map_direction_out(self, v, load=False):
    """
    Setter method for neighbor_route_map_direction_out, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpnv6_neighbor_address_holder/af_vpnv6_neighbor/neighbor_route_map/neighbor_route_map_direction_out (container)
    If this variable is read-only (config: false) in the
