...
class auto_cost(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/ipv6/router/ospf/auto-cost. Each member element of
  ...
  def _get_reference_bandwidth(self):
    """
    Getter method for reference_bandwidth, mapped from YANG variable /routing_system/ipv6/router/ospf/auto_cost/reference_bandwidth (ospf:band-width)
  ...
  def _set_reference_bandwidth(self, v, load=False):
    """
    Setter method for reference_bandwidth, mapped from YANG variable /routing_system/ipv6/router/ospf/auto_cost/reference_bandwidth (ospf:band-width)
