...
class authentication(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/area/virtual-link/authentication. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'area', u'virtual-link', u'authentication']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'area', u'virtual-link', u'authentication']

  def _get_key_chain(self):
    """
    Getter method for key_chain, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/authentication/key_chain (ospf-keychain-string)
    """
    return self.__key_chain
      
  def _set_key_chain(self, v, load=False):
    """
    Setter method for key_chain, mapped from YANG variable /routing_system/router/ospf/area/virtual_link/authentication/key_chain (ospf-keychain-string)
