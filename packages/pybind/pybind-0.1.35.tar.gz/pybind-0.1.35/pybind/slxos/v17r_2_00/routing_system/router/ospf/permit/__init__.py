...
class permit(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/permit. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'permit']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'permit']

  def _get_redistribute(self):
    """
    Getter method for redistribute, mapped from YANG variable /routing_system/router/ospf/permit/redistribute (list)
    """
    return self.__redistribute
      
  def _set_redistribute(self, v, load=False):
    """
    Setter method for redistribute, mapped from YANG variable /routing_system/router/ospf/permit/redistribute (list)
