...
class direction_in(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv4/vpnv4-unicast/af-vpn-neighbor-peergroup-holder/af-vpn-neighbor-peergroup/filter-list/direction-in. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__filter_list_direction_in_acl_name = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..63']}), is_leaf=True, yang_name="filter-list-direction-in-acl-name", rest_name="filter-list-direction-in-acl-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='ip-filter-name', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv4', u'vpnv4-unicast', u'af-vpn-neighbor-peergroup-holder', u'af-vpn-neighbor-peergroup', u'filter-list', u'direction-in']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'vpnv4', u'unicast', u'neighbor', u'filter-list']

  def _get_filter_list_direction_in_acl_name(self):
    """
    Getter method for filter_list_direction_in_acl_name, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/filter_list/direction_in/filter_list_direction_in_acl_name (ip-filter-name)
    """
    return self.__filter_list_direction_in_acl_name
      
  def _set_filter_list_direction_in_acl_name(self, v, load=False):
    """
    Setter method for filter_list_direction_in_acl_name, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/filter_list/direction_in/filter_list_direction_in_acl_name (ip-filter-name)
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..63']}), is_leaf=True, yang_name="filter-list-direction-in-acl-name", rest_name="filter-list-direction-in-acl-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='ip-filter-name', is_config=True)
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..63']}), is_leaf=True, yang_name="filter-list-direction-in-acl-name", rest_name="filter-list-direction-in-acl-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-incomplete-no': None, u'cli-incomplete-command': None}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='ip-filter-name', is_config=True)""",
        })
  ...
  def _get_filter_list_name_direction_in(self):
    """
    Getter method for filter_list_name_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/filter_list/direction_in/filter_list_name_direction_in (empty)
    """
    return self.__filter_list_name_direction_in
      
  def _set_filter_list_name_direction_in(self, v, load=False):
    """
    Setter method for filter_list_name_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/filter_list/direction_in/filter_list_name_direction_in (empty)
    If this variable is read-only (config: false) in the
