...
class static(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/redistribute/static. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__static_route_map',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'ospf', u'redistribute', u'static']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'ospf', u'redistribute', u'static']
  ...
  def _set_static_route_map(self, v, load=False):
    """
    Setter method for static_route_map, mapped from YANG variable /routing_system/router/ospf/redistribute/static/static_route_map (common-def:name-string63)
  ...
  _pyangbind_elements = {'static_route_map': static_route_map, }
