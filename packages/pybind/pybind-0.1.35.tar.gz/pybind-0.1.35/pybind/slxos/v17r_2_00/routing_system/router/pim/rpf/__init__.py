...
class rpf(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/pim/rpf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'pim', u'rpf']
  ...
  def _get_ecmp(self):
    """
    Getter method for ecmp, mapped from YANG variable /routing_system/router/pim/rpf/ecmp (container)
    """
    return self.__ecmp
      
  def _set_ecmp(self, v, load=False):
    """
    Setter method for ecmp, mapped from YANG variable /routing_system/router/pim/rpf/ecmp (container)
