...
class ve(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__name','__bfd','__vrf','__ip','__shutdown','__ipv6','__vrrp','__vrrpe','__ip_acl_interface','__ip_pbr_interface','__intf_isis','__qos','__rpf',)
  ...
  def _get_rpf(self):
    """
    Getter method for rpf, mapped from YANG variable /routing_system/interface/ve/rpf (container)
  ...
  def _set_rpf(self, v, load=False):
    """
    Setter method for rpf, mapped from YANG variable /routing_system/interface/ve/rpf (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'name': name, 'bfd': bfd, 'vrf': vrf, 'ip': ip, 'shutdown': shutdown, 'ipv6': ipv6, 'vrrp': vrrp, 'vrrpe': vrrpe, 'ip_acl_interface': ip_acl_interface, 'ip_pbr_interface': ip_pbr_interface, 'intf_isis': intf_isis, 'qos': qos, 'rpf': rpf, }
