...
class link_onstartup(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/ospf/max-metric/router-lsa/on-startup/link-onstartup. Each member element of
  ...
  def _set_all_link_onstartup(self, v, load=False):
    """
    Setter method for all_link_onstartup, mapped from YANG variable /routing_system/router/ospf/max_metric/router_lsa/on_startup/link_onstartup/all_link_onstartup (empty)
  ...
  def _set_ptp_link_onstartup(self, v, load=False):
    """
    Setter method for ptp_link_onstartup, mapped from YANG variable /routing_system/router/ospf/max_metric/router_lsa/on_startup/link_onstartup/ptp_link_onstartup (empty)
    If this variable is read-only (config: false) in the
  ...
  def _set_stub_link_onstartup(self, v, load=False):
    """
    Setter method for stub_link_onstartup, mapped from YANG variable /routing_system/router/ospf/max_metric/router_lsa/on_startup/link_onstartup/stub_link_onstartup (empty)
    If this variable is read-only (config: false) in the
  ...
  def _set_transit_link_onstartup(self, v, load=False):
    """
    Setter method for transit_link_onstartup, mapped from YANG variable /routing_system/router/ospf/max_metric/router_lsa/on_startup/link_onstartup/transit_link_onstartup (empty)
    If this variable is read-only (config: false) in the
