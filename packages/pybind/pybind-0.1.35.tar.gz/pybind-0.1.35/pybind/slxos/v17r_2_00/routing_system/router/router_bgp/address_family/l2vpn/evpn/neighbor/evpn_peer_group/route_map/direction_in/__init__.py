...
class direction_in(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/l2vpn/evpn/neighbor/evpn-peer-group/route-map/direction-in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'l2vpn', u'evpn', u'neighbor', u'evpn-peer-group', u'route-map', u'direction-in']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'l2vpn', u'evpn', u'neighbor', u'evpn-peer-group', u'route-map', u'in']

  def _get_route_map_name_direction_in(self):
    """
    Getter method for route_map_name_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/route_map/direction_in/route_map_name_direction_in (common-def:name-string64)
    """
    return self.__route_map_name_direction_in
      
  def _set_route_map_name_direction_in(self, v, load=False):
    """
    Setter method for route_map_name_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_peer_group/route_map/direction_in/route_map_name_direction_in (common-def:name-string64)
