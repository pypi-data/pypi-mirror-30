...
class ip(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ip-acl-interface/ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ip-acl-interface', u'ip']
  ...
  def _set_access_group(self, v, load=False):
    """
    Setter method for access_group, mapped from YANG variable /routing_system/interface/ve/ip_acl_interface/ip/access_group (list)
