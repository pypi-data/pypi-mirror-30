...
class vrrpv3e(PybindBase):
  ...
  def _get_virtual_mac(self):
    """
    Getter method for virtual_mac, mapped from YANG variable /routing_system/interface/ve/ipv6/vrrpv3e/virtual_mac (enumeration)
  ...
  def _set_virtual_mac(self, v, load=False):
    """
    Setter method for virtual_mac, mapped from YANG variable /routing_system/interface/ve/ipv6/vrrpv3e/virtual_mac (enumeration)
    If this variable is read-only (config: false) in the
    ...
    try:
      ...
      raise ValueError({
          ...
          'defined-type': "brocade-vrrpv3:enumeration",
