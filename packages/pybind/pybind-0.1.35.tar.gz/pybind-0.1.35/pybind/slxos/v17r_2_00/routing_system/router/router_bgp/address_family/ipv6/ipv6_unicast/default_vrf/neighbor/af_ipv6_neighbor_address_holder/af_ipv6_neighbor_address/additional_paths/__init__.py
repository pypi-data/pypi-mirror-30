...
class additional_paths(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv6/ipv6-unicast/default-vrf/neighbor/af-ipv6-neighbor-address-holder/af-ipv6-neighbor-address/additional-paths. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'default-vrf', u'neighbor', u'af-ipv6-neighbor-address-holder', u'af-ipv6-neighbor-address', u'additional-paths']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'ipv6', u'unicast', u'neighbor', u'af-ipv6-neighbor-address', u'additional-paths']

  def _get_addpath_disable(self):
    """
    Getter method for addpath_disable, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/additional_paths/addpath_disable (empty)
    """
    return self.__addpath_disable
      
  def _set_addpath_disable(self, v, load=False):
    """
    Setter method for addpath_disable, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/additional_paths/addpath_disable (empty)
  ...
  def _get_addpath_txrx(self):
    """
    Getter method for addpath_txrx, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/additional_paths/addpath_txrx (container)
    """
    return self.__addpath_txrx
      
  def _set_addpath_txrx(self, v, load=False):
    """
    Setter method for addpath_txrx, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/additional_paths/addpath_txrx (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_addpath_advertise(self):
    """
    Getter method for addpath_advertise, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/additional_paths/addpath_advertise (container)
    """
    return self.__addpath_advertise
      
  def _set_addpath_advertise(self, v, load=False):
    """
    Setter method for addpath_advertise, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/neighbor/af_ipv6_neighbor_address_holder/af_ipv6_neighbor_address/additional_paths/addpath_advertise (container)
    If this variable is read-only (config: false) in the
