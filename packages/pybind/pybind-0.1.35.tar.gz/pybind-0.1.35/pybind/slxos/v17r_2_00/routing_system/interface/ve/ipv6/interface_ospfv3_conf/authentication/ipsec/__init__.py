...
class ipsec(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/ve/ipv6/interface-ospfv3-conf/authentication/ipsec. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u've', u'ipv6', u'interface-ospfv3-conf', u'authentication', u'ipsec']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Ve', u'ipv6', u'ospf', u'authentication', u'ipsec']

  def _get_ipsec_authentication_disable(self):
    """
    Getter method for ipsec_authentication_disable, mapped from YANG variable /routing_system/interface/ve/ipv6/interface_ospfv3_conf/authentication/ipsec/ipsec_authentication_disable (empty)
  ...
  def _set_ipsec_authentication_disable(self, v, load=False):
    """
    Setter method for ipsec_authentication_disable, mapped from YANG variable /routing_system/interface/ve/ipv6/interface_ospfv3_conf/authentication/ipsec/ipsec_authentication_disable (empty)
  ...
  def _get_ifc_key_add_remove_interval(self):
    """
    Getter method for ifc_key_add_remove_interval, mapped from YANG variable /routing_system/interface/ve/ipv6/interface_ospfv3_conf/authentication/ipsec/ifc_key_add_remove_interval (common-def:time-interval-sec)
  ...
  def _set_ifc_key_add_remove_interval(self, v, load=False):
    """
    Setter method for ifc_key_add_remove_interval, mapped from YANG variable /routing_system/interface/ve/ipv6/interface_ospfv3_conf/authentication/ipsec/ifc_key_add_remove_interval (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
