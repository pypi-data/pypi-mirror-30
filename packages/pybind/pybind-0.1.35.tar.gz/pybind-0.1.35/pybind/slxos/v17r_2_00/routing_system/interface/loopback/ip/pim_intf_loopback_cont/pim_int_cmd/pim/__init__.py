...
class pim(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/loopback/ip/pim-intf-loopback-cont/pim-int-cmd/pim. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u'loopback', u'ip', u'pim-intf-loopback-cont', u'pim-int-cmd', u'pim']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Loopback', u'ip', u'pim']
  ...
  def _set_neighbor_filter(self, v, load=False):
    """
    Setter method for neighbor_filter, mapped from YANG variable /routing_system/interface/loopback/ip/pim_intf_loopback_cont/pim_int_cmd/pim/neighbor_filter (ip-prefix-name-t)
  ...
  def _set_dr_priority(self, v, load=False):
    """
    Setter method for dr_priority, mapped from YANG variable /routing_system/interface/loopback/ip/pim_intf_loopback_cont/pim_int_cmd/pim/dr_priority (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _set_ttl_threshold(self, v, load=False):
    """
    Setter method for ttl_threshold, mapped from YANG variable /routing_system/interface/loopback/ip/pim_intf_loopback_cont/pim_int_cmd/pim/ttl_threshold (uint32)
    If this variable is read-only (config: false) in the
