...
class ip_config(PybindBase):
  ...
  def _get_arp(self):
    """
    Getter method for arp, mapped from YANG variable /routing_system/interface/ve/ip/ip_config/arp (container)
    """
    return self.__arp
      
  def _set_arp(self, v, load=False):
    """
    Setter method for arp, mapped from YANG variable /routing_system/interface/ve/ip/ip_config/arp (container)
    If this variable is read-only (config: false) in the
