...
class send_community(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv4/vpnv4-unicast/af-vpn-neighbor-peergroup-holder/af-vpn-neighbor-peergroup/send-community. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv4', u'vpnv4-unicast', u'af-vpn-neighbor-peergroup-holder', u'af-vpn-neighbor-peergroup', u'send-community']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'vpnv4', u'unicast', u'neighbor', u'send-community']

  def _get_send_community_status(self):
    """
    Getter method for send_community_status, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/send_community/send_community_status (empty)
    """
    return self.__send_community_status
      
  def _set_send_community_status(self, v, load=False):
    """
    Setter method for send_community_status, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/send_community/send_community_status (empty)
  ...
  def _get_both(self):
    """
    Getter method for both, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/send_community/both (empty)
    """
    return self.__both
      
  def _set_both(self, v, load=False):
    """
    Setter method for both, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/send_community/both (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_extended(self):
    """
    Getter method for extended, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/send_community/extended (empty)
    """
    return self.__extended
      
  def _set_extended(self, v, load=False):
    """
    Setter method for extended, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/send_community/extended (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_standard(self):
    """
    Getter method for standard, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/send_community/standard (empty)
    """
    return self.__standard
      
  def _set_standard(self, v, load=False):
    """
    Setter method for standard, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/send_community/standard (empty)
    If this variable is read-only (config: false) in the
