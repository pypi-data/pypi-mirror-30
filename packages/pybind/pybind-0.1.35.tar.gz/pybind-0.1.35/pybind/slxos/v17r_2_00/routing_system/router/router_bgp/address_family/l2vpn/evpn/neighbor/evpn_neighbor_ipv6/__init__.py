...
class evpn_neighbor_ipv6(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/l2vpn/evpn/neighbor/evpn-neighbor-ipv6. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__evpn_neighbor_ipv6_address','__encapsulation','__maximum_prefix','__route_reflector_client','__allowas_in','__next_hop_unchanged','__enable_peer_as_check','__route_map','__activate','__send_community',)

  _yang_name = 'evpn-neighbor-ipv6'
  _rest_name = 'evpn-neighbor-ipv6'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'l2vpn', u'evpn', u'neighbor', u'evpn-neighbor-ipv6']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'l2vpn', u'evpn', u'neighbor', u'evpn-neighbor-ipv6']

  def _get_evpn_neighbor_ipv6_address(self):
    """
    Getter method for evpn_neighbor_ipv6_address, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/evpn_neighbor_ipv6_address (inet:ipv6-address)
    """
    return self.__evpn_neighbor_ipv6_address
      
  def _set_evpn_neighbor_ipv6_address(self, v, load=False):
    """
    Setter method for evpn_neighbor_ipv6_address, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/evpn_neighbor_ipv6_address (inet:ipv6-address)
  ...
  def _get_encapsulation(self):
    """
    Getter method for encapsulation, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/encapsulation (encapsulation-t)
    """
    return self.__encapsulation
      
  def _set_encapsulation(self, v, load=False):
    """
    Setter method for encapsulation, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/encapsulation (encapsulation-t)
    If this variable is read-only (config: false) in the
  ...
  def _get_maximum_prefix(self):
    """
    Getter method for maximum_prefix, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/maximum_prefix (max-prefix-limit)
    """
    return self.__maximum_prefix
      
  def _set_maximum_prefix(self, v, load=False):
    """
    Setter method for maximum_prefix, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/maximum_prefix (max-prefix-limit)
    If this variable is read-only (config: false) in the
  ...
  def _get_route_reflector_client(self):
    """
    Getter method for route_reflector_client, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/route_reflector_client (empty)
    """
    return self.__route_reflector_client
      
  def _set_route_reflector_client(self, v, load=False):
    """
    Setter method for route_reflector_client, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/route_reflector_client (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_allowas_in(self):
    """
    Getter method for allowas_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/allowas_in (uint32)
    """
    return self.__allowas_in
      
  def _set_allowas_in(self, v, load=False):
    """
    Setter method for allowas_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/allowas_in (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_next_hop_unchanged(self):
    """
    Getter method for next_hop_unchanged, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/next_hop_unchanged (empty)
    """
    return self.__next_hop_unchanged
      
  def _set_next_hop_unchanged(self, v, load=False):
    """
    Setter method for next_hop_unchanged, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/next_hop_unchanged (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_enable_peer_as_check(self):
    """
    Getter method for enable_peer_as_check, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/enable_peer_as_check (empty)
    """
    return self.__enable_peer_as_check
      
  def _set_enable_peer_as_check(self, v, load=False):
    """
    Setter method for enable_peer_as_check, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/enable_peer_as_check (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_route_map(self):
    """
    Getter method for route_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/route_map (container)
    """
    return self.__route_map
      
  def _set_route_map(self, v, load=False):
    """
    Setter method for route_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/route_map (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_activate(self):
    """
    Getter method for activate, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/activate (empty)
    """
    return self.__activate
      
  def _set_activate(self, v, load=False):
    """
    Setter method for activate, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/activate (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_send_community(self):
    """
    Getter method for send_community, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/send_community (container)
    """
    return self.__send_community
      
  def _set_send_community(self, v, load=False):
    """
    Setter method for send_community, mapped from YANG variable /routing_system/router/router_bgp/address_family/l2vpn/evpn/neighbor/evpn_neighbor_ipv6/send_community (container)
    If this variable is read-only (config: false) in the
