...
class authentication(PybindBase):
  ...
  def _get_key_chain(self):
    """
    Getter method for key_chain, mapped from YANG variable /routing_system/interface/ve/ipv6/interface_ospfv3_conf/authentication/key_chain (string)
    """
    return self.__key_chain
      
  def _set_key_chain(self, v, load=False):
    """
    Setter method for key_chain, mapped from YANG variable /routing_system/interface/ve/ipv6/interface_ospfv3_conf/authentication/key_chain (string)
