...
class authentication(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__key_chain','__ipsec_auth_key_config','__ipsec',)
  ...
  def _get_key_chain(self):
    """
    Getter method for key_chain, mapped from YANG variable /routing_system/interface/loopback/ipv6/interface_ospfv3_conf/authentication/key_chain (string)
    """
    return self.__key_chain
      
  def _set_key_chain(self, v, load=False):
    """
    Setter method for key_chain, mapped from YANG variable /routing_system/interface/loopback/ipv6/interface_ospfv3_conf/authentication/key_chain (string)
  ...
  _pyangbind_elements = {'key_chain': key_chain, 'ipsec_auth_key_config': ipsec_auth_key_config, 'ipsec': ipsec, }
