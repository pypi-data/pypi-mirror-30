...
class neighbor_route_map(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv4/vpnv4-unicast/af-vpn-neighbor-peergroup-holder/af-vpn-neighbor-peergroup/neighbor-route-map. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv4', u'vpnv4-unicast', u'af-vpn-neighbor-peergroup-holder', u'af-vpn-neighbor-peergroup', u'neighbor-route-map']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'router', u'bgp', u'address-family', u'vpnv4', u'unicast', u'neighbor', u'route-map']

  def _get_neighbor_route_map_direction_in(self):
    """
    Getter method for neighbor_route_map_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/neighbor_route_map/neighbor_route_map_direction_in (container)
    """
    return self.__neighbor_route_map_direction_in
      
  def _set_neighbor_route_map_direction_in(self, v, load=False):
    """
    Setter method for neighbor_route_map_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/neighbor_route_map/neighbor_route_map_direction_in (container)
  ...
  def _get_neighbor_route_map_direction_out(self):
    """
    Getter method for neighbor_route_map_direction_out, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/neighbor_route_map/neighbor_route_map_direction_out (container)
    """
    return self.__neighbor_route_map_direction_out
      
  def _set_neighbor_route_map_direction_out(self, v, load=False):
    """
    Setter method for neighbor_route_map_direction_out, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv4/vpnv4_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/neighbor_route_map/neighbor_route_map_direction_out (container)
    If this variable is read-only (config: false) in the
