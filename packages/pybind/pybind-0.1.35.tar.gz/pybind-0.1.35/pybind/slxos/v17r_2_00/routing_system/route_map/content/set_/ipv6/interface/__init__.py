...
class interface(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/set/ipv6/interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'route-map', u'content', u'set', u'ipv6', u'interface']
  ...
  def _set_ipv6_null0(self, v, load=False):
    """
    Setter method for ipv6_null0, mapped from YANG variable /routing_system/route_map/content/set/ipv6/interface/ipv6_null0 (empty)
