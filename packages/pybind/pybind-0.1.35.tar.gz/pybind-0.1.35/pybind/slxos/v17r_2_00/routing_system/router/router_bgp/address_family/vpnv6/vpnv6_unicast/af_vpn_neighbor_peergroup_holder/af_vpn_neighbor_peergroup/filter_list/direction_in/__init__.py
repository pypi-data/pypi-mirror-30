...
class direction_in(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/vpnv6/vpnv6-unicast/af-vpn-neighbor-peergroup-holder/af-vpn-neighbor-peergroup/filter-list/direction-in. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'vpnv6', u'vpnv6-unicast', u'af-vpn-neighbor-peergroup-holder', u'af-vpn-neighbor-peergroup', u'filter-list', u'direction-in']
  ...
  def _get_filter_list_direction_in_acl_name(self):
    """
    Getter method for filter_list_direction_in_acl_name, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/filter_list/direction_in/filter_list_direction_in_acl_name (ip-filter-name)
    """
    return self.__filter_list_direction_in_acl_name
      
  def _set_filter_list_direction_in_acl_name(self, v, load=False):
    """
    Setter method for filter_list_direction_in_acl_name, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/filter_list/direction_in/filter_list_direction_in_acl_name (ip-filter-name)
  ...
  def _set_filter_list_name_direction_in(self, v, load=False):
    """
    Setter method for filter_list_name_direction_in, mapped from YANG variable /routing_system/router/router_bgp/address_family/vpnv6/vpnv6_unicast/af_vpn_neighbor_peergroup_holder/af_vpn_neighbor_peergroup/filter_list/direction_in/filter_list_name_direction_in (empty)
    If this variable is read-only (config: false) in the
