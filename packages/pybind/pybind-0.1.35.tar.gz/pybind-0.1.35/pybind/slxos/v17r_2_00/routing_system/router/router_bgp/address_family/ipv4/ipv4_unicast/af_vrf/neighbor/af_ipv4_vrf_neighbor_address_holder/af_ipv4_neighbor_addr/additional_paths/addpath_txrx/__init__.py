...
class addpath_txrx(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/af-vrf/neighbor/af-ipv4-vrf-neighbor-address-holder/af-ipv4-neighbor-addr/additional-paths/addpath-txrx. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'af-vrf', u'neighbor', u'af-ipv4-vrf-neighbor-address-holder', u'af-ipv4-neighbor-addr', u'additional-paths', u'addpath-txrx']
  ...
  def _get_addpath_send(self):
    """
    Getter method for addpath_send, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/additional_paths/addpath_txrx/addpath_send (empty)
    """
    return self.__addpath_send
      
  def _set_addpath_send(self, v, load=False):
    """
    Setter method for addpath_send, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/additional_paths/addpath_txrx/addpath_send (empty)
  ...
  def _get_addpath_receive(self):
    """
    Getter method for addpath_receive, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/additional_paths/addpath_txrx/addpath_receive (empty)
    """
    return self.__addpath_receive
      
  def _set_addpath_receive(self, v, load=False):
    """
    Setter method for addpath_receive, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/neighbor/af_ipv4_vrf_neighbor_address_holder/af_ipv4_neighbor_addr/additional_paths/addpath_txrx/addpath_receive (empty)
    If this variable is read-only (config: false) in the
