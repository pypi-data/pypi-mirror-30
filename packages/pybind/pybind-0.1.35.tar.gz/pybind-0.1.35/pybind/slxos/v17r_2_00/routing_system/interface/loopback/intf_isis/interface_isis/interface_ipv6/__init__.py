...
class interface_ipv6(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/loopback/intf-isis/interface-isis/interface-ipv6. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u'loopback', u'intf-isis', u'interface-isis', u'interface-ipv6']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Loopback', u'isis', u'ipv6']
  ...
  def _set_interface_ipv6_metric(self, v, load=False):
    """
    Setter method for interface_ipv6_metric, mapped from YANG variable /routing_system/interface/loopback/intf_isis/interface_isis/interface_ipv6/interface_ipv6_metric (list)
