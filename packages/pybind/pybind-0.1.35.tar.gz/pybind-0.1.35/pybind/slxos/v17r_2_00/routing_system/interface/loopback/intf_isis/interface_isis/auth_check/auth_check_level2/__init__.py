...
class auth_check_level2(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/interface/loopback/intf-isis/interface-isis/auth-check/auth-check-level2. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'routing-system', u'interface', u'loopback', u'intf-isis', u'interface-isis', u'auth-check', u'auth-check-level2']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Loopback', u'isis', u'auth-check', u'level-2']
  ...
  def _set_interface_auth_check_level2_disable(self, v, load=False):
    """
    Setter method for interface_auth_check_level2_disable, mapped from YANG variable /routing_system/interface/loopback/intf_isis/interface_isis/auth_check/auth_check_level2/interface_auth_check_level2_disable (empty)
