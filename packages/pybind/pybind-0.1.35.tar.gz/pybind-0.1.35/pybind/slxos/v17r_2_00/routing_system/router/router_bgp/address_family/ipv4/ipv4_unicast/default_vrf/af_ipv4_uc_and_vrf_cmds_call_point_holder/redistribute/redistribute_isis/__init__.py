...
class redistribute_isis(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/router/router-bgp/address-family/ipv4/ipv4-unicast/default-vrf/af-ipv4-uc-and-vrf-cmds-call-point-holder/redistribute/redistribute-isis. Each member element of
  ...
  def _get_redistribute_isis_route_map(self):
    """
    Getter method for redistribute_isis_route_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/redistribute/redistribute_isis/redistribute_isis_route_map (common-def:name-string63)
  ...
  def _set_redistribute_isis_route_map(self, v, load=False):
    """
    Setter method for redistribute_isis_route_map, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/redistribute/redistribute_isis/redistribute_isis_route_map (common-def:name-string63)
  ...
  def _get_level_1(self):
    """
    Getter method for level_1, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/redistribute/redistribute_isis/level_1 (empty)
  ...
  def _set_level_1(self, v, load=False):
    """
    Setter method for level_1, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/redistribute/redistribute_isis/level_1 (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_level_2(self):
    """
    Getter method for level_2, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/redistribute/redistribute_isis/level_2 (empty)
  ...
  def _set_level_2(self, v, load=False):
    """
    Setter method for level_2, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/redistribute/redistribute_isis/level_2 (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_level_1_2(self):
    """
    Getter method for level_1_2, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/redistribute/redistribute_isis/level_1_2 (empty)
  ...
  def _set_level_1_2(self, v, load=False):
    """
    Setter method for level_1_2, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/redistribute/redistribute_isis/level_1_2 (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_redistribute_isis_metric(self):
    """
    Getter method for redistribute_isis_metric, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/redistribute/redistribute_isis/redistribute_isis_metric (conn-metric)
    """
    return self.__redistribute_isis_metric
      
  def _set_redistribute_isis_metric(self, v, load=False):
    """
    Setter method for redistribute_isis_metric, mapped from YANG variable /routing_system/router/router_bgp/address_family/ipv4/ipv4_unicast/default_vrf/af_ipv4_uc_and_vrf_cmds_call_point_holder/redistribute/redistribute_isis/redistribute_isis_metric (conn-metric)
    If this variable is read-only (config: false) in the
