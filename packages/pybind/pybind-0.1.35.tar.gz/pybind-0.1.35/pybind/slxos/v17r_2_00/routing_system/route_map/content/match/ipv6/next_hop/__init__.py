...
class next_hop(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/route-map/content/match/ipv6/next-hop. Each member element of
  ...
  def _get_ipv6_prefix_list_rmm_n(self):
    """
    Getter method for ipv6_prefix_list_rmm_n, mapped from YANG variable /routing_system/route_map/content/match/ipv6/next_hop/ipv6_prefix_list_rmm_n (ipv6-prefix-name-t)
  ...
  def _set_ipv6_prefix_list_rmm_n(self, v, load=False):
    """
    Setter method for ipv6_prefix_list_rmm_n, mapped from YANG variable /routing_system/route_map/content/match/ipv6/next_hop/ipv6_prefix_list_rmm_n (ipv6-prefix-name-t)
