...
class anycast_gateway_mac(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /routing-system/ipv6/static-ag-ipv6-config/anycast-gateway-mac. Each member element of
  ...
  def _set_ipv6_anycast_gateway_mac(self, v, load=False):
    """
    Setter method for ipv6_anycast_gateway_mac, mapped from YANG variable /routing_system/ipv6/static_ag_ipv6_config/anycast_gateway_mac/ipv6_anycast_gateway_mac (mac-access-list:mac-address-type)
  ...
  def _get_ipv6_anycast_default_mac(self):
    """
    Getter method for ipv6_anycast_default_mac, mapped from YANG variable /routing_system/ipv6/static_ag_ipv6_config/anycast_gateway_mac/ipv6_anycast_default_mac (empty)
  ...
  def _set_ipv6_anycast_default_mac(self, v, load=False):
    """
    Setter method for ipv6_anycast_default_mac, mapped from YANG variable /routing_system/ipv6/static_ag_ipv6_config/anycast_gateway_mac/ipv6_anycast_default_mac (empty)
    If this variable is read-only (config: false) in the
