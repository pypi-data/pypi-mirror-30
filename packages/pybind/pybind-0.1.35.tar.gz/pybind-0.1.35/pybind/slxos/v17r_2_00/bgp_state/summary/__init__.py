...
class summary(PybindBase):
  ...
  from YANG module brocade-bgp-operational - based on the path /bgp-state/summary. Each member element of
  ...
  def _get_evpn(self):
    """
    Getter method for evpn, mapped from YANG variable /bgp_state/summary/evpn (container)
  ...
  def _set_evpn(self, v, load=False):
    """
    Setter method for evpn, mapped from YANG variable /bgp_state/summary/evpn (container)
