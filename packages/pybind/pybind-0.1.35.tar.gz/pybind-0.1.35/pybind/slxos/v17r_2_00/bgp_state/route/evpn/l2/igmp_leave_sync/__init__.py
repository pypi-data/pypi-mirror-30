...
class igmp_leave_sync(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__ipv4_orig_rtrid = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv4-orig-rtrid", rest_name="ipv4-orig-rtrid", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv4-address', is_config=False)
    ...
    self.__ipv6_orig_rtrid = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-orig-rtrid", rest_name="ipv6-orig-rtrid", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv6-address', is_config=False)
    ...
    self.__ipv4_grp_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv4-grp-address", rest_name="ipv4-grp-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv4-address', is_config=False)
    ...
    self.__leave_grp_sync = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="leave-grp-sync", rest_name="leave-grp-sync", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='uint32', is_config=False)
    ...
    self.__ipv4_src_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv4-src-address", rest_name="ipv4-src-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv4-address', is_config=False)
    ...
    self.__ipv6_grp_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-grp-address", rest_name="ipv6-grp-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv6-address', is_config=False)
    ...
    self.__ipv6_src_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-src-address", rest_name="ipv6-src-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv6-address', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp-state', u'route', u'evpn', u'l2', u'igmp-leave-sync']
  ...
  def _get_prefix(self):
    """
    Getter method for prefix, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/prefix (inet:ipv4-prefix)
  ...
  def _set_prefix(self, v, load=False):
    """
    Setter method for prefix, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/prefix (inet:ipv4-prefix)
  ...
  def _get_status(self):
    """
    Getter method for status, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/status (string)
  ...
  def _set_status(self, v, load=False):
    """
    Setter method for status, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/status (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_age(self):
    """
    Getter method for age, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/age (string)
  ...
  def _set_age(self, v, load=False):
    """
    Setter method for age, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/age (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_next_hop(self):
    """
    Getter method for next_hop, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/next_hop (inet:ipv4-address)
  ...
  def _set_next_hop(self, v, load=False):
    """
    Setter method for next_hop, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/next_hop (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_next_hop_learned_from_peer(self):
    """
    Getter method for next_hop_learned_from_peer, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/next_hop_learned_from_peer (string)
  ...
  def _set_next_hop_learned_from_peer(self, v, load=False):
    """
    Setter method for next_hop_learned_from_peer, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/next_hop_learned_from_peer (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_next_hop_metric(self):
    """
    Getter method for next_hop_metric, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/next_hop_metric (uint32)
  ...
  def _set_next_hop_metric(self, v, load=False):
    """
    Setter method for next_hop_metric, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/next_hop_metric (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_rd(self):
    """
    Getter method for rd, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/rd (string)
  ...
  def _set_rd(self, v, load=False):
    """
    Setter method for rd, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/rd (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_vrf_label_direction(self):
    """
    Getter method for vrf_label_direction, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/vrf_label_direction (direction)
  ...
  def _set_vrf_label_direction(self, v, load=False):
    """
    Setter method for vrf_label_direction, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/vrf_label_direction (direction)
    If this variable is read-only (config: false) in the
  ...
  def _get_local_preference(self):
    """
    Getter method for local_preference, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/local_preference (string)
  ...
  def _set_local_preference(self, v, load=False):
    """
    Setter method for local_preference, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/local_preference (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_med(self):
    """
    Getter method for med, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/med (string)
  ...
  def _set_med(self, v, load=False):
    """
    Setter method for med, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/med (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_origin(self):
    """
    Getter method for origin, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/origin (string)
  ...
  def _set_origin(self, v, load=False):
    """
    Setter method for origin, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/origin (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_weight(self):
    """
    Getter method for weight, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/weight (int32)
  ...
  def _set_weight(self, v, load=False):
    """
    Setter method for weight, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/weight (int32)
    If this variable is read-only (config: false) in the
  ...
  def _get_as_path(self):
    """
    Getter method for as_path, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/as_path (string)
  ...
  def _set_as_path(self, v, load=False):
    """
    Setter method for as_path, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/as_path (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_communities(self):
    """
    Getter method for communities, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/communities (string)
  ...
  def _set_communities(self, v, load=False):
    """
    Setter method for communities, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/communities (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_extended_community(self):
    """
    Getter method for extended_community, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/extended_community (string)
  ...
  def _set_extended_community(self, v, load=False):
    """
    Setter method for extended_community, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/extended_community (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_atomic_aggregate_set(self):
    """
    Getter method for atomic_aggregate_set, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/atomic_aggregate_set (boolean)
  ...
  def _set_atomic_aggregate_set(self, v, load=False):
    """
    Setter method for atomic_aggregate_set, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/atomic_aggregate_set (boolean)
    If this variable is read-only (config: false) in the
  ...
  def _get_aggregator(self):
    """
    Getter method for aggregator, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/aggregator (inet:ipv4-address)
  ...
  def _set_aggregator(self, v, load=False):
    """
    Setter method for aggregator, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/aggregator (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_originator(self):
    """
    Getter method for originator, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/originator (inet:ipv4-address)
  ...
  def _set_originator(self, v, load=False):
    """
    Setter method for originator, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/originator (inet:ipv4-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_cluster_list(self):
    """
    Getter method for cluster_list, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/cluster_list (string)
  ...
  def _set_cluster_list(self, v, load=False):
    """
    Setter method for cluster_list, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/cluster_list (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_adj_rib_out_count(self):
    """
    Getter method for adj_rib_out_count, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/adj_rib_out_count (int32)
  ...
  def _set_adj_rib_out_count(self, v, load=False):
    """
    Setter method for adj_rib_out_count, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/adj_rib_out_count (int32)
    If this variable is read-only (config: false) in the
  ...
  def _get_admin_distance(self):
    """
    Getter method for admin_distance, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/admin_distance (int32)
  ...
  def _set_admin_distance(self, v, load=False):
    """
    Setter method for admin_distance, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/admin_distance (int32)
    If this variable is read-only (config: false) in the
  ...
  def _get_tag(self):
    """
    Getter method for tag, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/tag (int32)
  ...
  def _set_tag(self, v, load=False):
    """
    Setter method for tag, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/tag (int32)
    If this variable is read-only (config: false) in the
  ...
  def _get_l3_label(self):
    """
    Getter method for l3_label, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/l3_label (int32)
  ...
  def _set_l3_label(self, v, load=False):
    """
    Setter method for l3_label, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/l3_label (int32)
    If this variable is read-only (config: false) in the
  ...
  def _get_l2_label(self):
    """
    Getter method for l2_label, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/l2_label (int32)
  ...
  def _set_l2_label(self, v, load=False):
    """
    Setter method for l2_label, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/l2_label (int32)
    If this variable is read-only (config: false) in the
  ...
  def _get_esi(self):
    """
    Getter method for esi, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/esi (string)
  ...
  def _set_esi(self, v, load=False):
    """
    Setter method for esi, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/esi (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_rmac(self):
    """
    Getter method for rmac, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/rmac (string)
  ...
  def _set_rmac(self, v, load=False):
    """
    Setter method for rmac, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/rmac (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_source_rd(self):
    """
    Getter method for source_rd, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/source_rd (string)
  ...
  def _set_source_rd(self, v, load=False):
    """
    Setter method for source_rd, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/source_rd (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_vrf_label(self):
    """
    Getter method for vrf_label, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/vrf_label (uint32)
  ...
  def _set_vrf_label(self, v, load=False):
    """
    Setter method for vrf_label, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/vrf_label (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_esi_value(self):
    """
    Getter method for esi_value, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/esi_value (string)
  ...
  def _set_esi_value(self, v, load=False):
    """
    Setter method for esi_value, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/esi_value (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_ethernet_tag(self):
    """
    Getter method for ethernet_tag, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ethernet_tag (uint32)
  ...
  def _set_ethernet_tag(self, v, load=False):
    """
    Setter method for ethernet_tag, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ethernet_tag (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_ipv4_orig_rtrid(self):
    """
    Getter method for ipv4_orig_rtrid, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ipv4_orig_rtrid (inet:ipv4-address)

    YANG Description: IPv4 Orig RtrID
    """
    return self.__ipv4_orig_rtrid
      
  def _set_ipv4_orig_rtrid(self, v, load=False):
    """
    Setter method for ipv4_orig_rtrid, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ipv4_orig_rtrid (inet:ipv4-address)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ipv4_orig_rtrid is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ipv4_orig_rtrid() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv4-orig-rtrid", rest_name="ipv4-orig-rtrid", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv4-address', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ipv4_orig_rtrid must be of a type compatible with inet:ipv4-address""",
          'defined-type': "inet:ipv4-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv4-orig-rtrid", rest_name="ipv4-orig-rtrid", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv4-address', is_config=False)""",
        })

    self.__ipv4_orig_rtrid = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_ipv4_orig_rtrid(self):
    self.__ipv4_orig_rtrid = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv4-orig-rtrid", rest_name="ipv4-orig-rtrid", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv4-address', is_config=False)


  def _get_ipv6_orig_rtrid(self):
    """
    Getter method for ipv6_orig_rtrid, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ipv6_orig_rtrid (inet:ipv6-address)

    YANG Description: IPv6 Orig RtrID
    """
    return self.__ipv6_orig_rtrid
      
  def _set_ipv6_orig_rtrid(self, v, load=False):
    """
    Setter method for ipv6_orig_rtrid, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ipv6_orig_rtrid (inet:ipv6-address)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ipv6_orig_rtrid is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ipv6_orig_rtrid() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-orig-rtrid", rest_name="ipv6-orig-rtrid", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv6-address', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ipv6_orig_rtrid must be of a type compatible with inet:ipv6-address""",
          'defined-type': "inet:ipv6-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-orig-rtrid", rest_name="ipv6-orig-rtrid", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv6-address', is_config=False)""",
        })

    self.__ipv6_orig_rtrid = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_ipv6_orig_rtrid(self):
    self.__ipv6_orig_rtrid = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-orig-rtrid", rest_name="ipv6-orig-rtrid", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv6-address', is_config=False)


  def _get_ipv4_grp_address(self):
    """
    Getter method for ipv4_grp_address, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ipv4_grp_address (inet:ipv4-address)

    YANG Description: IPv4 Grp address
    """
    return self.__ipv4_grp_address
      
  def _set_ipv4_grp_address(self, v, load=False):
    """
    Setter method for ipv4_grp_address, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ipv4_grp_address (inet:ipv4-address)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ipv4_grp_address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ipv4_grp_address() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv4-grp-address", rest_name="ipv4-grp-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv4-address', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ipv4_grp_address must be of a type compatible with inet:ipv4-address""",
          'defined-type': "inet:ipv4-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv4-grp-address", rest_name="ipv4-grp-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv4-address', is_config=False)""",
        })

    self.__ipv4_grp_address = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_ipv4_grp_address(self):
    self.__ipv4_grp_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv4-grp-address", rest_name="ipv4-grp-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv4-address', is_config=False)


  def _get_ipv6_grp_address(self):
    """
    Getter method for ipv6_grp_address, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ipv6_grp_address (inet:ipv6-address)

    YANG Description: IPv6 Grp address
    """
    return self.__ipv6_grp_address
      
  def _set_ipv6_grp_address(self, v, load=False):
    """
    Setter method for ipv6_grp_address, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ipv6_grp_address (inet:ipv6-address)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ipv6_grp_address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ipv6_grp_address() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-grp-address", rest_name="ipv6-grp-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv6-address', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ipv6_grp_address must be of a type compatible with inet:ipv6-address""",
          'defined-type': "inet:ipv6-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-grp-address", rest_name="ipv6-grp-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv6-address', is_config=False)""",
        })

    self.__ipv6_grp_address = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_ipv6_grp_address(self):
    self.__ipv6_grp_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-grp-address", rest_name="ipv6-grp-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv6-address', is_config=False)


  def _get_ipv4_src_address(self):
    """
    Getter method for ipv4_src_address, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ipv4_src_address (inet:ipv4-address)

    YANG Description: IPv4 Src address
    """
    return self.__ipv4_src_address
      
  def _set_ipv4_src_address(self, v, load=False):
    """
    Setter method for ipv4_src_address, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ipv4_src_address (inet:ipv4-address)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ipv4_src_address is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ipv4_src_address() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv4-src-address", rest_name="ipv4-src-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv4-address', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ipv4_src_address must be of a type compatible with inet:ipv4-address""",
          'defined-type': "inet:ipv4-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv4-src-address", rest_name="ipv4-src-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv4-address', is_config=False)""",
        })

    self.__ipv4_src_address = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_ipv4_src_address(self):
    self.__ipv4_src_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv4-src-address", rest_name="ipv4-src-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv4-address', is_config=False)


  def _get_ipv6_src_address(self):
    """
    Getter method for ipv6_src_address, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ipv6_src_address (inet:ipv6-address)

    YANG Description: IPv6 Src address
    """
    return self.__ipv6_src_address
      
  def _set_ipv6_src_address(self, v, load=False):
    """
    Setter method for ipv6_src_address, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/ipv6_src_address (inet:ipv6-address)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-src-address", rest_name="ipv6-src-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv6-address', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ipv6_src_address must be of a type compatible with inet:ipv6-address""",
          'defined-type': "inet:ipv6-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-src-address", rest_name="ipv6-src-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv6-address', is_config=False)""",
        })

    self.__ipv6_src_address = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_ipv6_src_address(self):
    self.__ipv6_src_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-src-address", rest_name="ipv6-src-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='inet:ipv6-address', is_config=False)


  def _get_leave_grp_sync(self):
    """
    Getter method for leave_grp_sync, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/leave_grp_sync (uint32)

    YANG Description: Leave Grp Sync
    """
    return self.__leave_grp_sync
      
  def _set_leave_grp_sync(self, v, load=False):
    """
    Setter method for leave_grp_sync, mapped from YANG variable /bgp_state/route/evpn/l2/igmp_leave_sync/leave_grp_sync (uint32)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="leave-grp-sync", rest_name="leave-grp-sync", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='uint32', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """leave_grp_sync must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="leave-grp-sync", rest_name="leave-grp-sync", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='uint32', is_config=False)""",
        })

    self.__leave_grp_sync = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_leave_grp_sync(self):
    self.__leave_grp_sync = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="leave-grp-sync", rest_name="leave-grp-sync", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='uint32', is_config=False)
  ...
  ipv4_orig_rtrid = __builtin__.property(_get_ipv4_orig_rtrid)
  ipv6_orig_rtrid = __builtin__.property(_get_ipv6_orig_rtrid)
  ipv4_grp_address = __builtin__.property(_get_ipv4_grp_address)
  ipv6_grp_address = __builtin__.property(_get_ipv6_grp_address)
  ipv4_src_address = __builtin__.property(_get_ipv4_src_address)
  ipv6_src_address = __builtin__.property(_get_ipv6_src_address)
  leave_grp_sync = __builtin__.property(_get_leave_grp_sync)


  _pyangbind_elements = {'prefix': prefix, 'status': status, 'age': age, 'next_hop': next_hop, 'next_hop_learned_from_peer': next_hop_learned_from_peer, 'next_hop_metric': next_hop_metric, 'rd': rd, 'vrf_label_direction': vrf_label_direction, 'local_preference': local_preference, 'med': med, 'origin': origin, 'weight': weight, 'as_path': as_path, 'communities': communities, 'extended_community': extended_community, 'atomic_aggregate_set': atomic_aggregate_set, 'aggregator': aggregator, 'originator': originator, 'cluster_list': cluster_list, 'adj_rib_out_count': adj_rib_out_count, 'admin_distance': admin_distance, 'tag': tag, 'l3_label': l3_label, 'l2_label': l2_label, 'esi': esi, 'rmac': rmac, 'source_rd': source_rd, 'vrf_label': vrf_label, 'esi_value': esi_value, 'ethernet_tag': ethernet_tag, 'ipv4_orig_rtrid': ipv4_orig_rtrid, 'ipv6_orig_rtrid': ipv6_orig_rtrid, 'ipv4_grp_address': ipv4_grp_address, 'ipv6_grp_address': ipv6_grp_address, 'ipv4_src_address': ipv4_src_address, 'ipv6_src_address': ipv6_src_address, 'leave_grp_sync': leave_grp_sync, }
