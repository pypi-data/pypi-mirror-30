...
import __builtin__
class msg_sent(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-bgp-operational - based on the path /bgp-state/neighbor/evpn/msg-sent. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'bgp-state', u'neighbor', u'evpn', u'msg-sent']
  ...
  def _get_open(self):
    """
    Getter method for open, mapped from YANG variable /bgp_state/neighbor/evpn/msg_sent/open (uint32)
  ...
  def _set_open(self, v, load=False):
    """
    Setter method for open, mapped from YANG variable /bgp_state/neighbor/evpn/msg_sent/open (uint32)
  ...
  def _get_update(self):
    """
    Getter method for update, mapped from YANG variable /bgp_state/neighbor/evpn/msg_sent/update (uint32)
  ...
  def _set_update(self, v, load=False):
    """
    Setter method for update, mapped from YANG variable /bgp_state/neighbor/evpn/msg_sent/update (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_keepalive(self):
    """
    Getter method for keepalive, mapped from YANG variable /bgp_state/neighbor/evpn/msg_sent/keepalive (uint32)
  ...
  def _set_keepalive(self, v, load=False):
    """
    Setter method for keepalive, mapped from YANG variable /bgp_state/neighbor/evpn/msg_sent/keepalive (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_notification(self):
    """
    Getter method for notification, mapped from YANG variable /bgp_state/neighbor/evpn/msg_sent/notification (uint32)
  ...
  def _set_notification(self, v, load=False):
    """
    Setter method for notification, mapped from YANG variable /bgp_state/neighbor/evpn/msg_sent/notification (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_refresh_req(self):
    """
    Getter method for refresh_req, mapped from YANG variable /bgp_state/neighbor/evpn/msg_sent/refresh_req (uint32)
  ...
  def _set_refresh_req(self, v, load=False):
    """
    Setter method for refresh_req, mapped from YANG variable /bgp_state/neighbor/evpn/msg_sent/refresh_req (uint32)
    If this variable is read-only (config: false) in the
