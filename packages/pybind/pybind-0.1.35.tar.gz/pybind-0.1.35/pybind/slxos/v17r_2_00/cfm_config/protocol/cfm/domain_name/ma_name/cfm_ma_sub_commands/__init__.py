...
class cfm_ma_sub_commands(PybindBase):
  ...
  from YANG module brocade-dot1ag - based on the path /cfm-config/protocol/cfm/domain-name/ma-name/cfm-ma-sub-commands. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'cfm-config', u'protocol', u'cfm', u'domain-name', u'ma-name', u'cfm-ma-sub-commands']
  ...
  def _get_ccm_interval(self):
    """
    Getter method for ccm_interval, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/ccm_interval (ccm-interval-type)
    """
    return self.__ccm_interval
      
  def _set_ccm_interval(self, v, load=False):
    """
    Setter method for ccm_interval, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/ccm_interval (ccm-interval-type)
  ...
  def _get_mip_policy(self):
    """
    Getter method for mip_policy, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mip_policy (mip-policy-type)
    """
    return self.__mip_policy
      
  def _set_mip_policy(self, v, load=False):
    """
    Setter method for mip_policy, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mip_policy (mip-policy-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_maid_format(self):
    """
    Getter method for maid_format, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/maid_format (maid-format-type)
    """
    return self.__maid_format
      
  def _set_maid_format(self, v, load=False):
    """
    Setter method for maid_format, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/maid_format (maid-format-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_mep(self):
    """
    Getter method for mep, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep (list)
    """
    return self.__mep
      
  def _set_mep(self, v, load=False):
    """
    Setter method for mep, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep (list)
    If this variable is read-only (config: false) in the
