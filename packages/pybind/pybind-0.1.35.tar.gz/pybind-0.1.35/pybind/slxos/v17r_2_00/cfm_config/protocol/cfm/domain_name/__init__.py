...
class domain_name(PybindBase):
  ...
  from YANG module brocade-dot1ag - based on the path /cfm-config/protocol/cfm/domain-name. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__domain_name','__domain_id','__domain_level','__ma_name',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__domain_id = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..4090']}), is_leaf=True, yang_name="domain-id", rest_name="id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Maintanance Domain Index', u'cli-run-template': u'$(.?:)', u'alt-name': u'id', u'cli-incomplete-command': None, u'cli-hide-in-submode': None}}, namespace='urn:brocade.com:mgmt:brocade-dot1ag', defining_module='brocade-dot1ag', yang_type='uint32', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'cfm-config', u'protocol', u'cfm', u'domain-name']
  ...
  def _get_domain_name(self):
    """
    Getter method for domain_name, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/domain_name (string)
    """
    return self.__domain_name
      
  def _set_domain_name(self, v, load=False):
    """
    Setter method for domain_name, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/domain_name (string)
  ...
  def _get_domain_id(self):
    """
    Getter method for domain_id, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/domain_id (uint32)
    """
    return self.__domain_id
      
  def _set_domain_id(self, v, load=False):
    """
    Setter method for domain_id, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/domain_id (uint32)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..4090']}), is_leaf=True, yang_name="domain-id", rest_name="id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Maintanance Domain Index', u'cli-run-template': u'$(.?:)', u'alt-name': u'id', u'cli-incomplete-command': None, u'cli-hide-in-submode': None}}, namespace='urn:brocade.com:mgmt:brocade-dot1ag', defining_module='brocade-dot1ag', yang_type='uint32', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """domain_id must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..4090']}), is_leaf=True, yang_name="domain-id", rest_name="id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure Maintanance Domain Index', u'cli-run-template': u'$(.?:)', u'alt-name': u'id', u'cli-incomplete-command': None, u'cli-hide-in-submode': None}}, namespace='urn:brocade.com:mgmt:brocade-dot1ag', defining_module='brocade-dot1ag', yang_type='uint32', is_config=True)""",
        })
  ...
  def _get_domain_level(self):
    """
    Getter method for domain_level, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/domain_level (uint32)
    """
    return self.__domain_level
      
  def _set_domain_level(self, v, load=False):
    """
    Setter method for domain_level, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/domain_level (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_ma_name(self):
    """
    Getter method for ma_name, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name (list)
    """
    return self.__ma_name
      
  def _set_ma_name(self, v, load=False):
    """
    Setter method for ma_name, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name (list)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'domain_name': domain_name, 'domain_id': domain_id, 'domain_level': domain_level, 'ma_name': ma_name, }
