...
class test_profile(PybindBase):
  ...
  from YANG module brocade-dot1ag - based on the path /cfm-config/protocol/cfm/y1731/test-profile. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'cfm-config', u'protocol', u'cfm', u'y1731', u'test-profile']
  ...
  def _get_test_profile(self):
    """
    Getter method for test_profile, mapped from YANG variable /cfm_config/protocol/cfm/y1731/test_profile/test_profile (string)
    """
    return self.__test_profile
      
  def _set_test_profile(self, v, load=False):
    """
    Setter method for test_profile, mapped from YANG variable /cfm_config/protocol/cfm/y1731/test_profile/test_profile (string)
  ...
  def _get_profile_type(self):
    """
    Getter method for profile_type, mapped from YANG variable /cfm_config/protocol/cfm/y1731/test_profile/profile_type (y1731-profile-type)
    """
    return self.__profile_type
      
  def _set_profile_type(self, v, load=False):
    """
    Setter method for profile_type, mapped from YANG variable /cfm_config/protocol/cfm/y1731/test_profile/profile_type (y1731-profile-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_test_profile_params(self):
    """
    Getter method for test_profile_params, mapped from YANG variable /cfm_config/protocol/cfm/y1731/test_profile/test_profile_params (container)
    """
    return self.__test_profile_params
      
  def _set_test_profile_params(self, v, load=False):
    """
    Setter method for test_profile_params, mapped from YANG variable /cfm_config/protocol/cfm/y1731/test_profile/test_profile_params (container)
    If this variable is read-only (config: false) in the
