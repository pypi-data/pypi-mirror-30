...
class slm_threshold(PybindBase):
  ...
  from YANG module brocade-dot1ag - based on the path /cfm-config/protocol/cfm/y1731/test-profile/test-profile-params/slm-threshold. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'cfm-config', u'protocol', u'cfm', u'y1731', u'test-profile', u'test-profile-params', u'slm-threshold']
  ...
  def _get_forward(self):
    """
    Getter method for forward, mapped from YANG variable /cfm_config/protocol/cfm/y1731/test_profile/test_profile_params/slm_threshold/forward (container)
    """
    return self.__forward
      
  def _set_forward(self, v, load=False):
    """
    Setter method for forward, mapped from YANG variable /cfm_config/protocol/cfm/y1731/test_profile/test_profile_params/slm_threshold/forward (container)
  ...
  def _get_backward(self):
    """
    Getter method for backward, mapped from YANG variable /cfm_config/protocol/cfm/y1731/test_profile/test_profile_params/slm_threshold/backward (container)
    """
    return self.__backward
      
  def _set_backward(self, v, load=False):
    """
    Setter method for backward, mapped from YANG variable /cfm_config/protocol/cfm/y1731/test_profile/test_profile_params/slm_threshold/backward (container)
    If this variable is read-only (config: false) in the
