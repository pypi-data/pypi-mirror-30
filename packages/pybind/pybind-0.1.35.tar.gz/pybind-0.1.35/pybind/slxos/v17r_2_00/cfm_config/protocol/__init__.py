...
class protocol(PybindBase):
  ...
  from YANG module brocade-dot1ag - based on the path /cfm-config/protocol. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__cfm',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'cfm-config', u'protocol']
  ...
  def _get_cfm(self):
    """
    Getter method for cfm, mapped from YANG variable /cfm_config/protocol/cfm (container)
    """
    return self.__cfm
      
  def _set_cfm(self, v, load=False):
    """
    Setter method for cfm, mapped from YANG variable /cfm_config/protocol/cfm (container)
