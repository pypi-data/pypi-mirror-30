...
class max_threshold(PybindBase):
  ...
  from YANG module brocade-dot1ag - based on the path /cfm-config/protocol/cfm/y1731/action-profile-name/event/max-threshold. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'cfm-config', u'protocol', u'cfm', u'y1731', u'action-profile-name', u'event', u'max-threshold']
  ...
  def _get_max_threshold_actions(self):
    """
    Getter method for max_threshold_actions, mapped from YANG variable /cfm_config/protocol/cfm/y1731/action_profile_name/event/max_threshold/max_threshold_actions (action-profile-bitmap)
    """
    return self.__max_threshold_actions
      
  def _set_max_threshold_actions(self, v, load=False):
    """
    Setter method for max_threshold_actions, mapped from YANG variable /cfm_config/protocol/cfm/y1731/action_profile_name/event/max_threshold/max_threshold_actions (action-profile-bitmap)
