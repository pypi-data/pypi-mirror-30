...
class mep(PybindBase):
  ...
  from YANG module brocade-dot1ag - based on the path /cfm-config/protocol/cfm/domain-name/ma-name/cfm-ma-sub-commands/mep. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'cfm-config', u'protocol', u'cfm', u'domain-name', u'ma-name', u'cfm-ma-sub-commands', u'mep']
  ...
  def _get_mep_id(self):
    """
    Getter method for mep_id, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/mep_id (uint32)
    """
    return self.__mep_id
      
  def _set_mep_id(self, v, load=False):
    """
    Setter method for mep_id, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/mep_id (uint32)
  ...
  def _get_mep_down_up(self):
    """
    Getter method for mep_down_up, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/mep_down_up (mep-down-up-type)
    """
    return self.__mep_down_up
      
  def _set_mep_down_up(self, v, load=False):
    """
    Setter method for mep_down_up, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/mep_down_up (mep-down-up-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/vlan (uint32)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/vlan (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_inner_vlan(self):
    """
    Getter method for inner_vlan, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/inner_vlan (uint32)
    """
    return self.__inner_vlan
      
  def _set_inner_vlan(self, v, load=False):
    """
    Setter method for inner_vlan, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/inner_vlan (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_mep_intf_type(self):
    """
    Getter method for mep_intf_type, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/mep_intf_type (dot1ag-interface-type)
    """
    return self.__mep_intf_type
      
  def _set_mep_intf_type(self, v, load=False):
    """
    Setter method for mep_intf_type, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/mep_intf_type (dot1ag-interface-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_mep_intf_name(self):
    """
    Getter method for mep_intf_name, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/mep_intf_name (dot1ag-interface-name)
    """
    return self.__mep_intf_name
      
  def _set_mep_intf_name(self, v, load=False):
    """
    Setter method for mep_intf_name, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/mep_intf_name (dot1ag-interface-name)
    If this variable is read-only (config: false) in the
  ...
  def _get_cfm_mep_sub_commands(self):
    """
    Getter method for cfm_mep_sub_commands, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/cfm_mep_sub_commands (container)
    """
    return self.__cfm_mep_sub_commands
      
  def _set_cfm_mep_sub_commands(self, v, load=False):
    """
    Setter method for cfm_mep_sub_commands, mapped from YANG variable /cfm_config/protocol/cfm/domain_name/ma_name/cfm_ma_sub_commands/mep/cfm_mep_sub_commands (container)
    If this variable is read-only (config: false) in the
