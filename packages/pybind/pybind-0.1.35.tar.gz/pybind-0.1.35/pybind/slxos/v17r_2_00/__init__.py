...
import keychain
class brocade_keychain(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-keychain - based on the path /brocade-keychain. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: Data Model for Keychain CLIs
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__keychain',)

  _yang_name = 'brocade-keychain'
  _rest_name = ''
  ...
  _pyangbind_elements = {'keychain': keychain, }
...
import igmp_multicast_snooping_bridge_domains_state
import igmp_snooping_bridge_domain_mrouters_state
import igmp_snooping_bridge_domains_state
class brocade_mc_hms_operational(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__igmp_snooping_state','__igmp_multicast_snooping_bridge_domains_state','__igmp_snooping_bridge_domain_mrouters_state','__igmp_snooping_bridge_domains_state',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__igmp_snooping_bridge_domain_mrouters_state = YANGDynClass(base=YANGListType("bd_id",igmp_snooping_bridge_domain_mrouters_state.igmp_snooping_bridge_domain_mrouters_state, yang_name="igmp-snooping-bridge-domain-mrouters-state", rest_name="igmp-snooping-bridge-domain-mrouters-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-snooping-bridge-domain-mrouters', u'cli-suppress-show-path': None}}), is_container='list', yang_name="igmp-snooping-bridge-domain-mrouters-state", rest_name="igmp-snooping-bridge-domain-mrouters-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-snooping-bridge-domain-mrouters', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=True)
    self.__igmp_multicast_snooping_bridge_domains_state = YANGDynClass(base=YANGListType("bd_id",igmp_multicast_snooping_bridge_domains_state.igmp_multicast_snooping_bridge_domains_state, yang_name="igmp-multicast-snooping-bridge-domains-state", rest_name="igmp-multicast-snooping-bridge-domains-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-multicast-snooping-bridge-domains', u'cli-suppress-show-path': None}}), is_container='list', yang_name="igmp-multicast-snooping-bridge-domains-state", rest_name="igmp-multicast-snooping-bridge-domains-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-multicast-snooping-bridge-domains', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=True)
    ...
    self.__igmp_snooping_bridge_domains_state = YANGDynClass(base=YANGListType("bd_id",igmp_snooping_bridge_domains_state.igmp_snooping_bridge_domains_state, yang_name="igmp-snooping-bridge-domains-state", rest_name="igmp-snooping-bridge-domains-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-snooping-bridge-domains', u'cli-suppress-show-path': None}}), is_container='list', yang_name="igmp-snooping-bridge-domains-state", rest_name="igmp-snooping-bridge-domains-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-snooping-bridge-domains', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=True)
  ...
  def _get_igmp_multicast_snooping_bridge_domains_state(self):
    """
    Getter method for igmp_multicast_snooping_bridge_domains_state, mapped from YANG variable /igmp_multicast_snooping_bridge_domains_state (list)

    YANG Description: Multicast snooping bridge domain
    """
    return self.__igmp_multicast_snooping_bridge_domains_state
      
  def _set_igmp_multicast_snooping_bridge_domains_state(self, v, load=False):
    """
    Setter method for igmp_multicast_snooping_bridge_domains_state, mapped from YANG variable /igmp_multicast_snooping_bridge_domains_state (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_igmp_multicast_snooping_bridge_domains_state is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_igmp_multicast_snooping_bridge_domains_state() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """igmp_multicast_snooping_bridge_domains_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("bd_id",igmp_multicast_snooping_bridge_domains_state.igmp_multicast_snooping_bridge_domains_state, yang_name="igmp-multicast-snooping-bridge-domains-state", rest_name="igmp-multicast-snooping-bridge-domains-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-multicast-snooping-bridge-domains', u'cli-suppress-show-path': None}}), is_container='list', yang_name="igmp-multicast-snooping-bridge-domains-state", rest_name="igmp-multicast-snooping-bridge-domains-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-multicast-snooping-bridge-domains', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=True)""",
        })

    self.__igmp_multicast_snooping_bridge_domains_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_igmp_multicast_snooping_bridge_domains_state(self):
    self.__igmp_multicast_snooping_bridge_domains_state = YANGDynClass(base=YANGListType("bd_id",igmp_multicast_snooping_bridge_domains_state.igmp_multicast_snooping_bridge_domains_state, yang_name="igmp-multicast-snooping-bridge-domains-state", rest_name="igmp-multicast-snooping-bridge-domains-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-multicast-snooping-bridge-domains', u'cli-suppress-show-path': None}}), is_container='list', yang_name="igmp-multicast-snooping-bridge-domains-state", rest_name="igmp-multicast-snooping-bridge-domains-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-multicast-snooping-bridge-domains', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=True)


  def _get_igmp_snooping_bridge_domain_mrouters_state(self):
    """
    Getter method for igmp_snooping_bridge_domain_mrouters_state, mapped from YANG variable /igmp_snooping_bridge_domain_mrouters_state (list)

    YANG Description: Igmp snoopig mrouters
    """
    return self.__igmp_snooping_bridge_domain_mrouters_state
      
  def _set_igmp_snooping_bridge_domain_mrouters_state(self, v, load=False):
    """
    Setter method for igmp_snooping_bridge_domain_mrouters_state, mapped from YANG variable /igmp_snooping_bridge_domain_mrouters_state (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_igmp_snooping_bridge_domain_mrouters_state is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_igmp_snooping_bridge_domain_mrouters_state() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """igmp_snooping_bridge_domain_mrouters_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("bd_id",igmp_snooping_bridge_domain_mrouters_state.igmp_snooping_bridge_domain_mrouters_state, yang_name="igmp-snooping-bridge-domain-mrouters-state", rest_name="igmp-snooping-bridge-domain-mrouters-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-snooping-bridge-domain-mrouters', u'cli-suppress-show-path': None}}), is_container='list', yang_name="igmp-snooping-bridge-domain-mrouters-state", rest_name="igmp-snooping-bridge-domain-mrouters-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-snooping-bridge-domain-mrouters', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=True)""",
        })

    self.__igmp_snooping_bridge_domain_mrouters_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_igmp_snooping_bridge_domain_mrouters_state(self):
    self.__igmp_snooping_bridge_domain_mrouters_state = YANGDynClass(base=YANGListType("bd_id",igmp_snooping_bridge_domain_mrouters_state.igmp_snooping_bridge_domain_mrouters_state, yang_name="igmp-snooping-bridge-domain-mrouters-state", rest_name="igmp-snooping-bridge-domain-mrouters-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-snooping-bridge-domain-mrouters', u'cli-suppress-show-path': None}}), is_container='list', yang_name="igmp-snooping-bridge-domain-mrouters-state", rest_name="igmp-snooping-bridge-domain-mrouters-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-snooping-bridge-domain-mrouters', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=True)


  def _get_igmp_snooping_bridge_domains_state(self):
    """
    Getter method for igmp_snooping_bridge_domains_state, mapped from YANG variable /igmp_snooping_bridge_domains_state (list)

    YANG Description: Igmp snooping enabled interface List
    """
    return self.__igmp_snooping_bridge_domains_state
      
  def _set_igmp_snooping_bridge_domains_state(self, v, load=False):
    """
    Setter method for igmp_snooping_bridge_domains_state, mapped from YANG variable /igmp_snooping_bridge_domains_state (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_igmp_snooping_bridge_domains_state is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_igmp_snooping_bridge_domains_state() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """igmp_snooping_bridge_domains_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("bd_id",igmp_snooping_bridge_domains_state.igmp_snooping_bridge_domains_state, yang_name="igmp-snooping-bridge-domains-state", rest_name="igmp-snooping-bridge-domains-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-snooping-bridge-domains', u'cli-suppress-show-path': None}}), is_container='list', yang_name="igmp-snooping-bridge-domains-state", rest_name="igmp-snooping-bridge-domains-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-snooping-bridge-domains', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=True)""",
        })

    self.__igmp_snooping_bridge_domains_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_igmp_snooping_bridge_domains_state(self):
    self.__igmp_snooping_bridge_domains_state = YANGDynClass(base=YANGListType("bd_id",igmp_snooping_bridge_domains_state.igmp_snooping_bridge_domains_state, yang_name="igmp-snooping-bridge-domains-state", rest_name="igmp-snooping-bridge-domains-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='bd-id', extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-snooping-bridge-domains', u'cli-suppress-show-path': None}}), is_container='list', yang_name="igmp-snooping-bridge-domains-state", rest_name="igmp-snooping-bridge-domains-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mc-hms-igmp-snooping-bridge-domains', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mc-hms-operational', defining_module='brocade-mc-hms-operational', yang_type='list', is_config=True)

  igmp_snooping_state = __builtin__.property(_get_igmp_snooping_state, _set_igmp_snooping_state)
  igmp_multicast_snooping_bridge_domains_state = __builtin__.property(_get_igmp_multicast_snooping_bridge_domains_state, _set_igmp_multicast_snooping_bridge_domains_state)
  igmp_snooping_bridge_domain_mrouters_state = __builtin__.property(_get_igmp_snooping_bridge_domain_mrouters_state, _set_igmp_snooping_bridge_domain_mrouters_state)
  igmp_snooping_bridge_domains_state = __builtin__.property(_get_igmp_snooping_bridge_domains_state, _set_igmp_snooping_bridge_domains_state)


  _pyangbind_elements = {'igmp_snooping_state': igmp_snooping_state, 'igmp_multicast_snooping_bridge_domains_state': igmp_multicast_snooping_bridge_domains_state, 'igmp_snooping_bridge_domain_mrouters_state': igmp_snooping_bridge_domain_mrouters_state, 'igmp_snooping_bridge_domains_state': igmp_snooping_bridge_domains_state, }
...
CFM Protocol.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__cfm_config',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__cfm_config = YANGDynClass(base=cfm_config.cfm_config, is_container='container', presence=False, yang_name="cfm-config", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'sort-priority': u'152'}}, namespace='urn:brocade.com:mgmt:brocade-dot1ag', defining_module='brocade-dot1ag', yang_type='container', is_config=True)
  ...
  def _get_cfm_config(self):
    """
    Getter method for cfm_config, mapped from YANG variable /cfm_config (container)
    """
    return self.__cfm_config
  ...
  def _unset_cfm_config(self):
    self.__cfm_config = YANGDynClass(base=cfm_config.cfm_config, is_container='container', presence=False, yang_name="cfm-config", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'sort-priority': u'152'}}, namespace='urn:brocade.com:mgmt:brocade-dot1ag', defining_module='brocade-dot1ag', yang_type='container', is_config=True)

  cfm_config = __builtin__.property(_get_cfm_config, _set_cfm_config)


  _pyangbind_elements = {'cfm_config': cfm_config, }
...
import queues_state
import statistics_protocol_state
class brocade_openflow_operational(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__openflow_state','__queues_state','__statistics_protocol_state',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__statistics_protocol_state = YANGDynClass(base=YANGListType("connection_name",statistics_protocol_state.statistics_protocol_state, yang_name="statistics-protocol-state", rest_name="statistics-protocol-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='connection-name', extensions={u'tailf-common': {u'callpoint': u'openflow-statistics-protocol', u'cli-suppress-show-path': None}}), is_container='list', yang_name="statistics-protocol-state", rest_name="statistics-protocol-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'openflow-statistics-protocol', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='list', is_config=True)
  ...
  def _get_statistics_protocol_state(self):
    """
    Getter method for statistics_protocol_state, mapped from YANG variable /statistics_protocol_state (list)

    YANG Description: statistics protocol information
    """
    return self.__statistics_protocol_state
      
  def _set_statistics_protocol_state(self, v, load=False):
    """
    Setter method for statistics_protocol_state, mapped from YANG variable /statistics_protocol_state (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_statistics_protocol_state is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_statistics_protocol_state() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """statistics_protocol_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("connection_name",statistics_protocol_state.statistics_protocol_state, yang_name="statistics-protocol-state", rest_name="statistics-protocol-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='connection-name', extensions={u'tailf-common': {u'callpoint': u'openflow-statistics-protocol', u'cli-suppress-show-path': None}}), is_container='list', yang_name="statistics-protocol-state", rest_name="statistics-protocol-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'openflow-statistics-protocol', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='list', is_config=True)""",
        })

    self.__statistics_protocol_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_statistics_protocol_state(self):
    self.__statistics_protocol_state = YANGDynClass(base=YANGListType("connection_name",statistics_protocol_state.statistics_protocol_state, yang_name="statistics-protocol-state", rest_name="statistics-protocol-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='connection-name', extensions={u'tailf-common': {u'callpoint': u'openflow-statistics-protocol', u'cli-suppress-show-path': None}}), is_container='list', yang_name="statistics-protocol-state", rest_name="statistics-protocol-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'openflow-statistics-protocol', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-openflow-operational', defining_module='brocade-openflow-operational', yang_type='list', is_config=True)
  ...
  statistics_protocol_state = __builtin__.property(_get_statistics_protocol_state, _set_statistics_protocol_state)


  _pyangbind_elements = {'openflow_state': openflow_state, 'queues_state': queues_state, 'statistics_protocol_state': statistics_protocol_state, }
...
import show_cluster_client_state_state
import show_cluster_mem_bd_mct_state
import show_cluster_mem_vlan_mct_state
class brocade_mct_operational(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__show_client_id_df_info_state','__show_cluster_client_state_state','__show_cluster_mem_bd_mct_state','__show_cluster_mem_vlan_mct_state',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__show_cluster_client_state_state = YANGDynClass(base=YANGListType("cluster_id",show_cluster_client_state_state.show_cluster_client_state_state, yang_name="show-cluster-client-state-state", rest_name="show-cluster-client-state-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id', extensions={u'tailf-common': {u'callpoint': u'mct-show-cluster-client-state', u'cli-suppress-show-path': None}}), is_container='list', yang_name="show-cluster-client-state-state", rest_name="show-cluster-client-state-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mct-show-cluster-client-state', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mct-operational', defining_module='brocade-mct-operational', yang_type='list', is_config=True)
    self.__show_cluster_mem_vlan_mct_state = YANGDynClass(base=YANGListType("cluster_id",show_cluster_mem_vlan_mct_state.show_cluster_mem_vlan_mct_state, yang_name="show-cluster-mem-vlan-mct-state", rest_name="show-cluster-mem-vlan-mct-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id', extensions={u'tailf-common': {u'callpoint': u'mct-show-cluster-mem-vlan-mct', u'cli-suppress-show-path': None}}), is_container='list', yang_name="show-cluster-mem-vlan-mct-state", rest_name="show-cluster-mem-vlan-mct-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mct-show-cluster-mem-vlan-mct', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mct-operational', defining_module='brocade-mct-operational', yang_type='list', is_config=True)
  ...
  def _get_show_cluster_client_state_state(self):
    """
    Getter method for show_cluster_client_state_state, mapped from YANG variable /show_cluster_client_state_state (list)

    YANG Description: MCT cluster client states
    """
    return self.__show_cluster_client_state_state
      
  def _set_show_cluster_client_state_state(self, v, load=False):
    """
    Setter method for show_cluster_client_state_state, mapped from YANG variable /show_cluster_client_state_state (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_show_cluster_client_state_state is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_show_cluster_client_state_state() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """show_cluster_client_state_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("cluster_id",show_cluster_client_state_state.show_cluster_client_state_state, yang_name="show-cluster-client-state-state", rest_name="show-cluster-client-state-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id', extensions={u'tailf-common': {u'callpoint': u'mct-show-cluster-client-state', u'cli-suppress-show-path': None}}), is_container='list', yang_name="show-cluster-client-state-state", rest_name="show-cluster-client-state-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mct-show-cluster-client-state', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mct-operational', defining_module='brocade-mct-operational', yang_type='list', is_config=True)""",
        })

    self.__show_cluster_client_state_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_show_cluster_client_state_state(self):
    self.__show_cluster_client_state_state = YANGDynClass(base=YANGListType("cluster_id",show_cluster_client_state_state.show_cluster_client_state_state, yang_name="show-cluster-client-state-state", rest_name="show-cluster-client-state-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id', extensions={u'tailf-common': {u'callpoint': u'mct-show-cluster-client-state', u'cli-suppress-show-path': None}}), is_container='list', yang_name="show-cluster-client-state-state", rest_name="show-cluster-client-state-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mct-show-cluster-client-state', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mct-operational', defining_module='brocade-mct-operational', yang_type='list', is_config=True)
  ...
  def _get_show_cluster_mem_vlan_mct_state(self):
    """
    Getter method for show_cluster_mem_vlan_mct_state, mapped from YANG variable /show_cluster_mem_vlan_mct_state (list)

    YANG Description: Vlan Label Info for show cluster mem-vlan
    """
    return self.__show_cluster_mem_vlan_mct_state
      
  def _set_show_cluster_mem_vlan_mct_state(self, v, load=False):
    """
    Setter method for show_cluster_mem_vlan_mct_state, mapped from YANG variable /show_cluster_mem_vlan_mct_state (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_show_cluster_mem_vlan_mct_state is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_show_cluster_mem_vlan_mct_state() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """show_cluster_mem_vlan_mct_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("cluster_id",show_cluster_mem_vlan_mct_state.show_cluster_mem_vlan_mct_state, yang_name="show-cluster-mem-vlan-mct-state", rest_name="show-cluster-mem-vlan-mct-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id', extensions={u'tailf-common': {u'callpoint': u'mct-show-cluster-mem-vlan-mct', u'cli-suppress-show-path': None}}), is_container='list', yang_name="show-cluster-mem-vlan-mct-state", rest_name="show-cluster-mem-vlan-mct-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mct-show-cluster-mem-vlan-mct', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mct-operational', defining_module='brocade-mct-operational', yang_type='list', is_config=True)""",
        })

    self.__show_cluster_mem_vlan_mct_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_show_cluster_mem_vlan_mct_state(self):
    self.__show_cluster_mem_vlan_mct_state = YANGDynClass(base=YANGListType("cluster_id",show_cluster_mem_vlan_mct_state.show_cluster_mem_vlan_mct_state, yang_name="show-cluster-mem-vlan-mct-state", rest_name="show-cluster-mem-vlan-mct-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id', extensions={u'tailf-common': {u'callpoint': u'mct-show-cluster-mem-vlan-mct', u'cli-suppress-show-path': None}}), is_container='list', yang_name="show-cluster-mem-vlan-mct-state", rest_name="show-cluster-mem-vlan-mct-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mct-show-cluster-mem-vlan-mct', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mct-operational', defining_module='brocade-mct-operational', yang_type='list', is_config=True)

  show_client_id_df_info_state = __builtin__.property(_get_show_client_id_df_info_state, _set_show_client_id_df_info_state)
  show_cluster_client_state_state = __builtin__.property(_get_show_cluster_client_state_state, _set_show_cluster_client_state_state)
  show_cluster_mem_bd_mct_state = __builtin__.property(_get_show_cluster_mem_bd_mct_state, _set_show_cluster_mem_bd_mct_state)
  show_cluster_mem_vlan_mct_state = __builtin__.property(_get_show_cluster_mem_vlan_mct_state, _set_show_cluster_mem_vlan_mct_state)


  _pyangbind_elements = {'show_client_id_df_info_state': show_client_id_df_info_state, 'show_cluster_client_state_state': show_cluster_client_state_state, 'show_cluster_mem_bd_mct_state': show_cluster_mem_bd_mct_state, 'show_cluster_mem_vlan_mct_state': show_cluster_mem_vlan_mct_state, }
...
import bgp_state
class brocade_bgp_operational(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-bgp-operational - based on the path /brocade-bgp-operational. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: This management module is an instrumentation to manage bgp
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__bgp_state',)

  _yang_name = 'brocade-bgp-operational'
  _rest_name = ''
  ...
  def _get_bgp_state(self):
    """
    Getter method for bgp_state, mapped from YANG variable /bgp_state (container)
  ...
  def _set_bgp_state(self, v, load=False):
    """
    Setter method for bgp_state, mapped from YANG variable /bgp_state (container)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=bgp_state.bgp_state, is_container='container', presence=False, yang_name="bgp-state", rest_name="bgp-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'bgp-bgp', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """bgp_state must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=bgp_state.bgp_state, is_container='container', presence=False, yang_name="bgp-state", rest_name="bgp-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'bgp-bgp', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-bgp-operational', defining_module='brocade-bgp-operational', yang_type='container', is_config=True)""",
        })
  ...
  bgp_state = __builtin__.property(_get_bgp_state, _set_bgp_state)


  _pyangbind_elements = {'bgp_state': bgp_state, }
...
class brocade_mpls_operational(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__mpls_state','__tunnel_status_state',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__tunnel_status_state = YANGDynClass(base=YANGListType("tunnel_destination",tunnel_status_state.tunnel_status_state, yang_name="tunnel-status-state", rest_name="tunnel-status-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='tunnel-destination', extensions={u'tailf-common': {u'callpoint': u'mpls-tunnel-status', u'cli-suppress-show-path': None}}), is_container='list', yang_name="tunnel-status-state", rest_name="tunnel-status-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mpls-tunnel-status', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=True)
  ...
  def _get_tunnel_status_state(self):
    """
    Getter method for tunnel_status_state, mapped from YANG variable /tunnel_status_state (list)

    YANG Description: MPLS Tunnel Status
    """
    return self.__tunnel_status_state
      
  def _set_tunnel_status_state(self, v, load=False):
    """
    Setter method for tunnel_status_state, mapped from YANG variable /tunnel_status_state (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_tunnel_status_state is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_tunnel_status_state() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """tunnel_status_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("tunnel_destination",tunnel_status_state.tunnel_status_state, yang_name="tunnel-status-state", rest_name="tunnel-status-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='tunnel-destination', extensions={u'tailf-common': {u'callpoint': u'mpls-tunnel-status', u'cli-suppress-show-path': None}}), is_container='list', yang_name="tunnel-status-state", rest_name="tunnel-status-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mpls-tunnel-status', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=True)""",
        })

    self.__tunnel_status_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_tunnel_status_state(self):
    self.__tunnel_status_state = YANGDynClass(base=YANGListType("tunnel_destination",tunnel_status_state.tunnel_status_state, yang_name="tunnel-status-state", rest_name="tunnel-status-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='tunnel-destination', extensions={u'tailf-common': {u'callpoint': u'mpls-tunnel-status', u'cli-suppress-show-path': None}}), is_container='list', yang_name="tunnel-status-state", rest_name="tunnel-status-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'mpls-tunnel-status', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-mpls-operational', defining_module='brocade-mpls-operational', yang_type='list', is_config=True)

  mpls_state = __builtin__.property(_get_mpls_state, _set_mpls_state)
  tunnel_status_state = __builtin__.property(_get_tunnel_status_state, _set_tunnel_status_state)


  _pyangbind_elements = {'mpls_state': mpls_state, 'tunnel_status_state': tunnel_status_state, }
...
class brocade_sysdiag_operational(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__hw_state','__tm_state','__cpu_interface_state',)
  ...
  def _get_hw_state(self):
    """
    Getter method for hw_state, mapped from YANG variable /hw_state (container)

    YANG Description: HW Route Info
    """
    return self.__hw_state
  ...
  hw_state = __builtin__.property(_get_hw_state, _set_hw_state)
  ...
  _pyangbind_elements = {'hw_state': hw_state, 'tm_state': tm_state, 'cpu_interface_state': cpu_interface_state, }
...
class brocade_l2sys_operational(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__bd_mac_br_state','__bridge_domain_mac_state',)
  ...
  _pyangbind_elements = {'bd_mac_br_state': bd_mac_br_state, 'bridge_domain_mac_state': bridge_domain_mac_state, }
...
class brocade_sec_services(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__telnet_sa = YANGDynClass(base=telnet_sa.telnet_sa, is_container='container', presence=False, yang_name="telnet-sa", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'display-when': u'/vcsmode/vcs-mode = "false"', u'sort-priority': u'3'}}, namespace='urn:brocade.com:mgmt:brocade-sec-services', defining_module='brocade-sec-services', yang_type='container', is_config=True)
    self.__ssh_sa = YANGDynClass(base=ssh_sa.ssh_sa, is_container='container', presence=False, yang_name="ssh-sa", rest_name="", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'display-when': u'/vcsmode/vcs-mode = "false"', u'sort-priority': u'2'}}, namespace='urn:brocade.com:mgmt:brocade-sec-services', defining_module='brocade-sec-services', yang_type='container', is_config=True)
...
import uda
import uda_key
class brocade_uda_access_list(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-uda-access-list - based on the path /brocade-uda-access-list. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: This management sub-module contains the configuration
implementaion for UDA Access-list.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__uda','__uda_key',)

  _yang_name = 'brocade-uda-access-list'
  _rest_name = ''
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__uda_key = YANGDynClass(base=uda_key.uda_key, is_container='container', presence=False, yang_name="uda-key", rest_name="uda-key", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'UDA key', u'cli-incomplete-no': None, u'sort-priority': u'53'}}, namespace='urn:brocade.com:mgmt:brocade-uda-access-list', defining_module='brocade-uda-access-list', yang_type='container', is_config=True)
    self.__uda = YANGDynClass(base=uda.uda, is_container='container', presence=False, yang_name="uda", rest_name="uda", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'UDA access list', u'cli-incomplete-no': None, u'sort-priority': u'53'}}, namespace='urn:brocade.com:mgmt:brocade-uda-access-list', defining_module='brocade-uda-access-list', yang_type='container', is_config=True)
  ...
  def _get_uda(self):
    """
    Getter method for uda, mapped from YANG variable /uda (container)
    """
    return self.__uda
      
  def _set_uda(self, v, load=False):
    """
    Setter method for uda, mapped from YANG variable /uda (container)
    If this variable is read-only (config: false) in the
  ...
  def _get_uda_key(self):
    """
    Getter method for uda_key, mapped from YANG variable /uda_key (container)
    """
    return self.__uda_key
      
  def _set_uda_key(self, v, load=False):
    """
    Setter method for uda_key, mapped from YANG variable /uda_key (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_uda_key is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_uda_key() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=uda_key.uda_key, is_container='container', presence=False, yang_name="uda-key", rest_name="uda-key", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'UDA key', u'cli-incomplete-no': None, u'sort-priority': u'53'}}, namespace='urn:brocade.com:mgmt:brocade-uda-access-list', defining_module='brocade-uda-access-list', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """uda_key must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=uda_key.uda_key, is_container='container', presence=False, yang_name="uda-key", rest_name="uda-key", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'UDA key', u'cli-incomplete-no': None, u'sort-priority': u'53'}}, namespace='urn:brocade.com:mgmt:brocade-uda-access-list', defining_module='brocade-uda-access-list', yang_type='container', is_config=True)""",
        })
  ...
  def _unset_uda_key(self):
    self.__uda_key = YANGDynClass(base=uda_key.uda_key, is_container='container', presence=False, yang_name="uda-key", rest_name="uda-key", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'UDA key', u'cli-incomplete-no': None, u'sort-priority': u'53'}}, namespace='urn:brocade.com:mgmt:brocade-uda-access-list', defining_module='brocade-uda-access-list', yang_type='container', is_config=True)

  uda = __builtin__.property(_get_uda, _set_uda)
  uda_key = __builtin__.property(_get_uda_key, _set_uda_key)


  _pyangbind_elements = {'uda': uda, 'uda_key': uda_key, }
...
class brocade_nsm_operational(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__bridge_domain_state','__logical_interface_state','__mct_state','__packet_encap_processing_state','__sub_interface_statistics_state','__topology_group_state','__vpn_statistics_state','__mct_mem_bd_state','__mct_mem_vlan_state',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__mct_mem_bd_state = YANGDynClass(base=YANGListType("cluster_id",mct_mem_bd_state.mct_mem_bd_state, yang_name="mct-mem-bd-state", rest_name="mct-mem-bd-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id', extensions={u'tailf-common': {u'callpoint': u'nsm-mct-mem-bd', u'cli-suppress-show-path': None}}), is_container='list', yang_name="mct-mem-bd-state", rest_name="mct-mem-bd-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-mct-mem-bd', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=True)
    self.__packet_encap_processing_state = YANGDynClass(base=packet_encap_processing_state.packet_encap_processing_state, is_container='container', presence=False, yang_name="packet-encap-processing-state", rest_name="packet-encap-processing-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-packet-encap-processing', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='container', is_config=True)
    ...
    self.__mct_mem_vlan_state = YANGDynClass(base=YANGListType("cluster_id",mct_mem_vlan_state.mct_mem_vlan_state, yang_name="mct-mem-vlan-state", rest_name="mct-mem-vlan-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id', extensions={u'tailf-common': {u'callpoint': u'nsm-mct-mem-vlan', u'cli-suppress-show-path': None}}), is_container='list', yang_name="mct-mem-vlan-state", rest_name="mct-mem-vlan-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-mct-mem-vlan', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=True)
  ...
  def _get_packet_encap_processing_state(self):
    """
    Getter method for packet_encap_processing_state, mapped from YANG variable /packet_encap_processing_state (container)

    YANG Description: Packet Encapsulation Processing
    """
    return self.__packet_encap_processing_state
      
  def _set_packet_encap_processing_state(self, v, load=False):
    """
    Setter method for packet_encap_processing_state, mapped from YANG variable /packet_encap_processing_state (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_packet_encap_processing_state is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_packet_encap_processing_state() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=packet_encap_processing_state.packet_encap_processing_state, is_container='container', presence=False, yang_name="packet-encap-processing-state", rest_name="packet-encap-processing-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-packet-encap-processing', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """packet_encap_processing_state must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=packet_encap_processing_state.packet_encap_processing_state, is_container='container', presence=False, yang_name="packet-encap-processing-state", rest_name="packet-encap-processing-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-packet-encap-processing', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='container', is_config=True)""",
        })

    self.__packet_encap_processing_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_packet_encap_processing_state(self):
    self.__packet_encap_processing_state = YANGDynClass(base=packet_encap_processing_state.packet_encap_processing_state, is_container='container', presence=False, yang_name="packet-encap-processing-state", rest_name="packet-encap-processing-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-packet-encap-processing', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='container', is_config=True)
  ...
  def _get_mct_mem_bd_state(self):
    """
    Getter method for mct_mem_bd_state, mapped from YANG variable /mct_mem_bd_state (list)

    YANG Description: Cluster BD Labels
    """
    return self.__mct_mem_bd_state
      
  def _set_mct_mem_bd_state(self, v, load=False):
    """
    Setter method for mct_mem_bd_state, mapped from YANG variable /mct_mem_bd_state (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mct_mem_bd_state is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_mct_mem_bd_state() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """mct_mem_bd_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("cluster_id",mct_mem_bd_state.mct_mem_bd_state, yang_name="mct-mem-bd-state", rest_name="mct-mem-bd-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id', extensions={u'tailf-common': {u'callpoint': u'nsm-mct-mem-bd', u'cli-suppress-show-path': None}}), is_container='list', yang_name="mct-mem-bd-state", rest_name="mct-mem-bd-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-mct-mem-bd', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=True)""",
        })

    self.__mct_mem_bd_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_mct_mem_bd_state(self):
    self.__mct_mem_bd_state = YANGDynClass(base=YANGListType("cluster_id",mct_mem_bd_state.mct_mem_bd_state, yang_name="mct-mem-bd-state", rest_name="mct-mem-bd-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id', extensions={u'tailf-common': {u'callpoint': u'nsm-mct-mem-bd', u'cli-suppress-show-path': None}}), is_container='list', yang_name="mct-mem-bd-state", rest_name="mct-mem-bd-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-mct-mem-bd', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=True)


  def _get_mct_mem_vlan_state(self):
    """
    Getter method for mct_mem_vlan_state, mapped from YANG variable /mct_mem_vlan_state (list)

    YANG Description: Cluster Vlan Labels
    """
    return self.__mct_mem_vlan_state
      
  def _set_mct_mem_vlan_state(self, v, load=False):
    """
    Setter method for mct_mem_vlan_state, mapped from YANG variable /mct_mem_vlan_state (list)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_mct_mem_vlan_state is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_mct_mem_vlan_state() directly.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """mct_mem_vlan_state must be of a type compatible with list""",
          'defined-type': "list",
          'generated-type': """YANGDynClass(base=YANGListType("cluster_id",mct_mem_vlan_state.mct_mem_vlan_state, yang_name="mct-mem-vlan-state", rest_name="mct-mem-vlan-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id', extensions={u'tailf-common': {u'callpoint': u'nsm-mct-mem-vlan', u'cli-suppress-show-path': None}}), is_container='list', yang_name="mct-mem-vlan-state", rest_name="mct-mem-vlan-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-mct-mem-vlan', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=True)""",
        })

    self.__mct_mem_vlan_state = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_mct_mem_vlan_state(self):
    self.__mct_mem_vlan_state = YANGDynClass(base=YANGListType("cluster_id",mct_mem_vlan_state.mct_mem_vlan_state, yang_name="mct-mem-vlan-state", rest_name="mct-mem-vlan-state", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='cluster-id', extensions={u'tailf-common': {u'callpoint': u'nsm-mct-mem-vlan', u'cli-suppress-show-path': None}}), is_container='list', yang_name="mct-mem-vlan-state", rest_name="mct-mem-vlan-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'callpoint': u'nsm-mct-mem-vlan', u'cli-suppress-show-path': None}}, namespace='urn:brocade.com:mgmt:brocade-nsm-operational', defining_module='brocade-nsm-operational', yang_type='list', is_config=True)
  ...
  packet_encap_processing_state = __builtin__.property(_get_packet_encap_processing_state, _set_packet_encap_processing_state)
  ...
  mct_mem_bd_state = __builtin__.property(_get_mct_mem_bd_state, _set_mct_mem_bd_state)
  mct_mem_vlan_state = __builtin__.property(_get_mct_mem_vlan_state, _set_mct_mem_vlan_state)


  _pyangbind_elements = {'bridge_domain_state': bridge_domain_state, 'logical_interface_state': logical_interface_state, 'mct_state': mct_state, 'packet_encap_processing_state': packet_encap_processing_state, 'sub_interface_statistics_state': sub_interface_statistics_state, 'topology_group_state': topology_group_state, 'vpn_statistics_state': vpn_statistics_state, 'mct_mem_bd_state': mct_mem_bd_state, 'mct_mem_vlan_state': mct_mem_vlan_state, }
