...
class seq(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__seq_id','__action','__source','__srchost','__src_mac_addr_mask','__dst','__dsthost','__dst_mac_addr_mask','__vlan_tag_format','__vlan','__vlan_id_mask','__outer_vlan','__outer_vlan_id_mask','__inner_vlan','__inner_vlan_id_mask','__ethertype','__arp_guard','__pcp','__pcp_force','__drop_precedence_force','__count','__log','__mirror','__copy_sflow',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__vlan_tag_format = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'untagged': {'value': 1}, u'single-tagged': {'value': 2}, u'double-tagged': {'value': 3}},), is_leaf=True, yang_name="vlan-tag-format", rest_name="vlan-tag-format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='enumeration', is_config=True)
    ...
    self.__inner_vlan = YANGDynClass(base=[RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..4090']}),RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'any': {'value': 0}},),], is_leaf=True, yang_name="inner-vlan", rest_name="inner-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='union', is_config=True)
    ...
    self.__outer_vlan = YANGDynClass(base=[RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..4090']}),RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'any': {'value': 0}},),], is_leaf=True, yang_name="outer-vlan", rest_name="outer-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='union', is_config=True)
    ...
    self.__vlan = YANGDynClass(base=[RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'any': {'value': 0}},),RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..4090']}),], is_leaf=True, yang_name="vlan", rest_name="vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Vlan', u'cli-optional-in-sequence': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='union', is_config=True)
    self.__arp_guard = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="arp-guard", rest_name="arp-guard", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Arp Gaurd', u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='empty', is_config=True)
    self.__outer_vlan_id_mask = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0][x][0-9a-fA-F]*', 'length': [u'5']}), is_leaf=True, yang_name="outer-vlan-id-mask", rest_name="outer-vlan-id-mask", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Outer vlan-id mask', u'cli-optional-in-sequence': None, u'cli-suppress-no': None, u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='vlan-format-vlan-id-mask', is_config=True)
    ...
    self.__vlan_id_mask = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0][x][0-9a-fA-F]*', 'length': [u'5']}), is_leaf=True, yang_name="vlan-id-mask", rest_name="vlan-id-mask", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None, u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='vlan-format-vlan-id-mask', is_config=True)
    self.__inner_vlan_id_mask = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0][x][0-9a-fA-F]*', 'length': [u'5']}), is_leaf=True, yang_name="inner-vlan-id-mask", rest_name="inner-vlan-id-mask", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Inner vlan-id mask', u'cli-optional-in-sequence': None, u'cli-suppress-no': None, u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='vlan-format-vlan-id-mask', is_config=True)
    self.__ethertype = YANGDynClass(base=[RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'arp': {'value': 2054}, u'ipv6': {'value': 34525}, u'fcoe': {'value': 35078}, u'ipv4': {'value': 2048}},),RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), restriction_dict={'range': [u'1536 .. 65535']}),], is_leaf=True, yang_name="ethertype", rest_name="ethertype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None, u'cli-optional-in-sequence': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='union', is_config=True)
  ...
  def _get_vlan_tag_format(self):
    ...
    """
    return self.__vlan_tag_format
      
  def _set_vlan_tag_format(self, v, load=False):
    """
    Setter method for vlan_tag_format, mapped from YANG variable /mac/access_list/extended/hide_mac_acl_ext/seq/vlan_tag_format (enumeration)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_vlan_tag_format is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_vlan_tag_format() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'untagged': {'value': 1}, u'single-tagged': {'value': 2}, u'double-tagged': {'value': 3}},), is_leaf=True, yang_name="vlan-tag-format", rest_name="vlan-tag-format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='enumeration', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vlan_tag_format must be of a type compatible with enumeration""",
          'defined-type': "brocade-mac-access-list:enumeration",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'untagged': {'value': 1}, u'single-tagged': {'value': 2}, u'double-tagged': {'value': 3}},), is_leaf=True, yang_name="vlan-tag-format", rest_name="vlan-tag-format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='enumeration', is_config=True)""",
        })

    self.__vlan_tag_format = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_vlan_tag_format(self):
    self.__vlan_tag_format = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'untagged': {'value': 1}, u'single-tagged': {'value': 2}, u'double-tagged': {'value': 3}},), is_leaf=True, yang_name="vlan-tag-format", rest_name="vlan-tag-format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='enumeration', is_config=True)


  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /mac/access_list/extended/hide_mac_acl_ext/seq/vlan (union)
  ...
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /mac/access_list/extended/hide_mac_acl_ext/seq/vlan (union)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=[RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'any': {'value': 0}},),RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..4090']}),], is_leaf=True, yang_name="vlan", rest_name="vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Vlan', u'cli-optional-in-sequence': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='union', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vlan must be of a type compatible with union""",
          'defined-type': "brocade-mac-access-list:union",
          'generated-type': """YANGDynClass(base=[RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'any': {'value': 0}},),RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..4090']}),], is_leaf=True, yang_name="vlan", rest_name="vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Vlan', u'cli-optional-in-sequence': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='union', is_config=True)""",
        })
  ...
  def _get_vlan_id_mask(self):
    ...
    """
    return self.__vlan_id_mask
      
  def _set_vlan_id_mask(self, v, load=False):
    """
    Setter method for vlan_id_mask, mapped from YANG variable /mac/access_list/extended/hide_mac_acl_ext/seq/vlan_id_mask (vlan-format-vlan-id-mask)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_vlan_id_mask is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_vlan_id_mask() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0][x][0-9a-fA-F]*', 'length': [u'5']}), is_leaf=True, yang_name="vlan-id-mask", rest_name="vlan-id-mask", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None, u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='vlan-format-vlan-id-mask', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vlan_id_mask must be of a type compatible with vlan-format-vlan-id-mask""",
          'defined-type': "brocade-mac-access-list:vlan-format-vlan-id-mask",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0][x][0-9a-fA-F]*', 'length': [u'5']}), is_leaf=True, yang_name="vlan-id-mask", rest_name="vlan-id-mask", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None, u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='vlan-format-vlan-id-mask', is_config=True)""",
        })

    self.__vlan_id_mask = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_vlan_id_mask(self):
    self.__vlan_id_mask = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0][x][0-9a-fA-F]*', 'length': [u'5']}), is_leaf=True, yang_name="vlan-id-mask", rest_name="vlan-id-mask", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None, u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='vlan-format-vlan-id-mask', is_config=True)
  ...
  def _set_outer_vlan(self, v, load=False):
    """
    Setter method for outer_vlan, mapped from YANG variable /mac/access_list/extended/hide_mac_acl_ext/seq/outer_vlan (union)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=[RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..4090']}),RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'any': {'value': 0}},),], is_leaf=True, yang_name="outer-vlan", rest_name="outer-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='union', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """outer_vlan must be of a type compatible with union""",
          'defined-type': "brocade-mac-access-list:union",
          'generated-type': """YANGDynClass(base=[RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..4090']}),RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'any': {'value': 0}},),], is_leaf=True, yang_name="outer-vlan", rest_name="outer-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='union', is_config=True)""",
        })
  ...
  def _get_outer_vlan_id_mask(self):
    ...
    """
    return self.__outer_vlan_id_mask
      
  def _set_outer_vlan_id_mask(self, v, load=False):
    """
    Setter method for outer_vlan_id_mask, mapped from YANG variable /mac/access_list/extended/hide_mac_acl_ext/seq/outer_vlan_id_mask (vlan-format-vlan-id-mask)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_outer_vlan_id_mask is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_outer_vlan_id_mask() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0][x][0-9a-fA-F]*', 'length': [u'5']}), is_leaf=True, yang_name="outer-vlan-id-mask", rest_name="outer-vlan-id-mask", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Outer vlan-id mask', u'cli-optional-in-sequence': None, u'cli-suppress-no': None, u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='vlan-format-vlan-id-mask', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """outer_vlan_id_mask must be of a type compatible with vlan-format-vlan-id-mask""",
          'defined-type': "brocade-mac-access-list:vlan-format-vlan-id-mask",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0][x][0-9a-fA-F]*', 'length': [u'5']}), is_leaf=True, yang_name="outer-vlan-id-mask", rest_name="outer-vlan-id-mask", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Outer vlan-id mask', u'cli-optional-in-sequence': None, u'cli-suppress-no': None, u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='vlan-format-vlan-id-mask', is_config=True)""",
        })

    self.__outer_vlan_id_mask = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_outer_vlan_id_mask(self):
    self.__outer_vlan_id_mask = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0][x][0-9a-fA-F]*', 'length': [u'5']}), is_leaf=True, yang_name="outer-vlan-id-mask", rest_name="outer-vlan-id-mask", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Outer vlan-id mask', u'cli-optional-in-sequence': None, u'cli-suppress-no': None, u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='vlan-format-vlan-id-mask', is_config=True)
  ...
  def _set_inner_vlan(self, v, load=False):
    """
    Setter method for inner_vlan, mapped from YANG variable /mac/access_list/extended/hide_mac_acl_ext/seq/inner_vlan (union)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=[RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..4090']}),RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'any': {'value': 0}},),], is_leaf=True, yang_name="inner-vlan", rest_name="inner-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='union', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """inner_vlan must be of a type compatible with union""",
          'defined-type': "brocade-mac-access-list:union",
          'generated-type': """YANGDynClass(base=[RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..4090']}),RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'any': {'value': 0}},),], is_leaf=True, yang_name="inner-vlan", rest_name="inner-vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='union', is_config=True)""",
        })
  ...
  def _get_inner_vlan_id_mask(self):
    ...
    """
    return self.__inner_vlan_id_mask
      
  def _set_inner_vlan_id_mask(self, v, load=False):
    """
    Setter method for inner_vlan_id_mask, mapped from YANG variable /mac/access_list/extended/hide_mac_acl_ext/seq/inner_vlan_id_mask (vlan-format-vlan-id-mask)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_inner_vlan_id_mask is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_inner_vlan_id_mask() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0][x][0-9a-fA-F]*', 'length': [u'5']}), is_leaf=True, yang_name="inner-vlan-id-mask", rest_name="inner-vlan-id-mask", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Inner vlan-id mask', u'cli-optional-in-sequence': None, u'cli-suppress-no': None, u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='vlan-format-vlan-id-mask', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """inner_vlan_id_mask must be of a type compatible with vlan-format-vlan-id-mask""",
          'defined-type': "brocade-mac-access-list:vlan-format-vlan-id-mask",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0][x][0-9a-fA-F]*', 'length': [u'5']}), is_leaf=True, yang_name="inner-vlan-id-mask", rest_name="inner-vlan-id-mask", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Inner vlan-id mask', u'cli-optional-in-sequence': None, u'cli-suppress-no': None, u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='vlan-format-vlan-id-mask', is_config=True)""",
        })

    self.__inner_vlan_id_mask = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_inner_vlan_id_mask(self):
    self.__inner_vlan_id_mask = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'[0][x][0-9a-fA-F]*', 'length': [u'5']}), is_leaf=True, yang_name="inner-vlan-id-mask", rest_name="inner-vlan-id-mask", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Inner vlan-id mask', u'cli-optional-in-sequence': None, u'cli-suppress-no': None, u'cli-drop-node-name': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='vlan-format-vlan-id-mask', is_config=True)
  ...
  def _set_ethertype(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=[RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'arp': {'value': 2054}, u'ipv6': {'value': 34525}, u'fcoe': {'value': 35078}, u'ipv4': {'value': 2048}},),RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), restriction_dict={'range': [u'1536 .. 65535']}),], is_leaf=True, yang_name="ethertype", rest_name="ethertype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None, u'cli-optional-in-sequence': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='union', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """ethertype must be of a type compatible with union""",
          'defined-type': "brocade-mac-access-list:union",
          'generated-type': """YANGDynClass(base=[RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'arp': {'value': 2054}, u'ipv6': {'value': 34525}, u'fcoe': {'value': 35078}, u'ipv4': {'value': 2048}},),RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), restriction_dict={'range': [u'1536 .. 65535']}),], is_leaf=True, yang_name="ethertype", rest_name="ethertype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None, u'cli-optional-in-sequence': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='union', is_config=True)""",
        })
  ...
  def _get_arp_guard(self):
    ...
    """
    return self.__arp_guard
      
  def _set_arp_guard(self, v, load=False):
    """
    Setter method for arp_guard, mapped from YANG variable /mac/access_list/extended/hide_mac_acl_ext/seq/arp_guard (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_arp_guard is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_arp_guard() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="arp-guard", rest_name="arp-guard", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Arp Gaurd', u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='empty', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """arp_guard must be of a type compatible with empty""",
          'defined-type': "empty",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="arp-guard", rest_name="arp-guard", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Arp Gaurd', u'cli-optional-in-sequence': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-mac-access-list', defining_module='brocade-mac-access-list', yang_type='empty', is_config=True)""",
        })
  ...
  vlan_tag_format = __builtin__.property(_get_vlan_tag_format, _set_vlan_tag_format)
  vlan = __builtin__.property(_get_vlan, _set_vlan)
  vlan_id_mask = __builtin__.property(_get_vlan_id_mask, _set_vlan_id_mask)
  outer_vlan = __builtin__.property(_get_outer_vlan, _set_outer_vlan)
  outer_vlan_id_mask = __builtin__.property(_get_outer_vlan_id_mask, _set_outer_vlan_id_mask)
  inner_vlan = __builtin__.property(_get_inner_vlan, _set_inner_vlan)
  inner_vlan_id_mask = __builtin__.property(_get_inner_vlan_id_mask, _set_inner_vlan_id_mask)
  ethertype = __builtin__.property(_get_ethertype, _set_ethertype)
  arp_guard = __builtin__.property(_get_arp_guard, _set_arp_guard)
  ...
  _pyangbind_elements = {'seq_id': seq_id, 'action': action, 'source': source, 'srchost': srchost, 'src_mac_addr_mask': src_mac_addr_mask, 'dst': dst, 'dsthost': dsthost, 'dst_mac_addr_mask': dst_mac_addr_mask, 'vlan_tag_format': vlan_tag_format, 'vlan': vlan, 'vlan_id_mask': vlan_id_mask, 'outer_vlan': outer_vlan, 'outer_vlan_id_mask': outer_vlan_id_mask, 'inner_vlan': inner_vlan, 'inner_vlan_id_mask': inner_vlan_id_mask, 'ethertype': ethertype, 'arp_guard': arp_guard, 'pcp': pcp, 'pcp_force': pcp_force, 'drop_precedence_force': drop_precedence_force, 'count': count, 'log': log, 'mirror': mirror, 'copy_sflow': copy_sflow, }
