...
class syslog_server(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__syslogip','__use_vrf','__format','__syslog_secure',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__format = YANGDynClass(base=unicode, default=unicode(""), is_leaf=True, yang_name="format", rest_name="format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Syslog format RFC-5424', u'cli-optional-in-sequence': None}}, namespace='urn:brocade.com:mgmt:brocade-ras', defining_module='brocade-ras', yang_type='string', is_config=True)
  ...
  def _get_format(self):
    """
    Getter method for format, mapped from YANG variable /logging/syslog_server/format (string)
    """
    return self.__format
      
  def _set_format(self, v, load=False):
    """
    Setter method for format, mapped from YANG variable /logging/syslog_server/format (string)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, default=unicode(""), is_leaf=True, yang_name="format", rest_name="format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Syslog format RFC-5424', u'cli-optional-in-sequence': None}}, namespace='urn:brocade.com:mgmt:brocade-ras', defining_module='brocade-ras', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """format must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=unicode, default=unicode(""), is_leaf=True, yang_name="format", rest_name="format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Syslog format RFC-5424', u'cli-optional-in-sequence': None}}, namespace='urn:brocade.com:mgmt:brocade-ras', defining_module='brocade-ras', yang_type='string', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'syslogip': syslogip, 'use_vrf': use_vrf, 'format': format, 'syslog_secure': syslog_secure, }
