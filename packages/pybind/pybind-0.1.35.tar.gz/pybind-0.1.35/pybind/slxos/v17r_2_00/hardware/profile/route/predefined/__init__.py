...
import __builtin__
import route_parameter
class predefined(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-hardware - based on the path /hardware/profile/route/predefined. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__route_profiletype','__route_parameter',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hardware', u'profile', u'route', u'predefined']
  ...
  def _get_route_profiletype(self):
    ...
    """
    return self.__route_profiletype
      
  def _set_route_profiletype(self, v, load=False):
    """
    Setter method for route_profiletype, mapped from YANG variable /hardware/profile/route/predefined/route_profiletype (route-profile-subtype)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_route_profiletype is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_route_profiletype() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      ...
      raise ValueError({
          'error-string': """route_profiletype must be of a type compatible with route-profile-subtype""",
          'defined-type': "brocade-hardware:route-profile-subtype",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'default': {'value': 0}, u'route-enhance': {'value': 1}},), is_leaf=True, yang_name="route_profiletype", rest_name="route_profiletype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-hardware', defining_module='brocade-hardware', yang_type='route-profile-subtype', is_config=True)""",
        })
  ...
  def _unset_route_profiletype(self):
    self.__route_profiletype = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'default': {'value': 0}, u'route-enhance': {'value': 1}},), is_leaf=True, yang_name="route_profiletype", rest_name="route_profiletype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-hardware', defining_module='brocade-hardware', yang_type='route-profile-subtype', is_config=True)
  ...
  _pyangbind_elements = {'route_profiletype': route_profiletype, 'route_parameter': route_parameter, }
