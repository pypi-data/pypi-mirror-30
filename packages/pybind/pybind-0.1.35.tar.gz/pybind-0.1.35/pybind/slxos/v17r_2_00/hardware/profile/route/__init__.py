...
class route(PybindBase):
  ...
  from YANG module brocade-hardware - based on the path /hardware/profile/route. Each member element of
  ...
  def _set_predefined(self, v, load=False):
    """
    Setter method for predefined, mapped from YANG variable /hardware/profile/route/predefined (container)
