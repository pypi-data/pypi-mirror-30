...
class predefined(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__tcam_profiletype = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'npb-optimised-1': {'value': 4}, u'default': {'value': 0}, u'vxlan-ext': {'value': 1}, u'layer2-optimised-1': {'value': 6}, u'multicast-profile': {'value': 7}, u'openflow-optimised-2': {'value': 3}, u'openflow-optimised-3': {'value': 5}, u'openflow-optimised-1': {'value': 2}},), is_leaf=True, yang_name="tcam_profiletype", rest_name="tcam_profiletype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-hardware', defining_module='brocade-hardware', yang_type='tcam-profile-subtype', is_config=True)
  ...
  def _set_tcam_profiletype(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'npb-optimised-1': {'value': 4}, u'default': {'value': 0}, u'vxlan-ext': {'value': 1}, u'layer2-optimised-1': {'value': 6}, u'multicast-profile': {'value': 7}, u'openflow-optimised-2': {'value': 3}, u'openflow-optimised-3': {'value': 5}, u'openflow-optimised-1': {'value': 2}},), is_leaf=True, yang_name="tcam_profiletype", rest_name="tcam_profiletype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-hardware', defining_module='brocade-hardware', yang_type='tcam-profile-subtype', is_config=True)
      ...
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'npb-optimised-1': {'value': 4}, u'default': {'value': 0}, u'vxlan-ext': {'value': 1}, u'layer2-optimised-1': {'value': 6}, u'multicast-profile': {'value': 7}, u'openflow-optimised-2': {'value': 3}, u'openflow-optimised-3': {'value': 5}, u'openflow-optimised-1': {'value': 2}},), is_leaf=True, yang_name="tcam_profiletype", rest_name="tcam_profiletype", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-drop-node-name': None, u'cli-suppress-no': None}}, namespace='urn:brocade.com:mgmt:brocade-hardware', defining_module='brocade-hardware', yang_type='tcam-profile-subtype', is_config=True)""",
        })
