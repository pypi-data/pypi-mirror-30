...
import __builtin__
import nport
class nport_interface(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/ag/nport-menu/nport-interface. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__nport',)

  _yang_name = 'nport-interface'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ag', u'nport-menu', u'nport-interface']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ag', u'nport', u'interface']

  def _get_nport(self):
    """
    Getter method for nport, mapped from YANG variable /rbridge_id/ag/nport_menu/nport_interface/nport (list)
    """
    return self.__nport
      
  def _set_nport(self, v, load=False):
    """
    Setter method for nport, mapped from YANG variable /rbridge_id/ag/nport_menu/nport_interface/nport (list)
    ...
    try:
      ...
      raise ValueError({
          'error-string': """nport must be of a type compatible with list""",
          'defined-type': "list",
  ...
  _pyangbind_elements = {'nport': nport, }
