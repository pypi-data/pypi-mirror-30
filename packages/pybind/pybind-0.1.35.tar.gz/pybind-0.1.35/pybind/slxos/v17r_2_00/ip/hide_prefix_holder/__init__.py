...
class hide_prefix_holder(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ip/hide-prefix-holder. Each member element of
  ...
  def _get_prefix_list(self):
    """
    Getter method for prefix_list, mapped from YANG variable /ip/hide_prefix_holder/prefix_list (list)
  ...
  def _set_prefix_list(self, v, load=False):
    """
    Setter method for prefix_list, mapped from YANG variable /ip/hide_prefix_holder/prefix_list (list)
