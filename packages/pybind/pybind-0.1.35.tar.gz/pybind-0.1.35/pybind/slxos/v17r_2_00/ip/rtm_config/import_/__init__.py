...
class import_(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ip/rtm-config/import. Each member element of
  ...
  def _get_routes(self):
    """
    Getter method for routes, mapped from YANG variable /ip/rtm_config/import/routes (list)
  ...
  def _set_routes(self, v, load=False):
    """
    Setter method for routes, mapped from YANG variable /ip/rtm_config/import/routes (list)
