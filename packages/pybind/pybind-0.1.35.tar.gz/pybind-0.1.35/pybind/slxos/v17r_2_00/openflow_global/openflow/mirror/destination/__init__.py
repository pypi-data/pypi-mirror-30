...
import __builtin__
import mirror_interface
class destination(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-openflow - based on the path /openflow-global/openflow/mirror/destination. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__mirror_interface',)

  _yang_name = 'destination'
  _rest_name = 'destination'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'openflow-global', u'openflow', u'mirror', u'destination']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'openflow', u'mirror', u'destination']

  def _get_mirror_interface(self):
    """
    Getter method for mirror_interface, mapped from YANG variable /openflow_global/openflow/mirror/destination/mirror_interface (list)
    """
  ...
  mirror_interface = __builtin__.property(_get_mirror_interface, _set_mirror_interface)


  _pyangbind_elements = {'mirror_interface': mirror_interface, }
