...
class tmcpustatsslotallgrp(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__slot_id','__priority','__enquepkt','__enqueubytes','__discardpkt','__discardbytes','__currdepth','__maxdepth',)
  ...
  def _get_priority(self):
    """
    Getter method for priority, mapped from YANG variable /tm_state/tmcpustatsslotallgrp/priority (uint16)
  ...
  def _set_priority(self, v, load=False):
    """
    Setter method for priority, mapped from YANG variable /tm_state/tmcpustatsslotallgrp/priority (uint16)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'slot_id': slot_id, 'priority': priority, 'enquepkt': enquepkt, 'enqueubytes': enqueubytes, 'discardpkt': discardpkt, 'discardbytes': discardbytes, 'currdepth': currdepth, 'maxdepth': maxdepth, }
