...
class group_id(PybindBase):
  ...
  def _get_packet_count(self):
    """
    Getter method for packet_count, mapped from YANG variable /openflow_state/group_id/packet_count (uint64)
  ...
  def _set_packet_count(self, v, load=False):
    """
    Setter method for packet_count, mapped from YANG variable /openflow_state/group_id/packet_count (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_byte_count(self):
    """
    Getter method for byte_count, mapped from YANG variable /openflow_state/group_id/byte_count (uint64)
  ...
  def _set_byte_count(self, v, load=False):
    """
    Setter method for byte_count, mapped from YANG variable /openflow_state/group_id/byte_count (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_mcast_group_id(self):
    """
    Getter method for mcast_group_id, mapped from YANG variable /openflow_state/group_id/mcast_group_id (uint32)
  ...
  def _set_mcast_group_id(self, v, load=False):
    """
    Setter method for mcast_group_id, mapped from YANG variable /openflow_state/group_id/mcast_group_id (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_replication_type(self):
    """
    Getter method for replication_type, mapped from YANG variable /openflow_state/group_id/replication_type (string)
  ...
  def _set_replication_type(self, v, load=False):
    """
    Setter method for replication_type, mapped from YANG variable /openflow_state/group_id/replication_type (string)
    If this variable is read-only (config: false) in the
