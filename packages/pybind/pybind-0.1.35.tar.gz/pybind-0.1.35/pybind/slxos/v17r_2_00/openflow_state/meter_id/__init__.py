...
class meter_id(PybindBase):
  ...
  def _get_in_packet_count(self):
    """
    Getter method for in_packet_count, mapped from YANG variable /openflow_state/meter_id/in_packet_count (uint64)
  ...
  def _set_in_packet_count(self, v, load=False):
    """
    Setter method for in_packet_count, mapped from YANG variable /openflow_state/meter_id/in_packet_count (uint64)
    If this variable is read-only (config: false) in the
  ...
  def _get_in_byte_count(self):
    """
    Getter method for in_byte_count, mapped from YANG variable /openflow_state/meter_id/in_byte_count (uint64)
  ...
  def _set_in_byte_count(self, v, load=False):
    """
    Setter method for in_byte_count, mapped from YANG variable /openflow_state/meter_id/in_byte_count (uint64)
    If this variable is read-only (config: false) in the
