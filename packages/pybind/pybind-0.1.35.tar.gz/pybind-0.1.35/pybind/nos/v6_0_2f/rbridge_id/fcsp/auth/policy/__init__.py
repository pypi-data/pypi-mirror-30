...
class policy(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/fcsp/auth/policy. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'fcsp', u'auth', u'policy']
  ...
  def _get_switch(self):
    """
    Getter method for switch, mapped from YANG variable /rbridge_id/fcsp/auth/policy/switch (fcsp-switch-policy-state)
    """
    return self.__switch
      
  def _set_switch(self, v, load=False):
    """
    Setter method for switch, mapped from YANG variable /rbridge_id/fcsp/auth/policy/switch (fcsp-switch-policy-state)
