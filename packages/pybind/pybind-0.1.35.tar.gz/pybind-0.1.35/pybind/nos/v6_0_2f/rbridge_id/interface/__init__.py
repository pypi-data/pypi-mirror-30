...
class interface(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface']
  ...
  def _get_ve(self):
    """
    Getter method for ve, mapped from YANG variable /rbridge_id/interface/ve (list)
    """
    return self.__ve
      
  def _set_ve(self, v, load=False):
    """
    Setter method for ve, mapped from YANG variable /rbridge_id/interface/ve (list)
  ...
  def _get_loopback(self):
    """
    Getter method for loopback, mapped from YANG variable /rbridge_id/interface/loopback (list)
    """
    return self.__loopback
      
  def _set_loopback(self, v, load=False):
    """
    Setter method for loopback, mapped from YANG variable /rbridge_id/interface/loopback (list)
    If this variable is read-only (config: false) in the
