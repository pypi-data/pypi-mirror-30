...
class import_(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ip/import. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ip', u'import']
  ...
  def _get_routes(self):
    """
    Getter method for routes, mapped from YANG variable /rbridge_id/ip/import/routes (list)
  ...
  def _set_routes(self, v, load=False):
    """
    Setter method for routes, mapped from YANG variable /rbridge_id/ip/import/routes (list)
