...
class next_hop(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/match/ipv6/next-hop. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'match', u'ipv6', u'next-hop']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'match', u'ipv6', u'next-hop']

  def _get_ipv6_prefix_list_rmm_n(self):
    """
    Getter method for ipv6_prefix_list_rmm_n, mapped from YANG variable /rbridge_id/route_map/content/match/ipv6/next_hop/ipv6_prefix_list_rmm_n (ipv6-prefix-name-t)
  ...
  def _set_ipv6_prefix_list_rmm_n(self, v, load=False):
    """
    Setter method for ipv6_prefix_list_rmm_n, mapped from YANG variable /rbridge_id/route_map/content/match/ipv6/next_hop/ipv6_prefix_list_rmm_n (ipv6-prefix-name-t)
