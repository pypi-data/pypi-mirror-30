...
class routes(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ip/import/routes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ip', u'import', u'routes']
  ...
  def _get_src_vrf(self):
    """
    Getter method for src_vrf, mapped from YANG variable /rbridge_id/ip/import/routes/src_vrf (common-def:vrf-name)
    """
    return self.__src_vrf
      
  def _set_src_vrf(self, v, load=False):
    """
    Setter method for src_vrf, mapped from YANG variable /rbridge_id/ip/import/routes/src_vrf (common-def:vrf-name)
  ...
  def _get_route_map(self):
    """
    Getter method for route_map, mapped from YANG variable /rbridge_id/ip/import/routes/route_map (common-def:name-string63)
    """
    return self.__route_map
      
  def _set_route_map(self, v, load=False):
    """
    Setter method for route_map, mapped from YANG variable /rbridge_id/ip/import/routes/route_map (common-def:name-string63)
    If this variable is read-only (config: false) in the
