...
class route_target(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/route-target. Each member element of
...
in NOS4.0.0 release
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'route-target']
  ...
  def _get_action(self):
    """
    Getter method for action, mapped from YANG variable /rbridge_id/vrf/route_target/action (enumeration)
    """
    return self.__action
      
  def _set_action(self, v, load=False):
    """
    Setter method for action, mapped from YANG variable /rbridge_id/vrf/route_target/action (enumeration)
  ...
  def _get_target_community(self):
    """
    Getter method for target_community, mapped from YANG variable /rbridge_id/vrf/route_target/target_community (rt-type)
  ...
  def _set_target_community(self, v, load=False):
    """
    Setter method for target_community, mapped from YANG variable /rbridge_id/vrf/route_target/target_community (rt-type)
    If this variable is read-only (config: false) in the
