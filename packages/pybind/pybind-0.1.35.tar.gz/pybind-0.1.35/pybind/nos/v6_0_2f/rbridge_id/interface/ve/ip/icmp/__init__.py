...
class icmp(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ip/icmp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ip', u'icmp']
  ...
  def _get_echo_reply(self):
    """
    Getter method for echo_reply, mapped from YANG variable /rbridge_id/interface/ve/ip/icmp/echo_reply (empty)
    """
    return self.__echo_reply
      
  def _set_echo_reply(self, v, load=False):
    """
    Setter method for echo_reply, mapped from YANG variable /rbridge_id/interface/ve/ip/icmp/echo_reply (empty)
  ...
  def _get_rate_limiting(self):
    """
    Getter method for rate_limiting, mapped from YANG variable /rbridge_id/interface/ve/ip/icmp/rate_limiting (uint32)
    """
    return self.__rate_limiting
      
  def _set_rate_limiting(self, v, load=False):
    """
    Setter method for rate_limiting, mapped from YANG variable /rbridge_id/interface/ve/ip/icmp/rate_limiting (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_unreachable(self):
    """
    Getter method for unreachable, mapped from YANG variable /rbridge_id/interface/ve/ip/icmp/unreachable (empty)
    """
    return self.__unreachable
      
  def _set_unreachable(self, v, load=False):
    """
    Setter method for unreachable, mapped from YANG variable /rbridge_id/interface/ve/ip/icmp/unreachable (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_redirect(self):
    """
    Getter method for redirect, mapped from YANG variable /rbridge_id/interface/ve/ip/icmp/redirect (empty)
    """
    return self.__redirect
      
  def _set_redirect(self, v, load=False):
    """
    Setter method for redirect, mapped from YANG variable /rbridge_id/interface/ve/ip/icmp/redirect (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_address_mask(self):
    """
    Getter method for address_mask, mapped from YANG variable /rbridge_id/interface/ve/ip/icmp/address_mask (empty)
    """
    return self.__address_mask
      
  def _set_address_mask(self, v, load=False):
    """
    Setter method for address_mask, mapped from YANG variable /rbridge_id/interface/ve/ip/icmp/address_mask (empty)
    If this variable is read-only (config: false) in the
