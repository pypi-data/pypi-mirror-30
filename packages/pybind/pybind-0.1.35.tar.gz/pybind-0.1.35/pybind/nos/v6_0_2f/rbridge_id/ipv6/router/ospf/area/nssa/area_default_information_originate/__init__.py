...
class area_default_information_originate(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/area/nssa/area-default-information-originate. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'area', u'nssa', u'area-default-information-originate']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'area', u'nssa', u'default-information-originate']

  def _get_area_default_information_originate_metric(self):
    """
    Getter method for area_default_information_originate_metric, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/nssa/area_default_information_originate/area_default_information_originate_metric (uint32)
  ...
  def _set_area_default_information_originate_metric(self, v, load=False):
    """
    Setter method for area_default_information_originate_metric, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/nssa/area_default_information_originate/area_default_information_originate_metric (uint32)
  ...
  def _get_area_default_information_originate_metric_type(self):
    """
    Getter method for area_default_information_originate_metric_type, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/nssa/area_default_information_originate/area_default_information_originate_metric_type (ospf:metric-type)
  ...
  def _set_area_default_information_originate_metric_type(self, v, load=False):
    """
    Setter method for area_default_information_originate_metric_type, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/nssa/area_default_information_originate/area_default_information_originate_metric_type (ospf:metric-type)
    If this variable is read-only (config: false) in the
