...
class multipath(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv4/ipv4-unicast/af-vrf/multipath. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv4', u'ipv4-unicast', u'af-vrf', u'multipath']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'ipv4', u'unicast', u'vrf', u'multipath']

  def _get_multipath_ebgp(self):
    """
    Getter method for multipath_ebgp, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/multipath/multipath_ebgp (empty)
    """
    return self.__multipath_ebgp
      
  def _set_multipath_ebgp(self, v, load=False):
    """
    Setter method for multipath_ebgp, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/multipath/multipath_ebgp (empty)
  ...
  def _get_multipath_ibgp(self):
    """
    Getter method for multipath_ibgp, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/multipath/multipath_ibgp (empty)
    """
    return self.__multipath_ibgp
      
  def _set_multipath_ibgp(self, v, load=False):
    """
    Setter method for multipath_ibgp, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/multipath/multipath_ibgp (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_multi_as(self):
    """
    Getter method for multi_as, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/multipath/multi_as (empty)
    """
    return self.__multi_as
      
  def _set_multi_as(self, v, load=False):
    """
    Setter method for multi_as, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv4/ipv4_unicast/af_vrf/multipath/multi_as (empty)
    If this variable is read-only (config: false) in the
