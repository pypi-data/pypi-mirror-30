...
class client(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ssh/client. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ssh', u'client']
  ...
  def _get_cipher(self):
    """
    Getter method for cipher, mapped from YANG variable /rbridge_id/ssh/client/cipher (string)
    """
    return self.__cipher
      
  def _set_cipher(self, v, load=False):
    """
    Setter method for cipher, mapped from YANG variable /rbridge_id/ssh/client/cipher (string)
  ...
  def _get_mac(self):
    """
    Getter method for mac, mapped from YANG variable /rbridge_id/ssh/client/mac (string)
    """
    return self.__mac
      
  def _set_mac(self, v, load=False):
    """
    Setter method for mac, mapped from YANG variable /rbridge_id/ssh/client/mac (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_key_exchange(self):
    """
    Getter method for key_exchange, mapped from YANG variable /rbridge_id/ssh/client/key_exchange (string)
    """
    return self.__key_exchange
      
  def _set_key_exchange(self, v, load=False):
    """
    Setter method for key_exchange, mapped from YANG variable /rbridge_id/ssh/client/key_exchange (string)
    If this variable is read-only (config: false) in the
