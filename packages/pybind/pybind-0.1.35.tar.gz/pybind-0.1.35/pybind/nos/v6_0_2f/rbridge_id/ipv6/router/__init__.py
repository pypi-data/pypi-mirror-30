...
class router(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router']
  ...
  def _get_ospf(self):
    """
    Getter method for ospf, mapped from YANG variable /rbridge_id/ipv6/router/ospf (list)
    """
    return self.__ospf
