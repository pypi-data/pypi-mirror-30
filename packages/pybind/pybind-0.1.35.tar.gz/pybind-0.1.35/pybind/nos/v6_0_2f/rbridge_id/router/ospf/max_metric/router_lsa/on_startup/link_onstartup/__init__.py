...
import __builtin__
class link_onstartup(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/ospf/max-metric/router-lsa/on-startup/link-onstartup. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf', u'max-metric', u'router-lsa', u'on-startup', u'link-onstartup']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf', u'max-metric', u'router-lsa', u'on-startup', u'link']

  def _get_all_link_onstartup(self):
    """
    Getter method for all_link_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/link_onstartup/all_link_onstartup (empty)
    """
    return self.__all_link_onstartup
      
  def _set_all_link_onstartup(self, v, load=False):
    """
    Setter method for all_link_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/link_onstartup/all_link_onstartup (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_all_link_onstartup is considered as a private
  ...
  def _get_ptp_link_onstartup(self):
    """
    Getter method for ptp_link_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/link_onstartup/ptp_link_onstartup (empty)
    """
    return self.__ptp_link_onstartup
      
  def _set_ptp_link_onstartup(self, v, load=False):
    """
    Setter method for ptp_link_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/link_onstartup/ptp_link_onstartup (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_ptp_link_onstartup is considered as a private
    method. Backends looking to populate this variable should
  ...
  def _get_stub_link_onstartup(self):
    """
    Getter method for stub_link_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/link_onstartup/stub_link_onstartup (empty)
    """
    return self.__stub_link_onstartup
      
  def _set_stub_link_onstartup(self, v, load=False):
    """
    Setter method for stub_link_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/link_onstartup/stub_link_onstartup (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_stub_link_onstartup is considered as a private
    method. Backends looking to populate this variable should
  ...
  def _get_transit_link_onstartup(self):
    """
    Getter method for transit_link_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/link_onstartup/transit_link_onstartup (empty)
    """
    return self.__transit_link_onstartup
      
  def _set_transit_link_onstartup(self, v, load=False):
    """
    Setter method for transit_link_onstartup, mapped from YANG variable /rbridge_id/router/ospf/max_metric/router_lsa/on_startup/link_onstartup/transit_link_onstartup (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_transit_link_onstartup is considered as a private
    method. Backends looking to populate this variable should
  ...
  stub_link_onstartup = __builtin__.property(_get_stub_link_onstartup, _set_stub_link_onstartup)
  transit_link_onstartup = __builtin__.property(_get_transit_link_onstartup, _set_transit_link_onstartup)


  _pyangbind_elements = {'all_link_onstartup': all_link_onstartup, 'ptp_link_onstartup': ptp_link_onstartup, 'stub_link_onstartup': stub_link_onstartup, 'transit_link_onstartup': transit_link_onstartup, }
