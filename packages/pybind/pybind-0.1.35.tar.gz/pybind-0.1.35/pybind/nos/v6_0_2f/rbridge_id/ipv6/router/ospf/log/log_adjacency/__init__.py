...
class log_adjacency(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/log/log-adjacency. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'log', u'log-adjacency']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'log', u'adjacency']

  def _get_log_adjacency_dr_only(self):
    """
    Getter method for log_adjacency_dr_only, mapped from YANG variable /rbridge_id/ipv6/router/ospf/log/log_adjacency/log_adjacency_dr_only (empty)
    """
    return self.__log_adjacency_dr_only
      
  def _set_log_adjacency_dr_only(self, v, load=False):
    """
    Setter method for log_adjacency_dr_only, mapped from YANG variable /rbridge_id/ipv6/router/ospf/log/log_adjacency/log_adjacency_dr_only (empty)
