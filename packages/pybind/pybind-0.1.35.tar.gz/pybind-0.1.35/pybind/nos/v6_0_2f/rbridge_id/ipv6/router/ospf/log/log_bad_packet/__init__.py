...
class log_bad_packet(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/log/log-bad-packet. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'log', u'log-bad-packet']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'log', u'bad-packet']

  def _get_log_bad_packet_checksum(self):
    """
    Getter method for log_bad_packet_checksum, mapped from YANG variable /rbridge_id/ipv6/router/ospf/log/log_bad_packet/log_bad_packet_checksum (empty)
    """
    return self.__log_bad_packet_checksum
      
  def _set_log_bad_packet_checksum(self, v, load=False):
    """
    Setter method for log_bad_packet_checksum, mapped from YANG variable /rbridge_id/ipv6/router/ospf/log/log_bad_packet/log_bad_packet_checksum (empty)
