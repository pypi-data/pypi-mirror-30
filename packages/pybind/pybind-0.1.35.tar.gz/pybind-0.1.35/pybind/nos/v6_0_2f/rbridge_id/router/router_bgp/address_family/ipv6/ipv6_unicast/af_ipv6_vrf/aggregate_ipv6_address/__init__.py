...
class aggregate_ipv6_address(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv6/ipv6-unicast/af-ipv6-vrf/aggregate-ipv6-address. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'af-ipv6-vrf', u'aggregate-ipv6-address']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'ipv6', u'unicast', u'vrf', u'aggregate-address']

  def _get_aggregate_ip_prefix(self):
    """
    Getter method for aggregate_ip_prefix, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/aggregate_ipv6_address/aggregate_ip_prefix (inet:ipv6-prefix)
    """
    return self.__aggregate_ip_prefix
      
  def _set_aggregate_ip_prefix(self, v, load=False):
    """
    Setter method for aggregate_ip_prefix, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/aggregate_ipv6_address/aggregate_ip_prefix (inet:ipv6-prefix)
  ...
  def _get_advertise_map(self):
    """
    Getter method for advertise_map, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/aggregate_ipv6_address/advertise_map (advertise-map)
    """
    return self.__advertise_map
      
  def _set_advertise_map(self, v, load=False):
    """
    Setter method for advertise_map, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/aggregate_ipv6_address/advertise_map (advertise-map)
    If this variable is read-only (config: false) in the
  ...
  def _get_as_set(self):
    """
    Getter method for as_set, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/aggregate_ipv6_address/as_set (empty)
    """
    return self.__as_set
      
  def _set_as_set(self, v, load=False):
    """
    Setter method for as_set, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/aggregate_ipv6_address/as_set (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_attribute_map(self):
    """
    Getter method for attribute_map, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/aggregate_ipv6_address/attribute_map (attribute-map)
    """
    return self.__attribute_map
      
  def _set_attribute_map(self, v, load=False):
    """
    Setter method for attribute_map, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/aggregate_ipv6_address/attribute_map (attribute-map)
    If this variable is read-only (config: false) in the
  ...
  def _get_summary_only(self):
    """
    Getter method for summary_only, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/aggregate_ipv6_address/summary_only (empty)
    """
    return self.__summary_only
      
  def _set_summary_only(self, v, load=False):
    """
    Setter method for summary_only, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/aggregate_ipv6_address/summary_only (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_suppress_map(self):
    """
    Getter method for suppress_map, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/aggregate_ipv6_address/suppress_map (suppress-map)
    """
    return self.__suppress_map
      
  def _set_suppress_map(self, v, load=False):
    """
    Setter method for suppress_map, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/af_ipv6_vrf/aggregate_ipv6_address/suppress_map (suppress-map)
    If this variable is read-only (config: false) in the
