...
class ipv6_track(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ipv6/ipv6-local-anycast-gateway/ipv6-track. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ipv6', u'ipv6-local-anycast-gateway', u'ipv6-track']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'Ve', u'ipv6', u'fabric-virtual-gateway', u'track']

  def _get_ipv6_interface(self):
    """
    Getter method for ipv6_interface, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_local_anycast_gateway/ipv6_track/ipv6_interface (list)
    """
  ...
  def _get_ipv6_network(self):
    """
    Getter method for ipv6_network, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_local_anycast_gateway/ipv6_track/ipv6_network (list)
    """
  ...
  def _get_ipv6_next_hop(self):
    """
    Getter method for ipv6_next_hop, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_local_anycast_gateway/ipv6_track/ipv6_next_hop (list)
    """
    return self.__ipv6_next_hop
      
  def _set_ipv6_next_hop(self, v, load=False):
    """
    Setter method for ipv6_next_hop, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_local_anycast_gateway/ipv6_track/ipv6_next_hop (list)
    If this variable is read-only (config: false) in the
