...
class routing_parameter(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/hardware-profile/route-table/predefined/routing_parameter. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'hardware-profile', u'route-table', u'predefined', u'routing_parameter']
  ...
  def _get_maximum_paths(self):
    """
    Getter method for maximum_paths, mapped from YANG variable /rbridge_id/hardware_profile/route_table/predefined/routing_parameter/maximum_paths (ecmp-subtype)
    """
    return self.__maximum_paths
      
  def _set_maximum_paths(self, v, load=False):
    """
    Setter method for maximum_paths, mapped from YANG variable /rbridge_id/hardware_profile/route_table/predefined/routing_parameter/maximum_paths (ecmp-subtype)
  ...
  def _get_openflow_enable(self):
    """
    Getter method for openflow_enable, mapped from YANG variable /rbridge_id/hardware_profile/route_table/predefined/routing_parameter/openflow_enable (openflow-subtype)
    """
    return self.__openflow_enable
      
  def _set_openflow_enable(self, v, load=False):
    """
    Setter method for openflow_enable, mapped from YANG variable /rbridge_id/hardware_profile/route_table/predefined/routing_parameter/openflow_enable (openflow-subtype)
    If this variable is read-only (config: false) in the
