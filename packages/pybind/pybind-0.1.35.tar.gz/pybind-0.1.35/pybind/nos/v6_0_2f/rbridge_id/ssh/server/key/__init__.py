...
class key(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ssh/server/key. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ssh', u'server', u'key']
  ...
  def _get_rsa(self):
    """
    Getter method for rsa, mapped from YANG variable /rbridge_id/ssh/server/key/rsa (rsa-bits-size)
    """
    return self.__rsa
      
  def _set_rsa(self, v, load=False):
    """
    Setter method for rsa, mapped from YANG variable /rbridge_id/ssh/server/key/rsa (rsa-bits-size)
  ...
  def _get_ecdsa(self):
    """
    Getter method for ecdsa, mapped from YANG variable /rbridge_id/ssh/server/key/ecdsa (ecdsa-bits-size)
    """
    return self.__ecdsa
      
  def _set_ecdsa(self, v, load=False):
    """
    Setter method for ecdsa, mapped from YANG variable /rbridge_id/ssh/server/key/ecdsa (ecdsa-bits-size)
    If this variable is read-only (config: false) in the
  ...
  def _get_dsa(self):
    """
    Getter method for dsa, mapped from YANG variable /rbridge_id/ssh/server/key/dsa (empty)
    """
    return self.__dsa
      
  def _set_dsa(self, v, load=False):
    """
    Setter method for dsa, mapped from YANG variable /rbridge_id/ssh/server/key/dsa (empty)
    If this variable is read-only (config: false) in the
