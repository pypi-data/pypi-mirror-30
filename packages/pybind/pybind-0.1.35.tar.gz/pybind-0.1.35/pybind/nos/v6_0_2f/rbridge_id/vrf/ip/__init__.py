...
class ip(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrf/ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrf', u'ip']
  ...
  def _get_vrf_router_id(self):
    """
    Getter method for vrf_router_id, mapped from YANG variable /rbridge_id/vrf/ip/vrf_router_id (inet:ipv4-address)
    """
    return self.__vrf_router_id
      
  def _set_vrf_router_id(self, v, load=False):
    """
    Setter method for vrf_router_id, mapped from YANG variable /rbridge_id/vrf/ip/vrf_router_id (inet:ipv4-address)
