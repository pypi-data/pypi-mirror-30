...
class unicast_request(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/vrrpe/arp/unicast-request. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'vrrpe', u'arp', u'unicast-request']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'Ve', u'vrrp-extended-group', u'arp', u'unicast-request']

  def _get_receive(self):
    """
    Getter method for receive, mapped from YANG variable /rbridge_id/interface/ve/vrrpe/arp/unicast_request/receive (empty)
  ...
  def _set_receive(self, v, load=False):
    """
    Setter method for receive, mapped from YANG variable /rbridge_id/interface/ve/vrrpe/arp/unicast_request/receive (empty)
