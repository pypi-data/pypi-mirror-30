...
class origin(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/origin. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'origin']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'set', u'origin']

  def _get_origin_igp(self):
    """
    Getter method for origin_igp, mapped from YANG variable /rbridge_id/route_map/content/set/origin/origin_igp (empty)
    """
    return self.__origin_igp
      
  def _set_origin_igp(self, v, load=False):
    """
    Setter method for origin_igp, mapped from YANG variable /rbridge_id/route_map/content/set/origin/origin_igp (empty)
  ...
  def _get_origin_incomplete(self):
    """
    Getter method for origin_incomplete, mapped from YANG variable /rbridge_id/route_map/content/set/origin/origin_incomplete (empty)
    """
    return self.__origin_incomplete
      
  def _set_origin_incomplete(self, v, load=False):
    """
    Setter method for origin_incomplete, mapped from YANG variable /rbridge_id/route_map/content/set/origin/origin_incomplete (empty)
    If this variable is read-only (config: false) in the
