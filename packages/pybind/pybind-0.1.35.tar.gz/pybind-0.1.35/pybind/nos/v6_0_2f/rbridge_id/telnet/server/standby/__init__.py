...
class standby(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/telnet/server/standby. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'telnet', u'server', u'standby']
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /rbridge_id/telnet/server/standby/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /rbridge_id/telnet/server/standby/enable (empty)
