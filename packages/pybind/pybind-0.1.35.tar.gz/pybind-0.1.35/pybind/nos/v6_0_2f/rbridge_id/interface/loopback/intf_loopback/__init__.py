...
class intf_loopback(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/loopback/intf-loopback. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'loopback', u'intf-loopback']
  ...
  def _get_shutdown(self):
    """
    Getter method for shutdown, mapped from YANG variable /rbridge_id/interface/loopback/intf_loopback/shutdown (empty)
    """
    return self.__shutdown
      
  def _set_shutdown(self, v, load=False):
    """
    Setter method for shutdown, mapped from YANG variable /rbridge_id/interface/loopback/intf_loopback/shutdown (empty)
