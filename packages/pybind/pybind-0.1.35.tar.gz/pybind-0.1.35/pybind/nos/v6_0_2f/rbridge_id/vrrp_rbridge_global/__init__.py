...
class vrrp_rbridge_global(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/vrrp-rbridge-global. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'vrrp-rbridge-global']
  ...
  def _get_vrrp_acceptmode_disable(self):
    """
    Getter method for vrrp_acceptmode_disable, mapped from YANG variable /rbridge_id/vrrp_rbridge_global/vrrp_acceptmode_disable (empty)
  ...
  def _set_vrrp_acceptmode_disable(self, v, load=False):
    """
    Setter method for vrrp_acceptmode_disable, mapped from YANG variable /rbridge_id/vrrp_rbridge_global/vrrp_acceptmode_disable (empty)
