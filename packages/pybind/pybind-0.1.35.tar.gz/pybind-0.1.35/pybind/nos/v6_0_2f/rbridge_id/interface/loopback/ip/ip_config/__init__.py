...
class ip_config(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/loopback/ip/ip-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'loopback', u'ip', u'ip-config']
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /rbridge_id/interface/loopback/ip/ip_config/address (list)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /rbridge_id/interface/loopback/ip/ip_config/address (list)
