...
class next_hop(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/ip/next-hop. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'ip', u'next-hop']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'set', u'ip', u'next-hop']

  def _get_peer_address(self):
    """
    Getter method for peer_address, mapped from YANG variable /rbridge_id/route_map/content/set/ip/next_hop/peer_address (empty)
  ...
  def _set_peer_address(self, v, load=False):
    """
    Setter method for peer_address, mapped from YANG variable /rbridge_id/route_map/content/set/ip/next_hop/peer_address (empty)
