...
class link_interval_properties(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/area/virtual-link/link-properties/link-interval-properties. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'area', u'virtual-link', u'link-properties', u'link-interval-properties']
  ...
  def _get_hello_interval(self):
    """
    Getter method for hello_interval, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/link_interval_properties/hello_interval (common-def:time-interval-sec)
  ...
  def _set_hello_interval(self, v, load=False):
    """
    Setter method for hello_interval, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/link_interval_properties/hello_interval (common-def:time-interval-sec)
  ...
  def _get_dead_interval(self):
    """
    Getter method for dead_interval, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/link_interval_properties/dead_interval (common-def:time-interval-sec)
  ...
  def _set_dead_interval(self, v, load=False):
    """
    Setter method for dead_interval, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/link_interval_properties/dead_interval (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
  ...
  def _get_hello_jitter(self):
    """
    Getter method for hello_jitter, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/link_interval_properties/hello_jitter (uint32)
  ...
  def _set_hello_jitter(self, v, load=False):
    """
    Setter method for hello_jitter, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/link_interval_properties/hello_jitter (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_retransmit_interval(self):
    """
    Getter method for retransmit_interval, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/link_interval_properties/retransmit_interval (common-def:time-interval-sec)
  ...
  def _set_retransmit_interval(self, v, load=False):
    """
    Setter method for retransmit_interval, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/link_interval_properties/retransmit_interval (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
  ...
  def _get_transmit_delay(self):
    """
    Getter method for transmit_delay, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/link_interval_properties/transmit_delay (common-def:time-interval-sec)
  ...
  def _set_transmit_delay(self, v, load=False):
    """
    Setter method for transmit_delay, mapped from YANG variable /rbridge_id/ipv6/router/ospf/area/virtual_link/link_properties/link_interval_properties/transmit_delay (common-def:time-interval-sec)
    If this variable is read-only (config: false) in the
