...
class virtual_ip(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ipv6/vrrpv3/virtual-ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ipv6', u'vrrpv3', u'virtual-ip']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'Ve', u'ipv6', u'vrrp-group', u'virtual-ip']

  def _get_virtual_ipaddr(self):
    """
    Getter method for virtual_ipaddr, mapped from YANG variable /rbridge_id/interface/ve/ipv6/vrrpv3/virtual_ip/virtual_ipaddr (inet:ipv6-address)
  ...
  def _set_virtual_ipaddr(self, v, load=False):
    """
    Setter method for virtual_ipaddr, mapped from YANG variable /rbridge_id/interface/ve/ipv6/vrrpv3/virtual_ip/virtual_ipaddr (inet:ipv6-address)
