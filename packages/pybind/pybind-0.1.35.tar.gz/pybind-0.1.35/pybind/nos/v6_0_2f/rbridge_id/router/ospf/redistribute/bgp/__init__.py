...
class bgp(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/ospf/redistribute/bgp. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__bgp_route_map',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf', u'redistribute', u'bgp']
  ...
  def _get_bgp_route_map(self):
    """
    Getter method for bgp_route_map, mapped from YANG variable /rbridge_id/router/ospf/redistribute/bgp/bgp_route_map (common-def:name-string63)
    """
    return self.__bgp_route_map
      
  def _set_bgp_route_map(self, v, load=False):
    """
    Setter method for bgp_route_map, mapped from YANG variable /rbridge_id/router/ospf/redistribute/bgp/bgp_route_map (common-def:name-string63)
  ...
  _pyangbind_elements = {'bgp_route_map': bgp_route_map, }
