...
class auto_cost(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/auto-cost. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'auto-cost']
  ...
  def _get_reference_bandwidth(self):
    """
    Getter method for reference_bandwidth, mapped from YANG variable /rbridge_id/ipv6/router/ospf/auto_cost/reference_bandwidth (ospf:band-width)

    YANG Description: Each interface on which OSPFv3 is enabled has a cost associated with it. By default, OSPF cost of an interface is based on the port speed of the interface. The software uses the following formula to calculate the cost.Cost = reference-bandwidth/interface-speed
    """
    return self.__reference_bandwidth
      
  def _set_reference_bandwidth(self, v, load=False):
    """
    Setter method for reference_bandwidth, mapped from YANG variable /rbridge_id/ipv6/router/ospf/auto_cost/reference_bandwidth (ospf:band-width)
