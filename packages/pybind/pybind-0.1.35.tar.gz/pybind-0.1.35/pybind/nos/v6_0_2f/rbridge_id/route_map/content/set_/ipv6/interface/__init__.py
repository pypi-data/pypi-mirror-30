...
class interface(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/ipv6/interface. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'ipv6', u'interface']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'set', u'ipv6', u'interface']

  def _get_ipv6_null0(self):
    """
    Getter method for ipv6_null0, mapped from YANG variable /rbridge_id/route_map/content/set/ipv6/interface/ipv6_null0 (empty)
    """
    return self.__ipv6_null0
      
  def _set_ipv6_null0(self, v, load=False):
    """
    Setter method for ipv6_null0, mapped from YANG variable /rbridge_id/route_map/content/set/ipv6/interface/ipv6_null0 (empty)
