...
class address(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/match/ipv6/address. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'match', u'ipv6', u'address']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'match', u'ipv6', u'address']

  def _get_ipv6_prefix_list_rmm(self):
    """
    Getter method for ipv6_prefix_list_rmm, mapped from YANG variable /rbridge_id/route_map/content/match/ipv6/address/ipv6_prefix_list_rmm (ipv6-prefix-name-t)
  ...
  def _set_ipv6_prefix_list_rmm(self, v, load=False):
    """
    Setter method for ipv6_prefix_list_rmm, mapped from YANG variable /rbridge_id/route_map/content/match/ipv6/address/ipv6_prefix_list_rmm (ipv6-prefix-name-t)
  ...
  def _get_ipv6_acl_rmm(self):
    """
    Getter method for ipv6_acl_rmm, mapped from YANG variable /rbridge_id/route_map/content/match/ipv6/address/ipv6_acl_rmm (ipv6-access-list:ipv6-l3-acl-policy-name)
  ...
  def _set_ipv6_acl_rmm(self, v, load=False):
    """
    Setter method for ipv6_acl_rmm, mapped from YANG variable /rbridge_id/route_map/content/match/ipv6/address/ipv6_acl_rmm (ipv6-access-list:ipv6-l3-acl-policy-name)
    If this variable is read-only (config: false) in the
