...
import __builtin__
class proto_vrrpv3(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/proto-vrrpv3. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__vrrp','__vrrp_extended',)

  _yang_name = 'proto-vrrpv3'
  _rest_name = 'protocol'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'proto-vrrpv3']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'protocol']

  def _get_vrrp(self):
    """
    Getter method for vrrp, mapped from YANG variable /rbridge_id/ipv6/proto_vrrpv3/vrrp (empty)

    YANG Description: Virtual Router Redundacy Protocol IPv6 (VRRPv3)
    """
    return self.__vrrp
      
  def _set_vrrp(self, v, load=False):
    """
    Setter method for vrrp, mapped from YANG variable /rbridge_id/ipv6/proto_vrrpv3/vrrp (empty)
  ...
  def _get_vrrp_extended(self):
    """
    Getter method for vrrp_extended, mapped from YANG variable /rbridge_id/ipv6/proto_vrrpv3/vrrp_extended (empty)

    YANG Description: Virtual Router Redundacy Protocol IPv6 Extended (VRRPv3-E)
    """
    return self.__vrrp_extended
      
  def _set_vrrp_extended(self, v, load=False):
    """
    Setter method for vrrp_extended, mapped from YANG variable /rbridge_id/ipv6/proto_vrrpv3/vrrp_extended (empty)
    If this variable is read-only (config: false) in the
