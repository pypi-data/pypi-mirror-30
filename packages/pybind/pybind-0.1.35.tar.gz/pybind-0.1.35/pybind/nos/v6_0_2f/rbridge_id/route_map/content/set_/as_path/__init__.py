...
class as_path(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/set/as-path. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'set', u'as-path']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'set', u'as-path']

  def _get_aspath_tag(self):
    """
    Getter method for aspath_tag, mapped from YANG variable /rbridge_id/route_map/content/set/as_path/aspath_tag (empty)
  ...
  def _set_aspath_tag(self, v, load=False):
    """
    Setter method for aspath_tag, mapped from YANG variable /rbridge_id/route_map/content/set/as_path/aspath_tag (empty)
  ...
  def _get_prepend(self):
    """
    Getter method for prepend, mapped from YANG variable /rbridge_id/route_map/content/set/as_path/prepend (string)
    """
    return self.__prepend
      
  def _set_prepend(self, v, load=False):
    """
    Setter method for prepend, mapped from YANG variable /rbridge_id/route_map/content/set/as_path/prepend (string)
    If this variable is read-only (config: false) in the
