...
class summary_address(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/summary-address. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'summary-address']
  ...
  def _get_summary_address_value(self):
    """
    Getter method for summary_address_value, mapped from YANG variable /rbridge_id/ipv6/router/ospf/summary_address/summary_address_value (common-def:ipv6-address-prefix)
  ...
  def _set_summary_address_value(self, v, load=False):
    """
    Setter method for summary_address_value, mapped from YANG variable /rbridge_id/ipv6/router/ospf/summary_address/summary_address_value (common-def:ipv6-address-prefix)
