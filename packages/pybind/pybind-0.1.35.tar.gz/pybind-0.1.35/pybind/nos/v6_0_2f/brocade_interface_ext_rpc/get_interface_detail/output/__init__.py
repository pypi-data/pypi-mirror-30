...
class output(PybindBase):
  ...
  from YANG module brocade-interface-ext - based on the path /brocade_interface_ext_rpc/get-interface-detail/output. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_interface_ext_rpc', u'get-interface-detail', u'output']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'get-interface-detail', u'output']

  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /brocade_interface_ext_rpc/get_interface_detail/output/interface (list)
...
interface.
  ...
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /brocade_interface_ext_rpc/get_interface_detail/output/interface (list)
...
interface.
  ...
  def _get_has_more(self):
    """
    Getter method for has_more, mapped from YANG variable /brocade_interface_ext_rpc/get_interface_detail/output/has_more (boolean)
...
fetched with another request.
  ...
  def _set_has_more(self, v, load=False):
    """
    Setter method for has_more, mapped from YANG variable /brocade_interface_ext_rpc/get_interface_detail/output/has_more (boolean)
    If this variable is read-only (config: false) in the
