...
class ipv6route(PybindBase):
  ...
  from YANG module brocade-common-def - based on the path /ipv6/ipv6route. Each member element of
  ...
  def _get_route(self):
    """
    Getter method for route, mapped from YANG variable /ipv6/ipv6route/route (list)
    """
    return self.__route
      
  def _set_route(self, v, load=False):
    """
    Setter method for route, mapped from YANG variable /ipv6/ipv6route/route (list)
