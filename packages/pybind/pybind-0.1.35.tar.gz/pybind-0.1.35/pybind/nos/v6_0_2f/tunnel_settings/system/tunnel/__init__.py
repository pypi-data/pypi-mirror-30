...
class tunnel(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__suppress_debounce',)
...
is down without a delay.
  ...
  _pyangbind_elements = {'suppress_debounce': suppress_debounce, }
