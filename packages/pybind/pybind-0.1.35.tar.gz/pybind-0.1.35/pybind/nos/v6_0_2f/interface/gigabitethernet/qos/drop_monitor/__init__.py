...
class drop_monitor(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/qos/drop-monitor. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'qos', u'drop-monitor']
  ...
  def _get_drop_monitor_enable(self):
    """
    Getter method for drop_monitor_enable, mapped from YANG variable /interface/gigabitethernet/qos/drop_monitor/drop_monitor_enable (empty)
    """
    return self.__drop_monitor_enable
      
  def _set_drop_monitor_enable(self, v, load=False):
    """
    Setter method for drop_monitor_enable, mapped from YANG variable /interface/gigabitethernet/qos/drop_monitor/drop_monitor_enable (empty)
