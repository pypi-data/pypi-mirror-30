...
class storm_control(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/storm-control. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'storm-control']
  ...
  def _get_ingress(self):
    """
    Getter method for ingress, mapped from YANG variable /interface/fortygigabitethernet/storm_control/ingress (list)
    """
