...
class history_control_entry(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/rmon/collection/history-control-entry. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'rmon', u'collection', u'history-control-entry']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'HundredGigabitEthernet', u'rmon', u'collection', u'history']

  def _get_history_control_index(self):
    """
    Getter method for history_control_index, mapped from YANG variable /interface/hundredgigabitethernet/rmon/collection/history_control_entry/history_control_index (history-control-index-type)
    """
    return self.__history_control_index
      
  def _set_history_control_index(self, v, load=False):
    """
    Setter method for history_control_index, mapped from YANG variable /interface/hundredgigabitethernet/rmon/collection/history_control_entry/history_control_index (history-control-index-type)
  ...
  def _get_history_control_buckets_requested(self):
    """
    Getter method for history_control_buckets_requested, mapped from YANG variable /interface/hundredgigabitethernet/rmon/collection/history_control_entry/history_control_buckets_requested (history-control-buckets-requested-type)
    """
    return self.__history_control_buckets_requested
      
  def _set_history_control_buckets_requested(self, v, load=False):
    """
    Setter method for history_control_buckets_requested, mapped from YANG variable /interface/hundredgigabitethernet/rmon/collection/history_control_entry/history_control_buckets_requested (history-control-buckets-requested-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_history_control_interval(self):
    """
    Getter method for history_control_interval, mapped from YANG variable /interface/hundredgigabitethernet/rmon/collection/history_control_entry/history_control_interval (history-control-interval-type)
    """
    return self.__history_control_interval
      
  def _set_history_control_interval(self, v, load=False):
    """
    Setter method for history_control_interval, mapped from YANG variable /interface/hundredgigabitethernet/rmon/collection/history_control_entry/history_control_interval (history-control-interval-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_history_control_owner(self):
    """
    Getter method for history_control_owner, mapped from YANG variable /interface/hundredgigabitethernet/rmon/collection/history_control_entry/history_control_owner (owner-string)
    """
    return self.__history_control_owner
      
  def _set_history_control_owner(self, v, load=False):
    """
    Setter method for history_control_owner, mapped from YANG variable /interface/hundredgigabitethernet/rmon/collection/history_control_entry/history_control_owner (owner-string)
    If this variable is read-only (config: false) in the
