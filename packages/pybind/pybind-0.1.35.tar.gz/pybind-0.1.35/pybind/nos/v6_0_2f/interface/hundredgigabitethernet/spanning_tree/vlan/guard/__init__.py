...
class guard(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/spanning-tree/vlan/guard. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'spanning-tree', u'vlan', u'guard']
  ...
  def _get_root(self):
    """
    Getter method for root, mapped from YANG variable /interface/hundredgigabitethernet/spanning_tree/vlan/guard/root (empty)
    """
    return self.__root
      
  def _set_root(self, v, load=False):
    """
    Setter method for root, mapped from YANG variable /interface/hundredgigabitethernet/spanning_tree/vlan/guard/root (empty)
