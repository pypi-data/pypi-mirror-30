...
class traffic_class(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/qos/random-detect/traffic-class. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'qos', u'random-detect', u'traffic-class']
  ...
  def _get_red_tc_value(self):
    """
    Getter method for red_tc_value, mapped from YANG variable /interface/hundredgigabitethernet/qos/random_detect/traffic_class/red_tc_value (uint32)
    """
    return self.__red_tc_value
      
  def _set_red_tc_value(self, v, load=False):
    """
    Setter method for red_tc_value, mapped from YANG variable /interface/hundredgigabitethernet/qos/random_detect/traffic_class/red_tc_value (uint32)
  ...
  def _get_red_enable(self):
    """
    Getter method for red_enable, mapped from YANG variable /interface/hundredgigabitethernet/qos/random_detect/traffic_class/red_enable (empty)
  ...
  def _set_red_enable(self, v, load=False):
    """
    Setter method for red_enable, mapped from YANG variable /interface/hundredgigabitethernet/qos/random_detect/traffic_class/red_enable (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_red_profile_id(self):
    """
    Getter method for red_profile_id, mapped from YANG variable /interface/hundredgigabitethernet/qos/random_detect/traffic_class/red_profile_id (uint32)
  ...
  def _set_red_profile_id(self, v, load=False):
    """
    Setter method for red_profile_id, mapped from YANG variable /interface/hundredgigabitethernet/qos/random_detect/traffic_class/red_profile_id (uint32)
    If this variable is read-only (config: false) in the
