...
class connectivity(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/connectivity. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'connectivity']
  ...
  def _get_deviceconnectivity(self):
    """
    Getter method for deviceconnectivity, mapped from YANG variable /interface/fortygigabitethernet/connectivity/deviceconnectivity (enumeration)
    """
    return self.__deviceconnectivity
      
  def _set_deviceconnectivity(self, v, load=False):
    """
    Setter method for deviceconnectivity, mapped from YANG variable /interface/fortygigabitethernet/connectivity/deviceconnectivity (enumeration)
