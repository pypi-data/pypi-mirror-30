...
class inspection(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/ip/arp-node-config/arp/inspection. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'ip', u'arp-node-config', u'arp', u'inspection']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'FortyGigabitEthernet', u'ip', u'arp', u'inspection']

  def _get_trust(self):
    """
    Getter method for trust, mapped from YANG variable /interface/fortygigabitethernet/ip/arp_node_config/arp/inspection/trust (empty)
    """
    return self.__trust
      
  def _set_trust(self, v, load=False):
    """
    Setter method for trust, mapped from YANG variable /interface/fortygigabitethernet/ip/arp_node_config/arp/inspection/trust (empty)
