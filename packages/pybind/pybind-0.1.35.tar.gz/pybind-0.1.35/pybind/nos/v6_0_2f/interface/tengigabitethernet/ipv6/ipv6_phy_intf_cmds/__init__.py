...
class ipv6_phy_intf_cmds(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ipv6/ipv6-phy-intf-cmds. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ipv6', u'ipv6-phy-intf-cmds']
  ...
  def _get_hop_by_hop_trap(self):
    """
    Getter method for hop_by_hop_trap, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_phy_intf_cmds/hop_by_hop_trap (empty)
    """
    return self.__hop_by_hop_trap
      
  def _set_hop_by_hop_trap(self, v, load=False):
    """
    Setter method for hop_by_hop_trap, mapped from YANG variable /interface/tengigabitethernet/ipv6/ipv6_phy_intf_cmds/hop_by_hop_trap (empty)
