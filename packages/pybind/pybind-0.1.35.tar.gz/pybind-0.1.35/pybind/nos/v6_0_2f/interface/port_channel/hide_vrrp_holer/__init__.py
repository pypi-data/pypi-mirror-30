...
import __builtin__
import vrrp
class hide_vrrp_holer(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/port-channel/hide-vrrp-holer. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__vrrp',)

  _yang_name = 'hide-vrrp-holer'
  _rest_name = ''
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'hide-vrrp-holer']
  ...
  def _get_vrrp(self):
    """
    Getter method for vrrp, mapped from YANG variable /interface/port_channel/hide_vrrp_holer/vrrp (list)
    """
    return self.__vrrp
      
  def _set_vrrp(self, v, load=False):
    """
    Setter method for vrrp, mapped from YANG variable /interface/port_channel/hide_vrrp_holer/vrrp (list)
