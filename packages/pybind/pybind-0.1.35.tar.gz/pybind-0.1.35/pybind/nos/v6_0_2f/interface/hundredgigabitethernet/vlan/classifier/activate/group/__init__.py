...
class group(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/vlan/classifier/activate/group. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'vlan', u'classifier', u'activate', u'group']
  ...
  def _get_groupid(self):
    """
    Getter method for groupid, mapped from YANG variable /interface/hundredgigabitethernet/vlan/classifier/activate/group/groupid (uint32)
    """
    return self.__groupid
      
  def _set_groupid(self, v, load=False):
    """
    Setter method for groupid, mapped from YANG variable /interface/hundredgigabitethernet/vlan/classifier/activate/group/groupid (uint32)
  ...
  def _get_vlan(self):
    """
    Getter method for vlan, mapped from YANG variable /interface/hundredgigabitethernet/vlan/classifier/activate/group/vlan (interface:vlan-type)
    """
    return self.__vlan
      
  def _set_vlan(self, v, load=False):
    """
    Setter method for vlan, mapped from YANG variable /interface/hundredgigabitethernet/vlan/classifier/activate/group/vlan (interface:vlan-type)
    If this variable is read-only (config: false) in the
