...
class service_policy(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/service-policy. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'service-policy']
  ...
  def _get_in_(self):
    """
    Getter method for in_, mapped from YANG variable /interface/port_channel/service_policy/in (map-name-type)
    """
    return self.__in_
      
  def _set_in_(self, v, load=False):
    """
    Setter method for in_, mapped from YANG variable /interface/port_channel/service_policy/in (map-name-type)
  ...
  def _get_out(self):
    """
    Getter method for out, mapped from YANG variable /interface/port_channel/service_policy/out (map-name-type)
    """
    return self.__out
      
  def _set_out(self, v, load=False):
    """
    Setter method for out, mapped from YANG variable /interface/port_channel/service_policy/out (map-name-type)
    If this variable is read-only (config: false) in the
