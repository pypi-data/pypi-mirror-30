...
class fcoeport(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/fcoeport. Each member element of
...
elements on a port.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'fcoeport']
  ...
  def _get_fcoeport_map(self):
    """
    Getter method for fcoeport_map, mapped from YANG variable /interface/hundredgigabitethernet/fcoeport/fcoeport_map (fcoe-map-name-type)
  ...
  def _set_fcoeport_map(self, v, load=False):
    """
    Setter method for fcoeport_map, mapped from YANG variable /interface/hundredgigabitethernet/fcoeport/fcoeport_map (fcoe-map-name-type)
  ...
  def _get_ns_ip_registration(self):
    """
    Getter method for ns_ip_registration, mapped from YANG variable /interface/hundredgigabitethernet/fcoeport/ns_ip_registration (empty)
  ...
  def _set_ns_ip_registration(self, v, load=False):
    """
    Setter method for ns_ip_registration, mapped from YANG variable /interface/hundredgigabitethernet/fcoeport/ns_ip_registration (empty)
    If this variable is read-only (config: false) in the
