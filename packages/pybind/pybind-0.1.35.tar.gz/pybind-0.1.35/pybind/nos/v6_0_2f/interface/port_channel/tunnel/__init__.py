...
class tunnel(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/tunnel. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'tunnel']
  ...
  def _get_tagged_ieee_bpdu(self):
    """
    Getter method for tagged_ieee_bpdu, mapped from YANG variable /interface/port_channel/tunnel/tagged_ieee_bpdu (empty)
    """
    return self.__tagged_ieee_bpdu
      
  def _set_tagged_ieee_bpdu(self, v, load=False):
    """
    Setter method for tagged_ieee_bpdu, mapped from YANG variable /interface/port_channel/tunnel/tagged_ieee_bpdu (empty)
