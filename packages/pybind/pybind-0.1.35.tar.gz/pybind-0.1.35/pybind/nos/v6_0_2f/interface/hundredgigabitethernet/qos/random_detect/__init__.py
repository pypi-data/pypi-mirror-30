...
class random_detect(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/qos/random-detect. Each member element of
  ...
  def _get_traffic_class(self):
    """
    Getter method for traffic_class, mapped from YANG variable /interface/hundredgigabitethernet/qos/random_detect/traffic_class (list)
    """
    return self.__traffic_class
      
  def _set_traffic_class(self, v, load=False):
    """
    Setter method for traffic_class, mapped from YANG variable /interface/hundredgigabitethernet/qos/random_detect/traffic_class (list)
