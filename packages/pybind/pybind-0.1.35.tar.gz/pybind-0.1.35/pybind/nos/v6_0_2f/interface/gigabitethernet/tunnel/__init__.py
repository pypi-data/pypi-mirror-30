...
class tunnel(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/tunnel. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'tunnel']
  ...
  def _get_tagged_ieee_bpdu(self):
    """
    Getter method for tagged_ieee_bpdu, mapped from YANG variable /interface/gigabitethernet/tunnel/tagged_ieee_bpdu (empty)
    """
    return self.__tagged_ieee_bpdu
      
  def _set_tagged_ieee_bpdu(self, v, load=False):
    """
    Setter method for tagged_ieee_bpdu, mapped from YANG variable /interface/gigabitethernet/tunnel/tagged_ieee_bpdu (empty)
