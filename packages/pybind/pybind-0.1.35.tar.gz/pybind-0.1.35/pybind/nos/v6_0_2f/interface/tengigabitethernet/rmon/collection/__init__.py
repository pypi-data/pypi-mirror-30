...
class collection(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/rmon/collection. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'rmon', u'collection']
  ...
  def _get_ether_stats_entry(self):
    """
    Getter method for ether_stats_entry, mapped from YANG variable /interface/tengigabitethernet/rmon/collection/ether_stats_entry (list)
    """
    return self.__ether_stats_entry
      
  def _set_ether_stats_entry(self, v, load=False):
    """
    Setter method for ether_stats_entry, mapped from YANG variable /interface/tengigabitethernet/rmon/collection/ether_stats_entry (list)
  ...
  def _get_history_control_entry(self):
    """
    Getter method for history_control_entry, mapped from YANG variable /interface/tengigabitethernet/rmon/collection/history_control_entry (list)
    """
    return self.__history_control_entry
      
  def _set_history_control_entry(self, v, load=False):
    """
    Setter method for history_control_entry, mapped from YANG variable /interface/tengigabitethernet/rmon/collection/history_control_entry (list)
    If this variable is read-only (config: false) in the
