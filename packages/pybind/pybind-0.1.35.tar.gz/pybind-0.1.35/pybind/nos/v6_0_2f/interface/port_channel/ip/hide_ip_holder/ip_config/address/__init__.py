...
class address(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/hide-ip-holder/ip-config/address. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__address','__secondary',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'hide-ip-holder', u'ip-config', u'address']
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/address/address (union)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/address/address (union)
  ...
  def _get_secondary(self):
    """
    Getter method for secondary, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/address/secondary (empty)
    """
    return self.__secondary
      
  def _set_secondary(self, v, load=False):
    """
    Setter method for secondary, mapped from YANG variable /interface/port_channel/ip/hide_ip_holder/ip_config/address/secondary (empty)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'address': address, 'secondary': secondary, }
