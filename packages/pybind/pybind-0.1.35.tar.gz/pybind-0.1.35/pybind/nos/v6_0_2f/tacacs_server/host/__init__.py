...
class host(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__hostname','__port','__protocol','__key','__encryption_level','__retries','__timeout',)
  ...
  _pyangbind_elements = {'hostname': hostname, 'port': port, 'protocol': protocol, 'key': key, 'encryption_level': encryption_level, 'retries': retries, 'timeout': timeout, }
