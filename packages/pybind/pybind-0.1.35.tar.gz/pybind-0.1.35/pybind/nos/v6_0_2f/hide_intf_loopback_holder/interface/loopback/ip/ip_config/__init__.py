...
class ip_config(PybindBase):
  ...
  from YANG module brocade-intf-loopback - based on the path /hide-intf-loopback-holder/interface/loopback/ip/ip-config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'hide-intf-loopback-holder', u'interface', u'loopback', u'ip', u'ip-config']
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /hide_intf_loopback_holder/interface/loopback/ip/ip_config/address (list)
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /hide_intf_loopback_holder/interface/loopback/ip/ip_config/address (list)
