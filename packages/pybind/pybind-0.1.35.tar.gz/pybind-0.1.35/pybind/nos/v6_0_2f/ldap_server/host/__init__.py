...
class host(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__hostname','__port','__retries','__timeout','__basedn',)
  ...
  _pyangbind_elements = {'hostname': hostname, 'port': port, 'retries': retries, 'timeout': timeout, 'basedn': basedn, }
