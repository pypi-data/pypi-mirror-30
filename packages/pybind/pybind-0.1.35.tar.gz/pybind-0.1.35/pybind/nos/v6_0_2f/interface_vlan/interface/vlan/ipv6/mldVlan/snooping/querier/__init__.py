...
class querier(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/interface/vlan/ipv6/mldVlan/snooping/querier. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface-vlan', u'interface', u'vlan', u'ipv6', u'mldVlan', u'snooping', u'querier']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Vlan', u'ipv6', u'mld', u'snooping', u'querier']

  def _get_qenable(self):
    """
    Getter method for qenable, mapped from YANG variable /interface_vlan/interface/vlan/ipv6/mldVlan/snooping/querier/qenable (empty)
    """
    return self.__qenable
      
  def _set_qenable(self, v, load=False):
    """
    Setter method for qenable, mapped from YANG variable /interface_vlan/interface/vlan/ipv6/mldVlan/snooping/querier/qenable (empty)
