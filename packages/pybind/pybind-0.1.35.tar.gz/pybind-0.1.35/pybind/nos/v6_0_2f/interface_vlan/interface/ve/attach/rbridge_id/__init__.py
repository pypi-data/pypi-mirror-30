...
class rbridge_id(PybindBase):
  ...
  def _get_rb_add(self):
    """
    Getter method for rb_add, mapped from YANG variable /interface_vlan/interface/ve/attach/rbridge_id/rb_add (comn:ui32-range)
    """
    return self.__rb_add
      
  def _set_rb_add(self, v, load=False):
    """
    Setter method for rb_add, mapped from YANG variable /interface_vlan/interface/ve/attach/rbridge_id/rb_add (comn:ui32-range)
  ...
  def _get_rb_remove(self):
    """
    Getter method for rb_remove, mapped from YANG variable /interface_vlan/interface/ve/attach/rbridge_id/rb_remove (comn:ui32-range)
    """
    return self.__rb_remove
      
  def _set_rb_remove(self, v, load=False):
    """
    Setter method for rb_remove, mapped from YANG variable /interface_vlan/interface/ve/attach/rbridge_id/rb_remove (comn:ui32-range)
    If this variable is read-only (config: false) in the
