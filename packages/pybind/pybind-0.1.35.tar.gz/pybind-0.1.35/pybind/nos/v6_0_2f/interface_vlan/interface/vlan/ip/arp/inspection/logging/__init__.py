...
class logging(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/interface/vlan/ip/arp/inspection/logging. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__acl_match',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface-vlan', u'interface', u'vlan', u'ip', u'arp', u'inspection', u'logging']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Vlan', u'ip', u'arp', u'inspection', u'logging']

  def _get_acl_match(self):
    """
    Getter method for acl_match, mapped from YANG variable /interface_vlan/interface/vlan/ip/arp/inspection/logging/acl_match (enumeration)
    """
    return self.__acl_match
      
  def _set_acl_match(self, v, load=False):
    """
    Setter method for acl_match, mapped from YANG variable /interface_vlan/interface/vlan/ip/arp/inspection/logging/acl_match (enumeration)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_acl_match is considered as a private
  ...
  _pyangbind_elements = {'acl_match': acl_match, }
