...
class input(PybindBase):
  ...
  from YANG module brocade-lag - based on the path /brocade_lag_rpc/get-portchannel-info-by-intf/input. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_lag_rpc', u'get-portchannel-info-by-intf', u'input']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'get-portchannel-info-by-intf', u'input']

  def _get_interface_type(self):
    """
    Getter method for interface_type, mapped from YANG variable /brocade_lag_rpc/get_portchannel_info_by_intf/input/interface_type (enumeration)
...
represents error scenario and should not be used.
  ...
  def _set_interface_type(self, v, load=False):
    """
    Setter method for interface_type, mapped from YANG variable /brocade_lag_rpc/get_portchannel_info_by_intf/input/interface_type (enumeration)
...
represents error scenario and should not be used.
  ...
  def _get_interface_name(self):
    """
    Getter method for interface_name, mapped from YANG variable /brocade_lag_rpc/get_portchannel_info_by_intf/input/interface_name (union)
...
'interface-type' must fail with an error.
  ...
  def _set_interface_name(self, v, load=False):
    """
    Setter method for interface_name, mapped from YANG variable /brocade_lag_rpc/get_portchannel_info_by_intf/input/interface_name (union)
    If this variable is read-only (config: false) in the
