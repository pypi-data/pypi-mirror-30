...
class qos(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__default_cos','__trust','__cos_mutation','__cos_traffic_class','__dscp_mutation','__dscp_traffic_class','__dscp_cos','__random_detect','__ecn','__drop_monitor','__rcv_queue','__flowcontrol',)
  ...
  def _get_ecn(self):
    """
    Getter method for ecn, mapped from YANG variable /interface/tengigabitethernet/qos/ecn (container)
    """
    return self.__ecn
      
  def _set_ecn(self, v, load=False):
    """
    Setter method for ecn, mapped from YANG variable /interface/tengigabitethernet/qos/ecn (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'default_cos': default_cos, 'trust': trust, 'cos_mutation': cos_mutation, 'cos_traffic_class': cos_traffic_class, 'dscp_mutation': dscp_mutation, 'dscp_traffic_class': dscp_traffic_class, 'dscp_cos': dscp_cos, 'random_detect': random_detect, 'ecn': ecn, 'drop_monitor': drop_monitor, 'rcv_queue': rcv_queue, 'flowcontrol': flowcontrol, }
