...
class static_group(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ip/igmp-phy-intf-cfg/igmp/static-group. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ip', u'igmp-phy-intf-cfg', u'igmp', u'static-group']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'TenGigabitEthernet', u'ip', u'igmp', u'static-group']

  def _get_sg_addr(self):
    """
    Getter method for sg_addr, mapped from YANG variable /interface/tengigabitethernet/ip/igmp_phy_intf_cfg/igmp/static_group/sg_addr (inet:ipv4-address)
    """
    return self.__sg_addr
      
  def _set_sg_addr(self, v, load=False):
    """
    Setter method for sg_addr, mapped from YANG variable /interface/tengigabitethernet/ip/igmp_phy_intf_cfg/igmp/static_group/sg_addr (inet:ipv4-address)
