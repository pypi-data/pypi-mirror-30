...
class activate(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/vlan/classifier/activate. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'vlan', u'classifier', u'activate']
  ...
  def _get_group(self):
    """
    Getter method for group, mapped from YANG variable /interface/hundredgigabitethernet/vlan/classifier/activate/group (list)
    """
    return self.__group
      
  def _set_group(self, v, load=False):
    """
    Setter method for group, mapped from YANG variable /interface/hundredgigabitethernet/vlan/classifier/activate/group (list)
