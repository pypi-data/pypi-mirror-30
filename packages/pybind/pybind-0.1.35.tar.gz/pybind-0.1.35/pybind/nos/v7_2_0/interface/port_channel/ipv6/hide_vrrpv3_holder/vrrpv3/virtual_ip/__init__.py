...
class virtual_ip(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ipv6/hide-vrrpv3-holder/vrrpv3/virtual-ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ipv6', u'hide-vrrpv3-holder', u'vrrpv3', u'virtual-ip']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'ipv6', u'vrrp-group', u'virtual-ip']

  def _get_virtual_ipaddr(self):
    """
    Getter method for virtual_ipaddr, mapped from YANG variable /interface/port_channel/ipv6/hide_vrrpv3_holder/vrrpv3/virtual_ip/virtual_ipaddr (inet:ipv6-address)
  ...
  def _set_virtual_ipaddr(self, v, load=False):
    """
    Setter method for virtual_ipaddr, mapped from YANG variable /interface/port_channel/ipv6/hide_vrrpv3_holder/vrrpv3/virtual_ip/virtual_ipaddr (inet:ipv6-address)
