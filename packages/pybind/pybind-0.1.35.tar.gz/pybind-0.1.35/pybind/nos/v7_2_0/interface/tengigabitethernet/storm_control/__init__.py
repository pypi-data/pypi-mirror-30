...
class storm_control(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/storm-control. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'storm-control']
  ...
  def _get_ingress(self):
    """
    Getter method for ingress, mapped from YANG variable /interface/tengigabitethernet/storm_control/ingress (list)
    """
    return self.__ingress
      
  def _set_ingress(self, v, load=False):
    """
    Setter method for ingress, mapped from YANG variable /interface/tengigabitethernet/storm_control/ingress (list)
