...
class tunnel(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/tunnel. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__tagged_ieee_bpdu',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'tunnel']
  ...
  def _get_tagged_ieee_bpdu(self):
    """
    Getter method for tagged_ieee_bpdu, mapped from YANG variable /interface/fortygigabitethernet/tunnel/tagged_ieee_bpdu (empty)
    """
    return self.__tagged_ieee_bpdu
      
  def _set_tagged_ieee_bpdu(self, v, load=False):
    """
    Setter method for tagged_ieee_bpdu, mapped from YANG variable /interface/fortygigabitethernet/tunnel/tagged_ieee_bpdu (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_tagged_ieee_bpdu is considered as a private
  ...
  _pyangbind_elements = {'tagged_ieee_bpdu': tagged_ieee_bpdu, }
