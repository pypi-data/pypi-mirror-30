...
class storm_control(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/storm-control. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'storm-control']
  ...
  def _get_ingress(self):
    """
    Getter method for ingress, mapped from YANG variable /interface/gigabitethernet/storm_control/ingress (list)
    """
    return self.__ingress
      
  def _set_ingress(self, v, load=False):
    """
    Setter method for ingress, mapped from YANG variable /interface/gigabitethernet/storm_control/ingress (list)
