...
class traffic_class(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/qos/ecn/random-detect/random-detect-ecn/traffic-class. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'qos', u'ecn', u'random-detect', u'random-detect-ecn', u'traffic-class']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'TenGigabitEthernet', u'qos', u'random-detect', u'ecn', u'traffic-class']

  def _get_red_tc_value(self):
    """
    Getter method for red_tc_value, mapped from YANG variable /interface/tengigabitethernet/qos/ecn/random_detect/random_detect_ecn/traffic_class/red_tc_value (traffic-class-id-type)
    """
    return self.__red_tc_value
      
  def _set_red_tc_value(self, v, load=False):
    """
    Setter method for red_tc_value, mapped from YANG variable /interface/tengigabitethernet/qos/ecn/random_detect/random_detect_ecn/traffic_class/red_tc_value (traffic-class-id-type)
