...
datagram that can be sent on the interface.
  ...
  def _get_protected_port(self):
    """
    Getter method for protected_port, mapped from YANG variable /interface/tengigabitethernet/protected_port (container)
  ...
  def _set_protected_port(self, v, load=False):
    """
    Setter method for protected_port, mapped from YANG variable /interface/tengigabitethernet/protected_port (container)
    If this variable is read-only (config: false) in the
...
following MAC learning process.
  ...
  def _get_rpf(self):
    """
    Getter method for rpf, mapped from YANG variable /interface/tengigabitethernet/rpf (container)
  ...
  def _set_rpf(self, v, load=False):
    """
    Setter method for rpf, mapped from YANG variable /interface/tengigabitethernet/rpf (container)
    If this variable is read-only (config: false) in the
