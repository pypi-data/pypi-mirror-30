...
class timeout(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/dot1x/timeout. Each member element of
...
configuration elements.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'dot1x', u'timeout']
  ...
  def _get_re_authperiod(self):
    """
    Getter method for re_authperiod, mapped from YANG variable /interface/fortygigabitethernet/dot1x/timeout/re_authperiod (dot1x-reauth-timeout-interval)
...
between re-authentication attempts.
  ...
  def _set_re_authperiod(self, v, load=False):
    """
    Setter method for re_authperiod, mapped from YANG variable /interface/fortygigabitethernet/dot1x/timeout/re_authperiod (dot1x-reauth-timeout-interval)
...
between re-authentication attempts.
  ...
  def _get_server_timeout(self):
    """
    Getter method for server_timeout, mapped from YANG variable /interface/fortygigabitethernet/dot1x/timeout/server_timeout (dot1x-server-timeout-interval)
...
server.
  ...
  def _set_server_timeout(self, v, load=False):
    """
    Setter method for server_timeout, mapped from YANG variable /interface/fortygigabitethernet/dot1x/timeout/server_timeout (dot1x-server-timeout-interval)
    If this variable is read-only (config: false) in the
...
server.
  ...
  def _get_supp_timeout(self):
    """
    Getter method for supp_timeout, mapped from YANG variable /interface/fortygigabitethernet/dot1x/timeout/supp_timeout (dot1x-supp-timeout-interval)
...
to client.
  ...
  def _set_supp_timeout(self, v, load=False):
    """
    Setter method for supp_timeout, mapped from YANG variable /interface/fortygigabitethernet/dot1x/timeout/supp_timeout (dot1x-supp-timeout-interval)
    If this variable is read-only (config: false) in the
...
to client.
  ...
  def _get_tx_period(self):
    """
    Getter method for tx_period, mapped from YANG variable /interface/fortygigabitethernet/dot1x/timeout/tx_period (dot1x-tx-timeout-interval)
...
retransmitting the request.
  ...
  def _set_tx_period(self, v, load=False):
    """
    Setter method for tx_period, mapped from YANG variable /interface/fortygigabitethernet/dot1x/timeout/tx_period (dot1x-tx-timeout-interval)
    If this variable is read-only (config: false) in the
