...
class random_detect(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/qos/ecn/random-detect. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'qos', u'ecn', u'random-detect']
  ...
  def _get_random_detect_ecn(self):
    """
    Getter method for random_detect_ecn, mapped from YANG variable /interface/gigabitethernet/qos/ecn/random_detect/random_detect_ecn (container)
    """
    return self.__random_detect_ecn
      
  def _set_random_detect_ecn(self, v, load=False):
    """
    Setter method for random_detect_ecn, mapped from YANG variable /interface/gigabitethernet/qos/ecn/random_detect/random_detect_ecn (container)
