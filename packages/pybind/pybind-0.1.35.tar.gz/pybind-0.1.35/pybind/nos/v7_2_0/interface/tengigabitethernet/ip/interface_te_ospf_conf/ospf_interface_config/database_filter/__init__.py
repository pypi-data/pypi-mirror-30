...
class database_filter(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ip/interface-te-ospf-conf/ospf-interface-config/database-filter. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ip', u'interface-te-ospf-conf', u'ospf-interface-config', u'database-filter']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'TenGigabitEthernet', u'ip', u'ospf', u'database-filter']

  def _get_all_out(self):
    """
    Getter method for all_out, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/database_filter/all_out (empty)
    """
    return self.__all_out
      
  def _set_all_out(self, v, load=False):
    """
    Setter method for all_out, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/database_filter/all_out (empty)
  ...
  def _get_all_external(self):
    """
    Getter method for all_external, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/database_filter/all_external (database-filter-options)
    """
    return self.__all_external
      
  def _set_all_external(self, v, load=False):
    """
    Setter method for all_external, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/database_filter/all_external (database-filter-options)
    If this variable is read-only (config: false) in the
  ...
  def _get_all_summary_external(self):
    """
    Getter method for all_summary_external, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/database_filter/all_summary_external (database-filter-options)
    """
    return self.__all_summary_external
      
  def _set_all_summary_external(self, v, load=False):
    """
    Setter method for all_summary_external, mapped from YANG variable /interface/tengigabitethernet/ip/interface_te_ospf_conf/ospf_interface_config/database_filter/all_summary_external (database-filter-options)
    If this variable is read-only (config: false) in the
