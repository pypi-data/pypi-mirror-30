...
class random_detect_ecn(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/qos/ecn/random-detect/random-detect-ecn. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'qos', u'ecn', u'random-detect', u'random-detect-ecn']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'qos', u'random-detect', u'ecn']

  def _get_traffic_class(self):
    """
    Getter method for traffic_class, mapped from YANG variable /interface/port_channel/qos/ecn/random_detect/random_detect_ecn/traffic_class (list)
    """
    return self.__traffic_class
      
  def _set_traffic_class(self, v, load=False):
    """
    Setter method for traffic_class, mapped from YANG variable /interface/port_channel/qos/ecn/random_detect/random_detect_ecn/traffic_class (list)
