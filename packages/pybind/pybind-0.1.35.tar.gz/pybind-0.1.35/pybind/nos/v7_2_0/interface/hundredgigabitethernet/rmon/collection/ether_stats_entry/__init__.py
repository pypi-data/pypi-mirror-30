...
class ether_stats_entry(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/rmon/collection/ether-stats-entry. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'rmon', u'collection', u'ether-stats-entry']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'HundredGigabitEthernet', u'rmon', u'collection', u'stats']

  def _get_ether_stats_index(self):
    """
    Getter method for ether_stats_index, mapped from YANG variable /interface/hundredgigabitethernet/rmon/collection/ether_stats_entry/ether_stats_index (ether-stats-index-type)
    """
    return self.__ether_stats_index
      
  def _set_ether_stats_index(self, v, load=False):
    """
    Setter method for ether_stats_index, mapped from YANG variable /interface/hundredgigabitethernet/rmon/collection/ether_stats_entry/ether_stats_index (ether-stats-index-type)
  ...
  def _get_ether_stats_owner(self):
    """
    Getter method for ether_stats_owner, mapped from YANG variable /interface/hundredgigabitethernet/rmon/collection/ether_stats_entry/ether_stats_owner (owner-string)
    """
    return self.__ether_stats_owner
      
  def _set_ether_stats_owner(self, v, load=False):
    """
    Setter method for ether_stats_owner, mapped from YANG variable /interface/hundredgigabitethernet/rmon/collection/ether_stats_entry/ether_stats_owner (owner-string)
    If this variable is read-only (config: false) in the
