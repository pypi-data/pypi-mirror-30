...
class virtual_ip(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/tengigabitethernet/ipv6/vrrpv3e-group/virtual-ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'tengigabitethernet', u'ipv6', u'vrrpv3e-group', u'virtual-ip']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'TenGigabitEthernet', u'ipv6', u'vrrp-extended-group', u'virtual-ip']

  def _get_virtual_ipaddr(self):
    """
    Getter method for virtual_ipaddr, mapped from YANG variable /interface/tengigabitethernet/ipv6/vrrpv3e_group/virtual_ip/virtual_ipaddr (inet:ipv6-address)
  ...
  def _set_virtual_ipaddr(self, v, load=False):
    """
    Setter method for virtual_ipaddr, mapped from YANG variable /interface/tengigabitethernet/ipv6/vrrpv3e_group/virtual_ip/virtual_ipaddr (inet:ipv6-address)
