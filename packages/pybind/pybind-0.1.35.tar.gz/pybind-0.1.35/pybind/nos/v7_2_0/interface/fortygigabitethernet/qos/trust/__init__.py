...
class trust(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/qos/trust. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'qos', u'trust']
  ...
  def _get_trust_cos(self):
    """
    Getter method for trust_cos, mapped from YANG variable /interface/fortygigabitethernet/qos/trust/trust_cos (empty)
    """
    return self.__trust_cos
      
  def _set_trust_cos(self, v, load=False):
    """
    Setter method for trust_cos, mapped from YANG variable /interface/fortygigabitethernet/qos/trust/trust_cos (empty)
  ...
  def _get_trust_dscp(self):
    """
    Getter method for trust_dscp, mapped from YANG variable /interface/fortygigabitethernet/qos/trust/trust_dscp (empty)
    """
    return self.__trust_dscp
      
  def _set_trust_dscp(self, v, load=False):
    """
    Setter method for trust_dscp, mapped from YANG variable /interface/fortygigabitethernet/qos/trust/trust_dscp (empty)
    If this variable is read-only (config: false) in the
