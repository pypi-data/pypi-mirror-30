...
class static_group(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/ip/igmp-po-intf-cfg/igmp/static-group. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'port-channel', u'ip', u'igmp-po-intf-cfg', u'igmp', u'static-group']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Port-channel', u'ip', u'igmp', u'static-group']

  def _get_sg_addr(self):
    """
    Getter method for sg_addr, mapped from YANG variable /interface/port_channel/ip/igmp_po_intf_cfg/igmp/static_group/sg_addr (inet:ipv4-address)
    """
    return self.__sg_addr
      
  def _set_sg_addr(self, v, load=False):
    """
    Setter method for sg_addr, mapped from YANG variable /interface/port_channel/ip/igmp_po_intf_cfg/igmp/static_group/sg_addr (inet:ipv4-address)
