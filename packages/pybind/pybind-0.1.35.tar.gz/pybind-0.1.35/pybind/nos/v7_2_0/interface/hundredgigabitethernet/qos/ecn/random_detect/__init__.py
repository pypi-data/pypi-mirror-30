...
import __builtin__
import random_detect_ecn
class random_detect(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/qos/ecn/random-detect. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__random_detect_ecn',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'qos', u'ecn', u'random-detect']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'HundredGigabitEthernet', u'qos', u'random-detect']

  def _get_random_detect_ecn(self):
    """
    Getter method for random_detect_ecn, mapped from YANG variable /interface/hundredgigabitethernet/qos/ecn/random_detect/random_detect_ecn (container)
    """
    return self.__random_detect_ecn
      
  def _set_random_detect_ecn(self, v, load=False):
    """
    Setter method for random_detect_ecn, mapped from YANG variable /interface/hundredgigabitethernet/qos/ecn/random_detect/random_detect_ecn (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_random_detect_ecn is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_random_detect_ecn() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  _pyangbind_elements = {'random_detect_ecn': random_detect_ecn, }
