...
class rpf(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/rpf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'rpf']
  ...
  def _get_log(self):
    """
    Getter method for log, mapped from YANG variable /interface/hundredgigabitethernet/rpf/log (empty)
  ...
  def _set_log(self, v, load=False):
    """
    Setter method for log, mapped from YANG variable /interface/hundredgigabitethernet/rpf/log (empty)
  ...
  def _get_mode(self):
    """
    Getter method for mode, mapped from YANG variable /interface/hundredgigabitethernet/rpf/mode (enumeration)

    YANG Description: Reverse Path Forwarding mode
    """
    return self.__mode
      
  def _set_mode(self, v, load=False):
    """
    Setter method for mode, mapped from YANG variable /interface/hundredgigabitethernet/rpf/mode (enumeration)
    If this variable is read-only (config: false) in the
