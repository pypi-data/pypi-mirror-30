...
class qos(PybindBase):
  ...
  def _get_ecn(self):
    """
    Getter method for ecn, mapped from YANG variable /interface/hundredgigabitethernet/qos/ecn (container)
    """
    return self.__ecn
      
  def _set_ecn(self, v, load=False):
    """
    Setter method for ecn, mapped from YANG variable /interface/hundredgigabitethernet/qos/ecn (container)
    If this variable is read-only (config: false) in the
