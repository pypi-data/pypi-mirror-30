...
class unicast_request(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/vrrp/arp/unicast-request. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'vrrp', u'arp', u'unicast-request']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'FortyGigabitEthernet', u'vrrp-group', u'arp', u'unicast-request']

  def _get_receive(self):
    """
    Getter method for receive, mapped from YANG variable /interface/fortygigabitethernet/vrrp/arp/unicast_request/receive (empty)
  ...
  def _set_receive(self, v, load=False):
    """
    Setter method for receive, mapped from YANG variable /interface/fortygigabitethernet/vrrp/arp/unicast_request/receive (empty)
