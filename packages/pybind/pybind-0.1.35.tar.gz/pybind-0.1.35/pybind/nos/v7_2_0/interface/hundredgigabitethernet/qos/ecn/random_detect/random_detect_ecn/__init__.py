...
class random_detect_ecn(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/qos/ecn/random-detect/random-detect-ecn. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__traffic_class',)

  _yang_name = 'random-detect-ecn'
  _rest_name = 'ecn'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'qos', u'ecn', u'random-detect', u'random-detect-ecn']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'HundredGigabitEthernet', u'qos', u'random-detect', u'ecn']

  def _get_traffic_class(self):
    """
    Getter method for traffic_class, mapped from YANG variable /interface/hundredgigabitethernet/qos/ecn/random_detect/random_detect_ecn/traffic_class (list)
    """
    return self.__traffic_class
      
  def _set_traffic_class(self, v, load=False):
    """
    Setter method for traffic_class, mapped from YANG variable /interface/hundredgigabitethernet/qos/ecn/random_detect/random_detect_ecn/traffic_class (list)
