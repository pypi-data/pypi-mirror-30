...
class ecn(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/qos/ecn. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'qos', u'ecn']
  ...
  def _get_random_detect(self):
    """
    Getter method for random_detect, mapped from YANG variable /interface/gigabitethernet/qos/ecn/random_detect (container)
    """
    return self.__random_detect
      
  def _set_random_detect(self, v, load=False):
    """
    Setter method for random_detect, mapped from YANG variable /interface/gigabitethernet/qos/ecn/random_detect (container)
