...
class random_detect(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/port-channel/qos/random-detect. Each member element of
  ...
  def _get_traffic_class(self):
    """
    Getter method for traffic_class, mapped from YANG variable /interface/port_channel/qos/random_detect/traffic_class (list)
    """
