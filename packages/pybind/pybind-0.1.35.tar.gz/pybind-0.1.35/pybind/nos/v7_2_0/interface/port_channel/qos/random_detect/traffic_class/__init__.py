...
class traffic_class(PybindBase):
  ...
  def _get_red_tc_value(self):
    """
    Getter method for red_tc_value, mapped from YANG variable /interface/port_channel/qos/random_detect/traffic_class/red_tc_value (uint32)
    """
    return self.__red_tc_value
      
  def _set_red_tc_value(self, v, load=False):
    """
    Setter method for red_tc_value, mapped from YANG variable /interface/port_channel/qos/random_detect/traffic_class/red_tc_value (uint32)
  ...
  def _get_red_enable(self):
    """
    Getter method for red_enable, mapped from YANG variable /interface/port_channel/qos/random_detect/traffic_class/red_enable (empty)
  ...
  def _set_red_enable(self, v, load=False):
    """
    Setter method for red_enable, mapped from YANG variable /interface/port_channel/qos/random_detect/traffic_class/red_enable (empty)
    If this variable is read-only (config: false) in the
