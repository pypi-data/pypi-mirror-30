...
class link_level_flowcontrol(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/qos/flowcontrol/link-level-flowcontrol. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'qos', u'flowcontrol', u'link-level-flowcontrol']
  ...
  def _get_flowcontrol_tx(self):
    """
    Getter method for flowcontrol_tx, mapped from YANG variable /interface/gigabitethernet/qos/flowcontrol/link_level_flowcontrol/flowcontrol_tx (enumeration)
    """
    return self.__flowcontrol_tx
      
  def _set_flowcontrol_tx(self, v, load=False):
    """
    Setter method for flowcontrol_tx, mapped from YANG variable /interface/gigabitethernet/qos/flowcontrol/link_level_flowcontrol/flowcontrol_tx (enumeration)
  ...
  def _get_flowcontrol_rx(self):
    """
    Getter method for flowcontrol_rx, mapped from YANG variable /interface/gigabitethernet/qos/flowcontrol/link_level_flowcontrol/flowcontrol_rx (enumeration)
    """
    return self.__flowcontrol_rx
      
  def _set_flowcontrol_rx(self, v, load=False):
    """
    Setter method for flowcontrol_rx, mapped from YANG variable /interface/gigabitethernet/qos/flowcontrol/link_level_flowcontrol/flowcontrol_rx (enumeration)
    If this variable is read-only (config: false) in the
