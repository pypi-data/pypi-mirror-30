...
class sflow(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/fortygigabitethernet/sflow. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'fortygigabitethernet', u'sflow']
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /interface/fortygigabitethernet/sflow/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /interface/fortygigabitethernet/sflow/enable (empty)
  ...
  def _get_polling_interval(self):
    """
    Getter method for polling_interval, mapped from YANG variable /interface/fortygigabitethernet/sflow/polling_interval (uint32)
    """
    return self.__polling_interval
      
  def _set_polling_interval(self, v, load=False):
    """
    Setter method for polling_interval, mapped from YANG variable /interface/fortygigabitethernet/sflow/polling_interval (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_sample_rate(self):
    """
    Getter method for sample_rate, mapped from YANG variable /interface/fortygigabitethernet/sflow/sample_rate (uint32)
    """
    return self.__sample_rate
      
  def _set_sample_rate(self, v, load=False):
    """
    Setter method for sample_rate, mapped from YANG variable /interface/fortygigabitethernet/sflow/sample_rate (uint32)
    If this variable is read-only (config: false) in the
