...
class igmp(PybindBase):
  ...
  def _get_last_member_query_count(self):
    """
    Getter method for last_member_query_count, mapped from YANG variable /interface/hundredgigabitethernet/ip/igmp_phy_intf_cfg/igmp/last_member_query_count (igmp-snooping:lmqc-type)
    """
    return self.__last_member_query_count
      
  def _set_last_member_query_count(self, v, load=False):
    """
    Setter method for last_member_query_count, mapped from YANG variable /interface/hundredgigabitethernet/ip/igmp_phy_intf_cfg/igmp/last_member_query_count (igmp-snooping:lmqc-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_startup_query_count(self):
    """
    Getter method for startup_query_count, mapped from YANG variable /interface/hundredgigabitethernet/ip/igmp_phy_intf_cfg/igmp/startup_query_count (igmp-snooping:sqc-type)
    """
    return self.__startup_query_count
      
  def _set_startup_query_count(self, v, load=False):
    """
    Setter method for startup_query_count, mapped from YANG variable /interface/hundredgigabitethernet/ip/igmp_phy_intf_cfg/igmp/startup_query_count (igmp-snooping:sqc-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_startup_query_interval(self):
    """
    Getter method for startup_query_interval, mapped from YANG variable /interface/hundredgigabitethernet/ip/igmp_phy_intf_cfg/igmp/startup_query_interval (igmp-snooping:sqi-type)
    """
    return self.__startup_query_interval
      
  def _set_startup_query_interval(self, v, load=False):
    """
    Setter method for startup_query_interval, mapped from YANG variable /interface/hundredgigabitethernet/ip/igmp_phy_intf_cfg/igmp/startup_query_interval (igmp-snooping:sqi-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_robustness_variable(self):
    """
    Getter method for robustness_variable, mapped from YANG variable /interface/hundredgigabitethernet/ip/igmp_phy_intf_cfg/igmp/robustness_variable (igmp-snooping:rob-type)
    """
    return self.__robustness_variable
      
  def _set_robustness_variable(self, v, load=False):
    """
    Setter method for robustness_variable, mapped from YANG variable /interface/hundredgigabitethernet/ip/igmp_phy_intf_cfg/igmp/robustness_variable (igmp-snooping:rob-type)
    If this variable is read-only (config: false) in the
