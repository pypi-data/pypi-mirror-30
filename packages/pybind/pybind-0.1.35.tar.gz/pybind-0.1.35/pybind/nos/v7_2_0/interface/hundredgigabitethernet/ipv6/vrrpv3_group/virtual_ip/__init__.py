...
class virtual_ip(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/ipv6/vrrpv3-group/virtual-ip. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'ipv6', u'vrrpv3-group', u'virtual-ip']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'HundredGigabitEthernet', u'ipv6', u'vrrp-group', u'virtual-ip']

  def _get_virtual_ipaddr(self):
    """
    Getter method for virtual_ipaddr, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/vrrpv3_group/virtual_ip/virtual_ipaddr (inet:ipv6-address)
  ...
  def _set_virtual_ipaddr(self, v, load=False):
    """
    Setter method for virtual_ipaddr, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/vrrpv3_group/virtual_ip/virtual_ipaddr (inet:ipv6-address)
