...
class igmp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/gigabitethernet/ip/igmp-phy-intf-cfg/igmp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'gigabitethernet', u'ip', u'igmp-phy-intf-cfg', u'igmp']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'GigabitEthernet', u'ip', u'igmp']

  def _get_last_member_query_interval(self):
    """
    Getter method for last_member_query_interval, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/last_member_query_interval (igmp-snooping:lmqt-type)
    """
    return self.__last_member_query_interval
      
  def _set_last_member_query_interval(self, v, load=False):
    """
    Setter method for last_member_query_interval, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/last_member_query_interval (igmp-snooping:lmqt-type)
  ...
  def _get_query_interval(self):
    """
    Getter method for query_interval, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/query_interval (igmp-snooping:qi-type)
    """
    return self.__query_interval
      
  def _set_query_interval(self, v, load=False):
    """
    Setter method for query_interval, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/query_interval (igmp-snooping:qi-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_query_max_response_time(self):
    """
    Getter method for query_max_response_time, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/query_max_response_time (igmp-snooping:qmrt-type)
    """
    return self.__query_max_response_time
      
  def _set_query_max_response_time(self, v, load=False):
    """
    Setter method for query_max_response_time, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/query_max_response_time (igmp-snooping:qmrt-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_last_member_query_count(self):
    """
    Getter method for last_member_query_count, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/last_member_query_count (igmp-snooping:lmqc-type)
    """
    return self.__last_member_query_count
      
  def _set_last_member_query_count(self, v, load=False):
    """
    Setter method for last_member_query_count, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/last_member_query_count (igmp-snooping:lmqc-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_startup_query_count(self):
    """
    Getter method for startup_query_count, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/startup_query_count (igmp-snooping:sqc-type)
    """
    return self.__startup_query_count
      
  def _set_startup_query_count(self, v, load=False):
    """
    Setter method for startup_query_count, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/startup_query_count (igmp-snooping:sqc-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_startup_query_interval(self):
    """
    Getter method for startup_query_interval, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/startup_query_interval (igmp-snooping:sqi-type)
    """
    return self.__startup_query_interval
      
  def _set_startup_query_interval(self, v, load=False):
    """
    Setter method for startup_query_interval, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/startup_query_interval (igmp-snooping:sqi-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_robustness_variable(self):
    """
    Getter method for robustness_variable, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/robustness_variable (igmp-snooping:rob-type)
    """
    return self.__robustness_variable
      
  def _set_robustness_variable(self, v, load=False):
    """
    Setter method for robustness_variable, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/robustness_variable (igmp-snooping:rob-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_immediate_leave(self):
    """
    Getter method for immediate_leave, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/immediate_leave (empty)
    """
    return self.__immediate_leave
      
  def _set_immediate_leave(self, v, load=False):
    """
    Setter method for immediate_leave, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/immediate_leave (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_static_group(self):
    """
    Getter method for static_group, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/static_group (list)
    """
    return self.__static_group
      
  def _set_static_group(self, v, load=False):
    """
    Setter method for static_group, mapped from YANG variable /interface/gigabitethernet/ip/igmp_phy_intf_cfg/igmp/static_group (list)
    If this variable is read-only (config: false) in the
