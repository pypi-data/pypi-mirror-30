...
class icmpv6(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface/hundredgigabitethernet/ipv6/icmpv6. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__echo_reply','__rate_limiting','__unreachable','__redirect',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'hundredgigabitethernet', u'ipv6', u'icmpv6']
  ...
  def _get_echo_reply(self):
    """
    Getter method for echo_reply, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/icmpv6/echo_reply (empty)
    """
    return self.__echo_reply
      
  def _set_echo_reply(self, v, load=False):
    """
    Setter method for echo_reply, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/icmpv6/echo_reply (empty)
  ...
  def _get_rate_limiting(self):
    """
    Getter method for rate_limiting, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/icmpv6/rate_limiting (uint32)
    """
    return self.__rate_limiting
      
  def _set_rate_limiting(self, v, load=False):
    """
    Setter method for rate_limiting, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/icmpv6/rate_limiting (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_unreachable(self):
    """
    Getter method for unreachable, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/icmpv6/unreachable (empty)
    """
    return self.__unreachable
      
  def _set_unreachable(self, v, load=False):
    """
    Setter method for unreachable, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/icmpv6/unreachable (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_redirect(self):
    """
    Getter method for redirect, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/icmpv6/redirect (empty)
    """
    return self.__redirect
      
  def _set_redirect(self, v, load=False):
    """
    Setter method for redirect, mapped from YANG variable /interface/hundredgigabitethernet/ipv6/icmpv6/redirect (empty)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'echo_reply': echo_reply, 'rate_limiting': rate_limiting, 'unreachable': unreachable, 'redirect': redirect, }
