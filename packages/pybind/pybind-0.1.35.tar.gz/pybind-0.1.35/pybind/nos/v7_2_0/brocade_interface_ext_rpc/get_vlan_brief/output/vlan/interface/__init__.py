...
class interface(PybindBase):
  ...
  from YANG module brocade-interface-ext - based on the path /brocade_interface_ext_rpc/get-vlan-brief/output/vlan/interface. Each member element of
...
operational details.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__interface_type','__interface_name','__tag','__classification',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__tag = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'converged': {'value': 3}, u'untagged': {'value': 1}, u'tagged': {'value': 2}},), is_leaf=True, yang_name="tag", rest_name="tag", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='urn:brocade.com:mgmt:brocade-interface-ext', defining_module='brocade-interface-ext', yang_type='enumeration', is_config=True)
    self.__classification = YANGDynClass(base=YANGListType("classification_type classification_value",classification.classification, yang_name="classification", rest_name="classification", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='classification-type classification-value', extensions=None), is_container='list', yang_name="classification", rest_name="classification", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, extensions=None, namespace='urn:brocade.com:mgmt:brocade-interface-ext', defining_module='brocade-interface-ext', yang_type='list', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'brocade_interface_ext_rpc', u'get-vlan-brief', u'output', u'vlan', u'interface']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'get-vlan-brief', u'output', u'vlan', u'interface']
...
'interface-type' must fail with an error.
  ...
  def _set_tag(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'converged': {'value': 3}, u'untagged': {'value': 1}, u'tagged': {'value': 2}},), is_leaf=True, yang_name="tag", rest_name="tag", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='urn:brocade.com:mgmt:brocade-interface-ext', defining_module='brocade-interface-ext', yang_type='enumeration', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """tag must be of a type compatible with enumeration""",
          'defined-type': "brocade-interface-ext:enumeration",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'converged': {'value': 3}, u'untagged': {'value': 1}, u'tagged': {'value': 2}},), is_leaf=True, yang_name="tag", rest_name="tag", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=False, namespace='urn:brocade.com:mgmt:brocade-interface-ext', defining_module='brocade-interface-ext', yang_type='enumeration', is_config=True)""",
        })
...
on a given vlan and an interface pair.
    ...
    try:
      ...
      raise ValueError({
          'error-string': """classification must be of a type compatible with list""",
          'defined-type': "list",
  ...
  _pyangbind_elements = {'interface_type': interface_type, 'interface_name': interface_name, 'tag': tag, 'classification': classification, }
