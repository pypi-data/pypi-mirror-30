...
class mrouter(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/interface/vlan/ipv6/mldVlan/snooping/mrouter. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface-vlan', u'interface', u'vlan', u'ipv6', u'mldVlan', u'snooping', u'mrouter']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Vlan', u'ipv6', u'mld', u'snooping', u'mrouter']

  def _get_interface(self):
    """
    Getter method for interface, mapped from YANG variable /interface_vlan/interface/vlan/ipv6/mldVlan/snooping/mrouter/interface (list)
    """
    return self.__interface
      
  def _set_interface(self, v, load=False):
    """
    Setter method for interface, mapped from YANG variable /interface_vlan/interface/vlan/ipv6/mldVlan/snooping/mrouter/interface (list)
