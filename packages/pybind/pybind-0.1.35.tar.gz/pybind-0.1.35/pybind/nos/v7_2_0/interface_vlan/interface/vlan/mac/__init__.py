...
class mac(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/interface/vlan/mac. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface-vlan', u'interface', u'vlan', u'mac']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Vlan', u'mac']

  def _get_access_group(self):
    """
    Getter method for access_group, mapped from YANG variable /interface_vlan/interface/vlan/mac/access_group (list)
    """
    return self.__access_group
      
  def _set_access_group(self, v, load=False):
    """
    Setter method for access_group, mapped from YANG variable /interface_vlan/interface/vlan/mac/access_group (list)
