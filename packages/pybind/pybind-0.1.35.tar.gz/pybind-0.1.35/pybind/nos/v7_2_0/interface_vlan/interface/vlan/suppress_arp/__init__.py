...
class suppress_arp(PybindBase):
  ...
  from YANG module brocade-interface - based on the path /interface-vlan/interface/vlan/suppress-arp. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface-vlan', u'interface', u'vlan', u'suppress-arp']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interface', u'Vlan', u'suppress-arp']

  def _get_suppress_arp_enable(self):
    """
    Getter method for suppress_arp_enable, mapped from YANG variable /interface_vlan/interface/vlan/suppress_arp/suppress_arp_enable (empty)
    """
    return self.__suppress_arp_enable
      
  def _set_suppress_arp_enable(self, v, load=False):
    """
    Setter method for suppress_arp_enable, mapped from YANG variable /interface_vlan/interface/vlan/suppress_arp/suppress_arp_enable (empty)
