...
class static_group(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ip/igmp/static-group. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ip', u'igmp', u'static-group']
  ...
  def _get_sg_addr(self):
    """
    Getter method for sg_addr, mapped from YANG variable /rbridge_id/interface/ve/ip/igmp/static_group/sg_addr (inet:ipv4-address)
    """
    return self.__sg_addr
      
  def _set_sg_addr(self, v, load=False):
    """
    Setter method for sg_addr, mapped from YANG variable /rbridge_id/interface/ve/ip/igmp/static_group/sg_addr (inet:ipv4-address)
