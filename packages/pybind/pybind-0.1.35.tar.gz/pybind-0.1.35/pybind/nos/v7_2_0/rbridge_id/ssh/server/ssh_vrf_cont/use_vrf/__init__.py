...
class use_vrf(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ssh/server/ssh-vrf-cont/use-vrf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ssh', u'server', u'ssh-vrf-cont', u'use-vrf']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ssh', u'server', u'use-vrf']

  def _get_use_vrf_name(self):
    """
    Getter method for use_vrf_name, mapped from YANG variable /rbridge_id/ssh/server/ssh_vrf_cont/use_vrf/use_vrf_name (string)
    """
    return self.__use_vrf_name
      
  def _set_use_vrf_name(self, v, load=False):
    """
    Setter method for use_vrf_name, mapped from YANG variable /rbridge_id/ssh/server/ssh_vrf_cont/use_vrf/use_vrf_name (string)
  ...
  def _get_ssh_vrf_shutdown(self):
    """
    Getter method for ssh_vrf_shutdown, mapped from YANG variable /rbridge_id/ssh/server/ssh_vrf_cont/use_vrf/ssh_vrf_shutdown (empty)
    """
    return self.__ssh_vrf_shutdown
      
  def _set_ssh_vrf_shutdown(self, v, load=False):
    """
    Setter method for ssh_vrf_shutdown, mapped from YANG variable /rbridge_id/ssh/server/ssh_vrf_cont/use_vrf/ssh_vrf_shutdown (empty)
    If this variable is read-only (config: false) in the
