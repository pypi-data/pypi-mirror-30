...
class route_target(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/l2vpn/evpn/retain/route-target. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'l2vpn', u'evpn', u'retain', u'route-target']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'l2vpn', u'evpn', u'retain', u'route-target']

  def _get_all(self):
    """
    Getter method for all, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/retain/route_target/all (empty)
    """
    return self.__all
      
  def _set_all(self, v, load=False):
    """
    Setter method for all, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/l2vpn/evpn/retain/route_target/all (empty)
