...
class import_(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/evpn-instance/route-target/import. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'evpn-instance', u'route-target', u'import']
  ...
  def _get_target_community(self):
    """
    Getter method for target_community, mapped from YANG variable /rbridge_id/evpn_instance/route_target/import/target_community (rt-type)
  ...
  def _set_target_community(self, v, load=False):
    """
    Setter method for target_community, mapped from YANG variable /rbridge_id/evpn_instance/route_target/import/target_community (rt-type)
  ...
  def _get_ignore_as(self):
    """
    Getter method for ignore_as, mapped from YANG variable /rbridge_id/evpn_instance/route_target/import/ignore_as (empty)
    """
    return self.__ignore_as
      
  def _set_ignore_as(self, v, load=False):
    """
    Setter method for ignore_as, mapped from YANG variable /rbridge_id/evpn_instance/route_target/import/ignore_as (empty)
    If this variable is read-only (config: false) in the
