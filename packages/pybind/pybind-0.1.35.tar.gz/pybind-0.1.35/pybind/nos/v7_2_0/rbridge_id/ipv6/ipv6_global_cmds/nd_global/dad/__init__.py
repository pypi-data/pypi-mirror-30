...
class dad(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/ipv6-global-cmds/nd-global/dad. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'ipv6-global-cmds', u'nd-global', u'dad']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'nd', u'dad']

  def _get_global_dad_time(self):
    """
    Getter method for global_dad_time, mapped from YANG variable /rbridge_id/ipv6/ipv6_global_cmds/nd_global/dad/global_dad_time (common-def:time-interval-sec)
    """
    return self.__global_dad_time
      
  def _set_global_dad_time(self, v, load=False):
    """
    Setter method for global_dad_time, mapped from YANG variable /rbridge_id/ipv6/ipv6_global_cmds/nd_global/dad/global_dad_time (common-def:time-interval-sec)
