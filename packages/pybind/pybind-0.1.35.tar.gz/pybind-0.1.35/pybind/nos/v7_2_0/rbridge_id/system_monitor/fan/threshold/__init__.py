...
class threshold(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/system-monitor/fan/threshold. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'system-monitor', u'fan', u'threshold']
  ...
  def _get_marginal_threshold(self):
    """
    Getter method for marginal_threshold, mapped from YANG variable /rbridge_id/system_monitor/fan/threshold/marginal_threshold (uint32)
    """
    return self.__marginal_threshold
      
  def _set_marginal_threshold(self, v, load=False):
    """
    Setter method for marginal_threshold, mapped from YANG variable /rbridge_id/system_monitor/fan/threshold/marginal_threshold (uint32)
  ...
  def _get_down_threshold(self):
    """
    Getter method for down_threshold, mapped from YANG variable /rbridge_id/system_monitor/fan/threshold/down_threshold (uint32)
    """
    return self.__down_threshold
      
  def _set_down_threshold(self, v, load=False):
    """
    Setter method for down_threshold, mapped from YANG variable /rbridge_id/system_monitor/fan/threshold/down_threshold (uint32)
    If this variable is read-only (config: false) in the
