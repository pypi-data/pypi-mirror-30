...
class vrf(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/vrf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'vrf']
  ...
  def _get_forwarding(self):
    """
    Getter method for forwarding, mapped from YANG variable /rbridge_id/interface/ve/vrf/forwarding (common-def:vrf-name)
...
with interface.
  ...
  def _set_forwarding(self, v, load=False):
    """
    Setter method for forwarding, mapped from YANG variable /rbridge_id/interface/ve/vrf/forwarding (common-def:vrf-name)
