...
class global_default_information_originate(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ipv6/router/ospf/global-default-information-originate. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'global-default-information-originate']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ipv6', u'router', u'ospf', u'default-information-originate']

  def _get_global_default_information_originate_always(self):
    """
    Getter method for global_default_information_originate_always, mapped from YANG variable /rbridge_id/ipv6/router/ospf/global_default_information_originate/global_default_information_originate_always (empty)
  ...
  def _set_global_default_information_originate_always(self, v, load=False):
    """
    Setter method for global_default_information_originate_always, mapped from YANG variable /rbridge_id/ipv6/router/ospf/global_default_information_originate/global_default_information_originate_always (empty)
  ...
  def _get_global_default_information_originate_metric(self):
    """
    Getter method for global_default_information_originate_metric, mapped from YANG variable /rbridge_id/ipv6/router/ospf/global_default_information_originate/global_default_information_originate_metric (uint32)
  ...
  def _set_global_default_information_originate_metric(self, v, load=False):
    """
    Setter method for global_default_information_originate_metric, mapped from YANG variable /rbridge_id/ipv6/router/ospf/global_default_information_originate/global_default_information_originate_metric (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_global_default_information_originate_metric_type(self):
    """
    Getter method for global_default_information_originate_metric_type, mapped from YANG variable /rbridge_id/ipv6/router/ospf/global_default_information_originate/global_default_information_originate_metric_type (ospf:metric-type)
  ...
  def _set_global_default_information_originate_metric_type(self, v, load=False):
    """
    Setter method for global_default_information_originate_metric_type, mapped from YANG variable /rbridge_id/ipv6/router/ospf/global_default_information_originate/global_default_information_originate_metric_type (ospf:metric-type)
    If this variable is read-only (config: false) in the
