...
class default_information_originate(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/ospf/default-information-originate. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'ospf', u'default-information-originate']
  ...
  def _get_always(self):
    """
    Getter method for always, mapped from YANG variable /rbridge_id/router/ospf/default_information_originate/always (empty)
    """
    return self.__always
      
  def _set_always(self, v, load=False):
    """
    Setter method for always, mapped from YANG variable /rbridge_id/router/ospf/default_information_originate/always (empty)
  ...
  def _get_def_orig_metric(self):
    """
    Getter method for def_orig_metric, mapped from YANG variable /rbridge_id/router/ospf/default_information_originate/def_orig_metric (uint32)
    """
    return self.__def_orig_metric
      
  def _set_def_orig_metric(self, v, load=False):
    """
    Setter method for def_orig_metric, mapped from YANG variable /rbridge_id/router/ospf/default_information_originate/def_orig_metric (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_def_orig_metric_type(self):
    """
    Getter method for def_orig_metric_type, mapped from YANG variable /rbridge_id/router/ospf/default_information_originate/def_orig_metric_type (metric-type)
    """
    return self.__def_orig_metric_type
      
  def _set_def_orig_metric_type(self, v, load=False):
    """
    Setter method for def_orig_metric_type, mapped from YANG variable /rbridge_id/router/ospf/default_information_originate/def_orig_metric_type (metric-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_def_orig_route_map(self):
    """
    Getter method for def_orig_route_map, mapped from YANG variable /rbridge_id/router/ospf/default_information_originate/def_orig_route_map (string)
    """
    return self.__def_orig_route_map
      
  def _set_def_orig_route_map(self, v, load=False):
    """
    Setter method for def_orig_route_map, mapped from YANG variable /rbridge_id/router/ospf/default_information_originate/def_orig_route_map (string)
    If this variable is read-only (config: false) in the
