...
class route_source(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/match/ip/route-source. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'match', u'ip', u'route-source']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'match', u'ip', u'route-source']

  def _get_prefix_list_rmrs(self):
    """
    Getter method for prefix_list_rmrs, mapped from YANG variable /rbridge_id/route_map/content/match/ip/route_source/prefix_list_rmrs (string)
  ...
  def _set_prefix_list_rmrs(self, v, load=False):
    """
    Setter method for prefix_list_rmrs, mapped from YANG variable /rbridge_id/route_map/content/match/ip/route_source/prefix_list_rmrs (string)
