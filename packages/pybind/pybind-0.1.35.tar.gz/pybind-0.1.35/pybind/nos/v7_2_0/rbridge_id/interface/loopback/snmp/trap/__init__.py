...
class trap(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/loopback/snmp/trap. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'loopback', u'snmp', u'trap']
  ...
  def _get_link_snmp_trap_status(self):
    """
    Getter method for link_snmp_trap_status, mapped from YANG variable /rbridge_id/interface/loopback/snmp/trap/link_snmp_trap_status (empty)
  ...
  def _set_link_snmp_trap_status(self, v, load=False):
    """
    Setter method for link_snmp_trap_status, mapped from YANG variable /rbridge_id/interface/loopback/snmp/trap/link_snmp_trap_status (empty)
