...
class export(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/evpn-instance/route-target/export. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'evpn-instance', u'route-target', u'export']
  ...
  def _get_target_community(self):
    """
    Getter method for target_community, mapped from YANG variable /rbridge_id/evpn_instance/route_target/export/target_community (rt-type)
  ...
  def _set_target_community(self, v, load=False):
    """
    Setter method for target_community, mapped from YANG variable /rbridge_id/evpn_instance/route_target/export/target_community (rt-type)
