...
class network(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/address-family/ipv6/ipv6-unicast/default-vrf/network. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'address-family', u'ipv6', u'ipv6-unicast', u'default-vrf', u'network']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'address-family', u'ipv6', u'unicast', u'network']

  def _get_network_ipv6_address(self):
    """
    Getter method for network_ipv6_address, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/network/network_ipv6_address (inet:ipv6-prefix)
    """
    return self.__network_ipv6_address
      
  def _set_network_ipv6_address(self, v, load=False):
    """
    Setter method for network_ipv6_address, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/network/network_ipv6_address (inet:ipv6-prefix)
  ...
  def _get_network_weight(self):
    """
    Getter method for network_weight, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/network/network_weight (absolute-decimal-number)
    """
    return self.__network_weight
      
  def _set_network_weight(self, v, load=False):
    """
    Setter method for network_weight, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/network/network_weight (absolute-decimal-number)
    If this variable is read-only (config: false) in the
  ...
  def _get_backdoor(self):
    """
    Getter method for backdoor, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/network/backdoor (empty)
    """
    return self.__backdoor
      
  def _set_backdoor(self, v, load=False):
    """
    Setter method for backdoor, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/network/backdoor (empty)
    If this variable is read-only (config: false) in the
  ...
  def _get_network_route_map(self):
    """
    Getter method for network_route_map, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/network/network_route_map (rmap-type)
    """
    return self.__network_route_map
      
  def _set_network_route_map(self, v, load=False):
    """
    Setter method for network_route_map, mapped from YANG variable /rbridge_id/router/router_bgp/address_family/ipv6/ipv6_unicast/default_vrf/network/network_route_map (rmap-type)
    If this variable is read-only (config: false) in the
