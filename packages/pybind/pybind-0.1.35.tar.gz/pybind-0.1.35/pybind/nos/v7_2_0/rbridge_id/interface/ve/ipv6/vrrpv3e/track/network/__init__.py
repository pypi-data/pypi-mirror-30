...
class network(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ipv6/vrrpv3e/track/network. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ipv6', u'vrrpv3e', u'track', u'network']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u'Ve', u'ipv6', u'vrrp-extended-group', u'track', u'network']

  def _get_network_address(self):
    """
    Getter method for network_address, mapped from YANG variable /rbridge_id/interface/ve/ipv6/vrrpv3e/track/network/network_address (common-def:ipv6-address-prefix)
  ...
  def _set_network_address(self, v, load=False):
    """
    Setter method for network_address, mapped from YANG variable /rbridge_id/interface/ve/ipv6/vrrpv3e/track/network/network_address (common-def:ipv6-address-prefix)
  ...
  def _get_network_priority(self):
    """
    Getter method for network_priority, mapped from YANG variable /rbridge_id/interface/ve/ipv6/vrrpv3e/track/network/network_priority (uint8)
    """
    return self.__network_priority
      
  def _set_network_priority(self, v, load=False):
    """
    Setter method for network_priority, mapped from YANG variable /rbridge_id/interface/ve/ipv6/vrrpv3e/track/network/network_priority (uint8)
    If this variable is read-only (config: false) in the
