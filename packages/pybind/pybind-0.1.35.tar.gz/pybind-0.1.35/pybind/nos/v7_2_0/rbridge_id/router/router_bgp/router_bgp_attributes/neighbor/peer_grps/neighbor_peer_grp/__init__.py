...
class neighbor_peer_grp(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__router_bgp_neighbor_peer_grp','__peer_group_name','__remote_as','__alternate_as','__update_source','__accept_lldp_neighbors','__description','__local_as','__next_hop_self','__advertisement_interval','__ebgp_btsh','__ebgp_multihop','__password','__enforce_first_as','__timers','__remove_private_as','__as_override','__soft_reconfiguration','__static_network_edge','__bfd','__maxas_limit','__graceful_shutdown','__af_neighbor_capability','__shutdown',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__accept_lldp_neighbors = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="accept-lldp-neighbors", rest_name="accept-lldp-neighbors", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Associate Auto Discovered LLDP neighbors'}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='empty', is_config=True)
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'neighbor', u'neighbor-peer-grp']
  ...
  def _get_accept_lldp_neighbors(self):
    """
    Getter method for accept_lldp_neighbors, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/accept_lldp_neighbors (empty)
    """
    return self.__accept_lldp_neighbors
      
  def _set_accept_lldp_neighbors(self, v, load=False):
    """
    Setter method for accept_lldp_neighbors, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/accept_lldp_neighbors (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_accept_lldp_neighbors is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_accept_lldp_neighbors() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="accept-lldp-neighbors", rest_name="accept-lldp-neighbors", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Associate Auto Discovered LLDP neighbors'}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='empty', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """accept_lldp_neighbors must be of a type compatible with empty""",
          'defined-type': "empty",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="accept-lldp-neighbors", rest_name="accept-lldp-neighbors", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Associate Auto Discovered LLDP neighbors'}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='empty', is_config=True)""",
        })

    self.__accept_lldp_neighbors = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_accept_lldp_neighbors(self):
    self.__accept_lldp_neighbors = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="accept-lldp-neighbors", rest_name="accept-lldp-neighbors", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'cli-full-command': None, u'info': u'Associate Auto Discovered LLDP neighbors'}}, namespace='urn:brocade.com:mgmt:brocade-bgp', defining_module='brocade-bgp', yang_type='empty', is_config=True)
  ...
  def _get_graceful_shutdown(self):
    """
    Getter method for graceful_shutdown, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/graceful_shutdown (container)
    """
    return self.__graceful_shutdown
      
  def _set_graceful_shutdown(self, v, load=False):
    """
    Setter method for graceful_shutdown, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/graceful_shutdown (container)
    If this variable is read-only (config: false) in the
  ...
  accept_lldp_neighbors = __builtin__.property(_get_accept_lldp_neighbors, _set_accept_lldp_neighbors)
