...
class ssh_vrf_cont(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ssh/server/ssh-vrf-cont. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ssh', u'server', u'ssh-vrf-cont']
  ...
  def _get_use_vrf(self):
    """
    Getter method for use_vrf, mapped from YANG variable /rbridge_id/ssh/server/ssh_vrf_cont/use_vrf (list)
    """
    return self.__use_vrf
      
  def _set_use_vrf(self, v, load=False):
    """
    Setter method for use_vrf, mapped from YANG variable /rbridge_id/ssh/server/ssh_vrf_cont/use_vrf (list)
