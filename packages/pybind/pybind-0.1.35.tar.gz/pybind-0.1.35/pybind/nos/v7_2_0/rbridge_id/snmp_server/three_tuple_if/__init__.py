...
import __builtin__
class three_tuple_if(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/snmp-server/three-tuple-if. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__three_tuple_if_display_enable',)

  _yang_name = 'three-tuple-if'
  _rest_name = 'three-tuple-if'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'snmp-server', u'three-tuple-if']
  ...
  def _get_three_tuple_if_display_enable(self):
    """
    Getter method for three_tuple_if_display_enable, mapped from YANG variable /rbridge_id/snmp_server/three_tuple_if/three_tuple_if_display_enable (empty)
    """
    return self.__three_tuple_if_display_enable
      
  def _set_three_tuple_if_display_enable(self, v, load=False):
    """
    Setter method for three_tuple_if_display_enable, mapped from YANG variable /rbridge_id/snmp_server/three_tuple_if/three_tuple_if_display_enable (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_three_tuple_if_display_enable is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_three_tuple_if_display_enable() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  _pyangbind_elements = {'three_tuple_if_display_enable': three_tuple_if_display_enable, }
