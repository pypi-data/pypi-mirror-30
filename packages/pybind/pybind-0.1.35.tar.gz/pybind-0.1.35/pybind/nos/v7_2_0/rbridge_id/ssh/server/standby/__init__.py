...
class standby(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/ssh/server/standby. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'ssh', u'server', u'standby']
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /rbridge_id/ssh/server/standby/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /rbridge_id/ssh/server/standby/enable (empty)
