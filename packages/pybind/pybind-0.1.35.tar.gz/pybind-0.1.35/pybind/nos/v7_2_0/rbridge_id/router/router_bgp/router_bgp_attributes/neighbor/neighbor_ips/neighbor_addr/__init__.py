...
class neighbor_addr(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__router_bgp_neighbor_address','__remote_as','__associate_peer_group','__update_source','__description','__local_as','__next_hop_self','__advertisement_interval','__ebgp_btsh','__ebgp_multihop','__password','__enforce_first_as','__timers','__remove_private_as','__as_override','__soft_reconfiguration','__static_network_edge','__bfd','__maxas_limit','__graceful_shutdown','__af_neighbor_capability','__shutdown',)

  _yang_name = 'neighbor-addr'
  _rest_name = 'neighbor-addr'
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'neighbor', u'neighbor-addr']
  ...
  def _get_graceful_shutdown(self):
    """
    Getter method for graceful_shutdown, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/graceful_shutdown (container)
    """
    return self.__graceful_shutdown
      
  def _set_graceful_shutdown(self, v, load=False):
    """
    Setter method for graceful_shutdown, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/graceful_shutdown (container)
    If this variable is read-only (config: false) in the
