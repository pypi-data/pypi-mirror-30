...
class rpf(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/rpf. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'rpf']
  ...
  def _get_log(self):
    """
    Getter method for log, mapped from YANG variable /rbridge_id/interface/ve/rpf/log (empty)
  ...
  def _set_log(self, v, load=False):
    """
    Setter method for log, mapped from YANG variable /rbridge_id/interface/ve/rpf/log (empty)
  ...
  def _get_mode(self):
    """
    Getter method for mode, mapped from YANG variable /rbridge_id/interface/ve/rpf/mode (enumeration)
  ...
  def _set_mode(self, v, load=False):
    """
    Setter method for mode, mapped from YANG variable /rbridge_id/interface/ve/rpf/mode (enumeration)
    If this variable is read-only (config: false) in the
