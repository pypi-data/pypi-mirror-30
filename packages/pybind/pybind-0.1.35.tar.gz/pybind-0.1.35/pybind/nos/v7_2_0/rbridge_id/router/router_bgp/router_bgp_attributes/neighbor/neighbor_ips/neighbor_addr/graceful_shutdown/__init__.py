...
class graceful_shutdown(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/router-bgp-attributes/neighbor/neighbor-ips/neighbor-addr/graceful-shutdown. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'neighbor-ips', u'neighbor-addr', u'graceful-shutdown']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'neighbor', u'neighbor-addr', u'graceful-shutdown']

  def _get_gshut_timer_value(self):
    """
    Getter method for gshut_timer_value, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/graceful_shutdown/gshut_timer_value (bgp-gshut-timer)
    """
    return self.__gshut_timer_value
      
  def _set_gshut_timer_value(self, v, load=False):
    """
    Setter method for gshut_timer_value, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/graceful_shutdown/gshut_timer_value (bgp-gshut-timer)
  ...
  def _get_gshut_route_map(self):
    """
    Getter method for gshut_route_map, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/graceful_shutdown/gshut_route_map (rmap-type)
    """
    return self.__gshut_route_map
      
  def _set_gshut_route_map(self, v, load=False):
    """
    Setter method for gshut_route_map, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/graceful_shutdown/gshut_route_map (rmap-type)
    If this variable is read-only (config: false) in the
  ...
  def _get_gshut_timer_attributes(self):
    """
    Getter method for gshut_timer_attributes, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/graceful_shutdown/gshut_timer_attributes (container)
    """
    return self.__gshut_timer_attributes
      
  def _set_gshut_timer_attributes(self, v, load=False):
    """
    Setter method for gshut_timer_attributes, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/graceful_shutdown/gshut_timer_attributes (container)
    If this variable is read-only (config: false) in the
