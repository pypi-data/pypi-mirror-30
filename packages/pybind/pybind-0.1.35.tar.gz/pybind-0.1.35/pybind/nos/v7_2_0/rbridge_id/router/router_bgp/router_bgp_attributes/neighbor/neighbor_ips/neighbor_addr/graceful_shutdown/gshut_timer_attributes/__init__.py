...
class gshut_timer_attributes(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/router-bgp-attributes/neighbor/neighbor-ips/neighbor-addr/graceful-shutdown/gshut-timer-attributes. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'router-bgp-attributes', u'neighbor', u'neighbor-ips', u'neighbor-addr', u'graceful-shutdown', u'gshut-timer-attributes']
  ...
  def _get_gshut_local_pref(self):
    """
    Getter method for gshut_local_pref, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/graceful_shutdown/gshut_timer_attributes/gshut_local_pref (bgp-gshut-local-pref)
    """
    return self.__gshut_local_pref
      
  def _set_gshut_local_pref(self, v, load=False):
    """
    Setter method for gshut_local_pref, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/graceful_shutdown/gshut_timer_attributes/gshut_local_pref (bgp-gshut-local-pref)
  ...
  def _get_gshut_community(self):
    """
    Getter method for gshut_community, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/graceful_shutdown/gshut_timer_attributes/gshut_community (bgp-gshut-community)
    """
    return self.__gshut_community
      
  def _set_gshut_community(self, v, load=False):
    """
    Setter method for gshut_community, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/neighbor_ips/neighbor_addr/graceful_shutdown/gshut_timer_attributes/gshut_community (bgp-gshut-community)
    If this variable is read-only (config: false) in the
