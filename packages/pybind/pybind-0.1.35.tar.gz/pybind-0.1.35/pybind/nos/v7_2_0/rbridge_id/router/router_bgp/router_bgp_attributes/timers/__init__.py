...
class timers(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/router-bgp-attributes/timers. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'router-bgp-attributes', u'timers']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'timers']

  def _get_keep_alive(self):
    """
    Getter method for keep_alive, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/timers/keep_alive (nei-keep-alive)
    """
    return self.__keep_alive
      
  def _set_keep_alive(self, v, load=False):
    """
    Setter method for keep_alive, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/timers/keep_alive (nei-keep-alive)
  ...
  def _get_hold_time(self):
    """
    Getter method for hold_time, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/timers/hold_time (nei-hold-time)
    """
    return self.__hold_time
      
  def _set_hold_time(self, v, load=False):
    """
    Setter method for hold_time, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/timers/hold_time (nei-hold-time)
    If this variable is read-only (config: false) in the
