...
class address(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/match/ip/address. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'match', u'ip', u'address']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'match', u'ip', u'address']

  def _get_prefix_list_rmm(self):
    """
    Getter method for prefix_list_rmm, mapped from YANG variable /rbridge_id/route_map/content/match/ip/address/prefix_list_rmm (ip-prefix-name-t)
  ...
  def _set_prefix_list_rmm(self, v, load=False):
    """
    Setter method for prefix_list_rmm, mapped from YANG variable /rbridge_id/route_map/content/match/ip/address/prefix_list_rmm (ip-prefix-name-t)
  ...
  def _get_acl_rmm(self):
    """
    Getter method for acl_rmm, mapped from YANG variable /rbridge_id/route_map/content/match/ip/address/acl_rmm (ip-access-list:l3-acl-policy-name)
  ...
  def _set_acl_rmm(self, v, load=False):
    """
    Setter method for acl_rmm, mapped from YANG variable /rbridge_id/route_map/content/match/ip/address/acl_rmm (ip-access-list:l3-acl-policy-name)
    If this variable is read-only (config: false) in the
