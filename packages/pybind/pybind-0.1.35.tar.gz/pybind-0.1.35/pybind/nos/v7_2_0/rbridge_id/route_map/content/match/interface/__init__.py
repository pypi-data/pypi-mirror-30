...
class interface(PybindBase):
  ...
  def _get_port_channel_rmm(self):
    """
    Getter method for port_channel_rmm, mapped from YANG variable /rbridge_id/route_map/content/match/interface/port_channel_rmm (interface:portchannel-type)
  ...
  def _set_port_channel_rmm(self, v, load=False):
    """
    Setter method for port_channel_rmm, mapped from YANG variable /rbridge_id/route_map/content/match/interface/port_channel_rmm (interface:portchannel-type)
    If this variable is read-only (config: false) in the
