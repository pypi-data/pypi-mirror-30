...
class dhcpd(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/dhcpd. Each member element of
  ...
  def __init__(self, *args, **kwargs):
    ...
    if extmethods is False:
      ...
      self._extmethods = False
    self.__enable = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="enable", rest_name="enable", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions={u'tailf-common': {u'info': u'Configure dhcpd', u'cli-full-command': None, u'callpoint': u'dhcpd_callpoint'}}, namespace='urn:brocade.com:mgmt:brocade-ip-administration', defining_module='brocade-ip-administration', yang_type='empty', is_config=True)
  ...
  def _get_enable(self):
    """
    Getter method for enable, mapped from YANG variable /rbridge_id/dhcpd/enable (empty)
    """
    return self.__enable
      
  def _set_enable(self, v, load=False):
    """
    Setter method for enable, mapped from YANG variable /rbridge_id/dhcpd/enable (empty)
