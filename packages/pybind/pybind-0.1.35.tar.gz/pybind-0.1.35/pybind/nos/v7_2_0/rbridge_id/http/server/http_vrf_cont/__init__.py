...
class http_vrf_cont(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/http/server/http-vrf-cont. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'http', u'server', u'http-vrf-cont']
  ...
  def _get_use_vrf(self):
    """
    Getter method for use_vrf, mapped from YANG variable /rbridge_id/http/server/http_vrf_cont/use_vrf (list)
    """
    return self.__use_vrf
      
  def _set_use_vrf(self, v, load=False):
    """
    Setter method for use_vrf, mapped from YANG variable /rbridge_id/http/server/http_vrf_cont/use_vrf (list)
