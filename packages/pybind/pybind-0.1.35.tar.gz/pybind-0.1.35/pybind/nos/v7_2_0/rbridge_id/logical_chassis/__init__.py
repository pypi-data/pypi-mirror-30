...
import __builtin__
class logical_chassis(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module brocade-rbridge - based on the path /rbridge-id/logical-chassis. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__principal_priority',)

  _yang_name = 'logical-chassis'
  _rest_name = 'logical-chassis'
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'logical-chassis']
  ...
  def _get_principal_priority(self):
    """
    Getter method for principal_priority, mapped from YANG variable /rbridge_id/logical_chassis/principal_priority (uint32)
    """
    return self.__principal_priority
      
  def _set_principal_priority(self, v, load=False):
    """
    Setter method for principal_priority, mapped from YANG variable /rbridge_id/logical_chassis/principal_priority (uint32)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_principal_priority is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_principal_priority() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  _pyangbind_elements = {'principal_priority': principal_priority, }
