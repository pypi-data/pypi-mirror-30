...
class ipv6_ve_intf_cmds(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/interface/ve/ipv6/ipv6-ve-intf-cmds. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'interface', u've', u'ipv6', u'ipv6-ve-intf-cmds']
  ...
  def _get_hop_by_hop_trap(self):
    """
    Getter method for hop_by_hop_trap, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_ve_intf_cmds/hop_by_hop_trap (empty)
    """
    return self.__hop_by_hop_trap
      
  def _set_hop_by_hop_trap(self, v, load=False):
    """
    Setter method for hop_by_hop_trap, mapped from YANG variable /rbridge_id/interface/ve/ipv6/ipv6_ve_intf_cmds/hop_by_hop_trap (empty)
