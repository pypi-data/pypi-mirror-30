...
class next_hop(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/match/ip/next-hop. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'match', u'ip', u'next-hop']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'match', u'ip', u'next-hop']

  def _get_prefix_list_rmm_n(self):
    """
    Getter method for prefix_list_rmm_n, mapped from YANG variable /rbridge_id/route_map/content/match/ip/next_hop/prefix_list_rmm_n (ip-prefix-name-t)
  ...
  def _set_prefix_list_rmm_n(self, v, load=False):
    """
    Setter method for prefix_list_rmm_n, mapped from YANG variable /rbridge_id/route_map/content/match/ip/next_hop/prefix_list_rmm_n (ip-prefix-name-t)
