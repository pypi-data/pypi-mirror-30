...
class policy(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/maps/policy. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__policyname','__ruleaction',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'maps', u'policy']
  ...
  def _get_policyname(self):
    """
    Getter method for policyname, mapped from YANG variable /rbridge_id/maps/policy/policyname (string)
    """
    return self.__policyname
      
  def _set_policyname(self, v, load=False):
    """
    Setter method for policyname, mapped from YANG variable /rbridge_id/maps/policy/policyname (string)
  ...
  def _get_ruleaction(self):
    """
    Getter method for ruleaction, mapped from YANG variable /rbridge_id/maps/policy/ruleaction (list)
    """
  ...
  def _set_ruleaction(self, v, load=False):
    ...
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_ruleaction() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  _pyangbind_elements = {'policyname': policyname, 'ruleaction': ruleaction, }
