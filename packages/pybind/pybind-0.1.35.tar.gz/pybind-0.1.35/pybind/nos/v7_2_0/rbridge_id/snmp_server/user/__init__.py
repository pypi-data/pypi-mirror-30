...
class user(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/snmp-server/user. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'snmp-server', u'user']
  ...
  def _get_username(self):
    """
    Getter method for username, mapped from YANG variable /rbridge_id/snmp_server/user/username (string)
    """
    return self.__username
      
  def _set_username(self, v, load=False):
    """
    Setter method for username, mapped from YANG variable /rbridge_id/snmp_server/user/username (string)
  ...
  def _get_groupname(self):
    """
    Getter method for groupname, mapped from YANG variable /rbridge_id/snmp_server/user/groupname (string)
    """
    return self.__groupname
      
  def _set_groupname(self, v, load=False):
    """
    Setter method for groupname, mapped from YANG variable /rbridge_id/snmp_server/user/groupname (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_auth(self):
    """
    Getter method for auth, mapped from YANG variable /rbridge_id/snmp_server/user/auth (enumeration)
    """
    return self.__auth
  ...
  def _get_auth_password(self):
    """
    Getter method for auth_password, mapped from YANG variable /rbridge_id/snmp_server/user/auth_password (string)
    """
    return self.__auth_password
      
  def _set_auth_password(self, v, load=False):
    """
    Setter method for auth_password, mapped from YANG variable /rbridge_id/snmp_server/user/auth_password (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_priv(self):
    """
    Getter method for priv, mapped from YANG variable /rbridge_id/snmp_server/user/priv (enumeration)
    """
    return self.__priv
  ...
  def _get_priv_password(self):
    """
    Getter method for priv_password, mapped from YANG variable /rbridge_id/snmp_server/user/priv_password (string)
    """
  ...
  def _get_encrypted(self):
    """
    Getter method for encrypted, mapped from YANG variable /rbridge_id/snmp_server/user/encrypted (empty)
    """
    return self.__encrypted
      
  def _set_encrypted(self, v, load=False):
    """
    Setter method for encrypted, mapped from YANG variable /rbridge_id/snmp_server/user/encrypted (empty)
    If this variable is read-only (config: false) in the
