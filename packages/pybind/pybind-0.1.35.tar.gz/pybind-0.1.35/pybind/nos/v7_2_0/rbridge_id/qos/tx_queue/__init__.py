...
class tx_queue(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/qos/tx-queue. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__tx_queue_limit',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'qos', u'tx-queue']
  ...
  def _get_tx_queue_limit(self):
    """
    Getter method for tx_queue_limit, mapped from YANG variable /rbridge_id/qos/tx_queue/tx_queue_limit (uint32)
    """
    return self.__tx_queue_limit
      
  def _set_tx_queue_limit(self, v, load=False):
    """
    Setter method for tx_queue_limit, mapped from YANG variable /rbridge_id/qos/tx_queue/tx_queue_limit (uint32)
  ...
  _pyangbind_elements = {'tx_queue_limit': tx_queue_limit, }
