...
class protocol_static_container(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/route-map/content/match/protocol/protocol-static-container. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'route-map', u'content', u'match', u'protocol', u'protocol-static-container']
  ...
  def _get_static(self):
    """
    Getter method for static, mapped from YANG variable /rbridge_id/route_map/content/match/protocol/protocol_static_container/static (empty)
  ...
  def _set_static(self, v, load=False):
    """
    Setter method for static, mapped from YANG variable /rbridge_id/route_map/content/match/protocol/protocol_static_container/static (empty)
