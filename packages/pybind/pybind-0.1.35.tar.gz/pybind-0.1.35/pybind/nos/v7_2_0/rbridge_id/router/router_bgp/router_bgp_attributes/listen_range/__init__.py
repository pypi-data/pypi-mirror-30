...
class listen_range(PybindBase):
  ...
  from YANG module brocade-rbridge - based on the path /rbridge-id/router/router-bgp/router-bgp-attributes/listen-range. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'router-bgp', u'router-bgp-attributes', u'listen-range']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'rbridge-id', u'router', u'bgp', u'listen-range']

  def _get_listen_range_prefix(self):
    """
    Getter method for listen_range_prefix, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/listen_range/listen_range_prefix (inet:ipv4-prefix)
    """
    return self.__listen_range_prefix
      
  def _set_listen_range_prefix(self, v, load=False):
    """
    Setter method for listen_range_prefix, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/listen_range/listen_range_prefix (inet:ipv4-prefix)
  ...
  def _get_peer_group(self):
    """
    Getter method for peer_group, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/listen_range/peer_group (bgp-peergroup)
    """
    return self.__peer_group
      
  def _set_peer_group(self, v, load=False):
    """
    Setter method for peer_group, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/listen_range/peer_group (bgp-peergroup)
    If this variable is read-only (config: false) in the
  ...
  def _get_limit(self):
    """
    Getter method for limit, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/listen_range/limit (listen-limit-type)
    """
    return self.__limit
      
  def _set_limit(self, v, load=False):
    """
    Setter method for limit, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/listen_range/limit (listen-limit-type)
    If this variable is read-only (config: false) in the
