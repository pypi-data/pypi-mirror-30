...
class update_source(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__sip_ipv4_address','__sip_ipv6_address','__ethernet_interface','__port_channel','__loopback','__ve_interface',)
  ...
  def _get_sip_ipv6_address(self):
    """
    Getter method for sip_ipv6_address, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/update_source/sip_ipv6_address (sip-ipv6-address)
    """
    return self.__sip_ipv6_address
      
  def _set_sip_ipv6_address(self, v, load=False):
    """
    Setter method for sip_ipv6_address, mapped from YANG variable /rbridge_id/router/router_bgp/router_bgp_attributes/neighbor/peer_grps/neighbor_peer_grp/update_source/sip_ipv6_address (sip-ipv6-address)
    If this variable is read-only (config: false) in the
  ...
  __choices__ = {u'ch-update-source': {u'ca-eth': [u'ethernet_interface'], u'ca-ipv6': [u'sip_ipv6_address'], u'ca-ipv4': [u'sip_ipv4_address'], u'ca-port-channel': [u'port_channel'], u'ca-ve': [u've_interface'], u'ca-loopback': [u'loopback']}}
  _pyangbind_elements = {'sip_ipv4_address': sip_ipv4_address, 'sip_ipv6_address': sip_ipv6_address, 'ethernet_interface': ethernet_interface, 'port_channel': port_channel, 'loopback': loopback, 've_interface': ve_interface, }
