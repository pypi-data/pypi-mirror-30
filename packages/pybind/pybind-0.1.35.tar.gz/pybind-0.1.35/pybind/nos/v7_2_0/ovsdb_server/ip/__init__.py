...
class ip(PybindBase):
  ...
  from YANG module brocade-tunnels - based on the path /ovsdb-server/ip. Each member element of
  ...
  def _get_address(self):
    """
    Getter method for address, mapped from YANG variable /ovsdb_server/ip/address (inet:ip-address)

    YANG Description: IPv4 address of the OVSDB server or client to connect.
    """
    return self.__address
      
  def _set_address(self, v, load=False):
    """
    Setter method for address, mapped from YANG variable /ovsdb_server/ip/address (inet:ip-address)
