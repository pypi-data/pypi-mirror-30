...
class Memory(PybindBase):
  ...
  from YANG module brocade-threshold-monitor - based on the path /threshold-monitor-hidden/threshold-monitor/Memory. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'threshold-monitor-hidden', u'threshold-monitor', u'Memory']
  ...
  def _rest_path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'threshold-monitor', u'Memory']

  def _get_poll(self):
    """
    Getter method for poll, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory/poll (uint32)
    """
    return self.__poll
      
  def _set_poll(self, v, load=False):
    """
    Setter method for poll, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory/poll (uint32)
  ...
  def _get_retry(self):
    """
    Getter method for retry, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory/retry (uint32)
    """
    return self.__retry
      
  def _set_retry(self, v, load=False):
    """
    Setter method for retry, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory/retry (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_limit(self):
    """
    Getter method for limit, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory/limit (uint32)
    """
    return self.__limit
      
  def _set_limit(self, v, load=False):
    """
    Setter method for limit, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory/limit (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_high_limit(self):
    """
    Getter method for high_limit, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory/high_limit (uint32)
    """
    return self.__high_limit
      
  def _set_high_limit(self, v, load=False):
    """
    Setter method for high_limit, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory/high_limit (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_low_limit(self):
    """
    Getter method for low_limit, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory/low_limit (uint32)
    """
    return self.__low_limit
      
  def _set_low_limit(self, v, load=False):
    """
    Setter method for low_limit, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory/low_limit (uint32)
    If this variable is read-only (config: false) in the
  ...
  def _get_actions(self):
    """
    Getter method for actions, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory/actions (enumeration)
    """
    return self.__actions
      
  def _set_actions(self, v, load=False):
    """
    Setter method for actions, mapped from YANG variable /threshold_monitor_hidden/threshold_monitor/Memory/actions (enumeration)
    If this variable is read-only (config: false) in the
