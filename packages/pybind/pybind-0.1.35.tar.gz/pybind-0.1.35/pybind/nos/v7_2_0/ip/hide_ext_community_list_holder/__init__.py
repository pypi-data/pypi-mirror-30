...
class hide_ext_community_list_holder(PybindBase):
  ...
  def _get_extcommunity_list(self):
    """
    Getter method for extcommunity_list, mapped from YANG variable /ip/hide_ext_community_list_holder/extcommunity_list (list)
    """
    return self.__extcommunity_list
      
  def _set_extcommunity_list(self, v, load=False):
    """
    Setter method for extcommunity_list, mapped from YANG variable /ip/hide_ext_community_list_holder/extcommunity_list (list)
