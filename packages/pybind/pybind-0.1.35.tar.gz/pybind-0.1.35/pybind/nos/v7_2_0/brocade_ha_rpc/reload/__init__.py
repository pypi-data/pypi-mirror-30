...
class reload(PybindBase):
  ...
  def _get_output(self):
    """
    Getter method for output, mapped from YANG variable /brocade_ha_rpc/reload/output (output)
    """
    return self.__output
      
  def _set_output(self, v, load=False):
    """
    Setter method for output, mapped from YANG variable /brocade_ha_rpc/reload/output (output)
    If this variable is read-only (config: false) in the
