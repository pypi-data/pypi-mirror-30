...
class advertise(PybindBase):
  ...
  def _get_bgp_auto_nbr_tlv(self):
    """
    Getter method for bgp_auto_nbr_tlv, mapped from YANG variable /protocol/lldp/profile/advertise/bgp_auto_nbr_tlv (empty)
    """
    return self.__bgp_auto_nbr_tlv
      
  def _set_bgp_auto_nbr_tlv(self, v, load=False):
    """
    Setter method for bgp_auto_nbr_tlv, mapped from YANG variable /protocol/lldp/profile/advertise/bgp_auto_nbr_tlv (empty)
    If this variable is read-only (config: false) in the
