...
class advertise(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_rest_name', '_extmethods', '__dcbx_fcoe_app_tlv','__dcbx_fcoe_logical_link_tlv','__dcbx_iscsi_app_tlv','__dcbx_tlv','__dot1_tlv','__dot3_tlv','__bgp_auto_nbr_tlv','__optional_tlv',)
  ...
  def _get_bgp_auto_nbr_tlv(self):
    """
    Getter method for bgp_auto_nbr_tlv, mapped from YANG variable /protocol/lldp/advertise/bgp_auto_nbr_tlv (empty)
    """
    return self.__bgp_auto_nbr_tlv
      
  def _set_bgp_auto_nbr_tlv(self, v, load=False):
    """
    Setter method for bgp_auto_nbr_tlv, mapped from YANG variable /protocol/lldp/advertise/bgp_auto_nbr_tlv (empty)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_bgp_auto_nbr_tlv is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_bgp_auto_nbr_tlv() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
  ...
  bgp_auto_nbr_tlv = __builtin__.property(_get_bgp_auto_nbr_tlv, _set_bgp_auto_nbr_tlv)
  optional_tlv = __builtin__.property(_get_optional_tlv, _set_optional_tlv)


  _pyangbind_elements = {'dcbx_fcoe_app_tlv': dcbx_fcoe_app_tlv, 'dcbx_fcoe_logical_link_tlv': dcbx_fcoe_logical_link_tlv, 'dcbx_iscsi_app_tlv': dcbx_iscsi_app_tlv, 'dcbx_tlv': dcbx_tlv, 'dot1_tlv': dot1_tlv, 'dot3_tlv': dot3_tlv, 'bgp_auto_nbr_tlv': bgp_auto_nbr_tlv, 'optional_tlv': optional_tlv, }
