...
class TestWMLClientWithKeras(unittest.TestCase):
    ...
    def test_09_monitor(self):
        ...
        with CaptureOutput() as capturer:
            process = Process(target=run_monitor, args=(self.client, TestWMLClientWithKeras.experiment_run_uid))
            process.start()
    ...
    def test_16_create_deployment(self):
        ...
        deployment_details = self.client.deployments.create(model_uid=TestWMLClientWithKeras.trained_model_uid, name="Test deployment", asynchronous=False)
