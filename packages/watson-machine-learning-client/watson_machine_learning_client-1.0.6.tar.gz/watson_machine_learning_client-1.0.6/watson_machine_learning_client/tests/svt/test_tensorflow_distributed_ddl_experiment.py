...
class TestWMLClientWithExperiment(unittest.TestCase):
    ...
    def test_09_monitor_logs(self):
        ...
        self.client.training.monitor_logs(training_uids[0])  # Call function.
        sys.stdout = sys.__stdout__  # Reset redirect.
        self.client.training.monitor_logs(training_uids[0])
        self.assertTrue("GPU" in captured_output.getvalue())
