...
class TestWMLClientWithExperiment(unittest.TestCase):
    ...
    def test_15_check_number_of_training_runs(self):
        print("NUMBER OF RUNS: " + str(len(self.client.experiments.get_details(TestWMLClientWithExperiment.experiment_uid)['resources'])))
        self.assertTrue(len(self.client.experiments.get_details(TestWMLClientWithExperiment.experiment_uid)['resources']) == 2*2)
