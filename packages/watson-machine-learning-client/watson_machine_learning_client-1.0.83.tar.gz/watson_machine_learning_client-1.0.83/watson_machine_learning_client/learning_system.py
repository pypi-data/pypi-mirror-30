...
import requests
import json
from watson_machine_learning_client.utils import get_headers, STR_TYPE, get_url, docstring_parameter, STR_TYPE_NAME, print_text_header_h2, print_text_header_h1, str_type_conv, meta_props_str_conv, StatusLogger
...
class LearningSystem(WMLResource):
    ...
    def __init__(self, client):
        ...
        self._base_published_models_url = client.wml_credentials[u'url'] + '/v3/wml_instances/' + client.wml_credentials[u'instance_id'] + '/published_models'
