...
import json
import re
from watson_machine_learning_client.utils import get_headers, print_text_header_h1, print_text_header_h2, TRAINING_RUN_DETAILS_TYPE, STR_TYPE, STR_TYPE_NAME, docstring_parameter, str_type_conv, meta_props_str_conv, group_metrics, StatusLogger
import time
...
class Training(WMLResource):
    ...
    def __init__(self, client):
        ...
        self._base_models_url = client.wml_credentials['url'] + "/v3/models"
    ...
    def run(self, definition_uid, meta_props, asynchronous=True):
        ...
        training_configuration_metadata = {
            u'model_definition': {
                ...
                u'author': {
                    # TODO u'email': meta_props[self.ConfigurationMetaNames.AUTHOR_EMAIL]
                },
