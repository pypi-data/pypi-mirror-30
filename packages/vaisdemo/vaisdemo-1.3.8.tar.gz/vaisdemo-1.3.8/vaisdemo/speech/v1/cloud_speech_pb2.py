...
# source: speech/v1/cloud_speech.proto
...
IntentRecognizeRequest = _reflection.GeneratedProtocolMessageType('IntentRecognizeRequest', (_message.Message,), dict(
  ...
  __module__ = 'speech.v1.cloud_speech_pb2'
...
StreamingIntentRecognizeResponse = _reflection.GeneratedProtocolMessageType('StreamingIntentRecognizeResponse', (_message.Message,), dict(
...
try:
  ...
  class SpeechStub(object):
    ...
    def __init__(self, channel):
      ...
      self.StreamingIntentRecognize = channel.stream_stream(
          ...
          response_deserializer=StreamingIntentRecognizeResponse.FromString,
          )
      ...
      self.Text2SpeechHmmAiHoa = channel.unary_unary(
          ...
          request_serializer=TtsRequest.SerializeToString,
          response_deserializer=TtsResponse.FromString,
          )
  ...
  def add_SpeechServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'StreamingIntentRecognize': grpc.stream_stream_rpc_method_handler(
            ...
            response_serializer=StreamingIntentRecognizeResponse.SerializeToString,
        ),
        ...
        'Text2SpeechHmmAiHoa': grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=TtsRequest.FromString,
            response_serializer=TtsResponse.SerializeToString,
        ),
  ...
  class BetaSpeechStub(object):
    ...
    def StreamingIntentRecognize(self, request_iterator, timeout, metadata=None, with_call=False, protocol_options=None):
      # missing associated documentation comment in .proto file
      pass
      raise NotImplementedError()
    def StreamingRecognize(self, request_iterator, timeout, metadata=None, with_call=False, protocol_options=None):
      ...
      pass
      raise NotImplementedError()
    def Text2SpeechHmmAiHoa(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      # missing associated documentation comment in .proto file
      pass
      raise NotImplementedError()
    Text2SpeechHmmAiHoa.future = None
    def Text2SpeechHmmMinhNguyet(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      # missing associated documentation comment in .proto file
      pass
      raise NotImplementedError()
    Text2SpeechHmmMinhNguyet.future = None
    def Text2SpeechConcatAiHoa(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      # missing associated documentation comment in .proto file
      pass
      raise NotImplementedError()
    Text2SpeechConcatAiHoa.future = None
    def Text2SpeechConcatMinhNguyet(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      # missing associated documentation comment in .proto file
      pass
      raise NotImplementedError()
    Text2SpeechConcatMinhNguyet.future = None
  ...
  def beta_create_Speech_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('vais.cloud.speech.v1.Speech', 'Recognize'): RecognizeRequest.FromString,
      ('vais.cloud.speech.v1.Speech', 'StreamingIntentRecognize'): StreamingRecognizeRequest.FromString,
      ('vais.cloud.speech.v1.Speech', 'StreamingRecognize'): StreamingRecognizeRequest.FromString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechConcatAiHoa'): TtsRequest.FromString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechConcatMinhNguyet'): TtsRequest.FromString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechHmmAiHoa'): TtsRequest.FromString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechHmmMinhNguyet'): TtsRequest.FromString,
    }
    response_serializers = {
      ('vais.cloud.speech.v1.Speech', 'Recognize'): RecognizeResponse.SerializeToString,
      ('vais.cloud.speech.v1.Speech', 'StreamingIntentRecognize'): StreamingIntentRecognizeResponse.SerializeToString,
      ('vais.cloud.speech.v1.Speech', 'StreamingRecognize'): StreamingRecognizeResponse.SerializeToString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechConcatAiHoa'): TtsResponse.SerializeToString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechConcatMinhNguyet'): TtsResponse.SerializeToString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechHmmAiHoa'): TtsResponse.SerializeToString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechHmmMinhNguyet'): TtsResponse.SerializeToString,
    }
    method_implementations = {
      ('vais.cloud.speech.v1.Speech', 'Recognize'): face_utilities.unary_unary_inline(servicer.Recognize),
      ('vais.cloud.speech.v1.Speech', 'StreamingIntentRecognize'): face_utilities.stream_stream_inline(servicer.StreamingIntentRecognize),
      ('vais.cloud.speech.v1.Speech', 'StreamingRecognize'): face_utilities.stream_stream_inline(servicer.StreamingRecognize),
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechConcatAiHoa'): face_utilities.unary_unary_inline(servicer.Text2SpeechConcatAiHoa),
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechConcatMinhNguyet'): face_utilities.unary_unary_inline(servicer.Text2SpeechConcatMinhNguyet),
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechHmmAiHoa'): face_utilities.unary_unary_inline(servicer.Text2SpeechHmmAiHoa),
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechHmmMinhNguyet'): face_utilities.unary_unary_inline(servicer.Text2SpeechHmmMinhNguyet),
    }
  ...
  def beta_create_Speech_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('vais.cloud.speech.v1.Speech', 'Recognize'): RecognizeRequest.SerializeToString,
      ('vais.cloud.speech.v1.Speech', 'StreamingIntentRecognize'): StreamingRecognizeRequest.SerializeToString,
      ('vais.cloud.speech.v1.Speech', 'StreamingRecognize'): StreamingRecognizeRequest.SerializeToString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechConcatAiHoa'): TtsRequest.SerializeToString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechConcatMinhNguyet'): TtsRequest.SerializeToString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechHmmAiHoa'): TtsRequest.SerializeToString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechHmmMinhNguyet'): TtsRequest.SerializeToString,
    }
    response_deserializers = {
      ('vais.cloud.speech.v1.Speech', 'Recognize'): RecognizeResponse.FromString,
      ('vais.cloud.speech.v1.Speech', 'StreamingIntentRecognize'): StreamingIntentRecognizeResponse.FromString,
      ('vais.cloud.speech.v1.Speech', 'StreamingRecognize'): StreamingRecognizeResponse.FromString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechConcatAiHoa'): TtsResponse.FromString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechConcatMinhNguyet'): TtsResponse.FromString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechHmmAiHoa'): TtsResponse.FromString,
      ('vais.cloud.speech.v1.Speech', 'Text2SpeechHmmMinhNguyet'): TtsResponse.FromString,
    }
    cardinalities = {
      'Recognize': cardinality.Cardinality.UNARY_UNARY,
      'StreamingIntentRecognize': cardinality.Cardinality.STREAM_STREAM,
      'StreamingRecognize': cardinality.Cardinality.STREAM_STREAM,
      'Text2SpeechConcatAiHoa': cardinality.Cardinality.UNARY_UNARY,
      'Text2SpeechConcatMinhNguyet': cardinality.Cardinality.UNARY_UNARY,
      'Text2SpeechHmmAiHoa': cardinality.Cardinality.UNARY_UNARY,
      'Text2SpeechHmmMinhNguyet': cardinality.Cardinality.UNARY_UNARY,
    }
    stub_options = beta_implementations.stub_options(host=host, metadata_transformer=metadata_transformer, request_serializers=request_serializers, response_deserializers=response_deserializers, thread_pool=pool, thread_pool_size=pool_size)
    return beta_implementations.dynamic_stub(channel, 'vais.cloud.speech.v1.Speech', cardinalities, options=stub_options)
except ImportError:
  pass
