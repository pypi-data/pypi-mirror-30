...
if sys.version_info[0] < 3:
    import cloud_speech_pb2 as speech_dot_v1_dot_cloud__speech__pb2
else:
    from . import cloud_speech_pb2 as speech_dot_v1_dot_cloud__speech__pb2
...
class SpeechStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Recognize = channel.unary_unary(
        ...
        request_serializer=speech_dot_v1_dot_cloud__speech__pb2.RecognizeRequest.SerializeToString,
        response_deserializer=speech_dot_v1_dot_cloud__speech__pb2.RecognizeResponse.FromString,
        )
    self.StreamingIntentRecognize = channel.stream_stream(
        '/vais.cloud.speech.v1.Speech/StreamingIntentRecognize',
        request_serializer=speech_dot_v1_dot_cloud__speech__pb2.StreamingRecognizeRequest.SerializeToString,
        response_deserializer=speech_dot_v1_dot_cloud__speech__pb2.StreamingIntentRecognizeResponse.FromString,
        )
    self.StreamingRecognize = channel.stream_stream(
        '/vais.cloud.speech.v1.Speech/StreamingRecognize',
        request_serializer=speech_dot_v1_dot_cloud__speech__pb2.StreamingRecognizeRequest.SerializeToString,
        response_deserializer=speech_dot_v1_dot_cloud__speech__pb2.StreamingRecognizeResponse.FromString,
        )
    self.Text2SpeechHmmAiHoa = channel.unary_unary(
        '/vais.cloud.speech.v1.Speech/Text2SpeechHmmAiHoa',
        request_serializer=speech_dot_v1_dot_cloud__speech__pb2.TtsRequest.SerializeToString,
        response_deserializer=speech_dot_v1_dot_cloud__speech__pb2.TtsResponse.FromString,
        )
...
def add_SpeechServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Recognize': grpc.unary_unary_rpc_method_handler(
          servicer.Recognize,
          request_deserializer=speech_dot_v1_dot_cloud__speech__pb2.RecognizeRequest.FromString,
          response_serializer=speech_dot_v1_dot_cloud__speech__pb2.RecognizeResponse.SerializeToString,
      ),
      'StreamingIntentRecognize': grpc.stream_stream_rpc_method_handler(
          servicer.StreamingIntentRecognize,
          request_deserializer=speech_dot_v1_dot_cloud__speech__pb2.StreamingRecognizeRequest.FromString,
          response_serializer=speech_dot_v1_dot_cloud__speech__pb2.StreamingIntentRecognizeResponse.SerializeToString,
      ),
      'StreamingRecognize': grpc.stream_stream_rpc_method_handler(
          servicer.StreamingRecognize,
          request_deserializer=speech_dot_v1_dot_cloud__speech__pb2.StreamingRecognizeRequest.FromString,
          response_serializer=speech_dot_v1_dot_cloud__speech__pb2.StreamingRecognizeResponse.SerializeToString,
      ),
      'Text2SpeechHmmAiHoa': grpc.unary_unary_rpc_method_handler(
          servicer.Text2SpeechHmmAiHoa,
          request_deserializer=speech_dot_v1_dot_cloud__speech__pb2.TtsRequest.FromString,
          response_serializer=speech_dot_v1_dot_cloud__speech__pb2.TtsResponse.SerializeToString,
      ),
