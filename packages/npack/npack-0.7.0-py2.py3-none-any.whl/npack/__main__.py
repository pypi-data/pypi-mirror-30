...
def main():
    ...
    | \| | __|_   _| __| |  |_ _\ \/ /    
    | .` | _|  | | | _|| |__ | | >  <     
    |_|\_|___| |_| |_| |____|___/_/\_\    npack.py version 0.7.0
    ...
    try:
        ...
        if args.act == "zip":
            ...
            eprint("%s | Please select either zip or checksum option. Option < %s > is not supported." % (datetime.utcnow(), args.act))
            parser.print_help()
