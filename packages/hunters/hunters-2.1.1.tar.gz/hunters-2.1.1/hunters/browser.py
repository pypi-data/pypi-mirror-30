...
class MiniBrowser(Browser):
    ...
    def __init__(self, browser_config=DEFAULT_BROWSER_CONFIG):
        ...
        self._user_agent = self._browser_config.user_agent
...
class BaseChrome(Browser):
    ...
    def user_agent(self, user_agent):
        ...
        self.api.Network.setUserAgentOverride(user_agent)
...
class ViewBrowser(Chrome):
    """The View Browser is extend by Chrome
    Every New ViewBrowser Instance will create a new Chrome
    """
...
class TabBrowser(ChromeTab):
    """The Tab Browser is extend by ChromeTab
