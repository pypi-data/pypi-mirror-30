...
def validate():
    ...
    temp_template_file = FileRetriever.retrieve(APIDefinition.TEMPLATE_FILE_FORM_NAME)
...
def parse():
    ...
    gabarit_file_mapping = FileRetriever.retrieve_multiple(APIDefinition.GABARIT_FORM_NAME, '.odt')

    annexe_file_mapping = FileRetriever.retrieve_multiple(APIDefinition.ANNEXE_FORM_NAME, '.pdf')
