...
if __name__ == '__main__':
    ...
    geofield = pickle.load(open('/export/cpc-lw-mcharles/mcharles/pycharm-deployments/fcst-consolidation/field.bin', 'rb'))

    geofield.fill_coastal_vals = False

    geomap = Geomap()
    geomap.plot(geofield)
    geomap.save('/export/cpc-lw-mcharles/mcharles/pycharm-deployments/fcst-consolidation/test.png', dpi=300)
