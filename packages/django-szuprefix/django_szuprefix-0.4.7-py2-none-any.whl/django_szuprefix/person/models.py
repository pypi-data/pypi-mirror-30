...
class Person(models.Model):
    class Meta:
        verbose_name_plural = verbose_name = u"个人"
    ...
    gender = models.CharField(u"性别", max_length=1, choices=choices.CHOICES_GENDER, default=choices.GENDER_UNDEFINED)
    mobile = models.CharField(u"手机", max_length=64, db_index=True, null=True, blank=True)
    email = models.CharField(u"邮箱", max_length=64, db_index=True, null=True, blank=True)
    id_card = models.CharField(u"身份证", max_length=18, db_index=True, null=True, blank=True)
    ...
    ethnic = models.CharField(u"民族", max_length=64, null=True, blank=True)
