...
class Organization(models.Model):
    class Meta:
        verbose_name_plural = verbose_name = u"组织机构"
    ...
    brief_name = models.CharField(u"简称", max_length=128, blank=True)
    oibc = models.CharField(u"组织机构代码", max_length=10, null=True, blank=True)
    usci = models.CharField(u"统一社会信用代码", max_length=18, null=True, blank=True)
    logo = models.ImageField(u"logo", null=True, blank=True)
    establish_date = models.DateField(u"创立日期", null=True, blank=True)
    address = models.CharField(u"地址",  max_length=256, null=True, blank=True)
    website = models.CharField(u"网站",  max_length=256, null=True, blank=True)
