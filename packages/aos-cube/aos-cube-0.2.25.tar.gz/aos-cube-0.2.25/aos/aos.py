...
def new(name, scm='git', component=False, protocol=None):
    ...
    if d_type == 'program':
        ...
        # p.set_root()
        import requests
        github_rtt = requests.get('https://raw.githubusercontent.com/alibaba/AliOS-Things/master/README.md').elapsed.total_seconds()
        gitee_rtt = requests.get('https://gitee.com/alios-things/AliOS-Things/raw/master/README.md').elapsed.total_seconds()
