...
class NetworkWatcher(Resource):
    ...
    def __init__(self, *, id: str=None, location: str=None, tags=None, etag: str="A unique read-only string that changes whenever the resource is updated.", **kwargs) -> None:
