...
class PacketCapturesOperations(object):
    ...
    def get_status(
        ...
        :rtype:
         ...
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2016_09_01.models.PacketCaptureQueryStatusResult]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
