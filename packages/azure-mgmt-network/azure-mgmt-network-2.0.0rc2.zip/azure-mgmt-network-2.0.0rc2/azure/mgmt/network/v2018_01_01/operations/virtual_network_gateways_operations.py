...
class VirtualNetworkGatewaysOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_01_01.models.VirtualNetworkGatewayPaged[~azure.mgmt.network.v2018_01_01.models.VirtualNetworkGateway]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list_connections(
        ...
        :rtype:
         ~azure.mgmt.network.v2018_01_01.models.VirtualNetworkGatewayConnectionListEntityPaged[~azure.mgmt.network.v2018_01_01.models.VirtualNetworkGatewayConnectionListEntity]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def internal_paging(next_link=None, raw=False):
    ...
    def generatevpnclientpackage(
        ...
        :type parameters:
         ~azure.mgmt.network.v2018_01_01.models.VpnClientParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def vpn_device_configuration_script(
        ...
        :param parameters: Parameters supplied to the generate vpn device
         script operation.
        :type parameters:
         ~azure.mgmt.network.v2018_01_01.models.VpnDeviceScriptParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
