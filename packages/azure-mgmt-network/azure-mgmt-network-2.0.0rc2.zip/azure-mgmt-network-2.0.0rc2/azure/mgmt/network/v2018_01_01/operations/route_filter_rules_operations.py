...
class RouteFilterRulesOperations(object):
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.network.v2018_01_01.models.RouteFilterRule]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.RouteFilterRule]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
