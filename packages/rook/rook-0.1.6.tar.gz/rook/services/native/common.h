...
// CHANGE - changed includes
#include <stdint.h>

#include "glog/logging.h"

// CHANGE - added includes
#include <string>
#include <vector>

// CHANGE - added macro (gflags replacement)
#define DEFINE_int32(name, value, description) const int FLAGS_##name = value
