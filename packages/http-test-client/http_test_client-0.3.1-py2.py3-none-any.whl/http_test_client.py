...
class Client(object):
    ...
    def json_request(self, url, method=None, headers=None, data=None, **kwargs):
    ...
    def _json_request(self, *args, **kwargs):
        return super(Client, self).json_request(*args, **kwargs)
...
class Api(object):
    ...
    def _request(self, url=None, *args, **kwargs):
        return self._client._request(self._url + (url or ''), *args, **kwargs)

    def _json_request(self, url=None, *args, **kwargs):
        return self._client._json_request(self._url + (url or ''), *args, **kwargs)
...
class RestResource(Api):
    def get(self, **kwargs):
        try:
            return self._json_request(method='GET', **kwargs)
    ...
    def update(self, data, **kwargs):
        return self._json_request(method='PUT', data=data, **kwargs)

    def delete(self, **kwargs):
        try:
            response = self._json_request(method='DELETE', **kwargs)
        except ClientError as ce:
            if ce.status_code != 404:
                raise ce
...
class RestResources(Api):
    ...
    def create(self, data, **kwargs):
        result = self._json_request(method='POST', data=data, **kwargs)
