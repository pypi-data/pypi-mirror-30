...
class HMDBasedCalibration(object):
    ...
    def collect_data(self, x, y, z):
        ...
        return _calibration_status[tobii_pro.hmd_based_calibration_collect_data(self.__core_eyetracker, x, y, z)]
    ...
    def compute_and_apply(self):
        ...
        '''
        interop_result = tobii_pro.hmd_based_calibration_compute_and_apply(self.__core_eyetracker)
