...
class ScreenBasedMonocularCalibration(object):
    ...
    def enter_calibration_mode(self):
        ...
        '''
        tobii_pro.calibration_enter_calibration_mode(self.__core_eyetracker)
    ...
    def leave_calibration_mode(self):
        ...
        EyeTrackerInternalError
        '''
        tobii_pro.calibration_leave_calibration_mode(self.__core_eyetracker)
    ...
    def collect_data(self, x, y, eye_to_calibrate):
        ...
        status = tobii_pro.screen_based_monocular_calibration_collect_data(self.__core_eyetracker, x, y, selected_eye)
    ...
    def discard_data(self, x, y, eye_to_calibrate):
        ...
        if eye_to_calibrate not in _selected_eye:
            raise ValueError("eye_to_calibrate argument is invalid!")
        selected_eye = _selected_eye.index(eye_to_calibrate)
        tobii_pro.screen_based_monocular_calibration_discard_data(self.__core_eyetracker, x, y, selected_eye)
    ...
    def compute_and_apply(self):
        ...
        '''
        interop_result = tobii_pro.screen_based_monocular_calibration_compute_and_apply(self.__core_eyetracker)
