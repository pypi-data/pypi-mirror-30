...
class ScreenBasedCalibration(object):
    ...
    def collect_data(self, x, y):
        ...
        return _calibration_status[tobii_pro.screen_based_calibration_collect_data(self.__core_eyetracker, x, y)]
    ...
    def discard_data(self, x, y):
        ...
        '''
        x, y = (float(_) for _ in (x, y))
        tobii_pro.screen_based_calibration_discard_data(self.__core_eyetracker, x, y)
