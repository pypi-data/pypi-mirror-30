...
if sys.version_info[0] == 3:
    from tobiiresearch.interop.python3 import tobii_pro_internal
else:
    from tobiiresearch.interop.python2 import tobii_pro_internal
...
def __call_function(function_name, arguments):
    ...
    call_result = tobii_pro_internal.call_function(function_name, arguments, result_callback)
