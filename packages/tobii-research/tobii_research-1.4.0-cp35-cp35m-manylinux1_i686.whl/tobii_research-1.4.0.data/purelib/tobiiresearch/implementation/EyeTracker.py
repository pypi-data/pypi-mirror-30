...
def _logging_subscribe(callback, as_dictionary=False):
    tobii_pro.subscribe_to(0, "", None, 0, lambda x: __log_callback(callback, as_dictionary, x))


def _logging_unsubscribe():
    tobii_pro.unsubscribe_from(0, None, 0)
...
class EyeTracker(object):
    ...
    def __del__(self):
        with self.__subscription_lock:
            for subscription_type in self.__subscriptions.keys():
                tobii_pro.unsubscribe_from(subscription_type, self, self.__core_eyetracker)
    ...
    def apply_licenses(self, license_key_ring):
        ...
        if isinstance(license_key_ring, bytes):
            return tobii_pro.apply_licenses(self.__core_eyetracker, (license_key_ring,))
        elif hasattr(license_key_ring, 'key_string'):
            return tobii_pro.apply_licenses(self.__core_eyetracker, (license_key_ring.key_string,))
        else:
            return tobii_pro.apply_licenses(self.__core_eyetracker,
    ...
    def clear_applied_licenses(self):
        ...
        '''
        return tobii_pro.clear_applied_licenses(self.__core_eyetracker)
    ...
    def retrieve_calibration_data(self):
        ...
        EyeTrackerLicenseError
        '''
        return tobii_pro.calibration_retrieve(self.__core_eyetracker)
    ...
    def apply_calibration_data(self, calibration_data):
        ...
        ValueError
        '''
        tobii_pro.calibration_apply(self.__core_eyetracker, calibration_data)
    ...
    def get_all_gaze_output_frequencies(self):
        ...
        '''
        return tobii_pro.get_all_gaze_output_frequencies(self.__core_eyetracker)
    ...
    def get_gaze_output_frequency(self):
        ...
        '''
        return tobii_pro.get_gaze_output_frequency(self.__core_eyetracker)
    ...
    def set_gaze_output_frequency(self, gaze_output_frequency):
        ...
        ValueError
        '''
        return tobii_pro.set_gaze_output_frequency(self.__core_eyetracker, float(gaze_output_frequency))
    ...
    def get_all_eye_tracking_modes(self):
        ...
        '''
        return tobii_pro.get_all_eye_tracking_modes(self.__core_eyetracker)
    ...
    def get_eye_tracking_mode(self):
        ...
        '''
        return tobii_pro.get_eye_tracking_mode(self.__core_eyetracker)
    ...
    def set_eye_tracking_mode(self, eye_tracking_mode):
        ...
        ValueError
        '''
        return tobii_pro.set_eye_tracking_mode(self.__core_eyetracker, eye_tracking_mode)
    ...
    def get_track_box(self):
        ...
        '''
        return tobii_pro.get_track_box(self.__core_eyetracker)
    ...
    def get_display_area(self):
        ...
        '''
        return tobii_pro.get_display_area(self.__core_eyetracker)
    ...
    def set_display_area(self, display_area):
        ...
        EyeTrackerLicenseError
        '''
        tobii_pro.set_display_area(self.__core_eyetracker, display_area)
    ...
    def get_hmd_lens_configuration(self):
        ...
        '''
        return tobii_pro.get_hmd_lens_configuration(self.__core_eyetracker)
    ...
    def set_hmd_lens_configuration(self, lens_configuration):
        ...
        EyeTrackerLicenseError
        '''
        tobii_pro.set_hmd_lens_configuration(self.__core_eyetracker, lens_configuration)
    ...
    def set_device_name(self, device_name):
        ...
        EyeTrackerLicenseError
        '''
        tobii_pro.set_device_name(self.__core_eyetracker, device_name)
        self.__init_from_data(tobii_pro.get_device_data(self.__core_eyetracker))
    ...
    def subscribe_to(self, subscription_type, callback, as_dictionary=False):
        ...
        @ref EYETRACKER_NOTIFICATION_EYE_TRACKING_MODE_CHANGED, @ref EYETRACKER_TIME_SYNCHRONIZATION_DATA or
        @ref EYETRACKER_STREAM_ERRORS.
        <CodeExample>gaze_data.py</CodeExample>
        Args:
