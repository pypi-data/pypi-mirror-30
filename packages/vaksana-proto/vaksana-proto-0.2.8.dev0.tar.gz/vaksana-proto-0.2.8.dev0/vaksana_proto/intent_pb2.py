...
_SERVICESTATS = _descriptor.Descriptor(
  name='ServiceStats',
  full_name='vaksana.ServiceStats',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='call_count', full_name='vaksana.ServiceStats.call_count', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='success_count', full_name='vaksana.ServiceStats.success_count', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='time_ms', full_name='vaksana.ServiceStats.time_ms', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cost', full_name='vaksana.ServiceStats.cost', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='meta_json', full_name='vaksana.ServiceStats.meta_json', index=4,
...
DESCRIPTOR.message_types_by_name['ServiceStats'] = _SERVICESTATS
...
ServiceStats = _reflection.GeneratedProtocolMessageType('ServiceStats', (_message.Message,), dict(
  DESCRIPTOR = _SERVICESTATS,
  __module__ = 'intent_pb2'
  # @@protoc_insertion_point(class_scope:vaksana.ServiceStats)
  ))
_sym_db.RegisterMessage(ServiceStats)
