...
class MarketStub(object):
  ...
  def __init__(self, channel):
    ...
    self.KeepAlive = channel.unary_unary(
        '/vaksana.Market/KeepAlive',
        request_serializer=vaksana__pb2.Token.SerializeToString,
    ...
    self.SaveStats = channel.unary_unary(
        '/vaksana.Market/SaveStats',
        request_serializer=vaksana__pb2.CServiceStats.SerializeToString,
        response_deserializer=vaksana__pb2.ErrCode.FromString,
        )
...
class MarketServicer(object):
  ...
  def SaveStats(self, request, context):
    """Manages the cost of running the service
    """
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
    raise NotImplementedError('Method not implemented!')
...
def add_MarketServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'KeepAlive': grpc.unary_unary_rpc_method_handler(
          servicer.KeepAlive,
          request_deserializer=vaksana__pb2.Token.FromString,
      ...
      'SaveStats': grpc.unary_unary_rpc_method_handler(
          servicer.SaveStats,
          request_deserializer=vaksana__pb2.CServiceStats.FromString,
          response_serializer=vaksana__pb2.ErrCode.SerializeToString,
      ),
