...
class TestFD3(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.fd3_cfg = os.path.join('hexer', 'config', 'fd3.cfg')
        ...
        config = {'blocks': cls.blocks, 'chunks': chunks}
        create_config(config, filename=cls.test_cfg)

    def test_00_create_config(self):
        result = create_config(self.blocks)
