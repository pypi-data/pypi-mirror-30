...
if __name__ == '__main__':
    ...
    parser.add_argument('-bg', "--background", help='Provide a background gene\
                        set as a csv file with a single column called `wbid`',
                        action='store_true')
    parser.add_argument('-mn', "--melted_name", help='Name for gene_to_terms \
    ...
    # open gene list:
    gene_list = pd.read_csv(gl_name, header=None)
    gene_list.columns = ['wbid']
