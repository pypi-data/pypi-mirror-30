...
# -*- coding: utf-8 -*-
#
# pypsea documentation build configuration file
#
...
_version_py = os.path.join(repo, 'pypsea', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'pypsea.tex', 'pypsea Documentation',
     'James Draper', 'manual'),
]
