...
class on_request_class():
    ...
    def __init__(self, connection, function, name, minio_client, output_channel, monitor_url, debug_mode):
...
def bind(function, name, version="1.0.0", pulserate=25, debug_mode=0):
    ...
    requester = on_request_class(connection, function, name, minio_client, output_channel, monitor_url, debug_mode)
