...
class PhoneSubscriberResource(resources.ModelResource):

    class Meta:
        model = PhoneSubscriber
        import_id_fields = ('phone','contractUser')

class PhoneSubscriberAdmin(CustomImportExportModelAdmin):
    list_display=['phone','rut','nombre','apellido','apellido2','contractUser']
    resource_class = PhoneSubscriberResource
    change_list_template = 'admin/qsms/change_list_import_export_addbasedatos.html'
    pass


class PhoneSubscriberBaseDatosInline(admin.TabularInline):
    model = PhoneSubscriberBaseDatos
    can_delete = False
    can_change = False
...
class BaseDatosAdmin(CustomImportExportModelAdmin):
    inlines = [PhoneSubscriberBaseDatosInline]
...
class NoChangePermisionAdmin(CustomImportExportModelAdmin):
    ...
    pass
class SaldoSMSAdmin(CustomImportExportModelAdmin):
...
admin.site.register(PhoneSubscriber,PhoneSubscriberAdmin)
admin.site.register(BaseDatos,BaseDatosAdmin)

admin.site.register(PhoneSubscriberBaseDatos,NoChangePermisionAdmin)
admin.site.register(Delivery,EnvioProgramadoAdmin)
admin.site.register(DeliveryQueue,NoChangePermisionAdmin)
admin.site.register(PhoneSubscriberTemplate,PlantillaAdmin)
admin.site.register(ContractSMS)
admin.site.register(SaldoSMS,SaldoSMSAdmin)
