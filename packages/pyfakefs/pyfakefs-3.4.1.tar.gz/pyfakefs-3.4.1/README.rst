...
-  The documentation at `GitHub
   ...
   -  The `Release 3.3
      documentation <http://jmcgeheeiv.github.io/pyfakefs/release33>`__
...
pyfakefs has support for ``unittest`` and ``pytest``, but can also be
used directly using ``fake_filesystem_unittest.Patcher``. Refer to the
`usage
documentation <http://jmcgeheeiv.github.io/pyfakefs/master/usage.html>`__
for more information on test scenarios, test customization and using
