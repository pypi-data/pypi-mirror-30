...
class BackTestTrade:
    ...
    def __init__(self, userid='', sub_account='', password=''):
        ...
        self.cancel_url = self.prefix + 'Tradeinterface/cancel_orders'
        self.query_history_url = self.prefix + 'Tradeinterface/get_history_info'
        self.sub_account_url = self.prefix + 'Tradeinterface/get_sub_account_info'
        self.create_sub_account_url = self.prefix + 'Tradeinterface/create_sub_account'
        self.del_sub_account_url = self.prefix + 'Tradeinterface/del_sub_account'
        self.stock_encode_name = 'tradeinfo'
        self.query_pro_encode_name = 'query_info'
        self.cancel_encode_name = 'cancel_info'
        self.send_dic = {'userid': '', 'password': '', 'buy_sell_type': '', 'stock_dic': {}}
        self.set_userid(userid)
        self.set_password(password)
        self.set_sub_account(sub_account)
    ...
    # 创建回测子账号
    def create_sub_account(self, new_account_name=''):
        self.send_dic['new_account_name'] = new_account_name
        return self.http_post(self.send_dic, self.query_pro_encode_name, self.create_sub_account_url)

    # 查看回测子账号
    def get_sub_account(self):
        return self.http_post(self.send_dic, self.query_pro_encode_name, self.sub_account_url)

    # 删除回测子账号
    def del_sub_account(self, del_account_name=''):
        self.send_dic['del_account_name'] = del_account_name
        return self.http_post(self.send_dic, self.query_pro_encode_name, self.del_sub_account_url)
    ...
    # 设置用户子账号
    def set_sub_account(self, sub_account=''):
        sub_account = str(sub_account)
        if sub_account.strip() != '':
            self.send_dic['sub_account'] = sub_account
            return True
        else:
            return False
