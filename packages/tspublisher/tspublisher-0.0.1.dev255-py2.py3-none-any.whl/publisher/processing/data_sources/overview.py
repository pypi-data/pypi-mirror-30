...
from publisher.settings import ENCYCLOPEDIA_OVERVIEW_YAML_DIR, ENCYCLOPEDIA_DEVICES_YAML_DIR


def get_overview_and_devices(phase, asset_directory):
    code = phase.released_as or phase.code

    yaml_overview_dir = os.path.join(ENCYCLOPEDIA_OVERVIEW_YAML_DIR, code)
    ...
    yaml_devices_dir = os.path.join(ENCYCLOPEDIA_DEVICES_YAML_DIR, code)
