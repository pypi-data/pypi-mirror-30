...
class DefaultApi(object):
    ...
    def delete_user(self, user_id, client_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_user(user_id, client_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_user_with_http_info(user_id, client_id, **kwargs)
        else:
            (data) = self.delete_user_with_http_info(user_id, client_id, **kwargs)
            return data

    def delete_user_with_http_info(self, user_id, client_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_user_with_http_info(user_id, client_id, callback=callback_function)
    ...
    def update_user(self, user_id, updates, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_user(user_id, updates, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_user_with_http_info(user_id, updates, **kwargs)
        else:
            (data) = self.update_user_with_http_info(user_id, updates, **kwargs)
            return data

    def update_user_with_http_info(self, user_id, updates, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_user_with_http_info(user_id, updates, callback=callback_function)
        ...
        all_params = ['user_id', 'updates', 'client_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
