# -*- coding: utf-8 -*-
#
# pytakeout documentation build configuration file.
#
...
htmlhelp_basename = 'pytakeoutdoc'
...
latex_documents = [
  ('index', 'pytakeout.tex', u'pytakeout Documentation',
...
man_pages = [
    ('index', 'pytakeout', u'pytakeout Documentation',
