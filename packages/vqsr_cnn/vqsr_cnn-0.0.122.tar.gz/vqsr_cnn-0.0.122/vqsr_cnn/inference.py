...
def score_and_write_batch(args, model, file_out, fifo, batch_size, python_batch_size, tensor_dir):
    ...
    for i in range(batch_size):
        ...
        print('Reference tensor sum:', np.sum(reference_string_to_tensor(fifo_data[4]), axis=0))
        print(' type:', fifo_data[6],'annotation tensor:', annotation_string_to_tensor(args, fifo_data[5]), '\n anno string:', fifo_data[5])
