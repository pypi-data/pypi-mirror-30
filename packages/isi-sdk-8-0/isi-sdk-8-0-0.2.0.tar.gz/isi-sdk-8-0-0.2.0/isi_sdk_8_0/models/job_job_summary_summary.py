...
class JobJobSummarySummary(object):
    ...
    def __init__(self, cluster_is_degraded=None, connected=None, coordinator=None, disconnected_nodes=None, down_or_read_only_nodes=None, next_jid=None, run_degraded=None, stats_ready=None):  # noqa: E501
