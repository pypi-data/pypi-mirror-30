...
class AuthGroupExtended(object):
    ...
    def __init__(self, dn=None, dns_domain=None, domain=None, generated_gid=None, gid=None, id=None, member_of=None, name=None, provider=None, sam_account_name=None, sid=None, type=None):  # noqa: E501
