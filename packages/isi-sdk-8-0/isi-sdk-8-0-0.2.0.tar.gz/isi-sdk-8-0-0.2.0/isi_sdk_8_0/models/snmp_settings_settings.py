...
class SnmpSettingsSettings(object):
    ...
    def __init__(self, read_only_community=None, service=None, snmp_v1_v2c_access=None, snmp_v3_access=None, snmp_v3_read_only_user=None, system_contact=None, system_location=None):  # noqa: E501
