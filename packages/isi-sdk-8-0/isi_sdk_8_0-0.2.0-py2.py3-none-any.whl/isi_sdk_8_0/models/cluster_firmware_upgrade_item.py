...
class ClusterFirmwareUpgradeItem(object):
    ...
    def __init__(self, exclude_device=None, exclude_type=None, include_device=None, include_type=None, no_burn=None, no_reboot=None, no_verify=None, nodes_to_upgrade=None):  # noqa: E501
    ...
    def nodes_to_upgrade(self):
        ...
        The nodes scheduled for upgrade. Order in array determines queue position number. 'All' and null option will upgrade all nodes in <lnn> order.  # noqa: E501
