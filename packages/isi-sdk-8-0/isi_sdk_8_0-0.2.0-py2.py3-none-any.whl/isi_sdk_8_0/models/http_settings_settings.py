...
class HttpSettingsSettings(object):
    ...
    def __init__(self, access_control=None, basic_authentication=None, dav=None, enable_access_log=None, integrated_authentication=None, server_root=None, service=None):  # noqa: E501
