...
class ReportSubreportPolicy(object):
    ...
    def __init__(self, action=None, file_matching_pattern=None, name=None, source_exclude_directories=None, source_include_directories=None, source_root_path=None, target_host=None, target_path=None):  # noqa: E501
        """ReportSubreportPolicy - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def action(self):
        """Gets the action of this ReportSubreportPolicy.  # noqa: E501

        If 'copy', source files will be copied to the target cluster.  If 'sync', the target directory will be made an image of the source directory:  Files and directories that have been deleted on the source, have been moved within the target directory, or no longer match the selection criteria will be deleted from the target directory.  # noqa: E501

        :return: The action of this ReportSubreportPolicy.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this ReportSubreportPolicy.

        If 'copy', source files will be copied to the target cluster.  If 'sync', the target directory will be made an image of the source directory:  Files and directories that have been deleted on the source, have been moved within the target directory, or no longer match the selection criteria will be deleted from the target directory.  # noqa: E501

        :param action: The action of this ReportSubreportPolicy.  # noqa: E501
        :type: str
        """
    ...
    def file_matching_pattern(self):
        """Gets the file_matching_pattern of this ReportSubreportPolicy.  # noqa: E501
        ...
        :return: The file_matching_pattern of this ReportSubreportPolicy.  # noqa: E501
    ...
    def file_matching_pattern(self, file_matching_pattern):
        """Sets the file_matching_pattern of this ReportSubreportPolicy.

        A file matching pattern, organized as an OR'ed set of AND'ed file criteria, for example ((a AND b) OR (x AND y)) used to define a set of files with specific properties.  Policies of type 'sync' cannot use 'path' or time criteria in their matching patterns, but policies of type 'copy' can use all listed criteria.  # noqa: E501

        :param file_matching_pattern: The file_matching_pattern of this ReportSubreportPolicy.  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this ReportSubreportPolicy.  # noqa: E501

        User-assigned name of this sync policy.  # noqa: E501

        :return: The name of this ReportSubreportPolicy.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ReportSubreportPolicy.

        User-assigned name of this sync policy.  # noqa: E501

        :param name: The name of this ReportSubreportPolicy.  # noqa: E501
        :type: str
        """
    ...
    def source_exclude_directories(self):
        """Gets the source_exclude_directories of this ReportSubreportPolicy.  # noqa: E501
        ...
        :return: The source_exclude_directories of this ReportSubreportPolicy.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def source_exclude_directories(self, source_exclude_directories):
        """Sets the source_exclude_directories of this ReportSubreportPolicy.

        Directories that will be excluded from the sync.  Modifying this field will result in a full synchronization of all data.  # noqa: E501

        :param source_exclude_directories: The source_exclude_directories of this ReportSubreportPolicy.  # noqa: E501
        :type: list[str]
        """
    ...
    def source_include_directories(self):
        """Gets the source_include_directories of this ReportSubreportPolicy.  # noqa: E501
        ...
        :return: The source_include_directories of this ReportSubreportPolicy.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def source_include_directories(self, source_include_directories):
        """Sets the source_include_directories of this ReportSubreportPolicy.

        Directories that will be included in the sync.  Modifying this field will result in a full synchronization of all data.  # noqa: E501

        :param source_include_directories: The source_include_directories of this ReportSubreportPolicy.  # noqa: E501
        :type: list[str]
        """
    ...
    def source_root_path(self):
        """Gets the source_root_path of this ReportSubreportPolicy.  # noqa: E501
        ...
        :return: The source_root_path of this ReportSubreportPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def source_root_path(self, source_root_path):
        """Sets the source_root_path of this ReportSubreportPolicy.

        The root directory on the source cluster the files will be synced from.  Modifying this field will result in a full synchronization of all data.  # noqa: E501

        :param source_root_path: The source_root_path of this ReportSubreportPolicy.  # noqa: E501
        :type: str
        """
    ...
    def target_host(self):
        """Gets the target_host of this ReportSubreportPolicy.  # noqa: E501
        ...
        :return: The target_host of this ReportSubreportPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def target_host(self, target_host):
        """Sets the target_host of this ReportSubreportPolicy.

        Hostname or IP address of sync target cluster.  Modifying the target cluster host can result in the policy being unrunnable if the new target does not match the current target association.  # noqa: E501

        :param target_host: The target_host of this ReportSubreportPolicy.  # noqa: E501
        :type: str
        """
    ...
    def target_path(self):
        """Gets the target_path of this ReportSubreportPolicy.  # noqa: E501

        Absolute filesystem path on the target cluster for the sync destination.  # noqa: E501

        :return: The target_path of this ReportSubreportPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def target_path(self, target_path):
        """Sets the target_path of this ReportSubreportPolicy.

        Absolute filesystem path on the target cluster for the sync destination.  # noqa: E501

        :param target_path: The target_path of this ReportSubreportPolicy.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReportSubreportPolicy):
            return False
