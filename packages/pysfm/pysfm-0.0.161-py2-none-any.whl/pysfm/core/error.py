...
#     if retCode == UF_PROTO_RET_SCAN_FAIL:
#         return UF_ERR_SCAN_FAIL
#     elif retCode == UF_PROTO_RET_NOT_FOUND:
#         return UF_ERR_NOT_FOUND
#     elif retCode == UF_PROTO_RET_NOT_MATCH:
#         return UF_ERR_NOT_MATCH
#     elif retCode == UF_PROTO_RET_TRY_AGAIN:
#         return UF_ERR_TRY_AGAIN
#     elif retCode == UF_PROTO_RET_TIME_OUT:
#         return UF_ERR_TIME_OUT
#     elif retCode == UF_PROTO_RET_MEM_FULL:
#         return UF_ERR_MEM_FULL
#     elif retCode == UF_PROTO_RET_EXIST_ID:
#         return UF_ERR_EXIST_ID
#     elif retCode == UF_PROTO_RET_FINGER_LIMIT:
#         return UF_ERR_FINGER_LIMIT
#     elif retCode == UF_PROTO_RET_UNSUPPORTED:
#         return UF_ERR_UNSUPPORTED
#     elif retCode == UF_PROTO_RET_INVALID_ID:
#         return UF_ERR_INVALID_ID
#     elif retCode == UF_PROTO_RET_TIMEOUT_MATCH:
#         return UF_ERR_TIMEOUT_MATCH
#     elif retCode == UF_PROTO_RET_BUSY:
#         return UF_ERR_BUSY
#     elif retCode == UF_PROTO_RET_CANCELED:
#         return UF_ERR_CANCELED
#     elif retCode == UF_PROTO_RET_DATA_ERROR:
#         return UF_ERR_DATA_ERROR
#     elif retCode == UF_PROTO_RET_EXIST_FINGER:
#         return UF_ERR_EXIST_FINGER
#     elif retCode == UF_PROTO_RET_DURESS_FINGER:
#         return UF_ERR_DURESS_FINGER
#     elif retCode == UF_PROTO_RET_CARD_ERROR:
#         return UF_ERR_CARD_ERROR
#     elif retCode == UF_PROTO_RET_LOCKED:
#         return UF_ERR_LOCKED
#     elif retCode == UF_PROTO_RET_ACCESS_NOT_GRANTED:
#         return UF_ERR_ACCESS_NOT_GRANTED
#     elif retCode == UF_PROTO_RET_EXCEED_ENTRANCE_LIMIT:
#         return UF_ERR_EXCEED_ENTRANCE_LIMIT
#     elif retCode == UF_PROTO_RET_REJECTED_ID:
#         return UF_ERR_REJECTED_ID
#     elif retCode == UF_PROTO_FAKE_DETECTED:
#         return UF_ERR_FAKE_DETECTED
#     elif retCode == UF_PROTO_RET_RECOVERY_MODE:
#         return UF_ERR_RECOVERY_MODE
#     elif retCode == UF_PROTO_RET_NO_SERIAL_NUMBER:
