...
from yacli.common import save_app_config, read_app_id_from_config, save_application_json, AppIdInvalid, AppDataCorrupt,\
FilePermissionError
...
def cli(ctx, app, filename):
    ...
    try:
        ...
        if req.status_code == 200:
            ...
            try:
                save_application_json(application_json)
            except:
