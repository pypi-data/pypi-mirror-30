...
class FlowPair(_object):
    ...
    def __init__(self, *args):
        this = _topology.new_FlowPair(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_setmethods__["down"] = _topology.FlowPair_down_set
    __swig_getmethods__["down"] = _topology.FlowPair_down_get
    if _newclass:
        down = _swig_property(_topology.FlowPair_down_get, _topology.FlowPair_down_set)
    __swig_setmethods__["up"] = _topology.FlowPair_up_set
    __swig_getmethods__["up"] = _topology.FlowPair_up_get
    if _newclass:
        up = _swig_property(_topology.FlowPair_up_get, _topology.FlowPair_up_set)
    __swig_destroy__ = _topology.delete_FlowPair
    __del__ = lambda self: None
FlowPair_swigregister = _topology.FlowPair_swigregister
...
class AMSCFloat(_object):
    ...
    def __init__(self, Xin, yin, _names, gradientMethod, persistenceType, win, neighborhoods, verbosity=False):
        this = _topology.new_AMSCFloat(Xin, yin, _names, gradientMethod, persistenceType, win, neighborhoods, verbosity)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def Dimension(self):
        return _topology.AMSCFloat_Dimension(self)

    def Size(self):
        return _topology.AMSCFloat_Size(self)

    def MaxY(self):
        return _topology.AMSCFloat_MaxY(self)

    def MinY(self):
        return _topology.AMSCFloat_MinY(self)

    def RangeY(self):
        return _topology.AMSCFloat_RangeY(self)

    def MaxX(self, dim):
        return _topology.AMSCFloat_MaxX(self, dim)

    def MinX(self, dim):
        return _topology.AMSCFloat_MinX(self, dim)

    def RangeX(self, dim):
        return _topology.AMSCFloat_RangeX(self, dim)

    def GetX(self, *args):
        return _topology.AMSCFloat_GetX(self, *args)

    def GetY(self, i):
        return _topology.AMSCFloat_GetY(self, i)

    def MinLabel(self, i, pers):
        return _topology.AMSCFloat_MinLabel(self, i, pers)

    def MaxLabel(self, i, pers):
        return _topology.AMSCFloat_MaxLabel(self, i, pers)

    def Name(self, dim):
        return _topology.AMSCFloat_Name(self, dim)

    def Neighbors(self, index):
        return _topology.AMSCFloat_Neighbors(self, index)

    def PrintHierarchy(self):
        return _topology.AMSCFloat_PrintHierarchy(self)

    def SortedPersistences(self):
        return _topology.AMSCFloat_SortedPersistences(self)

    def XMLFormattedHierarchy(self):
        return _topology.AMSCFloat_XMLFormattedHierarchy(self)

    def GetPartitions(self, persistence):
        return _topology.AMSCFloat_GetPartitions(self, persistence)

    def GetStableManifolds(self, persistence):
        return _topology.AMSCFloat_GetStableManifolds(self, persistence)

    def GetUnstableManifolds(self, persistence):
        return _topology.AMSCFloat_GetUnstableManifolds(self, persistence)

    def addToHierarchy(self, isMinimum, dyingIndex, persistence, survivingIndex, saddleIndex):
        return _topology.AMSCFloat_addToHierarchy(self, isMinimum, dyingIndex, persistence, survivingIndex, saddleIndex)
    __swig_destroy__ = _topology.delete_AMSCFloat
    __del__ = lambda self: None
AMSCFloat_swigregister = _topology.AMSCFloat_swigregister
...
class AMSCDouble(_object):
    ...
    def __init__(self, Xin, yin, _names, gradientMethod, persistenceType, win, neighborhoods, verbosity=False):
        this = _topology.new_AMSCDouble(Xin, yin, _names, gradientMethod, persistenceType, win, neighborhoods, verbosity)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def Dimension(self):
        return _topology.AMSCDouble_Dimension(self)

    def Size(self):
        return _topology.AMSCDouble_Size(self)

    def MaxY(self):
        return _topology.AMSCDouble_MaxY(self)

    def MinY(self):
        return _topology.AMSCDouble_MinY(self)

    def RangeY(self):
        return _topology.AMSCDouble_RangeY(self)

    def MaxX(self, dim):
        return _topology.AMSCDouble_MaxX(self, dim)

    def MinX(self, dim):
        return _topology.AMSCDouble_MinX(self, dim)

    def RangeX(self, dim):
        return _topology.AMSCDouble_RangeX(self, dim)

    def GetX(self, *args):
        return _topology.AMSCDouble_GetX(self, *args)

    def GetY(self, i):
        return _topology.AMSCDouble_GetY(self, i)

    def MinLabel(self, i, pers):
        return _topology.AMSCDouble_MinLabel(self, i, pers)

    def MaxLabel(self, i, pers):
        return _topology.AMSCDouble_MaxLabel(self, i, pers)

    def Name(self, dim):
        return _topology.AMSCDouble_Name(self, dim)

    def Neighbors(self, index):
        return _topology.AMSCDouble_Neighbors(self, index)

    def PrintHierarchy(self):
        return _topology.AMSCDouble_PrintHierarchy(self)

    def SortedPersistences(self):
        return _topology.AMSCDouble_SortedPersistences(self)

    def XMLFormattedHierarchy(self):
        return _topology.AMSCDouble_XMLFormattedHierarchy(self)

    def GetPartitions(self, persistence):
        return _topology.AMSCDouble_GetPartitions(self, persistence)

    def GetStableManifolds(self, persistence):
        return _topology.AMSCDouble_GetStableManifolds(self, persistence)

    def GetUnstableManifolds(self, persistence):
        return _topology.AMSCDouble_GetUnstableManifolds(self, persistence)

    def addToHierarchy(self, isMinimum, dyingIndex, persistence, survivingIndex, saddleIndex):
        return _topology.AMSCDouble_addToHierarchy(self, isMinimum, dyingIndex, persistence, survivingIndex, saddleIndex)
    __swig_destroy__ = _topology.delete_AMSCDouble
    __del__ = lambda self: None
AMSCDouble_swigregister = _topology.AMSCDouble_swigregister
...
class MergeTreeFloat(_object):
    ...
    def __init__(self, Xin, yin, _names, gradientMethod, neighborhoods, verbosity=False):
        this = _topology.new_MergeTreeFloat(Xin, yin, _names, gradientMethod, neighborhoods, verbosity)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
...
class MergeTreeDouble(_object):
    ...
    def __init__(self, Xin, yin, _names, gradientMethod, neighborhoods, verbosity=False):
        this = _topology.new_MergeTreeDouble(Xin, yin, _names, gradientMethod, neighborhoods, verbosity)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
