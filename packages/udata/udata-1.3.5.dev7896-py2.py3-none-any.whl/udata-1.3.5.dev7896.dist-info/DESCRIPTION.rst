...
- Upgrade ``sifter`` to ``0.5.3`` `#1548 <https://github.com/opendatateam/udata/pull/1548>`__
- Upgrade ``jquery-validation`` to 1.17.0 and fixes some issues with client-side URL validation `#1550 <https://github.com/opendatateam/udata/pull/1550>`__
- Minor change on OEmbed cards to avoid theme to override the cards ``font-family`` `#1549 <https://github.com/opendatateam/udata/pull/1549>`__
- Improve cli unicode handling `#1551 <https://github.com/opendatateam/udata/pull/1551>`__
- Fix DCAT harvester mime type detection `#1552 <https://github.com/opendatateam/udata/pull/1552>`__
...
- Non-admin users should not see the "publish as anyone" filter field on "publish as" screen `#1538 <https://github.com/opendatateam/udata/pull/1538>`__
