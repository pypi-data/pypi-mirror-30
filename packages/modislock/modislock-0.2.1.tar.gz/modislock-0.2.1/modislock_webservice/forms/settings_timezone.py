...
class SettingsTimeZoneFrom(FlaskForm):
    """TimeZoneSettings
    ...
    tz_zone = SelectField(label='Time Zone',
                          description='System Time Zone',
                          choices=[("America/Adak", "(GMT-10:00) America/Adak (Hawaii-Aleutian Standard Time)"),
    ...
    submit_timezone_btn = SubmitField('Save Time Settings')
    ...
    #         return False
    #
    #     time_test = re.compile('^[0-9]{2}:[0-9]{2}$')
    #
    #     if time_test.match(self.sys_time.data) is not None:
    #         return True
    #     else:
    #         self.sys_time.errors.append('Invalid time format')
    #         return False
