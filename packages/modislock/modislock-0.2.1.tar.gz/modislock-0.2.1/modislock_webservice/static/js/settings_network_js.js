...
e.preventDefault()})}(jQuery);(function(){$('#dhcp_mode').checked?network_enable():network_disable();$("#dhcp_mode").change(function(){(this.checked)?network_disable():network_enable();});})();function network_disable(){$("input[id$='address']").prop('disabled',true);}
function network_enable(){$("input[id$='address']").prop('disabled',false);}