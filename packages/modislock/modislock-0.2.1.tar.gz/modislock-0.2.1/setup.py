...
class PostInstallCommand(install):
        ...
        if os.path.isdir(self.install_dir):
            ...
            for key in asset_bundles.keys():
                try:
                    ...
                    print('Bundle Error: {}'.format(e))
                    continue

    def _build_documentation(self):
        print('Documentation generation complete in directory: {}'.format(self.install_dir))
    ...
    def _post_install(self):
        ...
        for r, d, f in os.walk(self.install_dir + '/pages'):
            try:
                ...
                print('Permission errors: {}'.format(e))
    ...
    def run(self):
        ...
        try:
            ...
            print('Error occurred in installation: {}'.format(e))
        # Post-install
