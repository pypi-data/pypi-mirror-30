...
msg_on_long_testing = '''```Ой-ой-ой. Тестировщики что-то уснули и очень долго тестируют билд в *{}*.
{}, разберись с проблемой срочно!
{}```'''

msg_on_long_review = '''```Ой-ой-ой. Билд *{}* давно протестирован, но все еще находится в статусе *Review*.
{}, разберись с проблемой срочно!
{}```'''

msg_on_unknown_status = '''```Ой-ой-ой. Кто-то очень ошибся и выставил неправильный статус *{3}* тестирования в *{0}*.
