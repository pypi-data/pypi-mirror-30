...
def copy_resources(arg_parser):
    ...
    shutil.copy2('{}Icon-32.png'.format(icons), '{}drawable-ldpi/icon.png'.format(proj_folder))
    shutil.copy2('{}Icon-48.png'.format(icons), '{}drawable-mdpi/icon.png'.format(proj_folder))
    shutil.copy2('{}Icon-72.png'.format(icons), '{}drawable-hdpi/icon.png'.format(proj_folder))
    shutil.copy2('{}Icon-96.png'.format(icons), '{}drawable-xhdpi/icon.png'.format(proj_folder))
