...
* Support for HTML, attachments, extra headers, and other features of
  `Django's built-in email <https://docs.djangoproject.com/en/v2.1/topics/email/>`_
...
.. image:: https://travis-ci.org/anymail/django-anymail.svg?branch=v2.1
       :target: https://travis-ci.org/anymail/django-anymail
       :alt:    build status on Travis-CI

.. image:: https://readthedocs.org/projects/anymail/badge/?version=v2.1
       :target: https://anymail.readthedocs.io/en/v2.1/
       :alt:    documentation on ReadTheDocs

**Resources**

* Full documentation: https://anymail.readthedocs.io/en/v2.1/
...
3. Now the regular `Django email functions <https://docs.djangoproject.com/en/v2.1/topics/email/>`_
...
See the `full documentation <https://anymail.readthedocs.io/en/v2.1/>`_
