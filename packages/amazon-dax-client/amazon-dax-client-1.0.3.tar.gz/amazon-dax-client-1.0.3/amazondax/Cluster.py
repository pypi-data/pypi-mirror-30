...
class Cluster(object):
    def __init__(self, region_name, seeds, credentials, user_agent=None, user_agent_extra=None, connect_timeout=None,
        ...
        self._router = Router(self._new_client, self._health_check_interval)
...
class Source(object):
    ...
    def _pull(self, seeds):
        ...
        raise DaxClientError('Failed to configure cluster endpoints.', DaxErrorCode.NoRoute)
