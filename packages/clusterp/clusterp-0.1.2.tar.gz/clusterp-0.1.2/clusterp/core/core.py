...
def plot_data(hw=None):
    ...
    if hw == 'cpu':
        ...
        for host in cf.hosts:
            ...
            ax_iowait.plot(hardware_df['time'], hardware_df['%i/o_wait'], label=host_alias)
            ax_utilization.plot(hardware_df['time'], hardware_df['%util'], label=host_alias)
        ...
        for host in cf.hosts:
            ...
            ax_utilization.plot(hardware_df['time'], hardware_df['memory_used_mb'], label=host_alias)
        ...
        for host in cf.hosts:
            ...
            ax_utilization.plot(hardware_df['time'], hardware_df['swap_used_mb'], label=host_alias)
        ...
        for device in cf.filesystem_names:
            ...
            for host in cf.hosts:
                ...
                ax_read.plot(hardware_df['time'], hardware_df['read_mb/s'], label=host_alias)
                ax_write.plot(hardware_df['time'], hardware_df['write_mb/s'], label=host_alias)
                ax_utilization.plot(hardware_df['time'], hardware_df['%util'], label=host_alias)
        ...
        for device in cf.net_interfaces:
            ...
            for host in cf.hosts:
                ...
                ax_in.plot(hardware_df['time'], hardware_df['read_mb/s'], label=host_alias)
                ax_out.plot(hardware_df['time'], hardware_df['transmitted_mb/s'], label=host_alias)
