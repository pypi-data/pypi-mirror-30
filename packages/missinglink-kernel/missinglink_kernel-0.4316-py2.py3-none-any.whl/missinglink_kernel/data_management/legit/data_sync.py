...
from .exceptions import AccessDenied, NotFound
...
class DataSync(object):
    ...
    class DownloadIterResults(collections.Iterator):
        ...
        def __get_next_results(self):
            ...
            resolved_tree = resolve_tree(tree, AddOffsetFunctionTransformer(self.__query_offset))

            query = str(resolved_tree)

            current_results, current_total_data_points = self.__repo.metadata.query(
                query, max_results=self.__batch_size, start_index=0)
