...
cdef object _rand_uint32_broadcast(np.ndarray low, np.ndarray high, object size, aug_state *state, object lock):
...
cdef object _rand_uint16_broadcast(np.ndarray low, np.ndarray high, object size, aug_state *state, object lock):
    """Array path for smaller integer types"""
...
cdef object _rand_uint8_broadcast(np.ndarray low, np.ndarray high, object size, aug_state *state, object lock):
    """Array path for smaller integer types"""
...
cdef object _rand_bool_broadcast(np.ndarray low, np.ndarray high, object size, aug_state *state, object lock):
    """Array path for smaller integer types"""
...
cdef object _rand_int32_broadcast(np.ndarray low, np.ndarray high, object size, aug_state *state, object lock):
    """Array path for smaller integer types"""
    cdef uint32_t rng, last_rng, off, val, mask, out_val
    cdef uint32_t buf
    cdef uint32_t *out_data
...
cdef object _rand_int16_broadcast(np.ndarray low, np.ndarray high, object size, aug_state *state, object lock):
    """Array path for smaller integer types"""
    cdef uint16_t rng, last_rng, off, val, mask, out_val
    cdef uint32_t buf
    cdef uint16_t *out_data
...
cdef object _rand_int8_broadcast(np.ndarray low, np.ndarray high, object size, aug_state *state, object lock):
    """Array path for smaller integer types"""
    cdef uint8_t rng, last_rng, off, val, mask, out_val
    cdef uint32_t buf
    cdef uint8_t *out_data
...
cdef object _rand_uint64_broadcast(object low, object high, object size, aug_state *state, object lock):
...
cdef object _rand_int64_broadcast(object low, object high, object size, aug_state *state, object lock):
    """Array path for 64-bit integer types"""
    cdef np.ndarray low_arr, high_arr, out_arr, highm1_arr
    cdef np.npy_intp i, cnt
    cdef np.broadcast it
...
cdef object _rand_uint64(object low, object high, object size, aug_state *state, object lock):
    """
...
cdef object _rand_uint32(object low, object high, object size, aug_state *state, object lock):
    """
...
cdef object _rand_uint16(object low, object high, object size, aug_state *state, object lock):
    """
...
cdef object _rand_uint8(object low, object high, object size, aug_state *state, object lock):
    """
...
cdef object _rand_bool(object low, object high, object size, aug_state *state, object lock):
    """
...
cdef object _rand_int64(object low, object high, object size, aug_state *state, object lock):
    """
...
cdef object _rand_int32(object low, object high, object size, aug_state *state, object lock):
    """
...
cdef object _rand_int16(object low, object high, object size, aug_state *state, object lock):
    """
...
cdef object _rand_int8(object low, object high, object size, aug_state *state, object lock):
    """
