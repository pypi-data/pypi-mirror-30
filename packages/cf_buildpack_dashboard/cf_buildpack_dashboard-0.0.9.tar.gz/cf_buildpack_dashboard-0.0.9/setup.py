...
setup(
    name="cf_buildpack_dashboard",
    url="",
    version=find_version('cf_buildpack_dashboard/__init__.py'),
    keywords='assessment',
    description="Builpack dashboard for Cloudfoundry",
    long_description=find_readme(),
    author="Claudio Benfatto",
    author_email="claudio.benfatto@gmail.com",
    license='MIT',
    ...
    package_data={'cf_buildpack_dashboard': ['api/static/css/*', 'api/static/js/*', 'api/templates/*']},
    ...
    entry_points = {
        'console_scripts': [
            'cf_buildpack_dashboard=cf_buildpack_dashboard.api.run:main_app']
    },
