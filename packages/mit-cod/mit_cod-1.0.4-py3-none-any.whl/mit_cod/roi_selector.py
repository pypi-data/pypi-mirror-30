...
class roi_selector(object):
    def __init__(self, image, window_name = "Select RoI (Press H for Help)", frmHelp = None, roiPickerMod = None):
    ...
    def get(self):
        ...
        if not self.__roiPickerMod is None:
            self.__roiPickerMod(0, self.__window_name)

        cv2.waitKey(1)
        MsgBoxInfo("Press H for help", "RoI Picker")
        ...
        while(not self.__done):
            ...
            if self.__frmHelp != None and (key == 72 or key == 104):
