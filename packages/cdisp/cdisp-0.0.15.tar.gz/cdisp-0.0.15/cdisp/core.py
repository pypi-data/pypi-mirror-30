...
#    wlength0 = 0.9e-6
    ...
    return data_frame
###
def dispersion_analysis(data_frame, list0, frequency_tag = 'freq', wlength0 = 0.9e-6):
    ## list of columns
    ...
    data_frame = data_frame.groupby(list0, as_index = False).apply(dispersion_calculation, wlength0 = wlength0)
    return data_frame
##
