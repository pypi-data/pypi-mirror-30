...
<root>
  ...
  <cardlayout wid='card-widgets'>
	...
	<frame wid='entries'>
		...
		<entry wid='entry2' />
		<entry wid='entry3' />
		<entry wid='entry4' style='Invalid.TEntry' />
  ...
  <geometry>
  	<pack for='btn-previous' side='left' padx='10' />
  	<pack for='btn-next' side='right' padx='10' />
  	<pack for='card-widgets' side='bottom' padx='10' pady='10' />
  </geometry>
</root>'''
