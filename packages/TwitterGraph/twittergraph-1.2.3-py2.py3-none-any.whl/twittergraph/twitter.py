...
class Extractor(object):
    ...
    def __init__(self, user =settings.USER_AUTH, passwd = settings.PASS_AUTH,  cantU = settings.TOTAL_USERS_EXTRACT, timeExt = settings.TOTAL_EXTRACT_TIME, lang = settings.LANGUAGE, timeout = settings.TIMEOUT):
