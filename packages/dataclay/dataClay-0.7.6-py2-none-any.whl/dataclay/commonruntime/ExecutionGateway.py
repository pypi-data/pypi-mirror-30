    ...
    def get_class_extradata(klass):
        ...
        if getRuntime().current_type == RuntimeType.client:
            ...
            if class_stubinfo is None:
                ...
                dc_ced.properties["has_alias"] = PreprocessedProperty(name="has_alias", position=property_pos, type=Type.build_from_docstring("bool"), beforeUpdate=None, afterUpdate="_set_has_alias_internal", inMaster=False)
                property_pos += 1
