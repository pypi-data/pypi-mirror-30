            ...
            if path:
                ...
                if is_remote:
                    ...
                    self._session = SparkSession.builder \
                        ...
                        .appName(self._app) \
                        .enableHiveSupport() \
                        .config('fs.s3a.access.key', self._s3_client.get_credentials_keys()['aws_access_key_id'])\
                        .config('fs.s3a.secret.key', self._s3_client.get_credentials_keys()['aws_secret_access_key'])\
                        .getOrCreate()
