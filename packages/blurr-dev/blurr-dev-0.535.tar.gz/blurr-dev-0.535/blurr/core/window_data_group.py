...
class _WindowSource:
    ...
    def __init__(self, block_list: List[BlockDataGroup]):
        self.view: List[BlockDataGroup] = block_list
...
class WindowDataGroup(DataGroup):
    ...
    def _load_blocks(self, blocks: List[Tuple[Key, Any]]) -> List[BlockDataGroup]:
        """
