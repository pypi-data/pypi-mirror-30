...
import creaturecast_designer.widgets.store_widget as str
...
class DockStackWidget(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.extensions_widget = str.StoreWidget(self)
...
class DesignerWidget(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.extensions_button.clicked.connect(self.load_store)
        self.dock_widgets = []
    ...
    def set_user(self, user_data):
        ...
        self.user_header.set_user(user_data)
        self.dock_stack_widget.set_user(user_data)
...
class DesignerStackWidget(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.login_widget.logged_in.connect(self.set_user)
    ...
    def set_user(self, user_data):
        ...
        self.designer_widget.set_user(user_data)
