...
class formfactorTest (unittest.TestCase):
    ...
    """
    def setUp(self):
        self.csSphereI= js.ff.sphereCoreShell(0,1.,2.,-7.,1.).X[0]
        R=2
        NN=10
        ...
        self.cloudsphere=js.ff.cloudScattering(np.r_[0,2.3],insidegrid,nFib=50)    # takes about 1.9 s on single core
