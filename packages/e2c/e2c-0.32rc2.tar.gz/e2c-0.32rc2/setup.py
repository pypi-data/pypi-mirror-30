...
setup(
    ...
    #
    url='https://gitlab.com/elastic-event-components/e2c',

    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    #
    description='Elastic Event Components is an open source software library ' 
                'to build flexible architectures using dataflow graphs.',
