...
class Pod(Field):
    ...
    def __init__(self, validator=None, default=None, show=('view', 'result'),
      ...
      forceOoCall=False, optimalColumnWidths=False, script=None, confirm=False,
      raiseOnError=False, action=None, beforeAction=None):
        ...
        # For this parameter, see appy.pod.renderer.Renderer's docstring
    ...
    def getValue(self, obj, name=None, template=None, format=None, result=None,
        ...
        rendererParams = {'template': templatePath, 'context': podContext,
          ...
          'optimalColumnWidths': self.optimalColumnWidths, 'script': script}
