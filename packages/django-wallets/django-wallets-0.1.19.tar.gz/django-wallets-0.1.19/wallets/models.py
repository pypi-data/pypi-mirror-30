...
class Invoice(models.Model):
    ...
    wallet_type = models.ForeignKey(ContentType, on_delete=models.CASCADE, limit_choices_to=limit, related_name='wallets_invoies')
    wallet_id = models.PositiveIntegerField()
    wallet_object = GenericForeignKey('wallet_type', 'wallet_id')

    tx_hash = models.CharField(max_length=100, null=True, blank=False)
