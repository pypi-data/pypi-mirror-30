If this document looks strange please convert it to a markdown file and use an appropriate viewer.
Otherwise please visit https://github.com/Stuart-Wilcox/servepy/ for more information 
