...
class DisplayServer:
    ...
    _wipe_start_day = None
    _wipe_execution_time = None
    ...
    def __init__(self, config, verbose):
        ...
        self._wipe_execution_time = datetime.datetime.strptime(self._config["wipe-screen"]["time"],"%H:%M").time()
        self._wipe_start_day = datetime.datetime.today()
