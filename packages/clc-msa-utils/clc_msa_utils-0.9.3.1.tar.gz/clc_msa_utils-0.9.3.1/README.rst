...
.. code:: python
   :number-lines: 1
          ...
          def process_dict(my_dict):
              # Return a cloned of my_dict removing None values and empty strings.
              dict_a = dict_replace_empty_values(my_dict,
                                                 process_none_values=True,
                                                 clone_dict=True,
                                                 remove_values=True)

               # Return a cloned of my_dict replacing None values and empty strings with "EMPTY".
