 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("py_stringsimjoin.similarity_measure.dice.dice", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initdice(void); /*proto*/
PyMODINIT_FUNC initdice(void)
#else
PyMODINIT_FUNC PyInit_dice(void); /*proto*/
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_dice(void)", 0);
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "py_stringsimjoin.similarity_measure.dice")) {
      if (unlikely(PyDict_SetItemString(modules, "py_stringsimjoin.similarity_measure.dice", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("dice", (void (*)(void))__pyx_f_16py_stringsimjoin_18similarity_measure_4dice_dice, "double (std::vector<int>  const &, std::vector<int>  const &)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  /*--- Type import code ---*/
