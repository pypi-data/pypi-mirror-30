...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "py_stringsimjoin.similarity_measure.edit_distance")) {
      if (unlikely(PyDict_SetItemString(modules, "py_stringsimjoin.similarity_measure.edit_distance", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("edit_distance", (void (*)(void))__pyx_f_16py_stringsimjoin_18similarity_measure_13edit_distance_edit_distance, "double (std::string const &, std::string const &)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  /*--- Type import code ---*/
