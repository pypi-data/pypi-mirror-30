...
1.) is_multiple(24,4) printa vrednost True
2.) is_even(20) printa vrednost True
3.) minmax([4,2,6,2,6,7,5]) ili minmax((4,2,6,2,6,7,5)) printa tuple vrednosti (2,7).
4.) suma_kvadrata(4) printa vrednost 14.
6.) suma_neparnih(4) printa vrednost 10
'''
