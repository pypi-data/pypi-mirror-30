...
class JobApi(object):
    ...
    def get_job_events_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['begin', 'end', 'job_id', 'resume', 'job_type', 'state', 'limit']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_job_job_with_http_info(self, job_job_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/1/job/jobs/{JobJobId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_job_reports_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['begin', 'end', 'job_id', 'resume', 'job_type', 'limit']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_job_job_with_http_info(self, job_job, job_job_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/1/job/jobs/{JobJobId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
