...
class SyncSettingsSettings(object):
    ...
    def __init__(self, burst_memory_constraint=None, burst_socket_buffer_size=None, force_interface=None, report_email=None, report_max_age=None, report_max_count=None, restrict_target_network=None, service=None, source_network=None, tw_chkpt_interval=None):  # noqa: E501
