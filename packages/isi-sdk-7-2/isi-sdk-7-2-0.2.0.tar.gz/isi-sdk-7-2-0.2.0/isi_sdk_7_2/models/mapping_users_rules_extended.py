...
from isi_sdk_7_2.models.mapping_users_rules_parameters import MappingUsersRulesParameters  # noqa: F401,E501
from isi_sdk_7_2.models.mapping_users_rules_rule_extended import MappingUsersRulesRuleExtended  # noqa: F401,E501
...
class MappingUsersRulesExtended(object):
    ...
    def parameters(self):
        ...
        If the final credential does not have valid UID/GID then it is replaced with default unix user.  # noqa: E501
    ...
    def rules(self):
        ...
        The list of user mapping rules.  # noqa: E501
