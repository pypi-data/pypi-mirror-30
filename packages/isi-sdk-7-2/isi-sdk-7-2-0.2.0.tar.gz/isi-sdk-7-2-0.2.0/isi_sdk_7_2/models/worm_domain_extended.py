...
from isi_sdk_7_2.models.worm_domain import WormDomain  # noqa: F401,E501
...
class WormDomainExtended(object):
    ...
    def autocommit_offset(self):
        ...
        The autocommit time period in seconds for the domain.  After a file exists in this domain without being modified for the specified time period, the file is automatically committed the next time the file is accessed.  If null, there is no autocommit time so files must be manually committed.  # noqa: E501
    ...
    def default_retention(self):
        ...
        The default amount of time, in seconds, that a file in this domain will be protected for.  This default is applied to a file if it is committed to the domain before being assigned its own expiration date.  Value can also be null (expire right away), 'forever', 'use_min' (use the 'min_retention' value), or 'use_max' (use the 'max_retention' value).  # noqa: E501
    ...
    def default_retention(self, default_retention):
        ...
        :type: int
        """
        if default_retention is not None and default_retention < 0:  # noqa: E501
            raise ValueError("Invalid value for `default_retention`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def max_retention(self):
        ...
        The maximum amount of time, in seconds, that a file in this domain will be protected for.  This will override the retention period of any file committed with a longer retention period.  Value can also be null (allow an infinite length retention period).  # noqa: E501
    ...
    def max_retention(self, max_retention):
        ...
        :type: int
        """
        if max_retention is not None and max_retention < 0:  # noqa: E501
            raise ValueError("Invalid value for `max_retention`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def min_retention(self):
        ...
        The minimum amount of time, in seconds, that a file in this domain will be protected for.  This will override the retention period of any file committed with a shorter retention period.  Value can also be null (expire right away), or 'forever'.  # noqa: E501
    ...
    def min_retention(self, min_retention):
        ...
        :type: int
        """
        if min_retention is not None and min_retention < 0:  # noqa: E501
            raise ValueError("Invalid value for `min_retention`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def override_date(self):
        ...
        Override retention date for the domain.  If this date is later than any committed file's own retention date, that file will remain protected beyond its own retention date until this date.  # noqa: E501
    ...
    def privileged_delete(self):
        ...
        If 'on', files in this domain can be deleted using the privileged delete feature.  Otherwise, they can't be deleted even with privileged delete.  If 'disabled', privileged file deletes are permanently disabled and cannot be turned back on again.  # noqa: E501
    ...
    def type(self):
        ...
        Whether this is an enterprise domain or this is a compliance domain. Compliance domains may not be created on enterprise clusters. Enterprise and compliance domains may be created on compliance clusters.  # noqa: E501
    ...
    def id(self):
        ...
        System-assigned ID of this protection domain.  # noqa: E501
    ...
    def incomplete(self):
        ...
        If true, OneFS is still in the process of creating this domain and it is not yet preventing files from being modified or deleted.  If false, the domain is fully created and operational.  # noqa: E501
    ...
    def lin(self):
        ...
        Logical inode number (LIN) for the root of this domain.  # noqa: E501
    ...
    def max_modifies(self):
        ...
        Maximum number of times a WORM domain can be modified over its lifetime.  # noqa: E501
    ...
    def path(self):
        ...
        Root path of this domain.  Files in this directory and all sub-directories will be protected.  # noqa: E501
    ...
    def total_modifies(self):
        ...
        The number of times this domain has been modified (had its domain attributes changed) so far.  A WORM domain can be modified a fixed number of times over its lifetime defined by max_modifies.  # noqa: E501
