...
class SmbSettingsShareSettings(object):
    ...
    def __init__(self, access_based_enumeration=None, access_based_enumeration_root_only=None, allow_delete_readonly=None, allow_execute_always=None, change_notify=None, create_permissions=None, csc_policy=None, directory_create_mask=None, directory_create_mode=None, file_create_mask=None, file_create_mode=None, hide_dot_files=None, host_acl=None, impersonate_guest=None, impersonate_user=None, mangle_byte_start=None, mangle_map=None, ntfs_acl_support=None, oplocks=None, strict_flush=None, strict_locking=None, zone=None):  # noqa: E501
