...
from isi_sdk_7_2.models.sync_rule import SyncRule  # noqa: F401,E501
from isi_sdk_7_2.models.sync_rule_schedule import SyncRuleSchedule  # noqa: F401,E501
...
class SyncRuleCreateParams(object):
    ...
    def limit(self):
        ...
        Amount the specified system resource type is limited by this rule.  Units are kb/s for bandwidth, files/s for file-count, or processing percentage used for cpu.  # noqa: E501
    ...
    def type(self, type):
        ...
        allowed_values = ["bandwidth", "file_count", "cpu"]  # noqa: E501
