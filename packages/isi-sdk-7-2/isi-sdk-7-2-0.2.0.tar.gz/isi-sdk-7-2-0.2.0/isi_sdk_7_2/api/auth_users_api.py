...
class AuthUsersApi(object):
    ...
    def create_user_member_of_item_with_http_info(self, user_member_of_item, user, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/1/auth/users/{User}/member_of', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_user_member_of_member_of_with_http_info(self, user_member_of_member_of, user, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/1/auth/users/{User}/member_of/{UserMemberOfMemberOf}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_user_member_of_with_http_info(self, user, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/platform/1/auth/users/{User}/member_of', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_user_change_password_with_http_info(self, user_change_password, user, **kwargs):  # noqa: E501
        ...
        all_params = ['user_change_password', 'user']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/platform/1/auth/users/{User}/change_password', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
