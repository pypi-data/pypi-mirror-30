...
class SchemeInfoEdit(QWidget):
    ...
    def __setupUi(self):
        ...
        self.name_edit.setPlaceholderText(self.tr("未命名的工作流"))
    ...
    def setScheme(self, scheme):
        ...
        self.scheme = scheme
        if not scheme.title:
            self.name_edit.setText(self.tr("未命名的工作流"))
...
class SchemeInfoDialog(QDialog):
    ...
    def __setupUi(self):
        ...
        check_layout.addWidget(
               QLabel(self.tr("您还可以稍后编辑工作流信息(文件 -> 工作流信息)。"),
                      self,
