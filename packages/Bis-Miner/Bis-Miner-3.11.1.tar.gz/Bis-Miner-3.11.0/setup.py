...
if sys.version_info < (3, 4):
    sys.exit('Bis-Miner requires Python >= 3.4')
...
DESCRIPTION = 'Bis-Miner, a component-based data mining framework.'
README_FILE = os.path.join(os.path.dirname(__file__), 'README.md')
LONG_DESCRIPTION = open(README_FILE).read()
AUTHOR = 'Ming Zhang'
AUTHOR_EMAIL = 'zhangm@bistone.com'
URL = 'http://www.bistone.com/'
LICENSE = 'GPLv3+'
...
ENTRY_POINTS = {
    ...
    "gui_scripts": (
        "bis-miner = Orange.canvas.__main__:main",
    ),
}
