...
Python libraries as specified in `requirements.txt <https://github.com/mbdevpl/ingit/blob/v0.4.1/requirements.txt>`_.

Building and running tests additionally requires packages listed in `test_requirements.txt <https://github.com/mbdevpl/ingit/blob/v0.4.1/test_requirements.txt>`_.
