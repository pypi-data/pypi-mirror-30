...
class AllTriggersConsidered(object):
  ...
  @property
  def vc(self):
    "bool vc struct property."
    return self._vc

  @vc.setter
  def vc(self, value):
    self._vc = msgbuffers.validate_bool(
      'AllTriggersConsidered.vc', value)

  def __init__(self, cliffDetected, cubeMoved, facePositionUpdated, fistBump, frustration, hiccup, motorCalibration, noPreDockPoses, objectPositionUpdated, placedOnCharger, petInitialDetection, robotFalling, robotPickedUp, robotPlacedOnSlope, returnedToTreads, robotOnBack, robotOnFace, robotOnSide, robotShaken, sparked, unexpectedMovement, vc):
  ...
  def unpack_from(cls, reader):
    ...
    _vc = bool(reader.read('b'))
    return cls(_cliffDetected, _cubeMoved, _facePositionUpdated, _fistBump, _frustration, _hiccup, _motorCalibration, _noPreDockPoses, _objectPositionUpdated, _placedOnCharger, _petInitialDetection, _robotFalling, _robotPickedUp, _robotPlacedOnSlope, _returnedToTreads, _robotOnBack, _robotOnFace, _robotOnSide, _robotShaken, _sparked, _unexpectedMovement, _vc)
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._cliffDetected == other._cliffDetected and
        ...
        self._unexpectedMovement == other._unexpectedMovement and
        self._vc == other._vc)
    else:
