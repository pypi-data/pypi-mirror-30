...
app_description = 'Executes SQL commands from STDIN in a single transaction'
...
app_install_requires = ['argparse', 'boto3', 'psycopg2-binary']
...
setup(
    ...
    url='https://github.com/QuiNovas/redshiftsql',
