...
static int tmat3x3_sq_ass_item(tmat3x3 * self, Py_ssize_t index, PyObject * value) {
	ivec3 o;
...
static PyObject * tmat3x3_richcompare(tmat3x3 * self, PyObject * other, int comp_type) {
	...
	case Py_EQ:
		if ((self->x->x == o2.x.x) && (self->x->y == o2.x.y) && (self->x->z == o2.x.z) &&
			...
			(self->z->x == o2.z.x) && (self->z->y == o2.z.y) && (self->z->z == o2.z.z)) Py_RETURN_TRUE;
...
static PySequenceMethods tmat3x3SeqMethods = {
	...
	0,
	(ssizeobjargproc)tmat3x3_sq_ass_item, // sq_ass_item
	0,
