...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChannel, TypeChannelParticipantsFilter, TypeInputMessage, TypeInputStickerSet, TypeInputUser, TypeBool, TypeChannelAdminRights, TypeChannelBannedRights, TypeInputChatPhoto, TypeChannelAdminLogEventsFilter
