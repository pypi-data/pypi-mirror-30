...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeInputPeer, TypeInputNotifyPeer, TypeInputPeerNotifySettings, TypeInputPrivacyKey, TypeInputPrivacyRule, TypeAccountDaysTTL, TypeReportReason
