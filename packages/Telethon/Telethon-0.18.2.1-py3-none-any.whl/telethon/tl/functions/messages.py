...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSendMessageAction, TypeBool, TypeInputPeer, TypeMessagesFilter, TypeInputMedia, TypeInputSingleMedia, TypeMessageEntity, TypeInputDocument, TypeInputEncryptedChat, TypeInlineBotSwitchPM, TypeInputUser, TypeInputStickerSet, TypeInputEncryptedFile, TypeInputStickeredMedia, TypeInputChatPhoto, TypeInputGeoPoint, TypeShippingOption, TypeInputBotInlineResult, TypeReplyMarkup, TypeInputBotInlineMessageID
    pass
