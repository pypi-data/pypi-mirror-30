...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputStickerSet, TypeChannelAdminRights, TypeInputUser, TypeBool, TypeChannelParticipantsFilter, TypeInputChannel, TypeChannelAdminLogEventsFilter, TypeInputChatPhoto, TypeChannelBannedRights
    pass
