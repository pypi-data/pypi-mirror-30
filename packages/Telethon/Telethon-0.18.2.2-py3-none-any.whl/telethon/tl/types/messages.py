...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeDialog, TypeFoundGif, TypeEncryptedFile, TypeChatFull, TypeHighScore, TypeChat, TypeBotInlineResult, TypeUser, TypeDocument, TypeMessage, TypeStickerSetCovered, TypeStickerSet, TypeStickerPack, TypeInlineBotSwitchPM
