...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInlineBotSwitchPM, TypeMessage, TypeBotInlineResult, TypeDialog, TypeEncryptedFile, TypeChatFull, TypeStickerSetCovered, TypeHighScore, TypeChat, TypeStickerSet, TypeStickerPack, TypeDocument, TypeUser, TypeFoundGif
