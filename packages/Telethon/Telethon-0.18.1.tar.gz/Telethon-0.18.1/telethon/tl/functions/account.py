...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReportReason, TypeInputPeerNotifySettings, TypeInputPrivacyRule, TypeAccountDaysTTL, TypeInputPrivacyKey, TypeInputPeer, TypeInputNotifyPeer, TypeBool
