...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelParticipantsFilter, TypeChannelAdminLogEventsFilter, TypeInputChatPhoto, TypeInputUser, TypeChannelBannedRights, TypeInputChannel, TypeInputStickerSet, TypeChannelAdminRights, TypeBool
    pass
