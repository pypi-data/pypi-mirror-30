...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeerNotifySettings, TypeReportReason, TypeInputPrivacyKey, TypeInputPeer, TypeBool, TypeAccountDaysTTL, TypeInputPrivacyRule, TypeInputNotifyPeer
