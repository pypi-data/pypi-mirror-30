...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeImportedContact, TypeChat, TypeContactBlocked, TypeContactLink, TypePeer, TypeUser, TypeTopPeerCategoryPeers, TypePopularContact, TypeContact
    pass
