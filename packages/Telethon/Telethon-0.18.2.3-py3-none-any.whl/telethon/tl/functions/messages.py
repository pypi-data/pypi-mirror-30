...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputDocument, TypeInputStickerSet, TypeReplyMarkup, TypeInputEncryptedChat, TypeInputSingleMedia, TypeSendMessageAction, TypeInputEncryptedFile, TypeInputBotInlineMessageID, TypeBool, TypeInputChatPhoto, TypeMessageEntity, TypeInputGeoPoint, TypeInputStickeredMedia, TypeInputBotInlineResult, TypeMessagesFilter, TypeInputUser, TypeShippingOption, TypeInputMedia, TypeInlineBotSwitchPM, TypeInputPeer, TypeInputMessage
    pass
