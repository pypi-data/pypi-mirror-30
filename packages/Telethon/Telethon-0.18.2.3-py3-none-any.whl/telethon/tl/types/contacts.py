...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePeer, TypeTopPeerCategoryPeers, TypeContactLink, TypeContact, TypeContactBlocked, TypeUser, TypeChat, TypePopularContact, TypeImportedContact
    pass
