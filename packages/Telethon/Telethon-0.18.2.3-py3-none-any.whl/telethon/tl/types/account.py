...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeBool, TypeAuthorization, TypeWebAuthorization, TypePrivacyRule
    pass
...
class WebAuthorizations(TLObject):
    ...
    def from_reader(reader):
        ...
        return WebAuthorizations(authorizations=_authorizations, users=_users)
