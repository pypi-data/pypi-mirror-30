...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContact, TypeContactLink, TypePeer, TypeTopPeerCategoryPeers, TypeContactBlocked, TypeImportedContact, TypeChat, TypePopularContact, TypeUser
    pass
