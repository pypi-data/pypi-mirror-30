...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeer, TypeInputPrivacyRule, TypeInputPeerNotifySettings, TypeInputPrivacyKey, TypeInputNotifyPeer, TypeReportReason, TypeBool, TypeAccountDaysTTL
