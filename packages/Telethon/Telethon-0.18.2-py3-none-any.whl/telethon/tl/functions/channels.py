...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelAdminLogEventsFilter, TypeChannelBannedRights, TypeInputUser, TypeInputStickerSet, TypeInputChannel, TypeChannelAdminRights, TypeInputChatPhoto, TypeBool, TypeChannelParticipantsFilter
    pass
