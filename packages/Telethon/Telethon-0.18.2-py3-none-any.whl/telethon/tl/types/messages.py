...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerPack, TypeFoundGif, TypeDocument, TypeMessage, TypeInlineBotSwitchPM, TypeUser, TypeChatFull, TypeHighScore, TypeBotInlineResult, TypeChat, TypeDialog, TypeEncryptedFile, TypeStickerSetCovered, TypeStickerSet
