...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContact, TypeContactLink, TypeImportedContact, TypeUser, TypeChat, TypeContactBlocked, TypePeer, TypeTopPeerCategoryPeers, TypePopularContact
    pass
