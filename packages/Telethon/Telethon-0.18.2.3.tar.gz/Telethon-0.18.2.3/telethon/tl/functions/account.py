...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeAccountDaysTTL, TypeReportReason, TypeInputPrivacyRule, TypeInputPrivacyKey, TypeBool, TypeInputNotifyPeer, TypeInputPeer, TypeInputPeerNotifySettings
...
class GetWebAuthorizationsRequest(TLObject):
    ...
    @staticmethod
    def from_reader(reader):
        return GetWebAuthorizationsRequest()
...
class ResetWebAuthorizationRequest(TLObject):
    ...
    def from_reader(reader):
        _hash = reader.read_long()
        return ResetWebAuthorizationRequest(hash=_hash)
...
class ResetWebAuthorizationsRequest(TLObject):
    ...
    @staticmethod
    def from_reader(reader):
        return ResetWebAuthorizationsRequest()
