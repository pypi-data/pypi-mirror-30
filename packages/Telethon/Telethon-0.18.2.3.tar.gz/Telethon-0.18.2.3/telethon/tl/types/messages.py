...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerSet, TypeMessage, TypeEncryptedFile, TypeDocument, TypeDialog, TypeUser, TypeInlineBotSwitchPM, TypeChat, TypeStickerPack, TypeHighScore, TypeFoundGif, TypeBotInlineResult, TypeStickerSetCovered, TypeChatFull
