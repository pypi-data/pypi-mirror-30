...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePopularContact, TypeUser, TypeTopPeerCategoryPeers, TypeImportedContact, TypePeer, TypeContactLink, TypeChat, TypeContactBlocked, TypeContact
    pass
