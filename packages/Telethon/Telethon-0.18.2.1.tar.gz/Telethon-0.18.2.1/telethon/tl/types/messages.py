...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerSet, TypeMessage, TypeStickerPack, TypeUser, TypeChatFull, TypeStickerSetCovered, TypeBotInlineResult, TypeDialog, TypeDocument, TypeFoundGif, TypeInlineBotSwitchPM, TypeHighScore, TypeChat, TypeEncryptedFile
