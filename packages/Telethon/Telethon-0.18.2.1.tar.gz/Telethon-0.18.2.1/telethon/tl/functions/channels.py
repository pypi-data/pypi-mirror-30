...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeChannelAdminLogEventsFilter, TypeChannelAdminRights, TypeInputChannel, TypeInputUser, TypeChannelParticipantsFilter, TypeInputStickerSet, TypeChannelBannedRights, TypeInputChatPhoto
    pass
