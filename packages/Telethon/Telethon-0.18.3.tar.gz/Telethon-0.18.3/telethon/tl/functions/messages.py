...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReplyMarkup, TypeShippingOption, TypeBool, TypeInputEncryptedChat, TypeInputGeoPoint, TypeInputEncryptedFile, TypeInputBotInlineMessageID, TypeInputStickeredMedia, TypeInputUser, TypeInputMedia, TypeInputChatPhoto, TypeInputDocument, TypeInlineBotSwitchPM, TypeInputBotInlineResult, TypeInputSingleMedia, TypeMessageEntity, TypeInputStickerSet, TypeMessagesFilter, TypeInputMessage, TypeSendMessageAction, TypeInputPeer
