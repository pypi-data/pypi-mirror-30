...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReportReason, TypeInputPrivacyKey, TypeInputPrivacyRule, TypeBool, TypeAccountDaysTTL, TypeInputPeerNotifySettings, TypeInputNotifyPeer, TypeInputPeer
