...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBotInlineResult, TypeStickerPack, TypeDocument, TypeFoundGif, TypeChatFull, TypeMessage, TypeEncryptedFile, TypeUser, TypeChat, TypeDialog, TypeStickerSet, TypeStickerSetCovered, TypeHighScore, TypeInlineBotSwitchPM
