...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactBlocked, TypeUser, TypeChat, TypeContact, TypeTopPeerCategoryPeers, TypeImportedContact, TypeContactLink, TypePeer, TypePopularContact
