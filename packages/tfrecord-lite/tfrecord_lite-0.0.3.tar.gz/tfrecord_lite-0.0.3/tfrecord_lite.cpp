 ...
 *     return {key.decode('utf-8'): value for key, value in decoded.items()}
 */
  __pyx_tuple__4 = PyTuple_Pack(6, __pyx_n_s_buffer, __pyx_n_s_names, __pyx_n_s_decoded, __pyx_n_s_name, __pyx_n_s_key, __pyx_n_s_value); if (unlikely(!__pyx_tuple__4)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__4);
  __Pyx_GIVEREF(__pyx_tuple__4);
  __pyx_codeobj__5 = (PyObject*)__Pyx_PyCode_New(2, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__4, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_tfrecord_lite_pyx, __pyx_n_s_decode_example, 43, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__5)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __pyx_pymod_exec_tfrecord_lite(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init tfrecord_lite", 0, __pyx_lineno, __pyx_filename);
    }
