...
You can also train a new model, with support for word level embeddings and bidirectional layers. The files for the new models can also be loaded.
...
You can view a demo of common features in [this Jupyter Notebook](/docs/textgenrnn-demo.ipynb).
