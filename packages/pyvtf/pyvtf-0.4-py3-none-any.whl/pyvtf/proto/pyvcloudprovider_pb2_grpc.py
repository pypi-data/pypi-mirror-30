...
from . import pyvcloudprovider_pb2 as proto_dot_pyvcloudprovider__pb2
...
class PyVcloudProviderStub(object):
  ...
  def __init__(self, channel):
    ...
    self.UpdateCatalog = channel.unary_unary(
        ...
        request_serializer=proto_dot_pyvcloudprovider__pb2.UpdateCatalogInfo.SerializeToString,
        response_deserializer=proto_dot_pyvcloudprovider__pb2.UpdateCatalogResult.FromString,
        )
    self.ShareCatalog = channel.unary_unary(
        '/proto.PyVcloudProvider/ShareCatalog',
        request_serializer=proto_dot_pyvcloudprovider__pb2.ShareCatalogInfo.SerializeToString,
        response_deserializer=proto_dot_pyvcloudprovider__pb2.ShareCatalogResult.FromString,
        )
    ...
    self.UpdateVApp = channel.unary_unary(
        ...
        request_serializer=proto_dot_vapp__pb2.UpdateVAppInfo.SerializeToString,
        response_deserializer=proto_dot_vapp__pb2.UpdateVAppResult.FromString,
        )
...
def add_PyVcloudProviderServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'UpdateCatalog': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=proto_dot_pyvcloudprovider__pb2.UpdateCatalogInfo.FromString,
          response_serializer=proto_dot_pyvcloudprovider__pb2.UpdateCatalogResult.SerializeToString,
      ),
      'ShareCatalog': grpc.unary_unary_rpc_method_handler(
          servicer.ShareCatalog,
          request_deserializer=proto_dot_pyvcloudprovider__pb2.ShareCatalogInfo.FromString,
          response_serializer=proto_dot_pyvcloudprovider__pb2.ShareCatalogResult.SerializeToString,
      ),
      ...
      'UpdateVApp': grpc.unary_unary_rpc_method_handler(
          servicer.UpdateVApp,
          request_deserializer=proto_dot_vapp__pb2.UpdateVAppInfo.FromString,
          response_serializer=proto_dot_vapp__pb2.UpdateVAppResult.SerializeToString,
      ),
