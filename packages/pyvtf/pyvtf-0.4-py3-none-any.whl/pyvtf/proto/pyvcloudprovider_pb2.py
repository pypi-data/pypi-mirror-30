...
from . import vapp_pb2 as proto_dot_vapp__pb2
from . import catalog_item_pb2 as proto_dot_catalog__item__pb2
...
_UPDATECATALOGINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='proto.UpdateCatalogInfo.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='old_name', full_name='proto.UpdateCatalogInfo.old_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='proto.UpdateCatalogInfo.description', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATECATALOGRESULT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='updated', full_name='proto.UpdateCatalogResult.updated', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SHARECATALOGINFO = _descriptor.Descriptor(
  name='ShareCatalogInfo',
  full_name='proto.ShareCatalogInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='proto.ShareCatalogInfo.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shared', full_name='proto.ShareCatalogInfo.shared', index=1,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SHARECATALOGRESULT = _descriptor.Descriptor(
  name='ShareCatalogResult',
  full_name='proto.ShareCatalogResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='proto.ShareCatalogResult.success', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['ShareCatalogInfo'] = _SHARECATALOGINFO
DESCRIPTOR.message_types_by_name['ShareCatalogResult'] = _SHARECATALOGRESULT
...
UpdateCatalogInfo = _reflection.GeneratedProtocolMessageType('UpdateCatalogInfo', (_message.Message,), dict(
...
UpdateCatalogResult = _reflection.GeneratedProtocolMessageType('UpdateCatalogResult', (_message.Message,), dict(
...
ShareCatalogInfo = _reflection.GeneratedProtocolMessageType('ShareCatalogInfo', (_message.Message,), dict(
  DESCRIPTOR = _SHARECATALOGINFO,
  __module__ = 'proto.pyvcloudprovider_pb2'
  # @@protoc_insertion_point(class_scope:proto.ShareCatalogInfo)
  ))
_sym_db.RegisterMessage(ShareCatalogInfo)

ShareCatalogResult = _reflection.GeneratedProtocolMessageType('ShareCatalogResult', (_message.Message,), dict(
  DESCRIPTOR = _SHARECATALOGRESULT,
  __module__ = 'proto.pyvcloudprovider_pb2'
  # @@protoc_insertion_point(class_scope:proto.ShareCatalogResult)
  ))
_sym_db.RegisterMessage(ShareCatalogResult)
...
_PYVCLOUDPROVIDER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ShareCatalog',
    full_name='proto.PyVcloudProvider.ShareCatalog',
    index=5,
    containing_service=None,
    input_type=_SHARECATALOGINFO,
    output_type=_SHARECATALOGRESULT,
    options=None,
  ),
  _descriptor.MethodDescriptor(
