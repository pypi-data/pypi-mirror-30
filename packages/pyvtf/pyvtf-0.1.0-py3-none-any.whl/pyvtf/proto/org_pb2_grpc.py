...
class OrgStub(object):
    ...
    """
        self.Create = channel.unary_unary(
            '/proto.Org/Create',
            request_serializer=proto_dot_org__pb2.CreateOrgInfo.
            SerializeToString,
            response_deserializer=proto_dot_org__pb2.CreateOrgResult.
            FromString,
        )
        self.Delete = channel.unary_unary(
            '/proto.Org/Delete',
            request_serializer=proto_dot_org__pb2.DeleteOrgInfo.
            SerializeToString,
            response_deserializer=proto_dot_org__pb2.DeleteOrgResult.
            FromString,
        )
        self.Read = channel.unary_unary(
            '/proto.Org/Read',
            request_serializer=proto_dot_org__pb2.ReadOrgInfo.
            SerializeToString,
            response_deserializer=proto_dot_org__pb2.ReadOrgResult.FromString,
        )
        self.Update = channel.unary_unary(
            '/proto.Org/Update',
            request_serializer=proto_dot_org__pb2.UpdateOrgInfo.
            SerializeToString,
            response_deserializer=proto_dot_org__pb2.UpdateOrgResult.
            FromString,
        )
