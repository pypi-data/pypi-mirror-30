...
class CommandV(Extensible):
    ...
    def push_image(self):
        ...
        for img in images:
            ...
            if push_result.get('error'):
                res['result'].update({'error': push_result.get('error')})
                return res
    ...
    def update_production(self):
        ...
        free_space = utils.verify_free_disk_space(self.__config.expected_backup_size)
        if not free_space:
        ...
        backup_result = self._production_backup_and_destroy(
            ...
            self.__config.prefix, self.__config.reason)
        ...
        start_result = self._production_update_and_start(
            stable_image, container_name, self.__config.status_checks,
