...
def quote_arbitrage_data_Kraken_LocalBitcoins_UK():
    ...
    try:
        ...
        Kraken_last_price_GBP = convert_currency(
                                    value      = Kraken_last_price_EUR,
                                    currency_1 = "EUR",
                                    currency_2 = "GBP"
                                )
        ...
        print("error -- could not convert currency or access Kraken API or access LocalBitcoins API")
        return None
...
def convert_currency(
    ...
    """
    Return a value of one currency expressed in another currency. By default,
    1 EUR is converted to GBP. The Yahoo Finance API is used as a data source.
    """
    df = get_currencies()
