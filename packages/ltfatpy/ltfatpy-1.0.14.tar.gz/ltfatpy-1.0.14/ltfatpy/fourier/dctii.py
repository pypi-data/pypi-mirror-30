...
def dctii(f, L=None, dim=None):
    ...
    ``dctii(f,L)`` zero-pads or truncates **f** to length **L** before doing
    the transformation.

    ``dctii(f,dim=dim)`` or ``dctii(f,L,dim)`` applies the transformation along
    dimension **dim**.
    ...
    .. image:: images/dctii.png
       :width: 700px
       :alt: dctii image
       :align: center
    .. seealso::  :func:`~ltfatpy.fourier.dctiii`,
        :func:`~ltfatpy.fourier.dctiv`, :func:`~ltfatpy.fourier.dstii`
