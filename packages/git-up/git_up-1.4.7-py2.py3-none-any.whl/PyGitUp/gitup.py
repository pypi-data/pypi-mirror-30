...
class GitUp(object):
    ...
    default_settings = {
        ...
        'fetch.prune': True,
        'fetch.all': False,
        'prune-with-missing-remotes': False,
    ...
    def rebase_all_branches(self):
        ...
        for branch in self.branches:
            ...
            try:
                ...
                if self.settings['prune-with-missing-remotes'] is True:
                    self.git.branch(branch.name, d=True)
                    print(colored('remote branch missing, deleting...', 'yellow'))
                    self.states.append('deleting')
                else:
