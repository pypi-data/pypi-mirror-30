# -*- coding: utf-8 -*-
"""
This module contains the functions to convert between unicode strings and LaTeX code.

.. note:: This is a modyfied version of the file comes with *bibserver* (http://github.com/okfn/bibserver)
...
__all__ = ['string_to_latex', 'latex_to_string', 'protect_uppercase', 'unicode_to_latex',
...
def latex_to_string(string):
    ...
    for key, value in unicode_to_latex:
        try:
            value = value.decode("utf-8")
        except AttributeError:
            pass
