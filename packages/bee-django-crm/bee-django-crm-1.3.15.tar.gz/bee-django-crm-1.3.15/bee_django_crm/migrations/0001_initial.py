# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-12-04 10:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(null=True, storage=django.core.files.storage.FileSystemStorage(location=b'static/poster_photo'), upload_to=b'')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preuser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='crm_user_applications', to='bee_django_crm.PreUser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checked_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Users')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Users')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='crm_track_user', to='bee_django_crm.PreUser')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='preuser',
            name='referral_user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='crm_referral_user', to='users.Users', verbose_name=b'\xe8\xbd\xac\xe4\xbb\x8b\xe4\xba\xba'),
        ),
        migrations.AddField(
            model_name='preuser',
            name='source',
