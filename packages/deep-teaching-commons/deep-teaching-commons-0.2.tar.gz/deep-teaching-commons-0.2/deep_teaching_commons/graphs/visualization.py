...
def draw(nx_graph, color=None, fillcolor=None, highlight_color=None, highlight_fillcolor=None, penwidth=None,
         observed_penwidth=None):
    color = color or '#808080'
    fillcolor = fillcolor or '#F0F0F0'
    highlight_color = highlight_color or '#76B900'
    highlight_fillcolor = highlight_fillcolor or '#DCEDC8'
    penwidth = penwidth or 1
    observed_penwidth = observed_penwidth or 2
    ...
    for s in nx_graph.nodes:
        ...
        if node.get('observed'):
            node['penwidth'] = observed_penwidth

        if node.get('highlight'):
            node['color'] = highlight_color
            node['fillcolor'] = highlight_fillcolor
