...
class ProvidersLdapLdapItem(object):
    ...
    @property
    def template(self):
        """Gets the template of this ProvidersLdapLdapItem.  # noqa: E501

        Specifies template to be used to create the LDAP provider. The list of templates can be found at /auth/providers/ldap-templates.  Any fields directly defined in your request will override the template values.  # noqa: E501

        :return: The template of this ProvidersLdapLdapItem.  # noqa: E501
        :rtype: str
        """
    ...
    def template(self, template):
        """Sets the template of this ProvidersLdapLdapItem.

        Specifies template to be used to create the LDAP provider. The list of templates can be found at /auth/providers/ldap-templates.  Any fields directly defined in your request will override the template values.  # noqa: E501

        :param template: The template of this ProvidersLdapLdapItem.  # noqa: E501
        :type: str
        """
        if template is not None and len(template) > 255:
            raise ValueError("Invalid value for `template`, length must be less than or equal to `255`")  # noqa: E501
        if template is not None and len(template) < 0:
            raise ValueError("Invalid value for `template`, length must be greater than or equal to `0`")  # noqa: E501
