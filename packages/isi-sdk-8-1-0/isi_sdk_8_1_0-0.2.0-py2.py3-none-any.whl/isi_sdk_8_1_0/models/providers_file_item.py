...
from isi_sdk_8_1_0.models.providers_file_id_params import ProvidersFileIdParams  # noqa: F401,E501
...
class ProvidersFileItem(object):
    ...
    def group_file(self, group_file):
        ...
        if group_file is not None and len(group_file) > 255:
            raise ValueError("Invalid value for `group_file`, length must be less than or equal to `255`")  # noqa: E501
