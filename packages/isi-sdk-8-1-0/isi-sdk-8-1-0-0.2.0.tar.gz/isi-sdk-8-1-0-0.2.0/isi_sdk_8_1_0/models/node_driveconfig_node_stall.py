...
class NodeDriveconfigNodeStall(object):
    ...
    def clear_time(self, clear_time):
        ...
        :type: int
        """
        if clear_time is not None and clear_time > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for `clear_time`, must be a value less than or equal to `4294967295`")  # noqa: E501
    ...
    def diskscrub_stripes(self, diskscrub_stripes):
        ...
        :type: int
        """
        if diskscrub_stripes is not None and diskscrub_stripes > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for `diskscrub_stripes`, must be a value less than or equal to `4294967295`")  # noqa: E501
    ...
    def max_error_frequency(self, max_error_frequency):
        ...
        :type: int
        """
        if max_error_frequency is not None and max_error_frequency > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for `max_error_frequency`, must be a value less than or equal to `4294967295`")  # noqa: E501
    ...
    def max_slow_access(self, max_slow_access):
        ...
        :type: int
        """
        if max_slow_access is not None and max_slow_access > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for `max_slow_access`, must be a value less than or equal to `4294967295`")  # noqa: E501
    ...
    def max_slow_frequency(self, max_slow_frequency):
        ...
        :type: int
        """
        if max_slow_frequency is not None and max_slow_frequency > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for `max_slow_frequency`, must be a value less than or equal to `4294967295`")  # noqa: E501
    ...
    def max_total_stall_time(self, max_total_stall_time):
        ...
        :type: int
        """
        if max_total_stall_time is not None and max_total_stall_time > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for `max_total_stall_time`, must be a value less than or equal to `4294967295`")  # noqa: E501
    ...
    def scan_max_ecc_delay(self, scan_max_ecc_delay):
        ...
        :type: int
        """
        if scan_max_ecc_delay is not None and scan_max_ecc_delay > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for `scan_max_ecc_delay`, must be a value less than or equal to `4294967295`")  # noqa: E501
    ...
    def scan_size(self, scan_size):
        ...
        :type: int
        """
        if scan_size is not None and scan_size > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for `scan_size`, must be a value less than or equal to `4294967295`")  # noqa: E501
    ...
    def sleep(self, sleep):
        ...
        :type: int
        """
        if sleep is not None and sleep > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for `sleep`, must be a value less than or equal to `4294967295`")  # noqa: E501
