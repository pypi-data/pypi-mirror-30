...
class AntivirusSettingsSettings(object):
    ...
    def __init__(self, fail_open=None, glob_filters=None, glob_filters_enabled=None, glob_filters_include=None, path_prefixes=None, quarantine=None, repair=None, report_expiry=None, scan_on_close=None, scan_on_open=None, scan_size_maximum=None, service=None, truncate=None):  # noqa: E501
    ...
    def report_expiry(self, report_expiry):
        ...
        if report_expiry is not None and report_expiry < 0:  # noqa: E501
            raise ValueError("Invalid value for `report_expiry`, must be a value greater than or equal to `0`")  # noqa: E501
    ...
    def scan_size_maximum(self, scan_size_maximum):
        ...
        :type: int
        """
        if scan_size_maximum is not None and scan_size_maximum > 4294967295:  # noqa: E501
            raise ValueError("Invalid value for `scan_size_maximum`, must be a value less than or equal to `4294967295`")  # noqa: E501
