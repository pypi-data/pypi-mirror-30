...
#Better create a Project ini to store project, project path information				
				if not projectName is None:
						if not (os.path.exists(projectPath)):
							...
							shutil.copytree(realPackagePath+"./conf", projectPath + "./conf")
							dataPath = projectPath + "./data/digitalRec"
							shutil.copytree(realPackagePath+"./data", projectPath + "./data")
							...
							shutil.copy2(realPackagePath +"./examples/digitalr.py", projectPath + "./digitalr.py")
			...
			if not len(sys.argv) < 5:
				...
				if os.path.exists(templateFullPath) and os.path.exists(projectPath):
					...
					shutil.copy2(templateFullPath, projectPath + "./designer/" +templateName+ ".py")
