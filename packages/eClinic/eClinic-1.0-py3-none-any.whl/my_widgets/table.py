...
class Data_Cell(Cell):
    def __init__(self, master, variable, anchor=CENTER, bordercolor=None, borderwidth=1, padx=0, pady=0, background=None, foreground=None, font=None):
        Cell.__init__(self, master, background=background, highlightbackground=bordercolor, highlightcolor=bordercolor, highlightthickness=borderwidth, bd= 1)

        # Change the width of a cell
        self._message_widget = Message(self, textvariable=variable, font=font, background=background, foreground=foreground, width=150)
        self._message_widget.pack(expand=True, padx=padx, pady=pady, anchor=anchor)

class Header_Cell(Cell):
    def __init__(self, master, text, bordercolor=None, borderwidth=1, padx=2, pady=0, background=None, foreground=None, font=None, anchor=CENTER, separator=True):
        ...
        self._header_label = Label(self, text=text,
            background=background,
            foreground="green", font="Verdana 10 bold")
...
class Table(Frame):
    def __init__(self, master, columns, column_weights=None, column_minwidths=200, height=500, minwidth=20, minheight=20, padx=5, pady=5, cell_font=None, cell_foreground="black", cell_background="white", cell_anchor=W, header_font=None, header_background="white", header_foreground="black", header_anchor=CENTER, bordercolor = "#999999", innerborder=True, outerborder=True, stripped_rows=("#EEEEEE", "white"), on_change_data=None, mousewheel_speed = 2, scroll_horizontally=False, scroll_vertically=True):
        ...
        if add_scrollbars:
            ...
            scrolling_area.grid(row=1, column=0, sticky=N+S+E+W)
            ...
            self._body.pack(expand=1, fill=BOTH, anchor="nw")
