...
class ProceduresSheet(Frame):
    def __init__(self, rows, cols, headers, parent, **kwargs):
        ...
        #----------------------------------------------
        title=Label(top_frame, text="Operations and Procedures and Consultation")
        ...
        self.engine.use(table='procedures', column="ProcedureName")
    ...
    def add_row(self):
        ...
        for j in range(self.columns):
            ...
            if j==2:
                ...
                if not self.department=="Cashier":
...
if __name__ == '__main__':
    root=Tk()
    sheet= ProceduresSheet(1, 5,["Procedure ID", "Procedure Name",
        "Cost","Qty","Subtotal"], root)
    sheet.build_sheet()
    root.mainloop()
