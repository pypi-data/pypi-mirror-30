...
class PreUser(models.Model):
    ...
    referral_user = models.ForeignKey(User, related_name='bee_crm_referral_user', null=True, blank=True,
...
class PreUserTrack(models.Model):
    ...
    created_by = models.ForeignKey(User, null=True, related_name='bee_crm_created_by_user')  # 操作人
...
class PreUserContract(models.Model):
    ...
    checked_by = models.ForeignKey(User, null=True)
