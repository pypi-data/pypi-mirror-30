...
from configurationutil.gui import AddEditConfigFrame
...
class AddEditHostFrame(AddEditConfigFrame):
    ...
    def __init__(self,
                 *args,
                 **kwargs):
        super(AddEditHostFrame, self).__init__(cfg=config.register_host_config,
