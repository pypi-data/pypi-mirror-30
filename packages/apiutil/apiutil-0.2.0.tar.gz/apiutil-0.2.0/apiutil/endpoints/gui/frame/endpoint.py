...
from configurationutil.gui import AddEditConfigFrame, ParamsConfigButton
...
class AddEditEndpointFrame(AddEditConfigFrame):
    ...
    def __init__(self,
                 *args,
                 **kwargs):
        super(AddEditEndpointFrame, self).__init__(cfg=config.register_endpoint_config,
    ...
    def draw_defaults(self):
        ...
        self._params = ParamsConfigButton(frame=self,
                                          params=self.defaults.get(EndpointKeysConstant.params, u'')
                                          if self.edit else u'',
