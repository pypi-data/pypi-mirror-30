...
class OBO(object):
    ...
    def parents(self, id, as_str=False, include_self=False):
        '''
        ...
        if not as_str:
            ...
            return frozenset(self._ids_to_str(parents))
    ...
    def children(self, id, as_str=False, include_self=False):
        '''
        ...
        if not as_str:
            ...
            return frozenset(self._ids_to_str(children))
    ...
    def best_common_term(self, terms, negatives=False):
        '''
...
class OBOTerm(object):
    ...
    @property
    def parentsR(self, *args, **kwargs):
        '''
            Get parents recursively.
        '''
        return self._OBO.parents(self.id, *args, **kwargs)
    ...
    def parents(self, *args, **kwargs):
        ...
        '''
        return self._OBO._parents(self.id, *args, **kwargs)

    @property
    def childrenR(self, *args, **kwargs):
        '''
            Get children recursively.
        '''
        return self._OBO.children(self.id, *args, **kwargs)
    ...
    def children(self, *args, **kwargs):
        ...
        '''
        return self._OBO._children(self.id, *args, **kwargs)
