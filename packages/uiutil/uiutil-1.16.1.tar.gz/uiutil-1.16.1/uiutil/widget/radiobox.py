...
class RadioBox(VarMixIn,
    ...
    def __init__(self,
        ...
        for label, option_object in iter(options.items()):
            ...
            self.radiobuttons[option_object] = self.containing_frame.radiobutton(
                                               text=label,
                                               variable=self._var,
                                               value=label,
                                               state=NORMAL,
    ...
    def value(self):
        ...
        return self.options[self._var.get()]
    ...
    def enable(self,
        ...
        if option is None:
            ...
            try:
                ...
                try:
                    option = [k for k, v in iter(self.options.items()) if v == option][0]
