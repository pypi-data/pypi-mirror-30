...
class ServiceError(Exception):
    ...
    """
    def __init__(self, type, message, suggested_http_status=None, errors=None):
...
class BadRequestError(ServiceError):
    ...
    """
    def __init__(self, type, message, suggested_http_status=None, errors=None):
        super(BadRequestError, self).__init__(type, message, suggested_http_status or status.HTTP_400_BAD_REQUEST,
                                              errors)
...
class NotFoundError(ServiceError):
    ...
    def __init__(self,
                 ...
                 errors=None):
        super(NotFoundError, self).__init__(type, message, status.HTTP_404_NOT_FOUND, errors)
...
class UnauthorizedError(ServiceError):
    ...
    def __init__(self,
                 ...
                 errors=None):
        super(UnauthorizedError, self).__init__(type, message, status.HTTP_401_UNAUTHORIZED, errors)
...
class AccessForbiddenError(ServiceError):
    ...
    def __init__(self,
                 ...
                 errors=None):
        super(AccessForbiddenError, self).__init__(type, message, status.HTTP_403_FORBIDDEN, errors)
...
class ServerError(ServiceError):
    ...
    def __init__(self,
                 ...
                 suggested_http_status=None, errors=None):
        super(ServerError, self).__init__(type, message, suggested_http_status or status.HTTP_500_INTERNAL_SERVER_ERROR,
                                          errors)
