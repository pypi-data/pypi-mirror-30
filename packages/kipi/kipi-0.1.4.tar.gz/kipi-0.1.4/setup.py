...
setup(
    ...
    url='https://github.com/bobc/kicad-getlibs',  # Optional

    author=kipi.__author__,  # Optional

    author_email=kipi.__email__,  # Optional
    ...
    keywords='kicad package installer',  # Optional
