...
import inspect
import logging
from keyup.script_utils import read_local_config, get_os, json_integrity
...
try:
    ...
    if os.path.exists(config_path):
        ...
        # validate configfile integrity
        """
        FOLLOWING SECTION REMOVED -- json_integrity always indicates faulty schema
        if not json_integrity(seed_config, local_config):
            logger.info('Removing current config file (%s)' % config_path)
