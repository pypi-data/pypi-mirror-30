...
class ResultJSONFramesSpeakers(object):
    ...
    def __init__(self, id=None, vad=None, beep=None, ring=None, valence=None, activation=None, snr=None, f0=None, positivity=None, gender=None, language=None, age=None, engagement=None, politeness=None, success=None, escalation=None, resolution=None):  # noqa: E501
