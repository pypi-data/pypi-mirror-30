...
from hypertemp.cli import KeyValue
from hypertemp.cli import get_content_type_and_charset, main, parse_argument
from hypertemp.cli import set_request_data, set_url_info
...
def test_cli_normal(monkeypatch, argv):
    monkeypatch.setattr('hypertemp.cli.HTTPConnection', DummyConnection)
    main(argv)
    assert True
