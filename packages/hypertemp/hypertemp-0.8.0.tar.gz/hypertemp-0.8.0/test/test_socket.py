...
import hypertemp.common.bufsocket
from hypertemp.common.bufsocket import BufferedSocket
from hypertemp.common.exceptions import ConnectionResetError, LineTooLongError
...
class TestBufferedSocket(object):
    ...
    def test_can_create_buffered_sockets(self, monkeypatch):
        monkeypatch.setattr(
            hypertemp.common.bufsocket.select, 'select', dummy_select
        )
        s = DummySocket()
        b = BufferedSocket(s)
