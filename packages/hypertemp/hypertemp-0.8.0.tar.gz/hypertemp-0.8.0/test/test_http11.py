...
import hypertemp
from hypertemp.http11.connection import HTTP11Connection
from hypertemp.http11.response import HTTP11Response
from hypertemp.common.headers import HTTPHeaderMap
from hypertemp.common.exceptions import \
    ChunkedDecodeError, ConnectionResetError
from hypertemp.common.util import HTTPVersion
from hypertemp.compat import bytes, zlib_compressobj
...
class TestHTTP11Connection(object):
    ...
    def test_request_with_file_body(self):
        ...
        old_fstat = hypertemp.http11.connection.os.fstat

        try:
            hypertemp.http11.connection.os.fstat = fake_fstat
            c = HTTP11Connection('httpbin.org')
            c._sock = sock = DummySocket()
            ...
            hypertemp.http11.connection.os.fstat = old_fstat
