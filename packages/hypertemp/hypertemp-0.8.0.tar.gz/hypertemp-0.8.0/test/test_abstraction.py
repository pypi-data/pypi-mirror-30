# -*- coding: utf-8 -*-
import hypertemp.common.connection

from hypertemp.common.connection import HTTPConnection
from hypertemp.common.exceptions import TLSUpgrade, HTTPUpgrade
...
class TestHTTPConnection(object):
    ...
    def test_tls_upgrade(self, monkeypatch):
        monkeypatch.setattr(
            hypertemp.common.connection, 'HTTP11Connection', DummyH1Connection
        )
        monkeypatch.setattr(
            hypertemp.common.connection, 'HTTP20Connection', DummyH2Connection
        )
