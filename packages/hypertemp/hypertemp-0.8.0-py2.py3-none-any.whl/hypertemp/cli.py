...
from hypertemp import HTTPConnection, HTTP20Connection
from hypertemp import __version__
from hypertemp.compat import is_py2, urlencode, urlsplit, write_to_stdout
from hypertemp.common.util import to_host_port_tuple
