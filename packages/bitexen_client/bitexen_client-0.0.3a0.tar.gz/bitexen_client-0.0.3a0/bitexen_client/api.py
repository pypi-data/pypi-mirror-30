...
class API(object):
    ...
    def _get_orders(self, account_number='0', status='', market_code=''):
        method = 'orders/' + str(account_number) + '/' + status + '/' + market_code + '/'
    ...
    def get_balance(self, account_number=''):
        method = 'balance/' + str(account_number) + '/'
        result = dotdict(self._query_private(method))
    ...
    def get_open_orders(self, account_number='0', market_code=''):
        return self._get_orders(account_number=account_number, status='O', market_code=market_code)

    def get_closed_orders(self, account_number='0', market_code=''):
        return self._get_orders(account_number=account_number, status='C', market_code=market_code)
    ...
    def create_order(self, order_type, market_code, volume, buy_sell, price='0', account_number=0):
        method = 'orders/'
