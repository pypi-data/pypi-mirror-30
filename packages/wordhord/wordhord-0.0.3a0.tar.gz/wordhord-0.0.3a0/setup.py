...
# -*- coding: utf-8 -*-
################################################################################
#    wordhord Copyright (C) 2017 Suizokukan
...
from wordhord.wordhord import __projectname__, __version__, __author__, __email__, \
...
setup(
    ...
    url='https://github.com/suizokukan/wordhord',
    ...
    description="GPLv3/Python3/toolbox for Old English text analyse",
    ...
    #entry_points={
    #    'console_scripts': ['wordhord=wordhord.main:entrypoint',],
    #},
)
