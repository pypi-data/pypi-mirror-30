...
setup(
    name='tapioca-ssllabs',
    version=get_version(package),
    description='ssllabs API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/siteblindado/tapioca-ssllabs',
    packages=[
        'tapioca_ssllabs',
    ],
    package_dir={'tapioca_ssllabs': 'tapioca_ssllabs'},
