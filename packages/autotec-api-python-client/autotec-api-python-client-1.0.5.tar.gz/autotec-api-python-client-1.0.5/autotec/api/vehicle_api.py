...
class VehicleApi(object):
    ...
    def calc_risk(self, x_api_key, x_autotec_id, request, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str x_api_key: The AutoTec assigned ID for the calling customer location (required)
        :param str x_autotec_id: The AutoTec assigned ID for the calling customer location (required)
