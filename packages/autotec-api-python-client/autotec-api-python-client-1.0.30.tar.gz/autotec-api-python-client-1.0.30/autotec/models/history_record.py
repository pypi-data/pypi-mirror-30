...
class HistoryRecord(object):
    ...
    def __init__(self, accident_sequence_number=None, activity_code=None, case_number=None, category=None, checklist_group=None, city=None, date=None, lease=None, lien=None, odometer=None, org_name=None, phone=None, state=None, title=None, type=None, uom=None):  # noqa: E501
    ...
    @property
    def date(self):
        """Gets the date of this HistoryRecord.  # noqa: E501

        the date of the activity  # noqa: E501

        :return: The date of this HistoryRecord.  # noqa: E501
        :rtype: date
        """
        return self._date
    ...
    @date.setter
    def date(self, date):
        """Sets the date of this HistoryRecord.

        the date of the activity  # noqa: E501

        :param date: The date of this HistoryRecord.  # noqa: E501
        :type: date
        """
