...
Compatibility
=============
Currently, django-newsletter is officially supported for Django 1.8, 1.11 with
Django 2.0 support pending user feedback (tests are passing). We support Python
2.7, 3.4, 3.5 and 3.6.
