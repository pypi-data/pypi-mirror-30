...
def program_setting():
    ...
    parser.add_argument('--version', action='version', version='pepbox 0.3.1')
...
def pepbox():
    ...
    if args.optimize:
        ...
        for tetramer_sp in tetramer_sp_subsets:
            irrelevant, relevant = determine_pep_specificity_thresholds_for_multiple_subjects(paths, path_tables_and_figures_folder_opt, processed_file_aa_pval_names, tetramer_sp=tetramer_sp, bonferroni=True)
        ...
        for tetramer_sp in tetramer_sp_subsets:
            ...
            for filename_aa in processed_file_aa_pval_names:
                ...
                produce_validation_bar_plot_aa(paths, path_tables_and_figures_folder_exvivo, filename_aa, tetramer_sp=tetramer_sp, culture_thresholds=[relevant, irrelevant])
