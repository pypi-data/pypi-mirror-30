...
id = "9bda2e040ea23d5e52b797b908df2e47d252c8af"
date = "2018-04-11 17:37:58 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "9bda2e040ea23d5e52b797b908df2e47d252c8af":
        return
    msg = "Program id (9bda2e040ea23d5e52b797b908df2e47d252c8af) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
