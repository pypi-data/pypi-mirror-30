...
line_0, = plt.plot(t, flux_0, label='sphere')
line_2, = plt.plot(t, flux_2, '--', label='h_f = 2')
line_4, = plt.plot(t, flux_4, ':', label='h_f = 4')
plt.ylabel("Flux",fontsize=16)
plt.legend(handles=[line_0,line_2,line_4],loc='lower left')

plt.subplot(212)
plt.xlim([-0.05,0.05])
line_2, = plt.plot(t, 1e6*(flux_2-flux_0), '--', label='h_f = 2')
line_4, = plt.plot(t, 1e6*(flux_4-flux_0), ':',  label='h_f = 4')
