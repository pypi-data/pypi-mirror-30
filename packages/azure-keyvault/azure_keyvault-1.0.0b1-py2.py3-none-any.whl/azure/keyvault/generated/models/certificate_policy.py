...
class CertificatePolicy(Model):
    ...
    :type x509_certificate_properties: :class:`X509CertificateProperties
     <true.models.X509CertificateProperties>`
