...
class DataBase():
    ...
    def fields_save(self, body, list_scheme):
        list_scheme_clean = {}
        body_field_errors = []
        ...
        for item_body_field in body:
            ...
            if item_body_field not in fields_default:
                print 'FIELDS_DEFAULT', fields_default
    ...
    # --------------------------------
    # Verifica se o campo recebido via body esta configurado no esquema
    def __check_body_item_scheme(self, body_field, list_scheme):
    ...
    def __check_dev_fields_default(self, fields_default):
        fields_clean = []
        fields_errors = {}
    ...
    def __check_empty(self, item_scheme, value):
        ...
        if item_scheme["type"] != 'string' and (len(self.__data_types.toStr(value)) == 0 or value == ''):
            value = '__empty__'
    ...
    # __has_default
    # --------------------------------
    def __has_default(self, item_scheme):
        has_default = False
    ...
    # __default
    # --------------------------------
    def __default(self, item_scheme):
        value = ""
        if 'default' in item_scheme.keys():
