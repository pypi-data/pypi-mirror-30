...
class Services(object):
    ...
    # --------------------------------
    def action(self):
        if hasattr(self, self.__data_rest.action) and self.__data_rest.validateService(self.version, self.name,
                                                                                       self.id):
    ...
    def scheme(self, scheme):
        ...
        if self.__data_rest.action == "save":
            ...
            for item in scheme:
                ...
                value = self.__data_rest.validateField(item, value)
            ...
            # Implementar coleção change
            # self.__data_rest.checksum(save_data)
            # TODO:: "UPDATE IMPLEMENTAR"
            print "UPDATE IMPLEMENTAR"
