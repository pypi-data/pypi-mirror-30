# -*- coding: utf-8 -*-
# =============================================================================
# SPHINX CONFIGURATION FOR: bubble docs
# =============================================================================
# SPHINX EXTENSIONS:
...
man_pages = [
    ('index', 'Bubble', u'%s Documentation' % project, [author], 1)
]
...
texinfo_documents = [
  ('index', 'bubble', u'%s Documentation' % project,
   author, 'bubble', 'Bubble api2api connections',
   'Miscellaneous'),
]
