...
init_path = os.path.join('kore_plugins_env', '__init__.py')
...
entry_points = """\
[kore.configs]
env = kore_plugins_env.env:EnvConfig
"""


setup(
    name='kore-plugins-env',
    version=metadata['version'],
    author=metadata['author'],
    author_email=metadata['email'],
    url=metadata['url'],
    packages=find_packages(include=('kore_plugins_env*',)),
