...
def textbox(msg="", text="", title=" ",
    ...
    tb = TextBox(msg=msg, text=text, title=title,
...
class TextBox(object):
    ...
    def __init__(self, msg, text, title, codebox, callback=lambda *args, **kwargs: True):
        """ Create box object
        ...
        self.ui = GUItk(msg, text,title,  codebox, self.callback_ui)
        self.text = text
...
class GUItk(object):
    ...
    def __init__(self, msg, text, title,  codebox, callback):
        """ Create ui object
    ...
    def create_ok_button(self):
        ...
        self.okButton = tk.Button(
            self.buttonsFrame, takefocus=tk.YES, text="OK", height=1, width=6,font=('微软雅黑',25))
        self.okButton.pack(
            expand=tk.NO, side=tk.LEFT, padx='2m', pady='1m', ipady="1m",
            ipadx="2m")
