...
def browse_dir_on_textbox( textbox : QLineEdit ) -> bool:
    ...
    dir_name = str( QFileDialog.getExistingDirectory( owner, "Select directory", textbox.text(), options = DLG_OPTS ) )
...
def browse_dir( owner, existing = None ):
    return str( QFileDialog.getExistingDirectory( owner, "Select directory", existing, options = DLG_OPTS ) )
...
def browse_save_on_textbox( textbox: QLineEdit, filter ) -> bool:
    ...
    dir_name = str( QFileDialog.getSaveFileName( owner, "Select file", directory, filter, options = DLG_OPTS ) )
...
def browse_save( parent, filter ):
    ...
    file_name, file_filter = QFileDialog.getSaveFileName( parent, "Save", "", filter, options = DLG_OPTS )
...
def browse_open( parent, filter ):
    file_name, file_filter = QFileDialog.getOpenFileName( parent, "Open", "", filter, options = DLG_OPTS )
