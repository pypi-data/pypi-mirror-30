...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="annotation">
    <xsl:if test="head/annotation">
      <div class="pdocAnnotation">
        <xsl:apply-templates select="head/annotation"/>
      </div>
    </xsl:if>
  </xsl:template>
  ...
  <!--
      =========================================================================
      PI tune-latex-newpage
      =========================================================================
  -->
  <xsl:template match="processing-instruction('tune-latex-newpage')">
    <span class="tune-latex-newpage"><xsl:text> </xsl:text></span>
  </xsl:template>

  <!--
      =========================================================================
      PI tune-latex-noindent
      =========================================================================
  -->
  <xsl:template match="processing-instruction('tune-latex-noindent')">
    <span class="tune-latex-noindent"><xsl:text> </xsl:text></span>
  </xsl:template>
