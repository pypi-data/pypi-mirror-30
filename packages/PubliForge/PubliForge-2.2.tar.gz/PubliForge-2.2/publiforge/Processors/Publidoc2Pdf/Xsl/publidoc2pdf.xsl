...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="indentation">4</xsl:param>
  <!-- Processor font parameters -->
  <xsl:param name="font_main">Serif, 11/13, m, n</xsl:param>
  <xsl:param name="font_header">Sans, 10/12, ,</xsl:param>
  <xsl:param name="font_folio">Sans, /, ,</xsl:param>
  <xsl:param name="font_title1">Sans, 22/26, bx,</xsl:param>
  <xsl:param name="font_title2">Sans, 20/22, bx,</xsl:param>
  <xsl:param name="font_title3">Sans, 15/17, bx,</xsl:param>
  <xsl:param name="font_title4">Sans, 12/14, bx,</xsl:param>
  <xsl:param name="font_title5">Sans, 11/13, , it</xsl:param>
  <xsl:param name="font_note">Sans, 7.5/9, ,</xsl:param>
  ...
  <xsl:param name="toc_numbering" select="0"/>
  <xsl:param name="openright" select="0"/>
...
%
\documentclass[twoside,<xsl:if test="$openright">openright,</xsl:if>11pt]{scrreprt}
