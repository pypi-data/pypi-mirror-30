...
class TestCiscoAutoload(TestCase):
    ...
    def _check_names(self, resources):
        names = []
        for resource in resources:
            if "port" in resource.model.lower() and resource.name in names:
                return False
            else:
    ...
    def test_is_loads_ms_iosxr_117_correctly(self):
        print '-----------ncs_4000------------'
        ip_address = "192.168.73.117"
    ...
    def test_is_loads_ms_iosxr_112_correctly(self):
        print '-----------ncs_4000------------'
        ip_address = "192.168.73.112"
        # ip_list = ["117", "110", "112", "109", "113", "114", "115", "111"]
        result = self._get_handler(ip_address).discover(self.SUPPORTED_OS)
        self.assertIsNotNone(result)
        self.assertIsNotNone(result.resources)
        self.assertIsNotNone(result.attributes)
    ...
    # def test_is_loads_ms_iosxr_110_correctly(self):
    #     print '-----------ncs_4000------------'
    #     ip_address = "192.168.73.110"
    #     # ip_list = ["117", "110", "112", "109", "113", "114", "115", "111"]
    #     result = self._get_handler(ip_address).discover(self.SUPPORTED_OS)
    #     self.assertIsNotNone(result)
    #     self.assertIsNotNone(result.resources)
    ...
    def test_is_loads_ms_iosxr_109_correctly(self):
        print '-----------ncs_4000------------'
        ip_address = "192.168.73.109"
        # ip_list = ["117", "110", "112", "109", "113", "114", "115", "111"]
        result = self._get_handler(ip_address).discover(self.SUPPORTED_OS)
        self.assertIsNotNone(result)
        self.assertIsNotNone(result.resources)
    ...
    def test_is_loads_ms_iosxr_113_correctly(self):
        print '-----------ncs_4000------------'
        ip_address = "192.168.73.113"
        # ip_list = ["117", "110", "112", "109", "113", "114", "115", "111"]
        result = self._get_handler(ip_address).discover(self.SUPPORTED_OS)
        self.assertIsNotNone(result)
        self.assertIsNotNone(result.resources)
    ...
    def test_is_loads_ms_iosxr_114_correctly(self):
        print '-----------ncs_4000------------'
        ip_address = "192.168.73.114"
        # ip_list = ["117", "110", "112", "109", "113", "114", "115", "111"]
        result = self._get_handler(ip_address).discover(self.SUPPORTED_OS)
        self.assertIsNotNone(result)
        self.assertIsNotNone(result.resources)
    ...
    def test_is_loads_ms_iosxr_115_correctly(self):
        print '-----------ncs_4000------------'
        ip_address = "192.168.73.115"
        # ip_list = ["117", "110", "112", "109", "113", "114", "115", "111"]
        result = self._get_handler(ip_address).discover(self.SUPPORTED_OS)
        self.assertIsNotNone(result)
        self.assertIsNotNone(result.resources)
    ...
    def test_is_loads_ms_iosxr_111_correctly(self):
        print '-----------ncs_4000------------'
    ...
    def is_valid_element(self, resource):
        if resource.model == 'Generic Module':
            if len(resource.relative_address.split("/")) == 2:
                return True
        if resource.model == 'Generic Sub Module':
            if len(resource.relative_address.split("/")) == 3:
                return True
        if resource.model == 'Generic Port':
            if len(resource.relative_address.split("/")) > 1:
                return True
        ...
        if resource.model == 'Generic Port Channel':
            if len(resource.relative_address.split("/")) < 2:
                return True
        if resource.model == 'Generic Chassis':
            if len(resource.relative_address.split("/")) < 2:
                return True

    # def test_is_loads_iosxr_iss_correctly(self):
    #     print '-----------ncs_4000------------'
    #     ip = '192.168.73.102'
    #     result = self._get_handler(ip).discover(self.SUPPORTED_OS)
    #     self.assertIsNotNone(result)
