...
if __name__ == "__main__":
    ...
    snmp = QualiSnmp(snmp_parameters=SNMPV2ReadParameters(ip="192.168.73.117", snmp_read_community="public"), logger=logger)
    autoload = CiscoGenericSNMPAutoload(resource_name="res_name", logger=logger, shell_name="bla bla", shell_type="CS_Router", snmp_handler=snmp)
    result = autoload.discover([".*"])
    print result