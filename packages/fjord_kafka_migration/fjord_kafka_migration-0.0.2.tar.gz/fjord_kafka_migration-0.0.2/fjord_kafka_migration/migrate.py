...
def run():
    ...
    parser.add_argument('--region', default=u'us-west-2', help='the aws region, e.g us-west-2, eu-central-1.')
    parser.add_argument('--profile', default=u'default', help='the aws profile configured in relative machine.')
    parser.add_argument('--cluster-name', help='the broker cluster name.')
    parser.add_argument('--task-definition', help='the running task definition in ecs.')
    parser.add_argument('--remote-container-id', help='the remote broker container id.')
    parser.add_argument('--local-container-id', help='the local broker container id.')
    parser.add_argument('--remote-username', help='the remote server ssh user name.')
    parser.add_argument('--remote-password', help='the remote server ssh password.')
