...
class BrokerTaskManager(object):
    ...
    def schedule_broker_task(self, container_id):
        ...
        try:
            ...
            response = self.ecs.update_broker_ec2_state(container_id, u'ACTIVE')
    ...
    def update_broker_ec2_state(self, container_id, state):
        ...
        try:
            ...
            logger.info("it's success to update container %s to state %s in cluster %s.", container_id, state, response)
