...
_PROCESSBUNDLESPLITREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fraction', full_name='org.apache.beam.model.fn_execution.v1.ProcessBundleSplitRequest.fraction', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ELEMENTCOUNTRESTRICTION = _descriptor.Descriptor(
  ...
  full_name='org.apache.beam.model.fn_execution.v1.ElementCountRestriction',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='count', full_name='org.apache.beam.model.fn_execution.v1.ElementCountRestriction.count', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ELEMENTCOUNTSKIPRESTRICTION = _descriptor.Descriptor(
  ...
  full_name='org.apache.beam.model.fn_execution.v1.ElementCountSkipRestriction',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='count', full_name='org.apache.beam.model.fn_execution.v1.ElementCountSkipRestriction.count', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PRIMITIVETRANSFORMSPLIT = _descriptor.Descriptor(
  ...
  full_name='org.apache.beam.model.fn_execution.v1.PrimitiveTransformSplit',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='primitive_transform_reference', full_name='org.apache.beam.model.fn_execution.v1.PrimitiveTransformSplit.primitive_transform_reference', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='completed_restriction', full_name='org.apache.beam.model.fn_execution.v1.PrimitiveTransformSplit.completed_restriction', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remaining_restriction', full_name='org.apache.beam.model.fn_execution.v1.PrimitiveTransformSplit.remaining_restriction', index=2,
...
_PROCESSBUNDLESPLITRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='splits', full_name='org.apache.beam.model.fn_execution.v1.ProcessBundleSplitResponse.splits', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ElementCountRestriction = _reflection.GeneratedProtocolMessageType('ElementCountRestriction', (_message.Message,), dict(
  ...
  __module__ = 'beam_fn_api_pb2'
  # @@protoc_insertion_point(class_scope:org.apache.beam.model.fn_execution.v1.ElementCountRestriction)
  ))
...
ElementCountSkipRestriction = _reflection.GeneratedProtocolMessageType('ElementCountSkipRestriction', (_message.Message,), dict(
  ...
  __module__ = 'beam_fn_api_pb2'
  # @@protoc_insertion_point(class_scope:org.apache.beam.model.fn_execution.v1.ElementCountSkipRestriction)
  ))
...
PrimitiveTransformSplit = _reflection.GeneratedProtocolMessageType('PrimitiveTransformSplit', (_message.Message,), dict(
  ...
  __module__ = 'beam_fn_api_pb2'
  # @@protoc_insertion_point(class_scope:org.apache.beam.model.fn_execution.v1.PrimitiveTransformSplit)
  ))
