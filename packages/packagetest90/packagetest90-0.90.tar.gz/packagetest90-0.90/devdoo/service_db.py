...
class ServiceDB:
    ...
    def __collection(self):
        ...
        database = self.config.mongo_server[self.datarest_db.database()]
    ...
    def __prepare_data_changes(self, data_update, data_active):
        ...
        insert_data_update = {
            "filter": {},
            "data": data,
            "created_time": Convert.to_str(datetime.datetime.utcnow()),
